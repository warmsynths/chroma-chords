        ...
        <div class="content">
          ...
          <div class="footer">
            ...
            ${this.isAuthenticated?I`
              <button class="footer-admin-btn" @click=${()=>{this.showAdminModal=!0}}>
...
`,Sg=[{device:"m8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:kg},{device:"circuit",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:Ag}];let zn=class extends Ge{constructor(){super(...arguments),this.visible=!1}emit(n,e){this.dispatchEvent(new CustomEvent(n,{detail:e,bubbles:!0,composed:!0}))}render(){return I`
  ...
  `;pe([D()],ce.prototype,"chordData",2);pe([D()],ce.prototype,"screen",2);pe([D()],ce.prototype,"genre",2);pe([D()],ce.prototype,"mood",2);pe([D()],ce.prototype,"progression",2);pe([D()],ce.prototype,"activeIndex",2);pe([D()],ce.prototype,"progressStep",2);pe([D()],ce.prototype,"order",2);pe([D()],ce.prototype,"keyOverride",2);pe([D()],ce.prototype,"scaleOverride",2);pe([D()],ce.prototype,"playing",2);pe([D()],ce.prototype,"showTheory",2);pe([D()],ce.prototype,"instrument",2);pe([D()],ce.prototype,"playStyle",2);pe([D()],ce.prototype,"sheetOpen",2);pe([D()],ce.prototype,"sheetMode",2);pe([D()],ce.prototype,"swapIndex",2);pe([D()],ce.prototype,"alternatives",2);pe([D()],ce.prototype,"length",2);pe([D()],ce.prototype,"sections",2);pe([D()],ce.prototype,"activeSectionIdx",2);pe([D()],ce.prototype,"pendingChordSuggestion",2);ce=pe([Dt("chroma-chords-app")],ce);
