import{f as ai,u as li,C as Ot,S as ci,P as L,a as W,R as Dt,b as Pt,M as Bt,F as fe,s as di,n as hi,l as pi,i as z,c as G,d,A as _t,w as J,O as ui}from"./vendor-dyN-iMiE.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function i(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=i(s);fetch(s.href,r)}})();/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gi={attribute:!0,type:String,converter:li,reflect:!1,hasChanged:ai},mi=(e=gi,t,i)=>{const{kind:o,metadata:s}=i;let r=globalThis.litPropertyMetadata.get(s);if(r===void 0&&globalThis.litPropertyMetadata.set(s,r=new Map),o==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(i.name,e),o==="accessor"){const{name:n}=i;return{set(a){const c=t.get.call(this);t.set.call(this,a),this.requestUpdate(n,c,e,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,e,a),a}}}if(o==="setter"){const{name:n}=i;return function(a){const c=this[n];t.call(this,a),this.requestUpdate(n,c,e,!0,a)}}throw Error("Unsupported decorator location: "+o)};function w(e){return(t,i)=>typeof i=="object"?mi(e,t,i):((o,s,r)=>{const n=s.hasOwnProperty(r);return s.constructor.createProperty(r,o),n?Object.getOwnPropertyDescriptor(s,r):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fi=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Rt(e,t){return(i,o,s)=>{const r=n=>n.renderRoot?.querySelector(e)??null;return fi(i,o,{get(){return r(this)}})}}const re="chroma_chords_projects",vi="chord_voyager_projects";class H{static getProjects(){try{let t=localStorage.getItem(re);if(t||(t=localStorage.getItem(vi),t&&localStorage.setItem(re,t)),t){const i=JSON.parse(t);let o=!1;return i.forEach(s=>{(s.genre==="Unknown"||!s.genre)&&(s.genre="Pop",o=!0)}),o&&localStorage.setItem(re,JSON.stringify(i)),i}}catch(t){console.error("Failed to load projects from localStorage:",t)}return[]}static setProjects(t){try{localStorage.setItem(re,JSON.stringify(t))}catch(i){console.error("Failed to set projects to localStorage:",i)}}static mergeProjects(t,i){const o=new Map;return t.forEach(s=>o.set(s.id,s)),i.forEach(s=>{const r=o.get(s.id);!r||s.lastModified>r.lastModified?o.set(s.id,s):s.lastModified===r.lastModified&&(r.syncedToCloud=!0)}),Array.from(o.values())}static saveProject(t){const i=this.getProjects(),o=i.findIndex(s=>s.id===t.id);t.lastModified=Date.now(),o>=0?i[o]=t:i.push(t);try{localStorage.setItem(re,JSON.stringify(i))}catch(s){console.error("Failed to save project to localStorage:",s)}}static deleteProject(t){let i=this.getProjects();i=i.filter(o=>o.id!==t);try{localStorage.setItem(re,JSON.stringify(i))}catch(o){console.error("Failed to delete project from localStorage:",o)}}static exportProjectFile(t){const i=JSON.stringify(t,null,2),o=new Blob([i],{type:"application/json"}),s=URL.createObjectURL(o),r=document.createElement("a");r.href=s,r.download=`${t.name.replace(/[^a-z0-9]/gi,"_").toLowerCase()}_chroma_chords.json`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(s)}static importProjectFile(t){return new Promise((i,o)=>{const s=new FileReader;s.onload=r=>{try{const n=r.target?.result,a=JSON.parse(n);a&&typeof a=="object"&&Array.isArray(a.chords)?(a.id=Math.random().toString(36).substr(2,9),a.lastModified=Date.now(),i(a)):o(new Error("Invalid project file format"))}catch{o(new Error("Failed to parse JSON file"))}},s.onerror=()=>o(new Error("Failed to read file")),s.readAsText(t)})}}class yi{constructor(){this.accessToken=null,this.FILENAME="chroma_chords_projects.json",this.OLD_FILENAME="chord_voyager_projects.json"}setAccessToken(t){this.accessToken=t}hasAccessToken(){return this.accessToken!==null}get headers(){if(!this.accessToken)throw new Error("Not authorized. Missing access token.");return{Authorization:`Bearer ${this.accessToken}`}}async findProjectFileId(){try{const t=encodeURIComponent(`name='${this.FILENAME}' and trashed=false`),i=await fetch(`https://www.googleapis.com/drive/v3/files?spaces=appDataFolder&q=${t}&fields=files(id)`,{method:"GET",headers:this.headers});if(!i.ok)throw i.status===401?new Error("Unauthorized"):new Error(`Drive API error: ${i.statusText}`);const o=await i.json();if(o.files&&o.files.length>0)return o.files[0].id;const s=encodeURIComponent(`name='${this.OLD_FILENAME}' and trashed=false`),r=await fetch(`https://www.googleapis.com/drive/v3/files?spaces=appDataFolder&q=${s}&fields=files(id)`,{method:"GET",headers:this.headers});if(r.ok){const n=await r.json();if(n.files&&n.files.length>0)return n.files[0].id}return null}catch(t){throw console.error("Failed to find project file in Google Drive:",t),t}}async loadProjects(){try{const t=await this.findProjectFileId();if(!t)return null;const i=await fetch(`https://www.googleapis.com/drive/v3/files/${t}?alt=media`,{method:"GET",headers:this.headers});if(!i.ok)throw new Error(`Failed to download file: ${i.statusText}`);return await i.json()}catch(t){throw console.error("Failed to load projects from Google Drive:",t),t}}async saveProjects(t){try{const i=await this.findProjectFileId(),o=JSON.stringify(t);if(i){const s=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${i}?uploadType=media`,{method:"PATCH",headers:{...this.headers,"Content-Type":"application/json"},body:o});if(!s.ok)throw new Error(`Failed to update file: ${s.statusText}`)}else{const s=await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{...this.headers,"Content-Type":"application/json"},body:JSON.stringify({name:this.FILENAME,parents:["appDataFolder"]})});if(!s.ok)throw new Error(`Failed to create file metadata: ${s.statusText}`);const n=(await s.json()).id,a=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${n}?uploadType=media`,{method:"PATCH",headers:{...this.headers,"Content-Type":"application/json"},body:o});if(!a.ok)throw new Error(`Failed to upload new file content: ${a.statusText}`)}}catch(i){throw console.error("Failed to save projects to Google Drive:",i),i}}async findAudioFileId(t){try{const i=`recording_${t}.webm`,o=encodeURIComponent(`name='${i}' and trashed=false`),s=await fetch(`https://www.googleapis.com/drive/v3/files?spaces=appDataFolder&q=${o}&fields=files(id)`,{method:"GET",headers:this.headers});if(!s.ok)throw s.status===401?new Error("Unauthorized"):new Error(`Drive API error: ${s.statusText}`);const r=await s.json();return r.files&&r.files.length>0?r.files[0].id:null}catch(i){throw console.error(`Failed to find audio file for project ${t}:`,i),i}}async uploadAudioFile(t,i){try{const o=`recording_${t}.webm`,s=await this.findAudioFileId(t);if(s){const r=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${s}?uploadType=media`,{method:"PATCH",headers:{...this.headers,"Content-Type":i.type||"audio/webm"},body:i});if(!r.ok)throw new Error(`Failed to update audio file: ${r.statusText}`);return s}else{const r=await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{...this.headers,"Content-Type":"application/json"},body:JSON.stringify({name:o,parents:["appDataFolder"]})});if(!r.ok)throw new Error(`Failed to create audio file metadata: ${r.statusText}`);const a=(await r.json()).id,c=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${a}?uploadType=media`,{method:"PATCH",headers:{...this.headers,"Content-Type":i.type||"audio/webm"},body:i});if(!c.ok)throw new Error(`Failed to upload new audio file content: ${c.statusText}`);return a}}catch(o){throw console.error(`Failed to upload audio file for project ${t}:`,o),o}}async downloadAudioFile(t){try{const i=await this.findAudioFileId(t);if(!i)return null;const o=await fetch(`https://www.googleapis.com/drive/v3/files/${i}?alt=media`,{method:"GET",headers:this.headers});if(!o.ok)throw new Error(`Failed to download audio file: ${o.statusText}`);return await o.blob()}catch(i){throw console.error(`Failed to download audio file for project ${t}:`,i),i}}async deleteAudioFile(t){try{const i=await this.findAudioFileId(t);if(!i)return;const o=await fetch(`https://www.googleapis.com/drive/v3/files/${i}`,{method:"DELETE",headers:this.headers});if(!o.ok&&o.status!==404)throw new Error(`Failed to delete audio file: ${o.statusText}`)}catch(i){throw console.error(`Failed to delete audio file for project ${t}:`,i),i}}}const xi=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],bi=["C","Db","D","Eb","E","F","Gb","G","Ab","A","Bb","B"],X={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},wi=new Set(["F","Bb","Eb","Ab","Db","Gb"]),ae=["C","Db","D","Eb","E","F","F#","G","Ab","A","Bb","B"],je={maj:[0,4,7],min:[0,3,7],dim:[0,3,6],aug:[0,4,8],dom7:[0,4,7,10],min7:[0,3,7,10],maj7:[0,4,7,11],dim7:[0,3,6,9],sus4:[0,5,7]},ki=Object.keys(je),Ti={TONIC:"home",SUPERTONIC:"rise",MEDIANT:"glow",SUBDOMINANT:"lift",DOMINANT:"reach",SUBMEDIANT:"hold","LEADING-TONE":"edge",SUBTONIC:"drift"},vt={TONIC:"Tonic",SUPERTONIC:"Supertonic",MEDIANT:"Mediant",SUBDOMINANT:"Subdominant",DOMINANT:"Dominant",SUBMEDIANT:"Submediant","LEADING-TONE":"Leading tone",SUBTONIC:"Subtonic"},Si={TONIC:.04,SUBMEDIANT:.24,MEDIANT:.34,SUBDOMINANT:.42,SUPERTONIC:.52,SUBTONIC:.58,"LEADING-TONE":.78,DOMINANT:.68},We={MAJOR:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii°"},NATURAL_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"III",SUBDOMINANT:"iv",DOMINANT:"v",SUBMEDIANT:"VI",SUBTONIC:"VII"},HARMONIC_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"III+",SUBDOMINANT:"iv",DOMINANT:"V",SUBMEDIANT:"VI","LEADING-TONE":"vii°"},MELODIC_MINOR:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"III+",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi°","LEADING-TONE":"vii°"},DORIAN:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"III",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi°",SUBTONIC:"VII"},MIXOLYDIAN:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii°",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi",SUBTONIC:"VII"},LYDIAN:{TONIC:"I",SUPERTONIC:"II",MEDIANT:"iii",SUBDOMINANT:"iv°",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii"}},Ii=Object.keys(We),yt={MAJOR:"Ionian",NATURAL_MINOR:"Aeolian",HARMONIC_MINOR:"Harmonic minor",MELODIC_MINOR:"Melodic minor",DORIAN:"Dorian",MIXOLYDIAN:"Mixolydian",LYDIAN:"Lydian"},ve=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],Ai={Pop:"MAJOR",Rock:"MAJOR",Gospel:"MAJOR","Indie/Folk":"MAJOR","Lo-fi/Chill":"DORIAN","Jazz-ish":"DORIAN","R&B/Soul":"MIXOLYDIAN","House/Dance":"MIXOLYDIAN",Synthwave:"LYDIAN",Cinematic:"LYDIAN",Blues:"MIXOLYDIAN","Funk/Disco":"MIXOLYDIAN","Country/Bluegrass":"MAJOR","Reggae/Dub":"DORIAN",Metal:"HARMONIC_MINOR",Punk:"MAJOR","Ambient/Drone":"LYDIAN","Trap/Hip-Hop":"NATURAL_MINOR","Bossa Nova/Latin":"DORIAN","Classical/Orchestral":"MAJOR","EDM/Trance":"NATURAL_MINOR",Afrobeats:"MIXOLYDIAN",Shoegaze:"LYDIAN"},Ni={Uplifting:null,Melancholy:"NATURAL_MINOR",Dreamy:null,Tense:"HARMONIC_MINOR",Warm:null,Nostalgic:"NATURAL_MINOR",Energetic:null,Dark:"HARMONIC_MINOR",Peaceful:null,Groovy:"MIXOLYDIAN",Epic:"MAJOR"},Lt={Uplifting:["DOMINANT","SUBDOMINANT","SUBMEDIANT"],Melancholy:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Dreamy:["MEDIANT","SUBDOMINANT","SUPERTONIC"],Tense:["DOMINANT","LEADING-TONE","SUPERTONIC"],Warm:["SUBDOMINANT","MEDIANT","SUBMEDIANT"],Nostalgic:["SUBMEDIANT","MEDIANT","DOMINANT"],Energetic:["DOMINANT","SUBDOMINANT","SUPERTONIC"],Dark:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Peaceful:["TONIC","SUBDOMINANT","MEDIANT"],Groovy:["SUBDOMINANT","DOMINANT","SUBTONIC"],Epic:["TONIC","DOMINANT","SUBMEDIANT"]},Q=[{name:"Uplifting",dot:"#F6D98B",desc:"Bright, major, forward-moving",iconPath:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5"},{name:"Melancholy",dot:"#9CC0EC",desc:"Minor-leaning, unresolved longing",iconPath:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15"},{name:"Dreamy",dot:"#C9A9E0",desc:"Suspended, floating, reverb-soaked",iconPath:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0"},{name:"Tense",dot:"#F2735F",desc:"Chromatic pulls, unresolved tension",iconPath:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12"},{name:"Warm",dot:"#F2C9A0",desc:"Rich, consonant, close voicings",iconPath:"M12 4 a6.5 6.5 0 1 0 6.5 6.5"},{name:"Nostalgic",dot:"#B8CC9E",desc:"Bittersweet, borrowed chords",iconPath:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},{name:"Energetic",dot:"#FF8C42",desc:"High velocity, driving rhythm",iconPath:"M13 2 L4 14 h7 l-2 8 11-12 h-7 z"},{name:"Dark",dot:"#7B61FF",desc:"Deep minor, ominous resonance",iconPath:"M12 3 a9 9 0 1 0 9 9 a9 9 0 0 1-9-9 z"},{name:"Peaceful",dot:"#7CD9B6",desc:"Serene, gentle acoustic space",iconPath:"M12 2 a10 10 0 1 0 10 10 A10 10 0 0 0 12 2 z M12 6 a6 6 0 1 1-6 6 a6 6 0 0 1 6-6 z"},{name:"Groovy",dot:"#E8609A",desc:"Syncopated, rhythmic bounce",iconPath:"M4 12 c4-4 8 4 12-4 s8 4 4 8"},{name:"Epic",dot:"#E5C158",desc:"Sweeping dynamics, triumphant power",iconPath:"M12 2 l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 z"}];function ye(e){return(Q.find(t=>t.name===e)||Q[0]).dot}const Mi={MAJOR:[{degrees:["TONIC","DOMINANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBMEDIANT","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","DOMINANT"]},{degrees:["TONIC","MEDIANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBDOMINANT","SUBMEDIANT","DOMINANT"]}],NATURAL_MINOR:[{degrees:["TONIC","SUBMEDIANT","MEDIANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","MEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUBTONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBMEDIANT"]}],HARMONIC_MINOR:[{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUBDOMINANT"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUPERTONIC","DOMINANT"]}],DORIAN:[{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUPERTONIC","SUBTONIC"]}],MIXOLYDIAN:[{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBDOMINANT"]}],LYDIAN:[{degrees:["TONIC","SUPERTONIC","SUBMEDIANT","DOMINANT"]},{degrees:["TONIC","DOMINANT","SUPERTONIC","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]}]};function Ci(e,t){return 1+e.degrees.filter(i=>t.includes(i)).length*.6}function Be(e,t){const i=e.reduce((s,r)=>s+t(r),0);let o=Math.random()*i;for(const s of e)if(o-=t(s),o<=0)return s;return e[e.length-1]}function Ei(e){if(e.length)return e[Math.floor(Math.random()*e.length)]}const Ke=4,oe=1,F=8,rt=1700,$i={TONIC:{SUBDOMINANT:.35,SUBMEDIANT:.25,SUPERTONIC:.15,DOMINANT:.15,MEDIANT:.05,SUBTONIC:.05},SUPERTONIC:{DOMINANT:.5,SUBDOMINANT:.2,SUBMEDIANT:.15,TONIC:.1,"LEADING-TONE":.05},MEDIANT:{SUBMEDIANT:.4,SUBDOMINANT:.3,SUPERTONIC:.15,DOMINANT:.15},SUBDOMINANT:{DOMINANT:.45,TONIC:.25,SUPERTONIC:.15,SUBMEDIANT:.15},DOMINANT:{TONIC:.55,SUBMEDIANT:.25,SUBDOMINANT:.15,MEDIANT:.05},SUBMEDIANT:{SUBDOMINANT:.4,SUPERTONIC:.25,DOMINANT:.2,TONIC:.15},"LEADING-TONE":{TONIC:.7,SUBMEDIANT:.2,MEDIANT:.1},SUBTONIC:{TONIC:.45,SUBDOMINANT:.3,SUBMEDIANT:.15,DOMINANT:.1}};function Me(e,t,i="MAJOR",o="Pop",s="Uplifting"){if(e===t)return .05;let n=($i[e]||{})[t]??.1;return(i.includes("MINOR")||i==="DORIAN")&&(e==="TONIC"&&t==="SUBMEDIANT"&&(n*=1.5),e==="SUBMEDIANT"&&t==="MEDIANT"&&(n*=1.4),e==="MEDIANT"&&t==="SUBTONIC"&&(n*=1.4),e==="SUBTONIC"&&t==="TONIC"&&(n*=1.3)),o==="Jazz-ish"||o==="Lo-fi/Chill"?(e==="SUPERTONIC"&&t==="DOMINANT"&&(n*=1.8),e==="DOMINANT"&&t==="TONIC"&&(n*=1.5),e==="TONIC"&&t==="SUPERTONIC"&&(n*=1.4)):(o==="House/Dance"||o==="Synthwave")&&(t==="SUBTONIC"||t==="SUBDOMINANT")&&(n*=1.5),(Lt[s]||[]).includes(t)&&(n*=1.5),Math.max(.01,n)}function Oi(e,t,i,o,s,r,n=Ke){let a="TONIC";(e.type.includes("MINOR")||e.type==="DORIAN")&&(r==="Melancholy"||r==="Nostalgic")&&Math.random()<.4&&(a=i.includes("SUBMEDIANT")?"SUBMEDIANT":"TONIC");const c=[a];let h=a;for(let f=1;f<n;f++){const l=f===n-1;let m=i.filter(p=>e.degrees[p]);m.length||(m=i);const v=m.filter(p=>p!==h),y=v.length?v:m;if(l){const p=Be(y,b=>{const M=Me(b,c[0],e.type,s,r),k=Me(h,b,e.type,s,r);return M*k});c.push(p)}else{const p=y.filter(k=>!c.includes(k)),b=p.length?p:y,M=Be(b,k=>Me(h,k,e.type,s,r));h=M,c.push(M)}}return c}function xe(e,t){const i=(e%12+12)%12;return t?bi[i]:xi[i]}function nt(e){const t=e[0]?.toUpperCase();let i="C",o=e;t&&/[A-G]/.test(t)&&(e[1]==="B"?(i=`${t}b`,o=e.slice(2)):e[1]==="#"?(i=`${t}#`,o=e.slice(2)):(i=t,o=e.slice(1))),o=o.toLowerCase();let s="maj";return o.includes("maj7")?s="maj7":o.includes("min7")||o.includes("m7")?s="min7":o.includes("dim7")?s="dim7":o.includes("dim")?s="dim":o.includes("aug")?s="aug":o.includes("sus")?s="sus4":o==="7"?s="dom7":o.includes("min")||o==="m"?s="min":s="maj",{root:i,quality:s}}function Ce(e,t){const{root:i,quality:o}=nt(e),s=X[i]??0;return je[o].map(n=>xe(s+n,t))}async function Di(){let e=await fetch("./chroma_chords_data.json");if(e.ok||(e=await fetch("./chord_voyager_data.json")),!e.ok)throw new Error(`HTTP error: ${e.status}`);const t=await e.json();return ji(t),t}const Pi={C:"F",Db:"F#",D:"G",Eb:"Ab",E:"A",F:"Bb","F#":"B",G:"C",Ab:"Db",A:"D",Bb:"Eb",B:"E"},Bi={C:"Bb","C#":"B",D:"C","D#":"Db",E:"D",F:"Eb","F#":"E",G:"F","G#":"F#",A:"G","A#":"Ab",B:"A"},_i={C:"G",Db:"Ab",D:"A",Eb:"Bb",E:"B",F:"C","F#":"Db",G:"D",Ab:"Eb",A:"E",Bb:"F",B:"F#"},Ri={DORIAN_SUPERTONIC:"TONIC",DORIAN_MEDIANT:"SUPERTONIC",DORIAN_SUBDOMINANT:"MEDIANT",DORIAN_DOMINANT:"SUBDOMINANT",DORIAN_SUBMEDIANT:"DOMINANT","DORIAN_LEADING-TONE":"SUBMEDIANT",DORIAN_TONIC:"SUBTONIC",MIXOLYDIAN_DOMINANT:"TONIC",MIXOLYDIAN_SUBMEDIANT:"SUPERTONIC","MIXOLYDIAN_LEADING-TONE":"MEDIANT",MIXOLYDIAN_TONIC:"SUBDOMINANT",MIXOLYDIAN_SUPERTONIC:"DOMINANT",MIXOLYDIAN_MEDIANT:"SUBMEDIANT",MIXOLYDIAN_SUBDOMINANT:"SUBTONIC",LYDIAN_SUBDOMINANT:"TONIC",LYDIAN_DOMINANT:"SUPERTONIC",LYDIAN_SUBMEDIANT:"MEDIANT","LYDIAN_LEADING-TONE":"SUBDOMINANT",LYDIAN_TONIC:"DOMINANT",LYDIAN_SUPERTONIC:"SUBMEDIANT",LYDIAN_MEDIANT:"LEADING-TONE"},Li={DORIAN_TONIC:"SUPERTONIC",DORIAN_SUPERTONIC:"MEDIANT",DORIAN_MEDIANT:"SUBDOMINANT",DORIAN_SUBDOMINANT:"DOMINANT",DORIAN_DOMINANT:"SUBMEDIANT",DORIAN_SUBMEDIANT:"LEADING-TONE",DORIAN_SUBTONIC:"TONIC",MIXOLYDIAN_TONIC:"DOMINANT",MIXOLYDIAN_SUPERTONIC:"SUBMEDIANT",MIXOLYDIAN_MEDIANT:"LEADING-TONE",MIXOLYDIAN_SUBDOMINANT:"TONIC",MIXOLYDIAN_DOMINANT:"SUPERTONIC",MIXOLYDIAN_SUBMEDIANT:"MEDIANT",MIXOLYDIAN_SUBTONIC:"SUBDOMINANT",LYDIAN_TONIC:"SUBDOMINANT",LYDIAN_SUPERTONIC:"DOMINANT",LYDIAN_MEDIANT:"SUBMEDIANT",LYDIAN_SUBDOMINANT:"LEADING-TONE",LYDIAN_DOMINANT:"TONIC",LYDIAN_SUBMEDIANT:"SUPERTONIC","LYDIAN_LEADING-TONE":"MEDIANT"},Ui={DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]};function ji(e){const t=[["MIXOLYDIAN",Pi],["DORIAN",Bi],["LYDIAN",_i]];for(const[i,o]of t)for(const[s,r]of Object.entries(o)){const n=e.scales[`${r}_MAJOR`];if(!n)continue;const a=`${s}_${i}`,c={};for(const h of Ui[i]){const f=Li[`${i}_${h}`],l=n.degrees[f];if(!l)continue;const m=JSON.parse(JSON.stringify(l));m.next_chord_options=(m.next_chord_options||[]).map(v=>{if(v.nodeId.startsWith(`${r}_MAJOR_`)){const y=v.nodeId.replace(`${r}_MAJOR_`,""),p=Ri[`${i}_${y}`];if(p)return{name:v.name,nodeId:`${s}_${i}_${p}`}}return v}),c[h]=m}e.scales[a]={root:s,type:i,degrees:c}}}const Fi=[156,192,236],zi=[242,115,95];function Ee(e,t,i){return e+(t-e)*i}function at(e){const t=Math.max(0,Math.min(1,e));return"#"+Fi.map((o,s)=>Math.round(Ee(o,zi[s],t))).map(o=>o.toString(16).padStart(2,"0")).join("")}function _e(e){const t=Math.max(0,Math.min(1,e));return{size:Math.round(Ee(84,128,t)),radius:Math.round(Ee(40,12,t)),fontSize:Math.round(Ee(21,30,t)),color:at(t)}}function Gi(e,t,i){return{Tonic:`As the tonic, ${i} establishes home — the point of full rest and resolution.`,Supertonic:`As the supertonic, ${i} steps just off home, a light pivot toward what comes next.`,Mediant:`As the mediant, ${i} offers a soft, glowing detour — related to home, but colored differently.`,Subdominant:`As the subdominant, ${i} lifts away from home, opening the progression outward before it turns back.`,Dominant:`As the dominant, ${i} builds the pull of the progression — tension that wants to resolve.`,Submediant:`As the submediant, ${i} offers a warmer, more introspective variation of the tonic — stable but tinged with longing.`,"Leading tone":`As the leading tone, ${i} sits right on the edge, straining toward resolution.`,Subtonic:`As the subtonic, ${i} drifts just below home, a soft modal step rather than a hard pull.`}[e]||`${i} colors the progression as the ${e.toLowerCase()} of ${t}.`}function ne(e,t,i,o){const r=i.degrees[t].chord_name,n=Si[t]??.5,a=We[i.type]||We.MAJOR;return{name:xt(r),tag:Ti[t]||"move",roman:a[t]||"?",color:at(n),functionLabel:vt[t]||t,notes:Ce(r,o),scaleLabel:`${i.root} ${yt[i.type]||i.type}`,desc:Gi(vt[t]||t,yt[i.type]||i.type,xt(r)),degree:t,scaleKey:e,tension:n}}function xt(e){const{root:t,quality:i}=nt(e);return`${t}${{maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"}[i]??""}`}const Yi={Pop:116,"Lo-fi/Chill":80,"R&B/Soul":90,"Indie/Folk":105,Synthwave:118,"Jazz-ish":95,Gospel:85,Cinematic:75,Rock:124,"House/Dance":126,Blues:88,"Funk/Disco":114,"Country/Bluegrass":110,"Reggae/Dub":78,Metal:140,Punk:155,"Ambient/Drone":65,"Trap/Hip-Hop":135,"Bossa Nova/Latin":120,"Classical/Orchestral":72,"EDM/Trance":132,Afrobeats:108,Shoegaze:112};function Ut(e,t){let i=Yi[e]||92;return t==="Tense"&&(i+=6),(t==="Dreamy"||t==="Melancholy")&&(i-=6),i}function jt(e,t,i,o){const s=Math.max(oe,Math.min(F,o?.length??Ke)),r=Ai[t]||"MAJOR",n=Ni[i],a=o?.scaleType||(n&&r==="MAJOR"?n:r);let c=o?.key&&ae.includes(o.key)?o.key:Ei(ae),h=`${c}_${a}`;e.scales[h]||(c="C",h=`${c}_${a}`);const f=e.scales[h],l=K(c,a),m=Object.keys(f.degrees),v=Lt[i]||[],y=Mi[a]||[],p=s===Ke?y.filter(x=>x.degrees.every(N=>m.includes(N))):[],k=(p.length&&Math.random()<.25?Be(p,x=>Ci(x,v)).degrees:Oi(f,h,m,v,t,i,s)).map(x=>ne(h,x,f,l));return{genre:t,mood:i,key:c,scaleType:a,bpm:Ut(t,i),chords:k}}function Vi(e,t,i,o,s,r){const n=`${t}_${i}`,a=e.scales[n];if(!a||!o.length)return null;const c=K(t,i),h=X[t]??0,f={};Object.entries(a.degrees).forEach(([m,v])=>{const{root:y}=nt(v.chord_name),p=X[y]??0;p in f||(f[p]=m)});const l=o.slice(0,F).map(({root:m,quality:v})=>{const y=X[m]??h,p=f[y];if(p)return ne(n,p,a,c);const b=(y-h+12)%12,M=je[v]?v:"maj";return Qe(t,b,M,"Borrowed","?","drift",c)});return l.length<oe?null:{genre:s,mood:r,key:t,scaleType:i,bpm:Ut(s,r),chords:l}}function Fe(e,t,i,o,s,r,n){const a=e.filter(f=>t.includes(f)),c=a.filter(f=>f!==i),h=c.length?c:a;if(h.length)return Be(h,f=>Me(o,f,s,r,n))}const qi={maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"};function Qe(e,t,i,o,s,r,n){const a=(X[e]??0)+t,h=`${xe(a,n)}${qi[i]}`,f=je[i].map(m=>xe(a+m,n)),l=.3;return{name:h,tag:r,roman:s,color:at(l),functionLabel:o,notes:f,scaleLabel:"Borrowed",desc:`${h} borrows its color from outside the current key.`,degree:"BORROWED",scaleKey:"",tension:l}}function Ze(e){const t=e.match(/^[A-Ga-g][#b]?/),i=t?t[0]:"C";return i[0].toUpperCase()+i.slice(1)}const bt={Major:[0,4,7],Minor:[0,3,7],"Suspended (sus)":[0,5,7],Diminished:[0,3,6]};function et(e,t,i,o){const s=X[e]??0;let r=bt[t]||bt.Major;return i==="6th"?r=[...r,9]:i==="7th (dom / m7)"?r=[...r,10]:i==="Major 7th (M7)"?r=[...r,11]:i==="9th"&&(r=[...r,10,14]),r.map(n=>xe(s+n,o))}const Xi={Major:"",Minor:"m","Suspended (sus)":"sus",Diminished:"dim"},Hi={None:"","6th":"6","7th (dom / m7)":"7","Major 7th (M7)":"maj7","9th":"9"};function Ji(e,t,i){return t==="Minor"&&i==="Major 7th (M7)"?`${e}m(maj7)`:`${e}${Xi[t]??""}${Hi[i]??""}`}const Ft=["C","D","E","F","G","A","B"],lt=10,Re=Ft.indexOf("E")+4*7,Wi=Re+4*2,tt=20,zt=tt+4*lt,Ki={C:[],G:["F#"],D:["F#","C#"],A:["F#","C#","G#"],E:["F#","C#","G#","D#"],B:["F#","C#","G#","D#","A#"],"F#":["F#","C#","G#","D#","A#","E#"],F:["Bb"],Bb:["Bb","Eb"],Eb:["Bb","Eb","Ab"],Ab:["Bb","Eb","Ab","Db"],Db:["Bb","Eb","Ab","Db","Gb"]},Qi={MAJOR:0,LYDIAN:5,MIXOLYDIAN:7,DORIAN:2,NATURAL_MINOR:9,HARMONIC_MINOR:9},Gt={};ae.forEach(e=>{Gt[X[e]]=e});function Yt(e,t){const i=Qi[t]??0,s=(((X[e]??0)-i)%12+12)%12;return Gt[s]??"C"}function Vt(e,t){return Ki[Yt(e,t)]??[]}function K(e,t){const i=Yt(e,t);return wi.has(i)||i.includes("b")}function $e(e,t){return xe(X[e]??0,K(e,t))}const wt={"F#":38,"C#":35,"G#":39,"D#":36,"A#":33,"E#":37,"B#":34,Bb:34,Eb:37,Ab:33,Db:36,Gb:32,Cb:35,Fb:31};function Zi(e){let t=4,i=-1;return e.map(o=>{const s=Ft.indexOf(o[0].toUpperCase());return i!==-1&&s<=i&&t++,i=s,s+t*7})}function te(e){return zt-(e-Re)*(lt/2)}const ue=10,ze=46,kt=26,Tt=14;function eo(e,t,i){const o=Vt(t,i),s=8,r=o.length?o.length*s+6:0,n=o.map(k=>wt[k]),a=e.map(k=>Zi(k.notes)),c=a.flat(),h=Math.min(tt,...c.map(te),...n.map(te)),f=Math.max(zt,...c.map(te),...n.map(te)),l=ue+Tt-h,m=f-h+12+ue+Tt,v=[0,1,2,3,4].map(k=>tt+k*lt+l),y=ue+kt+r,p=o.map((k,x)=>({x:ue+kt+x*s,y:te(wt[k])+l,sign:k.includes("#")?"sharp":"flat"})),b=e.map((k,x)=>{const N=y+x*ze+ze/2,P=a[x],U=P.map(u=>({x:N,y:te(u)+l})),V=[];P.forEach(u=>{(u-Re)%2===0&&(u<Re||u>Wi)&&V.push({x:N-9,y:te(u)+l})});const se=Math.min(...U.map(u=>u.y))-10;return{cx:N,name:k.name,roman:k.roman,notes:U,ledgers:V,labelY:se}});return{width:y+e.length*ze+ue,height:m,lines:v,keySignature:p,chords:b}}function to(e,t,i){const o=Ze(e.name),s=o.includes("b");return{...e,name:Ji(o,t,i),notes:et(o,t,i,s)}}function io(e,t,i){const o=t.chords[i],s=e.scales[o.scaleKey],r=Object.keys(s.degrees),n=K(t.key,t.scaleType),a=[],c=(i-1+t.chords.length)%t.chords.length,h=t.chords[c]?.degree||"TONIC",f=t.scaleType.includes("MINOR")?"MAJOR":"NATURAL_MINOR",l=`${t.key}_${f}`,m=e.scales[l],v=K(t.key,f),y=f==="NATURAL_MINOR"?["SUBMEDIANT","MEDIANT","SUBDOMINANT"]:["SUBDOMINANT","SUBMEDIANT"];if(m){const x=Fe(y,Object.keys(m.degrees),o.degree,h,t.scaleType,t.genre,t.mood);if(x){const N=ne(l,x,m,v);a.push({label:"Darker",sub:"heavier, more shadow",chord:N,functionCaption:`Borrowed · ${N.notes.join(" · ")}`,rationale:`A borrowed chord from the parallel ${f==="NATURAL_MINOR"?"minor":"major"} — it darkens the color with an unexpected shadow.`})}}else{const x=f==="NATURAL_MINOR"?Qe(t.key,8,"maj","Submediant","bVI","hold",v):Qe(t.key,5,"maj","Subdominant","IV","lift",v);a.push({label:"Darker",sub:"heavier, more shadow",chord:x,functionCaption:`Borrowed · ${x.notes.join(" · ")}`,rationale:"A borrowed chord — it darkens the color with a shadow pulled from outside the current key."})}let p=o.scaleKey,b=s;if(t.scaleType==="NATURAL_MINOR"&&Math.random()<.5){const x=`${t.key}_HARMONIC_MINOR`,N=e.scales[x];N?.degrees.DOMINANT&&(p=x,b=N)}const M=Fe(["DOMINANT","LEADING-TONE","SUPERTONIC"],Object.keys(b.degrees),o.degree,h,t.scaleType,t.genre,t.mood);if(M){const x=ne(p,M,b,n);a.push({label:"More tension",sub:"sharper pull forward",chord:x,functionCaption:`${x.functionLabel} · ${x.notes.join(" · ")}`,rationale:`Aimed at the ${x.functionLabel.toLowerCase()} — it sharpens the pull forward with extra bite.`})}const k=Fe(["SUBDOMINANT","MEDIANT","SUBMEDIANT"],r,o.degree,h,t.scaleType,t.genre,t.mood);if(k){const x=ne(o.scaleKey,k,s,n);a.push({label:"Dreamier",sub:"softer, more air",chord:x,functionCaption:`${x.functionLabel} · ${x.notes.join(" · ")}`,rationale:"Soft and airy — it floats rather than resolving."})}if(r.includes("TONIC")){const x=ne(o.scaleKey,"TONIC",s,n);a.push({label:"Resolve home",sub:"settles back to center",chord:x,functionCaption:`${x.functionLabel} · ${x.notes.join(" · ")}`,rationale:"Returns to the tonic — full resolution, the sense of arriving home."})}return a}const oo={m8:"https://warmsynths.github.io/hypersyn-chord-helper/",circuit:"https://warmsynths.github.io/circuit-chords/"},so={m8:43303,circuit:43302};function ro(e,t,i){let o=oo[t];typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(o=`http://localhost:${so[t]}/`);const r=(i&&i.length>0?i.map(n=>e.chords[n]).filter(n=>!!n):e.chords).map(n=>encodeURIComponent(n.name)).join("+");return`${o}?p=${r}`}const no=Q.map(e=>e.name),ao=["rhodes","epiano","guitar","pad-strings","bell","organ","juno-pad","stab"];function lo(e,t){const i=e.length+1,o=t.length+1,s=Array.from({length:i},()=>new Array(o).fill(0));for(let r=0;r<i;r++)s[r][0]=r;for(let r=0;r<o;r++)s[0][r]=r;for(let r=1;r<i;r++)for(let n=1;n<o;n++)s[r][n]=e[r-1]===t[n-1]?s[r-1][n-1]:1+Math.min(s[r-1][n-1],s[r-1][n],s[r][n-1]);return s[i-1][o-1]}function ie(e,t){if(typeof e!="string")return null;const i=e.trim();if(!i)return null;const o=i.toLowerCase(),s=t.find(c=>c.toLowerCase()===o);if(s)return s;let r=null,n=1/0;for(const c of t){const h=lo(o,c.toLowerCase());h<n&&(n=h,r=c)}const a=Math.max(2,Math.floor(o.length*.4));return n<=a?r:null}function co(e){if(!Array.isArray(e))return;const t=[];for(const i of e){if(!i||typeof i!="object")continue;const o=i,s=ie(o.root,ae),r=ie(o.quality,ki);s&&r&&t.push({root:s,quality:r})}if(t.length)return t.slice(0,F)}function ho(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t=e,i=ie(t.presetId,ao)??(typeof t.presetId=="string"&&t.presetId.trim()?t.presetId.trim():void 0);if(!i)return;const o=t.customConfig&&typeof t.customConfig=="object"&&!Array.isArray(t.customConfig)?t.customConfig:void 0;return{presetId:i,customConfig:o}}function Ge(e,t){const i=e&&typeof e=="object"?e:{},o=ie(i.genre,ve)??t.genre,s=ie(i.mood,no)??t.mood,r=ie(i.key,ae)??void 0,n=ie(i.scaleType,Ii)??void 0,a=r&&n?co(i.chords):void 0;let c;typeof i.length=="number"&&Number.isFinite(i.length)&&(c=Math.max(oe,Math.min(F,Math.round(i.length))));const h=typeof i.rhythmStyle=="string"&&i.rhythmStyle.trim()?i.rhythmStyle.trim():void 0,f=ho(i.instrumentConfig),l=i._rateLimit&&typeof i._rateLimit=="object"?i._rateLimit:void 0;return{genre:o,mood:s,key:r,scaleType:n,length:c,chords:a,rhythmStyle:h,instrumentConfig:f,_rateLimit:l}}const Ye=[{id:"deepseek-v4-flash-free",name:"DeepSeek V4 Flash Free",provider:"opencodeai",vendor:"DeepSeek"},{id:"mimo-v2.5-free",name:"MiMo V2.5 Free",provider:"opencodeai",vendor:"Xiaomi"},{id:"laguna-s-2.1-free",name:"Laguna S 2.1 Free",provider:"opencodeai",vendor:"Stealth"},{id:"ling-3.0-flash-free",name:"Ling-3.0-flash Free",provider:"opencodeai",vendor:"Stealth"},{id:"nemotron-3-ultra-free",name:"Nemotron 3 Ultra Free",provider:"opencodeai",vendor:"NVIDIA"},{id:"north-mini-code-free",name:"North Mini Code Free",provider:"opencodeai",vendor:"Stealth"}],Oe=[{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash-Lite",provider:"google",vendor:"Google"},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",provider:"google",vendor:"Google"},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash",provider:"google",vendor:"Google"}],qt="chroma-chords-llm-provider",Xt="chroma-chords-llm-model";function Ht(){const e=localStorage.getItem(qt);return e==="opencodeai"||e==="anthropic"||e==="openrouter"||e==="google"?e:"google"}function po(e){localStorage.setItem(qt,e)}function Jt(){const e=localStorage.getItem(Xt);return e?e==="gemini-1.5-flash"||e==="gemini-2.0-flash"||e==="gemini-2.5-flash"||e==="gemini-3.5-flash"||e==="gemini-1.5-pro"?"gemini-3.1-flash-lite":e:Oe[0].id}function Ve(e){localStorage.setItem(Xt,e)}const qe={genre:ve[0],mood:Q[0].name},Wt="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev",uo=12e3;async function go(){try{const e=await fetch(Wt);if(e.ok){const t=await e.json();if(t&&typeof t.remaining=="number")return{remaining:t.remaining,limit:t.limit,isFreeTier:t.isFreeTier}}}catch{}return null}const Kt={Uplifting:["happy","joy","bright","hope","celebrat","win","sun","morning","triumph"],Melancholy:["sad","rain","lonely","grief","loss","blue","tear","goodbye"],Dreamy:["dream","float","cloud","soft","sleep","hazy","ethereal","stars"],Tense:["fear","anxious","dark","storm","fight","chase","danger","thriller"],Warm:["cozy","home","fire","love","autumn","familiar","fireplace"],Nostalgic:["memory","childhood","old","faded","remember","summer","photo","yearbook"],Energetic:["energetic","pumped","hype","fast","running","workout","power","fire"],Dark:["dark","creepy","night","evil","shadow","gothic","gloomy"],Peaceful:["peaceful","calm","quiet","zen","relax","nature","gentle","still"],Groovy:["groovy","funky","danceable","rhythm","swing","bounce","jam"],Epic:["epic","heroic","grand","triumphant","majestic","legendary","glory"]},Qt={Pop:["pop","radio","dance","catchy","hit"],"Lo-fi/Chill":["lofi","lo-fi","study","bedroom","tape","chill","relax"],"R&B/Soul":["rnb","r&b","soul","smooth","slow jam","sultry"],"Indie/Folk":["folk","acoustic","campfire","porch","story","indie"],Synthwave:["synth","80s","neon","retro","synthwave","arcade"],"Jazz-ish":["jazz","smoky","bar","lounge","late night","saxophone"],Gospel:["gospel","church","choir","soulful","worship"],Cinematic:["movie","film","epic","trailer","scene","cinematic"],Rock:["rock","guitar","drive","loud","energy","highway"],"House/Dance":["house","edm","club","rave","four on the floor","dance floor"],Blues:["blues","12 bar","delta","chicago blues","harmonica"],"Funk/Disco":["funk","funky","groovy","disco","slap bass","boogie"],"Country/Bluegrass":["country","bluegrass","nashville","banjo","twang"],"Reggae/Dub":["reggae","dub","jamaica","ska","offbeat","roots"],Metal:["metal","heavy metal","thrash","riff","shred","headbang","metallica","megadeth","slayer","iron maiden"],Punk:["punk","garage","mosh","rebel","skate"],"Ambient/Drone":["ambient","drone","atmospheric","soundscape","meditation","space"],"Trap/Hip-Hop":["trap","hiphop","hip-hop","rap","808","beat"],"Bossa Nova/Latin":["bossa","bossa nova","samba","latin","rio","habanera"],"Classical/Orchestral":["classical","orchestra","symphony","concerto","violin","chamber"],"EDM/Trance":["trance","techno","buildup","drop","festival"],Afrobeats:["afrobeats","afropop","lagos","highlife","afro"],Shoegaze:["shoegaze","fuzz","wall of sound","dream pop","gazer"]};function Le(e,t){const i=e.toLowerCase();let o=null,s=0;return Object.keys(t).forEach(r=>{const n=t[r].reduce((a,c)=>a+(i.includes(c)?1:0),0);n>s&&(s=n,o=r)}),o}function it(e){const t=Le(e,Qt),i=Le(e,Kt);return!t||!i?null:{genre:t,mood:i}}let ct=null;function Zt(e){ct=e}function mo(){return ct}async function fo(e,t){const i=new AbortController,o=setTimeout(()=>i.abort(),uo),s=ct;try{const r={"Content-Type":"application/json"};s&&(r.Authorization=`Bearer ${s}`);const n=await fetch(Wt,{method:"POST",headers:r,body:JSON.stringify({text:e,provider:Ht(),model:Jt()}),signal:i.signal}),a=await n.json().catch(()=>null);if(!n.ok||a&&typeof a=="object"&&"error"in a){const c=a&&typeof a=="object"&&"error"in a?String(a.error):`HTTP ${n.status}`,h=new Error(`Classifier request failed: ${c}`);throw a&&typeof a=="object"&&"_rateLimit"in a&&(h._rateLimit=a._rateLimit),h}return a}finally{clearTimeout(o)}}async function ei(e,t){const i=e.trim(),o=i.toLowerCase();if(o.startsWith("mock")||o.startsWith("test")){const r=i.replace(/^(mock|test)\s*:?\s*/i,"").trim(),n=Le(r,Qt)??"Synthwave",a=Le(r,Kt)??"Dreamy",c={Metal:"stab",Rock:"guitar",Punk:"stab","Lo-fi/Chill":"epiano",Synthwave:"juno-pad","EDM/Trance":"juno-pad",Gospel:"organ","Reggae/Dub":"organ","Country/Bluegrass":"guitar","Bossa Nova/Latin":"guitar","Ambient/Drone":"pad-strings",Cinematic:"pad-strings","Classical/Orchestral":"pad-strings","Jazz-ish":"rhodes",Pop:"rhodes","R&B/Soul":"epiano"},h={Metal:"heavy_strum",Rock:"driving_strum",Punk:"fast_power_strum","Lo-fi/Chill":"slow_arpeggio",Synthwave:"retro_16th_arp","EDM/Trance":"fast_triplets",Gospel:"block_chords","Reggae/Dub":"offbeat_ska","Jazz-ish":"swing_feel","Bossa Nova/Latin":"syncopated_bossa","Ambient/Drone":"sustained_pad","Classical/Orchestral":"slow_arpeggio",Pop:"straight_8ths"},f={Metal:{key:"E",scaleType:"NATURAL_MINOR",chords:[{root:"E",quality:"min"},{root:"G",quality:"maj"},{root:"D",quality:"maj"},{root:"C",quality:"maj"},{root:"E",quality:"min"},{root:"A",quality:"min"},{root:"B",quality:"dom7"},{root:"E",quality:"min"}]},Rock:{key:"A",scaleType:"MAJOR",chords:[{root:"A",quality:"maj"},{root:"D",quality:"maj"},{root:"E",quality:"dom7"},{root:"F#",quality:"min"},{root:"D",quality:"maj"},{root:"A",quality:"maj"},{root:"E",quality:"dom7"},{root:"A",quality:"maj"}]},"Jazz-ish":{key:"F",scaleType:"DORIAN",chords:[{root:"F",quality:"min7"},{root:"A#",quality:"dom7"},{root:"D#",quality:"maj7"},{root:"G#",quality:"maj7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"min7"},{root:"F",quality:"dom7"}]},"Lo-fi/Chill":{key:"C",scaleType:"DORIAN",chords:[{root:"C",quality:"min7"},{root:"F",quality:"maj7"},{root:"A#",quality:"maj7"},{root:"D#",quality:"maj7"},{root:"C",quality:"min7"},{root:"D#",quality:"maj7"},{root:"F",quality:"min7"},{root:"G",quality:"min7"}]},Gospel:{key:"C",scaleType:"MAJOR",chords:[{root:"C",quality:"maj"},{root:"E",quality:"min7"},{root:"F",quality:"maj7"},{root:"G",quality:"dom7"},{root:"A",quality:"min7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"maj"}]},_default:{key:"F#",scaleType:"DORIAN",chords:[{root:"F#",quality:"min7"},{root:"B",quality:"maj"},{root:"C#",quality:"min7"},{root:"E",quality:"maj"},{root:"F#",quality:"min7"},{root:"A",quality:"maj7"},{root:"B",quality:"min7"},{root:"C#",quality:"dom7"}]}},l=f[n]||f._default,m=c[n]||"rhodes",v=h[n]||"slow_arpeggio",y={genre:n,mood:a,key:l.key,scaleType:l.scaleType,length:8,chords:l.chords,rhythmStyle:v,instrumentConfig:{presetId:m,customConfig:{envelope:{attack:.05,decay:.5,sustain:.6,release:1.2}}}};return Ge(y,{genre:n,mood:a})}const s=it(e);try{const r=await fo(e,t);return Ge(r,s??qe)}catch(r){console.warn("LLM classification failed, falling back to keyword heuristic:",r);const n=Ge(s??qe,qe);return r&&typeof r=="object"&&"_rateLimit"in r&&(n._rateLimit=r._rateLimit),n}}const Xe=["cc801a4c62860be6a11bbae1c7ff2a4156e4332e0cc9ed03fcb41ffe20c712e2","99c0bce064de4add7fc8e2433b627113e7d1ef63b97ad627b37194c9bace3dac"];function ge(e){return typeof window<"u"&&typeof localStorage<"u"?localStorage.getItem(e):null}function St(e,t){typeof window<"u"&&typeof localStorage<"u"&&localStorage.setItem(e,t)}function He(e){typeof window<"u"&&typeof localStorage<"u"&&localStorage.removeItem(e)}class vo{constructor(){this.driveService=new yi,this.tokenClient=null,this.userEmail=null,this.authenticated=!1,this.isDriveSyncing=!1,this.syncTimeout=null,this.syncQueued=!1,this.authStateCallbacks=new Set,this.userEmail=ge("chroma-chords-auth")||ge("chroma-chords-user")||ge("chord-voyager-auth"),this.initSilentAuth(),this.setupGoogleAuth()}getUserEmail(){return this.userEmail}isAuthenticated(){return this.authenticated}get isAdmin(){return!!(this.userEmail&&this.userEmail.toLowerCase().trim()==="warmsynthsiloveyou@gmail.com")}subscribeAuthState(t){return this.authStateCallbacks.add(t),t(this.userEmail,this.authenticated),()=>this.authStateCallbacks.delete(t)}notifyAuthState(){this.authStateCallbacks.forEach(t=>t(this.userEmail,this.authenticated))}async hashEmail(t){const o=new TextEncoder().encode(t),s=await crypto.subtle.digest("SHA-256",o);return Array.from(new Uint8Array(s)).map(n=>n.toString(16).padStart(2,"0")).join("")}initSilentAuth(){const t=ge("chroma-chords-auth")||ge("chord-voyager-auth");t&&this.hashEmail(t).then(i=>{Xe.includes(i)&&(this.authenticated=!0,this.userEmail=t,this.notifyAuthState())})}setupGoogleAuth(){if(typeof window>"u")return;const t=setInterval(()=>{window.google&&(clearInterval(t),this.tokenClient=window.google.accounts.oauth2.initTokenClient({client_id:"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com",scope:"https://www.googleapis.com/auth/drive.appdata https://www.googleapis.com/auth/userinfo.email",callback:async i=>{if(!(!i||i.error||!i.access_token))try{const o=await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${i.access_token}`}});if(!o.ok)return;const s=await o.json();if(!s?.email)return;const r=await this.hashEmail(s.email);if(!Xe.includes(r))return;this.authenticated=!0,this.userEmail=s.email,St("chroma-chords-auth",s.email),this.driveService.setAccessToken(i.access_token),this.notifyAuthState(),await this.syncProjectsFromCloud(),await this.syncProjectsToCloud()}catch(o){console.error("Silent Drive auth failed",o)}}}))},200)}async requestLogin(){return typeof window>"u"?null:(window.google?.accounts?.oauth2||await new Promise(t=>{const i=document.querySelector('script[src="https://accounts.google.com/gsi/client"]');if(i){i.addEventListener("load",()=>t(),{once:!0}),setTimeout(t,3e3);return}const o=document.createElement("script");o.src="https://accounts.google.com/gsi/client",o.async=!0,o.onload=()=>t(),o.onerror=()=>t(),document.head.appendChild(o)}),window.google?.accounts?.oauth2?new Promise(t=>{try{this.tokenClient||(this.tokenClient=window.google.accounts.oauth2.initTokenClient({client_id:"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com",scope:"https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/drive.appdata",callback:async i=>{if(i?.access_token){this.driveService.setAccessToken(i.access_token),Zt(i.access_token);const s=await(await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${i.access_token}`}}).catch(()=>null))?.json().catch(()=>null);if(!s?.email){t(null);return}const r=await this.hashEmail(s.email);if(!Xe.includes(r)){t(null);return}const n=s.email;St("chroma-chords-auth",n),this.userEmail=n,this.authenticated=!0,this.notifyAuthState(),await this.syncProjectsFromCloud(),t(n);return}t(null)}})),this.tokenClient.requestAccessToken()}catch(i){console.warn("Google Identity Services request failed:",i),t(null)}}):null)}logout(){He("chroma-chords-auth"),He("chroma-chords-user"),He("chord-voyager-auth"),this.userEmail=null,this.authenticated=!1,this.notifyAuthState()}getProjects(){return H.getProjects()}saveProject(t){H.saveProject(t)}async deleteProject(t){H.deleteProject(t),this.scheduleCloudSync()}async syncProjectsFromCloud(){if(!(this.isDriveSyncing||!this.driveService.hasAccessToken())){this.isDriveSyncing=!0;try{const t=await this.driveService.loadProjects();if(t){t.forEach(s=>s.syncedToCloud=!0);const i=H.getProjects(),o=H.mergeProjects(i,t);H.setProjects(o)}}catch(t){console.error("Failed to sync from cloud",t)}finally{this.isDriveSyncing=!1}}}scheduleCloudSync(){this.syncTimeout&&clearTimeout(this.syncTimeout),this.syncTimeout=setTimeout(()=>{this.syncTimeout=null,this.isDriveSyncing?this.syncQueued=!0:this.syncProjectsToCloud()},2e3)}async syncProjectsToCloud(){if(!(!this.authenticated||!this.driveService.hasAccessToken()||this.isDriveSyncing)){this.isDriveSyncing=!0;try{const t=H.getProjects();await this.driveService.saveProjects(t),t.forEach(i=>i.syncedToCloud=!0),H.setProjects(t)}catch(t){console.error("Failed to sync to cloud",t)}finally{this.isDriveSyncing=!1,this.syncQueued&&(this.syncQueued=!1,this.scheduleCloudSync())}}}}const j=new vo,ee=new Ot({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination(),yo=new ci({urls:{F1:"A_029__F1_5.m4a",B1:"A_035__B1_5.m4a",E2:"A_040__E2_5.m4a",A2:"A_045__A2_5.m4a",D3:"A_050__D3_5.m4a",G3:"A_055__G3_5.m4a",B3:"A_059__B3_5.m4a",D4:"A_062__D4_5.m4a",F4:"A_065__F4_5.m4a",B4:"A_071__B4_5.m4a",E5:"A_076__E5_5.m4a",A5:"A_081__A5_5.m4a",D6:"A_086__D6_5.m4a",G6:"A_091__G6_5.m4a"},baseUrl:"https://danigb.github.io/samples/jlearman/rhodes-mki/jRhodes3d-mono/",volume:-12,onload:()=>{console.log("Rhodes piano sampler loaded successfully!")},onerror:e=>{console.warn("Failed to load Rhodes piano sampler:",e)}}).connect(ee),xo=new L(W,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(ee),bo=new Dt({decay:4.5,wet:.35}).connect(ee),wo=new L(W,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(bo),ko=new Pt({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).start().connect(ee),To=new L(W,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(ko),So=new L(Bt,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(ee),Io=new L(fe,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(ee),Ao=new L(W,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(ee),No=new L(fe,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(ee);function Mo(e){switch(e){case"organ":return xo;case"pad-strings":return wo;case"juno-pad":return To;case"stab":return So;case"epiano":return Io;case"guitar":return Ao;case"bell":return No;case"rhodes":default:return yo}}const le=[{name:"Piano",instrument:"rhodes",color:"#9CC0EC"},{name:"Rhodes",instrument:"epiano",color:"#F2A79B"},{name:"Nylon Guitar",instrument:"guitar",color:"#F6D98B"},{name:"Warm Pad",instrument:"pad-strings",color:"#C9A9E0"},{name:"Synth Bell",instrument:"bell",color:"#B8CC9E"},{name:"Drawbar Organ",instrument:"organ",color:"#E8609A"},{name:"Analog Synth",instrument:"juno-pad",color:"#7B61FF"},{name:"Synth Stab",instrument:"stab",color:"#FF8C42"}],ce=[{name:"Block chords",color:"#F2A79B",patch:{arpMode:"off",spread:.3}},{name:"Arpeggio",color:"#9CC0EC",patch:{arpMode:"up",arpRate:"1/8",arpRange:1}},{name:"Strum",color:"#F6D98B",patch:{arpMode:"up",arpRate:"1/32",arpRange:1}},{name:"Broken (swing)",color:"#C9A9E0",patch:{arpMode:"up",arpRate:"1/8T",arpRange:1}},{name:"Half-time",color:"#B8CC9E",patch:{arpMode:"off",spread:.1,durationMultiplier:1.8}},{name:"Descending Arp",color:"#7B61FF",patch:{arpMode:"down",arpRate:"1/8",arpRange:1}},{name:"Off-beat / Ska",color:"#FF8C42",patch:{arpMode:"off",spread:.1,microTiming:.8}},{name:"Fast Triplet",color:"#7CD9B6",patch:{arpMode:"up",arpRate:"1/16T",arpRange:1}}],dt={Pop:"rhodes",Rock:"rhodes","Indie/Folk":"rhodes","Lo-fi/Chill":"rhodes","Jazz-ish":"rhodes","R&B/Soul":"rhodes",Gospel:"organ",Cinematic:"pad-strings",Synthwave:"juno-pad","House/Dance":"stab",Blues:"rhodes","Funk/Disco":"epiano","Country/Bluegrass":"guitar","Reggae/Dub":"organ",Metal:"stab",Punk:"stab","Ambient/Drone":"pad-strings","Trap/Hip-Hop":"epiano","Bossa Nova/Latin":"guitar","Classical/Orchestral":"pad-strings","EDM/Trance":"juno-pad",Afrobeats:"epiano",Shoegaze:"pad-strings"},ht={Pop:{minVelocity:90,maxVelocity:110,spread:.5,microTiming:.3,humanVariance:.3,duration:1},Rock:{minVelocity:105,maxVelocity:127,spread:.2,microTiming:.1,humanVariance:.15,duration:.9},"Indie/Folk":{minVelocity:80,maxVelocity:105,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},"Lo-fi/Chill":{minVelocity:55,maxVelocity:85,spread:2.5,microTiming:1.2,humanVariance:.8,duration:1.4,arpMode:"up",arpRate:"1/8",arpRange:1},"Jazz-ish":{minVelocity:70,maxVelocity:100,spread:1.8,microTiming:1,humanVariance:.6,duration:1.2,arpMode:"up",arpRate:"1/8T",arpRange:1},"R&B/Soul":{minVelocity:75,maxVelocity:105,spread:1.2,microTiming:.6,humanVariance:.5,duration:1.3},Gospel:{minVelocity:95,maxVelocity:120,spread:.4,microTiming:.2,humanVariance:.2,duration:1.5},Cinematic:{minVelocity:60,maxVelocity:90,spread:0,microTiming:0,humanVariance:.1,duration:2.2},Synthwave:{minVelocity:70,maxVelocity:95,spread:0,microTiming:0,humanVariance:.1,duration:1.8},"House/Dance":{minVelocity:100,maxVelocity:127,spread:0,microTiming:.1,humanVariance:.15,duration:.5},Blues:{minVelocity:80,maxVelocity:110,spread:1.4,microTiming:.7,humanVariance:.5,duration:1.2},"Funk/Disco":{minVelocity:95,maxVelocity:125,spread:.3,microTiming:.2,humanVariance:.2,duration:.8},"Country/Bluegrass":{minVelocity:85,maxVelocity:115,spread:1,microTiming:.4,humanVariance:.3,duration:1},"Reggae/Dub":{minVelocity:70,maxVelocity:100,spread:2,microTiming:1,humanVariance:.6,duration:1.3},Metal:{minVelocity:110,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:.8},Punk:{minVelocity:115,maxVelocity:127,spread:.1,microTiming:.1,humanVariance:.1,duration:.7},"Ambient/Drone":{minVelocity:45,maxVelocity:75,spread:0,microTiming:0,humanVariance:.05,duration:3},"Trap/Hip-Hop":{minVelocity:90,maxVelocity:120,spread:.2,microTiming:.2,humanVariance:.2,duration:1},"Bossa Nova/Latin":{minVelocity:75,maxVelocity:105,spread:1.5,microTiming:.8,humanVariance:.5,duration:1.1,arpMode:"up",arpRate:"1/8T",arpRange:1},"Classical/Orchestral":{minVelocity:50,maxVelocity:115,spread:.5,microTiming:.3,humanVariance:.3,duration:2},"EDM/Trance":{minVelocity:95,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:1.2},Afrobeats:{minVelocity:85,maxVelocity:115,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},Shoegaze:{minVelocity:65,maxVelocity:95,spread:.8,microTiming:.4,humanVariance:.3,duration:2.5}},Co={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Warm Pad",bell:"Synth Bell",organ:"Piano",stab:"Nylon Guitar"};function De(e){const t=dt[e]??"rhodes";return Co[t]??"Piano"}function Pe(e){return(ht[e]?.arpMode??"off")==="off"?"Block chords":"Arpeggio"}function Eo(){return Promise.race([pi(),new Promise(e=>setTimeout(e,3e3))])}function ti(e,t){const i=t/60;switch(e){case"1/4":return 1/i;case"1/8":return .5/i;case"1/8T":return .5/i*(2/3);case"1/16":return .25/i;case"1/32":return .125/i;default:return .25/i}}function ii(e,t){const i=[];for(let o=0;o<t;o++)for(const s of e){const r=s.match(/^([A-G]#?)(-?\d+)$/);if(r){const n=r[1],a=parseInt(r[2],10)+o;i.push(`${n}${a}`)}else i.push(s)}return i}function oi(e,t){const i=[...e];switch(t){case"up":return i;case"down":return[...i].reverse();case"up-down":return[...i,...[...i].reverse().slice(1,-1)];case"random":return i.sort(()=>Math.random()-.5);default:return i}}const It={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Analog Synth",bell:"Synth Bell",organ:"Drawbar Organ",stab:"Synth Stab"};function $o(e){if(!e)return;const t=e.toLowerCase().trim();return It[t]?It[t]:le.find(o=>o.name.toLowerCase()===t||o.instrument.toLowerCase()===t)?.name}function Oo(e){if(!e)return;const t=e.toLowerCase().trim();return t.includes("strum")?"Strum":t.includes("descend")?"Descending Arp":t.includes("half")?"Half-time":t.includes("swing")||t.includes("broken")?"Broken (swing)":t.includes("offbeat")||t.includes("ska")||t.includes("syncopat")||t.includes("groove")?"Off-beat / Ska":t.includes("triplet")||t.includes("fast")?"Fast Triplet":t.includes("arp")||t.includes("cascade")?"Arpeggio":t.includes("block")||t.includes("pad")||t.includes("sustained")?"Block chords":ce.find(o=>o.name.toLowerCase()===t)?.name??"Block chords"}function Do(e,t=.7,i,o="rhodes",s){try{Promise.all([di(),Eo()]).then(()=>{const r=Mo(o);if(s&&typeof s=="object"&&Object.keys(s).length>0)try{typeof r.set=="function"&&r.set(s)}catch(h){console.warn("Failed to apply customConfig to Tone.js instrument:",h)}const n=e.length,a=n<=1?1:Math.max(.4,1/Math.sqrt(n)),c=hi();if(i&&i.arpMode&&i.arpMode!=="off"){const h=i.bpm??80,f=i.arpRate??"1/16",l=i.arpRange??1,m=i.arpMode,v=ti(f,h),y=ii(e,l),p=oi(y,m),b=()=>i.minVelocity!==void 0&&i.maxVelocity!==void 0?(i.minVelocity+Math.random()*(i.maxVelocity-i.minVelocity))/127*a:a,M=i.duration?i.duration*(1+(Math.random()-.5)*.1*(i.humanVariance??0)):Math.max(.05,v*.9);p.forEach((k,x)=>{const N=i.microTiming?(Math.random()-.5)*i.microTiming*.02:0;r.triggerAttackRelease(k,M,c+x*v+N,b())});return}e.forEach((h,f)=>{let l=0,m=a,v=t;if(i){const{minVelocity:y,maxVelocity:p,spread:b,microTiming:M,humanVariance:k,duration:x}=i;m=(y+Math.random()*(p-y))/127*a;const P=f*b*.1,U=(Math.random()-.5)*M*.05,V=(Math.random()-.5)*k*.03;l=Math.max(0,P+U+V),v=x*(1+(Math.random()-.5)*.2*k)}r.triggerAttackRelease(h,v,c+l,m)})}).catch(r=>{console.warn("Audio playback gesture failed:",r)})}catch(r){console.warn("Audio playback failed:",r)}}function At(e,t,i){const o=t==="Unknown"||!t?"Pop":t,s=i?.instrument?le.find(m=>m.name===i.instrument):void 0,r=i?.playStyle?ce.find(m=>m.name===i.playStyle):void 0,n=s?.instrument??dt[o]??"rhodes",a=ht[o]||{},c=r?.patch??{},h={...a,...c,bpm:i?.bpm??a.bpm??90},f=i?.duration??a.duration??.9,l=c.durationMultiplier?f*c.durationMultiplier:f;Do(e,l,h,n,i?.customConfig)}class Po{constructor(){this.mode="single",this.progression=null,this.order=[],this.sections=[],this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.playing=!1,this.instrument=null,this.playStyle=null,this.autoplayTimer=null,this.tickCallbacks=new Set}setProgression(t,i){this.mode="single",this.progression=t,t?this.order=i||Array.from({length:t.chords.length},(o,s)=>s):this.order=[]}setSong(t){this.mode="song",this.sections=t,this.songStep=0,this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}isSongMode(){return this.mode==="song"}getActiveSectionIndex(){return this.activeSectionIndex}getTotalSteps(){return this.mode==="song"?this.sections.reduce((t,i)=>t+i.order.length,0):this.order.length}setOrder(t,i){this.order=t,typeof i=="number"&&(this.activeIndex=i)}setInstrument(t){this.instrument=t}setPlayStyle(t){this.playStyle=t}isPlaying(){return this.playing}getActiveIndex(){return this.activeIndex}getProgressStep(){return this.mode==="song"?this.songStep:this.progressStep}subscribeTick(t){return this.tickCallbacks.add(t),()=>this.tickCallbacks.delete(t)}notifyTick(){const t=this.getTotalSteps();this.mode==="song"?this.tickCallbacks.forEach(i=>i(this.activeIndex,this.songStep,this.activeSectionIndex,t,!0)):this.tickCallbacks.forEach(i=>i(this.activeIndex,this.progressStep,0,t,!1))}updateSongStepState(t){let i=0;for(let o=0;o<this.sections.length;o++){const s=this.sections[o].order.length;if(t<i+s){this.activeSectionIndex=o;const r=t-i;this.activeIndex=this.sections[o].order[r]??0,this.progressStep=r;return}i+=s}this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}startAutoplay(){this.stopAutoplay(),this.autoplayTimer=setInterval(()=>{if(this.playing){if(this.mode==="song"){const t=this.getTotalSteps();if(t<=0)return;this.songStep=(this.songStep+1)%t,this.updateSongStepState(this.songStep)}else{if(!this.progression||this.order.length<=0)return;this.activeIndex=(this.activeIndex+1)%this.order.length,this.progressStep=(this.progressStep+1)%this.order.length}this.playActiveChord(),this.notifyTick()}},rt)}stopAutoplay(){this.autoplayTimer&&(clearInterval(this.autoplayTimer),this.autoplayTimer=null)}togglePlay(){return this.playing?(this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.stopAutoplay(),this.notifyTick()):(this.playing=!0,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.mode==="song"&&this.sections.length>0&&this.updateSongStepState(0),this.startAutoplay(),this.playActiveChord(),this.notifyTick()),this.playing}playActiveChord(){if(this.mode==="song"){const t=this.sections[this.activeSectionIndex];if(!t)return;const i=this.activeIndex,o=t.progression.chords[i];if(o){const r=(o.notes&&o.notes.length>0?o.notes:Ce(o.name,K(t.progression.key,t.progression.scaleType))).map(n=>`${n}4`);At(r,t.progression.genre,{bpm:t.progression.bpm,duration:1.2,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0})}}else{if(!this.progression)return;const t=this.order[this.activeIndex]??0,i=this.progression.chords[t];if(i){let o=Array.isArray(i.notes)?i.notes:[];if(o.length===0||!o.every(s=>typeof s=="string"&&s.trim().length>0)){const s=i.name||"CMAJ",r=this.progression.key||"C",n=this.progression.scaleType||"MAJOR";o=Ce(s,K(r,n))}this.playChordNotes(o,1.2)}}}playChordAtIndex(t,i=.8){if(!this.progression||!this.progression.chords[t])return;const o=this.progression.chords[t];let s=Array.isArray(o.notes)?o.notes:[];if(s.length===0||!s.every(r=>typeof r=="string"&&r.trim().length>0)){const r=o.name||"CMAJ",n=this.progression.key||"C",a=this.progression.scaleType||"MAJOR";s=Ce(r,K(n,a))}this.playChordNotes(s,i)}playChordNotes(t,i){if(!this.progression)return;const o=Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.trim().length>0):[];if(o.length===0)return;const r=o.map(n=>n.replace(/\d+$/,"")).map(n=>`${n}4`);At(r,this.progression.genre||"Unknown",{bpm:this.progression.bpm||120,duration:i||.8,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0})}reset(){this.stopAutoplay(),this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.notifyTick()}}const I=new Po;class Bo{static setGoogleToken(t){Zt(t)}static getGoogleToken(){return mo()}static async resolvePrompt(t,i,o,s,r,n){let a=n||null,c=null,h=null;if(!a&&r&&r.trim().length>0)try{a=await ei(r)}catch(m){console.warn("Failed to classify prompt via LLM/local fallback:",m)}const f=!!(a&&a.chords?.length&&a.key&&a.scaleType);let l=null;return f&&a&&a.chords&&a.key&&a.scaleType&&(l=Vi(t,a.key,a.scaleType,a.chords,a.genre||i,a.mood||o)),l||(l=jt(t,i,o,{length:s})),f&&a&&(a.instrumentConfig?.presetId&&(c=$o(a.instrumentConfig.presetId)??null),a.rhythmStyle&&(h=Oo(a.rhythmStyle)??null)),l.chords.length>s&&(l={...l,chords:l.chords.slice(0,s)}),r&&(l={...l,searchTerm:r}),{progression:l,instrument:c,playStyle:h,normalizedSuggestion:a}}}const me=[{name:"Verse",desc:"Settled, familiar.",reorder:e=>Array.from({length:e},(t,i)=>i)},{name:"Chorus",desc:"Brighter, opens the key up.",reorder:e=>Array.from({length:e},(t,i)=>(i+Math.ceil(e/2))%e)},{name:"Pre-chorus",desc:"Leans in, sets up the turn.",reorder:e=>Array.from({length:e},(t,i)=>(i+1)%e)},{name:"Bridge",desc:"Detours, borrows a shadow chord.",reorder:e=>Array.from({length:e},(t,i)=>e-1-i)},{name:"Outro",desc:"Settles back down.",reorder:e=>Array.from({length:e},(t,i)=>(i-1+e)%e)}];class Ae{static createInitialSong(t,i){const o=i||Array.from({length:t.chords.length},(s,r)=>r);return[{name:me[0].name,desc:me[0].desc,progression:t,order:o.slice()}]}static addSection(t,i){if(t.length>=me.length)return{sections:t,activeIndex:t.length-1};const o=me[t.length],s=o.reorder(i.chords.length),r={name:o.name,desc:o.desc,progression:i,order:s},n=[...t,r];return{sections:n,activeIndex:n.length-1}}static syncActiveSection(t,i,o,s){if(!t[i])return t;const r=[...t];return r[i]={...r[i],progression:o,order:s.slice()},r}}var _o=Object.defineProperty,Ro=Object.getOwnPropertyDescriptor,pt=(e,t,i,o)=>{for(var s=o>1?void 0:o?Ro(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&_o(t,i,s),s};const ot=["bean","bird","cat","note"];function be(e=.45){return{show:Math.random()<e,kind:ot[Math.floor(Math.random()*ot.length)]}}function we(e){return e[Math.floor(Math.random()*e.length)]}class ut{constructor(t=7,i=1800){this.threshold=t,this.windowMs=i,this.count=0,this.lastClickAt=0}click(){const t=Date.now();return t-this.lastClickAt>this.windowMs&&(this.count=0),this.lastClickAt=t,this.count+=1,this.count>=this.threshold?(this.count=0,!0):!1}}const Lo={bean:{width:92,height:86},bird:{width:88,height:88},cat:{width:90,height:88},note:{width:74,height:67}};let ke=class extends G{constructor(){super(...arguments),this.kind="bean",this.scale=1}willUpdate(e){if(e.has("kind")||e.has("scale")){const{width:t,height:i}=Lo[this.kind];this.style.width=`${t*this.scale}px`,this.style.height=`${i*this.scale}px`}}renderBean(){const e="#D98A54";return d`
    ...
    `}render(){const e=this.kind==="bird"?this.renderBird():this.kind==="cat"?this.renderCat():this.kind==="note"?this.renderNote():this.renderBean();return e?d`<div style="transform:scale(${this.scale}); transform-origin:top left;">${e}</div>`:_t}};ke.styles=z`
    :host {
      display: block;
      pointer-events: none;
      user-select: none;
  ...
  `;pt([w({type:String})],ke.prototype,"kind",2);pt([w({type:Number})],ke.prototype,"scale",2);ke=pt([Y("mascot-character")],ke);var Uo=Object.defineProperty,jo=Object.getOwnPropertyDescriptor,gt=(e,t,i,o)=>{for(var s=o>1?void 0:o?jo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Uo(t,i,s),s};const st=3200;let Te=class extends G{constructor(){super(...arguments),this.trigger=0,this.visible=!1,this.hideTimer=null}updated(e){e.has("trigger")&&this.trigger>0&&(this.visible=!0,this.hideTimer&&clearTimeout(this.hideTimer),this.hideTimer=setTimeout(()=>{this.visible=!1},st))}disconnectedCallback(){super.disconnectedCallback(),this.hideTimer&&clearTimeout(this.hideTimer)}render(){return this.visible?d`
      <div class="caption">✨ you found the whole gang! ✨</div>
      <div class="overlay">
        <div class="row">
          ${ot.map(e=>d`<mascot-character .kind=${e} .scale=${.5}></mascot-character>`)}
        </div>
      </div>
    `:_t}};Te.styles=z`
    :host {
    ...
    .overlay {
      ...
      gap: 10px;
      pointer-events: none;
      animation: egg-pop ${st}ms ease forwards;
    }
    .caption {
      position: fixed;
      left: 50%;
      ...
      border-radius: 100px;
      white-space: nowrap;
      animation: egg-caption-pop ${st}ms ease forwards;
    }
    .row {
      display: flex;
        ...
        <div class="content">
          ...
          <div class="vibe-input-shell">
            ...
            <div class="vibe-input-wrap">
              ...
              <input
                ...
                placeholder=${Nt[this.placeholderIdx]}
              />
              ${this.isAdmin?d`
                <button class="vibe-admin-btn" @click=${()=>{this.showAdminModal=!0}} title="AI Model Configuration">
                  ⚡ ${this.currentProvider==="google"?`Google AI (${Oe.find(l=>l.id===this.currentModel)?.name||"Gemini"})`:this.currentProvider==="opencodeai"?`OpenCode AI (${Ye.find(l=>l.id===this.currentModel)?.name||"DeepSeek V4"})`:this.currentProvider==="anthropic"?"Claude":this.remainingRequests!==null?`OpenRouter (${this.remainingRequests} left)`:"OpenRouter"}
                </button>
              `:""}
            </div>
          </div>
          ${this.isClassifying?d`
            <div class="suggestion-wrap">
              <div class="suggestion-note loading">✨ ${Ne[this.loadingMsgIdx]}</div>
            </div>
          `:f?d`
            <div class="suggestion-wrap">
          ...
          <div class="pill-grid">
            ${o.map(l=>{const m=ve.indexOf(l);return d`
  ...
  `;$([w({type:String})],E.prototype,"genre",2);$([w({type:String})],E.prototype,"mood",2);$([w({type:Number})],E.prototype,"length",2);$([g()],E.prototype,"freeText",2);$([g()],E.prototype,"placeholderIdx",2);$([g()],E.prototype,"llmSuggestion",2);$([g()],E.prototype,"llmResolved",2);$([g()],E.prototype,"classifyError",2);$([g()],E.prototype,"expandedGenre",2);$([g()],E.prototype,"expandedMood",2);$([g()],E.prototype,"mascot",2);$([g()],E.prototype,"mascotSlot",2);$([g()],E.prototype,"peekMascot",2);$([g()],E.prototype,"peekSide",2);$([w({type:Boolean})],E.prototype,"isAuthenticated",2);$([w({type:Boolean})],E.prototype,"isAdmin",2);$([g()],E.prototype,"currentProvider",2);$([g()],E.prototype,"currentModel",2);$([g()],E.prototype,"showAdminModal",2);$([g()],E.prototype,"isClassifying",2);$([g()],E.prototype,"loadingMsgIdx",2);$([g()],E.prototype,"remainingRequests",2);$([g()],E.prototype,"paradeTrigger",2);E=$([Y("seed-screen")],E);var Jo=Object.defineProperty,Wo=Object.getOwnPropertyDescriptor,R=(e,t,i,o)=>{for(var s=o>1?void 0:o?Wo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Jo(t,i,s),s};const Ko=["C","D","E","F","G","A","B"],Qo=[{note:"C#",flat:"Db",left:"10%"},{note:"D#",flat:"Eb",left:"24.2857%"},{note:"F#",flat:"Gb",left:"52.857%"},{note:"G#",flat:"Ab",left:"67.1428%"},{note:"A#",flat:"Bb",left:"81.4285%"}],Zo=[{label:"Major",sub:"bright"},{label:"Minor",sub:"warm"},{label:"Suspended (sus)",sub:"floating"},{label:"Diminished",sub:"unstable"}],es=[{label:"None",sub:"triad only"},{label:"6th",sub:"soft lift"},{label:"7th (dom / m7)",sub:"classic tension"},{label:"Major 7th (M7)",sub:"lush, jazzy"},{label:"9th",sub:"wide, colorful"}];let _=class extends G{constructor(){super(...arguments),this.alternatives=[],this.showTheory=!1,this.moodColor="#9B7CA8",this.position=0,this.total=4,this.mode="swap",this.visible=!1,this.resetKey=null,this.quality="Major",this.extension="None",this.dragY=0,this.dragging=!1,this.snapping=!1,this.dragStartY=0,this.dragStartTime=0,this.onGrabberDown=e=>{e.preventDefault(),this.dragStartY=e.clientY,this.dragStartTime=performance.now(),this.dragging=!0,this.snapping=!1,this.dragY=0},this.onGrabberMove=e=>{this.dragging&&(this.dragY=Math.max(0,e.clientY-this.dragStartY))},this.onGrabberUp=()=>{if(!this.dragging)return;this.dragging=!1;const e=Math.max(1,performance.now()-this.dragStartTime),t=this.dragY/e,i=this.sheetEl?.getBoundingClientRect().height||400,o=this.dragY>i*.3||t>.6;this.snapping=!0,o?(this.dragY=i+80,setTimeout(()=>{this.close()},260)):(this.dragY=0,setTimeout(()=>{this.snapping=!1},260))}}connectedCallback(){super.connectedCallback(),window.addEventListener("pointermove",this.onGrabberMove),window.addEventListener("pointerup",this.onGrabberUp),window.addEventListener("pointercancel",this.onGrabberUp)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointermove",this.onGrabberMove),window.removeEventListener("pointerup",this.onGrabberUp),window.removeEventListener("pointercancel",this.onGrabberUp)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}close(){this.emit("close")}onSheetBackgroundClick(e){e.target===e.currentTarget&&this.close()}setQuality(e){this.quality=e,this.previewVoicing(),this.commitVoicing()}setExtension(e){this.extension=e,this.previewVoicing(),this.commitVoicing()}previewVoicing(){const e=Ze(this.chord.name),t=e.includes("b"),i=et(e,this.quality,this.extension,t);this.emit("voicing-preview",i)}commitVoicing(){this.emit("voicing-change",{quality:this.quality,extension:this.extension})}willUpdate(e){e.has("resetKey")&&(this.quality="Major",this.extension="None")}render(){const e=this.chord,t=Ze(e.name),i=t.includes("b"),o=this.mode==="voicing"?et(t,this.quality,this.extension,i):e.notes,s=_e(e.tension),r=this.dragging||this.snapping?`transform: translateY(${this.dragY}px); transition: ${this.dragging?"none":"transform .26s cubic-bezier(.32,.72,0,1)"};`:"";return d`
      ...
      <div class="sheet ${this.visible?"visible":""}" style=${r} @pointerdown=${this.onSheetBackgroundClick}>
        ...
        ${this.mode==="swap"?d`
          <div class="alt-list">
            ${this.alternatives.map(n=>{const a=_e(n.chord.tension),c=Math.round(a.size*.4);return d`
  ...
  `;R([w({type:Object})],_.prototype,"chord",2);R([w({type:Array})],_.prototype,"alternatives",2);R([w({type:Boolean})],_.prototype,"showTheory",2);R([w({type:String})],_.prototype,"moodColor",2);R([w({type:Number})],_.prototype,"position",2);R([w({type:Number})],_.prototype,"total",2);R([w({type:String})],_.prototype,"mode",2);R([w({type:Boolean})],_.prototype,"visible",2);R([w({type:Number})],_.prototype,"resetKey",2);R([g()],_.prototype,"quality",2);R([g()],_.prototype,"extension",2);R([g()],_.prototype,"dragY",2);R([g()],_.prototype,"dragging",2);R([g()],_.prototype,"snapping",2);R([Rt(".sheet")],_.prototype,"sheetEl",2);_=R([Y("swap-sheet")],_);var ts=Object.defineProperty,is=Object.getOwnPropertyDescriptor,si=(e,t,i,o)=>{for(var s=o>1?void 0:o?is(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&ts(t,i,s),s};const os=J`
...
`,rs=[{device:"m8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:os},{device:"circuit",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:ss}];let Ue=class extends G{constructor(){super(...arguments),this.visible=!1}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}render(){return d`
  ...
  `;si([w({type:Boolean})],Ue.prototype,"visible",2);Ue=si([Y("share-modal")],Ue);function Ct(e){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=e.match(/^([A-Ga-g][#b]?)(-?\d+)?$/);if(!i)return 60;const o=i[1].charAt(0).toUpperCase()+i[1].slice(1),s=t[o]??0,r=i[2]!==void 0?parseInt(i[2],10):4;return Math.min(127,Math.max(0,(r+1)*12+s))}function ri(e,t,i){const o=t&&t.length>0?t.map(v=>e.chords[v]).filter(v=>!!v):e.chords,s=e.bpm||120,r=1.7,n=i?ce.find(v=>v.name.toLowerCase()===i.toLowerCase()):void 0,a=ht[e.genre]||{},c=n?.patch??{},h={...a,...c},f=a.duration??.9,l=c.durationMultiplier?f*c.durationMultiplier:f,m=[];return o.forEach((v,y)=>{const p=y*r,M=(v.notes&&v.notes.length>0?v.notes:["C","E","G"]).map(k=>`${k}4`);if(h.arpMode&&h.arpMode!=="off"){const k=h.arpRate??"1/16",x=h.arpRange??1,N=h.arpMode,P=ti(k,s),U=ii(M,x),V=oi(U,N),he=h.duration?h.duration:Math.max(.6,l);V.forEach((se,u)=>{const B=p+u*P;m.push({note:se,midi:Ct(se),startTime:B,duration:he})})}else{const k=h.spread??0;M.forEach((x,N)=>{const P=N*k*.1,U=p+P;m.push({note:x,midi:Ct(x),startTime:U,duration:l})})}}),m}function ns(e){const t=[];let i=Math.max(0,Math.floor(e));for(t.push(i&127);(i>>=7)>0;)t.unshift(i&127|128);return t}function as(e,t,i){const o=e.bpm||120,s=480,r=ri(e,t,i),n=[];r.forEach(p=>{const b=Math.round(p.startTime/(60/o)*s),M=Math.max(1,Math.round(p.duration/(60/o)*s));n.push({tick:b,type:"on",midi:p.midi}),n.push({tick:b+M,type:"off",midi:p.midi})}),n.sort((p,b)=>p.tick!==b.tick?p.tick-b.tick:p.type!==b.type?p.type==="off"?-1:1:p.midi-b.midi);const a=[],c=Math.round(6e7/o);a.push(0),a.push(255,81,3),a.push(c>>16&255,c>>8&255,c&255);const h="Chroma Chords";a.push(0),a.push(255,3,h.length);for(let p=0;p<h.length;p++)a.push(h.charCodeAt(p));let f=0;n.forEach(p=>{const b=p.tick-f;f=p.tick,a.push(...ns(b)),p.type==="on"?a.push(144,p.midi,80):a.push(128,p.midi,0)}),a.push(0),a.push(255,47,0);const l=[77,84,104,100,0,0,0,6,0,0,0,1,s>>8&255,s&255],m=a.length,v=[77,84,114,107,m>>24&255,m>>16&255,m>>8&255,m&255],y=new Uint8Array(l.length+v.length+a.length);return y.set(l,0),y.set(v,l.length),y.set(a,l.length+v.length),y}function ls(e,t,i,o){const s=as(e,t,o),r=new Blob([s],{type:"audio/midi"}),n=(e.key||"C").toLowerCase(),a=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),c=e.bpm||120,h=`chroma-chords-${n}-${a}-${c}bpm.mid`;ni(r,h)}function cs(e,t){const i=new Ot({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination();switch((e?le.find(r=>r.name.toLowerCase()===e.toLowerCase()):void 0)?.instrument??(t?dt[t]:void 0)??"rhodes"){case"bell":return new L(fe,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(i);case"epiano":return new L(fe,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(i);case"guitar":return new L(W,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(i);case"organ":return new L(W,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(i);case"pad-strings":{const r=new Dt({decay:4.5,wet:.35}).connect(i);return new L(W,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(r)}case"juno-pad":{const r=new Pt({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).start().connect(i);return new L(W,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(r)}case"stab":return new L(Bt,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(i);case"rhodes":default:return new L(fe,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-12}).connect(i)}}function ds(e){const t=e.numberOfChannels,i=e.sampleRate,o=16,s=o/8,r=t*s,n=e.length*t*s,a=new ArrayBuffer(44+n),c=new DataView(a),h=(m,v)=>{for(let y=0;y<v.length;y++)c.setUint8(m+y,v.charCodeAt(y))};h(0,"RIFF"),c.setUint32(4,36+n,!0),h(8,"WAVE"),h(12,"fmt "),c.setUint32(16,16,!0),c.setUint16(20,1,!0),c.setUint16(22,t,!0),c.setUint32(24,i,!0),c.setUint32(28,i*r,!0),c.setUint16(32,r,!0),c.setUint16(34,o,!0),h(36,"data"),c.setUint32(40,n,!0);const f=[];for(let m=0;m<t;m++)f.push(e.getChannelData(m));let l=44;for(let m=0;m<e.length;m++)for(let v=0;v<t;v++){const y=Math.max(-1,Math.min(1,f[v][m])),p=y<0?y*32768:y*32767;c.setInt16(l,p,!0),l+=2}return new Blob([new Uint8Array(a)],{type:"audio/wav"})}async function hs(e,t,i,o){const s=ri(e,t,o);if(!s.length)return;const n=s.reduce((v,y)=>Math.max(v,y.startTime+y.duration),0)+1.2,a=await ui(async()=>{const v=cs(i,e.genre);s.forEach(y=>{v.triggerAttackRelease(y.note,y.duration,y.startTime)})},n),c=ds(a.get()),h=(e.key||"C").toLowerCase(),f=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),l=e.bpm||120,m=`chroma-chords-${h}-${f}-${l}bpm.wav`;ni(c,m)}function ni(e,t){if(typeof URL>"u"||typeof URL.createObjectURL!="function")return;const i=URL.createObjectURL(e);if(typeof document>"u")return;const o=document.createElement("a");o.href=i,o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),setTimeout(()=>URL.revokeObjectURL(i),1e3)}var ps=Object.defineProperty,us=Object.getOwnPropertyDescriptor,de=(e,t,i,o)=>{for(var s=o>1?void 0:o?us(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&ps(t,i,s),s};let Z=class extends G{constructor(){super(...arguments),this.visible=!1,this.defaultName="",this.mounted=!1,this.name="",this.closeTimer=null}willUpdate(e){e.has("visible")&&(this.visible?(this.closeTimer&&(clearTimeout(this.closeTimer),this.closeTimer=null),this.mounted=!0,this.name=this.defaultName,setTimeout(()=>{this.inputEl&&(this.inputEl.focus(),this.inputEl.select())},100)):this.mounted&&(this.closeTimer=setTimeout(()=>{this.mounted=!1},300)))}close(){this.dispatchEvent(new CustomEvent("close"))}save(){const e=this.name.trim();e&&(this.dispatchEvent(new CustomEvent("save",{detail:e})),this.close())}onInput(e){this.name=e.target.value}onKeyDown(e){e.key==="Escape"?this.close():e.key==="Enter"&&this.name.trim()&&this.save()}render(){return this.mounted?d`
  ...
  `;de([w({type:Boolean})],Z.prototype,"visible",2);de([w({type:String})],Z.prototype,"defaultName",2);de([g()],Z.prototype,"mounted",2);de([g()],Z.prototype,"name",2);de([Rt(".name-input")],Z.prototype,"inputEl",2);Z=de([Y("save-set-modal")],Z);var gs=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,S=(e,t,i,o)=>{for(var s=o>1?void 0:o?ms(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&gs(t,i,s),s};const fs=[{side:"left",top:"18%"},{side:"left",top:"58%"},{side:"right",top:"24%"},{side:"right",top:"64%"}],Je=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],vs=["Lo-fi/Chill","R&B/Soul","Pop","Synthwave"],ys=["Warm","Melancholy","Nostalgic","Dreamy"],xs=["Piano","Rhodes","Nylon Guitar","Warm Pad"],bs=["Block chords","Arpeggio","Strum","Broken (swing)"],ws=[{label:"Major",value:"MAJOR"},{label:"Minor",value:"NATURAL_MINOR"},{label:"Harmonic Minor",value:"HARMONIC_MINOR"},{label:"Dorian",value:"DORIAN"},{label:"Mixolydian",value:"MIXOLYDIAN"},{label:"Lydian",value:"LYDIAN"}],Et=220,ks=280,$t={Uplifting:{anim:"cv-panel-uplifting",dur:2.4,ease:"ease-out"},Melancholy:{anim:"cv-panel-melancholy",dur:6,ease:"ease-in-out"},Dreamy:{anim:"cv-panel-dreamy",dur:7,ease:"ease-in-out"},Tense:{anim:"cv-panel-tense",dur:.9,ease:"ease-in-out"},Warm:{anim:"cv-panel-warm",dur:4.2,ease:"ease-in-out"},Nostalgic:{anim:"cv-panel-nostalgic",dur:5.4,ease:"ease-in-out"}};let T=class extends G{constructor(){super(...arguments),this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.playing=!0,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.sheetOpen=!1,this.isAuthenticated=!1,this.sheetMode="swap",this.swapChord=null,this.swapIndex=null,this.alternatives=[],this.menuMounted=!1,this.menuVisible=!1,this.expandedMenuGenre=!1,this.expandedMenuMood=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.saveModalVisible=!1,this.shareMounted=!1,this.shareVisible=!1,this.sheetMounted=!1,this.sheetVisible=!1,this.toast=null,this.spinning=!1,this.drag=null,this.snapProgress=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.mascot=be(.35),this.mascotSlot=we(fs),this.panelPeekMascot=be(.18),this.panelPeekSide=we(["left","right"]),this.eggCounter=new ut,this.paradeTrigger=0,this.menuCloseTimer=null,this.shareCloseTimer=null,this.sheetCloseTimer=null,this.toastTimer=null,this.pressTimer=null,this.pressTapFn=null,this.pressStartX=0,this.pressStartY=0,this.lastPointerX=0,this.lastPointerY=0,this.onDragMove=e=>{if(this.lastPointerX=e.clientX,this.lastPointerY=e.clientY,this.pressTimer&&!this.drag){(Math.abs(e.clientY-this.pressStartY)>8||Math.abs(e.clientX-this.pressStartX)>8)&&(clearTimeout(this.pressTimer),this.pressTimer=null);return}this.drag&&(this.drag={...this.drag,offsetX:e.clientX-this.pressStartX,offsetY:e.clientY-this.pressStartY})},this.onDragEnd=()=>{if(this.pressTimer&&(clearTimeout(this.pressTimer),this.pressTimer=null),!this.drag){this.pressTapFn&&this.pressTapFn(),this.pressTapFn=null;return}const e=this.drag.pos;this.drag=null,this.pressTapFn=null;const t=Array.from(this.renderRoot.querySelectorAll(".chord-chip"));let i=e,o=1/0;if(t.forEach((s,r)=>{if(r===e)return;const n=s.getBoundingClientRect(),a=n.left+n.width/2,c=n.top+n.height/2,h=(this.lastPointerX-a)**2+(this.lastPointerY-c)**2;h<o&&(o=h,i=r)}),i!==e){const s=[...this.order],[r]=s.splice(e,1);s.splice(i,0,r),this.emit("reorder",s)}}}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}connectedCallback(){super.connectedCallback(),window.addEventListener("pointermove",this.onDragMove),window.addEventListener("pointerup",this.onDragEnd),window.addEventListener("pointercancel",this.onDragEnd)}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}}disconnectedCallback(){super.disconnectedCallback(),this.menuCloseTimer&&clearTimeout(this.menuCloseTimer),this.shareCloseTimer&&clearTimeout(this.shareCloseTimer),this.sheetCloseTimer&&clearTimeout(this.sheetCloseTimer),this.toastTimer&&clearTimeout(this.toastTimer),this.pressTimer&&clearTimeout(this.pressTimer),window.removeEventListener("pointermove",this.onDragMove),window.removeEventListener("pointerup",this.onDragEnd),window.removeEventListener("pointercancel",this.onDragEnd)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1})),e.has("sheetOpen")&&(this.sheetOpen?(this.sheetCloseTimer&&(clearTimeout(this.sheetCloseTimer),this.sheetCloseTimer=null),this.sheetMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.sheetVisible=!0}))):(this.sheetVisible=!1,this.sheetCloseTimer=setTimeout(()=>{this.sheetMounted=!1},ks)))}toggleMenu(){this.menuMounted?this.closeMenu():this.openMenu()}openMenu(){this.menuCloseTimer&&(clearTimeout(this.menuCloseTimer),this.menuCloseTimer=null),this.menuMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.menuVisible=!0}))}closeMenu(){this.menuVisible=!1,this.menuCloseTimer&&clearTimeout(this.menuCloseTimer),this.menuCloseTimer=setTimeout(()=>{this.menuMounted=!1,this.expandedMenuGenre=!1,this.expandedMenuMood=!1},Et)}openShare(){this.closeMenu(),this.shareCloseTimer&&(clearTimeout(this.shareCloseTimer),this.shareCloseTimer=null),this.shareMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.shareVisible=!0}))}closeShare(){this.shareVisible=!1,this.shareCloseTimer=setTimeout(()=>{this.shareMounted=!1},Et)}exportDevice(e,t){this.closeShare();const i=ro(this.progression,e,this.order);window.open(i,"_blank"),this.toastTimer&&clearTimeout(this.toastTimer),this.toast=`Sent to ${t}`,this.toastTimer=setTimeout(()=>{this.toast=null},2e3)}async handleExportWav(){this.closeShare(),this.toastTimer&&clearTimeout(this.toastTimer),this.toast="Rendering WAV audio...";try{const e=this.progression,t=this.instrument??De(e.genre),i=this.playStyle??Pe(e.genre);await hs(e,this.order,t,i),this.toast="Saved WAV audio file"}catch(e){console.error("WAV export error:",e),this.toast="Failed to export WAV"}this.toastTimer=setTimeout(()=>{this.toast=null},2500)}handleExportMidi(){this.closeShare(),this.toastTimer&&clearTimeout(this.toastTimer);try{const e=this.progression,t=this.instrument??De(e.genre),i=this.playStyle??Pe(e.genre);ls(e,this.order,t,i),this.toast="Saved MIDI file"}catch(e){console.error("MIDI export error:",e),this.toast="Failed to export MIDI"}this.toastTimer=setTimeout(()=>{this.toast=null},2500)}reroll(){this.spinning=!0,setTimeout(()=>{this.spinning=!1},400),this.emit("reroll")}pressStart(e,t,i){i.preventDefault(),this.pressTapFn=t,this.pressStartX=i.clientX,this.pressStartY=i.clientY,this.pressTimer&&clearTimeout(this.pressTimer),this.pressTimer=setTimeout(()=>{this.pressTimer=null,this.drag={pos:e,offsetX:0,offsetY:0}},150)}dragStyleFor(e){const t=this.drag;return t&&t.pos===e?`transform:translate(${t.offsetX}px, ${t.offsetY}px) scale(1.08) rotate(-1deg);transition:none;z-index:20;box-shadow:0 20px 40px rgba(46,39,31,0.35);cursor:grabbing;`:"cursor:grab;"}renderHeaderTitle(e,t){if(e.searchTerm){const i=e.searchTerm.trim(),s=(i.endsWith(".")?i.slice(0,-1):i).split(/\s+/);if(s.length===1)return d`<h1><span style="color:${t}">${s[0]}.</span></h1>`;const r=s.slice(0,-1).join(" "),n=s[s.length-1];return d`<h1>${r} <span style="color:${t}">${n}.</span></h1>`}return d`<h1>Your progression, feeling <span style="color:${t}">${e.mood.toLowerCase()}.</span></h1>`}renderLengthControl(){const e=this.progression.chords.length;return d`
    ...
    `}render(){const e=this.progression,t=ye(e.mood),i=this.instrument??De(e.genre),o=this.playStyle??Pe(e.genre),s=Math.max(1,this.order.length),r=this.playing?this.snapProgress?this.progressStep/s*100:(this.progressStep+1)/s*100:0,n=$t[e.mood]||$t.Dreamy,a=this.showTheory?eo(this.order.map(u=>e.chords[u]),e.key,e.scaleType):null,c=Vt(e.key,e.scaleType).length,h=c===0?"no sharps or flats":`${c} ${c===1?"sharp/flat":"sharps/flats"}`;let f=vs.filter(u=>Je.includes(u));f.includes(e.genre)||(f=f.slice(0,-1).concat(e.genre));const l=Je.filter(u=>!f.includes(u)),m=this.expandedMenuGenre?Je:f,v=Q.map(u=>u.name);let y=ys.filter(u=>v.includes(u));y.includes(e.mood)||(y=y.slice(0,-1).concat(e.mood));const p=v.filter(u=>!y.includes(u)),M=(this.expandedMenuMood?v:y).map(u=>Q.find(B=>B.name===u)),k=le.filter(u=>u.name!==i);let x=xs.filter(u=>k.some(B=>B.name===u));const N=k.filter(u=>!x.includes(u.name)),P=this.expandedAllInstruments?k:k.filter(u=>x.includes(u.name)),U=ce.filter(u=>u.name!==o);let V=bs.filter(u=>U.some(B=>B.name===u));const he=U.filter(u=>!V.includes(u.name)),se=this.expandedAllPlayStyles?U:U.filter(u=>V.includes(u.name));return d`
      <div class="frame">
        ${this.mascot.show?d`
          <div class="mascot-slot ${this.mascotSlot.side}" style="top:${this.mascotSlot.top}">
            <mascot-character .kind=${this.mascot.kind} .scale=${.75}></mascot-character>
        ...
        ${this.menuMounted?d`
          ...
          <div class="menu ${this.menuVisible?"visible":""}">
            ...
            <div class="menu-chips">
              ${ae.map(u=>d`
                <div class="menu-chip ${u===e.key?"selected":""}" style=${u===e.key?`background:${t}`:""} @click=${()=>this.emit("set-key",u)}>${$e(u,e.scaleType)}</div>
              `)}
            </div>
            <div class="menu-chips">
              ${ws.map(u=>d`
        ...
        <div class="content">
          ...
          <div class="panel-shell">
            ...
            <div class="panel" style="animation:${n.anim} ${n.dur}s ${n.ease} infinite;">
              ...
              <div class="chip-row">
              ${this.order.map((u,B)=>{const Ie=e.chords[u],pe=_e(Ie.tension),ft=B===this.activeIndex;return d`
                  <div
                    class="chord-chip ${ft?"active":""}"
                    style="width:${pe.size}px;height:${pe.size}px;border-radius:${pe.radius}px;background:${pe.color};${this.dragStyleFor(B)}"
                    @pointerdown=${q=>this.pressStart(B,()=>this.emit("chord-preview",u),q)}
                  >
                    ${this.showTheory?d`<div class="roman-badge">${Ie.roman}</div>`:""}
                    ${ft?d`<div class="now-marker"><div class="now-dot"></div><div class="now-text">now</div></div>`:""}
                    <div class="chord-name" style="font-size:${pe.fontSize}px;">${Ie.name}</div>
          ...
          ${a?d`
            <div class="theory-strip">
              <div class="theory-key-label">${$e(e.key,e.scaleType)} ${e.scaleType.replace("_"," ")} · ${h}</div>
              <div class="theory-staff-scroll">
                ${J`
                  <svg width="${a.width}" height="${a.height}" viewBox="0 0 ${a.width} ${a.height}">
                    ${a.lines.map(u=>J`<rect x="6" y="${u}" width="${a.width-12}" height="1.4" fill="rgba(46,39,31,0.35)" />`)}
                    <text x="8" y="${a.lines[3]+14}" font-size="46" font-family="Georgia, 'Times New Roman', serif" fill="var(--cv-ink)">𝄞</text>
                    ${a.keySignature.map(u=>J`<text x="${u.x}" y="${u.y+6}" font-size="20" fill="var(--cv-ink)">${u.sign==="sharp"?"♯":"♭"}</text>`)}
                    ${a.chords.map(u=>J`
                      <text x="${u.cx}" y="${u.labelY}" font-size="11" font-weight="800" fill="var(--cv-ink)" text-anchor="middle">${u.name}</text>
                      ${u.ledgers.map(B=>J`<rect x="${B.x}" y="${B.y}" width="18" height="1.6" fill="rgba(46,39,31,0.5)" />`)}
                      ${u.notes.map(B=>J`<ellipse cx="${B.x}" cy="${B.y}" rx="6" ry="5.2" fill="var(--cv-ink)" />`)}
                      <text x="${u.cx}" y="${a.height-4}" font-size="12" font-weight="800" fill="${t}" text-anchor="middle">${u.roman}</text>
                    `)}
                  </svg>
                `}
              </div>
          ...
          <div class="transport">
            ...
            <div class="progress-track">
              <div
                ...
                style="width:${r}%;background:${t};--progress-duration:${rt}ms"
              ></div>
            </div>
          ...
          <div class="transport-meta">${$e(e.key,e.scaleType).toUpperCase()} ${e.scaleType.replace("_"," ")} · ${e.bpm} BPM</div>
  ...
  `;S([w({type:Object})],T.prototype,"progression",2);S([w({type:Number})],T.prototype,"activeIndex",2);S([w({type:Number})],T.prototype,"progressStep",2);S([w({type:Array})],T.prototype,"order",2);S([w({type:Boolean})],T.prototype,"playing",2);S([w({type:Boolean})],T.prototype,"showTheory",2);S([w({type:String})],T.prototype,"instrument",2);S([w({type:String})],T.prototype,"playStyle",2);S([w({type:Boolean})],T.prototype,"sheetOpen",2);S([w({type:Boolean})],T.prototype,"isAuthenticated",2);S([w({type:String})],T.prototype,"sheetMode",2);S([w({type:Object})],T.prototype,"swapChord",2);S([w({type:Number})],T.prototype,"swapIndex",2);S([w({type:Array})],T.prototype,"alternatives",2);S([g()],T.prototype,"menuMounted",2);S([g()],T.prototype,"menuVisible",2);S([g()],T.prototype,"expandedMenuGenre",2);S([g()],T.prototype,"expandedMenuMood",2);S([g()],T.prototype,"expandedAllInstruments",2);S([g()],T.prototype,"expandedAllPlayStyles",2);S([g()],T.prototype,"saveModalVisible",2);S([g()],T.prototype,"shareMounted",2);S([g()],T.prototype,"shareVisible",2);S([g()],T.prototype,"sheetMounted",2);S([g()],T.prototype,"sheetVisible",2);S([g()],T.prototype,"toast",2);S([g()],T.prototype,"spinning",2);S([g()],T.prototype,"drag",2);S([g()],T.prototype,"snapProgress",2);S([g()],T.prototype,"expandedInstrument",2);S([g()],T.prototype,"expandedPlayStyle",2);S([g()],T.prototype,"mascot",2);S([g()],T.prototype,"mascotSlot",2);S([g()],T.prototype,"panelPeekMascot",2);S([g()],T.prototype,"panelPeekSide",2);S([g()],T.prototype,"paradeTrigger",2);T=S([Y("loop-screen")],T);var Ts=Object.defineProperty,Ss=Object.getOwnPropertyDescriptor,D=(e,t,i,o)=>{for(var s=o>1?void 0:o?Ss(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Ts(t,i,s),s};const Is=["Piano","Rhodes","Nylon Guitar","Warm Pad"],As=["Block chords","Arpeggio","Strum","Broken (swing)"],Ns=["flex-start","center","flex-end"];let O=class extends G{constructor(){super(...arguments),this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.canAddSection=!0,this.playing=!1,this.progressStep=0,this.totalSteps=0,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.snapProgress=!1,this.saveModalVisible=!1,this.mascot=be(.5),this.mascotAlign=we([...Ns]),this.eggCounter=new ut,this.paradeTrigger=0}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1}))}selectSection(e){this.dispatchEvent(new CustomEvent("select-section",{detail:e,bubbles:!0,composed:!0}))}addSection(){this.canAddSection&&this.dispatchEvent(new CustomEvent("add-section",{bubbles:!0,composed:!0}))}backToProgression(){this.dispatchEvent(new CustomEvent("back-to-progression",{bubbles:!0,composed:!0}))}render(){const e=this.sections[0]?.progression.genre??"Pop",t=this.instrument??De(e),i=this.playStyle??Pe(e),o=this.totalSteps||this.sections.reduce((p,b)=>p+b.order.length,0),s=!this.playing||o<=0?0:this.snapProgress?this.progressStep/o*100:(this.progressStep+1)/o*100,r=le.filter(p=>p.name!==t);let n=Is.filter(p=>r.some(b=>b.name===p));const a=r.filter(p=>!n.includes(p.name)),c=this.expandedAllInstruments?r:r.filter(p=>n.includes(p.name)),h=ce.filter(p=>p.name!==i);let f=As.filter(p=>h.some(b=>b.name===p));const l=h.filter(p=>!f.includes(p.name)),m=this.expandedAllPlayStyles?h:h.filter(p=>f.includes(p.name)),v=this.sections[this.playing?this.activePlayingSectionIdx:0]||this.sections[0],y=v?ye(v.progression.mood):"#C9A9E0";return d`
      <div class="frame">
        <div class="wordmark" @click=${()=>this.onWordmarkClick()}>
        ...
        <div class="content">
          ...
          <div class="section-list">
            ${this.sections.map((p,b)=>{const M=this.playing?b===this.activePlayingSectionIdx:b===this.activeSectionIdx,k=ye(p.progression.mood);return d`
                <div class="section-row ${M?"active":""}" style=${M?`--ring-color:${k}`:""} @click=${()=>this.selectSection(b)}>
                  ...
                  <div class="section-chips">
                    ${p.order.map(x=>{const N=p.progression.chords[x],P=_e(N.tension);return d`<div class="section-chip" style="background:${P.color};border-radius:${Math.round(P.radius*.35)}px;"></div>`})}
                  </div>
                </div>
              `})}
          ...
          <div class="whole-song-section">
            ...
            <div class="transport">
              ...
              <div class="progress-track">
                <div
                  class="progress-fill ${this.snapProgress?"snap":""}"
                  style="width:${s}%;background:${y};--progress-duration:${rt}ms"
                ></div>
              </div>
              ${this.isAuthenticated?d`
  ...
  `;D([w({type:Array})],O.prototype,"sections",2);D([w({type:Number})],O.prototype,"activeSectionIdx",2);D([w({type:Number})],O.prototype,"activePlayingSectionIdx",2);D([w({type:Boolean})],O.prototype,"canAddSection",2);D([w({type:Boolean})],O.prototype,"playing",2);D([w({type:Number})],O.prototype,"progressStep",2);D([w({type:Number})],O.prototype,"totalSteps",2);D([w({type:String})],O.prototype,"instrument",2);D([w({type:String})],O.prototype,"playStyle",2);D([w({type:Boolean})],O.prototype,"isAuthenticated",2);D([g()],O.prototype,"expandedInstrument",2);D([g()],O.prototype,"expandedPlayStyle",2);D([g()],O.prototype,"expandedAllInstruments",2);D([g()],O.prototype,"expandedAllPlayStyles",2);D([g()],O.prototype,"snapProgress",2);D([g()],O.prototype,"saveModalVisible",2);D([g()],O.prototype,"mascot",2);D([g()],O.prototype,"mascotAlign",2);D([g()],O.prototype,"paradeTrigger",2);O=D([Y("song-screen")],O);var Ms=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,mt=(e,t,i,o)=>{for(var s=o>1?void 0:o?Cs(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Ms(t,i,s),s};let Se=class extends G{constructor(){super(...arguments),this.projects=[],this.isSyncing=!1}onBack(){this.dispatchEvent(new CustomEvent("back"))}onLoadProject(e){this.dispatchEvent(new CustomEvent("load-project",{detail:e}))}onSync(){this.isSyncing||(this.isSyncing=!0,this.dispatchEvent(new CustomEvent("sync-projects")),setTimeout(()=>{this.isSyncing=!1},2e3))}onDeleteProject(e,t){e.stopPropagation(),this.dispatchEvent(new CustomEvent("delete-project",{detail:t}))}render(){return d`
      <div class="frame">
        ...
        <div class="content">
          ...
          `:d`
            <div class="grid">
              ${this.projects.map(e=>{const t=e.scaleType||"MAJOR",i=e.key||"C",o=e.bpm||120,s=e.name||"Untitled Set",r=e.genre||"Unknown",n=e.mood||"Neutral",a=e.lastModified?new Date(e.lastModified).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}):"Unknown Date",c=ye(n);return d`
                  <div class="card" @click=${()=>this.onLoadProject(e.id)}>
                    ...
                    <div class="card-details">
                      <div class="detail-pill">${$e(i,t)} ${t.replace("_"," ")}</div>
  ...
  `;mt([w({type:Array})],Se.prototype,"projects",2);mt([g()],Se.prototype,"isSyncing",2);Se=mt([Y("sets-screen")],Se);var Es=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,C=(e,t,i,o)=>{for(var s=o>1?void 0:o?$s(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Es(t,i,s),s};let A=class extends G{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.screen="seed",this.genre="Pop",this.mood="Dreamy",this.progression=null,this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.keyOverride=null,this.scaleOverride=null,this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.sheetOpen=!1,this.sheetMode="swap",this.swapIndex=null,this.alternatives=[],this.length=4,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.pendingChordSuggestion=null,this.userEmail=null,this.isAuthenticated=!1,this.currentProjectId=null,this.activeSearchPrompt=null,this.unsubscribeAuth=null,this.unsubscribeTick=null,this.onLoginRequest=async()=>{await j.requestLogin()},this.onLogoutRequest=()=>{j.logout()}}async firstUpdated(){this.showTheory=(localStorage.getItem("chroma-chords-show-theory")||localStorage.getItem("chord-voyager-show-theory"))==="true";const e=localStorage.getItem("chroma-chords-instrument");e&&le.some(i=>i.name===e)&&(this.instrument=e);const t=localStorage.getItem("chroma-chords-play-style");t&&ce.some(i=>i.name===t)&&(this.playStyle=t),I.setInstrument(this.instrument),I.setPlayStyle(this.playStyle),this.unsubscribeAuth=j.subscribeAuthState((i,o)=>{this.userEmail=i,this.isAuthenticated=o,this.requestUpdate()}),this.unsubscribeTick=I.subscribeTick((i,o,s,r,n)=>{this.activeIndex=i,this.progressStep=o,typeof s=="number"&&(this.activePlayingSectionIdx=s),typeof r=="number"&&(this.totalSongSteps=r),this.playing=I.isPlaying(),this.requestUpdate()});try{this.chordData=await Di()}catch(i){console.error("Failed to load chord data:",i)}}get isAdmin(){return j.isAdmin}disconnectedCallback(){super.disconnectedCallback(),I.stopAutoplay(),this.unsubscribeAuth&&this.unsubscribeAuth(),this.unsubscribeTick&&this.unsubscribeTick()}onGenreChange(e){this.genre=e.detail,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}onMoodChange(e){this.mood=e.detail,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}onFreetextSuggestionApplied(e){const t=e.detail;this.pendingChordSuggestion=t.chords?.length&&t.key&&t.scaleType?t:null,e.detail.promptText&&(this.activeSearchPrompt=e.detail.promptText)}async onGenerate(e){this.keyOverride=null,this.scaleOverride=null;const t=e?.detail?.promptText||this.activeSearchPrompt||void 0,i=await Bo.resolvePrompt(this.chordData,this.genre,this.mood,this.length,t,this.pendingChordSuggestion);i.instrument&&(this.instrument=i.instrument,localStorage.setItem("chroma-chords-instrument",i.instrument),I.setInstrument(i.instrument)),i.playStyle&&(this.playStyle=i.playStyle,localStorage.setItem("chroma-chords-play-style",i.playStyle),I.setPlayStyle(i.playStyle));const o=i.progression;this.progression=o,this.order=Array.from({length:o.chords.length},(s,r)=>r),this.length=o.chords.length,this.activeIndex=0,this.progressStep=0,this.playing=!1,I.setProgression(o,this.order),I.reset(),this.screen="loop",this.sections=Ae.createInitialSong(o,this.order),this.activeSectionIdx=0,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}onLengthChange(e){this.length=e.detail}regenerate(){const e=jt(this.chordData,this.genre,this.mood,{key:this.keyOverride??void 0,scaleType:this.scaleOverride??void 0,length:this.length});this.progression=e,this.order=Array.from({length:this.length},(t,i)=>i),this.activeIndex=0,this.progressStep=0,I.setProgression(e,this.order),this.syncActiveSection(),this.playing&&(I.startAutoplay(),I.playActiveChord())}syncActiveSection(){this.progression&&(this.sections=Ae.syncActiveSection(this.sections,this.activeSectionIdx,this.progression,this.order))}onSetKey(e){this.keyOverride=e.detail,this.regenerate()}onSetScale(e){this.scaleOverride=e.detail,this.regenerate()}onSetGenre(e){this.genre=e.detail,this.regenerate()}onSetMood(e){this.mood=e.detail,this.regenerate()}onSetLength(e){this.length=e.detail,this.regenerate()}onReroll(){this.progression&&this.regenerate()}onReorder(e){if(!this.progression)return;const t=this.order[this.activeIndex];this.order=e.detail;const i=this.order.indexOf(t);this.activeIndex=i>=0?i:0,I.setOrder(this.order,this.activeIndex),this.syncActiveSection()}onBack(){I.stopAutoplay(),this.playing=!1,this.screen="seed",this.sheetOpen=!1,this.keyOverride=null,this.scaleOverride=null}onViewSets(){I.stopAutoplay(),this.playing=!1,this.screen="sets"}onLoadProject(e){const t=e.detail,i=j.getProjects().find(o=>o.id===t);i&&(this.currentProjectId=i.id,this.progression={genre:i.genre||"Unknown",mood:i.mood||"Neutral",key:i.key||"C",scaleType:i.scaleType||"MAJOR",bpm:i.bpm||120,chords:i.chords},this.order=Array.from({length:this.progression.chords.length},(o,s)=>s),this.length=this.progression.chords.length,this.showTheory=i.showTheory??this.showTheory,I.setProgression(this.progression,this.order),this.screen="loop",this.sections=Ae.createInitialSong(this.progression,this.order),this.activeSectionIdx=0)}onDeleteProject(e){j.deleteProject(e.detail),this.currentProjectId===e.detail&&(this.currentProjectId=null),this.requestUpdate()}async onSyncProjects(){await j.syncProjectsFromCloud(),await j.syncProjectsToCloud(),this.requestUpdate()}onSaveSet(e){this.saveProject(e.detail)}onTheoryToggle(){this.showTheory=!this.showTheory,localStorage.setItem("chroma-chords-show-theory",String(this.showTheory))}onSetInstrument(e){this.instrument=e.detail,localStorage.setItem("chroma-chords-instrument",e.detail),I.setInstrument(e.detail)}onSetPlayStyle(e){this.playStyle=e.detail,localStorage.setItem("chroma-chords-play-style",e.detail),I.setPlayStyle(e.detail)}onTogglePlay(){this.playing=I.togglePlay()}onTogglePlaySong(){I.setSong(this.sections),this.playing=I.togglePlay()}onChordTap(e){this.progression&&(this.swapIndex=e.detail,this.sheetMode="swap",this.alternatives=io(this.chordData,this.progression,e.detail),this.sheetOpen=!0,I.playChordAtIndex(e.detail,.8))}onChordVoicingTap(e){this.progression&&(this.swapIndex=e.detail,this.sheetMode="voicing",this.alternatives=[],this.sheetOpen=!0,I.playChordAtIndex(e.detail,.8))}onChordPreview(e){this.progression&&I.playChordAtIndex(e.detail,.8)}onSheetClose(){this.sheetOpen=!1,this.swapIndex=null}onSelectAlternative(e){if(!this.progression||this.swapIndex===null)return;const t=[...this.progression.chords];t[this.swapIndex]=e.detail.chord,this.progression={...this.progression,chords:t},I.setProgression(this.progression,this.order),this.sheetOpen=!1,this.swapIndex=null,this.syncActiveSection(),I.playChordNotes(e.detail.chord.notes,.8)}onVoicingPreview(e){I.playChordNotes(e.detail,.6)}onVoicingChange(e){if(!this.progression||this.swapIndex===null)return;const t=[...this.progression.chords];t[this.swapIndex]=to(t[this.swapIndex],e.detail.quality,e.detail.extension),this.progression={...this.progression,chords:t},I.setProgression(this.progression,this.order),this.syncActiveSection()}onBackToProgression(){I.stopAutoplay(),this.playing=!1,this.screen="loop",this.progression&&I.setProgression(this.progression,this.order)}onViewSong(){I.stopAutoplay(),this.playing=!1,this.sheetOpen=!1,this.screen="song",I.setSong(this.sections)}onSelectSection(e){const t=this.sections[e.detail];t&&(this.activeSectionIdx=e.detail,this.progression=t.progression,this.order=t.order.slice(),this.activeIndex=0,this.progressStep=0,this.length=t.progression.chords.length,this.keyOverride=t.progression.key,this.scaleOverride=t.progression.scaleType,this.sheetOpen=!1,this.screen="loop",I.setProgression(this.progression,this.order),this.playing&&(I.startAutoplay(),I.playActiveChord()))}onAddSection(){if(!this.progression)return;const e=Ae.addSection(this.sections,this.progression);this.sections=e.sections,this.activeSectionIdx=e.activeIndex,this.screen==="song"&&I.setSong(this.sections)}saveProject(e){if(!this.progression)return;const t=this.currentProjectId||Math.random().toString(36).slice(2,11);this.currentProjectId=t;const i=j.getProjects().find(r=>r.id===t),o=e||(i?i.name:`${this.progression.genre} · ${this.progression.mood}`),s={id:t,name:o,lastModified:Date.now(),genre:this.progression.genre,mood:this.progression.mood,key:this.progression.key,scaleType:this.progression.scaleType,bpm:this.progression.bpm,chords:this.progression.chords,showTheory:this.showTheory};j.saveProject(s),e&&j.scheduleCloudSync()}render(){let e;if(this.screen==="sets")e=d`
        <sets-screen
      ...
      `;else if(this.screen==="song")e=d`
        <song-screen
          ...
          .canAddSection=${this.sections.length<me.length}
