...
`,pm=[{device:"m8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:um},{device:"circuit",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:dm}];let kn=class extends Ke{constructor(){super(...arguments),this.visible=!1}emit(n,e){this.dispatchEvent(new CustomEvent(n,{detail:e,bubbles:!0,composed:!0}))}render(){return R`
        ...
        ${i?R`
          <div class="page-tabs">
            <div class="page-tab-wrap">
              ${Array.from({length:s},(c,l)=>{const h=l*4+1,u=Math.min(this.order.length,l*4+4);return R`<div class="page-tab ${l===r?"selected":""} ${this.pageHoverIndex===l?"drag-target":""}" @click=${()=>{this.page=l}}>${h}–${u}</div>`})}
            </div>
          </div>
        `:""}
  ...
  `;pe([le({type:Object})],ae.prototype,"progression",2);pe([le({type:Number})],ae.prototype,"activeIndex",2);pe([le({type:Array})],ae.prototype,"order",2);pe([le({type:Boolean})],ae.prototype,"playing",2);pe([le({type:Boolean})],ae.prototype,"showTheory",2);pe([le({type:Boolean})],ae.prototype,"sheetOpen",2);pe([le({type:Object})],ae.prototype,"swapChord",2);pe([le({type:Number})],ae.prototype,"swapIndex",2);pe([le({type:Array})],ae.prototype,"alternatives",2);pe([H()],ae.prototype,"menuMounted",2);pe([H()],ae.prototype,"menuVisible",2);pe([H()],ae.prototype,"shareMounted",2);pe([H()],ae.prototype,"shareVisible",2);pe([H()],ae.prototype,"sheetMounted",2);pe([H()],ae.prototype,"sheetVisible",2);pe([H()],ae.prototype,"toast",2);pe([H()],ae.prototype,"spinning",2);pe([H()],ae.prototype,"drag",2);pe([H()],ae.prototype,"page",2);pe([Si(".chord-stack")],ae.prototype,"stackEl",2);pe([Si(".desktop-chord-grid")],ae.prototype,"gridEl",2);ae=pe([cs("loop-screen")],ae);var _m=Object.defineProperty,vm=Object.getOwnPropertyDescriptor,ti=(n,e,t,s)=>{for(var i=s>1?void 0:s?vm(e,t):e,r=n.length-1,o;r>=0;r--)(o=n[r])&&(i=(s?o(e,t,i):o(i))||i);return s&&i&&_m(e,t,i),i};let os=class extends Ke{constructor(){super(...arguments),this.sections=[],this.activeSectionIdx=0,this.canAddSection=!0}selectSection(n){this.dispatchEvent(new CustomEvent("select-section",{detail:n,bubbles:!0,composed:!0}))}addSection(){this.canAddSection&&this.dispatchEvent(new CustomEvent("add-section",{bubbles:!0,composed:!0}))}render(){return R`
      <div class="frame">
        <div class="grain"></div>
        <div class="top-bar">
