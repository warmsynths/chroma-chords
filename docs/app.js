import{f as _i,u as Ri,s as Li,n as Ui,l as ji,P as Y,F as Ae,S as ae,M as ai,C as li,R as ci,a as di,b as zi,i as H,c as W,d as h,A as hi,w as z,O as Gi}from"./assets/vendor-7vM_bUxM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function i(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=i(s);fetch(s.href,r)}})();/**
 * @license
 ...
 */function St(e,t){return(i,o,s)=>{const r=n=>n.renderRoot?.querySelector(e)??null;return qi(i,o,{get(){return r(this)}})}}const ge="chroma_chords_projects",Hi="chord_voyager_projects";class me{static getProjects(){try{let t=localStorage.getItem(ge);if(t||(t=localStorage.getItem(Hi),t&&localStorage.setItem(ge,t)),t){const i=JSON.parse(t);let o=!1;return i.forEach(s=>{(s.genre==="Unknown"||!s.genre)&&(s.genre="Pop",o=!0),Array.isArray(s.chords)||(s.chords=[],o=!0)}),o&&localStorage.setItem(ge,JSON.stringify(i)),i}}catch(t){console.error("Failed to load projects from localStorage:",t)}return[]}static setProjects(t){try{localStorage.setItem(ge,JSON.stringify(t))}catch(i){console.error("Failed to set projects to localStorage:",i)}}static mergeProjects(t,i){const o=new Map;return t.forEach(s=>o.set(s.id,s)),i.forEach(s=>{const r=o.get(s.id);!r||s.lastModified>r.lastModified?o.set(s.id,s):s.lastModified===r.lastModified&&(r.syncedToCloud=!0)}),Array.from(o.values())}static saveProject(t){const i=this.getProjects(),o=i.findIndex(s=>s.id===t.id);t.lastModified=Date.now(),o>=0?i[o]=t:i.push(t);try{localStorage.setItem(ge,JSON.stringify(i))}catch(s){console.error("Failed to save project to localStorage:",s)}}static deleteProject(t){let i=this.getProjects();i=i.filter(o=>o.id!==t);try{localStorage.setItem(ge,JSON.stringify(i))}catch(o){console.error("Failed to delete project from localStorage:",o)}}static exportProjectFile(t){const i=JSON.stringify(t,null,2),o=new Blob([i],{type:"application/json"}),s=URL.createObjectURL(o),r=document.createElement("a");r.href=s,r.download=`${t.name.replace(/[^a-z0-9]/gi,"_").toLowerCase()}_chroma_chords.json`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(s)}static importProjectFile(t){return new Promise((i,o)=>{const s=new FileReader;s.onload=r=>{try{const n=r.target?.result,c=JSON.parse(n);c&&typeof c=="object"&&Array.isArray(c.chords)?(c.id=Math.random().toString(36).substr(2,9),c.lastModified=Date.now(),i(c)):o(new Error("Invalid project file format"))}catch{o(new Error("Failed to parse JSON file"))}},s.onerror=()=>o(new Error("Failed to read file")),s.readAsText(t)})}}const Fe="chroma_chords_auth_token",Xe="chroma_chords_auth_user",Wi="184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com";function Je(e){try{const t=e.split(".");if(t.length!==3)return null;let i=t[1].replace(/-/g,"+").replace(/_/g,"/");for(;i.length%4!==0;)i+="=";let o="";if(typeof atob=="function")o=atob(i);else if(typeof Buffer<"u")o=Buffer.from(i,"base64").toString("binary");else return null;const s=decodeURIComponent(o.split("").map(r=>"%"+("00"+r.charCodeAt(0).toString(16)).slice(-2)).join(""));return JSON.parse(s)}catch{return null}}function Xi(){try{return"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com"}catch{return Wi}}class Ji{constructor(t){this.currentUser=null,this.currentAccessToken=null,this.isLoading=!0,this.listeners=new Set,this.gisLoaded=!1,this.clientId=t!==void 0?t:Xi(),this.initSession()}initSession(){if(typeof window>"u"||typeof localStorage>"u"){this.isLoading=!1;return}try{const t=localStorage.getItem(Fe);if(t){const i=Je(t);i&&i.exp&&i.exp*1e3>Date.now()?(this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture}):(localStorage.removeItem(Fe),localStorage.removeItem(Xe),this.currentAccessToken=null,this.currentUser=null)}}catch(t){console.warn("Failed to restore auth session from localStorage:",t)}finally{this.isLoading=!1}}isConfigured(){return!!this.clientId}getAuthState(){return{user:this.currentUser,accessToken:this.currentAccessToken,isAuthenticated:!!this.currentUser&&!!this.currentAccessToken,isLoading:this.isLoading}}getUser(){return this.currentUser}async getAccessToken(){if(this.currentAccessToken){const t=Je(this.currentAccessToken);if(t&&t.exp&&t.exp*1e3<=Date.now())return await this.signOut(),null}return this.currentAccessToken}subscribe(t){return this.listeners.add(t),t(this.getAuthState()),()=>{this.listeners.delete(t)}}notify(){const t=this.getAuthState();this.listeners.forEach(i=>{try{i(t)}catch(o){console.error("Error in AuthState listener:",o)}})}handleCredentialResponse(t){if(!t||typeof t!="string")return{success:!1,message:"Invalid credential provided."};const i=Je(t);if(!i||!i.sub)return{success:!1,message:"Failed to decode Google user token."};if(i.exp&&i.exp*1e3<=Date.now())return{success:!1,message:"Google session token has expired."};this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture};try{typeof localStorage<"u"&&(localStorage.setItem(Fe,t),localStorage.setItem(Xe,JSON.stringify(this.currentUser)))}catch(o){console.warn("Failed to persist auth session to localStorage:",o)}return this.notify(),{success:!0,user:this.currentUser}}async loadGisScript(){return typeof window>"u"?!1:window.google?.accounts?.id?(this.gisLoaded=!0,!0):new Promise(t=>{const i=document.querySelector('script[src*="accounts.google.com/gsi/client"]');if(i){i.addEventListener("load",()=>{this.gisLoaded=!0,t(!0)}),i.addEventListener("error",()=>t(!1));return}const o=document.createElement("script");o.src="https://accounts.google.com/gsi/client",o.async=!0,o.defer=!0,o.onload=()=>{this.gisLoaded=!0,t(!0)},o.onerror=()=>t(!1),document.head.appendChild(o)})}async renderGoogleButton(t,i){if(!this.clientId||typeof window>"u"||!t)return;await this.loadGisScript();const o=window.google;if(o?.accounts?.id)try{o.accounts.id.initialize({client_id:this.clientId,callback:s=>{if(s.credential){const r=this.handleCredentialResponse(s.credential);i?.({success:r.success,message:r.message})}else i?.({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.innerHTML="",o.accounts.id.renderButton(t,{theme:"outline",size:"large",type:"standard",shape:"pill",text:"continue_with",logo_alignment:"left",width:320})}catch(s){console.warn("Failed to render Google button:",s)}}async signInWithGoogle(){if(!this.clientId)return{success:!1,message:"Google Client ID is not configured."};if(typeof window>"u")return{success:!1,message:"Window is not available in current environment."};await this.loadGisScript();const t=window.google;return t?.accounts?.id?new Promise(i=>{try{t.accounts.id.initialize({client_id:this.clientId,callback:o=>{if(o.credential){const s=this.handleCredentialResponse(o.credential);i({success:s.success,message:s.message})}else i({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.accounts.id.prompt(o=>{(o.isNotDisplayed?.()||o.isSkippedMoment?.())&&console.info("Google prompt skipped or not displayed.")})}catch(o){const s=o instanceof Error?o.message:String(o);i({success:!1,message:s})}}):{success:!1,message:"Google Sign-In script failed to load."}}async signInWithOAuth(t="google"){return t!=="google"?{success:!1,message:`Unsupported auth provider: ${t}. Only Google is supported.`}:this.signInWithGoogle()}async signOut(){this.currentUser=null,this.currentAccessToken=null;try{typeof localStorage<"u"&&(localStorage.removeItem(Fe),localStorage.removeItem(Xe)),typeof window<"u"&&window.google?.accounts?.id&&window.google.accounts.id.disableAutoSelect?.()}catch(t){console.warn("Error during sign out storage cleanup:",t)}return this.notify(),{success:!0}}}const fe=new Ji;class Ki{formatUrl(t){let i=t.trim().replace(/\/+$/,"");return i&&!i.startsWith("http://")&&!i.startsWith("https://")&&(i="https://"+i),i}applyAuthHeaders(t,i){if(!i)return;const o=i.trim();o.toLowerCase().startsWith("bearer ")?t.Authorization=o:t.Authorization=`Bearer ${o}`}async testConnection(t,i){const o=this.formatUrl(t);if(!o)return{ok:!1,status:0,message:"Worker URL cannot be empty"};try{const s={};this.applyAuthHeaders(s,i);const r=new AbortController,n=setTimeout(()=>r.abort(),8e3),c=await fetch(`${o}/api/health`,{method:"GET",headers:s,signal:r.signal});if(clearTimeout(n),c.status===200)return{ok:!0,status:200,message:"Connected to Cloudflare Worker",timestamp:(await c.json().catch(()=>({}))).timestamp};if(c.status===401)return{ok:!1,status:401,message:"Unauthorized: Invalid or missing authorization token"};const l=await c.text().catch(()=>"");return{ok:!1,status:c.status,message:`Connection error (${c.status}): ${l||c.statusText}`}}catch(s){return s instanceof Error&&s.name==="AbortError"?{ok:!1,status:0,message:"Connection timed out (8s limit)"}:{ok:!1,status:0,message:"Network error: Unable to reach worker endpoint"}}}async sync(t,i,o){const s=this.formatUrl(t);if(!s)throw new Error("Worker URL is not configured");const r={"Content-Type":"application/json"};this.applyAuthHeaders(r,i);const n=new AbortController,c=setTimeout(()=>n.abort(),15e3),l=await fetch(`${s}/api/sync`,{method:"POST",headers:r,body:JSON.stringify(o),signal:n.signal});if(clearTimeout(c),!l.ok){let d="";try{const p=await l.json();d=p.error||p.message||""}catch{d=await l.text().catch(()=>"")}throw new Error(`Cloud sync failed (${l.status}): ${d||l.statusText||"Unknown error"}`)}return await l.json()}}const Qi=new Ki,Bt="chroma_chords_deleted_projects",Pt="chroma_chords_last_sync_time",Zi="https://chroma-chords-api.warmsynths.workers.dev";function es(){try{return"https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev"}catch{return Zi}}function Ft(e){return typeof window<"u"&&typeof localStorage<"u"?localStorage.getItem(e):null}function _t(e,t){typeof window<"u"&&typeof localStorage<"u"&&localStorage.setItem(e,t)}class ts{constructor(){this.userEmail=null,this.authenticated=!1,this.isCloudSyncing=!1,this.syncTimeout=null,this.syncQueued=!1,this.syncStatus="sign-in",this.authStateCallbacks=new Set,this.projectsChangeCallbacks=new Set,this.syncStatusCallbacks=new Set,this.unsubscribeAuth=null,this.onlineHandler=null,this.offlineHandler=null,this.setupAuthSubscription(),this.setupOnlineListener()}setupAuthSubscription(){this.unsubscribeAuth=fe.subscribe(t=>{const i=this.authenticated;this.userEmail=t.user?.email||null,this.authenticated=t.isAuthenticated,this.syncStatus=this.authenticated?"synced":"sign-in",this.notifyAuthState(),this.notifySyncStatus(),!i&&this.authenticated&&this.syncWithCloud().catch(o=>{console.warn("Auto cloud sync on sign-in encountered an error:",o)})})}setupOnlineListener(){typeof window<"u"&&typeof window.addEventListener=="function"&&(this.onlineHandler=()=>{this.isAuthenticated()&&this.scheduleCloudSync()},this.offlineHandler=()=>{this.isAuthenticated()&&(this.syncStatus="offline",this.notifySyncStatus())},window.addEventListener("online",this.onlineHandler),window.addEventListener("offline",this.offlineHandler))}destroy(){this.unsubscribeAuth&&(this.unsubscribeAuth(),this.unsubscribeAuth=null),typeof window<"u"&&typeof window.removeEventListener=="function"&&(this.onlineHandler&&(window.removeEventListener("online",this.onlineHandler),this.onlineHandler=null),this.offlineHandler&&(window.removeEventListener("offline",this.offlineHandler),this.offlineHandler=null)),this.syncTimeout&&(clearTimeout(this.syncTimeout),this.syncTimeout=null)}getUserEmail(){return this.userEmail}isAuthenticated(){return this.authenticated}get isAdmin(){return!!(this.userEmail&&this.userEmail.toLowerCase().trim()==="warmsynthsiloveyou@gmail.com")}getSyncStatus(){return this.syncStatus}subscribeSyncStatus(t){return this.syncStatusCallbacks.add(t),t(this.syncStatus),()=>this.syncStatusCallbacks.delete(t)}notifySyncStatus(){this.syncStatusCallbacks.forEach(t=>{try{t(this.syncStatus)}catch(i){console.error("Error in SyncStatus callback:",i)}})}subscribeAuthState(t){return this.authStateCallbacks.add(t),t(this.userEmail,this.authenticated),()=>this.authStateCallbacks.delete(t)}notifyAuthState(){this.authStateCallbacks.forEach(t=>{try{t(this.userEmail,this.authenticated)}catch(i){console.error("Error in AuthState callback:",i)}})}subscribeProjects(t){return this.projectsChangeCallbacks.add(t),t(this.getProjects()),()=>this.projectsChangeCallbacks.delete(t)}notifyProjectsChanged(){const t=this.getProjects();this.projectsChangeCallbacks.forEach(i=>{try{i(t)}catch(o){console.error("Error in ProjectsChange callback:",o)}})}logout(){this.userEmail=null,this.authenticated=!1,this.syncStatus="sign-in",this.notifyAuthState(),this.notifySyncStatus()}getProjects(){return me.getProjects()}isProjectSaved(t){return t?me.getProjects().some(i=>i.id===t):!1}saveProject(t){me.saveProject(t),this.removeTombstone(t.id),this.notifyProjectsChanged(),this.scheduleCloudSync()}deleteProject(t){me.deleteProject(t),this.addTombstone(t),this.notifyProjectsChanged(),this.scheduleCloudSync()}getTombstones(){const t=Ft(Bt);if(!t)return[];try{return JSON.parse(t)}catch{return[]}}setTombstones(t){_t(Bt,JSON.stringify(t))}addTombstone(t){const i=this.getTombstones(),o=i.findIndex(r=>r.id===t),s=new Date().toISOString();o>=0?i[o].deletedAt=s:i.push({id:t,deletedAt:s}),this.setTombstones(i)}removeTombstone(t){const i=this.getTombstones().filter(o=>o.id!==t);this.setTombstones(i)}getLastSyncTime(){return Ft(Pt)}setLastSyncTime(t){_t(Pt,t)}scheduleCloudSync(){this.syncTimeout&&clearTimeout(this.syncTimeout),this.syncTimeout=setTimeout(()=>{this.syncTimeout=null,this.isCloudSyncing?this.syncQueued=!0:this.syncWithCloud().catch(t=>{console.warn("Scheduled cloud sync failed:",t)})},2e3)}async syncWithCloud(t){if(this.isCloudSyncing){this.syncQueued=!0;return}const i=await fe.getAccessToken();if(!this.isAuthenticated()||!i)return;const o=t||es();if(o){this.isCloudSyncing=!0,this.syncStatus="syncing",this.notifySyncStatus();try{const s=me.getProjects(),r=this.getTombstones(),n=this.getLastSyncTime(),c=s.map(y=>({...y,deletedAt:null})),l=await Qi.sync(o,i,{sets:c,lastSyncTime:n,tombstones:r}),d=new Map;s.forEach(y=>{d.set(y.id,{...y,syncedToCloud:!0})});const p=l.tombstones||[],a=new Set(p.map(y=>y.id));(l.sets||[]).forEach(y=>{if(y.deletedAt)a.add(y.id);else{const k=d.get(y.id),S=y.lastModified||(y.updatedAt?new Date(y.updatedAt).getTime():0),I=k?.lastModified||0;(!k||S>=I)&&d.set(y.id,{id:y.id,name:y.name,lastModified:S,genre:y.genre,mood:y.mood,key:y.key,scaleType:y.scaleType,bpm:y.bpm,showTheory:y.showTheory,chords:Array.isArray(y.chords)?y.chords:[],syncedToCloud:!0})}}),a.forEach(y=>{d.delete(y)});const g=Array.from(d.values());me.setProjects(g);const m=this.getTombstones(),x=new Set(r.map(y=>y.id)),f=m.filter(y=>!x.has(y.id));this.setTombstones(f),(l.lastSyncTime||l.syncedAt)&&this.setLastSyncTime(l.lastSyncTime||l.syncedAt),this.syncStatus="synced",this.notifySyncStatus(),this.notifyProjectsChanged()}catch(s){console.warn("Cloud sync encountered an error, transitioning to offline status:",s),this.syncStatus="offline",this.notifySyncStatus()}finally{this.isCloudSyncing=!1,this.syncQueued&&(this.syncQueued=!1,this.scheduleCloudSync())}}}async syncProjectsFromCloud(){return this.syncWithCloud()}async syncProjectsToCloud(){return this.syncWithCloud()}}const U=new ts;let Ke=null,Qe=null,Ze=null,Rt=null,et=null,tt=null,it=null,st=null,ot=null,rt=null,nt=null;function pi(){return Ke||(Ke=new di({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination()),Ke}function is(){return Qe||(Qe=new zi({urls:{F1:"A_029__F1_5.m4a",B1:"A_035__B1_5.m4a",E2:"A_040__E2_5.m4a",A2:"A_045__A2_5.m4a",D3:"A_050__D3_5.m4a",G3:"A_055__G3_5.m4a",B3:"A_059__B3_5.m4a",D4:"A_062__D4_5.m4a",F4:"A_065__F4_5.m4a",B4:"A_071__B4_5.m4a",E5:"A_076__E5_5.m4a",A5:"A_081__A5_5.m4a",D6:"A_086__D6_5.m4a",G6:"A_091__G6_5.m4a"},baseUrl:"https://danigb.github.io/samples/jlearman/rhodes-mki/jRhodes3d-mono/",volume:-12,onload:()=>{console.log("Rhodes piano sampler loaded successfully!")},onerror:e=>{console.warn("Failed to load Rhodes piano sampler:",e)}}).connect(pi())),Qe}function ss(e){const t=pi();switch(e){case"organ":return Ze||(Ze=new Y(ae,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(t)),Ze;case"pad-strings":return et||(Rt=new ci({decay:4.5,wet:.35}).connect(t),et=new Y(ae,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(Rt)),et;case"juno-pad":if(!it){tt=new li({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).connect(t);try{tt.start()}catch{}it=new Y(ae,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(tt)}return it;case"stab":return st||(st=new Y(ai,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(t)),st;case"epiano":return ot||(ot=new Y(Ae,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(t)),ot;case"guitar":return rt||(rt=new Y(ae,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(t)),rt;case"bell":return nt||(nt=new Y(Ae,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(t)),nt;case"rhodes":default:return is()}}const xe=[{name:"Piano",instrument:"rhodes",color:"#9CC0EC"},{name:"Rhodes",instrument:"epiano",color:"#F2A79B"},{name:"Nylon Guitar",instrument:"guitar",color:"#F6D98B"},{name:"Warm Pad",instrument:"pad-strings",color:"#C9A9E0"},{name:"Synth Bell",instrument:"bell",color:"#B8CC9E"},{name:"Drawbar Organ",instrument:"organ",color:"#E8609A"},{name:"Analog Synth",instrument:"juno-pad",color:"#7B61FF"},{name:"Synth Stab",instrument:"stab",color:"#FF8C42"}],we=[{name:"Block chords",color:"#F2A79B",patch:{arpMode:"off",spread:.3}},{name:"Arpeggio",color:"#9CC0EC",patch:{arpMode:"up",arpRate:"1/8",arpRange:1}},{name:"Strum",color:"#F6D98B",patch:{arpMode:"up",arpRate:"1/32",arpRange:1}},{name:"Broken (swing)",color:"#C9A9E0",patch:{arpMode:"up",arpRate:"1/8T",arpRange:1}},{name:"Half-time",color:"#B8CC9E",patch:{arpMode:"off",spread:.1,durationMultiplier:1.8}},{name:"Descending Arp",color:"#7B61FF",patch:{arpMode:"down",arpRate:"1/8",arpRange:1}},{name:"Off-beat / Ska",color:"#FF8C42",patch:{arpMode:"off",spread:.1,microTiming:.8}},{name:"Fast Triplet",color:"#7CD9B6",patch:{arpMode:"up",arpRate:"1/16T",arpRange:1}}],Tt={Pop:"rhodes",Rock:"rhodes","Indie/Folk":"rhodes","Lo-fi/Chill":"rhodes","Jazz-ish":"rhodes","R&B/Soul":"rhodes",Gospel:"organ",Cinematic:"pad-strings",Synthwave:"juno-pad","House/Dance":"stab",Blues:"rhodes","Funk/Disco":"epiano","Country/Bluegrass":"guitar","Reggae/Dub":"organ",Metal:"stab",Punk:"stab","Ambient/Drone":"pad-strings","Trap/Hip-Hop":"epiano","Bossa Nova/Latin":"guitar","Classical/Orchestral":"pad-strings","EDM/Trance":"juno-pad",Afrobeats:"epiano",Shoegaze:"pad-strings"},It={Pop:{minVelocity:90,maxVelocity:110,spread:.5,microTiming:.3,humanVariance:.3,duration:1},Rock:{minVelocity:105,maxVelocity:127,spread:.2,microTiming:.1,humanVariance:.15,duration:.9},"Indie/Folk":{minVelocity:80,maxVelocity:105,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},"Lo-fi/Chill":{minVelocity:55,maxVelocity:85,spread:2.5,microTiming:1.2,humanVariance:.8,duration:1.4,arpMode:"up",arpRate:"1/8",arpRange:1},"Jazz-ish":{minVelocity:70,maxVelocity:100,spread:1.8,microTiming:1,humanVariance:.6,duration:1.2,arpMode:"up",arpRate:"1/8T",arpRange:1},"R&B/Soul":{minVelocity:75,maxVelocity:105,spread:1.2,microTiming:.6,humanVariance:.5,duration:1.3},Gospel:{minVelocity:95,maxVelocity:120,spread:.4,microTiming:.2,humanVariance:.2,duration:1.5},Cinematic:{minVelocity:60,maxVelocity:90,spread:0,microTiming:0,humanVariance:.1,duration:2.2},Synthwave:{minVelocity:70,maxVelocity:95,spread:0,microTiming:0,humanVariance:.1,duration:1.8},"House/Dance":{minVelocity:100,maxVelocity:127,spread:0,microTiming:.1,humanVariance:.15,duration:.5},Blues:{minVelocity:80,maxVelocity:110,spread:1.4,microTiming:.7,humanVariance:.5,duration:1.2},"Funk/Disco":{minVelocity:95,maxVelocity:125,spread:.3,microTiming:.2,humanVariance:.2,duration:.8},"Country/Bluegrass":{minVelocity:85,maxVelocity:115,spread:1,microTiming:.4,humanVariance:.3,duration:1},"Reggae/Dub":{minVelocity:70,maxVelocity:100,spread:2,microTiming:1,humanVariance:.6,duration:1.3},Metal:{minVelocity:110,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:.8},Punk:{minVelocity:115,maxVelocity:127,spread:.1,microTiming:.1,humanVariance:.1,duration:.7},"Ambient/Drone":{minVelocity:45,maxVelocity:75,spread:0,microTiming:0,humanVariance:.05,duration:3},"Trap/Hip-Hop":{minVelocity:90,maxVelocity:120,spread:.2,microTiming:.2,humanVariance:.2,duration:1},"Bossa Nova/Latin":{minVelocity:75,maxVelocity:105,spread:1.5,microTiming:.8,humanVariance:.5,duration:1.1,arpMode:"up",arpRate:"1/8T",arpRange:1},"Classical/Orchestral":{minVelocity:50,maxVelocity:115,spread:.5,microTiming:.3,humanVariance:.3,duration:2},"EDM/Trance":{minVelocity:95,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:1.2},Afrobeats:{minVelocity:85,maxVelocity:115,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},Shoegaze:{minVelocity:65,maxVelocity:95,spread:.8,microTiming:.4,humanVariance:.3,duration:2.5}},os={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Warm Pad",bell:"Synth Bell",organ:"Piano",stab:"Nylon Guitar"};function Le(e){const t=Tt[e]??"rhodes";return os[t]??"Piano"}function Ue(e){return(It[e]?.arpMode??"off")==="off"?"Block chords":"Arpeggio"}function rs(){return Promise.race([ji(),new Promise(e=>setTimeout(e,3e3))])}function ui(e,t){const i=t/60;switch(e){case"1/4":return 1/i;case"1/8":return .5/i;case"1/8T":return .5/i*(2/3);case"1/16":return .25/i;case"1/32":return .125/i;default:return .25/i}}function gi(e,t){const i=[];for(let o=0;o<t;o++)for(const s of e){const r=s.match(/^([A-G]#?)(-?\d+)$/);if(r){const n=r[1],c=parseInt(r[2],10)+o;i.push(`${n}${c}`)}else i.push(s)}return i}function mi(e,t){const i=[...e];switch(t){case"up":return i;case"down":return[...i].reverse();case"up-down":return[...i,...[...i].reverse().slice(1,-1)];case"random":return i.sort(()=>Math.random()-.5);default:return i}}const Lt={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Analog Synth",bell:"Synth Bell",organ:"Drawbar Organ",stab:"Synth Stab"};function ns(e){if(!e)return;const t=e.toLowerCase().trim();return Lt[t]?Lt[t]:xe.find(o=>o.name.toLowerCase()===t||o.instrument.toLowerCase()===t)?.name}function as(e){if(!e)return;const t=e.toLowerCase().trim();return t.includes("strum")?"Strum":t.includes("descend")?"Descending Arp":t.includes("half")?"Half-time":t.includes("swing")||t.includes("broken")?"Broken (swing)":t.includes("offbeat")||t.includes("ska")||t.includes("syncopat")||t.includes("groove")?"Off-beat / Ska":t.includes("triplet")||t.includes("fast")?"Fast Triplet":t.includes("arp")||t.includes("cascade")?"Arpeggio":t.includes("block")||t.includes("pad")||t.includes("sustained")?"Block chords":we.find(o=>o.name.toLowerCase()===t)?.name??"Block chords"}function ls(e,t=.7,i,o="rhodes",s){try{Promise.all([Li(),rs()]).then(()=>{const r=ss(o);if(s&&typeof s=="object"&&Object.keys(s).length>0)try{typeof r.set=="function"&&r.set(s)}catch(d){console.warn("Failed to apply customConfig to Tone.js instrument:",d)}const n=e.length,c=n<=1?1:Math.max(.4,1/Math.sqrt(n)),l=Ui();if(i&&i.arpMode&&i.arpMode!=="off"){const d=i.bpm??80,p=i.arpRate??"1/16",a=i.arpRange??1,g=i.arpMode,m=ui(p,d),x=gi(e,a),f=mi(x,g),y=()=>i.minVelocity!==void 0&&i.maxVelocity!==void 0?(i.minVelocity+Math.random()*(i.maxVelocity-i.minVelocity))/127*c:c,k=i.duration?i.duration*(1+(Math.random()-.5)*.1*(i.humanVariance??0)):Math.max(.05,m*.9);f.forEach((S,I)=>{const w=i.microTiming?(Math.random()-.5)*i.microTiming*.02:0;r.triggerAttackRelease(S,k,l+I*m+w,y())});return}e.forEach((d,p)=>{let a=0,g=c,m=t;if(i){const{minVelocity:x,maxVelocity:f,spread:y,microTiming:k,humanVariance:S,duration:I}=i;g=(x+Math.random()*(f-x))/127*c;const O=p*y*.1,_=(Math.random()-.5)*k*.05,K=(Math.random()-.5)*S*.03;a=Math.max(0,O+_+K),m=I*(1+(Math.random()-.5)*.2*S)}r.triggerAttackRelease(d,m,l+a,g)})}).catch(r=>{console.warn("Audio playback gesture failed:",r)})}catch(r){console.warn("Audio playback failed:",r)}}function Ut(e,t,i){const o=t==="Unknown"||!t?"Pop":t,s=i?.instrument?xe.find(g=>g.name===i.instrument):void 0,r=i?.playStyle?we.find(g=>g.name===i.playStyle):void 0,n=s?.instrument??Tt[o]??"rhodes",c=It[o]||{},l=r?.patch??{},d={...c,...l,bpm:i?.bpm??c.bpm??90},p=i?.duration??c.duration??.9,a=l.durationMultiplier?p*l.durationMultiplier:p;ls(e,a,d,n,i?.customConfig)}const cs=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],ds=["C","Db","D","Eb","E","F","Gb","G","Ab","A","Bb","B"],Q={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},hs=new Set(["F","Bb","Eb","Ab","Db","Gb"]),be=["C","Db","D","Eb","E","F","F#","G","Ab","A","Bb","B"],He={maj:[0,4,7],min:[0,3,7],dim:[0,3,6],aug:[0,4,8],dom7:[0,4,7,10],min7:[0,3,7,10],maj7:[0,4,7,11],dim7:[0,3,6,9],sus4:[0,5,7]},ps=Object.keys(He),us={TONIC:"home",SUPERTONIC:"rise",MEDIANT:"glow",SUBDOMINANT:"lift",DOMINANT:"reach",SUBMEDIANT:"hold","LEADING-TONE":"edge",SUBTONIC:"drift"},jt={TONIC:"Tonic",SUPERTONIC:"Supertonic",MEDIANT:"Mediant",SUBDOMINANT:"Subdominant",DOMINANT:"Dominant",SUBMEDIANT:"Submediant","LEADING-TONE":"Leading tone",SUBTONIC:"Subtonic"},gs={TONIC:.04,SUBMEDIANT:.24,MEDIANT:.34,SUBDOMINANT:.42,SUPERTONIC:.52,SUBTONIC:.58,"LEADING-TONE":.78,DOMINANT:.68},gt={MAJOR:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii°"},NATURAL_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"III",SUBDOMINANT:"iv",DOMINANT:"v",SUBMEDIANT:"VI",SUBTONIC:"VII"},HARMONIC_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"III+",SUBDOMINANT:"iv",DOMINANT:"V",SUBMEDIANT:"VI","LEADING-TONE":"vii°"},MELODIC_MINOR:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"III+",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi°","LEADING-TONE":"vii°"},DORIAN:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"III",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi°",SUBTONIC:"VII"},MIXOLYDIAN:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii°",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi",SUBTONIC:"VII"},LYDIAN:{TONIC:"I",SUPERTONIC:"II",MEDIANT:"iii",SUBDOMINANT:"iv°",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii"}},ms=Object.keys(gt),zt={MAJOR:"Ionian",NATURAL_MINOR:"Aeolian",HARMONIC_MINOR:"Harmonic minor",MELODIC_MINOR:"Melodic minor",DORIAN:"Dorian",MIXOLYDIAN:"Mixolydian",LYDIAN:"Lydian"},Ne=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],fs={Pop:"MAJOR",Rock:"MAJOR",Gospel:"MAJOR","Indie/Folk":"MAJOR","Lo-fi/Chill":"DORIAN","Jazz-ish":"DORIAN","R&B/Soul":"MIXOLYDIAN","House/Dance":"MIXOLYDIAN",Synthwave:"LYDIAN",Cinematic:"LYDIAN",Blues:"MIXOLYDIAN","Funk/Disco":"MIXOLYDIAN","Country/Bluegrass":"MAJOR","Reggae/Dub":"DORIAN",Metal:"HARMONIC_MINOR",Punk:"MAJOR","Ambient/Drone":"LYDIAN","Trap/Hip-Hop":"NATURAL_MINOR","Bossa Nova/Latin":"DORIAN","Classical/Orchestral":"MAJOR","EDM/Trance":"NATURAL_MINOR",Afrobeats:"MIXOLYDIAN",Shoegaze:"LYDIAN"},bs={Uplifting:null,Melancholy:"NATURAL_MINOR",Dreamy:null,Tense:"HARMONIC_MINOR",Warm:null,Nostalgic:"NATURAL_MINOR",Energetic:null,Dark:"HARMONIC_MINOR",Peaceful:null,Groovy:"MIXOLYDIAN",Epic:"MAJOR"},Ct={Uplifting:["DOMINANT","SUBDOMINANT","SUBMEDIANT"],Melancholy:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Dreamy:["MEDIANT","SUBDOMINANT","SUPERTONIC"],Tense:["DOMINANT","LEADING-TONE","SUPERTONIC"],Warm:["SUBDOMINANT","MEDIANT","SUBMEDIANT"],Nostalgic:["SUBMEDIANT","MEDIANT","DOMINANT"],Energetic:["DOMINANT","SUBDOMINANT","SUPERTONIC"],Dark:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Peaceful:["TONIC","SUBDOMINANT","MEDIANT"],Groovy:["SUBDOMINANT","DOMINANT","SUBTONIC"],Epic:["TONIC","DOMINANT","SUBMEDIANT"]},le=[{name:"Uplifting",dot:"#F6D98B",desc:"Bright, major, forward-moving",iconPath:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5"},{name:"Melancholy",dot:"#9CC0EC",desc:"Minor-leaning, unresolved longing",iconPath:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15"},{name:"Dreamy",dot:"#C9A9E0",desc:"Suspended, floating, reverb-soaked",iconPath:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0"},{name:"Tense",dot:"#F2735F",desc:"Chromatic pulls, unresolved tension",iconPath:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12"},{name:"Warm",dot:"#F2C9A0",desc:"Rich, consonant, close voicings",iconPath:"M12 4 a6.5 6.5 0 1 0 6.5 6.5"},{name:"Nostalgic",dot:"#B8CC9E",desc:"Bittersweet, borrowed chords",iconPath:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},{name:"Energetic",dot:"#FF8C42",desc:"High velocity, driving rhythm",iconPath:"M13 2 L4 14 h7 l-2 8 11-12 h-7 z"},{name:"Dark",dot:"#7B61FF",desc:"Deep minor, ominous resonance",iconPath:"M12 3 a9 9 0 1 0 9 9 a9 9 0 0 1-9-9 z"},{name:"Peaceful",dot:"#7CD9B6",desc:"Serene, gentle acoustic space",iconPath:"M12 2 a10 10 0 1 0 10 10 A10 10 0 0 0 12 2 z M12 6 a6 6 0 1 1-6 6 a6 6 0 0 1 6-6 z"},{name:"Groovy",dot:"#E8609A",desc:"Syncopated, rhythmic bounce",iconPath:"M4 12 c4-4 8 4 12-4 s8 4 4 8"},{name:"Epic",dot:"#E5C158",desc:"Sweeping dynamics, triumphant power",iconPath:"M12 2 l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 z"}];function ye(e){return(le.find(t=>t.name===e)||le[0]).dot}const ys={MAJOR:[{degrees:["TONIC","DOMINANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBMEDIANT","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","DOMINANT"]},{degrees:["TONIC","MEDIANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBDOMINANT","SUBMEDIANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","MEDIANT","SUBMEDIANT"]},{degrees:["SUBDOMINANT","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","DOMINANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","SUBMEDIANT","TONIC"]}],NATURAL_MINOR:[{degrees:["TONIC","SUBMEDIANT","MEDIANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","MEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUBTONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","SUBTONIC","TONIC","DOMINANT"]},{degrees:["SUBMEDIANT","SUBTONIC","MEDIANT","TONIC"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","SUBMEDIANT","SUBDOMINANT","TONIC"]}],HARMONIC_MINOR:[{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUBDOMINANT"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUPERTONIC","DOMINANT"]},{degrees:["SUBMEDIANT","DOMINANT","TONIC","SUBDOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]}],DORIAN:[{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUPERTONIC","SUBTONIC"]},{degrees:["SUBDOMINANT","TONIC","SUBTONIC","SUPERTONIC"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUPERTONIC","SUBDOMINANT","SUBTONIC","TONIC"]}],MIXOLYDIAN:[{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBDOMINANT"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUBDOMINANT","SUBTONIC","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","TONIC","SUBDOMINANT","SUPERTONIC"]}],LYDIAN:[{degrees:["TONIC","SUPERTONIC","SUBMEDIANT","DOMINANT"]},{degrees:["TONIC","DOMINANT","SUPERTONIC","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]}]};function vs(e,t){return 1+e.degrees.filter(i=>t.includes(i)).length*.6}function je(e,t){const i=e.reduce((s,r)=>s+t(r),0);let o=Math.random()*i;for(const s of e)if(o-=t(s),o<=0)return s;return e[e.length-1]}function xs(e){if(e.length)return e[Math.floor(Math.random()*e.length)]}const mt=4,ue=1,ee=8,At=1700,ws={TONIC:{SUBDOMINANT:.35,SUBMEDIANT:.25,SUPERTONIC:.15,DOMINANT:.15,MEDIANT:.05,SUBTONIC:.05},SUPERTONIC:{DOMINANT:.5,SUBDOMINANT:.2,SUBMEDIANT:.15,TONIC:.1,"LEADING-TONE":.05},MEDIANT:{SUBMEDIANT:.4,SUBDOMINANT:.3,SUPERTONIC:.15,DOMINANT:.15},SUBDOMINANT:{DOMINANT:.45,TONIC:.25,SUPERTONIC:.15,SUBMEDIANT:.15},DOMINANT:{TONIC:.55,SUBMEDIANT:.25,SUBDOMINANT:.15,MEDIANT:.05},SUBMEDIANT:{SUBDOMINANT:.4,SUPERTONIC:.25,DOMINANT:.2,TONIC:.15},"LEADING-TONE":{TONIC:.7,SUBMEDIANT:.2,MEDIANT:.1},SUBTONIC:{TONIC:.45,SUBDOMINANT:.3,SUBMEDIANT:.15,DOMINANT:.1}};function ks(e,t="MAJOR",i="Pop",o="Uplifting"){let r={TONIC:1,SUBDOMINANT:.45,SUBMEDIANT:.4,SUPERTONIC:.3,SUBTONIC:.3,MEDIANT:.15,DOMINANT:.15,"LEADING-TONE":.02}[e]??.1;return t.includes("MINOR")||t==="DORIAN"?(e==="SUBMEDIANT"&&(r*=1.4),e==="SUBTONIC"&&(r*=1.3)):t==="MIXOLYDIAN"?(e==="SUBTONIC"&&(r*=1.8),e==="SUBDOMINANT"&&(r*=1.5)):t==="LYDIAN"&&e==="SUPERTONIC"&&(r*=1.8),i==="Lo-fi/Chill"||i==="R&B/Soul"?((e==="SUBDOMINANT"||e==="SUPERTONIC")&&(r*=2),e==="SUBMEDIANT"&&(r*=1.5)):i==="Jazz-ish"||i==="Bossa Nova/Latin"?(e==="SUPERTONIC"&&(r*=2.5),e==="SUBDOMINANT"&&(r*=1.8)):i==="Pop"||i==="Indie/Folk"||i==="Shoegaze"?(e==="SUBDOMINANT"||e==="SUBMEDIANT")&&(r*=1.8):i==="Synthwave"||i==="House/Dance"||i==="Rock"||i==="Punk"||i==="Funk/Disco"||i==="Reggae/Dub"?(e==="SUBTONIC"&&(r*=2.2),e==="SUBDOMINANT"&&(r*=1.8),e==="SUBMEDIANT"&&(r*=1.6)):(i==="Classical/Orchestral"||i==="Gospel")&&e==="TONIC"&&(r*=2.5),o==="Uplifting"||o==="Epic"||o==="Peaceful"?e==="TONIC"&&(r*=2.5):o==="Melancholy"||o==="Dark"?(e==="SUBMEDIANT"&&(r*=2.2),e==="SUPERTONIC"&&(r*=1.5)):o==="Dreamy"||o==="Nostalgic"||o==="Warm"?(e==="SUBDOMINANT"&&(r*=2),e==="SUBMEDIANT"&&(r*=1.6),e==="MEDIANT"&&(r*=1.4)):o==="Tense"?(e==="SUPERTONIC"||e==="SUBDOMINANT")&&(r*=1.8):(o==="Groovy"||o==="Energetic")&&(e==="SUBTONIC"||e==="SUBDOMINANT")&&(r*=1.8),(Ct[o]||[]).includes(e)&&(r*=1.3),Math.max(.01,r)}function at(e,t,i="MAJOR",o="Pop",s="Uplifting"){if(e===t)return .05;let n=(ws[e]||{})[t]??.1;return(i.includes("MINOR")||i==="DORIAN")&&(e==="TONIC"&&t==="SUBMEDIANT"&&(n*=1.5),e==="SUBMEDIANT"&&t==="MEDIANT"&&(n*=1.4),e==="MEDIANT"&&t==="SUBTONIC"&&(n*=1.4),e==="SUBTONIC"&&t==="TONIC"&&(n*=1.3)),o==="Jazz-ish"||o==="Lo-fi/Chill"?(e==="SUPERTONIC"&&t==="DOMINANT"&&(n*=1.8),e==="DOMINANT"&&t==="TONIC"&&(n*=1.5),e==="TONIC"&&t==="SUPERTONIC"&&(n*=1.4)):(o==="House/Dance"||o==="Synthwave")&&(t==="SUBTONIC"||t==="SUBDOMINANT")&&(n*=1.5),(Ct[s]||[]).includes(t)&&(n*=1.5),Math.max(.01,n)}function Ss(e,t,i,o,s,r,n=mt){let c=i.filter(a=>e.degrees[a]);c.length||(c=i);const l=je(c,a=>ks(a,e.type,s,r))||"TONIC",d=[l];let p=l;for(let a=1;a<n;a++){const g=a===n-1;let m=i.filter(y=>e.degrees[y]);m.length||(m=i);const x=m.filter(y=>y!==p),f=x.length?x:m;if(g){const y=je(f,k=>{const S=at(k,d[0],e.type,s,r),I=at(p,k,e.type,s,r);return S*I});d.push(y)}else{const y=f.filter(I=>!d.includes(I)),k=y.length?y:f,S=je(k,I=>at(p,I,e.type,s,r));p=S,d.push(S)}}return d}function D(e,t){const i=(e%12+12)%12;return t?ds[i]:cs[i]}function Nt(e){const t=e[0]?.toUpperCase();let i="C",o=e;t&&/[A-G]/.test(t)&&(e[1]==="B"?(i=`${t}b`,o=e.slice(2)):e[1]==="#"?(i=`${t}#`,o=e.slice(2)):(i=t,o=e.slice(1))),o=o.toLowerCase();let s="maj";return o.includes("maj7")?s="maj7":o.includes("min7")||o.includes("m7")?s="min7":o.includes("dim7")?s="dim7":o.includes("dim")?s="dim":o.includes("aug")?s="aug":o.includes("sus")?s="sus4":o==="7"?s="dom7":o.includes("min")||o==="m"?s="min":s="maj",{root:i,quality:s}}function Me(e,t){const{root:i,quality:o}=Nt(e),s=Q[i]??0;return He[o].map(n=>D(s+n,t))}async function Gt(){const e=typeof import.meta<"u"?"./":"/",t=e.endsWith("/")?e:`${e}/`,i=`${t}chroma_chords_data.json`,o=`${t}chord_voyager_data.json`;let s=await fetch(i).catch(()=>null);if((!s||!s.ok)&&(s=await fetch(o).catch(()=>null)),(!s||!s.ok)&&(s=await fetch("/chroma_chords_data.json").catch(()=>null)),(!s||!s.ok)&&(s=await fetch("/chord_voyager_data.json").catch(()=>null)),!s||!s.ok){const n=new URL("./chroma_chords_data.json",import.meta.url).href;s=await fetch(n)}if(!s.ok)throw new Error(`HTTP error: ${s.status}`);const r=await s.json();return $s(r),r}const Ts={C:"F",Db:"F#",D:"G",Eb:"Ab",E:"A",F:"Bb","F#":"B",G:"C",Ab:"Db",A:"D",Bb:"Eb",B:"E"},Is={C:"Bb","C#":"B",D:"C","D#":"Db",E:"D",F:"Eb","F#":"E",G:"F","G#":"F#",A:"G","A#":"Ab",B:"A"},Cs={C:"G",Db:"Ab",D:"A",Eb:"Bb",E:"B",F:"C","F#":"Db",G:"D",Ab:"Eb",A:"E",Bb:"F",B:"F#"},As={DORIAN_SUPERTONIC:"TONIC",DORIAN_MEDIANT:"SUPERTONIC",DORIAN_SUBDOMINANT:"MEDIANT",DORIAN_DOMINANT:"SUBDOMINANT",DORIAN_SUBMEDIANT:"DOMINANT","DORIAN_LEADING-TONE":"SUBMEDIANT",DORIAN_TONIC:"SUBTONIC",MIXOLYDIAN_DOMINANT:"TONIC",MIXOLYDIAN_SUBMEDIANT:"SUPERTONIC","MIXOLYDIAN_LEADING-TONE":"MEDIANT",MIXOLYDIAN_TONIC:"SUBDOMINANT",MIXOLYDIAN_SUPERTONIC:"DOMINANT",MIXOLYDIAN_MEDIANT:"SUBMEDIANT",MIXOLYDIAN_SUBDOMINANT:"SUBTONIC",LYDIAN_SUBDOMINANT:"TONIC",LYDIAN_DOMINANT:"SUPERTONIC",LYDIAN_SUBMEDIANT:"MEDIANT","LYDIAN_LEADING-TONE":"SUBDOMINANT",LYDIAN_TONIC:"DOMINANT",LYDIAN_SUPERTONIC:"SUBMEDIANT",LYDIAN_MEDIANT:"LEADING-TONE"},Ns={DORIAN_TONIC:"SUPERTONIC",DORIAN_SUPERTONIC:"MEDIANT",DORIAN_MEDIANT:"SUBDOMINANT",DORIAN_SUBDOMINANT:"DOMINANT",DORIAN_DOMINANT:"SUBMEDIANT",DORIAN_SUBMEDIANT:"LEADING-TONE",DORIAN_SUBTONIC:"TONIC",MIXOLYDIAN_TONIC:"DOMINANT",MIXOLYDIAN_SUPERTONIC:"SUBMEDIANT",MIXOLYDIAN_MEDIANT:"LEADING-TONE",MIXOLYDIAN_SUBDOMINANT:"TONIC",MIXOLYDIAN_DOMINANT:"SUPERTONIC",MIXOLYDIAN_SUBMEDIANT:"MEDIANT",MIXOLYDIAN_SUBTONIC:"SUBDOMINANT",LYDIAN_TONIC:"SUBDOMINANT",LYDIAN_SUPERTONIC:"DOMINANT",LYDIAN_MEDIANT:"SUBMEDIANT",LYDIAN_SUBDOMINANT:"LEADING-TONE",LYDIAN_DOMINANT:"TONIC",LYDIAN_SUBMEDIANT:"SUPERTONIC","LYDIAN_LEADING-TONE":"MEDIANT"},Ms={DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]};function $s(e){const t=[["MIXOLYDIAN",Ts],["DORIAN",Is],["LYDIAN",Cs]];for(const[i,o]of t)for(const[s,r]of Object.entries(o)){const n=e.scales[`${r}_MAJOR`];if(!n)continue;const c=`${s}_${i}`,l={};for(const d of Ms[i]){const p=Ns[`${i}_${d}`],a=n.degrees[p];if(!a)continue;const g=JSON.parse(JSON.stringify(a));g.next_chord_options=(g.next_chord_options||[]).map(m=>{if(m.nodeId.startsWith(`${r}_MAJOR_`)){const x=m.nodeId.replace(`${r}_MAJOR_`,""),f=As[`${i}_${x}`];if(f)return{name:m.name,nodeId:`${s}_${i}_${f}`}}return m}),l[d]=g}e.scales[c]={root:s,type:i,degrees:l}}}const Es=[156,192,236],Os=[242,115,95];function ze(e,t,i){return e+(t-e)*i}function We(e){const t=Math.max(0,Math.min(1,e));return"#"+Es.map((o,s)=>Math.round(ze(o,Os[s],t))).map(o=>o.toString(16).padStart(2,"0")).join("")}function $e(e){const t=Math.max(0,Math.min(1,e));return{size:Math.round(ze(84,128,t)),radius:Math.round(ze(40,12,t)),fontSize:Math.round(ze(21,30,t)),color:We(t)}}function Ds(e,t,i){return{Tonic:`As the tonic, ${i} establishes home — the point of full rest and resolution.`,Supertonic:`As the supertonic, ${i} steps just off home, a light pivot toward what comes next.`,Mediant:`As the mediant, ${i} offers a soft, glowing detour — related to home, but colored differently.`,Subdominant:`As the subdominant, ${i} lifts away from home, opening the progression outward before it turns back.`,Dominant:`As the dominant, ${i} builds the pull of the progression — tension that wants to resolve.`,Submediant:`As the submediant, ${i} offers a warmer, more introspective variation of the tonic — stable but tinged with longing.`,"Leading tone":`As the leading tone, ${i} sits right on the edge, straining toward resolution.`,Subtonic:`As the subtonic, ${i} drifts just below home, a soft modal step rather than a hard pull.`}[e]||`${i} colors the progression as the ${e.toLowerCase()} of ${t}.`}function fi(e,t,i,o){const r=i.degrees[t].chord_name,n=gs[t]??.5,c=gt[i.type]||gt.MAJOR;return{name:Vt(r),tag:us[t]||"move",roman:c[t]||"?",color:We(n),functionLabel:jt[t]||t,notes:Me(r,o),scaleLabel:`${i.root} ${zt[i.type]||i.type}`,desc:Ds(jt[t]||t,zt[i.type]||i.type,Vt(r)),degree:t,scaleKey:e,tension:n}}function Vt(e){const{root:t,quality:i}=Nt(e);return`${t}${{maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"}[i]??""}`}const Bs={Pop:116,"Lo-fi/Chill":80,"R&B/Soul":90,"Indie/Folk":105,Synthwave:118,"Jazz-ish":95,Gospel:85,Cinematic:75,Rock:124,"House/Dance":126,Blues:88,"Funk/Disco":114,"Country/Bluegrass":110,"Reggae/Dub":78,Metal:140,Punk:155,"Ambient/Drone":65,"Trap/Hip-Hop":135,"Bossa Nova/Latin":120,"Classical/Orchestral":72,"EDM/Trance":132,Afrobeats:108,Shoegaze:112};function bi(e,t){let i=Bs[e]||92;return t==="Tense"&&(i+=6),(t==="Dreamy"||t==="Melancholy")&&(i-=6),i}function ft(e,t,i,o){const s=Math.max(ue,Math.min(ee,o?.length??mt)),r=fs[t]||"MAJOR",n=bs[i],c=o?.scaleType||(n&&r==="MAJOR"?n:r);let l=o?.key&&be.includes(o.key)?o.key:xs(be),d=`${l}_${c}`;e.scales[d]||(l="C",d=`${l}_${c}`);let p=e.scales[d];if(!p){const I=Object.keys(e.scales).find(w=>w.endsWith(`_${c}`))||Object.keys(e.scales)[0];p=e.scales[I],l=p?p.root:"C",d=I}const a=oe(l,c),g=Object.keys(p.degrees),m=Ct[i]||[],x=ys[c]||[],f=s===mt?x.filter(I=>I.degrees.every(w=>g.includes(w))):[],S=(f.length&&Math.random()<.25?je(f,I=>vs(I,m)).degrees:Ss(p,d,g,m,t,i,s)).map(I=>fi(d,I,p,a));return{genre:t,mood:i,key:l,scaleType:c,bpm:bi(t,i),chords:S}}function Ps(e,t,i,o,s,r){const n=`${t}_${i}`,c=e.scales[n];if(!c||!o.length)return null;const l=oe(t,i),d=Q[t]??0,p={};Object.entries(c.degrees).forEach(([g,m])=>{const{root:x}=Nt(m.chord_name),f=Q[x]??0;f in p||(p[f]=g)});const a=o.slice(0,ee).map(({root:g,quality:m})=>{const x=Q[g]??d,f=p[x];if(f)return fi(n,f,c,l);const y=(x-d+12)%12,k=He[m]?m:"maj";return _s(t,y,k,"Borrowed","?","drift",l)});return a.length<ue?null:{genre:s,mood:r,key:t,scaleType:i,bpm:bi(s,r),chords:a}}const Fs={maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"};function _s(e,t,i,o,s,r,n){const c=(Q[e]??0)+t,d=`${D(c,n)}${Fs[i]}`,p=He[i].map(g=>D(c+g,n)),a=.3;return{name:d,tag:r,roman:s,color:We(a),functionLabel:o,notes:p,scaleLabel:"Borrowed",desc:`${d} borrows its color from outside the current key.`,degree:"BORROWED",scaleKey:"",tension:a}}function bt(e){const t=e.match(/^[A-Ga-g][#b]?/),i=t?t[0]:"C";return i[0].toUpperCase()+i.slice(1)}const Yt={Major:[0,4,7],Minor:[0,3,7],"Suspended (sus)":[0,5,7],Diminished:[0,3,6]};function Ge(e,t,i,o){const s=Q[e]??0;let r=Yt[t]||Yt.Major;return i==="6th"?r=[...r,9]:i==="7th (dom / m7)"?r=[...r,10]:i==="Major 7th (M7)"?r=[...r,11]:i==="9th"&&(r=[...r,10,14]),r.map(n=>D(s+n,o))}const Rs={Major:"",Minor:"m","Suspended (sus)":"sus",Diminished:"dim"},Ls={None:"","6th":"6","7th (dom / m7)":"7","Major 7th (M7)":"maj7","9th":"9"};function yi(e,t,i){return t==="Minor"&&i==="Major 7th (M7)"?`${e}m(maj7)`:`${e}${Rs[t]??""}${Ls[i]??""}`}const vi=["C","D","E","F","G","A","B"],Mt=10,Ve=vi.indexOf("E")+4*7,Us=Ve+4*2,yt=20,xi=yt+4*Mt,js={C:[],G:["F#"],D:["F#","C#"],A:["F#","C#","G#"],E:["F#","C#","G#","D#"],B:["F#","C#","G#","D#","A#"],"F#":["F#","C#","G#","D#","A#","E#"],F:["Bb"],Bb:["Bb","Eb"],Eb:["Bb","Eb","Ab"],Ab:["Bb","Eb","Ab","Db"],Db:["Bb","Eb","Ab","Db","Gb"]},zs={MAJOR:0,LYDIAN:5,MIXOLYDIAN:7,DORIAN:2,NATURAL_MINOR:9,HARMONIC_MINOR:9},wi={};be.forEach(e=>{wi[Q[e]]=e});function ki(e,t){const i=zs[t]??0,s=(((Q[e]??0)-i)%12+12)%12;return wi[s]??"C"}function Si(e,t){return js[ki(e,t)]??[]}function oe(e,t){const i=ki(e,t);return hs.has(i)||i.includes("b")}function _e(e,t){return D(Q[e]??0,oe(e,t))}const qt={"F#":38,"C#":35,"G#":39,"D#":36,"A#":33,"E#":37,"B#":34,Bb:34,Eb:37,Ab:33,Db:36,Gb:32,Cb:35,Fb:31};function Gs(e){let t=4,i=-1;return e.map(o=>{const s=vi.indexOf(o[0].toUpperCase());return i!==-1&&s<=i&&t++,i=s,s+t*7})}function he(e){return xi-(e-Ve)*(Mt/2)}const Te=10,lt=46,Ht=26,Wt=14;function Vs(e,t,i){const o=Si(t,i),s=8,r=o.length?o.length*s+6:0,n=o.map(S=>qt[S]),c=e.map(S=>Gs(S.notes)),l=c.flat(),d=Math.min(yt,...l.map(he),...n.map(he)),p=Math.max(xi,...l.map(he),...n.map(he)),a=Te+Wt-d,g=p-d+12+Te+Wt,m=[0,1,2,3,4].map(S=>yt+S*Mt+a),x=Te+Ht+r,f=o.map((S,I)=>({x:Te+Ht+I*s,y:he(qt[S])+a,sign:S.includes("#")?"sharp":"flat"})),y=e.map((S,I)=>{const w=x+I*lt+lt/2,O=c[I],_=O.map(F=>({x:w,y:he(F)+a})),K=[];O.forEach(F=>{(F-Ve)%2===0&&(F<Ve||F>Us)&&K.push({x:w-9,y:he(F)+a})});const b=Math.min(..._.map(F=>F.y))-10;return{cx:w,name:S.name,roman:S.roman,notes:_,ledgers:K,labelY:b}});return{width:x+e.length*lt+Te,height:g,lines:m,keySignature:f,chords:y}}function Ys(e,t,i){const o=bt(e.name),s=o.includes("b");return{...e,name:yi(o,t,i),notes:Ge(o,t,i,s)}}function R(e,t,i,o,s,r,n,c){const l=yi(e,t,i),d=Ge(e,t,i,c);return{name:l,tag:o||"sub",roman:o,color:We(n),functionLabel:s,notes:d,scaleLabel:"Substitution",desc:r,degree:"SUBSTITUTION",scaleKey:"",tension:n}}function Ti(e,t,i){const o=Q[t.key]??0,s=t.scaleType.includes("MINOR"),r=oe(t.key,t.scaleType),n=s?[(()=>{const p=D(o+1,!0),a=R(p,"Major","Major 7th (M7)","♭II","Neapolitan","a dark, dramatic slide in from a half-step above",.6,!0);return{name:a.name,roman:"♭II",notes:a.notes,sub:"Neapolitan chord — a dramatic slide in from a half-step above",chord:a,tension:.6}})(),(()=>{const p=D(o+5,!0),a=R(p,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.45,!0);return{name:a.name,roman:"iv",notes:a.notes,sub:"the minor subdominant — deeper minor mood",chord:a,tension:.45}})(),(()=>{const p=D(o+10,!0),a=R(p,"Minor","7th (dom / m7)","v","Minor dominant","unresolved minor drift",.52,!0);return{name:a.name,roman:"v",notes:a.notes,sub:"a step further into shadow — unresolving drift",chord:a,tension:.52}})()]:[(()=>{const p=D(o+8,!0),a=R(p,"Major","Major 7th (M7)","♭VI","Flat submediant",`borrowed from ${t.key} minor — the cinematic shadow`,.5,!0);return{name:a.name,roman:"♭VI",notes:a.notes,sub:`borrowed from ${t.key} minor — the cinematic shadow`,chord:a,tension:.5}})(),(()=>{const p=D(o+5,!0),a=R(p,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.42,!0);return{name:a.name,roman:"iv",notes:a.notes,sub:"the minor subdominant — softer, sadder",chord:a,tension:.42}})(),(()=>{const p=D(o+3,!0),a=R(p,"Major","Major 7th (M7)","♭III","Flat mediant","a step further out — cooler, more remote",.58,!0);return{name:a.name,roman:"♭III",notes:a.notes,sub:"a step further out — cooler, more remote",chord:a,tension:.58}})()],c=[(()=>{const p=D(o+7,r),a=D(o+2,r),g=R(a,"Major","7th (dom / m7)","V7/V","Secondary dominant",`aimed at ${p}7 — sharpens the approach`,.82,r);return{name:g.name,roman:"V7/V",notes:g.notes,sub:`aimed at ${p}7 — sharpens the approach`,chord:g,tension:.82}})(),(()=>{const p=D(o+(s?3:9),r),a=D(o+4,r),g=R(a,"Major","7th (dom / m7)","V7/vi","Secondary dominant",`aimed at ${p}m7 — makes it feel arrived at`,.88,r);return{name:g.name,roman:"V7/vi",notes:g.notes,sub:`aimed at ${p}m7 — makes it feel arrived at`,chord:g,tension:.88}})(),(()=>{const p=D(o+1,!0),a=R(p,"Major","7th (dom / m7)","subV7","Tritone substitute","a tritone substitute — slides in sideways",.95,!0);return{name:a.name,roman:"subV7",notes:a.notes,sub:"a tritone substitute — slides in sideways",chord:a,tension:.95}})()],l=[(()=>{const p=D(o+5,r),a=R(p,"Major","Major 7th (M7)",s?"IV":"IVmaj7","Subdominant","floats rather than resolving",.3,r);return{name:a.name,roman:"IV",notes:a.notes,sub:"floats rather than resolving",chord:a,tension:.3}})(),(()=>{const p=D(o,r),a=R(p,s?"Minor":"Major","9th",s?"im9":"Imaj9","Tonic extension","the same home with more air in it",.18,r);return{name:a.name,roman:s?"im9":"Imaj9",notes:a.notes,sub:"the same home with more air in it",chord:a,tension:.18}})(),(()=>{const p=D(o+(s?3:4),r),a=R(p,s?"Major":"Minor","7th (dom / m7)",s?"♭III":"iii","Mediant","wistful, halfway between home and away",.35,r);return{name:a.name,roman:s?"♭III":"iii",notes:a.notes,sub:"wistful, halfway between home and away",chord:a,tension:.35}})()],d=[(()=>{const p=D(o,r),a=R(p,s?"Minor":"Major",s?"None":"Major 7th (M7)",s?"i":"I","Tonic","full resolution — the sense of arriving",.05,r);return{name:a.name,roman:s?"i":"I",notes:a.notes,sub:"full resolution — the sense of arriving",chord:a,tension:.05}})(),(()=>{const p=D(o+7,r),a=R(p,"Major","7th (dom / m7)","V7","Dominant","the pull that makes home feel earned",1,r);return{name:a.name,roman:"V7",notes:a.notes,sub:"the pull that makes home feel earned",chord:a,tension:1}})(),(()=>{const p=D(o+(s?8:9),r),a=R(p,s?"Major":"Minor","7th (dom / m7)",s?"♭VI":"vi","Submediant","a soft landing instead of a full stop",.28,r);return{name:a.name,roman:s?"♭VI":"vi",notes:a.notes,sub:"a soft landing instead of a full stop",chord:a,tension:.28}})()];return[{name:"Darker",sub:"heavier, more shadow",tension:.55,rows:n},{name:"More tension",sub:"sharper pull forward",tension:.85,rows:c},{name:"Dreamier",sub:"softer, more air",tension:.3,rows:l},{name:"Resolve home",sub:"settles back to center",tension:.05,rows:d}]}function qs(e,t,i){const o=Q[t.key]??0,s=t.scaleType.includes("MINOR"),r=oe(t.key,t.scaleType),n=t.chords;if(s){const f=n[0]?.name||"chord 1",y=n[1]?.name||"chord 2",k=n[2]?.name||"chord 3",S=n[3]?.name||"chord 4",I=R(D(o,r),"Major","None","I","Major tonic","same root, turned bright",.2,r),w=R(D(o+5,r),"Major","None","IV","Major subdominant","the Dorian lift, sunny and open",.35,r),O=R(D(o+9,r),"Minor","None","vi","Submediant","melodic lift upward",.4,r),_=R(D(o+11,r),"Diminished","None","vii°","Leading tone","classical harmonic pull",.55,r);return[{name:I.name,sub:`in place of ${f} · same root, turned bright`,roman:"I",notes:I.notes,chord:I,tension:.2},{name:w.name,sub:`in place of ${y} · the Dorian lift, sunny and open`,roman:"IV",notes:w.notes,chord:w,tension:.35},{name:O.name,sub:`in place of ${k} · melodic lift upward`,roman:"vi",notes:O.notes,chord:O,tension:.4},{name:_.name,sub:`in place of ${S} · classical harmonic pull`,roman:"vii°",notes:_.notes,chord:_,tension:.55}]}const c=n[0]?.name||"chord 1",l=n[1]?.name||"chord 2",d=n[2]?.name||"chord 3",p=n[3]?.name||"chord 4",a=R(D(o,r),"Minor","None","i","Tonic minor","same root, turned sad",.3,r),g=R(D(o+5,!0),"Minor","None","iv","Minor subdominant","the lift, but heavier",.4,!0),m=R(D(o+8,!0),"Major","None","♭VI","Flat submediant","big and cinematic",.45,!0),x=R(D(o+10,!0),"Major","None","♭VII","Flat subtonic","lands sideways, not home",.5,!0);return[{name:a.name,sub:`in place of ${c} · same root, turned sad`,roman:"i",notes:a.notes,chord:a,tension:.3},{name:g.name,sub:`in place of ${l} · the lift, but heavier`,roman:"iv",notes:g.notes,chord:g,tension:.4},{name:m.name,sub:`in place of ${d} · big and cinematic`,roman:"♭VI",notes:m.notes,chord:m,tension:.45},{name:x.name,sub:`in place of ${p} · lands sideways, not home`,roman:"♭VII",notes:x.notes,chord:x,tension:.5}]}function Hs(e,t,i){return Ti(e,t).map(s=>{const r=s.rows[0];return{label:s.name,sub:s.sub,chord:r.chord,functionCaption:`${r.roman} · ${r.notes.join(" · ")}`,rationale:r.sub}})}const Ws={m8:"https://warmsynths.github.io/hypersyn-chord-helper/",circuit:"https://warmsynths.github.io/circuit-chords/"},Xs={m8:43303,circuit:43302};function Js(e,t,i){let o=Ws[t];typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(o=`http://localhost:${Xs[t]}/`);const r=(i&&i.length>0?i.map(n=>e.chords[n]).filter(n=>!!n):e.chords).map(n=>encodeURIComponent(n.name)).join("+");return`${o}?p=${r}`}class Ks{constructor(){this.mode="single",this.progression=null,this.order=[],this.sections=[],this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.playing=!1,this.instrument=null,this.playStyle=null,this.autoplayTimer=null,this.tickCallbacks=new Set,this.abOverride=null}setProgression(t,i){this.mode="single",this.progression=t,t?this.order=i||Array.from({length:t.chords.length},(o,s)=>s):this.order=[]}setSong(t){this.mode="song",this.sections=t,this.songStep=0,this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}isSongMode(){return this.mode==="song"}getActiveSectionIndex(){return this.activeSectionIndex}getTotalSteps(){return this.mode==="song"?this.sections.reduce((t,i)=>t+i.order.length,0):this.order.length}setOrder(t,i){this.order=t,typeof i=="number"&&(this.activeIndex=i)}setInstrument(t){this.instrument=t}setPlayStyle(t){this.playStyle=t}isPlaying(){return this.playing}getActiveIndex(){return this.activeIndex}getProgressStep(){return this.mode==="song"?this.songStep:this.progressStep}subscribeTick(t){return this.tickCallbacks.add(t),()=>this.tickCallbacks.delete(t)}notifyTick(){const t=this.getTotalSteps();this.mode==="song"?this.tickCallbacks.forEach(i=>i(this.activeIndex,this.songStep,this.activeSectionIndex,t,!0)):this.tickCallbacks.forEach(i=>i(this.activeIndex,this.progressStep,0,t,!1))}updateSongStepState(t){let i=0;for(let o=0;o<this.sections.length;o++){const s=this.sections[o].order.length;if(t<i+s){this.activeSectionIndex=o;const r=t-i;this.activeIndex=this.sections[o].order[r]??0,this.progressStep=r;return}i+=s}this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}startAutoplay(){this.stopAutoplay(),this.autoplayTimer=setInterval(()=>{if(this.playing){if(this.mode==="song"){const t=this.getTotalSteps();if(t<=0)return;this.songStep=(this.songStep+1)%t,this.updateSongStepState(this.songStep)}else{if(!this.progression||this.order.length<=0)return;this.activeIndex=(this.activeIndex+1)%this.order.length,this.progressStep=(this.progressStep+1)%this.order.length}this.playActiveChord(),this.notifyTick()}},At)}stopAutoplay(){this.autoplayTimer&&(clearInterval(this.autoplayTimer),this.autoplayTimer=null)}togglePlay(){return this.playing?(this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.stopAutoplay(),this.notifyTick()):(this.playing=!0,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.mode==="song"&&this.sections.length>0&&this.updateSongStepState(0),this.startAutoplay(),this.playActiveChord(),this.notifyTick()),this.playing}setABOverride(t,i,o){t===null?this.abOverride=null:this.abOverride={index:t,chord:i,side:o}}clearABOverride(){this.abOverride=null}playActiveChord(){if(this.mode==="song"){const t=this.sections[this.activeSectionIndex];if(!t)return;const i=this.activeIndex,o=t.progression.chords[i];if(o){const r=(o.notes&&o.notes.length>0?o.notes:Me(o.name,oe(t.progression.key,t.progression.scaleType))).map(n=>`${n}4`);Ut(r,t.progression.genre,{bpm:t.progression.bpm,duration:1.2,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0})}}else{if(!this.progression)return;const t=this.order[this.activeIndex]??0;let i=this.progression.chords[t];if(this.abOverride&&this.abOverride.index===t&&this.abOverride.side==="after"&&this.abOverride.chord&&(i=this.abOverride.chord),i){let o=Array.isArray(i.notes)?i.notes:[];if(o.length===0||!o.every(s=>typeof s=="string"&&s.trim().length>0)){const s=i.name||"CMAJ",r=this.progression.key||"C",n=this.progression.scaleType||"MAJOR";o=Me(s,oe(r,n))}this.playChordNotes(o,1.2)}}}playChordAtIndex(t,i=.8){if(!this.progression||!this.progression.chords[t])return;const o=this.progression.chords[t];let s=Array.isArray(o.notes)?o.notes:[];if(s.length===0||!s.every(r=>typeof r=="string"&&r.trim().length>0)){const r=o.name||"CMAJ",n=this.progression.key||"C",c=this.progression.scaleType||"MAJOR";s=Me(r,oe(n,c))}this.playChordNotes(s,i)}playChordNotes(t,i){if(!this.progression)return;const o=Array.isArray(t)?t.filter(n=>typeof n=="string"&&n.trim().length>0):[];if(o.length===0)return;const r=o.map(n=>n.replace(/\d+$/,"")).map(n=>`${n}4`);Ut(r,this.progression.genre||"Unknown",{bpm:this.progression.bpm||120,duration:i||.8,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0})}jumpToStep(t){!this.progression||this.order.length<=0||(this.activeIndex=t%this.order.length,this.progressStep=t%this.order.length,this.playActiveChord(),this.notifyTick())}reset(){this.stopAutoplay(),this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.notifyTick()}}const T=new Ks,Qs=le.map(e=>e.name),Zs=["rhodes","epiano","guitar","pad-strings","bell","organ","juno-pad","stab"];function eo(e,t){const i=e.length+1,o=t.length+1,s=Array.from({length:i},()=>new Array(o).fill(0));for(let r=0;r<i;r++)s[r][0]=r;for(let r=0;r<o;r++)s[0][r]=r;for(let r=1;r<i;r++)for(let n=1;n<o;n++)s[r][n]=e[r-1]===t[n-1]?s[r-1][n-1]:1+Math.min(s[r-1][n-1],s[r-1][n],s[r][n-1]);return s[i-1][o-1]}function pe(e,t){if(typeof e!="string")return null;const i=e.trim();if(!i)return null;const o=i.toLowerCase(),s=t.find(l=>l.toLowerCase()===o);if(s)return s;let r=null,n=1/0;for(const l of t){const d=eo(o,l.toLowerCase());d<n&&(n=d,r=l)}const c=Math.max(2,Math.floor(o.length*.4));return n<=c?r:null}function to(e){if(!Array.isArray(e))return;const t=[];for(const i of e){if(!i||typeof i!="object")continue;const o=i,s=pe(o.root,be),r=pe(o.quality,ps);s&&r&&t.push({root:s,quality:r})}if(t.length)return t.slice(0,ee)}function io(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t=e,i=pe(t.presetId,Zs)??(typeof t.presetId=="string"&&t.presetId.trim()?t.presetId.trim():void 0);if(!i)return;const o=t.customConfig&&typeof t.customConfig=="object"&&!Array.isArray(t.customConfig)?t.customConfig:void 0;return{presetId:i,customConfig:o}}function ct(e,t){const i=e&&typeof e=="object"?e:{},o=pe(i.genre,Ne)??t.genre,s=pe(i.mood,Qs)??t.mood,r=pe(i.key,be)??void 0,n=pe(i.scaleType,ms)??void 0,c=r&&n?to(i.chords):void 0;let l;typeof i.length=="number"&&Number.isFinite(i.length)&&(l=Math.max(ue,Math.min(ee,Math.round(i.length))));const d=typeof i.rhythmStyle=="string"&&i.rhythmStyle.trim()?i.rhythmStyle.trim():void 0,p=io(i.instrumentConfig),a=i._rateLimit&&typeof i._rateLimit=="object"?i._rateLimit:void 0;return{genre:o,mood:s,key:r,scaleType:n,length:l,chords:c,rhythmStyle:d,instrumentConfig:p,_rateLimit:a}}const so=[{id:"deepseek-v4-flash-free",name:"DeepSeek V4 Flash Free",provider:"opencodeai",vendor:"DeepSeek"},{id:"mimo-v2.5-free",name:"MiMo V2.5 Free",provider:"opencodeai",vendor:"Xiaomi"},{id:"laguna-s-2.1-free",name:"Laguna S 2.1 Free",provider:"opencodeai",vendor:"Stealth"},{id:"ling-3.0-flash-free",name:"Ling-3.0-flash Free",provider:"opencodeai",vendor:"Stealth"},{id:"nemotron-3-ultra-free",name:"Nemotron 3 Ultra Free",provider:"opencodeai",vendor:"NVIDIA"},{id:"north-mini-code-free",name:"North Mini Code Free",provider:"opencodeai",vendor:"Stealth"}],vt=[{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash-Lite",provider:"google",vendor:"Google"},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",provider:"google",vendor:"Google"},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash",provider:"google",vendor:"Google"}],Ii="chroma-chords-llm-provider",Ci="chroma-chords-llm-model";function Ai(){const e=localStorage.getItem(Ii);return e==="opencodeai"||e==="anthropic"||e==="openrouter"||e==="google"?e:"google"}function oo(e){localStorage.setItem(Ii,e)}function Ni(){const e=localStorage.getItem(Ci);return e?e==="gemini-1.5-flash"||e==="gemini-2.0-flash"||e==="gemini-2.5-flash"||e==="gemini-3.5-flash"||e==="gemini-1.5-pro"?"gemini-3.1-flash-lite":e:vt[0].id}function dt(e){localStorage.setItem(Ci,e)}const ht={genre:Ne[0],mood:le[0].name},Mi="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev",ro=12e3;async function no(){try{const e=await fetch(Mi);if(e.ok)return await e.json()}catch{}return null}const $i={Uplifting:["happy","joy","bright","hope","celebrat","win","sun","morning","triumph"],Melancholy:["sad","rain","lonely","grief","loss","blue","tear","goodbye"],Dreamy:["dream","float","cloud","soft","sleep","hazy","ethereal","stars"],Tense:["fear","anxious","dark","storm","fight","chase","danger","thriller"],Warm:["cozy","home","fire","love","autumn","familiar","fireplace"],Nostalgic:["memory","childhood","old","faded","remember","summer","photo","yearbook"],Energetic:["energetic","pumped","hype","fast","running","workout","power","fire"],Dark:["dark","creepy","night","evil","shadow","gothic","gloomy"],Peaceful:["peaceful","calm","quiet","zen","relax","nature","gentle","still"],Groovy:["groovy","funky","danceable","rhythm","swing","bounce","jam"],Epic:["epic","heroic","grand","triumphant","majestic","legendary","glory"]},Ei={Pop:["pop","radio","dance","catchy","hit"],"Lo-fi/Chill":["lofi","lo-fi","study","bedroom","tape","chill","relax"],"R&B/Soul":["rnb","r&b","soul","smooth","slow jam","sultry"],"Indie/Folk":["folk","acoustic","campfire","porch","story","indie"],Synthwave:["synth","80s","neon","retro","synthwave","arcade"],"Jazz-ish":["jazz","smoky","bar","lounge","late night","saxophone"],Gospel:["gospel","church","choir","soulful","worship"],Cinematic:["movie","film","epic","trailer","scene","cinematic"],Rock:["rock","guitar","drive","loud","energy","highway"],"House/Dance":["house","edm","club","rave","four on the floor","dance floor"],Blues:["blues","12 bar","delta","chicago blues","harmonica"],"Funk/Disco":["funk","funky","groovy","disco","slap bass","boogie"],"Country/Bluegrass":["country","bluegrass","nashville","banjo","twang"],"Reggae/Dub":["reggae","dub","jamaica","ska","offbeat","roots"],Metal:["metal","heavy metal","thrash","riff","shred","headbang","metallica","megadeth","slayer","iron maiden"],Punk:["punk","garage","mosh","rebel","skate"],"Ambient/Drone":["ambient","drone","atmospheric","soundscape","meditation","space"],"Trap/Hip-Hop":["trap","hiphop","hip-hop","rap","808","beat"],"Bossa Nova/Latin":["bossa","bossa nova","samba","latin","rio","habanera"],"Classical/Orchestral":["classical","orchestra","symphony","concerto","violin","chamber"],"EDM/Trance":["trance","techno","buildup","drop","festival"],Afrobeats:["afrobeats","afropop","lagos","highlife","afro"],Shoegaze:["shoegaze","fuzz","wall of sound","dream pop","gazer"]};function Ye(e,t){const i=e.toLowerCase();let o=null,s=0;return Object.keys(t).forEach(r=>{const n=t[r].reduce((c,l)=>c+(i.includes(l)?1:0),0);n>s&&(s=n,o=r)}),o}function Oi(e){const t=Ye(e,Ei),i=Ye(e,$i);return!t||!i?null:{genre:t,mood:i}}async function ao(e){const t=new AbortController,i=setTimeout(()=>t.abort(),ro);try{const s=await fetch(Mi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:e,provider:Ai(),model:Ni()}),signal:t.signal}),r=await s.json().catch(()=>null);if(!s.ok||r&&typeof r=="object"&&"error"in r){const n=r&&typeof r=="object"&&"error"in r?String(r.error):`HTTP ${s.status}`,c=new Error(`Classifier request failed: ${n}`);throw r&&typeof r=="object"&&"_rateLimit"in r&&(c._rateLimit=r._rateLimit),c}return r}finally{clearTimeout(i)}}async function lo(e){const t=e.trim(),i=t.toLowerCase();if(i.startsWith("mock")||i.startsWith("test")){const s=t.replace(/^(mock|test)\s*:?\s*/i,"").trim(),r=Ye(s,Ei)??"Synthwave",n=Ye(s,$i)??"Dreamy",c={Metal:"stab",Rock:"guitar",Punk:"stab","Lo-fi/Chill":"epiano",Synthwave:"juno-pad","EDM/Trance":"juno-pad",Gospel:"organ","Reggae/Dub":"organ","Country/Bluegrass":"guitar","Bossa Nova/Latin":"guitar","Ambient/Drone":"pad-strings",Cinematic:"pad-strings","Classical/Orchestral":"pad-strings","Jazz-ish":"rhodes",Pop:"rhodes","R&B/Soul":"epiano"},l={Metal:"heavy_strum",Rock:"driving_strum",Punk:"fast_power_strum","Lo-fi/Chill":"slow_arpeggio",Synthwave:"retro_16th_arp","EDM/Trance":"fast_triplets",Gospel:"block_chords","Reggae/Dub":"offbeat_ska","Jazz-ish":"swing_feel","Bossa Nova/Latin":"syncopated_bossa","Ambient/Drone":"sustained_pad","Classical/Orchestral":"slow_arpeggio",Pop:"straight_8ths"},d={Metal:{key:"E",scaleType:"NATURAL_MINOR",chords:[{root:"E",quality:"min"},{root:"G",quality:"maj"},{root:"D",quality:"maj"},{root:"C",quality:"maj"},{root:"E",quality:"min"},{root:"A",quality:"min"},{root:"B",quality:"dom7"},{root:"E",quality:"min"}]},Rock:{key:"A",scaleType:"MAJOR",chords:[{root:"A",quality:"maj"},{root:"D",quality:"maj"},{root:"E",quality:"dom7"},{root:"F#",quality:"min"},{root:"D",quality:"maj"},{root:"A",quality:"maj"},{root:"E",quality:"dom7"},{root:"A",quality:"maj"}]},"Jazz-ish":{key:"F",scaleType:"DORIAN",chords:[{root:"F",quality:"min7"},{root:"A#",quality:"dom7"},{root:"D#",quality:"maj7"},{root:"G#",quality:"maj7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"min7"},{root:"F",quality:"dom7"}]},"Lo-fi/Chill":{key:"C",scaleType:"DORIAN",chords:[{root:"C",quality:"min7"},{root:"F",quality:"maj7"},{root:"A#",quality:"maj7"},{root:"D#",quality:"maj7"},{root:"C",quality:"min7"},{root:"D#",quality:"maj7"},{root:"F",quality:"min7"},{root:"G",quality:"min7"}]},Gospel:{key:"C",scaleType:"MAJOR",chords:[{root:"C",quality:"maj"},{root:"E",quality:"min7"},{root:"F",quality:"maj7"},{root:"G",quality:"dom7"},{root:"A",quality:"min7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"maj"}]},_default:{key:"F#",scaleType:"DORIAN",chords:[{root:"F#",quality:"min7"},{root:"B",quality:"maj"},{root:"C#",quality:"min7"},{root:"E",quality:"maj"},{root:"F#",quality:"min7"},{root:"A",quality:"maj7"},{root:"B",quality:"min7"},{root:"C#",quality:"dom7"}]}},p=d[r]||d._default,a=c[r]||"rhodes",g=l[r]||"slow_arpeggio",m={genre:r,mood:n,key:p.key,scaleType:p.scaleType,length:8,chords:p.chords,rhythmStyle:g,instrumentConfig:{presetId:a,customConfig:{envelope:{attack:.05,decay:.5,sustain:.6,release:1.2}}}};return ct(m,{genre:r,mood:n})}const o=Oi(e);try{const s=await ao(e);return ct(s,o??ht)}catch(s){console.warn("LLM classification failed, falling back to keyword heuristic:",s);const r=ct(o??ht,ht);return s&&typeof s=="object"&&"_rateLimit"in s&&(r._rateLimit=s._rateLimit),r}}class co{static async resolvePrompt(t,i,o,s,r,n){let c=n||null,l=null,d=null;if(!c&&r&&r.trim().length>0)try{c=await lo(r)}catch(g){console.warn("Failed to classify prompt via LLM/local fallback:",g)}const p=!!(c&&c.chords?.length&&c.key&&c.scaleType);let a=null;return p&&c&&c.chords&&c.key&&c.scaleType&&(a=Ps(t,c.key,c.scaleType,c.chords,c.genre||i,c.mood||o)),a||(a=ft(t,i,o,{length:s})),p&&c&&(c.instrumentConfig?.presetId&&(l=ns(c.instrumentConfig.presetId)??null),c.rhythmStyle&&(d=as(c.rhythmStyle)??null)),a.chords.length>s&&(a={...a,chords:a.chords.slice(0,s)}),r&&(a={...a,searchTerm:r}),{progression:a,instrument:l,playStyle:d,normalizedSuggestion:c}}}const Ce=[{name:"Verse",desc:"Settled, familiar.",reorder:e=>Array.from({length:e},(t,i)=>i)},{name:"Chorus",desc:"Brighter, opens the key up.",reorder:e=>Array.from({length:e},(t,i)=>(i+Math.ceil(e/2))%e)},{name:"Pre-chorus",desc:"Leans in, sets up the turn.",reorder:e=>Array.from({length:e},(t,i)=>(i+1)%e)},{name:"Bridge",desc:"Detours, borrows a shadow chord.",reorder:e=>Array.from({length:e},(t,i)=>e-1-i)},{name:"Outro",desc:"Settles back down.",reorder:e=>Array.from({length:e},(t,i)=>(i-1+e)%e)}];class Re{static createInitialSong(t,i){const o=i||Array.from({length:t.chords.length},(s,r)=>r);return[{name:Ce[0].name,desc:Ce[0].desc,progression:t,order:o.slice()}]}static addSection(t,i){if(t.length>=Ce.length)return{sections:t,activeIndex:t.length-1};const o=Ce[t.length],s=o.reorder(i.chords.length),r={name:o.name,desc:o.desc,progression:i,order:s},n=[...t,r];return{sections:n,activeIndex:n.length-1}}static syncActiveSection(t,i,o,s){if(!t[i])return t;const r=[...t];return r[i]={...r[i],progression:o,order:s.slice()},r}}var ho=Object.defineProperty,po=Object.getOwnPropertyDescriptor,$t=(e,t,i,o)=>{for(var s=o>1?void 0:o?po(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&ho(t,i,s),s};const xt=["bean","bird","cat","note"];function ve(e=.45){return{show:Math.random()<e,kind:xt[Math.floor(Math.random()*xt.length)]}}function Ee(e){return e[Math.floor(Math.random()*e.length)]}class Et{constructor(t=7,i=1800){this.threshold=t,this.windowMs=i,this.count=0,this.lastClickAt=0}click(){const t=Date.now();return t-this.lastClickAt>this.windowMs&&(this.count=0),this.lastClickAt=t,this.count+=1,this.count>=this.threshold?(this.count=0,!0):!1}}const uo={bean:{width:92,height:86},bird:{width:88,height:88},cat:{width:90,height:88},note:{width:74,height:67}};let Oe=class extends W{constructor(){super(...arguments),this.kind="bean",this.scale=1}willUpdate(e){if(e.has("kind")||e.has("scale")){const{width:t,height:i}=uo[this.kind];this.style.width=`${t*this.scale}px`,this.style.height=`${i*this.scale}px`}}renderBean(){const e="#D98A54";return h`
    ...
    `}render(){const e=this.kind==="bird"?this.renderBird():this.kind==="cat"?this.renderCat():this.kind==="note"?this.renderNote():this.renderBean();return e?h`<div style="transform:scale(${this.scale}); transform-origin:top left;">${e}</div>`:hi}};Oe.styles=H`
    :host {
      display: block;
      pointer-events: none;
      user-select: none;
  ...
  `;$t([v({type:String})],Oe.prototype,"kind",2);$t([v({type:Number})],Oe.prototype,"scale",2);Oe=$t([X("mascot-character")],Oe);const G=4,ne=45e3,Xt="chroma_chords_capacity_v2";class go{constructor(){this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=Date.now(),this.timer=null,this.subscribers=new Set,this.init()}init(){try{if(typeof localStorage<"u"){const t=localStorage.getItem(Xt),i=Date.now();if(t){const o=JSON.parse(t),s=typeof o.charges=="number"?o.charges:G,r=typeof o.lastTime=="number"?o.lastTime:i;if(s<G){const n=Math.max(0,i-r),c=Math.floor(n/ne);this.charges=Math.min(G,s+c);const l=n%ne;this.rechargeNextSec=Math.max(1,Math.ceil((ne-l)/1e3)),this.lastCapacityTime=i-l}else this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=i}else this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=i}}catch{this.charges=G,this.rechargeNextSec=45}this.save(),this.startTimer()}save(){try{typeof localStorage<"u"&&localStorage.setItem(Xt,JSON.stringify({charges:this.charges,lastTime:this.lastCapacityTime}))}catch{}}startTimer(){this.timer&&clearInterval(this.timer),this.timer=setInterval(()=>{if(this.charges<G){const t=Date.now(),i=Math.max(0,t-this.lastCapacityTime);if(i>=ne){const s=Math.floor(i/ne);this.charges=Math.min(G,this.charges+s),this.lastCapacityTime=t-i%ne,this.save()}const o=(t-this.lastCapacityTime)%ne;this.rechargeNextSec=Math.max(1,Math.ceil((ne-o)/1e3))}else this.rechargeNextSec=45;this.notify()},1e3)}getState(){return{charges:this.charges,max:G,rechargeNextSec:this.rechargeNextSec}}getCharges(){return this.charges}getRechargeNextSec(){return this.rechargeNextSec}getCapacityMax(){return G}spendCharge(){return this.charges<=0?(this.notify(),!1):(this.charges===G&&(this.lastCapacityTime=Date.now()),this.charges-=1,this.save(),this.notify(),!0)}subscribe(t){return this.subscribers.add(t),t(this.getState()),()=>{this.subscribers.delete(t)}}notify(){const t=this.getState();this.subscribers.forEach(i=>{try{i(t)}catch(o){console.error("Error in CapacityService subscriber callback:",o)}})}}const wt=new go;var mo=Object.defineProperty,fo=Object.getOwnPropertyDescriptor,Ot=(e,t,i,o)=>{for(var s=o>1?void 0:o?fo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&mo(t,i,s),s};const kt=3200;let De=class extends W{constructor(){super(...arguments),this.trigger=0,this.visible=!1,this.hideTimer=null}updated(e){e.has("trigger")&&this.trigger>0&&(this.visible=!0,this.hideTimer&&clearTimeout(this.hideTimer),this.hideTimer=setTimeout(()=>{this.visible=!1},kt))}disconnectedCallback(){super.disconnectedCallback(),this.hideTimer&&clearTimeout(this.hideTimer)}render(){return this.visible?h`
  ...
  `;q([v({type:Boolean})],V.prototype,"compact",2);q([v({type:Boolean})],V.prototype,"hideCapacity",2);q([v({type:Boolean})],V.prototype,"isAdmin",2);q([v({type:Number})],V.prototype,"capacityCharges",2);q([v({type:Number})],V.prototype,"capacityMax",2);q([v({type:Number})],V.prototype,"rechargeNextSec",2);q([v({type:Boolean})],V.prototype,"isAuthenticated",2);q([v({type:String})],V.prototype,"userEmail",2);q([v({type:Number})],V.prototype,"savedCount",2);q([v({type:String})],V.prototype,"syncStatus",2);q([v({type:String})],V.prototype,"title",2);q([u()],V.prototype,"accountMenuOpen",2);q([u()],V.prototype,"showCapacityNote",2);V=q([X("app-header")],V);var vo=Object.defineProperty,xo=Object.getOwnPropertyDescriptor,E=(e,t,i,o)=>{for(var s=o>1?void 0:o?xo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&vo(t,i,s),s};const wo=[{side:"left",top:"20%"},{side:"left",top:"62%"},{side:"right",top:"30%"},{side:"right",top:"68%"}],ko=["#F2A79B","#9CC0EC","#F6D98B"],So=[6,3,12],Jt=["rainy drive at 2am, first day of summer...","Portishead","Bohemian Rhapsody"],To=["Lo-fi/Chill","R&B/Soul","Pop","Synthwave"],Io=["Warm","Melancholy","Nostalgic","Dreamy"],pt=["Rummaging through crates of old vinyl...","Asking the chord wizards nicely...","Warming up the analog vacuum tubes...","Dusting off the Fender Rhodes...","Consulting the musical oracle...","Polishing major 7th chords...","Tuning the vintage synthesizer...","Translating feelings into frequencies...","Listening to the cosmic frequency...","Channeling 80s synthwave energy...","Humming a secret little melody...","Strumming invisible guitar strings...","Checking the vibe meters...","Brewing a fresh cup of lo-fi beats...","Setting the tape delay to 120ms...","Counting the beats per minute...","Mixing harmonizing magic...","Summoning smooth jazz cats...","Tweaking the resonance knob...","Scanning the musical multiverse..."];let M=class extends W{constructor(){super(...arguments),this.genre="Pop",this.mood="Dreamy",this.length=4,this.freeText="",this.placeholderIdx=0,this.llmSuggestion=null,this.llmResolved=!1,this.classifyError=null,this.expandedGenre=!1,this.expandedMood=!1,this.mascot=ve(.35),this.mascotSlot=Ee(wo),this.peekMascot=ve(.18),this.peekSide=Ee(["left","right"]),this.isAuthenticated=!1,this.userEmail=null,this.isAdmin=!1,this.isGenerating=!1,this.currentProvider=Ai(),this.currentModel=Ni(),this.showAdminModal=!1,this.isClassifying=!1,this.loadingMsgIdx=0,this.googleRemaining=15,this.googleLimit=15,this.googleCooldownSec=4,this.orRemaining=50,this.orLimit=50,this.capacityCharges=G,this.rechargeNextSec=45,this.showCapacityNote=!1,this.unsubscribeCapacity=null,this.loadingTimer=null,this.cooldownTimer=null,this.eggCounter=new Et,this.paradeTrigger=0,this.jellyBodies=[],this.animFrameId=null,this.mouseX=null,this.mouseY=null,this.physicsLoop=()=>{if(!this.isConnected)return;const e=performance.now(),t=this.getBoundingClientRect(),i=t.width>0?t.width:typeof window<"u"?window.innerWidth:800;let o=t.height>0?t.height:typeof window<"u"?window.innerHeight:600;const s=this.shadowRoot?.querySelector(".divider-row");if(s){const c=s.getBoundingClientRect();c.top>t.top&&(o=c.top-t.top)}const r=this.jellyBodies,n=r.length;for(let c=0;c<n;c++){const l=r[c];if(l.vx+=Math.sin(e*6e-4*l.driftFreqX+l.driftPhaseX)*l.driftForce,l.vy+=Math.cos(e*7e-4*l.driftFreqY+l.driftPhaseY)*l.driftForce,this.mouseX!==null&&this.mouseY!==null){const a=l.x-this.mouseX,g=l.y-this.mouseY,m=Math.hypot(a,g);if(m<140&&m>0){const x=(1-m/140)*.12;l.vx+=a/m*x,l.vy+=g/m*x}}l.vx*=l.drag,l.vy*=l.drag;const d=Math.hypot(l.vx,l.vy);d>l.maxSpeed&&(l.vx=l.vx/d*l.maxSpeed,l.vy=l.vy/d*l.maxSpeed),l.x+=l.vx,l.y+=l.vy,l.angle+=l.vRot;const p=l.radius;l.x<p?(l.x=p,l.vx=Math.abs(l.vx)*l.restitution+.02,l.squishX=.88,l.squishY=1.12):l.x>i-p&&(l.x=i-p,l.vx=-Math.abs(l.vx)*l.restitution-.02,l.squishX=.88,l.squishY=1.12),l.y<p?(l.y=p,l.vy=Math.abs(l.vy)*l.restitution+.02,l.squishX=1.12,l.squishY=.88):l.y>o-p&&(l.y=o-p,l.vy=-Math.abs(l.vy)*l.restitution-.02,l.squishX=1.12,l.squishY=.88),l.squishX+=(1-l.squishX)*.08,l.squishY+=(1-l.squishY)*.08}for(let c=0;c<n;c++)for(let l=c+1;l<n;l++){const d=r[c],p=r[l],a=p.x-d.x,g=p.y-d.y,m=Math.hypot(a,g),x=d.radius+p.radius;if(m<x&&m>0){const f=x-m,y=a/m,k=g/m;d.x-=y*f*.4,d.y-=k*f*.4,p.x+=y*f*.4,p.y+=k*f*.4;const S=d.vx-p.vx,I=d.vy-p.vy,w=(y*S+k*I)/(d.mass+p.mass),O=.35;d.vx-=w*p.mass*y*O,d.vy-=w*p.mass*k*O,p.vx+=w*d.mass*y*O,p.vy+=w*d.mass*k*O;const _=.12;d.squishX=Math.max(.85,1-_*Math.abs(y)),d.squishY=Math.max(.85,1-_*Math.abs(k)),p.squishX=Math.max(.85,1-_*Math.abs(y)),p.squishY=Math.max(.85,1-_*Math.abs(k))}}if(this.shadowRoot)for(let c=0;c<n;c++){const l=r[c],d=this.shadowRoot.getElementById(`jelly-${l.id}`);d&&(d.style.transform=`translate3d(${l.x-l.radius}px, ${l.y-l.radius}px, 0) rotate(${l.angle}deg) scale(${l.squishX}, ${l.squishY})`)}this.animFrameId=requestAnimationFrame(this.physicsLoop)},this.placeholderTimer=null,this.classifyDebounce=null,this.classifyToken=0,this.generate=()=>{if(!this.isGenerating){if(this.capacityCharges<=0){this.showCapacityNote=!0;return}this.spendCapacityCharge(),this.dispatchEvent(new CustomEvent("generate",{detail:{promptText:this.freeText.trim()},bubbles:!0,composed:!0}))}}}spendCapacityCharge(){const e=wt.spendCharge();return e||(this.showCapacityNote=!0),e}startLoadingTimer(){this.stopLoadingTimer(),this.loadingMsgIdx=Math.floor(Math.random()*pt.length),this.loadingTimer=setInterval(()=>{let e=Math.floor(Math.random()*pt.length);e===this.loadingMsgIdx&&(e=(e+1)%pt.length),this.loadingMsgIdx=e},800)}stopLoadingTimer(){this.loadingTimer&&(clearInterval(this.loadingTimer),this.loadingTimer=null)}onLoginClick(){this.dispatchEvent(new CustomEvent("request-login",{bubbles:!0,composed:!0}))}onLogoutClick(){this.dispatchEvent(new CustomEvent("request-logout",{bubbles:!0,composed:!0})),this.showAdminModal=!1}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}changeProvider(e){this.currentProvider=e,oo(e),e==="google"?(this.currentModel=vt[0].id,dt(this.currentModel)):e==="opencodeai"&&(this.currentModel=so[0].id,dt(this.currentModel))}changeModel(e){this.currentModel=e,dt(e)}initJellyBodies(){const e=this.getBoundingClientRect(),t=e.width>0?e.width:typeof window<"u"?window.innerWidth:800;let i=e.height>0?e.height:typeof window<"u"?window.innerHeight:600;const o=Math.min(i,400),s=[{key:"blob1",r:20},{key:"blob2",r:14},{key:"blob3",r:17},{key:"circle",r:16},{key:"pill",r:16},{key:"arch",r:15},{key:"squircle",r:16}],r=3,n=[];for(let c=0;c<r;c++){const l=s[c%s.length],d=l.r+30,p=d+Math.random()*Math.max(100,t-d*2),a=d+Math.random()*Math.max(50,o-d*2),g=.08+Math.random()*.18,m=.35+Math.random()*.25,x=.985,f=.006+Math.random()*.008,y=.35,k=Math.random()*Math.PI*2;n.push({id:c,shapeKey:l.key,width:l.r*2,height:l.r*2,x:p,y:a,vx:Math.cos(k)*g,vy:Math.sin(k)*g,maxSpeed:m,drag:x,driftForce:f,restitution:y,radius:l.r,mass:l.r*l.r,angle:Math.random()*360,vRot:(Math.random()-.5)*.05,squishX:1,squishY:1,driftPhaseX:Math.random()*Math.PI*2,driftPhaseY:Math.random()*Math.PI*2,driftFreqX:.6+Math.random()*.5,driftFreqY:.6+Math.random()*.5})}this.jellyBodies=n}onFrameMouseMove(e){const t=this.getBoundingClientRect();this.mouseX=e.clientX-t.left,this.mouseY=e.clientY-t.top}onFrameMouseLeave(){this.mouseX=null,this.mouseY=null}get currentLimit(){return this.currentProvider==="openrouter"?this.orLimit:this.googleLimit}get currentRemaining(){return this.currentProvider==="openrouter"?this.orRemaining:this.googleRemaining}loadKeyInfo(){no().then(e=>{e&&(e.google&&(this.googleLimit=e.google.limit,this.googleRemaining=e.google.remaining,this.googleCooldownSec=e.google.cooldownSeconds),e.openrouter&&(this.orLimit=e.openrouter.limit,this.orRemaining=e.openrouter.remaining),this.startCooldownTimer())})}startCooldownTimer(){this.cooldownTimer&&clearInterval(this.cooldownTimer),this.cooldownTimer=setInterval(()=>{this.googleRemaining<this.googleLimit?this.googleRemaining+=1:this.cooldownTimer&&(clearInterval(this.cooldownTimer),this.cooldownTimer=null)},this.googleCooldownSec*1e3)}connectedCallback(){super.connectedCallback(),this.placeholderTimer=setInterval(()=>{this.placeholderIdx=(this.placeholderIdx+1)%Jt.length},2800),this.unsubscribeCapacity=wt.subscribe(e=>{this.capacityCharges=e.charges,this.rechargeNextSec=e.rechargeNextSec,this.requestUpdate()}),this.loadKeyInfo(),this.initJellyBodies()}firstUpdated(){this.loadKeyInfo(),typeof window<"u"&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&(this.animFrameId=requestAnimationFrame(this.physicsLoop))}updated(e){super.updated(e),e.has("isAdmin")&&this.isAdmin&&this.loadKeyInfo()}disconnectedCallback(){super.disconnectedCallback(),this.animFrameId&&cancelAnimationFrame(this.animFrameId),this.placeholderTimer&&clearInterval(this.placeholderTimer),this.classifyDebounce&&clearTimeout(this.classifyDebounce),this.cooldownTimer&&clearInterval(this.cooldownTimer),this.unsubscribeCapacity&&(this.unsubscribeCapacity(),this.unsubscribeCapacity=null),this.stopLoadingTimer()}selectGenre(e){this.dispatchEvent(new CustomEvent("genre-change",{detail:e,bubbles:!0,composed:!0}))}selectMood(e){this.dispatchEvent(new CustomEvent("mood-change",{detail:e,bubbles:!0,composed:!0}))}setLength(e){this.dispatchEvent(new CustomEvent("length-change",{detail:e,bubbles:!0,composed:!0}))}decLength(){this.length>ue&&this.setLength(this.length-1)}incLength(){this.length<ee&&this.setLength(this.length+1)}onFreeTextChange(e){this.freeText=e.target.value}applyBest(e){this.selectGenre(e.genre),this.selectMood(e.mood);const t={...e,promptText:this.freeText.trim()};this.dispatchEvent(new CustomEvent("freetext-suggestion-applied",{detail:t,bubbles:!0,composed:!0}))}renderJellySvg(e){switch(e){case"blob1":return h`<svg width="38" height="38" viewBox="0 0 38 38"><path d="M19 2C28 2 36 9 36 19C36 29 28 36 18 36C8 36 2 27 2 18C2 9 10 2 19 2Z" fill="#F6D98B"/></svg>`;case"blob2":return h`<svg width="26" height="26" viewBox="0 0 24 24"><path d="M12 2C18 2 22 8 22 14C22 20 16 22 10 22C4 22 2 16 2 10C2 4 6 2 12 2Z" fill="#F2A79B" opacity="0.9"/></svg>`;case"blob3":return h`<svg width="32" height="32" viewBox="0 0 32 32"><path d="M16 2C24 2 30 7 30 16C30 25 22 30 14 30C6 30 2 23 2 14C2 5 8 2 16 2Z" fill="#F2C9A0"/></svg>`;case"circle":return h`<svg width="30" height="30" viewBox="0 0 30 30"><circle cx="15" cy="15" r="14" fill="#9CC0EC"/></svg>`;case"dot":return h`<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="7" fill="#9CC0EC"/></svg>`;case"ring":return h`<svg width="44" height="44" viewBox="0 0 46 46"><circle cx="23" cy="23" r="20" fill="none" stroke="#9CC0EC" stroke-width="6" opacity="0.6"/></svg>`;case"doubleRing":return h`<svg width="36" height="36" viewBox="0 0 36 36"><circle cx="18" cy="18" r="15" fill="none" stroke="#9CC0EC" stroke-width="3"/><circle cx="18" cy="18" r="7" fill="#9CC0EC"/></svg>`;case"pill":return h`<svg width="34" height="20" viewBox="0 0 34 20"><rect x="2" y="2" width="30" height="16" rx="8" fill="#F2C9A0"/></svg>`;case"crescent":return h`<svg width="30" height="30" viewBox="0 0 30 30"><path d="M18 4A14 14 0 1 0 28 22 11 11 0 1 1 18 4z" fill="#C9A9E0"/></svg>`;case"arch":return h`<svg width="36" height="22" viewBox="0 0 36 20"><path d="M2 18 A 16 16 0 0 1 34 18 Z" fill="#B8CC9E" opacity="0.85"/></svg>`;case"squircle":return h`<svg width="32" height="32" viewBox="0 0 32 32"><rect x="2" y="2" width="28" height="28" rx="12" fill="#9CC0EC"/></svg>`;case"oval":return h`<svg width="32" height="22" viewBox="0 0 32 22"><ellipse cx="16" cy="11" rx="14" ry="9" fill="#B8CC9E"/></svg>`;case"donut":return h`<svg width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="13" fill="none" stroke="#C6564B" stroke-width="6" opacity="0.75"/></svg>`;default:return h`<svg width="24" height="24" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#F6D98B"/></svg>`}}render(){const e=ye(this.mood);let t=To.filter(a=>Ne.includes(a));t.includes(this.genre)||(t=t.slice(0,-1).concat(this.genre));const i=Ne.filter(a=>!t.includes(a)),o=this.expandedGenre?t.concat(i):t,s=le.map(a=>a.name);let r=Io.filter(a=>s.includes(a));r.includes(this.mood)||(r=r.slice(0,-1).concat(this.mood));const n=s.filter(a=>!r.includes(a)),l=(this.expandedMood?r.concat(n):r).map(a=>le.find(g=>g.name===a)),d=this.freeText.trim(),p=d.length>2?Oi(d):null;return h`
      <div class="frame" @mousemove=${this.onFrameMouseMove} @mouseleave=${this.onFrameMouseLeave}>
        ...
        <div class="content">
          ...
          <div class="pill-grid">
            ${o.map(a=>{const g=Ne.indexOf(a);return h`
                <div class="pill ${a===this.genre?"selected":""}" style=${a===this.genre?`background:${e}`:""} @click=${()=>this.selectGenre(a)}>
                  <div class="genre-icon-wrap">
                    <svg width="12" height="12" viewBox="0 0 24 24">
                      <rect x="6" y="6" width="12" height="12" rx=${So[g%3]} fill=${ko[g%3]} />
                    </svg>
                  </div>
                  ${a}
                </div>
  ...
  `;P([v({type:Object})],B.prototype,"chord",2);P([v({type:Number})],B.prototype,"swapIndex",2);P([v({type:Object})],B.prototype,"progression",2);P([v({type:Array})],B.prototype,"order",2);P([v({type:Array})],B.prototype,"alternatives",2);P([v({type:Array})],B.prototype,"theoryGroups",2);P([v({type:Array})],B.prototype,"borrowedChords",2);P([v({type:Boolean})],B.prototype,"showTheory",2);P([v({type:String})],B.prototype,"moodColor",2);P([v({type:Number})],B.prototype,"position",2);P([v({type:Number})],B.prototype,"total",2);P([v({type:String})],B.prototype,"mode",2);P([v({type:Boolean})],B.prototype,"visible",2);P([v({type:Number})],B.prototype,"resetKey",2);P([u()],B.prototype,"drillGroup",2);P([u()],B.prototype,"abPick",2);P([u()],B.prototype,"abSide",2);P([u()],B.prototype,"abPlaying",2);P([u()],B.prototype,"abStep",2);P([u()],B.prototype,"auditioningChordName",2);P([u()],B.prototype,"quality",2);P([u()],B.prototype,"extension",2);P([u()],B.prototype,"dragY",2);P([u()],B.prototype,"dragging",2);P([u()],B.prototype,"snapping",2);P([St(".sheet")],B.prototype,"sheetEl",2);B=P([X("swap-sheet")],B);var Oo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,Di=(e,t,i,o)=>{for(var s=o>1?void 0:o?Do(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Oo(t,i,s),s};const Bo=z`
...
`,Fo=[{device:"m8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:Bo},{device:"circuit",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:Po}];let qe=class extends W{constructor(){super(...arguments),this.visible=!1,this.onKeyDown=e=>{e.key==="Escape"&&this.visible&&this.emit("close")}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKeyDown)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}render(){return h`
  ...
  `;Di([v({type:Boolean})],qe.prototype,"visible",2);qe=Di([X("share-modal")],qe);function Qt(e){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=e.match(/^([A-Ga-g][#b]?)(-?\d+)?$/);if(!i)return 60;const o=i[1].charAt(0).toUpperCase()+i[1].slice(1),s=t[o]??0,r=i[2]!==void 0?parseInt(i[2],10):4;return Math.min(127,Math.max(0,(r+1)*12+s))}function Bi(e,t,i){const o=t&&t.length>0?t.map(m=>e.chords[m]).filter(m=>!!m):e.chords,s=e.bpm||120,r=1.7,n=i?we.find(m=>m.name.toLowerCase()===i.toLowerCase()):void 0,c=It[e.genre]||{},l=n?.patch??{},d={...c,...l},p=c.duration??.9,a=l.durationMultiplier?p*l.durationMultiplier:p,g=[];return o.forEach((m,x)=>{const f=x*r,k=(m.notes&&m.notes.length>0?m.notes:["C","E","G"]).map(S=>`${S}4`);if(d.arpMode&&d.arpMode!=="off"){const S=d.arpRate??"1/16",I=d.arpRange??1,w=d.arpMode,O=ui(S,s),_=gi(k,I),K=mi(_,w),Be=d.duration?d.duration:Math.max(.6,a);K.forEach((b,F)=>{const ie=f+F*O;g.push({note:b,midi:Qt(b),startTime:ie,duration:Be})})}else{const S=d.spread??0;k.forEach((I,w)=>{const O=w*S*.1,_=f+O;g.push({note:I,midi:Qt(I),startTime:_,duration:a})})}}),g}function _o(e){const t=[];let i=Math.max(0,Math.floor(e));for(t.push(i&127);(i>>=7)>0;)t.unshift(i&127|128);return t}function Ro(e,t,i){const o=e.bpm||120,s=480,r=Bi(e,t,i),n=[];r.forEach(f=>{const y=Math.round(f.startTime/(60/o)*s),k=Math.max(1,Math.round(f.duration/(60/o)*s));n.push({tick:y,type:"on",midi:f.midi}),n.push({tick:y+k,type:"off",midi:f.midi})}),n.sort((f,y)=>f.tick!==y.tick?f.tick-y.tick:f.type!==y.type?f.type==="off"?-1:1:f.midi-y.midi);const c=[],l=Math.round(6e7/o);c.push(0),c.push(255,81,3),c.push(l>>16&255,l>>8&255,l&255);const d="Chroma Chords";c.push(0),c.push(255,3,d.length);for(let f=0;f<d.length;f++)c.push(d.charCodeAt(f));let p=0;n.forEach(f=>{const y=f.tick-p;p=f.tick,c.push(..._o(y)),f.type==="on"?c.push(144,f.midi,80):c.push(128,f.midi,0)}),c.push(0),c.push(255,47,0);const a=[77,84,104,100,0,0,0,6,0,0,0,1,s>>8&255,s&255],g=c.length,m=[77,84,114,107,g>>24&255,g>>16&255,g>>8&255,g&255],x=new Uint8Array(a.length+m.length+c.length);return x.set(a,0),x.set(m,a.length),x.set(c,a.length+m.length),x}function Lo(e,t,i,o){const s=Ro(e,t,o),r=new Blob([s],{type:"audio/midi"}),n=(e.key||"C").toLowerCase(),c=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),l=e.bpm||120,d=`chroma-chords-${n}-${c}-${l}bpm.mid`;Pi(r,d)}function Uo(e,t){const i=new di({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination();switch((e?xe.find(r=>r.name.toLowerCase()===e.toLowerCase()):void 0)?.instrument??(t?Tt[t]:void 0)??"rhodes"){case"bell":return new Y(Ae,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(i);case"epiano":return new Y(Ae,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(i);case"guitar":return new Y(ae,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(i);case"organ":return new Y(ae,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(i);case"pad-strings":{const r=new ci({decay:4.5,wet:.35}).connect(i);return new Y(ae,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(r)}case"juno-pad":{const r=new li({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).start().connect(i);return new Y(ae,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(r)}case"stab":return new Y(ai,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(i);case"rhodes":default:return new Y(Ae,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-12}).connect(i)}}function jo(e){const t=e.numberOfChannels,i=e.sampleRate,o=16,s=o/8,r=t*s,n=e.length*t*s,c=new ArrayBuffer(44+n),l=new DataView(c),d=(g,m)=>{for(let x=0;x<m.length;x++)l.setUint8(g+x,m.charCodeAt(x))};d(0,"RIFF"),l.setUint32(4,36+n,!0),d(8,"WAVE"),d(12,"fmt "),l.setUint32(16,16,!0),l.setUint16(20,1,!0),l.setUint16(22,t,!0),l.setUint32(24,i,!0),l.setUint32(28,i*r,!0),l.setUint16(32,r,!0),l.setUint16(34,o,!0),d(36,"data"),l.setUint32(40,n,!0);const p=[];for(let g=0;g<t;g++)p.push(e.getChannelData(g));let a=44;for(let g=0;g<e.length;g++)for(let m=0;m<t;m++){const x=Math.max(-1,Math.min(1,p[m][g])),f=x<0?x*32768:x*32767;l.setInt16(a,f,!0),a+=2}return new Blob([new Uint8Array(c)],{type:"audio/wav"})}async function zo(e,t,i,o){const s=Bi(e,t,o);if(!s.length)return;const n=s.reduce((m,x)=>Math.max(m,x.startTime+x.duration),0)+1.2,c=await Gi(async()=>{const m=Uo(i,e.genre);s.forEach(x=>{m.triggerAttackRelease(x.note,x.duration,x.startTime)})},n),l=jo(c.get()),d=(e.key||"C").toLowerCase(),p=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),a=e.bpm||120,g=`chroma-chords-${d}-${p}-${a}bpm.wav`;Pi(l,g)}function Pi(e,t){if(typeof URL>"u"||typeof URL.createObjectURL!="function")return;const i=URL.createObjectURL(e);if(typeof document>"u")return;const o=document.createElement("a");o.href=i,o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),setTimeout(()=>URL.revokeObjectURL(i),1e3)}var Go=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,ke=(e,t,i,o)=>{for(var s=o>1?void 0:o?Vo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Go(t,i,s),s};let ce=class extends W{constructor(){super(...arguments),this.visible=!1,this.defaultName="",this.mounted=!1,this.name="",this.closeTimer=null}willUpdate(e){e.has("visible")&&(this.visible?(this.closeTimer&&(clearTimeout(this.closeTimer),this.closeTimer=null),this.mounted=!0,this.name=this.defaultName,setTimeout(()=>{this.inputEl&&(this.inputEl.focus(),this.inputEl.select())},100)):this.mounted&&(this.closeTimer=setTimeout(()=>{this.mounted=!1},300)))}close(){this.dispatchEvent(new CustomEvent("close"))}save(){const e=this.name.trim();e&&(this.dispatchEvent(new CustomEvent("save",{detail:e})),this.close())}onInput(e){this.name=e.target.value}onKeyDown(e){e.key==="Escape"?this.close():e.key==="Enter"&&this.name.trim()&&this.save()}render(){return this.mounted?h`
  ...
  `;ke([v({type:Boolean})],ce.prototype,"visible",2);ke([v({type:String})],ce.prototype,"defaultName",2);ke([u()],ce.prototype,"mounted",2);ke([u()],ce.prototype,"name",2);ke([St(".name-input")],ce.prototype,"inputEl",2);ce=ke([X("save-set-modal")],ce);var Yo=Object.defineProperty,qo=Object.getOwnPropertyDescriptor,A=(e,t,i,o)=>{for(var s=o>1?void 0:o?qo(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Yo(t,i,s),s};const Ho=[{side:"left",top:"18%"},{side:"left",top:"58%"},{side:"right",top:"24%"},{side:"right",top:"64%"}],ut=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],Wo=["Lo-fi/Chill","R&B/Soul","Pop","Synthwave"],Xo=["Warm","Melancholy","Nostalgic","Dreamy"],Jo=["Piano","Rhodes","Nylon Guitar","Warm Pad"],Ko=["Block chords","Arpeggio","Strum","Broken (swing)"],Qo=[{label:"Major",value:"MAJOR"},{label:"Minor",value:"NATURAL_MINOR"},{label:"Harmonic Minor",value:"HARMONIC_MINOR"},{label:"Dorian",value:"DORIAN"},{label:"Mixolydian",value:"MIXOLYDIAN"},{label:"Lydian",value:"LYDIAN"}],Zt=220,ei=280,ti={Uplifting:{anim:"cv-panel-uplifting",dur:2.4,ease:"ease-out"},Melancholy:{anim:"cv-panel-melancholy",dur:6,ease:"ease-in-out"},Dreamy:{anim:"cv-panel-dreamy",dur:7,ease:"ease-in-out"},Tense:{anim:"cv-panel-tense",dur:.9,ease:"ease-in-out"},Warm:{anim:"cv-panel-warm",dur:4.2,ease:"ease-in-out"},Nostalgic:{anim:"cv-panel-nostalgic",dur:5.4,ease:"ease-in-out"}};let C=class extends W{constructor(){super(...arguments),this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.playing=!0,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.sheetOpen=!1,this.isAuthenticated=!1,this.userEmail=null,this.isBookmarked=!1,this.sheetMode="swap",this.swapChord=null,this.swapIndex=null,this.alternatives=[],this.theoryGroups=[],this.borrowedChords=[],this.menuMounted=!1,this.menuVisible=!1,this.flashedIndex=null,this.expandedMenuGenre=!1,this.expandedMenuMood=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.saveModalVisible=!1,this.shareMounted=!1,this.shareVisible=!1,this.sheetMounted=!1,this.sheetVisible=!1,this.toast=null,this.spinning=!1,this.drag=null,this.snapProgress=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.mascot=ve(.35),this.mascotSlot=Ee(Ho),this.panelPeekMascot=ve(.18),this.panelPeekSide=Ee(["left","right"]),this.eggCounter=new Et,this.paradeTrigger=0,this.menuCloseTimer=null,this.shareCloseTimer=null,this.sheetCloseTimer=null,this.toastTimer=null,this.pressTimer=null,this.pressTapFn=null,this.pressStartX=0,this.pressStartY=0,this.lastPointerX=0,this.lastPointerY=0,this.onDragMove=e=>{if(this.lastPointerX=e.clientX,this.lastPointerY=e.clientY,this.pressTimer&&!this.drag){(Math.abs(e.clientY-this.pressStartY)>8||Math.abs(e.clientX-this.pressStartX)>8)&&(clearTimeout(this.pressTimer),this.pressTimer=null);return}this.drag&&(this.drag={...this.drag,offsetX:e.clientX-this.pressStartX,offsetY:e.clientY-this.pressStartY})},this.onDragEnd=()=>{if(this.pressTimer&&(clearTimeout(this.pressTimer),this.pressTimer=null),!this.drag){this.pressTapFn&&this.pressTapFn(),this.pressTapFn=null;return}const e=this.drag.pos;this.drag=null,this.pressTapFn=null;const t=Array.from(this.renderRoot.querySelectorAll(".chord-chip"));let i=e,o=1/0;if(t.forEach((s,r)=>{if(r===e)return;const n=s.getBoundingClientRect(),c=n.left+n.width/2,l=n.top+n.height/2,d=(this.lastPointerX-c)**2+(this.lastPointerY-l)**2;d<o&&(o=d,i=r)}),i!==e){const s=[...this.order],[r]=s.splice(e,1);s.splice(i,0,r),this.emit("reorder",s)}}}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}connectedCallback(){super.connectedCallback(),window.addEventListener("pointermove",this.onDragMove),window.addEventListener("pointerup",this.onDragEnd),window.addEventListener("pointercancel",this.onDragEnd)}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}e.has("sheetOpen")&&(this.sheetOpen?(this.sheetCloseTimer&&(clearTimeout(this.sheetCloseTimer),this.sheetCloseTimer=null),this.sheetMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.sheetVisible=!0}))):(this.sheetVisible=!1,this.sheetCloseTimer&&clearTimeout(this.sheetCloseTimer),this.sheetCloseTimer=setTimeout(()=>{this.sheetMounted=!1},ei)))}disconnectedCallback(){super.disconnectedCallback(),this.menuCloseTimer&&clearTimeout(this.menuCloseTimer),this.shareCloseTimer&&clearTimeout(this.shareCloseTimer),this.sheetCloseTimer&&clearTimeout(this.sheetCloseTimer),this.toastTimer&&clearTimeout(this.toastTimer),this.pressTimer&&clearTimeout(this.pressTimer),window.removeEventListener("pointermove",this.onDragMove),window.removeEventListener("pointerup",this.onDragEnd),window.removeEventListener("pointercancel",this.onDragEnd)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1})),e.has("sheetOpen")&&(this.sheetOpen?(this.sheetCloseTimer&&(clearTimeout(this.sheetCloseTimer),this.sheetCloseTimer=null),this.sheetMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.sheetVisible=!0}))):(this.sheetVisible=!1,this.sheetCloseTimer=setTimeout(()=>{this.sheetMounted=!1},ei)))}toggleMenu(){this.menuMounted?this.closeMenu():this.openMenu()}openMenu(){this.menuCloseTimer&&(clearTimeout(this.menuCloseTimer),this.menuCloseTimer=null),this.menuMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.menuVisible=!0}))}closeMenu(){this.menuVisible=!1,this.menuCloseTimer&&clearTimeout(this.menuCloseTimer),this.menuCloseTimer=setTimeout(()=>{this.menuMounted=!1,this.expandedMenuGenre=!1,this.expandedMenuMood=!1},Zt)}openShare(){this.closeMenu(),this.shareCloseTimer&&(clearTimeout(this.shareCloseTimer),this.shareCloseTimer=null),this.shareMounted=!0,requestAnimationFrame(()=>requestAnimationFrame(()=>{this.shareVisible=!0}))}closeShare(){this.shareVisible=!1,this.shareCloseTimer=setTimeout(()=>{this.shareMounted=!1},Zt)}exportDevice(e,t){this.closeShare();const i=Js(this.progression,e,this.order);window.open(i,"_blank"),this.toastTimer&&clearTimeout(this.toastTimer),this.toast=`Sent to ${t}`,this.toastTimer=setTimeout(()=>{this.toast=null},2e3)}async handleExportWav(){this.closeShare(),this.toastTimer&&clearTimeout(this.toastTimer),this.toast="Rendering WAV audio...";try{const e=this.progression,t=this.instrument??Le(e.genre),i=this.playStyle??Ue(e.genre);await zo(e,this.order,t,i),this.toast="Saved WAV audio file"}catch(e){console.error("WAV export error:",e),this.toast="Failed to export WAV"}this.toastTimer=setTimeout(()=>{this.toast=null},2500)}handleExportMidi(){this.closeShare(),this.toastTimer&&clearTimeout(this.toastTimer);try{const e=this.progression,t=this.instrument??Le(e.genre),i=this.playStyle??Ue(e.genre);Lo(e,this.order,t,i),this.toast="Saved MIDI file"}catch(e){console.error("MIDI export error:",e),this.toast="Failed to export MIDI"}this.toastTimer=setTimeout(()=>{this.toast=null},2500)}reroll(){this.spinning=!0,setTimeout(()=>{this.spinning=!1},400),this.emit("reroll")}pressStart(e,t,i){i.preventDefault(),this.pressTapFn=t,this.pressStartX=i.clientX,this.pressStartY=i.clientY,this.pressTimer&&clearTimeout(this.pressTimer),this.pressTimer=setTimeout(()=>{this.pressTimer=null,this.drag={pos:e,offsetX:0,offsetY:0}},150)}previewChordTile(e){this.flashedIndex=e,setTimeout(()=>{this.flashedIndex===e&&(this.flashedIndex=null)},320),this.emit("chord-preview",e)}dragStyleFor(e){const t=this.drag;return t&&t.pos===e?`transform:translate(${t.offsetX}px, ${t.offsetY}px) scale(1.08) rotate(-1deg);transition:none;z-index:20;box-shadow:0 20px 40px rgba(46,39,31,0.35);cursor:grabbing;`:"cursor:grab;"}renderHeaderTitle(e,t){if(e.searchTerm){const i=e.searchTerm.trim(),s=(i.endsWith(".")?i.slice(0,-1):i).split(/\s+/);if(s.length===1)return h`<h1><span style="color:${t}">${s[0]}.</span></h1>`;const r=s.slice(0,-1).join(" "),n=s[s.length-1];return h`<h1>${r} <span style="color:${t}">${n}.</span></h1>`}return h`<h1>Your progression, feeling <span style="color:${t}">${e.mood.toLowerCase()}.</span></h1>`}renderLengthControl(){const e=this.progression.chords.length;return h`
    ...
    `}render(){const e=this.progression,t=ye(e.mood),i=this.instrument??Le(e.genre),o=this.playStyle??Ue(e.genre),s=Math.max(1,this.order.length),r=this.playing?this.snapProgress?this.progressStep/s*100:Math.min(100,(this.progressStep+1)/s*100):0;ti[e.mood]||ti.Dreamy;const n=this.showTheory?Vs(this.order.map(b=>e.chords[b]),e.key,e.scaleType):null,c=Si(e.key,e.scaleType).length,l=c===0?"no sharps or flats":`${c} ${c===1?"sharp/flat":"sharps/flats"}`;let d=Wo.filter(b=>ut.includes(b));d.includes(e.genre)||(d=d.slice(0,-1).concat(e.genre));const p=ut.filter(b=>!d.includes(b)),a=this.expandedMenuGenre?ut:d,g=le.map(b=>b.name);let m=Xo.filter(b=>g.includes(b));m.includes(e.mood)||(m=m.slice(0,-1).concat(e.mood));const x=g.filter(b=>!m.includes(b)),y=(this.expandedMenuMood?g:m).map(b=>le.find(F=>F.name===b)),k=xe.filter(b=>b.name!==i);let S=Jo.filter(b=>k.some(F=>F.name===b));const I=k.filter(b=>!S.includes(b.name)),w=this.expandedAllInstruments?k:k.filter(b=>S.includes(b.name)),O=we.filter(b=>b.name!==o);let _=Ko.filter(b=>O.some(F=>F.name===b));const K=O.filter(b=>!_.includes(b.name)),Be=this.expandedAllPlayStyles?O:O.filter(b=>_.includes(b.name));return h`
      <div class="frame">
        ${this.mascot.show?h`
          <div class="mascot-slot ${this.mascotSlot.side}" style="top:${this.mascotSlot.top}">
            <mascot-character .kind=${this.mascot.kind} .scale=${.75}></mascot-character>
        ...
        <div class="content">
          ...
          <div class="panel-shell">
            ...
            <div class="panel">
              ...
              <div class="chip-row">
              ${this.order.map((b,F)=>{const ie=e.chords[b],Pe=$e(ie.tension),Dt=F===this.activeIndex,Fi=this.flashedIndex===b;return h`
                  <div
                    class="chord-chip ${Dt?"active":""} ${Fi?"flashed":""}"
                  ...
                  >
                    ...
                    ${Dt?h`<div class="now-marker"><div class="now-dot"></div><div class="now-text">now</div></div>`:""}
              ...
              <div class="theory-staff-scroll">
                ${z`
                  <svg width="${n.width}" height="${n.height}" viewBox="0 0 ${n.width} ${n.height}">
                    ${n.lines.map(b=>z`<rect x="6" y="${b}" width="${n.width-12}" height="1.4" fill="rgba(46,39,31,0.35)" />`)}
                    <text x="8" y="${n.lines[3]+14}" font-size="46" font-family="Georgia, 'Times New Roman', serif" fill="var(--cv-ink)">𝄞</text>
                    ${n.keySignature.map(b=>z`<text x="${b.x}" y="${b.y+6}" font-size="20" fill="var(--cv-ink)">${b.sign==="sharp"?"♯":"♭"}</text>`)}
                    ${n.chords.map(b=>z`
                      <text x="${b.cx}" y="${b.labelY}" font-size="11" font-weight="800" fill="var(--cv-ink)" text-anchor="middle">${b.name}</text>
                      ${b.ledgers.map(F=>z`<rect x="${F.x}" y="${F.y}" width="18" height="1.6" fill="rgba(46,39,31,0.5)" />`)}
                      ${b.notes.map(F=>z`<ellipse cx="${F.x}" cy="${F.y}" rx="6" ry="5.2" fill="var(--cv-ink)" />`)}
  ...
  `;A([v({type:Object})],C.prototype,"progression",2);A([v({type:Number})],C.prototype,"activeIndex",2);A([v({type:Number})],C.prototype,"progressStep",2);A([v({type:Array})],C.prototype,"order",2);A([v({type:Boolean})],C.prototype,"playing",2);A([v({type:Boolean})],C.prototype,"showTheory",2);A([v({type:String})],C.prototype,"instrument",2);A([v({type:String})],C.prototype,"playStyle",2);A([v({type:Boolean})],C.prototype,"sheetOpen",2);A([v({type:Boolean})],C.prototype,"isAuthenticated",2);A([v({type:String})],C.prototype,"userEmail",2);A([v({type:Boolean})],C.prototype,"isBookmarked",2);A([v({type:String})],C.prototype,"sheetMode",2);A([v({type:Object})],C.prototype,"swapChord",2);A([v({type:Number})],C.prototype,"swapIndex",2);A([v({type:Array})],C.prototype,"alternatives",2);A([v({type:Array})],C.prototype,"theoryGroups",2);A([v({type:Array})],C.prototype,"borrowedChords",2);A([u()],C.prototype,"menuMounted",2);A([u()],C.prototype,"menuVisible",2);A([u()],C.prototype,"flashedIndex",2);A([u()],C.prototype,"expandedMenuGenre",2);A([u()],C.prototype,"expandedMenuMood",2);A([u()],C.prototype,"expandedAllInstruments",2);A([u()],C.prototype,"expandedAllPlayStyles",2);A([u()],C.prototype,"saveModalVisible",2);A([u()],C.prototype,"shareMounted",2);A([u()],C.prototype,"shareVisible",2);A([u()],C.prototype,"sheetMounted",2);A([u()],C.prototype,"sheetVisible",2);A([u()],C.prototype,"toast",2);A([u()],C.prototype,"spinning",2);A([u()],C.prototype,"drag",2);A([u()],C.prototype,"snapProgress",2);A([u()],C.prototype,"expandedInstrument",2);A([u()],C.prototype,"expandedPlayStyle",2);A([u()],C.prototype,"mascot",2);A([u()],C.prototype,"mascotSlot",2);A([u()],C.prototype,"panelPeekMascot",2);A([u()],C.prototype,"panelPeekSide",2);A([u()],C.prototype,"paradeTrigger",2);C=A([X("loop-screen")],C);var Zo=Object.defineProperty,er=Object.getOwnPropertyDescriptor,j=(e,t,i,o)=>{for(var s=o>1?void 0:o?er(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Zo(t,i,s),s};const tr=["Piano","Rhodes","Nylon Guitar","Warm Pad"],ir=["Block chords","Arpeggio","Strum","Broken (swing)"],sr=["flex-start","center","flex-end"];let L=class extends W{constructor(){super(...arguments),this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.canAddSection=!0,this.playing=!1,this.progressStep=0,this.totalSteps=0,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.isBookmarked=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.snapProgress=!1,this.saveModalVisible=!1,this.mascot=ve(.5),this.mascotAlign=Ee([...sr]),this.eggCounter=new Et,this.paradeTrigger=0}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1}))}selectSection(e){this.dispatchEvent(new CustomEvent("select-section",{detail:e,bubbles:!0,composed:!0}))}addSection(){this.canAddSection&&this.dispatchEvent(new CustomEvent("add-section",{bubbles:!0,composed:!0}))}backToProgression(){this.dispatchEvent(new CustomEvent("back-to-progression",{bubbles:!0,composed:!0}))}render(){const e=this.sections[0]?.progression.genre??"Pop",t=this.instrument??Le(e),i=this.playStyle??Ue(e),o=this.totalSteps||this.sections.reduce((f,y)=>f+y.order.length,0),s=!this.playing||o<=0?0:this.snapProgress?this.progressStep/o*100:(this.progressStep+1)/o*100,r=xe.filter(f=>f.name!==t);let n=tr.filter(f=>r.some(y=>y.name===f));const c=r.filter(f=>!n.includes(f.name)),l=this.expandedAllInstruments?r:r.filter(f=>n.includes(f.name)),d=we.filter(f=>f.name!==i);let p=ir.filter(f=>d.some(y=>y.name===f));const a=d.filter(f=>!p.includes(f.name)),g=this.expandedAllPlayStyles?d:d.filter(f=>p.includes(f.name)),m=this.sections[this.playing?this.activePlayingSectionIdx:0]||this.sections[0],x=m?ye(m.progression.mood):"#C9A9E0";return h`
      <div class="frame">
        <app-header
          .isAuthenticated=${this.isAuthenticated}
          @view-sets=${()=>this.dispatchEvent(new CustomEvent("view-sets",{bubbles:!0,composed:!0}))}
        ...
        <div class="content">
          ...
          <div class="section-list">
            ${this.sections.map((f,y)=>{const k=this.playing?y===this.activePlayingSectionIdx:y===this.activeSectionIdx,S=ye(f.progression.mood);return h`
                <div class="section-row ${k?"active":""}" style=${k?`--ring-color:${S}`:""} @click=${()=>this.selectSection(y)}>
                  <div>
                    <div class="section-name">${f.name.toUpperCase()}</div>
                    <div class="section-chords">${f.desc}</div>
                  </div>
                  <div class="section-chips">
                    ${f.order.map(I=>{const w=f.progression.chords[I],O=$e(w.tension);return h`<div class="section-chip" style="background:${O.color};border-radius:${Math.round(O.radius*.35)}px;"></div>`})}
                  </div>
                </div>
              `})}
        ...
        <save-set-modal
          .visible=${this.saveModalVisible}
          .defaultName=${e&&m?`${e} · ${m.progression.mood}`:"My Set"}
          @close=${()=>{this.saveModalVisible=!1}}
  ...
  `;j([v({type:Array})],L.prototype,"sections",2);j([v({type:Number})],L.prototype,"activeSectionIdx",2);j([v({type:Number})],L.prototype,"activePlayingSectionIdx",2);j([v({type:Boolean})],L.prototype,"canAddSection",2);j([v({type:Boolean})],L.prototype,"playing",2);j([v({type:Number})],L.prototype,"progressStep",2);j([v({type:Number})],L.prototype,"totalSteps",2);j([v({type:String})],L.prototype,"instrument",2);j([v({type:String})],L.prototype,"playStyle",2);j([v({type:Boolean})],L.prototype,"isAuthenticated",2);j([v({type:Boolean})],L.prototype,"isBookmarked",2);j([u()],L.prototype,"expandedInstrument",2);j([u()],L.prototype,"expandedPlayStyle",2);j([u()],L.prototype,"expandedAllInstruments",2);j([u()],L.prototype,"expandedAllPlayStyles",2);j([u()],L.prototype,"snapProgress",2);j([u()],L.prototype,"saveModalVisible",2);j([u()],L.prototype,"mascot",2);j([u()],L.prototype,"mascotAlign",2);j([u()],L.prototype,"paradeTrigger",2);L=j([X("song-screen")],L);var or=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,te=(e,t,i,o)=>{for(var s=o>1?void 0:o?rr(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&or(t,i,s),s};let J=class extends W{constructor(){super(...arguments),this.projects=[],this.isAuthenticated=!1,this.userEmail=null,this.syncStatus="sign-in",this.isSyncing=!1,this.renamingId=null,this.draftName="",this.confirmDeleteId=null,this.emptyMascot=ve(.9),this.unsubscribeSyncStatus=null}connectedCallback(){super.connectedCallback(),this.unsubscribeSyncStatus=U.subscribeSyncStatus(e=>{this.syncStatus=e,this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeSyncStatus&&(this.unsubscribeSyncStatus(),this.unsubscribeSyncStatus=null)}onBack(){this.dispatchEvent(new CustomEvent("back"))}onLoadProject(e){this.renamingId||this.confirmDeleteId||this.dispatchEvent(new CustomEvent("load-project",{detail:e}))}async onSync(){if(!(this.isSyncing||this.syncStatus==="syncing")){this.isSyncing=!0,this.dispatchEvent(new CustomEvent("sync-projects",{bubbles:!0,composed:!0}));try{await U.syncWithCloud()}catch(e){console.warn("Manual sync error:",e)}finally{this.isSyncing=!1}}}startRename(e,t,i){e.stopPropagation(),this.renamingId=t,this.draftName=i,this.confirmDeleteId=null}onDraftChange(e){this.draftName=e.target.value}commitRename(e){if(this.renamingId===e){const t=this.draftName.trim();t&&this.dispatchEvent(new CustomEvent("rename-project",{detail:{id:e,name:t},bubbles:!0,composed:!0})),this.renamingId=null}}cancelRename(){this.renamingId=null,this.draftName=""}askDelete(e,t){e.stopPropagation(),this.confirmDeleteId=t,this.renamingId=null}confirmDelete(e,t){e.stopPropagation(),this.confirmDeleteId=null,this.dispatchEvent(new CustomEvent("delete-project",{detail:t,bubbles:!0,composed:!0}))}cancelDelete(e){e.stopPropagation(),this.confirmDeleteId=null}render(){return h`
      <div class="frame">
        <app-header
          .isAuthenticated=${this.isAuthenticated}
          .userEmail=${this.userEmail}
        ...
        <div class="content" style="margin-top: 10px;">
          ...
          `:h`
            <div class="saved-sets-list">
              ${this.projects.map(e=>{e.scaleType,e.key;const t=e.name||"Untitled Set",i=e.genre||"Unknown",o=e.mood||"Neutral",s=ye(o),r=this.renamingId===e.id,n=this.confirmDeleteId===e.id,c=e.chords&&e.chords.length?e.chords.length:4,l=`${i} · ${o} · ${c} bars`;return h`
                  <div class="card" @click=${()=>this.onLoadProject(e.id)}>
                    <div class="swatch-bar" style="background: ${s};">
                      ${(e.chords&&e.chords.length?e.chords:[{tension:0},{tension:1},{tension:2},{tension:3}]).map(d=>{const p=typeof d=="object"&&d!==null?d.tension??0:0,g=$e(p)?.color||"rgba(46, 39, 31, 0.55)",m=typeof d=="object"&&d!==null&&d.name||"";return h`<span class="chip-dot" style="background: ${g};" title=${m}></span>`})}
                    </div>
  ...
  `;te([v({type:Array})],J.prototype,"projects",2);te([v({type:Boolean})],J.prototype,"isAuthenticated",2);te([v({type:String})],J.prototype,"userEmail",2);te([v({type:String})],J.prototype,"syncStatus",2);te([u()],J.prototype,"isSyncing",2);te([u()],J.prototype,"renamingId",2);te([u()],J.prototype,"draftName",2);te([u()],J.prototype,"confirmDeleteId",2);te([u()],J.prototype,"emptyMascot",2);J=te([X("sets-screen")],J);var nr=Object.defineProperty,ar=Object.getOwnPropertyDescriptor,re=(e,t,i,o)=>{for(var s=o>1?void 0:o?ar(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&nr(t,i,s),s};const ii={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},lr=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],si={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},oi={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},ri={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},Ie={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}},cr=[4,9,2,7,11,4],ni=[7,0,4,9];let Z=class extends W{constructor(){super(...arguments),this.order=[0,1,2,3],this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.playInstrument="Piano",this.showDegrees=!1,this.activeChordIndex=null}parseChord(e){const t=/^([A-G][b#]?)(.*)$/.exec(e||"C"),i=t?t[1]:"C",o=t?t[2]:"",s=si[o]||si[ri[o]||"maj"]||[0,4,7];return{root:i,rootPc:ii[i]===void 0?0:ii[i],q:o,intervals:s}}shapeQual(e){const t=e===""?"maj":e;if(Ie[5][t]||Ie[6][t])return t;const i=ri[t];return i&&(Ie[5][i]||Ie[6][i])?i:"maj"}guitarVoicing(e){const t=this.parseChord(e),i=this.shapeQual(t.q),o=[];return[[6,4],[5,9]].forEach(([s,r])=>{const n=Ie[s][i];if(!n)return;const c=((t.rootPc-r)%12+12)%12;o.push({rootFret:c,frets:n.map(l=>l===null?null:l+c)})}),o.length?(o.sort((s,r)=>s.rootFret-r.rootFret),o[0].frets):null}ukeVoicing(e){const t=this.parseChord(e),i=ni,o=t.intervals.map(c=>(t.rootPc+c)%12),s=c=>{const l=new Set(c);let d=null;const p=[],a=g=>{if(g===4){const m=p.map((k,S)=>(i[S]+k)%12);for(const k of l)if(m.indexOf(k)<0)return;for(const k of m)if(!l.has(k))return;const x=p.filter(k=>k>0),f=x.length?Math.max(...x)-Math.min(...x):0;if(f>3)return;const y=f*12+p.reduce((k,S)=>k+S,0);(!d||y<d.score)&&(d={frets:p.slice(),score:y});return}for(let m=0;m<=5;m++)p.push(m),a(g+1),p.pop()};return a(0),d},r=s(o);if(r)return r.frets;const n=s(t.intervals.filter(c=>c!==7).map(c=>(t.rootPc+c)%12));return n?n.frets:null}degOf(e,t){return oi[((e-t)%12+12)%12]||"1"}notesLineFor(e){return e.intervals.map(t=>{const i=lr[(e.rootPc+t)%12];return this.showDegrees?`${i} (${this.degOf((e.rootPc+t)%12,e.rootPc)})`:i}).join(" · ")}onChordClick(e){this.activeChordIndex=e,this.dispatchEvent(new CustomEvent("chord-preview",{detail:e,bubbles:!0,composed:!0})),setTimeout(()=>{this.activeChordIndex===e&&(this.activeChordIndex=null)},450)}onBackClick(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}renderPianoSvg(e,t){const r=[0,2,4,5,7,9,11],n=this.parseChord(e),c=[],l=[],d=[];for(let a=0;a<2;a++)r.forEach((g,m)=>{c.push({x:(a*7+m)*22,w:22-1.5,h:86})});for(let a=0;a<2;a++)[0,1,3,4,5].forEach(g=>{const m=a*7+g;l.push({x:m*22+22*.64,w:22*.58,h:52})});n.intervals.forEach(a=>{const g=n.rootPc+a,m=Math.floor(g/12),x=g%12,f=r.indexOf(x),y=a===0,k=y?"#F2735F":t,S=this.showDegrees&&oi[a%12]||"";if(f>=0){const I=m*7+f;d.push({cx:I*22+(22-1.5)/2,cy:67,r:9,fill:k,label:S,lc:y?"#FBF3E6":"#2E271F"})}else{const w=(m*7+r.indexOf(x-1))*22+22*.64,O=22*.58;d.push({cx:w+O/2,cy:38,r:7.5,fill:k,label:S,lc:y?"#FBF3E6":"#2E271F"})}});const p=14*22;return h`
    ...
    `}renderFretSvg(e,t){const n=this.parseChord(e),c=t?ni:cr,l=t?this.ukeVoicing(e)||[null,null,null,null]:this.guitarVoicing(e)||[null,null,null,null,null,null],d=c.length,p=l.filter(w=>w!==null&&w>0),a=p.length&&Math.max(...p)>4?Math.min(...p)-1:0,g=[],m=[],x=[],f=[],y=[];for(let w=0;w<d;w++)g.push({x:w*18});for(let w=0;w<=4;w++)m.push({y:16+w*24,sw:w===0&&a===0?3:1.2});l.forEach((w,O)=>{const _=O*18;if(w===null){y.push({x:_});return}if(w===0){f.push({x:_});return}const K=((c[O]+w-n.rootPc)%12+12)%12;x.push({cx:_,cy:16+(w-a-.5)*24,fill:K===0?"#F2735F":"#2E271F",label:this.showDegrees?this.degOf((c[O]+w)%12,n.rootPc):""})});const k=(d-1)*18+26,S=16+4*24+12,I=(d-1)*18;return{posLabel:a>0?`${a+1}fr`:"",svg:h`
      ...
      `}}render(){if(!this.progression)return h``;const e=ye(this.progression.mood);this.style.setProperty("--active-mood-color",e);const t=this.order.map(s=>this.progression.chords[s]||this.progression.chords[0]),i=this.playInstrument==="Piano",o=i?"One voicing per chord, root position — the red dot is the root, play left to right.":"Exact voicings including 7ths — the red dot is the root, ○ is an open string, × is muted.";return h`
      <app-header
        .isAuthenticated=${this.isAuthenticated}
        .userEmail=${this.userEmail}
      ></app-header>
  ...
  `;re([v({type:Object})],Z.prototype,"progression",2);re([v({type:Array})],Z.prototype,"order",2);re([v({type:Boolean})],Z.prototype,"isAuthenticated",2);re([v({type:String})],Z.prototype,"userEmail",2);re([v({type:Number})],Z.prototype,"savedCount",2);re([u()],Z.prototype,"playInstrument",2);re([u()],Z.prototype,"showDegrees",2);re([u()],Z.prototype,"activeChordIndex",2);Z=re([X("play-along-screen")],Z);var dr=Object.defineProperty,hr=Object.getOwnPropertyDescriptor,Se=(e,t,i,o)=>{for(var s=o>1?void 0:o?hr(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&dr(t,i,s),s};let de=class extends W{constructor(){super(...arguments),this.open=!1,this.mounted=!1,this.isOAuthLoading=!1,this.errorMessage=null,this.closeTimer=null}updated(e){e.has("open")&&(this.open?(this.closeTimer&&(clearTimeout(this.closeTimer),this.closeTimer=null),this.mounted=!0,this.errorMessage=null,setTimeout(()=>{this.googleBtnContainer&&fe.renderGoogleButton(this.googleBtnContainer,t=>{t.success?this.close():t.message&&(this.errorMessage=t.message)})},50)):this.mounted&&(this.closeTimer=setTimeout(()=>{this.mounted=!1},280)))}close(){this.errorMessage=null,this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}async handleGoogleSignIn(){this.errorMessage=null,this.isOAuthLoading=!0;try{const e=await fe.signInWithGoogle();e.success?this.close():e.message&&(this.errorMessage=e.message)}catch(e){const t=e instanceof Error?e.message:String(e);this.errorMessage=t||"Google sign-in failed. Please try again."}finally{this.isOAuthLoading=!1}}render(){return this.mounted?h`
  ...
  `;Se([v({type:Boolean})],de.prototype,"open",2);Se([u()],de.prototype,"mounted",2);Se([u()],de.prototype,"isOAuthLoading",2);Se([u()],de.prototype,"errorMessage",2);Se([St("#google-btn-container")],de.prototype,"googleBtnContainer",2);de=Se([X("auth-modal")],de);var pr=Object.defineProperty,ur=Object.getOwnPropertyDescriptor,$=(e,t,i,o)=>{for(var s=o>1?void 0:o?ur(t,i):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&pr(t,i,s),s};let N=class extends W{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.screen="seed",this.genre="Pop",this.mood="Dreamy",this.progression=null,this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.keyOverride=null,this.scaleOverride=null,this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.sheetOpen=!1,this.sheetMode="swap",this.swapIndex=null,this.alternatives=[],this.theoryGroups=[],this.borrowedChords=[],this.length=4,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.pendingChordSuggestion=null,this.userEmail=null,this.isAuthenticated=!1,this.syncStatus="sign-in",this.authModalOpen=!1,this.toastMessage=null,this.toastUndoId=null,this.isGenerating=!1,this.currentProjectId=null,this.activeSearchPrompt=null,this.unsubscribeAuth=null,this.unsubscribeProjects=null,this.unsubscribeSyncStatus=null,this.unsubscribeTick=null,this.toastDismissTimeout=null,this.onHashChange=()=>{this.syncRouteFromHash()},this.onGlobalKeyDown=e=>{e.key==="Escape"&&this.sheetOpen&&(this.sheetOpen=!1,this.swapIndex=null,this.requestUpdate())},this.onLoginRequest=()=>{this.authModalOpen=!0},this.onLogoutRequest=async()=>{await fe.signOut(),U.logout()},this.previousScreenBeforeSets="seed"}connectedCallback(){super.connectedCallback(),this.showTheory=(localStorage.getItem("chroma-chords-show-theory")||localStorage.getItem("chord-voyager-show-theory"))==="true";const e=localStorage.getItem("chroma-chords-instrument");e&&xe.some(i=>i.name===e)&&(this.instrument=e);const t=localStorage.getItem("chroma-chords-play-style");t&&we.some(i=>i.name===t)&&(this.playStyle=t),T.setInstrument(this.instrument),T.setPlayStyle(this.playStyle),this.unsubscribeAuth=fe.subscribe(i=>{this.userEmail=i.user?.email||null,this.isAuthenticated=i.isAuthenticated}),this.unsubscribeProjects=U.subscribeProjects(()=>{this.requestUpdate()}),this.unsubscribeSyncStatus=U.subscribeSyncStatus(i=>{this.syncStatus=i,this.requestUpdate()}),this.unsubscribeTick=T.subscribeTick((i,o,s,r,n)=>{this.activeIndex=i,this.progressStep=o,typeof s=="number"&&(this.activePlayingSectionIdx=s),typeof r=="number"&&(this.totalSongSteps=r),this.playing=T.isPlaying()}),window.addEventListener("hashchange",this.onHashChange),window.addEventListener("keydown",this.onGlobalKeyDown),this.syncRouteFromHash(),Gt().then(i=>{this.chordData=i}).catch(i=>{console.error("Failed to load chord data:",i)})}disconnectedCallback(){super.disconnectedCallback(),T.stopAutoplay(),window.removeEventListener("hashchange",this.onHashChange),window.removeEventListener("keydown",this.onGlobalKeyDown),this.unsubscribeAuth&&this.unsubscribeAuth(),this.unsubscribeProjects&&this.unsubscribeProjects(),this.unsubscribeSyncStatus&&this.unsubscribeSyncStatus(),this.unsubscribeTick&&this.unsubscribeTick(),this.toastDismissTimeout&&clearTimeout(this.toastDismissTimeout)}get isAdmin(){return U.isAdmin}syncRouteFromHash(){const e=window.location.hash.replace(/^#/,"").toLowerCase();e==="sets"||e==="11a"?(this.screen!=="sets"&&(this.previousScreenBeforeSets=this.screen),this.screen="sets"):e==="play-along"||e==="12a"?this.progression?this.screen="play-along":this.screen="seed":e==="song"||e==="5a"?this.progression?(this.screen="song",T.setSong(this.sections)):this.screen="seed":e==="loop"||e==="3a"||e==="8a"?this.progression?this.screen="loop":this.screen="seed":(e==="seed"||e==="2a"||!e)&&(this.screen="seed")}setScreen(e){this.screen=e;const t=`#${e}`;window.location.hash!==t&&history.pushState(null,"",t)}onGenreChange(e){this.genre=e.detail,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}onMoodChange(e){this.mood=e.detail,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}onFreetextSuggestionApplied(e){const t=e.detail;this.pendingChordSuggestion=t.chords?.length&&t.key&&t.scaleType?t:null,e.detail.promptText&&(this.activeSearchPrompt=e.detail.promptText)}async onGenerate(e){if(!this.isGenerating){this.isGenerating=!0;try{this.keyOverride=null,this.scaleOverride=null;const t=e?.detail?.promptText||this.activeSearchPrompt||void 0,i=await co.resolvePrompt(this.chordData,this.genre,this.mood,this.length,t,this.pendingChordSuggestion);i.instrument&&(this.instrument=i.instrument,localStorage.setItem("chroma-chords-instrument",i.instrument),T.setInstrument(i.instrument)),i.playStyle&&(this.playStyle=i.playStyle,localStorage.setItem("chroma-chords-play-style",i.playStyle),T.setPlayStyle(i.playStyle));const o=i.progression;this.progression=o,this.order=Array.from({length:o.chords.length},(s,r)=>r),this.length=o.chords.length,this.activeIndex=0,this.progressStep=0,this.playing=!1,T.setProgression(o,this.order),T.reset(),this.setScreen("loop"),this.sections=Re.createInitialSong(o,this.order),this.activeSectionIdx=0,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}catch(t){console.error("Failed to generate progression:",t),this.toastMessage="Failed to generate progression. Please try again.",setTimeout(()=>{this.toastMessage&&(this.toastMessage=null)},3500)}finally{this.isGenerating=!1}}}onLengthChange(e){this.length=e.detail}regenerate(){const e=ft(this.chordData,this.genre,this.mood,{key:this.keyOverride??void 0,scaleType:this.scaleOverride??void 0,length:this.length});this.progression=e,this.order=Array.from({length:this.length},(t,i)=>i),this.activeIndex=0,this.progressStep=0,T.setProgression(e,this.order),this.syncActiveSection(),this.playing&&(T.startAutoplay(),T.playActiveChord())}syncActiveSection(){this.progression&&(this.sections=Re.syncActiveSection(this.sections,this.activeSectionIdx,this.progression,this.order))}onSetKey(e){this.keyOverride=e.detail,this.regenerate()}onSetScale(e){this.scaleOverride=e.detail,this.regenerate()}onSetGenre(e){this.genre=e.detail,this.regenerate()}onSetMood(e){this.mood=e.detail,this.regenerate()}onSetLength(e){this.length=e.detail,this.regenerate()}onReroll(){this.progression&&this.regenerate()}onReorder(e){if(!this.progression)return;const t=this.order[this.activeIndex];this.order=e.detail;const i=this.order.indexOf(t);this.activeIndex=i>=0?i:0,T.setOrder(this.order,this.activeIndex),this.syncActiveSection()}onBack(){T.stopAutoplay(),this.playing=!1,this.setScreen("seed"),this.sheetOpen=!1,this.keyOverride=null,this.scaleOverride=null}onViewSets(){T.stopAutoplay(),this.playing=!1,this.previousScreenBeforeSets=this.screen==="sets"?"seed":this.screen,this.setScreen("sets")}onBackFromSets(){T.stopAutoplay(),this.playing=!1,this.progression?this.setScreen(this.previousScreenBeforeSets==="song"?"song":"loop"):this.setScreen("seed")}async onLoadProject(e){const t=e.detail,i=U.getProjects().find(s=>s.id===t);if(!i)return;let o=Array.isArray(i.chords)?i.chords:[];if(o.length===0)try{let s=this.chordData;(!s||!s.scales||Object.keys(s.scales).length===0)&&(s=await Gt(),this.chordData=s),o=ft(s,i.genre||"Pop",i.mood||"Neutral",{key:i.key||"C",scaleType:i.scaleType||"MAJOR",length:4}).chords,i.chords=o,U.saveProject(i)}catch(s){console.error(`Failed to auto-recover chords for project "${t}":`,s),this.showToast("Unable to load set: empty chord data.");return}this.currentProjectId=i.id,this.progression={genre:i.genre||"Unknown",mood:i.mood||"Neutral",key:i.key||"C",scaleType:i.scaleType||"MAJOR",bpm:i.bpm||120,chords:o},this.order=Array.from({length:this.progression.chords.length},(s,r)=>r),this.length=this.progression.chords.length,this.showTheory=i.showTheory??this.showTheory,T.setProgression(this.progression,this.order),this.setScreen("loop"),this.sections=Re.createInitialSong(this.progression,this.order),this.activeSectionIdx=0}onDeleteProject(e){U.deleteProject(e.detail),this.currentProjectId===e.detail&&(this.currentProjectId=null),this.requestUpdate()}onRenameProject(e){const t=U.getProjects().find(i=>i.id===e.detail.id);t&&(t.name=e.detail.name,U.saveProject(t),this.requestUpdate())}async onSyncProjects(){await U.syncWithCloud(),this.requestUpdate()}onSaveSet(e){this.saveProject(e.detail)}onTheoryToggle(){this.showTheory=!this.showTheory,localStorage.setItem("chroma-chords-show-theory",String(this.showTheory))}onSetInstrument(e){this.instrument=e.detail,localStorage.setItem("chroma-chords-instrument",e.detail),T.setInstrument(e.detail)}onSetPlayStyle(e){this.playStyle=e.detail,localStorage.setItem("chroma-chords-play-style",e.detail),T.setPlayStyle(e.detail)}onTogglePlay(){this.playing=T.togglePlay()}onTogglePlaySong(){T.setSong(this.sections),this.playing=T.togglePlay()}onChordTap(e){this.progression&&(this.playing&&(T.stopAutoplay(),this.playing=!1),T.clearABOverride(),this.swapIndex=e.detail,this.sheetMode="swap",this.alternatives=Hs(this.chordData,this.progression,e.detail),this.theoryGroups=Ti(this.chordData,this.progression,e.detail),this.borrowedChords=qs(this.chordData,this.progression,e.detail),this.sheetOpen=!0,T.playChordAtIndex(e.detail,.8))}onChordVoicingTap(e){this.progression&&(this.playing&&(T.stopAutoplay(),this.playing=!1),T.clearABOverride(),this.swapIndex=e.detail,this.sheetMode="voicing",this.alternatives=[],this.theoryGroups=[],this.borrowedChords=[],this.sheetOpen=!0,T.playChordAtIndex(e.detail,.8))}onChordPreview(e){this.progression&&(this.playing&&(T.stopAutoplay(),this.playing=!1),T.playChordAtIndex(e.detail,.8))}onAuditionChord(e){const t=e.detail;let i=Array.isArray(t.notes)?t.notes:[];i.length===0&&t.name&&this.progression&&(i=Me(t.name,oe(this.progression.key,this.progression.scaleType))),T.playChordNotes(i,.8)}onSheetClose(){T.clearABOverride(),this.sheetOpen=!1,this.swapIndex=null}onSelectAlternative(e){if(!this.progression||this.swapIndex===null)return;this.playing&&(T.stopAutoplay(),this.playing=!1),T.clearABOverride();const t=e.detail.chord??e.detail,i=[...this.progression.chords];i[this.swapIndex]=t,this.progression={...this.progression,chords:i},T.setProgression(this.progression,this.order),this.sheetOpen=!1,this.swapIndex=null,this.syncActiveSection(),T.playChordNotes(t.notes,.8)}onVoicingPreview(e){T.playChordNotes(e.detail,.6)}onVoicingChange(e){if(!this.progression||this.swapIndex===null)return;const t=[...this.progression.chords];t[this.swapIndex]=Ys(t[this.swapIndex],e.detail.quality,e.detail.extension),this.progression={...this.progression,chords:t},T.setProgression(this.progression,this.order),this.syncActiveSection()}onBackToProgression(){T.stopAutoplay(),this.playing=!1,this.setScreen("loop"),this.progression&&T.setProgression(this.progression,this.order)}onViewSong(){T.stopAutoplay(),this.playing=!1,this.sheetOpen=!1,this.setScreen("song"),T.setSong(this.sections)}onViewPlayAlong(){T.stopAutoplay(),this.playing=!1,this.sheetOpen=!1,this.setScreen("play-along")}onBackFromPlayAlong(){this.setScreen("loop")}onSelectSection(e){const t=this.sections[e.detail];t&&(this.activeSectionIdx=e.detail,this.progression=t.progression,this.order=t.order.slice(),this.activeIndex=0,this.progressStep=0,this.length=t.progression.chords.length,this.keyOverride=t.progression.key,this.scaleOverride=t.progression.scaleType,this.sheetOpen=!1,this.setScreen("loop"),T.setProgression(this.progression,this.order),this.playing&&(T.startAutoplay(),T.playActiveChord()))}onAddSection(){if(!this.progression)return;const e=Re.addSection(this.sections,this.progression);this.sections=e.sections,this.activeSectionIdx=e.activeIndex,this.screen==="song"&&T.setSong(this.sections)}showToast(e,t){this.toastDismissTimeout&&clearTimeout(this.toastDismissTimeout),this.toastMessage=e,this.toastUndoId=t||null,this.toastDismissTimeout=setTimeout(()=>{this.toastMessage=null,this.toastUndoId=null},4500)}onToastUndo(){this.toastUndoId&&(U.deleteProject(this.toastUndoId),this.currentProjectId===this.toastUndoId&&(this.currentProjectId=null),this.toastMessage=null,this.toastUndoId=null,this.requestUpdate())}onToastView(){this.toastMessage=null,this.toastUndoId=null,this.onViewSets()}saveProject(e){if(!this.progression)return;const t=this.currentProjectId||Math.random().toString(36).slice(2,11);this.currentProjectId=t;const i=U.getProjects().find(r=>r.id===t),o=e||(i?i.name:`${this.progression.genre} · ${this.progression.mood}`),s={id:t,name:o,lastModified:Date.now(),genre:this.progression.genre,mood:this.progression.mood,key:this.progression.key,scaleType:this.progression.scaleType,bpm:this.progression.bpm,chords:this.progression.chords,showTheory:this.showTheory};U.saveProject(s),e&&U.scheduleCloudSync(),this.showToast(`Saved "${o}"`,t),this.requestUpdate()}render(){let e;const t=!!(this.currentProjectId&&U.isProjectSaved(this.currentProjectId));if(this.screen==="sets")e=h`
      ...
      `;else if(this.screen==="song")e=h`
        <song-screen
          ...
          .canAddSection=${this.sections.length<Ce.length}
