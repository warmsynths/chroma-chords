import{f as Do,u as Bo,s as Hi,n as ci,l as Yi,F as Wt,S as xe,G as Qe,a as De,E as xt,C as Be,V as yt,D as Fe,R as Me,P as Q,b as Jt,M as vt,c as Wi,d as Oe,g as Fo,i as se,e as ne,h as u,A as Ji,O as Po,w as U}from"./assets/vendor-C6HArRHJ.js";import"https://warmsynths.github.io/human-midi/human-engine.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function i(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(s){if(s.ep)return;s.ep=!0;const n=i(s);fetch(s.href,n)}})();/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ki(e,t){return(i,o,s)=>{const n=r=>r.renderRoot?.querySelector(e)??null;return Uo(i,o,{get(){return n(this)}})}}const Ce="chroma_chords_projects",Ro="chord_voyager_projects";class Te{static getProjects(){if(typeof localStorage>"u"||typeof localStorage.getItem!="function")return[];try{let t=localStorage.getItem(Ce);if(t||(t=localStorage.getItem(Ro),t&&localStorage.setItem(Ce,t)),t){const i=JSON.parse(t);let o=!1;return i.forEach(s=>{(s.genre==="Unknown"||!s.genre)&&(s.genre="Pop",o=!0),Array.isArray(s.chords)||(s.chords=[],o=!0)}),o&&localStorage.setItem(Ce,JSON.stringify(i)),i}}catch(t){console.error("Failed to load projects from localStorage:",t)}return[]}static setProjects(t){if(!(typeof localStorage>"u"||typeof localStorage.setItem!="function"))try{localStorage.setItem(Ce,JSON.stringify(t))}catch(i){console.error("Failed to set projects to localStorage:",i)}}static mergeProjects(t,i){const o=new Map;return t.forEach(s=>o.set(s.id,s)),i.forEach(s=>{const n=o.get(s.id);!n||s.lastModified>n.lastModified?o.set(s.id,s):s.lastModified===n.lastModified&&(n.syncedToCloud=!0)}),Array.from(o.values())}static saveProject(t){const i=this.getProjects(),o=i.findIndex(s=>s.id===t.id);t.lastModified=Date.now(),o>=0?i[o]=t:i.push(t);try{localStorage.setItem(Ce,JSON.stringify(i))}catch(s){console.error("Failed to save project to localStorage:",s)}}static deleteProject(t){let i=this.getProjects();i=i.filter(o=>o.id!==t);try{localStorage.setItem(Ce,JSON.stringify(i))}catch(o){console.error("Failed to delete project from localStorage:",o)}}static exportProjectFile(t){const i=JSON.stringify(t,null,2),o=new Blob([i],{type:"application/json"}),s=URL.createObjectURL(o),n=document.createElement("a");n.href=s,n.download=`${t.name.replace(/[^a-z0-9]/gi,"_").toLowerCase()}_chroma_chords.json`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(s)}static importProjectFile(t){return new Promise((i,o)=>{const s=new FileReader;s.onload=n=>{try{const r=n.target?.result,c=JSON.parse(r);c&&typeof c=="object"&&Array.isArray(c.chords)?(c.id=Math.random().toString(36).substr(2,9),c.lastModified=Date.now(),i(c)):o(new Error("Invalid project file format"))}catch{o(new Error("Failed to parse JSON file"))}},s.onerror=()=>o(new Error("Failed to read file")),s.readAsText(t)})}}const Ze="chroma_chords_auth_token",kt="chroma_chords_auth_user",jo="184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com";function St(e){try{const t=e.split(".");if(t.length!==3)return null;let i=t[1].replace(/-/g,"+").replace(/_/g,"/");for(;i.length%4!==0;)i+="=";let o="";if(typeof atob=="function")o=atob(i);else if(typeof Buffer<"u")o=Buffer.from(i,"base64").toString("binary");else return null;const s=decodeURIComponent(o.split("").map(n=>"%"+("00"+n.charCodeAt(0).toString(16)).slice(-2)).join(""));return JSON.parse(s)}catch{return null}}function _o(){try{return"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com"}catch{return jo}}class Go{constructor(t){this.currentUser=null,this.currentAccessToken=null,this.isLoading=!0,this.listeners=new Set,this.gisLoaded=!1,this.clientId=t!==void 0?t:_o(),this.initSession()}initSession(){if(typeof window>"u"||typeof localStorage>"u"||typeof localStorage.getItem!="function"){this.isLoading=!1;return}try{const t=localStorage.getItem(Ze);if(t){const i=St(t);i&&i.exp&&i.exp*1e3>Date.now()?(this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture}):(localStorage.removeItem(Ze),localStorage.removeItem(kt),this.currentAccessToken=null,this.currentUser=null)}}catch(t){console.warn("Failed to restore auth session from localStorage:",t)}finally{this.isLoading=!1}}isConfigured(){return!!this.clientId}getAuthState(){return{user:this.currentUser,accessToken:this.currentAccessToken,isAuthenticated:!!this.currentUser&&!!this.currentAccessToken,isLoading:this.isLoading}}getUser(){return this.currentUser}async getAccessToken(){if(this.currentAccessToken){const t=St(this.currentAccessToken);if(t&&t.exp&&t.exp*1e3<=Date.now())return await this.signOut(),null}return this.currentAccessToken}subscribe(t){return this.listeners.add(t),t(this.getAuthState()),()=>{this.listeners.delete(t)}}notify(){const t=this.getAuthState();this.listeners.forEach(i=>{try{i(t)}catch(o){console.error("Error in AuthState listener:",o)}})}handleCredentialResponse(t){if(!t||typeof t!="string")return{success:!1,message:"Invalid credential provided."};const i=St(t);if(!i||!i.sub)return{success:!1,message:"Failed to decode Google user token."};if(i.exp&&i.exp*1e3<=Date.now())return{success:!1,message:"Google session token has expired."};this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture};try{typeof localStorage<"u"&&(localStorage.setItem(Ze,t),localStorage.setItem(kt,JSON.stringify(this.currentUser)))}catch(o){console.warn("Failed to persist auth session to localStorage:",o)}return this.notify(),{success:!0,user:this.currentUser}}async loadGisScript(){return typeof window>"u"?!1:window.google?.accounts?.id?(this.gisLoaded=!0,!0):new Promise(t=>{const i=document.querySelector('script[src*="accounts.google.com/gsi/client"]');if(i){i.addEventListener("load",()=>{this.gisLoaded=!0,t(!0)}),i.addEventListener("error",()=>t(!1));return}const o=document.createElement("script");o.src="https://accounts.google.com/gsi/client",o.async=!0,o.defer=!0,o.onload=()=>{this.gisLoaded=!0,t(!0)},o.onerror=()=>t(!1),document.head.appendChild(o)})}async renderGoogleButton(t,i){if(!this.clientId||typeof window>"u"||!t)return;await this.loadGisScript();const o=window.google;if(o?.accounts?.id)try{o.accounts.id.initialize({client_id:this.clientId,callback:s=>{if(s.credential){const n=this.handleCredentialResponse(s.credential);i?.({success:n.success,message:n.message})}else i?.({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.innerHTML="",o.accounts.id.renderButton(t,{theme:"outline",size:"large",type:"standard",shape:"pill",text:"continue_with",logo_alignment:"left",width:320})}catch(s){console.warn("Failed to render Google button:",s)}}async signInWithGoogle(){if(!this.clientId)return{success:!1,message:"Google Client ID is not configured."};if(typeof window>"u")return{success:!1,message:"Window is not available in current environment."};await this.loadGisScript();const t=window.google;return t?.accounts?.id?new Promise(i=>{try{t.accounts.id.initialize({client_id:this.clientId,callback:o=>{if(o.credential){const s=this.handleCredentialResponse(o.credential);i({success:s.success,message:s.message})}else i({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.accounts.id.prompt(o=>{(o.isNotDisplayed?.()||o.isSkippedMoment?.())&&console.info("Google prompt skipped or not displayed.")})}catch(o){const s=o instanceof Error?o.message:String(o);i({success:!1,message:s})}}):{success:!1,message:"Google Sign-In script failed to load."}}async signInWithOAuth(t="google"){return t!=="google"?{success:!1,message:`Unsupported auth provider: ${t}. Only Google is supported.`}:this.signInWithGoogle()}async signOut(){this.currentUser=null,this.currentAccessToken=null;try{typeof localStorage<"u"&&(localStorage.removeItem(Ze),localStorage.removeItem(kt)),typeof window<"u"&&window.google?.accounts?.id&&window.google.accounts.id.disableAutoSelect?.()}catch(t){console.warn("Error during sign out storage cleanup:",t)}return this.notify(),{success:!0}}}const Pe=new Go;class Vo{formatUrl(t){let i=t.trim().replace(/\/+$/,"");return i&&!i.startsWith("http://")&&!i.startsWith("https://")&&(i="https://"+i),i}applyAuthHeaders(t,i){if(!i)return;const o=i.trim();o.toLowerCase().startsWith("bearer ")?t.Authorization=o:t.Authorization=`Bearer ${o}`}async testConnection(t,i){const o=this.formatUrl(t);if(!o)return{ok:!1,status:0,message:"Worker URL cannot be empty"};try{const s={};this.applyAuthHeaders(s,i);const n=new AbortController,r=setTimeout(()=>n.abort(),8e3),c=await fetch(`${o}/api/health`,{method:"GET",headers:s,signal:n.signal});if(clearTimeout(r),c.status===200)return{ok:!0,status:200,message:"Connected to Cloudflare Worker",timestamp:(await c.json().catch(()=>({}))).timestamp};if(c.status===401)return{ok:!1,status:401,message:"Unauthorized: Invalid or missing authorization token"};const d=await c.text().catch(()=>"");return{ok:!1,status:c.status,message:`Connection error (${c.status}): ${d||c.statusText}`}}catch(s){return s instanceof Error&&s.name==="AbortError"?{ok:!1,status:0,message:"Connection timed out (8s limit)"}:{ok:!1,status:0,message:"Network error: Unable to reach worker endpoint"}}}async sync(t,i,o){const s=this.formatUrl(t);if(!s)throw new Error("Worker URL is not configured");const n={"Content-Type":"application/json"};this.applyAuthHeaders(n,i);const r=new AbortController,c=setTimeout(()=>r.abort(),15e3),d=await fetch(`${s}/api/sync`,{method:"POST",headers:n,body:JSON.stringify(o),signal:r.signal});if(clearTimeout(c),!d.ok){let p="";try{const g=await d.json();p=g.error||g.message||""}catch{p=await d.text().catch(()=>"")}throw new Error(`Cloud sync failed (${d.status}): ${p||d.statusText||"Unknown error"}`)}return await d.json()}}const qo=new Vo,yi="chroma_chords_deleted_projects",wi="chroma_chords_last_sync_time",Ho="https://chroma-chords-api.warmsynths.workers.dev";function Yo(){try{return"https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev"}catch{return Ho}}function ki(e){return typeof window<"u"&&typeof localStorage<"u"?localStorage.getItem(e):null}function Si(e,t){typeof window<"u"&&typeof localStorage<"u"&&localStorage.setItem(e,t)}class Wo{constructor(){this.userEmail=null,this.authenticated=!1,this.isCloudSyncing=!1,this.syncTimeout=null,this.syncQueued=!1,this.syncStatus="sign-in",this.authStateCallbacks=new Set,this.projectsChangeCallbacks=new Set,this.syncStatusCallbacks=new Set,this.unsubscribeAuth=null,this.onlineHandler=null,this.offlineHandler=null,this.setupAuthSubscription(),this.setupOnlineListener()}setupAuthSubscription(){this.unsubscribeAuth=Pe.subscribe(t=>{const i=this.authenticated;this.userEmail=t.user?.email||null,this.authenticated=t.isAuthenticated,this.syncStatus=this.authenticated?"synced":"sign-in",this.notifyAuthState(),this.notifySyncStatus(),!i&&this.authenticated&&this.syncWithCloud().catch(o=>{console.warn("Auto cloud sync on sign-in encountered an error:",o)})})}setupOnlineListener(){typeof window<"u"&&typeof window.addEventListener=="function"&&(this.onlineHandler=()=>{this.isAuthenticated()&&this.scheduleCloudSync()},this.offlineHandler=()=>{this.isAuthenticated()&&(this.syncStatus="offline",this.notifySyncStatus())},window.addEventListener("online",this.onlineHandler),window.addEventListener("offline",this.offlineHandler))}destroy(){this.unsubscribeAuth&&(this.unsubscribeAuth(),this.unsubscribeAuth=null),typeof window<"u"&&typeof window.removeEventListener=="function"&&(this.onlineHandler&&(window.removeEventListener("online",this.onlineHandler),this.onlineHandler=null),this.offlineHandler&&(window.removeEventListener("offline",this.offlineHandler),this.offlineHandler=null)),this.syncTimeout&&(clearTimeout(this.syncTimeout),this.syncTimeout=null)}getUserEmail(){return this.userEmail}isAuthenticated(){return this.authenticated}get isAdmin(){return!!(this.userEmail&&this.userEmail.toLowerCase().trim()==="warmsynthsiloveyou@gmail.com")}getSyncStatus(){return this.syncStatus}subscribeSyncStatus(t){return this.syncStatusCallbacks.add(t),t(this.syncStatus),()=>this.syncStatusCallbacks.delete(t)}notifySyncStatus(){this.syncStatusCallbacks.forEach(t=>{try{t(this.syncStatus)}catch(i){console.error("Error in SyncStatus callback:",i)}})}subscribeAuthState(t){return this.authStateCallbacks.add(t),t(this.userEmail,this.authenticated),()=>this.authStateCallbacks.delete(t)}notifyAuthState(){this.authStateCallbacks.forEach(t=>{try{t(this.userEmail,this.authenticated)}catch(i){console.error("Error in AuthState callback:",i)}})}subscribeProjects(t){return this.projectsChangeCallbacks.add(t),t(this.getProjects()),()=>this.projectsChangeCallbacks.delete(t)}subscribe(t){return this.subscribeProjects(t)}notifyProjectsChanged(){const t=this.getProjects();this.projectsChangeCallbacks.forEach(i=>{try{i(t)}catch(o){console.error("Error in ProjectsChange callback:",o)}})}logout(){this.userEmail=null,this.authenticated=!1,this.syncStatus="sign-in",this.notifyAuthState(),this.notifySyncStatus()}getProjects(){return Te.getProjects()}isProjectSaved(t){return t?Te.getProjects().some(i=>i.id===t):!1}saveProject(t){Te.saveProject(t),this.removeTombstone(t.id),this.notifyProjectsChanged(),this.scheduleCloudSync()}deleteProject(t){Te.deleteProject(t),this.addTombstone(t),this.notifyProjectsChanged(),this.scheduleCloudSync()}getTombstones(){const t=ki(yi);if(!t)return[];try{return JSON.parse(t)}catch{return[]}}setTombstones(t){Si(yi,JSON.stringify(t))}addTombstone(t){const i=this.getTombstones(),o=i.findIndex(n=>n.id===t),s=new Date().toISOString();o>=0?i[o].deletedAt=s:i.push({id:t,deletedAt:s}),this.setTombstones(i)}removeTombstone(t){const i=this.getTombstones().filter(o=>o.id!==t);this.setTombstones(i)}getLastSyncTime(){return ki(wi)}setLastSyncTime(t){Si(wi,t)}scheduleCloudSync(){this.syncTimeout&&clearTimeout(this.syncTimeout),this.syncTimeout=setTimeout(()=>{this.syncTimeout=null,this.isCloudSyncing?this.syncQueued=!0:this.syncWithCloud().catch(t=>{console.warn("Scheduled cloud sync failed:",t)})},2e3)}async syncWithCloud(t){if(this.isCloudSyncing){this.syncQueued=!0;return}const i=await Pe.getAccessToken();if(!this.isAuthenticated()||!i)return;const o=t||Yo();if(o){this.isCloudSyncing=!0,this.syncStatus="syncing",this.notifySyncStatus();try{const s=Te.getProjects(),n=this.getTombstones(),r=this.getLastSyncTime(),c=s.map(h=>({...h,deletedAt:null})),d=await qo.sync(o,i,{sets:c,lastSyncTime:r,tombstones:n}),p=new Map;s.forEach(h=>{p.set(h.id,{...h,syncedToCloud:!0})});const g=d.tombstones||[],a=new Set(g.map(h=>h.id));(d.sets||[]).forEach(h=>{if(h.deletedAt)a.add(h.id);else{const m=p.get(h.id),y=h.lastModified||(h.updatedAt?new Date(h.updatedAt).getTime():0),k=m?.lastModified||0;(!m||y>=k)&&p.set(h.id,{id:h.id,name:h.name,lastModified:y,genre:h.genre,mood:h.mood,key:h.key,scaleType:h.scaleType,bpm:h.bpm,showTheory:h.showTheory,chords:Array.isArray(h.chords)?h.chords:[],syncedToCloud:!0})}}),a.forEach(h=>{p.delete(h)});const v=Array.from(p.values());Te.setProjects(v);const b=this.getTombstones(),f=new Set(n.map(h=>h.id)),l=b.filter(h=>!f.has(h.id));this.setTombstones(l),(d.lastSyncTime||d.syncedAt)&&this.setLastSyncTime(d.lastSyncTime||d.syncedAt),this.syncStatus="synced",this.notifySyncStatus(),this.notifyProjectsChanged()}catch(s){console.warn("Cloud sync encountered an error, transitioning to offline status:",s),this.syncStatus="offline",this.notifySyncStatus()}finally{this.isCloudSyncing=!1,this.syncQueued&&(this.syncQueued=!1,this.scheduleCloudSync())}}}async syncProjectsFromCloud(){return this.syncWithCloud()}async syncProjectsToCloud(){return this.syncWithCloud()}}const F=new Wo;let It=null,ht=null,ut=null,gt=null,et=null,$t=null,Ct=null,Tt=null,Et=null,tt=null,it=null,ot=null,st=null,nt=null,At=null,Nt=null,rt=null,Mt=null,Ot=null;function Xi(){return It||(It=new Wi({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination()),It}let at="Warm",Ee=null,Dt=null,ye=null,Bt=null,lt=null,we=null,Ft=null,Pt=null,zt=null,ke=null;function Ke(){if(!Ee){Ee=new Qe(1);const e=Xi();Dt=new De({frequency:3200,type:"lowpass",rolloff:-12}),ye=new Qe(1),Dt.connect(ye),ye.connect(e),Ee.connect(Dt),Bt=new xt({high:3.5,mid:0,low:-.5,highFrequency:4500}),lt=new Be({frequency:1.5,delayTime:3,depth:.35,wet:.3});try{lt.start()}catch{}we=new Qe(0),Bt.connect(lt),lt.connect(we),we.connect(e),Ee.connect(Bt),Ft=new De({frequency:1800,type:"bandpass",Q:.8}),Pt=new yt({frequency:.5,depth:.1,wet:.4}),zt=new Fe({distortion:.1,wet:.15}),ke=new Qe(0),Ft.connect(Pt),Pt.connect(zt),zt.connect(ke),ke.connect(e),Ee.connect(Ft)}return Ee}function Ne(e){Ke();const t=e?e.toLowerCase().trim():"warm";at=t==="glassy"?"Glassy":t==="dusty"?"Dusty":"Warm";const i=.05,o=ci();try{ye&&we&&ke&&(at==="Warm"?(ye.gain.rampTo(1,i,o),we.gain.rampTo(0,i,o),ke.gain.rampTo(0,i,o)):at==="Glassy"?(ye.gain.rampTo(0,i,o),we.gain.rampTo(1,i,o),ke.gain.rampTo(0,i,o)):at==="Dusty"&&(ye.gain.rampTo(0,i,o),we.gain.rampTo(0,i,o),ke.gain.rampTo(1,i,o)))}catch(s){console.warn("Failed to ramp master tone:",s)}}function Jo(e="Warm",t){const i=e?e.toLowerCase().trim():"warm",o=t??Fo();if(i==="glassy"){const n=new xt({high:3.5,mid:0,low:-.5,highFrequency:4500}),r=new Be({frequency:1.5,delayTime:3,depth:.35,wet:.3});try{r.start(0)}catch{}return n.connect(r),r.connect(o),n}if(i==="dusty"){const n=new De({frequency:1800,type:"bandpass",Q:.8}),r=new yt({frequency:.5,depth:.1,wet:.4}),c=new Fe({distortion:.1,wet:.15});return n.connect(r),r.connect(c),c.connect(o),n}const s=new De({frequency:3200,type:"lowpass",rolloff:-12});return s.connect(o),s}const Lt=typeof import.meta<"u"&&"./"||"./",di=Lt.endsWith("/")?Lt:`${Lt}/`,Qi={A1:"A1.mp3",C2:"C2.mp3","F#2":"Fs2.mp3",C3:"C3.mp3","F#3":"Fs3.mp3",C4:"C4.mp3","F#4":"Fs4.mp3",C5:"C5.mp3","F#5":"Fs5.mp3",C6:"C6.mp3","F#6":"Fs6.mp3",C7:"C7.mp3"},Ko=`${di}audio/samples/grand-piano/`,Zi={F1:"A_029__F1_5.m4a",B1:"A_035__B1_5.m4a",E2:"A_040__E2_5.m4a",A2:"A_045__A2_5.m4a",D3:"A_050__D3_5.m4a",G3:"A_055__G3_5.m4a",B3:"A_059__B3_5.m4a",D4:"A_062__D4_5.m4a",F4:"A_065__F4_5.m4a",B4:"A_071__B4_5.m4a",E5:"A_076__E5_5.m4a",A5:"A_081__A5_5.m4a",D6:"A_086__D6_5.m4a",G6:"A_091__G6_5.m4a"},Xo=`${di}audio/samples/stage-rhodes/`,eo={B1:"B1.mp3",E2:"E2.mp3",A2:"A2.mp3",D3:"D3.mp3",G3:"G3.mp3",B3:"B3.mp3",E4:"E4.mp3",A4:"A4.mp3",E5:"E5.mp3",A5:"A5.mp3"},Qo=`${di}audio/samples/nylon-guitar/`;function Zo(e="piano"){let t=null,i={};if(e==="guitar"?(t=gt,i=eo):e==="rhodes"||e==="epiano"?(t=ut,i=Zi):(t=ht,i=Qi),!t||!t.loaded)return null;const o=t._buffers;if(!o)return null;const s={};for(const n of Object.keys(i))try{const r=Wt(n).toMidi(),c=o.has(r)?o.get(r):o.has(n)?o.get(n):null;c&&typeof c.get=="function"&&c.get()&&(s[n]=c.get())}catch{}return Object.keys(s).length>0?s:null}async function es(e="piano"){const t=ts(e);if(t.loaded)return t;try{return await Promise.race([Yi(),new Promise((i,o)=>setTimeout(()=>o(new Error("Sample load timeout")),3e3))]),t}catch(i){return console.warn(`ensureSamplerLoaded(${e}) timed out or failed:`,i),null}}function to(){return ht||(ht=new Oe({urls:Qi,baseUrl:Ko,volume:-9,onload:()=>console.log("Grand Piano sampler loaded successfully!"),onerror:e=>console.warn("Failed to load Grand Piano sampler:",e)}).connect(Ke())),ht}function io(){return ut||(ut=new Oe({urls:Zi,baseUrl:Xo,volume:-10,onload:()=>console.log("Stage Rhodes sampler loaded successfully!"),onerror:e=>console.warn("Failed to load Stage Rhodes sampler:",e)}).connect(Ke())),ut}function oo(){return gt||(gt=new Oe({urls:eo,baseUrl:Qo,volume:-8,onload:()=>console.log("Nylon Guitar sampler loaded successfully!"),onerror:e=>console.warn("Failed to load Nylon Guitar sampler:",e)}).connect(Ke())),gt}function ts(e){return e==="guitar"?oo():e==="rhodes"||e==="epiano"?io():to()}function is(e){const t=Ke();switch(e){case"organ":return et||($t=new yt({frequency:5.8,depth:.12,wet:.55}),Ct=new Fe({distortion:.08,wet:.15}),Tt=new De({frequency:4500,type:"lowpass",rolloff:-12}),et=new Q(xe,{oscillator:{type:"fatsine",count:3,spread:15},envelope:{attack:.008,decay:.15,sustain:.9,release:.25},volume:-12}),et.connect($t),$t.connect(Ct),Ct.connect(Tt),Tt.connect(t)),et;case"pad-strings":if(!it){Et=new Me({decay:5.5,preDelay:.03,wet:.45}),tt=new Be({frequency:.45,delayTime:4,depth:.5,wet:.4});try{tt.start()}catch{}it=new Q(xe,{oscillator:{type:"fatsawtooth",count:3,spread:22},envelope:{attack:.65,decay:.8,sustain:.85,release:2.5},volume:-13}),it.connect(tt),tt.connect(Et),Et.connect(t)}return it;case"juno-pad":if(!st){ot=new Be({frequency:.85,delayTime:3.5,depth:.72,wet:.55});try{ot.start()}catch{}st=new Q(vt,{oscillator:{type:"fatsawtooth",count:3,spread:20},envelope:{attack:.02,decay:.45,sustain:.65,release:.85},filterEnvelope:{attack:.02,decay:.5,sustain:.35,release:.8,baseFrequency:750,octaves:3.2,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.5},volume:-12}),st.connect(ot),ot.connect(t)}return st;case"stab":return nt||(At=new Fe({distortion:.1,wet:.12}),Nt=new Me({decay:1,wet:.22}),nt=new Q(vt,{oscillator:{type:"fatsawtooth",count:2,spread:12},envelope:{attack:.003,decay:.16,sustain:.08,release:.18},filterEnvelope:{attack:.003,decay:.14,sustain:.05,release:.16,baseFrequency:420,octaves:3.5,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2},volume:-10}),nt.connect(At),At.connect(Nt),Nt.connect(t)),nt;case"bell":return rt||(Mt=new xt({high:3.5,mid:-.5,low:-2,highFrequency:4800}),Ot=new Me({decay:3.2,wet:.32}),rt=new Q(Jt,{harmonicity:3.5,modulationIndex:12,envelope:{attack:.002,decay:1.2,sustain:.04,release:1.4},modulationEnvelope:{attack:.002,decay:.6,sustain:.01,release:.5},volume:-12}),rt.connect(Mt),Mt.connect(Ot),Ot.connect(t)),rt;case"guitar":return oo();case"rhodes":case"epiano":return io();case"piano":default:return to()}}const le=[{name:"Grand Piano",instrument:"piano",color:"#9CC0EC"},{name:"Stage Rhodes",instrument:"rhodes",color:"#F2A79B"},{name:"Nylon Guitar",instrument:"guitar",color:"#F6D98B"},{name:"Cinematic Pad",instrument:"pad-strings",color:"#C9A9E0"},{name:"Celestial Bell",instrument:"bell",color:"#B8CC9E"},{name:"Drawbar Organ",instrument:"organ",color:"#E8609A"},{name:"Juno Synth",instrument:"juno-pad",color:"#7B61FF"},{name:"House Stab",instrument:"stab",color:"#FF8C42"}],Ii={piano:"Grand Piano","grand piano":"Grand Piano",rhodes:"Stage Rhodes","stage rhodes":"Stage Rhodes",epiano:"Stage Rhodes","nylon guitar":"Nylon Guitar",guitar:"Nylon Guitar","warm pad":"Cinematic Pad","cinematic pad":"Cinematic Pad","pad-strings":"Cinematic Pad","synth bell":"Celestial Bell","celestial bell":"Celestial Bell",bell:"Celestial Bell","drawbar organ":"Drawbar Organ",organ:"Drawbar Organ","analog synth":"Juno Synth","juno synth":"Juno Synth","juno-pad":"Juno Synth","synth stab":"House Stab","house stab":"House Stab",stab:"House Stab"};function ge(e){if(!e)return"Grand Piano";const t=e.trim().toLowerCase();if(Ii[t])return Ii[t];const i=le.find(o=>o.name.toLowerCase()===t);return i?i.name:"Grand Piano"}const $e=[{name:"Block chords",color:"#F2A79B",patch:{arpMode:"off",spread:.3}},{name:"Arpeggio",color:"#9CC0EC",patch:{arpMode:"up",arpRate:"1/8",arpRange:1}},{name:"Strum",color:"#F6D98B",patch:{arpMode:"up",arpRate:"1/32",arpRange:1}},{name:"Broken (swing)",color:"#C9A9E0",patch:{arpMode:"up",arpRate:"1/8T",arpRange:1}},{name:"Half-time",color:"#B8CC9E",patch:{arpMode:"off",spread:.1,durationMultiplier:1.8}},{name:"Descending Arp",color:"#7B61FF",patch:{arpMode:"down",arpRate:"1/8",arpRange:1}},{name:"Off-beat / Ska",color:"#FF8C42",patch:{arpMode:"off",spread:.1,microTiming:.8}},{name:"Fast Triplet",color:"#7CD9B6",patch:{arpMode:"up",arpRate:"1/16T",arpRange:1}}],Xe={Pop:"piano",Rock:"piano","Indie/Folk":"guitar","Lo-fi/Chill":"rhodes","Jazz-ish":"rhodes","R&B/Soul":"rhodes",Gospel:"organ",Cinematic:"pad-strings",Synthwave:"juno-pad","House/Dance":"stab",Blues:"rhodes","Funk/Disco":"rhodes","Country/Bluegrass":"guitar","Reggae/Dub":"organ",Metal:"stab",Punk:"stab","Ambient/Drone":"pad-strings","Trap/Hip-Hop":"bell","Bossa Nova/Latin":"guitar","Classical/Orchestral":"piano","EDM/Trance":"juno-pad",Afrobeats:"guitar",Shoegaze:"pad-strings"},pi={Pop:{minVelocity:90,maxVelocity:110,spread:.5,microTiming:.3,humanVariance:.3,duration:1},Rock:{minVelocity:105,maxVelocity:127,spread:.2,microTiming:.1,humanVariance:.15,duration:.9},"Indie/Folk":{minVelocity:80,maxVelocity:105,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},"Lo-fi/Chill":{minVelocity:55,maxVelocity:85,spread:2.5,microTiming:1.2,humanVariance:.8,duration:1.4,arpMode:"up",arpRate:"1/8",arpRange:1},"Jazz-ish":{minVelocity:70,maxVelocity:100,spread:1.8,microTiming:1,humanVariance:.6,duration:1.2,arpMode:"up",arpRate:"1/8T",arpRange:1},"R&B/Soul":{minVelocity:75,maxVelocity:105,spread:1.2,microTiming:.6,humanVariance:.5,duration:1.3},Gospel:{minVelocity:95,maxVelocity:120,spread:.4,microTiming:.2,humanVariance:.2,duration:1.5},Cinematic:{minVelocity:60,maxVelocity:90,spread:0,microTiming:0,humanVariance:.1,duration:2.2},Synthwave:{minVelocity:70,maxVelocity:95,spread:0,microTiming:0,humanVariance:.1,duration:1.8},"House/Dance":{minVelocity:100,maxVelocity:127,spread:0,microTiming:.1,humanVariance:.15,duration:.5},Blues:{minVelocity:80,maxVelocity:110,spread:1.4,microTiming:.7,humanVariance:.5,duration:1.2},"Funk/Disco":{minVelocity:95,maxVelocity:125,spread:.3,microTiming:.2,humanVariance:.2,duration:.8},"Country/Bluegrass":{minVelocity:85,maxVelocity:115,spread:1,microTiming:.4,humanVariance:.3,duration:1},"Reggae/Dub":{minVelocity:70,maxVelocity:100,spread:2,microTiming:1,humanVariance:.6,duration:1.3},Metal:{minVelocity:110,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:.8},Punk:{minVelocity:115,maxVelocity:127,spread:.1,microTiming:.1,humanVariance:.1,duration:.7},"Ambient/Drone":{minVelocity:45,maxVelocity:75,spread:0,microTiming:0,humanVariance:.05,duration:3},"Trap/Hip-Hop":{minVelocity:90,maxVelocity:120,spread:.2,microTiming:.2,humanVariance:.2,duration:1},"Bossa Nova/Latin":{minVelocity:75,maxVelocity:105,spread:1.5,microTiming:.8,humanVariance:.5,duration:1.1,arpMode:"up",arpRate:"1/8T",arpRange:1},"Classical/Orchestral":{minVelocity:50,maxVelocity:115,spread:.5,microTiming:.3,humanVariance:.3,duration:2},"EDM/Trance":{minVelocity:95,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:1.2},Afrobeats:{minVelocity:85,maxVelocity:115,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},Shoegaze:{minVelocity:65,maxVelocity:95,spread:.8,microTiming:.4,humanVariance:.3,duration:2.5}},os={piano:"Grand Piano",rhodes:"Stage Rhodes",epiano:"Stage Rhodes",guitar:"Nylon Guitar","pad-strings":"Cinematic Pad",bell:"Celestial Bell",organ:"Drawbar Organ","juno-pad":"Juno Synth",stab:"House Stab"};function ss(e){const t=Xe[e]??"piano";return os[t]??"Grand Piano"}function ns(e){return(pi[e]?.arpMode??"off")==="off"?"Block chords":"Arpeggio"}function so(){return Promise.race([Yi(),new Promise(e=>setTimeout(e,80))])}function no(e,t){const i=t/60;switch(e){case"1/4":return 1/i;case"1/8":return .5/i;case"1/8T":return .5/i*(2/3);case"1/16":return .25/i;case"1/32":return .125/i;default:return .25/i}}function ro(e,t){const i=[];for(let o=0;o<t;o++)for(const s of e){const n=s.match(/^([A-G]#?)(-?\d+)$/);if(n){const r=n[1],c=parseInt(n[2],10)+o;i.push(`${r}${c}`)}else i.push(s)}return i}function ao(e,t){const i=[...e];switch(t){case"up":return i;case"down":return[...i].reverse();case"up-down":return[...i,...[...i].reverse().slice(1,-1)];case"random":return i.sort(()=>Math.random()-.5);default:return i}}const $i={piano:"Grand Piano",rhodes:"Stage Rhodes",epiano:"Stage Rhodes",guitar:"Nylon Guitar","pad-strings":"Cinematic Pad","juno-pad":"Juno Synth",bell:"Celestial Bell",organ:"Drawbar Organ",stab:"House Stab"};function rs(e){if(!e)return;const t=e.toLowerCase().trim();return $i[t]?$i[t]:le.find(o=>o.name.toLowerCase()===t||o.instrument.toLowerCase()===t)?.name}function as(e){if(!e)return;const t=e.toLowerCase().trim();return t.includes("strum")?"Strum":t.includes("descend")?"Descending Arp":t.includes("half")?"Half-time":t.includes("swing")||t.includes("broken")?"Broken (swing)":t.includes("offbeat")||t.includes("ska")||t.includes("syncopat")||t.includes("groove")?"Off-beat / Ska":t.includes("triplet")||t.includes("fast")?"Fast Triplet":t.includes("arp")||t.includes("cascade")?"Arpeggio":t.includes("block")||t.includes("pad")||t.includes("sustained")?"Block chords":$e.find(o=>o.name.toLowerCase()===t)?.name??"Block chords"}function ls(e,t=.7,i,o="piano",s){try{Promise.all([Hi(),so()]).then(()=>{const n=is(o);if(s&&typeof s=="object"&&Object.keys(s).length>0)try{typeof n.set=="function"&&n.set(s)}catch(a){console.warn("Failed to apply customConfig to Tone.js instrument:",a)}const r=e.length,c=r<=1?1:Math.max(.4,1/Math.sqrt(r)),d=ci();if(i&&i.arpMode&&i.arpMode!=="off"){const a=i.bpm??80,v=i.arpRate??"1/16",b=i.arpRange??1,f=i.arpMode,l=no(v,a),h=ro(e,b),m=ao(h,f),y=()=>i.minVelocity!==void 0&&i.maxVelocity!==void 0?(i.minVelocity+Math.random()*(i.maxVelocity-i.minVelocity))/127*c:c,k=i.duration?i.duration*(1+(Math.random()-.5)*.1*(i.humanVariance??0)):Math.max(.05,l*.9);m.forEach((w,E)=>{const O=i.microTiming?(Math.random()-.5)*i.microTiming*.02:0;n.triggerAttackRelease(w,k,d+E*l+O,y())});return}const p=o==="guitar";(p?[...e].sort((a,v)=>{try{return Wt(a).toMidi()-Wt(v).toMidi()}catch{return 0}}):e).forEach((a,v)=>{let b=0,f=c,l=t;if(i){const{minVelocity:h,maxVelocity:m,spread:y,microTiming:k,humanVariance:w,duration:E}=i;f=(typeof i.velocity=="number"?Math.min(1,Math.max(.1,i.velocity/127)):(h+Math.random()*(m-h))/127)*c;const _=p?v*.024:0,G=v*(y??.3)*.1,Y=(Math.random()-.5)*(k??0)*.05,K=(Math.random()-.5)*(w??0)*.03;b=Math.max(0,_+G+Y+K),l=(E||t)*(1+(Math.random()-.5)*.2*(w??0))}else p&&(b=v*.024);p&&v===0&&(f=Math.min(1,f*1.1)),n.triggerAttackRelease(a,l,d+b,f)})}).catch(n=>{console.warn("Audio playback gesture failed:",n)})}catch(n){console.warn("Audio playback failed:",n)}}function lo(e,t){if(!Array.isArray(e)||e.length===0)return[];if(e.length<=1)return e;if(t<=25)return e.length<=2?e:[e[0],e[e.length-1]];if(t<=55)return e.length<=4?e:e.slice(0,4);if(t<=80)return e;const i=[...e],s=e[e.length-1].match(/^([A-G]#?)(-?\d+)$/);if(s){const n=parseInt(s[2],10);i.push(`${s[1]}${n+1}`)}return i}function Ci(e,t,i){const o=t==="Unknown"||!t?"Pop":t,s=i?.instrument?ge(i.instrument):void 0,n=s?le.find(h=>h.name.toLowerCase()===s.toLowerCase()):void 0,r=i?.playStyle?$e.find(h=>h.name===i.playStyle):void 0,c=n?.instrument??Xe[o]??"piano",d=pi[o]||{},p=r?.patch??{};i?.feelSettings?.tone&&Ne(i.feelSettings.tone);const g={};if(i?.feelSettings){const{spread:h,swing:m,humanState:y}=i.feelSettings;y?Object.assign(g,y):(typeof h=="number"&&(g.spread=parseFloat((h/100*1.5).toFixed(2))),typeof m=="number"&&(g.microTiming=parseFloat((m/100*.9).toFixed(2)),g.humanVariance=parseFloat((m/100*.6).toFixed(2))))}const a={...d,...p,...g,bpm:i?.bpm??d.bpm??90,...typeof i?.velocity=="number"?{velocity:i.velocity}:{}},v=i?.duration??d.duration??.9,b=p.durationMultiplier?v*p.durationMultiplier:v,f=i?.feelSettings?.density??50,l=lo(e,f);ls(l,b,a,c,i?.customConfig)}let Ut=null;function cs(){if(!Ut){const e=Xi();Ut=new xe({oscillator:{type:"sine"},envelope:{attack:.02,decay:.25,sustain:.85,release:.4},volume:-7}).connect(e)}return Ut}function ds(e,t=.8,i,o=.85){try{Promise.all([Hi(),so()]).then(()=>{const s=cs(),r=`${e.replace(/\d+$/,"")}1`,c=typeof i=="number"?i:ci();s.triggerAttackRelease(r,t,c,o)}).catch(s=>console.warn("Sub bass audio failed:",s))}catch(s){console.warn("Sub bass audio failed:",s)}}function ps(e,t="root position"){const i={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},o=4,s=(Array.isArray(e)?e:[]).filter(p=>typeof p=="string"&&p.trim().length>0).map(p=>p.replace(/\d+$/,""));if(s.length===0)return["C4","E4","G4"];let n=o,r=i[s[0]]??0;const c=[];s.forEach((p,g)=>{const a=i[p]??0;g>0&&a<=r&&n++,c.push({name:p,oct:n}),r=a});const d=(t||"").toLowerCase();if(d.includes("octave")||d.includes("high"))return c.map(p=>`${p.name}${p.oct+1}`);if(d.includes("inversion")||d.includes("1st")){if(c.length>1){const[p,...g]=c;return[...g.map(a=>`${a.name}${a.oct}`),`${p.name}${p.oct+1}`]}return c.map(p=>`${p.name}${p.oct}`)}else return c.map(p=>`${p.name}${p.oct}`)}const hs=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],us=["C","Db","D","Eb","E","F","Gb","G","Ab","A","Bb","B"],P={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},gs=new Set(["F","Bb","Eb","Ab","Db","Gb"]),Ye=["C","Db","D","Eb","E","F","F#","G","Ab","A","Bb","B"],ce={maj:[0,4,7],min:[0,3,7],dim:[0,3,6],aug:[0,4,8],dom7:[0,4,7,10],min7:[0,3,7,10],maj7:[0,4,7,11],dim7:[0,3,6,9],sus4:[0,5,7],sus2:[0,2,7],dom9:[0,4,7,10,14],maj9:[0,4,7,11,14],min9:[0,3,7,10,14],maj6:[0,4,7,9],min6:[0,3,7,9],mmaj7:[0,3,7,11],sus7:[0,5,7,10],sus9:[0,5,7,10,14]},ms=Object.keys(ce),co={TONIC:"home",SUPERTONIC:"rise",MEDIANT:"glow",SUBDOMINANT:"lift",DOMINANT:"reach",SUBMEDIANT:"hold","LEADING-TONE":"edge",SUBTONIC:"drift"},Kt={TONIC:"Tonic",SUPERTONIC:"Supertonic",MEDIANT:"Mediant",SUBDOMINANT:"Subdominant",DOMINANT:"Dominant",SUBMEDIANT:"Submediant","LEADING-TONE":"Leading tone",SUBTONIC:"Subtonic"},hi={TONIC:.04,SUBMEDIANT:.24,MEDIANT:.34,SUBDOMINANT:.42,SUPERTONIC:.52,SUBTONIC:.58,"LEADING-TONE":.78,DOMINANT:.68},Xt={MAJOR:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},NATURAL_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},HARMONIC_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III+",SUBDOMINANT:"iv",DOMINANT:"V",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MELODIC_MINOR:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III+",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},DORIAN:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MIXOLYDIAN:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii°",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},LYDIAN:{TONIC:"I",SUPERTONIC:"II",MEDIANT:"iii",SUBDOMINANT:"iv°",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii",SUBTONIC:"♭VII"},PHRYGIAN:{TONIC:"i",SUPERTONIC:"♭II",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v°",SUBMEDIANT:"♭VI","LEADING-TONE":"vii",SUBTONIC:"♭vii"},LOCRIAN:{TONIC:"i°",SUPERTONIC:"♭II",MEDIANT:"♭iii",SUBDOMINANT:"iv",DOMINANT:"♭V",SUBMEDIANT:"♭VI","LEADING-TONE":"♭vii",SUBTONIC:"♭vii"}};function D(e,t){const i=(e%12+12)%12;return t?us[i]:hs[i]}function ee(e){if(!e)return{root:"C",quality:"maj"};const t=e.trim(),i=t[0]?.toUpperCase();let o="C",s=t;if(i&&/[A-G]/.test(i)){const r=t[1];r==="b"||r==="B"||r==="♭"||r==="♭"?(o=`${i}b`,s=t.slice(2)):r==="#"||r==="♯"||r==="♯"?(o=`${i}#`,s=t.slice(2)):(o=i,s=t.slice(1))}s=s.toLowerCase();let n="maj";return s.includes("maj9")||s.includes("m9")&&s.includes("maj")?n="maj9":s.includes("min9")||s.includes("m9")?n="min9":s.includes("dom9")||s.includes("9sus")||s.includes("9")?s.includes("9sus")||s.includes("sus9")?n="sus9":n="dom9":s.includes("m(maj7)")||s.includes("mmaj7")||s.includes("minmaj7")?n="mmaj7":s.includes("maj7sus")||s.includes("7sus")?n="sus7":s.includes("maj7")||s.includes("m7")&&s.includes("maj")?n="maj7":s.includes("min7")||s.includes("m7")?n="min7":s.includes("min6")||s.includes("m6")?n="min6":s.includes("maj6")||s.includes("6")&&!s.includes("m")?n="maj6":s.includes("dim7")?n="dim7":s.includes("dim")||s.includes("°")?n="dim":s.includes("aug")||s.includes("+")?n="aug":s.includes("sus2")?n="sus2":s.includes("sus4")||s.includes("sus")?n="sus4":s.includes("7")?n="dom7":s.includes("min")||s==="m"?n="min":n="maj",{root:o,quality:n}}const fs=Object.keys(Xt),ze={MAJOR:"Ionian",NATURAL_MINOR:"Aeolian",HARMONIC_MINOR:"Harmonic minor",MELODIC_MINOR:"Melodic minor",DORIAN:"Dorian",MIXOLYDIAN:"Mixolydian",LYDIAN:"Lydian"},He=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],vs={Pop:"MAJOR",Rock:"MAJOR",Gospel:"MAJOR","Indie/Folk":"MAJOR","Lo-fi/Chill":"DORIAN","Jazz-ish":"DORIAN","R&B/Soul":"MIXOLYDIAN","House/Dance":"MIXOLYDIAN",Synthwave:"LYDIAN",Cinematic:"LYDIAN",Blues:"MIXOLYDIAN","Funk/Disco":"MIXOLYDIAN","Country/Bluegrass":"MAJOR","Reggae/Dub":"DORIAN",Metal:"HARMONIC_MINOR",Punk:"MAJOR","Ambient/Drone":"LYDIAN","Trap/Hip-Hop":"NATURAL_MINOR","Bossa Nova/Latin":"DORIAN","Classical/Orchestral":"MAJOR","EDM/Trance":"NATURAL_MINOR",Afrobeats:"MIXOLYDIAN",Shoegaze:"LYDIAN"},bs={Uplifting:null,Melancholy:"NATURAL_MINOR",Dreamy:null,Tense:"HARMONIC_MINOR",Warm:null,Nostalgic:"NATURAL_MINOR",Energetic:null,Dark:"HARMONIC_MINOR",Peaceful:null,Groovy:"MIXOLYDIAN",Epic:"MAJOR"},ui={Uplifting:["DOMINANT","SUBDOMINANT","SUBMEDIANT"],Melancholy:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Dreamy:["MEDIANT","SUBDOMINANT","SUPERTONIC"],Tense:["DOMINANT","LEADING-TONE","SUPERTONIC"],Warm:["SUBDOMINANT","MEDIANT","SUBMEDIANT"],Nostalgic:["SUBMEDIANT","MEDIANT","DOMINANT"],Energetic:["DOMINANT","SUBDOMINANT","SUPERTONIC"],Dark:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Peaceful:["TONIC","SUBDOMINANT","MEDIANT"],Groovy:["SUBDOMINANT","DOMINANT","SUBTONIC"],Epic:["TONIC","DOMINANT","SUBMEDIANT"]},Le=[{name:"Uplifting",dot:"#F6D98B",desc:"Bright, major, forward-moving",iconPath:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5"},{name:"Melancholy",dot:"#9CC0EC",desc:"Minor-leaning, unresolved longing",iconPath:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15"},{name:"Dreamy",dot:"#C9A9E0",desc:"Suspended, floating, reverb-soaked",iconPath:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0"},{name:"Tense",dot:"#F2735F",desc:"Chromatic pulls, unresolved tension",iconPath:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12"},{name:"Warm",dot:"#F2C9A0",desc:"Rich, consonant, close voicings",iconPath:"M12 4 a6.5 6.5 0 1 0 6.5 6.5"},{name:"Nostalgic",dot:"#B8CC9E",desc:"Bittersweet, borrowed chords",iconPath:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},{name:"Energetic",dot:"#FF8C42",desc:"High velocity, driving rhythm",iconPath:"M13 2 L4 14 h7 l-2 8 11-12 h-7 z"},{name:"Dark",dot:"#7B61FF",desc:"Deep minor, ominous resonance",iconPath:"M12 3 a9 9 0 1 0 9 9 a9 9 0 0 1-9-9 z"},{name:"Peaceful",dot:"#7CD9B6",desc:"Serene, gentle acoustic space",iconPath:"M12 2 a10 10 0 1 0 10 10 A10 10 0 0 0 12 2 z M12 6 a6 6 0 1 1-6 6 a6 6 0 0 1 6-6 z"},{name:"Groovy",dot:"#E8609A",desc:"Syncopated, rhythmic bounce",iconPath:"M4 12 c4-4 8 4 12-4 s8 4 4 8"},{name:"Epic",dot:"#E5C158",desc:"Sweeping dynamics, triumphant power",iconPath:"M12 2 l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 z"}];function Ie(e){return(Le.find(t=>t.name===e)||Le[0]).dot}const xs={MAJOR:[{degrees:["TONIC","DOMINANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBMEDIANT","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","DOMINANT"]},{degrees:["TONIC","MEDIANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBDOMINANT","SUBMEDIANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","MEDIANT","SUBMEDIANT"]},{degrees:["SUBDOMINANT","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","DOMINANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","SUBMEDIANT","TONIC"]}],NATURAL_MINOR:[{degrees:["TONIC","SUBMEDIANT","MEDIANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","MEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUBTONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","SUBTONIC","TONIC","DOMINANT"]},{degrees:["SUBMEDIANT","SUBTONIC","MEDIANT","TONIC"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","SUBMEDIANT","SUBDOMINANT","TONIC"]}],HARMONIC_MINOR:[{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUBDOMINANT"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUPERTONIC","DOMINANT"]},{degrees:["SUBMEDIANT","DOMINANT","TONIC","SUBDOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]}],DORIAN:[{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUPERTONIC","SUBTONIC"]},{degrees:["SUBDOMINANT","TONIC","SUBTONIC","SUPERTONIC"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUPERTONIC","SUBDOMINANT","SUBTONIC","TONIC"]}],MIXOLYDIAN:[{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBDOMINANT"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUBDOMINANT","SUBTONIC","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","TONIC","SUBDOMINANT","SUPERTONIC"]}],LYDIAN:[{degrees:["TONIC","SUPERTONIC","SUBMEDIANT","DOMINANT"]},{degrees:["TONIC","DOMINANT","SUPERTONIC","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]}]};function ys(e,t){return 1+e.degrees.filter(i=>t.includes(i)).length*.6}function mt(e,t){const i=e.reduce((s,n)=>s+t(n),0);let o=Math.random()*i;for(const s of e)if(o-=t(s),o<=0)return s;return e[e.length-1]}function ws(e){if(e.length)return e[Math.floor(Math.random()*e.length)]}const Qt=4,Ue=1,me=8,ks=1700,Ss={TONIC:{SUBDOMINANT:.35,SUBMEDIANT:.25,SUPERTONIC:.15,DOMINANT:.15,MEDIANT:.05,SUBTONIC:.05},SUPERTONIC:{DOMINANT:.5,SUBDOMINANT:.2,SUBMEDIANT:.15,TONIC:.1,"LEADING-TONE":.05},MEDIANT:{SUBMEDIANT:.4,SUBDOMINANT:.3,SUPERTONIC:.15,DOMINANT:.15},SUBDOMINANT:{DOMINANT:.45,TONIC:.25,SUPERTONIC:.15,SUBMEDIANT:.15},DOMINANT:{TONIC:.55,SUBMEDIANT:.25,SUBDOMINANT:.15,MEDIANT:.05},SUBMEDIANT:{SUBDOMINANT:.4,SUPERTONIC:.25,DOMINANT:.2,TONIC:.15},"LEADING-TONE":{TONIC:.7,SUBMEDIANT:.2,MEDIANT:.1},SUBTONIC:{TONIC:.45,SUBDOMINANT:.3,SUBMEDIANT:.15,DOMINANT:.1}};function Is(e,t="MAJOR",i="Pop",o="Uplifting"){let n={TONIC:1,SUBDOMINANT:.45,SUBMEDIANT:.4,SUPERTONIC:.3,SUBTONIC:.3,MEDIANT:.15,DOMINANT:.15,"LEADING-TONE":.02}[e]??.1;return t.includes("MINOR")||t==="DORIAN"?(e==="SUBMEDIANT"&&(n*=1.4),e==="SUBTONIC"&&(n*=1.3)):t==="MIXOLYDIAN"?(e==="SUBTONIC"&&(n*=1.8),e==="SUBDOMINANT"&&(n*=1.5)):t==="LYDIAN"&&e==="SUPERTONIC"&&(n*=1.8),i==="Lo-fi/Chill"||i==="R&B/Soul"?((e==="SUBDOMINANT"||e==="SUPERTONIC")&&(n*=2),e==="SUBMEDIANT"&&(n*=1.5)):i==="Jazz-ish"||i==="Bossa Nova/Latin"?(e==="SUPERTONIC"&&(n*=2.5),e==="SUBDOMINANT"&&(n*=1.8)):i==="Pop"||i==="Indie/Folk"||i==="Shoegaze"?(e==="SUBDOMINANT"||e==="SUBMEDIANT")&&(n*=1.8):i==="Synthwave"||i==="House/Dance"||i==="Rock"||i==="Punk"||i==="Funk/Disco"||i==="Reggae/Dub"?(e==="SUBTONIC"&&(n*=2.2),e==="SUBDOMINANT"&&(n*=1.8),e==="SUBMEDIANT"&&(n*=1.6)):(i==="Classical/Orchestral"||i==="Gospel")&&e==="TONIC"&&(n*=2.5),o==="Uplifting"||o==="Epic"||o==="Peaceful"?e==="TONIC"&&(n*=2.5):o==="Melancholy"||o==="Dark"?(e==="SUBMEDIANT"&&(n*=2.2),e==="SUPERTONIC"&&(n*=1.5)):o==="Dreamy"||o==="Nostalgic"||o==="Warm"?(e==="SUBDOMINANT"&&(n*=2),e==="SUBMEDIANT"&&(n*=1.6),e==="MEDIANT"&&(n*=1.4)):o==="Tense"?(e==="SUPERTONIC"||e==="SUBDOMINANT")&&(n*=1.8):(o==="Groovy"||o==="Energetic")&&(e==="SUBTONIC"||e==="SUBDOMINANT")&&(n*=1.8),(ui[o]||[]).includes(e)&&(n*=1.3),Math.max(.01,n)}function Rt(e,t,i="MAJOR",o="Pop",s="Uplifting"){if(e===t)return .05;let r=(Ss[e]||{})[t]??.1;return(i.includes("MINOR")||i==="DORIAN")&&(e==="TONIC"&&t==="SUBMEDIANT"&&(r*=1.5),e==="SUBMEDIANT"&&t==="MEDIANT"&&(r*=1.4),e==="MEDIANT"&&t==="SUBTONIC"&&(r*=1.4),e==="SUBTONIC"&&t==="TONIC"&&(r*=1.3)),o==="Jazz-ish"||o==="Lo-fi/Chill"?(e==="SUPERTONIC"&&t==="DOMINANT"&&(r*=1.8),e==="DOMINANT"&&t==="TONIC"&&(r*=1.5),e==="TONIC"&&t==="SUPERTONIC"&&(r*=1.4)):(o==="House/Dance"||o==="Synthwave")&&(t==="SUBTONIC"||t==="SUBDOMINANT")&&(r*=1.5),(ui[s]||[]).includes(t)&&(r*=1.5),Math.max(.01,r)}function $s(e,t,i,o,s,n,r=Qt){let c=i.filter(a=>e.degrees[a]);c.length||(c=i);const d=mt(c,a=>Is(a,e.type,s,n))||"TONIC",p=[d];let g=d;for(let a=1;a<r;a++){const v=a===r-1;let b=i.filter(h=>e.degrees[h]);b.length||(b=i);const f=b.filter(h=>h!==g),l=f.length?f:b;if(v){const h=mt(l,m=>{const y=Rt(m,p[0],e.type,s,n),k=Rt(g,m,e.type,s,n);return y*k});p.push(h)}else{const h=l.filter(k=>!p.includes(k)),m=h.length?h:l,y=mt(m,k=>Rt(g,k,e.type,s,n));g=y,p.push(y)}}return p}function wt(e,t,i){return e.includes("b")||e==="F"||e==="Bb"||e==="Eb"||e==="Ab"||e==="Db"||e==="Gb"?!0:e.includes("#")?!1:i}function H(e,t){const{root:i,quality:o}=ee(e),s=P[i]??0,n=ce[o]||ce.maj,r=wt(i,o,t);return n.map(c=>D(s+c,r))}async function Cs(){const e=typeof import.meta<"u"?"./":"/",t=e.endsWith("/")?e:`${e}/`,i=`${t}chroma_chords_data.json`,o=`${t}chord_voyager_data.json`;let s=await fetch(i).catch(()=>null);if((!s||!s.ok)&&(s=await fetch(o).catch(()=>null)),(!s||!s.ok)&&(s=await fetch("/chroma_chords_data.json").catch(()=>null)),(!s||!s.ok)&&(s=await fetch("/chord_voyager_data.json").catch(()=>null)),!s||!s.ok){const r=new URL("./chroma_chords_data.json",import.meta.url).href;s=await fetch(r)}if(!s.ok)throw new Error(`HTTP error: ${s.status}`);const n=await s.json();return Ds(n),n}const Ts={C:"F",Db:"F#",D:"G",Eb:"Ab",E:"A",F:"Bb","F#":"B",G:"C",Ab:"Db",A:"D",Bb:"Eb",B:"E"},Es={C:"Bb","C#":"B",D:"C","D#":"Db",E:"D",F:"Eb","F#":"E",G:"F","G#":"F#",A:"G","A#":"Ab",B:"A"},As={C:"G",Db:"Ab",D:"A",Eb:"Bb",E:"B",F:"C","F#":"Db",G:"D",Ab:"Eb",A:"E",Bb:"F",B:"F#"},Ns={DORIAN_SUPERTONIC:"TONIC",DORIAN_MEDIANT:"SUPERTONIC",DORIAN_SUBDOMINANT:"MEDIANT",DORIAN_DOMINANT:"SUBDOMINANT",DORIAN_SUBMEDIANT:"DOMINANT","DORIAN_LEADING-TONE":"SUBMEDIANT",DORIAN_TONIC:"SUBTONIC",MIXOLYDIAN_DOMINANT:"TONIC",MIXOLYDIAN_SUBMEDIANT:"SUPERTONIC","MIXOLYDIAN_LEADING-TONE":"MEDIANT",MIXOLYDIAN_TONIC:"SUBDOMINANT",MIXOLYDIAN_SUPERTONIC:"DOMINANT",MIXOLYDIAN_MEDIANT:"SUBMEDIANT",MIXOLYDIAN_SUBDOMINANT:"SUBTONIC",LYDIAN_SUBDOMINANT:"TONIC",LYDIAN_DOMINANT:"SUPERTONIC",LYDIAN_SUBMEDIANT:"MEDIANT","LYDIAN_LEADING-TONE":"SUBDOMINANT",LYDIAN_TONIC:"DOMINANT",LYDIAN_SUPERTONIC:"SUBMEDIANT",LYDIAN_MEDIANT:"LEADING-TONE"},Ms={DORIAN_TONIC:"SUPERTONIC",DORIAN_SUPERTONIC:"MEDIANT",DORIAN_MEDIANT:"SUBDOMINANT",DORIAN_SUBDOMINANT:"DOMINANT",DORIAN_DOMINANT:"SUBMEDIANT",DORIAN_SUBMEDIANT:"LEADING-TONE",DORIAN_SUBTONIC:"TONIC",MIXOLYDIAN_TONIC:"DOMINANT",MIXOLYDIAN_SUPERTONIC:"SUBMEDIANT",MIXOLYDIAN_MEDIANT:"LEADING-TONE",MIXOLYDIAN_SUBDOMINANT:"TONIC",MIXOLYDIAN_DOMINANT:"SUPERTONIC",MIXOLYDIAN_SUBMEDIANT:"MEDIANT",MIXOLYDIAN_SUBTONIC:"SUBDOMINANT",LYDIAN_TONIC:"SUBDOMINANT",LYDIAN_SUPERTONIC:"DOMINANT",LYDIAN_MEDIANT:"SUBMEDIANT",LYDIAN_SUBDOMINANT:"LEADING-TONE",LYDIAN_DOMINANT:"TONIC",LYDIAN_SUBMEDIANT:"SUPERTONIC","LYDIAN_LEADING-TONE":"MEDIANT"},Os={DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]};function Ds(e){const t=[["MIXOLYDIAN",Ts],["DORIAN",Es],["LYDIAN",As]];for(const[i,o]of t)for(const[s,n]of Object.entries(o)){const r=e.scales[`${n}_MAJOR`];if(!r)continue;const c=`${s}_${i}`,d={};for(const p of Os[i]){const g=Ms[`${i}_${p}`],a=r.degrees[g];if(!a)continue;const v=JSON.parse(JSON.stringify(a));v.next_chord_options=(v.next_chord_options||[]).map(b=>{if(b.nodeId.startsWith(`${n}_MAJOR_`)){const f=b.nodeId.replace(`${n}_MAJOR_`,""),l=Ns[`${i}_${f}`];if(l)return{name:b.name,nodeId:`${s}_${i}_${l}`}}return b}),d[p]=v}e.scales[c]={root:s,type:i,degrees:d}}}const Bs=[156,192,236],Fs=[242,115,95];function ft(e,t,i){return e+(t-e)*i}function Re(e){const t=Math.max(0,Math.min(1,e));return"#"+Bs.map((o,s)=>Math.round(ft(o,Fs[s],t))).map(o=>o.toString(16).padStart(2,"0")).join("")}function Z(e){const t=Math.max(0,Math.min(1,e));return{size:Math.round(ft(84,128,t)),radius:Math.round(ft(40,12,t)),fontSize:Math.round(ft(21,30,t)),color:Re(t)}}function po(e,t,i){return{Tonic:`As the tonic, ${i} establishes home — the point of full rest and resolution.`,Supertonic:`As the supertonic, ${i} steps just off home, a light pivot toward what comes next.`,Mediant:`As the mediant, ${i} offers a soft, glowing detour — related to home, but colored differently.`,Subdominant:`As the subdominant, ${i} lifts away from home, opening the progression outward before it turns back.`,Dominant:`As the dominant, ${i} builds the pull of the progression — tension that wants to resolve.`,Submediant:`As the submediant, ${i} offers a warmer, more introspective variation of the tonic — stable but tinged with longing.`,"Leading tone":`As the leading tone, ${i} sits right on the edge, straining toward resolution.`,Subtonic:`As the subtonic, ${i} drifts just below home, a soft modal step rather than a hard pull.`}[e]||`${i} colors the progression as the ${e.toLowerCase()} of ${t}.`}function ho(e,t,i,o){const n=i.degrees[t].chord_name,r=hi[t]??.5,c=Xt[i.type]||Xt.MAJOR;return{name:Ti(n),tag:co[t]||"move",roman:c[t]||"?",color:Re(r),functionLabel:Kt[t]||t,notes:H(n,o),scaleLabel:`${i.root} ${ze[i.type]||i.type}`,desc:po(Kt[t]||t,ze[i.type]||i.type,Ti(n)),degree:t,scaleKey:e,tension:r}}function Ti(e){const{root:t,quality:i}=ee(e);return`${t}${{maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"}[i]??""}`}const Ps={Pop:116,"Lo-fi/Chill":80,"R&B/Soul":90,"Indie/Folk":105,Synthwave:118,"Jazz-ish":95,Gospel:85,Cinematic:75,Rock:124,"House/Dance":126,Blues:88,"Funk/Disco":114,"Country/Bluegrass":110,"Reggae/Dub":78,Metal:140,Punk:155,"Ambient/Drone":65,"Trap/Hip-Hop":135,"Bossa Nova/Latin":120,"Classical/Orchestral":72,"EDM/Trance":132,Afrobeats:108,Shoegaze:112};function uo(e,t){let i=Ps[e]||92;return t==="Tense"&&(i+=6),(t==="Dreamy"||t==="Melancholy")&&(i-=6),i}function Zt(e,t,i,o){const s=Math.max(Ue,Math.min(me,o?.length??Qt)),n=vs[t]||"MAJOR",r=bs[i],c=o?.scaleType||(r&&n==="MAJOR"?r:n);let d=o?.key&&Ye.includes(o.key)?o.key:ws(Ye),p=`${d}_${c}`;e.scales[p]||(d="C",p=`${d}_${c}`);let g=e.scales[p];if(!g){const k=Object.keys(e.scales).find(w=>w.endsWith(`_${c}`))||Object.keys(e.scales)[0];g=e.scales[k],d=g?g.root:"C",p=k}const a=j(d,c),v=Object.keys(g.degrees),b=ui[i]||[],f=xs[c]||[],l=s===Qt?f.filter(k=>k.degrees.every(w=>v.includes(w))):[],y=(l.length&&Math.random()<.25?mt(l,k=>ys(k,b)).degrees:$s(g,p,v,b,t,i,s)).map(k=>ho(p,k,g,a));return{genre:t,mood:i,key:d,scaleType:c,bpm:uo(t,i),chords:y}}const zs={TONIC:{upper:"I",lower:"i"},SUPERTONIC:{upper:"II",lower:"ii"},MEDIANT:{upper:"III",lower:"iii"},SUBDOMINANT:{upper:"IV",lower:"iv"},DOMINANT:{upper:"V",lower:"v"},SUBMEDIANT:{upper:"VI",lower:"vi"},"LEADING-TONE":{upper:"VII",lower:"vii"},SUBTONIC:{upper:"♭VII",lower:"♭vii"}},Ls={0:{upper:"I",lower:"i"},1:{upper:"♭II",lower:"♭ii"},2:{upper:"II",lower:"ii"},3:{upper:"♭III",lower:"♭iii"},4:{upper:"III",lower:"iii"},5:{upper:"IV",lower:"iv"},6:{upper:"♯IV",lower:"♯iv"},7:{upper:"V",lower:"v"},8:{upper:"♭VI",lower:"♭vi"},9:{upper:"VI",lower:"vi"},10:{upper:"♭VII",lower:"♭vii"},11:{upper:"VII",lower:"vii"}};function go(e){return ce[e]?e:ee(`C${e||""}`).quality}function mo(e,t){return t==="dom7"?`${e}7`:t==="maj7"?`${e}maj7`:t==="min7"?`${e}7`:t==="dim"?`${e}°`:t==="dim7"?`${e}°7`:t==="aug"?`${e}+`:t==="sus4"?`${e}sus4`:t==="sus2"?`${e}sus2`:t==="dom9"?`${e}9`:t==="maj9"?`${e}maj9`:t==="min9"?`${e}m9`:e}function fo(e,t){const i=zs[e]||{upper:"I",lower:"i"},s=t==="min"||t==="min7"||t==="dim"||t==="dim7"||t==="min9"?i.lower:i.upper;return mo(s,t)}function gi(e,t){const i=Ls[(e%12+12)%12]||{upper:"?",lower:"?"},s=t==="min"||t==="min7"||t==="dim"||t==="dim7"||t==="min9"?i.lower:i.upper;return mo(s,t)}function Us(e,t,i,o){const s=t==="maj"||t==="dom7"||t==="dom9",n=t==="min"||t==="min7"||t==="min9";if(e==="MEDIANT"&&s)return{functionLabel:"Secondary Dominant",tag:"glow",tension:.58,desc:`${i} acts as a secondary dominant (III) adding bright chromatic tension and pull.`};if(e==="SUPERTONIC"&&s)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.62,desc:`${i} acts as a secondary dominant (II), driving momentum toward the dominant.`};if(e==="SUBMEDIANT"&&s)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.55,desc:`${i} acts as a secondary dominant (VI), energizing the progression.`};if(e==="TONIC"&&t==="dom7")return{functionLabel:"Secondary Dominant",tag:"reach",tension:.52,desc:`${i} acts as a secondary dominant (I7), pulling strongly toward the subdominant.`};if(e==="SUBDOMINANT"&&n)return{functionLabel:"Borrowed (Minor iv)",tag:"drift",tension:.48,desc:`${i} borrows the poignant minor iv cadence from the parallel minor mode.`};const r=hi[e]??.4;return{functionLabel:"Chromatic Alteration",tag:"color",tension:Math.min(.85,r+.15),desc:`${i} adds chromatic color to the ${o.root} ${ze[o.type]||o.type} progression.`}}function mi(e,t,i,o){const s=(e%12+12)%12,n=(P[i]??0)+s,c=`${D(n,o)}${fi[t]??t}`;return s===10?{functionLabel:"Borrowed (Subtonic ♭VII)",tag:"drift",tension:.45,desc:`${c} is the borrowed Mixolydian ♭VII chord, adding a classic rock/pop lift.`}:s===8?{functionLabel:"Borrowed (Submediant ♭VI)",tag:"glow",tension:.5,desc:`${c} is the borrowed Aeolian ♭VI chord, introducing epic modal depth.`}:s===3?{functionLabel:"Borrowed (Mediant ♭III)",tag:"glow",tension:.52,desc:`${c} is the borrowed ♭III chord, providing chromatic punch and modal color.`}:s===1?{functionLabel:"Neapolitan (♭II)",tag:"edge",tension:.65,desc:`${c} is the Neapolitan ♭II chord, providing dramatic half-step motion.`}:{functionLabel:"Borrowed",tag:"drift",tension:.42,desc:`${c} borrows its color from outside the current key.`}}function Rs(e,t,i,o,s){const n=i.degrees[t],{root:r}=ee(n.chord_name),c=P[r]??0,d=D(c,s),p=`${d}${fi[o]??o}`,g=wt(d,o,s),a=ce[o]?ce[o].map(f=>D(c+f,g)):H(n.chord_name,s),v=fo(t,o),b=Us(t,o,p,i);return{name:p,tag:b.tag,roman:v,color:Re(b.tension),functionLabel:b.functionLabel,notes:a,scaleLabel:`${i.root} ${ze[i.type]||i.type}`,desc:b.desc,degree:t,scaleKey:e,tension:b.tension}}function js(e,t,i,o,s,n){const r=`${t}_${i}`,c=e.scales[r];if(!c||!o.length)return null;const d=j(t,i),p=P[t]??0,g={};Object.entries(c.degrees).forEach(([v,b])=>{const{root:f}=ee(b.chord_name),l=P[f]??0;l in g||(g[l]=v)});const a=o.slice(0,me).map(({root:v,quality:b})=>{const f=P[v]??p,l=g[f],h=go(b);if(l){const w=c.degrees[l],{quality:E}=ee(w.chord_name);return h===E||!b&&E?ho(r,l,c,d):Rs(r,l,c,h,d)}const m=(f-p+12)%12,y=mi(m,h,t,d),k=gi(m,h);return _s(t,m,h,y.functionLabel,k,y.tag,d)});return a.length<Ue?null:{genre:s,mood:n,key:t,scaleType:i,bpm:uo(s,n),chords:a}}const fi={maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"};function _s(e,t,i,o,s,n,r){const c=(P[e]??0)+t,d=D(c,r),p=go(i),g=`${d}${fi[p]??p}`,a=wt(d,p,r),v=(ce[p]||ce.maj).map(l=>D(c+l,a)),b=s==="?"?gi(t,p):s,f=.42;return{name:g,tag:n,roman:b,color:Re(f),functionLabel:o==="Borrowed"?mi(t,p,e,r).functionLabel:o,notes:v,scaleLabel:"Borrowed",desc:`${g} borrows its color from outside the current key.`,degree:"BORROWED",scaleKey:"",tension:f}}function ei(e){const t=e.match(/^[A-Ga-g][#b]?/),i=t?t[0]:"C";return i[0].toUpperCase()+i.slice(1)}function Gs(e){const t=(e||"C").trim(),i=t[0]?.toUpperCase()||"C";let o=i,s=t.slice(1);if(t.length>1){const n=t[1];n==="b"||n==="B"||n==="♭"||n==="♭"?(o=`${i}b`,s=t.slice(2)):(n==="#"||n==="♯"||n==="♯")&&(o=`${i}#`,s=t.slice(2))}return{root:o,suffix:s}}function Vs(e,t,i){const{root:o,suffix:s}=Gs(e),n=o.replace("♭","b").replace("♯","#"),c=(((P[n]??0)+t)%12+12)%12;return`${D(c,i)}${s}`}function qs(e,t,i){if(!e||!e.chords||e.chords.length===0)return e;const o=/\bmin\b|minor/i.test(t)||/\b[A-G][#b]?m\b/.test(t),s=/\bmaj\b|major/i.test(t),n=o&&!s,r=t.replace(/\s*(maj|min|major|minor)\s*/gi,"").replace(/♭/g,"b").replace(/♯/g,"#").trim(),c=n?"NATURAL_MINOR":s?"MAJOR":e.scaleType||"MAJOR",d=r,p=(e.key||"C").replace("♭","b").replace("♯","#").trim(),g=P[p]??0,a=P[d]??0,v=((a-g)%12+12)%12,b=j(d,c),f=`${d}_${c}`,l={TONIC:0,SUPERTONIC:2,MEDIANT:c.includes("MINOR")||c==="DORIAN"?3:4,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:c==="MAJOR"||c==="DORIAN"?9:8,SUBTONIC:10,"LEADING-TONE":11},h=e.chords.map(m=>{const y=Vs(m.name,v,b),{root:k,quality:w}=ee(y),O=(((P[k]??0)-a)%12+12)%12;let _=null;for(const[J,ae]of Object.entries(l))if(ae===O){_=J;break}let G,Y,K=m.tag||"move",ie=m.tension,V=m.degree;if(_)V=_,G=fo(V,w),Y=Kt[V]||V,K=co[V]||K,ie=hi[V]??ie;else{V="BORROWED",G=gi(O,w);const J=mi(O,w,d,b);Y=J.functionLabel,K=J.tag||K,ie=J.tension||.45}const T=H(y,b);return{...m,name:y,roman:G,functionLabel:Y,tag:K,notes:T,degree:V,scaleKey:f,scaleLabel:`${d} ${ze[c]||c}`,desc:po(Y,ze[c]||c,y),tension:ie}});return{...e,key:d,scaleType:c,chords:h}}const Ei={Major:[0,4,7],Minor:[0,3,7],"Suspended (sus)":[0,5,7],Diminished:[0,3,6]};function vo(e,t,i,o){const s=P[e]??0;let n=Ei[t]||Ei.Major;return i==="6th"?n=[...n,9]:i==="7th (dom / m7)"?n=[...n,10]:i==="Major 7th (M7)"?n=[...n,11]:i==="9th"&&(n=[...n,10,14]),n.map(r=>D(s+r,o))}const Hs={Major:"",Minor:"m","Suspended (sus)":"sus",Diminished:"dim"},Ys={None:"","6th":"6","7th (dom / m7)":"7","Major 7th (M7)":"maj7","9th":"9"};function bo(e,t,i){return t==="Minor"&&i==="Major 7th (M7)"?`${e}m(maj7)`:`${e}${Hs[t]??""}${Ys[i]??""}`}const Ws={MAJOR:0,LYDIAN:5,MIXOLYDIAN:7,DORIAN:2,NATURAL_MINOR:9,HARMONIC_MINOR:9},xo={};Ye.forEach(e=>{xo[P[e]]=e});function Js(e,t){const i=Ws[t]??0,s=(((P[e]??0)-i)%12+12)%12;return xo[s]??"C"}function j(e,t){const i=Js(e,t);return gs.has(i)||i.includes("b")}function Ai(e,t,i){const o=ei(e.name),s=o.includes("b"),n=bo(o,t,i),r=vo(o,t,i,s);let c=e.roman||"";if(c){const g=c.match(/^([♭♯b#]*)([ivxIVX]+)/);if(g){const a=g[1],v=g[2],b=t==="Minor"||t==="Diminished",f=b?v.toLowerCase():v.toUpperCase();let l="";t==="Diminished"?l=i==="7th (dom / m7)"?"°7":"°":t==="Suspended (sus)"?l="sus4":i==="6th"?l="6":i==="7th (dom / m7)"?l="7":i==="Major 7th (M7)"?l=b?"m(maj7)":"maj7":i==="9th"&&(l=b?"m9":"maj9"),c=`${a}${f}${l}`}}let d=e.tension??1;t==="Diminished"?d=Math.max(d,3):t==="Suspended (sus)"?d=Math.max(d,2):i==="7th (dom / m7)"?d=Math.max(d,2.5):(i==="9th"||i==="Major 7th (M7)")&&(d=Math.max(d,2));const p=Re(d);return{...e,name:n,notes:r,roman:c,tension:d,color:p}}function L(e,t,i,o,s,n,r,c){const d=bo(e,t,i),p=vo(e,t,i,c);return{name:d,tag:o||"sub",roman:o,color:Re(r),functionLabel:s,notes:p,scaleLabel:"Substitution",desc:n,degree:"SUBSTITUTION",scaleKey:"",tension:r}}function vi(e,t,i){const o=P[t.key]??0,s=t.scaleType.includes("MINOR"),n=j(t.key,t.scaleType),r=s?[(()=>{const g=D(o+1,!0),a=L(g,"Major","Major 7th (M7)","♭II","Neapolitan","a dark, dramatic slide in from a half-step above",.6,!0);return{name:a.name,roman:"♭II",notes:a.notes,sub:"Neapolitan chord — a dramatic slide in from a half-step above",chord:a,tension:.6}})(),(()=>{const g=D(o+5,!0),a=L(g,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.45,!0);return{name:a.name,roman:"iv",notes:a.notes,sub:"the minor subdominant — deeper minor mood",chord:a,tension:.45}})(),(()=>{const g=D(o+10,!0),a=L(g,"Minor","7th (dom / m7)","v","Minor dominant","unresolved minor drift",.52,!0);return{name:a.name,roman:"v",notes:a.notes,sub:"a step further into shadow — unresolving drift",chord:a,tension:.52}})()]:[(()=>{const g=D(o+8,!0),a=L(g,"Major","Major 7th (M7)","♭VI","Flat submediant",`borrowed from ${t.key} minor — the cinematic shadow`,.5,!0);return{name:a.name,roman:"♭VI",notes:a.notes,sub:`borrowed from ${t.key} minor — the cinematic shadow`,chord:a,tension:.5}})(),(()=>{const g=D(o+5,!0),a=L(g,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.42,!0);return{name:a.name,roman:"iv",notes:a.notes,sub:"the minor subdominant — softer, sadder",chord:a,tension:.42}})(),(()=>{const g=D(o+3,!0),a=L(g,"Major","Major 7th (M7)","♭III","Flat mediant","a step further out — cooler, more remote",.58,!0);return{name:a.name,roman:"♭III",notes:a.notes,sub:"a step further out — cooler, more remote",chord:a,tension:.58}})()],c=[(()=>{const g=D(o+7,n),a=D(o+2,n),v=L(a,"Major","7th (dom / m7)","V7/V","Secondary dominant",`aimed at ${g}7 — sharpens the approach`,.82,n);return{name:v.name,roman:"V7/V",notes:v.notes,sub:`aimed at ${g}7 — sharpens the approach`,chord:v,tension:.82}})(),(()=>{const g=D(o+(s?3:9),n),a=D(o+4,n),v=L(a,"Major","7th (dom / m7)","V7/vi","Secondary dominant",`aimed at ${g}m7 — makes it feel arrived at`,.88,n);return{name:v.name,roman:"V7/vi",notes:v.notes,sub:`aimed at ${g}m7 — makes it feel arrived at`,chord:v,tension:.88}})(),(()=>{const g=D(o+1,!0),a=L(g,"Major","7th (dom / m7)","subV7","Tritone substitute","a tritone substitute — slides in sideways",.95,!0);return{name:a.name,roman:"subV7",notes:a.notes,sub:"a tritone substitute — slides in sideways",chord:a,tension:.95}})()],d=[(()=>{const g=D(o+5,n),a=L(g,"Major","Major 7th (M7)",s?"IV":"IVmaj7","Subdominant","floats rather than resolving",.3,n);return{name:a.name,roman:"IV",notes:a.notes,sub:"floats rather than resolving",chord:a,tension:.3}})(),(()=>{const g=D(o,n),a=L(g,s?"Minor":"Major","9th",s?"im9":"Imaj9","Tonic extension","the same home with more air in it",.18,n);return{name:a.name,roman:s?"im9":"Imaj9",notes:a.notes,sub:"the same home with more air in it",chord:a,tension:.18}})(),(()=>{const g=D(o+(s?3:4),n),a=L(g,s?"Major":"Minor","7th (dom / m7)",s?"♭III":"iii","Mediant","wistful, halfway between home and away",.35,n);return{name:a.name,roman:s?"♭III":"iii",notes:a.notes,sub:"wistful, halfway between home and away",chord:a,tension:.35}})()],p=[(()=>{const g=D(o,n),a=L(g,s?"Minor":"Major",s?"None":"Major 7th (M7)",s?"i":"I","Tonic","full resolution — the sense of arriving",.05,n);return{name:a.name,roman:s?"i":"I",notes:a.notes,sub:"full resolution — the sense of arriving",chord:a,tension:.05}})(),(()=>{const g=D(o+7,n),a=L(g,"Major","7th (dom / m7)","V7","Dominant","the pull that makes home feel earned",1,n);return{name:a.name,roman:"V7",notes:a.notes,sub:"the pull that makes home feel earned",chord:a,tension:1}})(),(()=>{const g=D(o+(s?8:9),n),a=L(g,s?"Major":"Minor","7th (dom / m7)",s?"♭VI":"vi","Submediant","a soft landing instead of a full stop",.28,n);return{name:a.name,roman:s?"♭VI":"vi",notes:a.notes,sub:"a soft landing instead of a full stop",chord:a,tension:.28}})()];return[{name:"Darker",sub:"heavier, more shadow",tension:.55,rows:r},{name:"More tension",sub:"sharper pull forward",tension:.85,rows:c},{name:"Dreamier",sub:"softer, more air",tension:.3,rows:d},{name:"Resolve home",sub:"settles back to center",tension:.05,rows:p}]}function yo(e,t,i){const o=P[t.key]??0,s=t.scaleType.includes("MINOR"),n=j(t.key,t.scaleType),r=t.chords;if(s){const l=r[0]?.name||"chord 1",h=r[1]?.name||"chord 2",m=r[2]?.name||"chord 3",y=r[3]?.name||"chord 4",k=L(D(o,n),"Major","None","I","Major tonic","same root, turned bright",.2,n),w=L(D(o+5,n),"Major","None","IV","Major subdominant","the Dorian lift, sunny and open",.35,n),E=L(D(o+9,n),"Minor","None","vi","Submediant","melodic lift upward",.4,n),O=L(D(o+11,n),"Diminished","None","vii°","Leading tone","classical harmonic pull",.55,n);return[{name:k.name,sub:`in place of ${l} · same root, turned bright`,roman:"I",notes:k.notes,chord:k,tension:.2},{name:w.name,sub:`in place of ${h} · the Dorian lift, sunny and open`,roman:"IV",notes:w.notes,chord:w,tension:.35},{name:E.name,sub:`in place of ${m} · melodic lift upward`,roman:"vi",notes:E.notes,chord:E,tension:.4},{name:O.name,sub:`in place of ${y} · classical harmonic pull`,roman:"vii°",notes:O.notes,chord:O,tension:.55}]}const c=r[0]?.name||"chord 1",d=r[1]?.name||"chord 2",p=r[2]?.name||"chord 3",g=r[3]?.name||"chord 4",a=L(D(o,n),"Minor","None","i","Tonic minor","same root, turned sad",.3,n),v=L(D(o+5,!0),"Minor","None","iv","Minor subdominant","the lift, but heavier",.4,!0),b=L(D(o+8,!0),"Major","None","♭VI","Flat submediant","big and cinematic",.45,!0),f=L(D(o+10,!0),"Major","None","♭VII","Flat subtonic","lands sideways, not home",.5,!0);return[{name:a.name,sub:`in place of ${c} · same root, turned sad`,roman:"i",notes:a.notes,chord:a,tension:.3},{name:v.name,sub:`in place of ${d} · the lift, but heavier`,roman:"iv",notes:v.notes,chord:v,tension:.4},{name:b.name,sub:`in place of ${p} · big and cinematic`,roman:"♭VI",notes:b.notes,chord:b,tension:.45},{name:f.name,sub:`in place of ${g} · lands sideways, not home`,roman:"♭VII",notes:f.notes,chord:f,tension:.5}]}function Ks(e,t,i){return vi(e,t).map(s=>{const n=s.rows[0];return{label:s.name,sub:s.sub,chord:n.chord,functionCaption:`${n.roman} · ${n.notes.join(" · ")}`,rationale:n.sub}})}const Xs={m8:"https://warmsynths.github.io/hypersyn-chord-helper/",circuit:"https://warmsynths.github.io/circuit-chords/"},Qs={m8:43303,circuit:43302};function Zs(e,t,i){let o=Xs[t];typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(o=`http://localhost:${Qs[t]}/`);const n=(i&&i.length>0?i.map(r=>e.chords[r]).filter(r=>!!r):e.chords).map(r=>encodeURIComponent(r.name)).join("+");return`${o}?p=${n}`}const en={0:{symbol:"1",name:"Root",isGuideTone:!1},1:{symbol:"♭9",name:"Minor 9th",isGuideTone:!1},2:{symbol:"9",name:"Major 2nd / 9th",isGuideTone:!1},3:{symbol:"♭3",name:"Minor 3rd",isGuideTone:!0},4:{symbol:"3",name:"Major 3rd",isGuideTone:!0},5:{symbol:"4",name:"Perfect 4th",isGuideTone:!1},6:{symbol:"♭5",name:"Diminished 5th",isGuideTone:!1},7:{symbol:"5",name:"Perfect 5th",isGuideTone:!1},8:{symbol:"♯5 / ♭6",name:"Augmented 5th",isGuideTone:!1},9:{symbol:"6",name:"Major 6th",isGuideTone:!1},10:{symbol:"♭7",name:"Minor 7th",isGuideTone:!0},11:{symbol:"7",name:"Major 7th",isGuideTone:!0},14:{symbol:"9",name:"Major 9th",isGuideTone:!1}};function tn(e,t){const{root:i,quality:o}=ee(e),s=P[i]??0,n=ce[o]||ce.maj,r=wt(i,o,t);return n.map(c=>{const d=D(s+c,r),p=en[c]||{symbol:`+${c}`,name:`Interval ${c}`,isGuideTone:!1};return{note:d,intervalSymbol:p.symbol,roleName:p.name,isGuideTone:p.isGuideTone}})}function on(e){if(!e||e.length<2)return[];const t=[],i=o=>o.replace(/[^A-Za-z♭♯]/g,"");for(let o=0;o<e.length;o++){const s=o,n=(o+1)%e.length,r=e[s],c=e[n],d=i(r.roman),p=i(c.roman),g=s+1,a=n+1,v=`Bar ${g} → ${a}`,b=`${r.name} → ${c.name}`,f=`${r.roman}–${c.roman}`;(d==="V"||d==="v")&&(p==="I"||p==="i")?t.push({name:"Perfect cadence",type:"Authentic Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"The dominant resolves home — the strongest full stop.",why:"The dominant resolves home — the strongest full stop.",move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name}):(d==="IV"||d==="iv")&&(p==="I"||p==="i")?t.push({name:"Plagal cadence",type:"Plagal Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"A softer landing home, no dominant pull.",why:"A softer landing home, no dominant pull.",move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name}):(d==="V"||d==="v")&&(p==="vi"||p==="♭VI"||p==="VI")?t.push({name:"Interrupted cadence",type:"Deceptive Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"Sidesteps home at the last moment.",why:"Sidesteps home at the last moment.",move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name}):d==="♭VII"&&(p==="I"||p==="i")?t.push({name:"Backdoor cadence",type:"Backdoor Cadence",shortName:`${r.name} → ${c.name} (♭VII–${c.roman})`,description:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",why:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name}):(p==="V"||p==="v")&&d!=="V"&&d!=="v"?t.push({name:"Half cadence",type:"Half Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"Pauses on the dominant, left hanging.",why:"Pauses on the dominant, left hanging.",move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name}):r.functionLabel==="Secondary Dominant"&&t.push({name:"Secondary Dominant pull",type:"Secondary Dominant Pull",shortName:`${r.name} → ${c.name}`,description:`${r.name} acts as a temporary dominant, pulling strongly into ${c.name}.`,why:`${r.name} acts as a temporary dominant, pulling strongly into ${c.name}.`,move:b,degrees:f,bars:v,fromBar:g,toBar:a,fromChord:r.name,toChord:c.name})}return t}function sn(e){if(!e||e.length<2)return[];const t=[];for(let i=0;i<e.length;i++){const o=i,s=(i+1)%e.length,n=e[o],r=e[s],c=new Set(n.notes.map(h=>P[h]??0)),d=r.notes.filter(h=>c.has(P[h]??-1)),p=P[ei(n.name)]??0,g=P[ei(r.name)]??0,a=Math.min((g-p+12)%12,(p-g+12)%12);let v="Harmonic Shift";d.length>=2?v=`Strong Common Tones (${d.length} shared)`:a<=2?v="Stepwise Bass Motion":(a===5||a===7)&&(v="4th / 5th Cycle Jump");const b=`Bar ${o+1} → ${s+1}`,f=`${n.name} → ${r.name}`,l=d.length?`${d.join(" · ")} held over`:a<=2?"Bass steps by a tone":"No shared notes";t.push({fromBar:o+1,toBar:s+1,fromChord:n.name,toChord:r.name,move:b,chords:f,link:l,hasShared:d.length>0,commonNotes:d,semitoneDistance:a,motionType:v})}return t}function ti(e,t=4){const i=Array.isArray(e)?e.filter(a=>typeof a=="string"&&a.trim().length>0):[];if(i.length===0)return[];const o={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},s=i.map(a=>a.replace(/\d+$/,"")),n=s[0],r=o[n]??0;let c=t,d=r;const p=[];return s.forEach((a,v)=>{const b=o[a]??0;v>0&&b<=d&&c++,p.push(`${a}${c}`),d=b}),[`${n}${t-1}`,...p]}class nn{constructor(){this.mode="single",this.progression=null,this.order=[],this.sections=[],this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.playing=!1,this.instrument=null,this.playStyle=null,this.autoplayTimer=null,this.tickCallbacks=new Set,this.abOverride=null,this.subBassEnabled=!1,this.barsPerChord=1,this.feelSettings={swing:0,spread:50,density:50,tone:"Warm"}}setSubBassEnabled(t){this.subBassEnabled=t}isSubBassEnabled(){return this.subBassEnabled}setProgression(t,i){this.mode="single",this.progression=t,t?this.order=i||Array.from({length:t.chords.length},(o,s)=>s):this.order=[]}setSong(t){this.mode="song",this.sections=t,this.songStep=0,this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}isSongMode(){return this.mode==="song"}getActiveSectionIndex(){return this.activeSectionIndex}getTotalSteps(){return this.mode==="song"?this.sections.reduce((t,i)=>t+i.order.length,0):this.order.length}setOrder(t,i){this.order=t,typeof i=="number"&&(this.activeIndex=i)}setInstrument(t){this.instrument=t}setPlayStyle(t){this.playStyle=t}setBpm(t){const i=Math.max(40,Math.min(240,t));this.progression&&(this.progression.bpm=i),this.playing&&this.startAutoplay()}setBarsPerChord(t){this.barsPerChord=Math.max(1,t),this.playing&&this.startAutoplay()}getBarsPerChord(){return this.barsPerChord}setFeelSettings(t){this.feelSettings={...this.feelSettings,...t}}getFeelSettings(){return{...this.feelSettings}}getStepIntervalMs(){const t=this.mode==="song"?this.sections[this.activeSectionIndex]?.progression.bpm||this.progression?.bpm||84:this.progression?.bpm||84,i=Math.max(40,Math.min(240,t)),o=Math.max(1,this.barsPerChord);return Math.round(o*(24e4/i))}isPlaying(){return this.playing}getActiveIndex(){return this.activeIndex}getProgressStep(){return this.mode==="song"?this.songStep:this.progressStep}subscribeTick(t){return this.tickCallbacks.add(t),()=>this.tickCallbacks.delete(t)}notifyTick(){const t=this.getTotalSteps();this.mode==="song"?this.tickCallbacks.forEach(i=>i(this.activeIndex,this.songStep,this.activeSectionIndex,t,!0)):this.tickCallbacks.forEach(i=>i(this.activeIndex,this.progressStep,0,t,!1))}updateSongStepState(t){let i=0;for(let o=0;o<this.sections.length;o++){const s=this.sections[o].order.length;if(t<i+s){this.activeSectionIndex=o;const n=t-i;this.activeIndex=this.sections[o].order[n]??0,this.progressStep=n;return}i+=s}this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}startAutoplay(){this.stopAutoplay();const t=this.getStepIntervalMs();this.autoplayTimer=setInterval(()=>{if(this.playing){if(this.mode==="song"){const i=this.getTotalSteps();if(i<=0)return;this.songStep=(this.songStep+1)%i,this.updateSongStepState(this.songStep)}else{if(!this.progression||this.order.length<=0)return;this.activeIndex=(this.activeIndex+1)%this.order.length,this.progressStep=(this.progressStep+1)%this.order.length}this.playActiveChord(),this.notifyTick()}},t)}stopAutoplay(){this.autoplayTimer&&(clearInterval(this.autoplayTimer),this.autoplayTimer=null)}togglePlay(){return this.playing?(this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.stopAutoplay(),this.notifyTick()):(this.playing=!0,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.mode==="song"&&this.sections.length>0&&this.updateSongStepState(0),this.startAutoplay(),this.playActiveChord(),this.notifyTick()),this.playing}setABOverride(t,i,o="before"){t==null?this.abOverride=null:typeof t=="object"?this.abOverride=t:this.abOverride={index:t,chord:i||null,side:o}}clearABOverride(){this.abOverride=null}playActiveChord(){if(this.mode==="song"){const t=this.sections[this.activeSectionIndex];if(!t)return;const i=this.activeIndex,o=t.progression.chords[i];if(o){const s=o.notes&&o.notes.length>0?o.notes:H(o.name,j(t.progression.key,t.progression.scaleType)),n=ti(s,4);Ci(n,t.progression.genre,{bpm:t.progression.bpm,duration:this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0,feelSettings:this.feelSettings})}}else{if(!this.progression)return;const t=this.order[this.activeIndex]??0;let i=this.progression.chords[t];if(this.abOverride&&this.abOverride.index===t&&this.abOverride.side==="after"&&this.abOverride.chord&&(i=this.abOverride.chord),i){let o=Array.isArray(i.notes)?i.notes:[];if(o.length===0||!o.every(s=>typeof s=="string"&&s.trim().length>0)){const s=i.name||"CMAJ",n=this.progression.key||"C",r=this.progression.scaleType||"MAJOR";o=H(s,j(n,r))}this.playChordNotes(o,1.2),this.subBassEnabled&&o.length>0&&ds(o[0],1.4)}}}auditionChord(t,i=.8){if(!t)return;let o=Array.isArray(t.notes)?t.notes:[];if(o.length===0||!o.every(s=>typeof s=="string"&&s.trim().length>0)){const s=t.name||"CMAJ",n=this.progression?.key||"C",r=this.progression?.scaleType||"MAJOR";o=H(s,j(n,r))}this.playChordNotes(o,i)}playChordAtIndex(t,i=.8,o,s){if(!this.progression||!this.progression.chords[t])return;const n=this.progression.chords[t];let r=Array.isArray(n.notes)?n.notes:[];if(r.length===0||!r.every(c=>typeof c=="string"&&c.trim().length>0)){const c=n.name||"CMAJ",d=this.progression.key||"C",p=this.progression.scaleType||"MAJOR";r=H(c,j(d,p))}this.playChordNotes(r,i,o,s)}playChordNotes(t,i,o,s){if(!this.progression)return;const n=Array.isArray(t)?t.filter(c=>typeof c=="string"&&c.trim().length>0):[];if(n.length===0)return;const r=o?ps(n,o):ti(n,4);Ci(r,this.progression.genre||"Unknown",{bpm:this.progression.bpm||120,duration:i||this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0,velocity:s,feelSettings:this.feelSettings})}jumpToStep(t){!this.progression||this.order.length<=0||(this.activeIndex=t%this.order.length,this.progressStep=t%this.order.length,this.playActiveChord(),this.notifyTick())}playFromBar(t){!this.progression||this.order.length<=0||(this.activeIndex=t%this.order.length,this.progressStep=t%this.order.length,this.playing=!0,this.startAutoplay(),this.playActiveChord(),this.notifyTick())}reset(){this.stopAutoplay(),this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.notifyTick()}}const S=new nn,rn=Le.map(e=>e.name),an=["rhodes","epiano","guitar","pad-strings","bell","organ","juno-pad","stab"];function ln(e,t){const i=e.length+1,o=t.length+1,s=Array.from({length:i},()=>new Array(o).fill(0));for(let n=0;n<i;n++)s[n][0]=n;for(let n=0;n<o;n++)s[0][n]=n;for(let n=1;n<i;n++)for(let r=1;r<o;r++)s[n][r]=e[n-1]===t[r-1]?s[n-1][r-1]:1+Math.min(s[n-1][r-1],s[n-1][r],s[n][r-1]);return s[i-1][o-1]}function Se(e,t){if(typeof e!="string")return null;const i=e.trim();if(!i)return null;const o=i.toLowerCase(),s=t.find(d=>d.toLowerCase()===o);if(s)return s;let n=null,r=1/0;for(const d of t){const p=ln(o,d.toLowerCase());p<r&&(r=p,n=d)}const c=Math.max(2,Math.floor(o.length*.4));return r<=c?n:null}function cn(e){if(!Array.isArray(e))return;const t=[];for(const i of e){if(!i||typeof i!="object")continue;const o=i,s=Se(o.root,Ye),n=Se(o.quality,ms);s&&n&&t.push({root:s,quality:n})}if(t.length)return t.slice(0,me)}function dn(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t=e,i=Se(t.presetId,an)??(typeof t.presetId=="string"&&t.presetId.trim()?t.presetId.trim():void 0);if(!i)return;const o=t.customConfig&&typeof t.customConfig=="object"&&!Array.isArray(t.customConfig)?t.customConfig:void 0;return{presetId:i,customConfig:o}}function jt(e,t){const i=e&&typeof e=="object"?e:{},o=Se(i.genre,He)??t.genre,s=Se(i.mood,rn)??t.mood,n=Se(i.key,Ye)??void 0,r=Se(i.scaleType,fs)??void 0,c=n&&r?cn(i.chords):void 0;let d;typeof i.length=="number"&&Number.isFinite(i.length)&&(d=Math.max(Ue,Math.min(me,Math.round(i.length))));const p=typeof i.rhythmStyle=="string"&&i.rhythmStyle.trim()?i.rhythmStyle.trim():void 0,g=dn(i.instrumentConfig),a=i._rateLimit&&typeof i._rateLimit=="object"?i._rateLimit:void 0;return{genre:o,mood:s,key:n,scaleType:r,length:d,chords:c,rhythmStyle:p,instrumentConfig:g,_rateLimit:a}}const pn=[{id:"deepseek-v4-flash-free",name:"DeepSeek V4 Flash Free",provider:"opencodeai",vendor:"DeepSeek"},{id:"mimo-v2.5-free",name:"MiMo V2.5 Free",provider:"opencodeai",vendor:"Xiaomi"},{id:"laguna-s-2.1-free",name:"Laguna S 2.1 Free",provider:"opencodeai",vendor:"Stealth"},{id:"ling-3.0-flash-free",name:"Ling-3.0-flash Free",provider:"opencodeai",vendor:"Stealth"},{id:"nemotron-3-ultra-free",name:"Nemotron 3 Ultra Free",provider:"opencodeai",vendor:"NVIDIA"},{id:"north-mini-code-free",name:"North Mini Code Free",provider:"opencodeai",vendor:"Stealth"}],ii=[{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash-Lite",provider:"google",vendor:"Google"},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",provider:"google",vendor:"Google"},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash",provider:"google",vendor:"Google"}],wo="chroma-chords-llm-provider",ko="chroma-chords-llm-model";function So(){const e=localStorage.getItem(wo);return e==="opencodeai"||e==="anthropic"||e==="openrouter"||e==="google"?e:"google"}function hn(e){localStorage.setItem(wo,e)}function Io(){const e=localStorage.getItem(ko);return e?e==="gemini-1.5-flash"||e==="gemini-2.0-flash"||e==="gemini-2.5-flash"||e==="gemini-3.5-flash"||e==="gemini-1.5-pro"?"gemini-3.1-flash-lite":e:ii[0].id}function _t(e){localStorage.setItem(ko,e)}const Gt={genre:He[0],mood:Le[0].name},$o="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev",un=12e3;async function gn(){try{const e=await fetch($o);if(e.ok)return await e.json()}catch{}return null}const Co={Uplifting:["happy","joy","bright","hope","celebrat","win","sun","morning","triumph"],Melancholy:["sad","rain","lonely","grief","loss","blue","tear","goodbye"],Dreamy:["dream","float","cloud","soft","sleep","hazy","ethereal","stars"],Tense:["fear","anxious","dark","storm","fight","chase","danger","thriller"],Warm:["cozy","home","fire","love","autumn","familiar","fireplace"],Nostalgic:["memory","childhood","old","faded","remember","summer","photo","yearbook"],Energetic:["energetic","pumped","hype","fast","running","workout","power","fire"],Dark:["dark","creepy","night","evil","shadow","gothic","gloomy"],Peaceful:["peaceful","calm","quiet","zen","relax","nature","gentle","still"],Groovy:["groovy","funky","danceable","rhythm","swing","bounce","jam"],Epic:["epic","heroic","grand","triumphant","majestic","legendary","glory"]},To={Pop:["pop","radio","dance","catchy","hit"],"Lo-fi/Chill":["lofi","lo-fi","study","bedroom","tape","chill","relax"],"R&B/Soul":["rnb","r&b","soul","smooth","slow jam","sultry"],"Indie/Folk":["folk","acoustic","campfire","porch","story","indie"],Synthwave:["synth","80s","neon","retro","synthwave","arcade"],"Jazz-ish":["jazz","smoky","bar","lounge","late night","saxophone"],Gospel:["gospel","church","choir","soulful","worship"],Cinematic:["movie","film","epic","trailer","scene","cinematic"],Rock:["rock","guitar","drive","loud","energy","highway"],"House/Dance":["house","edm","club","rave","four on the floor","dance floor"],Blues:["blues","12 bar","delta","chicago blues","harmonica"],"Funk/Disco":["funk","funky","groovy","disco","slap bass","boogie"],"Country/Bluegrass":["country","bluegrass","nashville","banjo","twang"],"Reggae/Dub":["reggae","dub","jamaica","ska","offbeat","roots"],Metal:["metal","heavy metal","thrash","riff","shred","headbang","metallica","megadeth","slayer","iron maiden"],Punk:["punk","garage","mosh","rebel","skate"],"Ambient/Drone":["ambient","drone","atmospheric","soundscape","meditation","space"],"Trap/Hip-Hop":["trap","hiphop","hip-hop","rap","808","beat"],"Bossa Nova/Latin":["bossa","bossa nova","samba","latin","rio","habanera"],"Classical/Orchestral":["classical","orchestra","symphony","concerto","violin","chamber"],"EDM/Trance":["trance","techno","buildup","drop","festival"],Afrobeats:["afrobeats","afropop","lagos","highlife","afro"],Shoegaze:["shoegaze","fuzz","wall of sound","dream pop","gazer"]};function bt(e,t){const i=e.toLowerCase();let o=null,s=0;return Object.keys(t).forEach(n=>{const r=t[n].reduce((c,d)=>c+(i.includes(d)?1:0),0);r>s&&(s=r,o=n)}),o}function Eo(e){const t=bt(e,To),i=bt(e,Co);return!t||!i?null:{genre:t,mood:i}}async function mn(e){const t=new AbortController,i=setTimeout(()=>t.abort(),un);try{const s=await fetch($o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:e,provider:So(),model:Io()}),signal:t.signal}),n=await s.json().catch(()=>null);if(!s.ok||n&&typeof n=="object"&&"error"in n){const r=n&&typeof n=="object"&&"error"in n?String(n.error):`HTTP ${s.status}`,c=new Error(`Classifier request failed: ${r}`);throw n&&typeof n=="object"&&"_rateLimit"in n&&(c._rateLimit=n._rateLimit),c}return n}finally{clearTimeout(i)}}async function fn(e){const t=e.trim(),i=t.toLowerCase();if(i.startsWith("mock")||i.startsWith("test")){const s=t.replace(/^(mock|test)\s*:?\s*/i,"").trim(),n=bt(s,To)??"Synthwave",r=bt(s,Co)??"Dreamy",c={Metal:"stab",Rock:"guitar",Punk:"stab","Lo-fi/Chill":"epiano",Synthwave:"juno-pad","EDM/Trance":"juno-pad",Gospel:"organ","Reggae/Dub":"organ","Country/Bluegrass":"guitar","Bossa Nova/Latin":"guitar","Ambient/Drone":"pad-strings",Cinematic:"pad-strings","Classical/Orchestral":"pad-strings","Jazz-ish":"rhodes",Pop:"rhodes","R&B/Soul":"epiano"},d={Metal:"heavy_strum",Rock:"driving_strum",Punk:"fast_power_strum","Lo-fi/Chill":"slow_arpeggio",Synthwave:"retro_16th_arp","EDM/Trance":"fast_triplets",Gospel:"block_chords","Reggae/Dub":"offbeat_ska","Jazz-ish":"swing_feel","Bossa Nova/Latin":"syncopated_bossa","Ambient/Drone":"sustained_pad","Classical/Orchestral":"slow_arpeggio",Pop:"straight_8ths"},p={Metal:{key:"E",scaleType:"NATURAL_MINOR",chords:[{root:"E",quality:"min"},{root:"G",quality:"maj"},{root:"D",quality:"maj"},{root:"C",quality:"maj"},{root:"E",quality:"min"},{root:"A",quality:"min"},{root:"B",quality:"dom7"},{root:"E",quality:"min"}]},Rock:{key:"A",scaleType:"MAJOR",chords:[{root:"A",quality:"maj"},{root:"D",quality:"maj"},{root:"E",quality:"dom7"},{root:"F#",quality:"min"},{root:"D",quality:"maj"},{root:"A",quality:"maj"},{root:"E",quality:"dom7"},{root:"A",quality:"maj"}]},"Jazz-ish":{key:"F",scaleType:"DORIAN",chords:[{root:"F",quality:"min7"},{root:"A#",quality:"dom7"},{root:"D#",quality:"maj7"},{root:"G#",quality:"maj7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"min7"},{root:"F",quality:"dom7"}]},"Lo-fi/Chill":{key:"C",scaleType:"DORIAN",chords:[{root:"C",quality:"min7"},{root:"F",quality:"maj7"},{root:"A#",quality:"maj7"},{root:"D#",quality:"maj7"},{root:"C",quality:"min7"},{root:"D#",quality:"maj7"},{root:"F",quality:"min7"},{root:"G",quality:"min7"}]},Gospel:{key:"C",scaleType:"MAJOR",chords:[{root:"C",quality:"maj"},{root:"E",quality:"min7"},{root:"F",quality:"maj7"},{root:"G",quality:"dom7"},{root:"A",quality:"min7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"maj"}]},_default:{key:"F#",scaleType:"DORIAN",chords:[{root:"F#",quality:"min7"},{root:"B",quality:"maj"},{root:"C#",quality:"min7"},{root:"E",quality:"maj"},{root:"F#",quality:"min7"},{root:"A",quality:"maj7"},{root:"B",quality:"min7"},{root:"C#",quality:"dom7"}]}},g=p[n]||p._default,a=c[n]||"rhodes",v=d[n]||"slow_arpeggio",b={genre:n,mood:r,key:g.key,scaleType:g.scaleType,length:8,chords:g.chords,rhythmStyle:v,instrumentConfig:{presetId:a,customConfig:{envelope:{attack:.05,decay:.5,sustain:.6,release:1.2}}}};return jt(b,{genre:n,mood:r})}const o=Eo(e);try{const s=await mn(e);return jt(s,o??Gt)}catch(s){console.warn("LLM classification failed, falling back to keyword heuristic:",s);const n=jt(o??Gt,Gt);return s&&typeof s=="object"&&"_rateLimit"in s&&(n._rateLimit=s._rateLimit),n}}class vn{static async resolvePrompt(t,i,o,s,n,r){let c=r||null,d=null,p=null;if(!c&&n&&n.trim().length>0)try{c=await fn(n)}catch(v){console.warn("Failed to classify prompt via LLM/local fallback:",v)}const g=!!(c&&c.chords?.length&&c.key&&c.scaleType);let a=null;return g&&c&&c.chords&&c.key&&c.scaleType&&(a=js(t,c.key,c.scaleType,c.chords,c.genre||i,c.mood||o)),a||(a=Zt(t,i,o,{length:s})),g&&c&&(c.instrumentConfig?.presetId&&(d=rs(c.instrumentConfig.presetId)??null),c.rhythmStyle&&(p=as(c.rhythmStyle)??null)),a.chords.length>s&&(a={...a,chords:a.chords.slice(0,s)}),n&&(a={...a,searchTerm:n}),{progression:a,instrument:d,playStyle:p,normalizedSuggestion:c}}}const ct=[{name:"Verse",desc:"Settled, familiar.",reorder:e=>Array.from({length:e},(t,i)=>i)},{name:"Chorus",desc:"Brighter, opens the key up.",reorder:e=>Array.from({length:e},(t,i)=>(i+Math.ceil(e/2))%e)},{name:"Pre-chorus",desc:"Leans in, sets up the turn.",reorder:e=>Array.from({length:e},(t,i)=>(i+1)%e)},{name:"Bridge",desc:"Detours, borrows a shadow chord.",reorder:e=>Array.from({length:e},(t,i)=>e-1-i)},{name:"Outro",desc:"Settles back down.",reorder:e=>Array.from({length:e},(t,i)=>(i-1+e)%e)}];class Ae{static createInitialSong(t,i){const o=i||Array.from({length:t.chords.length},(s,n)=>n);return[{name:ct[0].name,desc:ct[0].desc,progression:t,order:o.slice()}]}static addSection(t,i){if(t.length>=ct.length)return{sections:t,activeIndex:t.length-1};const o=ct[t.length],s=o.reorder(i.chords.length),n={name:o.name,desc:o.desc,progression:i,order:s},r=[...t,n];return{sections:r,activeIndex:r.length-1}}static syncActiveSection(t,i,o,s){if(!t[i])return t;const n=[...t];return n[i]={...n[i],progression:o,order:s.slice()},n}}const q=4,he=45e3,Ni="chroma_chords_capacity_v2";class bn{constructor(){this.charges=q,this.rechargeNextSec=45,this.lastCapacityTime=Date.now(),this.timer=null,this.subscribers=new Set,this.init()}init(){try{if(typeof localStorage<"u"){const t=localStorage.getItem(Ni),i=Date.now();if(t){const o=JSON.parse(t),s=typeof o.charges=="number"?o.charges:q,n=typeof o.lastTime=="number"?o.lastTime:i;if(s<q){const r=Math.max(0,i-n),c=Math.floor(r/he);this.charges=Math.min(q,s+c);const d=r%he;this.rechargeNextSec=Math.max(1,Math.ceil((he-d)/1e3)),this.lastCapacityTime=i-d}else this.charges=q,this.rechargeNextSec=45,this.lastCapacityTime=i}else this.charges=q,this.rechargeNextSec=45,this.lastCapacityTime=i}}catch{this.charges=q,this.rechargeNextSec=45}this.save(),this.startTimer()}save(){try{typeof localStorage<"u"&&localStorage.setItem(Ni,JSON.stringify({charges:this.charges,lastTime:this.lastCapacityTime}))}catch{}}startTimer(){this.timer&&clearInterval(this.timer),this.timer=setInterval(()=>{if(this.charges<q){const t=Date.now(),i=Math.max(0,t-this.lastCapacityTime);if(i>=he){const s=Math.floor(i/he);this.charges=Math.min(q,this.charges+s),this.lastCapacityTime=t-i%he,this.save()}const o=(t-this.lastCapacityTime)%he;this.rechargeNextSec=Math.max(1,Math.ceil((he-o)/1e3))}else this.rechargeNextSec=45;this.notify()},1e3)}getState(){return{charges:this.charges,max:q,rechargeNextSec:this.rechargeNextSec}}getCharges(){return this.charges}getRechargeNextSec(){return this.rechargeNextSec}getCapacityMax(){return q}spendCharge(){return this.charges<=0?(this.notify(),!1):(this.charges===q&&(this.lastCapacityTime=Date.now()),this.charges-=1,this.save(),this.notify(),!0)}subscribe(t){return this.subscribers.add(t),t(this.getState()),()=>{this.subscribers.delete(t)}}notify(){const t=this.getState();this.subscribers.forEach(i=>{try{i(t)}catch(o){console.error("Error in CapacityService subscriber callback:",o)}})}}const oi=new bn;var xn=Object.defineProperty,yn=Object.getOwnPropertyDescriptor,X=(e,t,i,o)=>{for(var s=o>1?void 0:o?yn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&xn(t,i,s),s};let W=class extends ne{constructor(){super(...arguments),this.compact=!1,this.hideCapacity=!1,this.isAdmin=!1,this.capacityCharges=4,this.capacityMax=4,this.rechargeNextSec=60,this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.syncStatus="synced",this.title="Chroma Chords",this.accountMenuOpen=!1,this.showCapacityNote=!1,this.unsubscribeProjects=null,this.unsubscribeCapacity=null}connectedCallback(){super.connectedCallback(),this.unsubscribeProjects=F.subscribeProjects(()=>{this.savedCount=F.getProjects().length,this.syncStatus=F.getSyncStatus(),this.requestUpdate()}),this.unsubscribeCapacity=oi.subscribe(e=>{this.capacityCharges=e.charges,this.capacityMax=e.max,this.rechargeNextSec=e.rechargeNextSec,this.requestUpdate()}),this.savedCount=F.getProjects().length}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeProjects&&this.unsubscribeProjects(),this.unsubscribeCapacity&&this.unsubscribeCapacity()}toggleCapacityNote(e){e.stopPropagation(),this.showCapacityNote=!this.showCapacityNote,this.accountMenuOpen=!1}toggleAccountMenu(e){e.stopPropagation(),this.accountMenuOpen=!this.accountMenuOpen,this.showCapacityNote=!1}onSignIn(){this.dispatchEvent(new CustomEvent("request-login",{bubbles:!0,composed:!0}))}onSignOut(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("request-logout",{bubbles:!0,composed:!0}))}onViewSets(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("view-sets",{bubbles:!0,composed:!0}))}onSyncNow(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("sync-projects",{bubbles:!0,composed:!0}))}render(){const e=(this.userEmail||"U")[0].toUpperCase();return u`
  ...
  `;X([I({type:Boolean})],W.prototype,"compact",2);X([I({type:Boolean})],W.prototype,"hideCapacity",2);X([I({type:Boolean})],W.prototype,"isAdmin",2);X([I({type:Number})],W.prototype,"capacityCharges",2);X([I({type:Number})],W.prototype,"capacityMax",2);X([I({type:Number})],W.prototype,"rechargeNextSec",2);X([I({type:Boolean})],W.prototype,"isAuthenticated",2);X([I({type:String})],W.prototype,"userEmail",2);X([I({type:Number})],W.prototype,"savedCount",2);X([I({type:String})],W.prototype,"syncStatus",2);X([I({type:String})],W.prototype,"title",2);X([x()],W.prototype,"accountMenuOpen",2);X([x()],W.prototype,"showCapacityNote",2);W=X([re("app-header")],W);var wn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,bi=(e,t,i,o)=>{for(var s=o>1?void 0:o?kn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&wn(t,i,s),s};const si=["bean","bird","cat","note"];function ni(e=.45){return{show:Math.random()<e,kind:si[Math.floor(Math.random()*si.length)]}}function ri(e){return e[Math.floor(Math.random()*e.length)]}class Ao{constructor(t=7,i=1800){this.threshold=t,this.windowMs=i,this.count=0,this.lastClickAt=0}click(){const t=Date.now();return t-this.lastClickAt>this.windowMs&&(this.count=0),this.lastClickAt=t,this.count+=1,this.count>=this.threshold?(this.count=0,!0):!1}}const Sn={bean:{width:92,height:86},bird:{width:88,height:88},cat:{width:90,height:88},note:{width:74,height:67}};let We=class extends ne{constructor(){super(...arguments),this.kind="bean",this.scale=1}willUpdate(e){if(e.has("kind")||e.has("scale")){const{width:t,height:i}=Sn[this.kind];this.style.width=`${t*this.scale}px`,this.style.height=`${i*this.scale}px`}}renderBean(){const e="#D98A54";return u`
    ...
    `}render(){const e=this.kind==="bird"?this.renderBird():this.kind==="cat"?this.renderCat():this.kind==="note"?this.renderNote():this.renderBean();return e?u`<div style="transform:scale(${this.scale}); transform-origin:top left;">${e}</div>`:Ji}};We.styles=se`
    :host {
      display: block;
      pointer-events: none;
      user-select: none;
  ...
  `;bi([I({type:String})],We.prototype,"kind",2);bi([I({type:Number})],We.prototype,"scale",2);We=bi([re("mascot-character")],We);var In=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,xi=(e,t,i,o)=>{for(var s=o>1?void 0:o?$n(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&In(t,i,s),s};const ai=3200;let Je=class extends ne{constructor(){super(...arguments),this.trigger=0,this.visible=!1,this.hideTimer=null}updated(e){e.has("trigger")&&this.trigger>0&&(this.visible=!0,this.hideTimer&&clearTimeout(this.hideTimer),this.hideTimer=setTimeout(()=>{this.visible=!1},ai))}disconnectedCallback(){super.disconnectedCallback(),this.hideTimer&&clearTimeout(this.hideTimer)}render(){return this.visible?u`
      <div class="caption">✨ you found the whole gang! ✨</div>
      <div class="overlay">
        <div class="row">
          ${si.map(e=>u`<mascot-character .kind=${e} .scale=${.5}></mascot-character>`)}
        </div>
      </div>
    `:Ji}};Je.styles=se`
    :host {
    ...
    .overlay {
      ...
      gap: 10px;
      pointer-events: none;
      animation: egg-pop ${ai}ms ease forwards;
    }
    .caption {
      position: fixed;
      left: 50%;
      ...
      white-space: nowrap;
      pointer-events: none;
      animation: egg-caption-pop ${ai}ms ease forwards;
    }
    .row {
      display: flex;
  ...
  `;xi([I({type:Number})],Je.prototype,"trigger",2);xi([x()],Je.prototype,"visible",2);Je=xi([re("mascot-parade")],Je);var Cn=Object.defineProperty,Tn=Object.getOwnPropertyDescriptor,B=(e,t,i,o)=>{for(var s=o>1?void 0:o?Tn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&Cn(t,i,s),s};const En=[{side:"left",top:"20%"},{side:"left",top:"62%"},{side:"right",top:"30%"},{side:"right",top:"68%"}],An=["#F2A79B","#9CC0EC","#F6D98B"],Nn=[6,3,12],Mi=["rainy drive at 2am, first day of summer...","Portishead","Bohemian Rhapsody"],Mn=["Lo-fi/Chill","R&B/Soul","Pop","Synthwave"],On=["Warm","Melancholy","Nostalgic","Dreamy"],Vt=["Rummaging through crates of old vinyl...","Asking the chord wizards nicely...","Warming up the analog vacuum tubes...","Dusting off the Fender Rhodes...","Consulting the musical oracle...","Polishing major 7th chords...","Tuning the vintage synthesizer...","Translating feelings into frequencies...","Listening to the cosmic frequency...","Channeling 80s synthwave energy...","Humming a secret little melody...","Strumming invisible guitar strings...","Checking the vibe meters...","Brewing a fresh cup of lo-fi beats...","Setting the tape delay to 120ms...","Counting the beats per minute...","Mixing harmonizing magic...","Summoning smooth jazz cats...","Tweaking the resonance knob...","Scanning the musical multiverse..."];let N=class extends ne{constructor(){super(...arguments),this.genre="Pop",this.mood="Dreamy",this.length=4,this.freeText="",this.placeholderIdx=0,this.llmSuggestion=null,this.llmResolved=!1,this.classifyError=null,this.expandedGenre=!1,this.expandedMood=!1,this.mascot=ni(.35),this.mascotSlot=ri(En),this.peekMascot=ni(.18),this.peekSide=ri(["left","right"]),this.isAuthenticated=!1,this.userEmail=null,this.isAdmin=!1,this.isGenerating=!1,this.currentProvider=So(),this.currentModel=Io(),this.showAdminModal=!1,this.isClassifying=!1,this.loadingMsgIdx=0,this.googleRemaining=15,this.googleLimit=15,this.googleCooldownSec=4,this.orRemaining=50,this.orLimit=50,this.capacityCharges=q,this.rechargeNextSec=45,this.showCapacityNote=!1,this.unsubscribeCapacity=null,this.loadingTimer=null,this.cooldownTimer=null,this.eggCounter=new Ao,this.paradeTrigger=0,this.jellyBodies=[],this.animFrameId=null,this.mouseX=null,this.mouseY=null,this.physicsLoop=()=>{if(!this.isConnected)return;const e=performance.now(),t=this.getBoundingClientRect(),i=t.width>0?t.width:typeof window<"u"?window.innerWidth:800;let o=t.height>0?t.height:typeof window<"u"?window.innerHeight:600;const s=this.shadowRoot?.querySelector(".divider-row");if(s){const c=s.getBoundingClientRect();c.top>t.top&&(o=c.top-t.top)}const n=this.jellyBodies,r=n.length;for(let c=0;c<r;c++){const d=n[c];if(d.vx+=Math.sin(e*6e-4*d.driftFreqX+d.driftPhaseX)*d.driftForce,d.vy+=Math.cos(e*7e-4*d.driftFreqY+d.driftPhaseY)*d.driftForce,this.mouseX!==null&&this.mouseY!==null){const a=d.x-this.mouseX,v=d.y-this.mouseY,b=Math.hypot(a,v);if(b<140&&b>0){const f=(1-b/140)*.12;d.vx+=a/b*f,d.vy+=v/b*f}}d.vx*=d.drag,d.vy*=d.drag;const p=Math.hypot(d.vx,d.vy);p>d.maxSpeed&&(d.vx=d.vx/p*d.maxSpeed,d.vy=d.vy/p*d.maxSpeed),d.x+=d.vx,d.y+=d.vy,d.angle+=d.vRot;const g=d.radius;d.x<g?(d.x=g,d.vx=Math.abs(d.vx)*d.restitution+.02,d.squishX=.88,d.squishY=1.12):d.x>i-g&&(d.x=i-g,d.vx=-Math.abs(d.vx)*d.restitution-.02,d.squishX=.88,d.squishY=1.12),d.y<g?(d.y=g,d.vy=Math.abs(d.vy)*d.restitution+.02,d.squishX=1.12,d.squishY=.88):d.y>o-g&&(d.y=o-g,d.vy=-Math.abs(d.vy)*d.restitution-.02,d.squishX=1.12,d.squishY=.88),d.squishX+=(1-d.squishX)*.08,d.squishY+=(1-d.squishY)*.08}for(let c=0;c<r;c++)for(let d=c+1;d<r;d++){const p=n[c],g=n[d],a=g.x-p.x,v=g.y-p.y,b=Math.hypot(a,v),f=p.radius+g.radius;if(b<f&&b>0){const l=f-b,h=a/b,m=v/b;p.x-=h*l*.4,p.y-=m*l*.4,g.x+=h*l*.4,g.y+=m*l*.4;const y=p.vx-g.vx,k=p.vy-g.vy,w=(h*y+m*k)/(p.mass+g.mass),E=.35;p.vx-=w*g.mass*h*E,p.vy-=w*g.mass*m*E,g.vx+=w*p.mass*h*E,g.vy+=w*p.mass*m*E;const O=.12;p.squishX=Math.max(.85,1-O*Math.abs(h)),p.squishY=Math.max(.85,1-O*Math.abs(m)),g.squishX=Math.max(.85,1-O*Math.abs(h)),g.squishY=Math.max(.85,1-O*Math.abs(m))}}if(this.shadowRoot)for(let c=0;c<r;c++){const d=n[c],p=this.shadowRoot.getElementById(`jelly-${d.id}`);p&&(p.style.transform=`translate3d(${d.x-d.radius}px, ${d.y-d.radius}px, 0) rotate(${d.angle}deg) scale(${d.squishX}, ${d.squishY})`)}this.animFrameId=requestAnimationFrame(this.physicsLoop)},this.placeholderTimer=null,this.classifyDebounce=null,this.classifyToken=0,this.generate=()=>{if(!this.isGenerating){if(this.capacityCharges<=0){this.showCapacityNote=!0;return}this.spendCapacityCharge(),this.dispatchEvent(new CustomEvent("generate",{detail:{promptText:this.freeText.trim()},bubbles:!0,composed:!0}))}}}spendCapacityCharge(){const e=oi.spendCharge();return e||(this.showCapacityNote=!0),e}startLoadingTimer(){this.stopLoadingTimer(),this.loadingMsgIdx=Math.floor(Math.random()*Vt.length),this.loadingTimer=setInterval(()=>{let e=Math.floor(Math.random()*Vt.length);e===this.loadingMsgIdx&&(e=(e+1)%Vt.length),this.loadingMsgIdx=e},800)}stopLoadingTimer(){this.loadingTimer&&(clearInterval(this.loadingTimer),this.loadingTimer=null)}onLoginClick(){this.dispatchEvent(new CustomEvent("request-login",{bubbles:!0,composed:!0}))}onLogoutClick(){this.dispatchEvent(new CustomEvent("request-logout",{bubbles:!0,composed:!0})),this.showAdminModal=!1}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}changeProvider(e){this.currentProvider=e,hn(e),e==="google"?(this.currentModel=ii[0].id,_t(this.currentModel)):e==="opencodeai"&&(this.currentModel=pn[0].id,_t(this.currentModel))}changeModel(e){this.currentModel=e,_t(e)}initJellyBodies(){const e=this.getBoundingClientRect(),t=e.width>0?e.width:typeof window<"u"?window.innerWidth:800;let i=e.height>0?e.height:typeof window<"u"?window.innerHeight:600;const o=Math.min(i,400),s=[{key:"blob1",r:20},{key:"blob2",r:14},{key:"blob3",r:17},{key:"circle",r:16},{key:"pill",r:16},{key:"arch",r:15},{key:"squircle",r:16}],n=3,r=[];for(let c=0;c<n;c++){const d=s[c%s.length],p=d.r+30,g=p+Math.random()*Math.max(100,t-p*2),a=p+Math.random()*Math.max(50,o-p*2),v=.08+Math.random()*.18,b=.35+Math.random()*.25,f=.985,l=.006+Math.random()*.008,h=.35,m=Math.random()*Math.PI*2;r.push({id:c,shapeKey:d.key,width:d.r*2,height:d.r*2,x:g,y:a,vx:Math.cos(m)*v,vy:Math.sin(m)*v,maxSpeed:b,drag:f,driftForce:l,restitution:h,radius:d.r,mass:d.r*d.r,angle:Math.random()*360,vRot:(Math.random()-.5)*.05,squishX:1,squishY:1,driftPhaseX:Math.random()*Math.PI*2,driftPhaseY:Math.random()*Math.PI*2,driftFreqX:.6+Math.random()*.5,driftFreqY:.6+Math.random()*.5})}this.jellyBodies=r}onFrameMouseMove(e){const t=this.getBoundingClientRect();this.mouseX=e.clientX-t.left,this.mouseY=e.clientY-t.top}onFrameMouseLeave(){this.mouseX=null,this.mouseY=null}get currentLimit(){return this.currentProvider==="openrouter"?this.orLimit:this.googleLimit}get currentRemaining(){return this.currentProvider==="openrouter"?this.orRemaining:this.googleRemaining}loadKeyInfo(){gn().then(e=>{e&&(e.google&&(this.googleLimit=e.google.limit,this.googleRemaining=e.google.remaining,this.googleCooldownSec=e.google.cooldownSeconds),e.openrouter&&(this.orLimit=e.openrouter.limit,this.orRemaining=e.openrouter.remaining),this.startCooldownTimer())})}startCooldownTimer(){this.cooldownTimer&&clearInterval(this.cooldownTimer),this.cooldownTimer=setInterval(()=>{this.googleRemaining<this.googleLimit?this.googleRemaining+=1:this.cooldownTimer&&(clearInterval(this.cooldownTimer),this.cooldownTimer=null)},this.googleCooldownSec*1e3)}connectedCallback(){super.connectedCallback(),this.placeholderTimer=setInterval(()=>{this.placeholderIdx=(this.placeholderIdx+1)%Mi.length},2800),this.unsubscribeCapacity=oi.subscribe(e=>{this.capacityCharges=e.charges,this.rechargeNextSec=e.rechargeNextSec,this.requestUpdate()}),this.loadKeyInfo(),this.initJellyBodies()}firstUpdated(){this.loadKeyInfo(),typeof window<"u"&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&(this.animFrameId=requestAnimationFrame(this.physicsLoop))}updated(e){super.updated(e),e.has("isAdmin")&&this.isAdmin&&this.loadKeyInfo()}disconnectedCallback(){super.disconnectedCallback(),this.animFrameId&&cancelAnimationFrame(this.animFrameId),this.placeholderTimer&&clearInterval(this.placeholderTimer),this.classifyDebounce&&clearTimeout(this.classifyDebounce),this.cooldownTimer&&clearInterval(this.cooldownTimer),this.unsubscribeCapacity&&(this.unsubscribeCapacity(),this.unsubscribeCapacity=null),this.stopLoadingTimer()}selectGenre(e){this.dispatchEvent(new CustomEvent("genre-change",{detail:e,bubbles:!0,composed:!0}))}selectMood(e){this.dispatchEvent(new CustomEvent("mood-change",{detail:e,bubbles:!0,composed:!0}))}setLength(e){this.dispatchEvent(new CustomEvent("length-change",{detail:e,bubbles:!0,composed:!0}))}decLength(){this.length>Ue&&this.setLength(this.length-1)}incLength(){this.length<me&&this.setLength(this.length+1)}onFreeTextChange(e){this.freeText=e.target.value}applyBest(e){this.selectGenre(e.genre),this.selectMood(e.mood);const t={...e,promptText:this.freeText.trim()};this.dispatchEvent(new CustomEvent("freetext-suggestion-applied",{detail:t,bubbles:!0,composed:!0}))}renderJellySvg(e){switch(e){case"blob1":return u`<svg width="38" height="38" viewBox="0 0 38 38"><path d="M19 2C28 2 36 9 36 19C36 29 28 36 18 36C8 36 2 27 2 18C2 9 10 2 19 2Z" fill="#F6D98B"/></svg>`;case"blob2":return u`<svg width="26" height="26" viewBox="0 0 24 24"><path d="M12 2C18 2 22 8 22 14C22 20 16 22 10 22C4 22 2 16 2 10C2 4 6 2 12 2Z" fill="#F2A79B" opacity="0.9"/></svg>`;case"blob3":return u`<svg width="32" height="32" viewBox="0 0 32 32"><path d="M16 2C24 2 30 7 30 16C30 25 22 30 14 30C6 30 2 23 2 14C2 5 8 2 16 2Z" fill="#F2C9A0"/></svg>`;case"circle":return u`<svg width="30" height="30" viewBox="0 0 30 30"><circle cx="15" cy="15" r="14" fill="#9CC0EC"/></svg>`;case"dot":return u`<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="7" fill="#9CC0EC"/></svg>`;case"ring":return u`<svg width="44" height="44" viewBox="0 0 46 46"><circle cx="23" cy="23" r="20" fill="none" stroke="#9CC0EC" stroke-width="6" opacity="0.6"/></svg>`;case"doubleRing":return u`<svg width="36" height="36" viewBox="0 0 36 36"><circle cx="18" cy="18" r="15" fill="none" stroke="#9CC0EC" stroke-width="3"/><circle cx="18" cy="18" r="7" fill="#9CC0EC"/></svg>`;case"pill":return u`<svg width="34" height="20" viewBox="0 0 34 20"><rect x="2" y="2" width="30" height="16" rx="8" fill="#F2C9A0"/></svg>`;case"crescent":return u`<svg width="30" height="30" viewBox="0 0 30 30"><path d="M18 4A14 14 0 1 0 28 22 11 11 0 1 1 18 4z" fill="#C9A9E0"/></svg>`;case"arch":return u`<svg width="36" height="22" viewBox="0 0 36 20"><path d="M2 18 A 16 16 0 0 1 34 18 Z" fill="#B8CC9E" opacity="0.85"/></svg>`;case"squircle":return u`<svg width="32" height="32" viewBox="0 0 32 32"><rect x="2" y="2" width="28" height="28" rx="12" fill="#9CC0EC"/></svg>`;case"oval":return u`<svg width="32" height="22" viewBox="0 0 32 22"><ellipse cx="16" cy="11" rx="14" ry="9" fill="#B8CC9E"/></svg>`;case"donut":return u`<svg width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="13" fill="none" stroke="#C6564B" stroke-width="6" opacity="0.75"/></svg>`;default:return u`<svg width="24" height="24" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#F6D98B"/></svg>`}}render(){const e=Ie(this.mood);let t=Mn.filter(a=>He.includes(a));t.includes(this.genre)||(t=t.slice(0,-1).concat(this.genre));const i=He.filter(a=>!t.includes(a)),o=this.expandedGenre?t.concat(i):t,s=Le.map(a=>a.name);let n=On.filter(a=>s.includes(a));n.includes(this.mood)||(n=n.slice(0,-1).concat(this.mood));const r=s.filter(a=>!n.includes(a)),d=(this.expandedMood?n.concat(r):n).map(a=>Le.find(v=>v.name===a)),p=this.freeText.trim(),g=p.length>2?Eo(p):null;return u`
      <div class="frame" @mousemove=${this.onFrameMouseMove} @mouseleave=${this.onFrameMouseLeave}>
        ...
        <div class="content">
          ...
          <div class="vibe-input-shell">
            ...
            <div class="vibe-input-wrap ${this.isGenerating?"generating":""}">
              ...
              <input
                ...
                placeholder=${this.isGenerating?"Composing your chords...":Mi[this.placeholderIdx]}
              />
              <button
                class="vibe-capacity-chip ${this.capacityCharges<=1?"low":""}"
                @click=${a=>{a.stopPropagation(),this.showCapacityNote=!this.showCapacityNote}}
                title=${this.capacityCharges>0?`${this.capacityCharges} of ${q} AI generates left. One comes back every ${this.rechargeNextSec>0?this.rechargeNextSec:45}s.`:`Cooling down — next one unlocks in ${Math.floor(this.rechargeNextSec/60)}:${String(this.rechargeNextSec%60).padStart(2,"0")}`}
                aria-label="AI generates remaining"
                type="button"
              >
                <span class="pips-wrap">
                  ${Array.from({length:q},(a,v)=>u`
            ...
            ${this.showCapacityNote?u`
              <div class="capacity-note" @click=${()=>{this.showCapacityNote=!1}}>
                ${this.capacityCharges>0?`${this.capacityCharges} of ${q} generates left`:`Cooling down — one more in ${this.rechargeNextSec}s`}
              </div>
            `:""}
          </div>
          ${g?u`
          ...
          <div class="pill-grid">
            ${o.map(a=>{const v=He.indexOf(a);return u`
                <div class="pill ${a===this.genre?"selected":""}" style=${a===this.genre?`background:${e}`:""} @click=${()=>this.selectGenre(a)}>
                  <div class="genre-icon-wrap">
                    <svg width="12" height="12" viewBox="0 0 24 24">
                      <rect x="6" y="6" width="12" height="12" rx=${Nn[v%3]} fill=${An[v%3]} />
                    </svg>
                  </div>
                  ${a}
                </div>
          ...
          <div class="length-control">
            ...
            <div class="length-segments">
              ${Array.from({length:me},(a,v)=>u`
                <div class="length-segment ${v<this.length?"filled":""}"></div>
              `)}
            </div>
            <div class="length-btn ${this.length>=me?"disabled":""}" @click=${()=>this.incLength()}>+</div>
  ...
  `;B([I({type:String})],N.prototype,"genre",2);B([I({type:String})],N.prototype,"mood",2);B([I({type:Number})],N.prototype,"length",2);B([x()],N.prototype,"freeText",2);B([x()],N.prototype,"placeholderIdx",2);B([x()],N.prototype,"llmSuggestion",2);B([x()],N.prototype,"llmResolved",2);B([x()],N.prototype,"classifyError",2);B([x()],N.prototype,"expandedGenre",2);B([x()],N.prototype,"expandedMood",2);B([x()],N.prototype,"mascot",2);B([x()],N.prototype,"mascotSlot",2);B([x()],N.prototype,"peekMascot",2);B([x()],N.prototype,"peekSide",2);B([I({type:Boolean})],N.prototype,"isAuthenticated",2);B([I({type:String})],N.prototype,"userEmail",2);B([I({type:Boolean})],N.prototype,"isAdmin",2);B([I({type:Boolean})],N.prototype,"isGenerating",2);B([x()],N.prototype,"currentProvider",2);B([x()],N.prototype,"currentModel",2);B([x()],N.prototype,"showAdminModal",2);B([x()],N.prototype,"isClassifying",2);B([x()],N.prototype,"loadingMsgIdx",2);B([x()],N.prototype,"googleRemaining",2);B([x()],N.prototype,"googleLimit",2);B([x()],N.prototype,"googleCooldownSec",2);B([x()],N.prototype,"orRemaining",2);B([x()],N.prototype,"orLimit",2);B([x()],N.prototype,"capacityCharges",2);B([x()],N.prototype,"rechargeNextSec",2);B([x()],N.prototype,"showCapacityNote",2);B([x()],N.prototype,"paradeTrigger",2);N=B([re("seed-screen")],N);function Oi(e){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=e.match(/^([A-Ga-g][#b]?)(-?\d+)?$/);if(!i)return 60;const o=i[1].charAt(0).toUpperCase()+i[1].slice(1),s=t[o]??0,n=i[2]!==void 0?parseInt(i[2],10):4;return Math.min(127,Math.max(0,(n+1)*12+s))}function No(e,t,i,o=1,s){const n=t&&t.length>0?t.map(y=>e.chords[y]).filter(y=>!!y):e.chords,r=e.bpm||120,c=o*240/r,d=i?$e.find(y=>y.name.toLowerCase()===i.toLowerCase()):void 0,p=pi[e.genre]||{},g=d?.patch??{},a={...p,...g,...s?.humanState??{}},v=p.duration??.9,b=g.durationMultiplier?v*g.durationMultiplier:v,f=s?.humanState?.strum!==void 0?s.humanState.strum/100*1.5:s?.spread!==void 0?s.spread/100*1.5:p.spread??.3,l=s?.humanState?.swing!==void 0?s.humanState.swing:s?.swing??0,h=s?.density??50,m=[];return n.forEach((y,k)=>{const w=l/100*.04*(k%2===1?1:0),E=k*c+w,O=y.notes&&y.notes.length>0?y.notes:["C","E","G"];let _=ti(O,4);if(_=lo(_,h),a.arpMode&&a.arpMode!=="off"){const G=a.arpRate??"1/16",Y=a.arpRange??1,K=a.arpMode,ie=no(G,r),V=ro(_,Y),T=ao(V,K),J=a.duration?a.duration:Math.max(.6,b);T.forEach((ae,Ge)=>{const Oo=E+Ge*ie;m.push({note:ae,midi:Oi(ae),startTime:Oo,duration:J})})}else{const G=s?.humanState?.instrument||void 0,Y=G?ge(G):void 0,ie=(Y?le.find(V=>V.name.toLowerCase()===Y.toLowerCase())?.instrument??"piano":Xe[e.genre]??"piano")==="guitar";_.forEach((V,T)=>{const ae=(ie?T*.024:0)+T*f*.1,Ge=E+ae;m.push({note:V,midi:Oi(V),startTime:Ge,duration:ie?Math.max(b,1.2):b})})}}),m}function Dn(e){const t=[];let i=Math.max(0,Math.floor(e));for(t.push(i&127);(i>>=7)>0;)t.unshift(i&127|128);return t}function Bn(e,t,i,o=1,s){const n=e.bpm||120,r=480,c=No(e,t,i,o,s),d=[];c.forEach(m=>{const y=Math.round(m.startTime/(60/n)*r),k=Math.max(1,Math.round(m.duration/(60/n)*r));d.push({tick:y,type:"on",midi:m.midi}),d.push({tick:y+k,type:"off",midi:m.midi})}),d.sort((m,y)=>m.tick!==y.tick?m.tick-y.tick:m.type!==y.type?m.type==="off"?-1:1:m.midi-y.midi);const p=[],g=Math.round(6e7/n);p.push(0),p.push(255,81,3),p.push(g>>16&255,g>>8&255,g&255);const a="Chroma Chords";p.push(0),p.push(255,3,a.length);for(let m=0;m<a.length;m++)p.push(a.charCodeAt(m));let v=0;d.forEach(m=>{const y=m.tick-v;v=m.tick,p.push(...Dn(y)),m.type==="on"?p.push(144,m.midi,80):p.push(128,m.midi,0)}),p.push(0),p.push(255,47,0);const b=[77,84,104,100,0,0,0,6,0,0,0,1,r>>8&255,r&255],f=p.length,l=[77,84,114,107,f>>24&255,f>>16&255,f>>8&255,f&255],h=new Uint8Array(b.length+l.length+p.length);return h.set(b,0),h.set(l,b.length),h.set(p,b.length+l.length),h}function Fn(e,t,i,o,s=1,n){const r=Bn(e,t,o,s,n),c=new Blob([r],{type:"audio/midi"}),d=(e.key||"C").toLowerCase(),p=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),g=e.bpm||120,a=`chroma-chords-${d}-${p}-${g}bpm.mid`;Mo(c,a)}function Pn(e,t,i="Warm",o){const s=new Wi({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination(),n=Jo(i,s),r=e?ge(e):void 0;switch((r?le.find(p=>p.name.toLowerCase()===r.toLowerCase()):void 0)?.instrument??(t?Xe[t]:void 0)??"piano"){case"bell":{const p=new xt({high:3.5,mid:-.5,low:-2,highFrequency:4800}).connect(n),g=new Me({decay:3.2,wet:.32}).connect(p);return new Q(Jt,{harmonicity:3.5,modulationIndex:12,envelope:{attack:.002,decay:1.2,sustain:.04,release:1.4},modulationEnvelope:{attack:.002,decay:.6,sustain:.01,release:.5},volume:-12}).connect(g)}case"organ":{const p=new De({frequency:4500,type:"lowpass",rolloff:-12}).connect(n),g=new Fe({distortion:.08,wet:.15}).connect(p),a=new yt({frequency:5.8,depth:.12,wet:.55}).connect(g);return new Q(xe,{oscillator:{type:"fatsine",count:3,spread:15},envelope:{attack:.008,decay:.15,sustain:.9,release:.25},volume:-12}).connect(a)}case"pad-strings":{const p=new Me({decay:5.5,preDelay:.03,wet:.45}).connect(n),g=new Be({frequency:.45,delayTime:4,depth:.5,wet:.4}).start(0).connect(p);return new Q(xe,{oscillator:{type:"fatsawtooth",count:3,spread:22},envelope:{attack:.65,decay:.8,sustain:.85,release:2.5},volume:-13}).connect(g)}case"juno-pad":{const p=new Be({frequency:.85,delayTime:3.5,depth:.72,wet:.55}).start(0).connect(n);return new Q(vt,{oscillator:{type:"fatsawtooth",count:3,spread:20},envelope:{attack:.02,decay:.45,sustain:.65,release:.85},filterEnvelope:{attack:.02,decay:.5,sustain:.35,release:.8,baseFrequency:750,octaves:3.2,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.5},volume:-12}).connect(p)}case"stab":{const p=new Fe({distortion:.1,wet:.12}).connect(n),g=new Me({decay:1,wet:.22}).connect(p);return new Q(vt,{oscillator:{type:"fatsawtooth",count:2,spread:12},envelope:{attack:.003,decay:.16,sustain:.08,release:.18},filterEnvelope:{attack:.003,decay:.14,sustain:.05,release:.16,baseFrequency:420,octaves:3.5,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2},volume:-10}).connect(g)}case"guitar":return o&&Object.keys(o).length>0?new Oe({urls:o,volume:-8}).connect(n):new Q(xe,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.6,sustain:.05,release:.8},volume:-8}).connect(n);case"rhodes":case"epiano":return o&&Object.keys(o).length>0?new Oe({urls:o,volume:-10}).connect(n):new Q(Jt,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-10}).connect(n);case"piano":default:return o&&Object.keys(o).length>0?new Oe({urls:o,volume:-9}).connect(n):new Q(xe,{oscillator:{type:"triangle"},envelope:{attack:.005,decay:.8,sustain:.15,release:1},volume:-9}).connect(n)}}function zn(e){const t=e.numberOfChannels,i=e.sampleRate,o=16,s=o/8,n=t*s,r=e.length*t*s,c=new ArrayBuffer(44+r),d=new DataView(c),p=(v,b)=>{for(let f=0;f<b.length;f++)d.setUint8(v+f,b.charCodeAt(f))};p(0,"RIFF"),d.setUint32(4,36+r,!0),p(8,"WAVE"),p(12,"fmt "),d.setUint32(16,16,!0),d.setUint16(20,1,!0),d.setUint16(22,t,!0),d.setUint32(24,i,!0),d.setUint32(28,i*n,!0),d.setUint16(32,n,!0),d.setUint16(34,o,!0),p(36,"data"),d.setUint32(40,r,!0);const g=[];for(let v=0;v<t;v++)g.push(e.getChannelData(v));let a=44;for(let v=0;v<e.length;v++)for(let b=0;b<t;b++){const f=Math.max(-1,Math.min(1,g[b][v])),l=f<0?f*32768:f*32767;d.setInt16(a,l,!0),a+=2}return new Blob([new Uint8Array(c)],{type:"audio/wav"})}async function Ln(e,t,i,o,s=1,n){const r=No(e,t,o,s,n);if(!r.length)return;const c=t&&t.length>0?t.map(E=>e.chords[E]).filter(E=>!!E):e.chords,d=e.bpm||120,p=s*240/d,g=Math.max(.1,c.length*p),a=i?ge(i):void 0,b=(a?le.find(E=>E.name.toLowerCase()===a.toLowerCase()):void 0)?.instrument??(e.genre?Xe[e.genre]:void 0)??"piano";await es(b);const f=Zo(b),l=n?.tone||"Warm",h=await Po(async()=>{const E=Pn(a||i,e.genre,l,f);r.forEach(O=>{O.startTime<g&&E.triggerAttackRelease(O.note,O.duration,O.startTime)})},g),m=zn(h.get()),y=(e.key||"C").toLowerCase(),k=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),w=`chroma-chords-${y}-${k}-${d}bpm.wav`;Mo(m,w)}function Mo(e,t){if(typeof URL>"u"||typeof URL.createObjectURL!="function")return;const i=URL.createObjectURL(e);if(typeof document>"u")return;const o=document.createElement("a");o.href=i,o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),setTimeout(()=>URL.revokeObjectURL(i),1e3)}var Un=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,pe=(e,t,i,o)=>{for(var s=o>1?void 0:o?Rn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&Un(t,i,s),s};const jn=U`
...
`,Gn=[{device:"m8",mono:"M8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:jn},{device:"circuit",mono:"CT",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:_n}];let oe=class extends ne{constructor(){super(...arguments),this.open=!1,this.visible=!1,this.progression=null,this.order=[],this.instrument=null,this.playStyle=null,this.barsPerChord=1,this.feelSettings=null,this.onKeyDown=e=>{e.key==="Escape"&&this.isOpened&&this.close()}}get isOpened(){return this.open||this.visible}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKeyDown)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}close(){this.emit("close")}handleDeviceClick(e){if(!this.progression)return;const t=Zs(this.progression,e,this.order);window.open(t,"_blank");const i=e==="m8"?"M8 Tracker":"Circuit Tracks";this.emit("toast",`Opening ${i} helper...`),this.close()}async handleWavClick(){if(this.progression){this.emit("toast","Generating WAV audio...");try{const e=this.barsPerChord||S.getBarsPerChord()||1,t=this.feelSettings||S.getFeelSettings();await Ln(this.progression,this.order,this.instrument,this.playStyle,e,t),this.emit("toast","WAV file downloaded")}catch(e){console.error("WAV export failed",e),this.emit("toast","Failed to generate WAV file")}this.close()}}handleMidiClick(){if(this.progression){try{const e=this.barsPerChord||S.getBarsPerChord()||1,t=this.feelSettings||S.getFeelSettings();Fn(this.progression,this.order,this.instrument,this.playStyle,e,t),this.emit("toast","MIDI file downloaded")}catch(e){console.error("MIDI export failed",e),this.emit("toast","Failed to generate MIDI file")}this.close()}}render(){const e=this.isOpened;return u`
  ...
  `;pe([I({type:Boolean})],oe.prototype,"open",2);pe([I({type:Boolean})],oe.prototype,"visible",2);pe([I({type:Object})],oe.prototype,"progression",2);pe([I({type:Array})],oe.prototype,"order",2);pe([I({type:String})],oe.prototype,"instrument",2);pe([I({type:String})],oe.prototype,"playStyle",2);pe([I({type:Number})],oe.prototype,"barsPerChord",2);pe([I({type:Object})],oe.prototype,"feelSettings",2);oe=pe([re("share-modal")],oe);var Vn=Object.defineProperty,qn=Object.getOwnPropertyDescriptor,C=(e,t,i,o)=>{for(var s=o>1?void 0:o?qn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&Vn(t,i,s),s};const qt=[{name:"Oasis",color:"#F6D98B",r:10,plain:"leans on a bright chord that shouldn’t fit, then walks home",theory:"borrowed major ♭III, plagal IV–I, sus4 held over a static root",hoist:["E♭maj7","Fmaj7","A♭"],font:"Anton, sans-serif",pillFs:13,pillTrack:"0.08em"},{name:"Radiohead",color:"#C9A9E0",r:3,plain:"swaps a chord for its stranger neighbour a third away",theory:"chromatic mediants and modal mixture — ♭VI and ♭III against a major tonic",hoist:["A♭maj7","E♭maj7","Em7"],font:"'Space Mono', monospace",weight:700,pillFs:12.5,pillTrack:"0.02em"},{name:"Nirvana",color:"#F2A79B",r:2,plain:"moves the root in big jumps and leaves the middle empty",theory:"power-chord roots by minor third and tritone — no thirds, so major or minor stays open",hoist:["A♭","E♭maj7","B♭"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"0.04em"},{name:"Steely Dan",color:"#9CC0EC",r:13,plain:"adds one note that makes a plain chord sound expensive",theory:"major triad plus 9th with no 7th, ii–V chains, tritone substitution",hoist:["Cmaj9","D♭7","Fm7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,italic:!0,pillFs:13,pillTrack:"0.01em"},{name:"Mac DeMarco",color:"#B8CC9E",r:7,plain:"two lush chords looped loose, bass sliding underneath",theory:"maj7 vamp with chromatic bass motion, no real resolution",hoist:["Fmaj7","Cmaj9","Em7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"-0.01em"}],Di=["Pop","Lo-fi/Chill","R&B/Soul","Synthwave","Indie/Folk","Rock","Jazz-ish","Cinematic"],Bi=["Uplifting","Melancholy","Dreamy"],Hn={Uplifting:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5",Melancholy:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15",Dreamy:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0",Tense:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12",Warm:"M12 4 a6.5 6.5 0 1 0 6.5 6.5",Nostalgic:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},be={Tonic:"home",Submediant:"drifting",Subdominant:"lifting",Supertonic:"stepping up",Mediant:"wistful",Dominant:"pulling home","Dominant 7th":"pulling home"},Yn=be,Ht=["A","S","D","F","G","H","J","K"],Wn=["Octave up","1st inversion","Low root"],Jn=[{label:"Major",sub:"bright"},{label:"Minor",sub:"warm"},{label:"Suspended (sus)",sub:"floating"},{label:"Diminished",sub:"unstable"}],Kn=[{label:"None",sub:"triad only"},{label:"6th",sub:"soft lift"},{label:"7th (dom / m7)",sub:"classic tension"},{label:"Major 7th (M7)",sub:"lush, jazzy"},{label:"9th",sub:"wide, colorful"}],Fi=[{k:"swing",label:"Swing",hint:"How far behind the beat the notes land",steps:[{v:0,name:"Straight"},{v:25,name:"Light"},{v:55,name:"Loose"},{v:85,name:"Heavy"}]},{k:"spread",label:"Spread",hint:"How far apart the notes sit",steps:[{v:15,name:"Tight"},{v:50,name:"Close"},{v:75,name:"Open"},{v:95,name:"Wide"}]},{k:"density",label:"Density",hint:"How many notes per chord",steps:[{v:20,name:"Sparse"},{v:50,name:"Simple"},{v:75,name:"Full"},{v:95,name:"Busy"}]}],ue={swing:0,spread:50,density:50,tone:"Warm"},Pi=["Warm","Glassy","Dusty"],Yt=["C min","A min","F min","D min","G min","E♭ maj","C maj","G maj","F maj"],Xn=["C","D♭","D","E♭","E","F","F♯","G","A♭","A","B♭","B"],zi={Darker:["Three chords that add weight without changing the key.","All three pull from the parallel minor or its subdominant — same key, more shadow."],"More tension":["Three chords that lean harder into the next bar.","Dominant approaches — each one aims at a chord later in the loop."],Dreamier:["Three chords that open the bar up and let it float.","Extensions and softer degrees — less pull toward home."],"Resolve home":["Three chords that settle the bar back to center.","Tonic and its neighbours — the sense of arriving."],Borrowed:["Four chords from the minor version of this key. Each one swaps in for a chord you already have.","Modal interchange — four chords from the parallel minor, each matched to the chord it can stand in for."]},Li=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],Ui={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},dt={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},pt={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},li={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},qe={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}};function Qn(e){const t=e===""?"maj":e;if(qe[5][t]||qe[6][t])return t;const i=li[t];return i&&(qe[5][i]||qe[6][i])?i:"maj"}function Zn(e){const t=Qn(e.q),i=[];return[[6,4],[5,9]].forEach(([o,s])=>{const n=qe[o][t];if(!n)return;const r=((e.rootPc-s)%12+12)%12;i.push({rootFret:r,frets:n.map(c=>c===null?null:c+r)})}),i.length?(i.sort((o,s)=>o.rootFret-s.rootFret),i[0].frets):null}function er(e){const t=[7,0,4,9],i=e.intervals.map(r=>(e.rootPc+r)%12),o=r=>{const c=new Set(r);let d=null;const p=[],g=a=>{if(a===4){const v=p.map((h,m)=>(t[m]+h)%12);for(const h of c)if(v.indexOf(h)<0)return;for(const h of v)if(!c.has(h))return;const b=p.filter(h=>h>0),f=b.length?Math.max(...b)-Math.min(...b):0;if(f>3)return;const l=f*12+p.reduce((h,m)=>h+m,0);(!d||l<d.score)&&(d={frets:p.slice(),score:l});return}for(let v=0;v<=5;v++)p.push(v),g(a+1),p.pop()};return g(0),d},s=o(i);if(s)return s.frets;const n=o(e.intervals.filter(r=>r!==7).map(r=>(e.rootPc+r)%12));return n?n.frets:null}const Ri=[{key:"Darker",label:"Darker",tension:.55},{key:"More tension",label:"Tense",tension:.9},{key:"Dreamier",label:"Dreamy",tension:.3},{key:"Resolve home",label:"Home",tension:.05},{key:"Borrowed",label:"Borrow",tension:.42,twoTone:!0}];let $=class extends ne{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.userEmail=null,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.isGenerating=!1,this.libraryOpen=!1,this.isMobile=typeof window<"u"?window.innerWidth<900:!1,this.activeView="loop",this.vibeOpen=!1,this.selectedBand=null,this.freeText="",this.vibePlaceholderIdx=0,this.expandedGenre=!1,this.expandedMood=!1,this.activeSwapFamily="Darker",this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.detailIndex=0,this.abPick=null,this.abSide="before",this.abPlaying=!1,this.savedSets=[],this.renamingId=null,this.draftName="",this.confirmDeleteId=null,this.librarySearch="",this.librarySelectMode=!1,this.librarySelected=[],this.playInstrument="Piano",this.showDegrees=!1,this.mobileSheetOpen=!1,this.mobileDetailSheetOpen=!1,this.padFlash=-1,this.padHeld=-1,this.gridFor=-1,this.lastPad=null,this.tempoOpen=!1,this.feelOpen=!1,this.shareOpen=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.barsPerChord=1,this.keyIdx=0,this.swing=0,this.spread=50,this.density=50,this.tone="Warm",this.showAdvancedFeel=!1,this.humanEngineState=null,this.auditionDeg=null,this.auditionName=null,this.auditionBar=0,this.gridTimer=null,this.vibeExamples=["Rainy drive at 2am, first day of summer...","Portishead trip-hop","Bohemian Rhapsody","Tame Impala neo-psychedelia","Warm acoustic fireplace"],this.placeholderTimer=null,this.unsubscribeProjects=null,this.onResizeHandler=()=>{this.isMobile=window.innerWidth<900},this.handleKeyDown=e=>{const t=e.target;if(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"))return;if(e.key===" "||e.code==="Space"){e.preventDefault(),this.togglePlay();return}if(e.key==="Escape"){e.preventDefault(),(this.tempoOpen||this.feelOpen)&&(this.tempoOpen=!1,this.feelOpen=!1,this.requestUpdate());return}const i=Ht.map(s=>s.toLowerCase()).indexOf((e.key||"").toLowerCase()),o=this.progression?.chords||[];if(i>=0&&i<o.length){e.preventDefault();const s=88+i%3*6,n=o[i],r=this.getChordLadder(n),c=this.getLadderHome(n);let d=c>=0?c:0,p=1,g="1st inversion";this.lastPad?.idx===i&&typeof this.lastPad.reach=="number"&&r.length>0&&(d=(this.lastPad.reach+1)%r.length),e.shiftKey&&(p=0,g="up an octave");const a=r.length>0&&r[d]?r[d]:n.name,v=d!==c&&!!r[d],b=this.progression?.key||"C",f=this.progression?.scaleType||"MAJOR",l=H(a,j(b,f));this.padFlash=i,this.padHeld=i,this.gridFor=i;const h=v?"→ "+a:p===0?"UP AN OCTAVE":p===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:i,voicing:g,vel:s,zone:p,reach:d,meta:h},S.playChordNotes(l,.85,g,s),this.requestUpdate()}},this.handleKeyUp=e=>{Ht.map(i=>i.toLowerCase()).indexOf((e.key||"").toLowerCase())>=0&&(this.padFlash=-1,this.requestUpdate())},this.toggleVibe=()=>{this.vibeOpen=!this.vibeOpen,this.requestUpdate()},this.toggleLibrary=()=>{this.libraryOpen=!this.libraryOpen,this.dispatchEvent(new CustomEvent("library-open-change",{detail:this.libraryOpen,bubbles:!0,composed:!0})),this.requestUpdate()},this.togglePlay=()=>{this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))},this.clearSelection=()=>{this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.abPick=null,this.abPlaying=!1,S.setABOverride(null),this.requestUpdate()},this.toggleABPlayback=()=>{if(!(!this.progression||this.swapIndex===null)){if(this.abPlaying=!this.abPlaying,this.abPlaying){const e=j(this.progression.key,this.progression.scaleType),t=this.abSide==="after"&&this.abPick?{...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:H(this.abPick.chord,e)}:this.progression.chords[this.swapIndex];S.setABOverride({index:this.swapIndex,side:this.abSide,chord:t}),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))}else this.playing&&this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),S.setABOverride(null);this.requestUpdate()}},this.confirmSwap=()=>{if(this.swapIndex===null||!this.abPick||!this.progression)return;const e=j(this.progression.key,this.progression.scaleType),t=H(this.abPick.chord,e),i=[...this.progression.chords];i[this.swapIndex]={...i[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:t};const o={...this.progression,chords:i};this.dispatchEvent(new CustomEvent("progression-change",{detail:o,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("toast",{detail:`Swapped in ${this.abPick.chord}`,bubbles:!0,composed:!0})),S.setABOverride(null),this.abPlaying=!1,this.swapIndex=null,this.isInspectorOpen=!1,this.mobileSheetOpen=!1,this.abPick=null,this.requestUpdate()},this.onDecLength=()=>{const e=this.progression?.chords.length||4;e>Ue&&this.dispatchEvent(new CustomEvent("set-length",{detail:e-1,bubbles:!0,composed:!0}))},this.onIncLength=()=>{const e=this.progression?.chords.length||4;e<me&&this.dispatchEvent(new CustomEvent("set-length",{detail:e+1,bubbles:!0,composed:!0}))},this.onReroll=()=>{this.dispatchEvent(new CustomEvent("reroll",{bubbles:!0,composed:!0}))},this.onTheoryToggle=()=>{this.showTheory=!this.showTheory,this.dispatchEvent(new CustomEvent("theory-toggle",{detail:this.showTheory,bubbles:!0,composed:!0})),this.requestUpdate()},this.toggleInstrumentExpand=()=>{this.expandedInstrument=!this.expandedInstrument,this.expandedPlayStyle=!1,this.requestUpdate()},this.togglePlayStyleExpand=()=>{this.expandedPlayStyle=!this.expandedPlayStyle,this.expandedInstrument=!1,this.requestUpdate()},this.onHumanChange=e=>{e.detail&&(this.humanEngineState=e.detail,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:e.detail}))},this.onHumanPreview=e=>{e.detail&&(this.humanEngineState=e.detail,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:e.detail}))}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResizeHandler),window.addEventListener("keydown",this.handleKeyDown),window.addEventListener("keyup",this.handleKeyUp),this.placeholderTimer=setInterval(()=>{this.vibePlaceholderIdx=(this.vibePlaceholderIdx+1)%this.vibeExamples.length},2800),this.savedSets=F.getProjects(),this.unsubscribeProjects=typeof F.subscribeProjects=="function"?F.subscribeProjects(()=>{this.savedSets=F.getProjects(),this.requestUpdate()}):typeof F.subscribe=="function"?F.subscribe(()=>{this.savedSets=F.getProjects(),this.requestUpdate()}):null,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone}),S.setBarsPerChord(this.barsPerChord),Ne(this.tone)}updated(e){super.updated(e),(e.has("swing")||e.has("spread")||e.has("density")||e.has("tone")||e.has("humanEngineState"))&&(S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:this.humanEngineState}),e.has("tone")&&Ne(this.tone)),e.has("barsPerChord")&&S.setBarsPerChord(this.barsPerChord)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResizeHandler),window.removeEventListener("keydown",this.handleKeyDown),window.removeEventListener("keyup",this.handleKeyUp),this.placeholderTimer&&clearInterval(this.placeholderTimer),this.unsubscribeProjects&&this.unsubscribeProjects()}getVibeSummary(){const e=[this.progression?.genre||"Pop",(this.progression?.mood||"Warm").toLowerCase()];return this.selectedBand&&e.push(this.selectedBand),e.join(" · ")}onGenreClick(e){this.dispatchEvent(new CustomEvent("set-genre",{detail:e,bubbles:!0,composed:!0})),this.requestUpdate()}onMoodClick(e){this.dispatchEvent(new CustomEvent("set-mood",{detail:e,bubbles:!0,composed:!0})),this.requestUpdate()}onBandClick(e){this.selectedBand===e?this.selectedBand=null:this.selectedBand=e;const t=qt.find(i=>i.name===this.selectedBand);t&&this.dispatchEvent(new CustomEvent("toast",{detail:`Active artist DNA: ${t.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}onVibeSubmit(e){e.preventDefault();const t=this.freeText.trim();t&&(this.dispatchEvent(new CustomEvent("freetext-generate",{detail:t,bubbles:!0,composed:!0})),this.vibeOpen=!1,this.requestUpdate())}onJumpBar(e){this.progressStep=e*4,S.playFromBar(e),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),this.requestUpdate()}getChordLadder(e){if(!e)return[];const t=String(e.name),i=(t.match(/^[A-G][#b]?/)||["C"])[0];return(/sus/.test(t)?["sus4","7sus4","9sus4","maj7sus4"]:/dim/.test(t)?["dim","dim7","dim9"]:/^[A-G][#b]?m(?!aj)/.test(t)?["m","m6","m7","m9","mMaj7"]:["","6","7","maj7","maj9"]).map(s=>i+s)}getLadderHome(e){return this.getChordLadder(e).indexOf(e&&e.name)}handlePadPointerDown(e,t){let i="1st inversion",o=1,s;const n=this.progression?.chords;if(e.currentTarget&&typeof e.currentTarget.getBoundingClientRect=="function"){const h=e.currentTarget.getBoundingClientRect(),m=(e.clientY-h.top)/(h.height||1);if(m<.34?(o=0,i="up an octave"):m>.67?(o=2,i="low, root position"):(o=1,i="1st inversion"),typeof e.clientX=="number"&&n&&n[t]){const y=this.getChordLadder(n[t]),k=Math.min(.999,Math.max(0,(e.clientX-h.left)/(h.width||1)));s=Math.min(y.length-1,Math.floor(k*y.length))}}const r=n?n[t]:null;if(!r)return;const c=this.getChordLadder(r),d=this.getLadderHome(r),p=s!==void 0&&c[s]?c[s]:r.name,g=s!==void 0&&s!==d&&!!c[s],a=this.progression?.key||"C",v=this.progression?.scaleType||"MAJOR",b=H(p,j(a,v)),f=88+t%3*6;this.gridTimer&&(clearTimeout(this.gridTimer),this.gridTimer=null),this.padFlash=t,this.padHeld=t,this.gridFor=t;const l=g?"→ "+p:o===0?"UP AN OCTAVE":o===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:t,voicing:i,vel:f,zone:o,reach:s,meta:l},S.playChordNotes(b,.85,i,f),this.requestUpdate()}handlePadPointerUp(){this.padFlash=-1,this.padHeld=-1,this.gridTimer&&clearTimeout(this.gridTimer),this.gridTimer=window.setTimeout(()=>{this.gridFor=-1,this.requestUpdate()},1100),this.requestUpdate()}openSwap(e){this.swapIndex=e,this.detailOpen=!1,this.isInspectorOpen=!0,this.abPick=null,this.abSide="before",this.abPlaying=!1,S.setABOverride(null),this.isMobile&&(this.mobileSheetOpen=!0),this.requestUpdate()}openDetail(e){this.detailIndex=e,this.detailOpen=!0,this.swapIndex=null,this.isInspectorOpen=!1,this.isMobile&&(this.mobileDetailSheetOpen=!0),this.requestUpdate()}selectAlternative(e){const t=this.progression?j(this.progression.key,this.progression.scaleType):!1,i=e.chord.notes&&e.chord.notes.length>0?e.chord.notes:H(e.chord.name,t);this.abPick={chord:e.name,tension:e.tension,roman:e.roman||"",fn:e.sub,label:e.name},this.abSide="after",this.swapIndex!==null&&this.progression&&S.setABOverride({index:this.swapIndex,side:"after",chord:{...this.progression.chords[this.swapIndex],name:e.name,roman:e.roman||"",tension:e.tension,notes:i}}),S.auditionChord({...e.chord,notes:i},.8),this.requestUpdate()}previewAlternative(e){if(!this.progression)return;const t=j(this.progression.key,this.progression.scaleType),i=H(e,t);S.auditionChord({name:e,notes:i,tag:"",color:"#F2A79B",functionLabel:"",desc:"",degree:"",scaleKey:this.progression.key,roman:"",scaleLabel:"",tension:.2},.8)}setABSide(e){if(this.abSide=e,this.swapIndex!==null&&this.progression){const t=j(this.progression.key,this.progression.scaleType);if(e==="before")S.setABOverride({index:this.swapIndex,side:"before",chord:this.progression.chords[this.swapIndex]}),S.auditionChord(this.progression.chords[this.swapIndex],.8);else if(this.abPick){const i=H(this.abPick.chord,t),o={...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:i};S.setABOverride({index:this.swapIndex,side:"after",chord:o}),S.auditionChord(o,.8)}}this.requestUpdate()}onAbCellClick(e){if(!this.progression)return;if(e===this.swapIndex&&this.abSide==="after"&&this.abPick){const i=j(this.progression.key,this.progression.scaleType),o={...this.progression.chords[e],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:H(this.abPick.chord,i)};S.auditionChord(o,.8)}else S.playChordAtIndex(e,.8)}getChordQualityLabel(e){if(!e)return"Major";const t=e.trim().replace(/^[A-G][#b♭♯]?/i,"");return/sus/i.test(t)?"Suspended (sus)":/(dim|°)/i.test(t)?"Diminished":/^(m|min)(?!aj)/.test(t)?"Minor":"Major"}getChordQualitySub(e){switch(this.getChordQualityLabel(e)){case"Minor":return"warm";case"Suspended (sus)":return"floating";case"Diminished":return"unstable";default:return"bright"}}getChordExtensionLabel(e){if(!e)return"None";const t=e.trim().replace(/^[A-G][#b♭♯]?/i,"");return/9/.test(t)?"9th":/(maj7|\(maj7\)|Δ)/i.test(t)||/M7/.test(t)?"Major 7th (M7)":/6/.test(t)?"6th":/(7|11|13)/.test(t)?"7th (dom / m7)":"None"}getChordExtensionSub(e){switch(this.getChordExtensionLabel(e)){case"6th":return"soft lift";case"7th (dom / m7)":return"classic tension";case"Major 7th (M7)":return"lush, jazzy";case"9th":return"wide, colorful";default:return"triad only"}}changeChordQuality(e){if(!this.progression)return;const t=[...this.progression.chords],i=t[this.detailIndex];if(!i)return;const o=this.getChordExtensionLabel(i.name),s=Ai(i,e,o);t[this.detailIndex]=s;const n={...this.progression,chords:t};this.progression=n,this.dispatchEvent(new CustomEvent("progression-change",{detail:n,bubbles:!0,composed:!0})),S.auditionChord(s,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${s.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}changeChordExtension(e){if(!this.progression)return;const t=[...this.progression.chords],i=t[this.detailIndex];if(!i)return;const o=this.getChordQualityLabel(i.name),s=Ai(i,o,e);t[this.detailIndex]=s;const n={...this.progression,chords:t};this.progression=n,this.dispatchEvent(new CustomEvent("progression-change",{detail:n,bubbles:!0,composed:!0})),S.auditionChord(s,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${s.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}renderDetailKeyboard(e=[]){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,F:5,"E#":5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=new Set(e.map(c=>t[c.replace(/\d+$/,"")]??-1)),o=[{note:"C",pc:0},{note:"D",pc:2},{note:"E",pc:4},{note:"F",pc:5},{note:"G",pc:7},{note:"A",pc:9},{note:"B",pc:11}],s=100/7,n=s*.58,r=[{note:"C#",pc:1,after:0},{note:"D#",pc:3,after:1},{note:"F#",pc:6,after:3},{note:"G#",pc:8,after:4},{note:"A#",pc:10,after:5}];return u`
      <div class="detail-mini-keyboard">
        <div style="display: flex;">
          ${o.map(c=>{const d=i.has(c.pc);return u`<div class="white-key ${d?"active":""}">${c.note}</div>`})}
        </div>
        ${r.map(c=>{const d=(c.after+1)*s-n/2,p=i.has(c.pc);return u`<div class="black-key ${p?"active":""}" style="left: ${d}%;"></div>`})}
      </div>
    `}get feelChanged(){return this.swing!==ue.swing||this.spread!==ue.spread||this.density!==ue.density||this.tone!==ue.tone}resetFeel(){this.swing=ue.swing,this.spread=ue.spread,this.density=ue.density,this.tone=ue.tone,this.humanEngineState=null,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:void 0}),Ne(this.tone),this.requestUpdate()}nudgeBpm(e){const t=this.progression?.bpm||84,i=Math.max(40,Math.min(240,t+e));this.progression&&(this.progression.bpm=i),S.setBpm(i),this.dispatchEvent(new CustomEvent("set-bpm",{detail:i,bubbles:!0,composed:!0})),this.requestUpdate()}setDirectBpm(e){if(isNaN(e))return;const t=Math.max(40,Math.min(240,e));this.progression&&(this.progression.bpm=t),S.setBpm(t),this.dispatchEvent(new CustomEvent("set-bpm",{detail:t,bubbles:!0,composed:!0})),this.requestUpdate()}setBarsPerChord(e){this.barsPerChord=e,S.setBarsPerChord(e),this.requestUpdate()}selectKey(e){if(this.keyIdx=Yt.indexOf(e),!this.progression)return;const t=qs(this.progression,e);this.progression=t,S.setProgression(t),this.dispatchEvent(new CustomEvent("progression-change",{detail:t,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("toast",{detail:`Transposed to ${t.key} ${t.scaleType==="NATURAL_MINOR"?"minor":"major"}`,bubbles:!0,composed:!0})),this.requestUpdate()}onScaleDegreeClick(e,t,i,o){this.auditionDeg=e,this.auditionName=t,this.auditionBar=i?o+1:0;const s=j(this.progression?.key||"C",this.progression?.scaleType||"MAJOR"),n=H(t,s);S.auditionChord({name:t,notes:n},.8),this.requestUpdate()}getTheoryData(e){const t=(this.progression?.scaleType||"").toUpperCase().includes("MINOR")||(this.progression?.key||"").includes("m"),i=this.progression?.key||"C",o=P[i.replace("b","b").replace("♭","b")]??0,s=t?{steps:[0,2,3,5,7,8,10],romans:["i","ii°","♭III","iv","v","♭VI","♭VII"],quals:["m","dim","","m","m","",""],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"natural minor"}:{steps:[0,2,4,5,7,9,11],romans:["I","ii","iii","IV","V","vi","vii°"],quals:["","m","m","","","m","dim"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"major"},n=i.replace("b","♭")+" "+s.name,r=e.map(l=>{const h=ee(l.name);return P[h.root]??0}),c=l=>s.steps.indexOf(((l-o)%12+12)%12),d=s.steps.map((l,h)=>{const m=(o+l)%12,k=Xn[m]+s.quals[h],w=r.indexOf(m),E=w>=0,O=this.auditionDeg===h;return{di:h,roman:s.romans[h],name:k,fn:s.fns[h],inLoop:E,on:O,barIdx:w,aria:`Hear ${k}, the ${s.fns[h].toLowerCase()} of ${n}`}}),p=this.auditionDeg===null||this.auditionDeg<0?"Tap a degree to hear it":this.auditionBar?`${this.auditionName} · bar ${this.auditionBar} of the loop`:`${this.auditionName} · not in this loop`,g=e.map(l=>l.roman||s.romans[Math.max(0,c(P[ee(l.name).root]??0))]).join(" – "),a=i.replace("b","♭")+" "+(t?"minor":"major"),v=on(e),b=sn(e),f=this.progression?.note||"";return{scaleName:n,scaleHint:p,scaleDegrees:d,romanFormula:g,keyModeLine:a,cadences:v,voiceLinks:b,setNote:f}}renderScaleChords(e,t,i,o){const s=Ie(this.progression?.mood||"Warm");return u`
      <div
      ...
      <div class="tempo-popover-desktop" style="background: var(--cv-cream); border-radius: 16px; padding: 14px 16px; margin-top: 11px; display: flex; flex-wrap: wrap; align-items: flex-end; gap: 18px;">
        ...
        <div style="flex: 1; min-width: 240px;">
          ...
          <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px;">
            ${Yt.map((t,i)=>{const o=this.keyIdx===i||this.progression?.key===t.replace(" min","").replace(" maj","").replace("♭","b");return u`
                <button
            ...
            <div style="display: flex; gap: 5px; flex: 1; min-width: 0;">
              ${Pi.map(e=>u`
                <button
                  ...
                  @click=${()=>{this.tone=e,S.setFeelSettings({tone:e}),Ne(e),this.requestUpdate()}}
                >
                  ${e}
                </button>
              `)}
    ...
    `}renderChordDetailContent(e){const t=e[this.detailIndex],i=this.getChordQualityLabel(t?.name),o=this.getChordExtensionLabel(t?.name),s=j(this.progression?.key||"C",this.progression?.scaleType||"MAJOR"),n=t?tn(t.name,s):[];return u`
      ...
      <div class="quality-chips-grid">
        ${Jn.map(r=>{const c=r.label===i;return u`
            <button
      ...
      <div class="ext-chips-grid">
        ${Kn.map(r=>{const c=r.label===o;return u`
            <button
    ...
    `}renderPianoCard(e,t){const i=ee(e.name),o=Ui[i.root]??0,s=pt[i.quality]||pt[li[i.quality]||"maj"]||[0,4,7],n=22,r=86,c=52,d=[0,2,4,5,7,9,11],p=[],g=[],a=[];for(let f=0;f<2;f++)d.forEach((l,h)=>{p.push({x:(f*7+h)*n,w:n-1.5,h:r})});for(let f=0;f<2;f++)[0,1,3,4,5].forEach(l=>{const h=f*7+l;g.push({x:h*n+n*.64,w:n*.58,h:c})});s.forEach(f=>{const l=o+f,h=Math.floor(l/12),m=l%12,y=d.indexOf(m),k=f===0,w=y<0,E=k?"#F2735F":w?"#FBF3E6":"#2E271F",O=k?"#FBF3E6":w?"#2E271F":"#FBF3E6",_=this.showDegrees?dt[f%12]:"";if(y>=0){const G=h*7+y;a.push({cx:G*n+(n-1.5)/2,cy:r-19,r:9,fill:E,isRoot:k,label:_,lc:O})}else{const Y=(h*7+d.indexOf(m-1))*n+n*.64,K=n*.58;a.push({cx:Y+K/2,cy:c-14,r:7.5,fill:E,isRoot:k,label:_,lc:O})}});const v=14*n,b=s.map(f=>{const l=Li[(o+f)%12];return this.showDegrees?`${l} (${dt[f%12]})`:l}).join(" · ");return u`
      <div
        class="play-card"
    ...
    `}renderFretCard(e,t,i){const o=ee(e.name),s=Ui[o.root]??0,n=pt[o.quality]||pt[li[o.quality]||"maj"]||[0,4,7],r=[4,9,2,7,11,4],c=[7,0,4,9],d=i==="Ukulele",p=d?c:r,g=d?er({root:o.root,rootPc:s,q:o.quality,intervals:n})||[null,null,null,null]:Zn({root:o.root,rootPc:s,q:o.quality})||[null,null,null,null,null,null],a=18,v=24,b=4,f=16,l=p.length,h=g.filter(T=>T!==null&&T>0),m=h.length&&Math.max(...h)>4?Math.min(...h)-1:0,y=[],k=[],w=[],E=[],O=[];for(let T=0;T<l;T++)y.push({x:T*a});for(let T=0;T<=b;T++)k.push({y:f+T*v,sw:T===0&&m===0?3:1.2});g.forEach((T,J)=>{const ae=J*a;if(T===null){O.push({x:ae});return}if(T===0){E.push({x:ae});return}const Ge=((p[J]+T-s)%12+12)%12;w.push({cx:ae,cy:f+(T-m-.5)*v,fill:Ge===0?"#F2735F":"#2E271F",label:this.showDegrees?dt[((p[J]+T-s)%12+12)%12]:""})});const _=(l-1)*a,G=(l-1)*a+26,Y=f+b*v+12,K=m>0?`${m+1}fr`:"",ie=m>0,V=n.map(T=>{const J=Li[(s+T)%12];return this.showDegrees?`${J} (${dt[T%12]})`:J}).join(" · ");return u`
      <div
        class="play-card"
      ...
      >
        <div style="display: flex; align-items: baseline; justify-content: space-between; gap: 8px; position: relative; z-index: 2;">
          ...
          ${ie?u`
            <div style="font-size: 11px; font-weight: 800; color: var(--cv-label);">${K}</div>
          `:""}
        </div>
        <svg width="${G}" height="${Y}" viewBox="-13 -2 ${G} ${Y}" style="display: block; width: 100%; max-width: ${G*1.5}px; height: auto;">
          ${k.map(T=>U`
    ...
    `}renderChordPad(e,t,i,o){const s=Z(e.tension||.1),n=this.activeIndex===t&&this.playing,r=this.padFlash===t||this.padHeld===t,c=this.swapIndex===t,d=this.getChordLadder(e),p=this.getLadderHome(e),g=this.lastPad?.idx===t,a=g&&typeof this.lastPad?.reach=="number"?this.lastPad.reach:p,v=g&&a>=0&&a!==p&&d[a],b=g?v?"→ "+d[a]:Wn[this.lastPad?.zone??1]||this.lastPad?.voicing||"":"";return u`
      <div
        class="pad-cell ${o?"chord-item-wrap":""} ${r?"pad-held":""} ${c?"selected":""} ${n?"pad-lit":""}"
        style="background: ${s.color};"
        tabindex="0"
        role="button"
        aria-label="${e.name}, ${be[e.functionLabel]||e.functionLabel} — press to play it; press nearer the top for a higher voicing"
        @pointerdown=${f=>this.handlePadPointerDown(f,t)}
        @pointerup=${()=>this.handlePadPointerUp()}
      ...
      >
        ...
        <div class="pad-top-row">
          <span class="pad-key-badge">${Ht[t]||""}</span>
          ${this.showTheory&&e.roman?u`<span class="pad-roman-badge">${e.roman}</span>`:""}
        </div>

        <div class="pad-bottom-info">
          <div class="pad-role-label">${Yn[e.functionLabel]||e.functionLabel}</div>
          <div class="pad-chord-name">${g&&v&&d[a]?d[a]:e.name}</div>
    ...
    `}render(){const e=this.progression?.chords||[],t=Ie(this.progression?.mood||"Warm"),i=qt.find(l=>l.name===this.selectedBand),o=this.getTheoryData(e),s=e.map(l=>l.tension||.1),n=Math.max(...s,.1),r=Math.min(...s,0),c=s.indexOf(n),d=s.every((l,h)=>h===0||l>=s[h-1]),p=n-r<.28?"Stays close to home":d?"A steady climb":s[s.length-1]<.25&&c<s.length-1?"Away, then home":"Drifts, then settles",g=`Opens ${be[e[0]?.functionLabel]||"home"} and ${n-r<.28?"never strays far — every chord sits in about the same place, so the loop feels calm and repeatable.":d?`tightens chord by chord, peaking on ${e[c]?.name||"the peak"}. Looping back does the resolving.`:`explores tension up to ${e[c]?.name||"the middle"} before easing back down home.`}`;let a=[],v="";const b=this.progression?.scaleType?.includes("MINOR")??!1;if(this.swapIndex!==null&&this.progression&&this.chordData.scales){if(this.activeSwapFamily==="Borrowed")a=yo(this.chordData,this.progression,this.swapIndex),v=`Four chords from the ${b?"major":"minor"} version of this key.`;else{const l=vi(this.chordData,this.progression,this.swapIndex);a=(l.find(m=>m.name===this.activeSwapFamily)||l[0])?.rows||[],v=zi[this.activeSwapFamily]?zi[this.activeSwapFamily][this.showTheory?1:0]:""}if(i){const l=a.filter(m=>i.hoist.includes(m.name)),h=a.filter(m=>!i.hoist.includes(m.name));a=[...l,...h]}}const f=this.swapIndex!==null?e[this.swapIndex]:null;return this.isMobile?u`
          ...
          <div style="padding: 14px 18px 24px; flex: 1;">
            ${this.activeView==="loop"?u`
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 14px;">
                <button class="instrument-chip" @click=${this.toggleInstrumentExpand} aria-label="Change instrument">
                  ...
                  ${ge(this.instrument)} <span style="opacity:0.6;">⌄</span>
                </button>
              ...
              ${this.expandedInstrument?u`
                <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 10px;">
                  ${le.map(l=>u`
                    <button
                      class="pill ${ge(this.instrument)===l.name?"active":""}"
              ...
              ${this.showTheory?u`
                <div class="mobile-theory-panel">
                  ...
                  <div class="mobile-arc-bars" style="display: flex; align-items: flex-end; gap: 6px; height: 132px; margin-top: 14px;">
                    ${e.map(l=>{const h=Math.round(28+(l.tension||.1)*85),m=Z(l.tension||.1);return u`
                        <div style="flex: 1; display: flex; flex-direction: column; align-items: center; cursor: default;">
                          ...
                          <div style="font-size: 10px; font-weight: 700; color: var(--cv-ink-muted);">${be[l.functionLabel]||""}</div>
                        </div>
                      `})}
                  </div>
            ...
            `:this.activeView==="song"?u`
              <div class="song-track-list" style="display: flex; flex-direction: column; gap: 12px; padding: 4px 0 20px;">
                ...
                ${this.sections.map((l,h)=>{const m=this.activeSectionIdx===h;return u`
                    <div
                    ...
                    >
                      ...
                      <div class="song-card-chips" style="display: flex; gap: 6px; margin-top: 12px; flex-wrap: wrap;">
                        ${l.progression.chords.map(y=>{const k=Z(y.tension);return u`<div class="song-chord-chip" style="width: 16px; height: 16px; border-radius: ${Math.round(k.radius*.4)}px; background: ${k.color}; flex-shrink: 0;" title="${y.name}"></div>`})}
                      </div>
                    </div>
                  `})}
                <button
          ...
          ${this.mobileSheetOpen&&this.swapIndex!==null?u`
            ...
            <div class="mobile-swap-sheet mobile-sheet">
              ...
              <div class="ab-compare-box ab-box">
                ...
                <div class="ab-loop-player-row">
                  ...
                  <div class="ab-cells-track">
                    ${e.map((l,h)=>{const m=h===this.swapIndex,y=m&&this.abSide==="after"&&this.abPick?this.abPick.chord:l.name,k=this.abPlaying&&Math.floor(this.progressStep/4)===h;return u`
                        <button
              ...
              <div class="swap-family-tabs swap-tab-nav" style="margin-top: 14px;">
                ${Ri.map(l=>{const h=this.activeSwapFamily===l.key,m=Z(l.tension),y=Math.round(m.size*.34),k=Math.round(m.radius*(y/m.size));return u`
                    <button
                    ...
                    >
                      ...
                      `:u`
                        <span
                          class="family-shape"
                          style="width: ${y}px; height: ${y}px; border-radius: ${k}px; background: ${m.color}; box-shadow: ${h?`0 0 0 3px ${t}`:"none"};"
                        ></span>
                      `}
              ...
              <div class="alt-candidates-list" style="margin-top: 10px;">
                ${a.map(l=>{const h=!!i&&i.hoist.includes(l.name),m=Z(l.tension),y=Math.max(26,Math.min(36,Math.round(m.size*.32))),k=Math.round(m.radius*(y/m.size));return u`
                    <div class="alt-chord-row alt-item-row ${this.abPick?.chord===l.name?"selected":""}" @click=${()=>this.selectAlternative(l)}>
                      <div class="alt-shape" style="width: ${y}px; height: ${y}px; border-radius: ${k}px; background: ${m.color}; box-shadow: ${this.abPick?.chord===l.name?`0 0 0 2px ${t}`:"none"}; flex-shrink: 0;"></div>
                      <div style="flex: 1; min-width: 0;">
                        <div style="display: flex; align-items: baseline; gap: 8px; flex-wrap: wrap;">
                          <span style="font-size: 15px; font-weight: 800; color: var(--cv-ink);">${l.name}</span>
                          ${this.showTheory&&l.roman?u`<span style="font-size: 11px; font-weight: 800; color: #7A5C88;">${l.roman}</span>`:""}
                        ...
                        ${this.showTheory&&l.notes&&l.notes.length?u`
      ...
      <div class="studio-container" style="--mood-color: ${t};">
        ...
        ${this.vibeOpen?u`
          <div class="vibe-popover-desktop">
            ...
            <div class="popover-kicker spaced">Mood</div>
            <div class="pills-group">
              ${Bi.map(l=>{const h=Ie(l),m=this.progression?.mood===l;return u`
                  <button class="pill mood-pill ${m?"active":""}" style="${m?`background: ${h}; color: #2E271F;`:""}" @click=${()=>this.onMoodClick(l)}>
                    <span class="mood-badge" style="background: ${m?"rgba(46, 39, 31, 0.12)":h+"33"};">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="${m?"#2E271F":h}" stroke-width="2.2" stroke-linecap="round"><path d="${Hn[l]||"M12 4 a6.5 6.5 0 1 0 6.5 6.5"}"/></svg>
                    </span>
                    ${l}
                  </button>
                `})}
                ...
                <div class="loop-strip-header" style="margin-bottom: 20px;">
                  ...
                  <div class="strip-timeline-wrap">
                    <div class="strip-cells-bar loop-beat-cells">
                      ${this.sections.map((l,h)=>{const m=this.playing&&this.activePlayingSectionIdx===h;return u`
                          <div
                            class="strip-cell"
          ...
          `:this.swapIndex!==null?u`
              ...
              <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 12px;">
                <div>
                  ...
                  <div style="display: flex; align-items: baseline; gap: 8px; margin-top: 4px;">
                    ...
                    <span class="swap-role">${be[f?.functionLabel||""]||""}</span>
                  </div>
                </div>
            ...
            <div class="inspector-body">
              ...
              <div class="alt-candidates-list">
                ${a.map(l=>{const h=!!i&&i.hoist.includes(l.name),m=Z(l.tension),y=Math.max(28,Math.min(38,Math.round(m.size*.32))),k=Math.round(m.radius*(y/m.size));return u`
                    <div class="alt-chord-row alt-item-row ${this.abPick?.chord===l.name?"selected":""}" @click=${()=>this.selectAlternative(l)}>
                      <div class="alt-shape" style="width: ${y}px; height: ${y}px; border-radius: ${k}px; background: ${m.color}; box-shadow: ${this.abPick?.chord===l.name?`0 0 0 2px ${t}`:"none"}; flex-shrink: 0;"></div>
                      <div style="flex: 1; min-width: 0;">
                        <div style="display: flex; align-items: baseline; gap: 8px; flex-wrap: wrap;">
                      ...
                      <button class="alt-play-chip alt-play-btn" @click=${w=>{w.stopPropagation(),this.previewAlternative(l.name)}}>Hear</button>
                    </div>
                  `})}
              </div>
          ...
          `:u`
            ...
            <div class="inspector-body">
              <div class="arc-bars-row">
                ${e.map((l,h)=>{const m=Z(l.tension||.1),y=Math.round(18+(l.tension||.1)*62);return u`
                    <button class="arc-bar-col" @click=${()=>this.openSwap(h)} aria-label="${l.name}, ${be[l.functionLabel]||""}">
                      ...
                      <div class="arc-bar-feel">${be[l.functionLabel]||""}</div>
                    </button>
                  `})}
              </div>
  ...
  `;je([I({type:Boolean})],fe.prototype,"visible",2);je([I({type:String})],fe.prototype,"defaultName",2);je([x()],fe.prototype,"mounted",2);je([x()],fe.prototype,"name",2);je([Ki(".name-input")],fe.prototype,"inputEl",2);fe=je([re("save-set-modal")],fe);var or=Object.defineProperty,sr=Object.getOwnPropertyDescriptor,R=(e,t,i,o)=>{for(var s=o>1?void 0:o?sr(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&or(t,i,s),s};const nr=["Grand Piano","Stage Rhodes","Nylon Guitar","Cinematic Pad"],rr=["Block chords","Arpeggio","Strum","Broken (swing)"],ar=["flex-start","center","flex-end"];let z=class extends ne{constructor(){super(...arguments),this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.canAddSection=!0,this.playing=!1,this.progressStep=0,this.totalSteps=0,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.isBookmarked=!1,this.embedded=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.snapProgress=!1,this.saveModalVisible=!1,this.mascot=ni(.5),this.mascotAlign=ri([...ar]),this.eggCounter=new Ao,this.paradeTrigger=0}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1}))}selectSection(e){this.dispatchEvent(new CustomEvent("select-section",{detail:e,bubbles:!0,composed:!0}))}addSection(){this.canAddSection&&this.dispatchEvent(new CustomEvent("add-section",{bubbles:!0,composed:!0}))}backToProgression(){this.dispatchEvent(new CustomEvent("back-to-progression",{bubbles:!0,composed:!0}))}render(){const e=this.sections[0]?.progression.genre??"Pop",t=this.instrument??ss(e),i=this.playStyle??ns(e),o=this.totalSteps||this.sections.reduce((l,h)=>l+h.order.length,0),s=!this.playing||o<=0?0:this.snapProgress?this.progressStep/o*100:(this.progressStep+1)/o*100,n=le.filter(l=>l.name!==t);let r=nr.filter(l=>n.some(h=>h.name===l));const c=n.filter(l=>!r.includes(l.name)),d=this.expandedAllInstruments?n:n.filter(l=>r.includes(l.name)),p=$e.filter(l=>l.name!==i);let g=rr.filter(l=>p.some(h=>h.name===l));const a=p.filter(l=>!g.includes(l.name)),v=this.expandedAllPlayStyles?p:p.filter(l=>g.includes(l.name)),b=this.sections[this.playing?this.activePlayingSectionIdx:0]||this.sections[0],f=b?Ie(b.progression.mood):"#C9A9E0";return u`
      <div class="frame" style="${this.embedded?"padding: 10px 0 30px;":""}">
        ...
        <div class="content">
          ...
          <div class="section-list">
            ${this.sections.map((l,h)=>{const m=this.playing?h===this.activePlayingSectionIdx:h===this.activeSectionIdx,y=Ie(l.progression.mood);return u`
                <div class="section-row ${m?"active":""}" style=${m?`--ring-color:${y}`:""} @click=${()=>this.selectSection(h)}>
                  ...
                  <div class="section-chips">
                    ${l.order.map(k=>{const w=l.progression.chords[k],E=Z(w.tension);return u`<div class="section-chip" style="background:${E.color};border-radius:${Math.round(E.radius*.4)}px;" title="${w.name}"></div>`})}
                  </div>
                </div>
              `})}
            ...
            <div class="transport">
              ...
              <div class="progress-track">
                <div
                  ...
                  style="width:${s}%;background:${f};--progress-duration:${ks}ms"
                ></div>
              </div>
              ${this.isAuthenticated?u`
  ...
  `;R([I({type:Array})],z.prototype,"sections",2);R([I({type:Number})],z.prototype,"activeSectionIdx",2);R([I({type:Number})],z.prototype,"activePlayingSectionIdx",2);R([I({type:Boolean})],z.prototype,"canAddSection",2);R([I({type:Boolean})],z.prototype,"playing",2);R([I({type:Number})],z.prototype,"progressStep",2);R([I({type:Number})],z.prototype,"totalSteps",2);R([I({type:String})],z.prototype,"instrument",2);R([I({type:String})],z.prototype,"playStyle",2);R([I({type:Boolean})],z.prototype,"isAuthenticated",2);R([I({type:Boolean})],z.prototype,"isBookmarked",2);R([I({type:Boolean})],z.prototype,"embedded",2);R([x()],z.prototype,"expandedInstrument",2);R([x()],z.prototype,"expandedPlayStyle",2);R([x()],z.prototype,"expandedAllInstruments",2);R([x()],z.prototype,"expandedAllPlayStyles",2);R([x()],z.prototype,"snapProgress",2);R([x()],z.prototype,"saveModalVisible",2);R([x()],z.prototype,"mascot",2);R([x()],z.prototype,"mascotAlign",2);R([x()],z.prototype,"paradeTrigger",2);z=R([re("song-screen")],z);var lr=Object.defineProperty,cr=Object.getOwnPropertyDescriptor,de=(e,t,i,o)=>{for(var s=o>1?void 0:o?cr(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&lr(t,i,s),s};const ji={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},dr=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],_i={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},Gi={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},Vi={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},Ve={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}},pr=[4,9,2,7,11,4],qi=[7,0,4,9];let te=class extends ne{constructor(){super(...arguments),this.order=[0,1,2,3],this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.embedded=!1,this.playInstrument="Piano",this.showDegrees=!1,this.activeChordIndex=null}parseChord(e){const t=/^([A-G][b#]?)(.*)$/.exec(e||"C"),i=t?t[1]:"C",o=t?t[2]:"",s=_i[o]||_i[Vi[o]||"maj"]||[0,4,7];return{root:i,rootPc:ji[i]===void 0?0:ji[i],q:o,intervals:s}}shapeQual(e){const t=e===""?"maj":e;if(Ve[5][t]||Ve[6][t])return t;const i=Vi[t];return i&&(Ve[5][i]||Ve[6][i])?i:"maj"}guitarVoicing(e){const t=this.parseChord(e),i=this.shapeQual(t.q),o=[];return[[6,4],[5,9]].forEach(([s,n])=>{const r=Ve[s][i];if(!r)return;const c=((t.rootPc-n)%12+12)%12;o.push({rootFret:c,frets:r.map(d=>d===null?null:d+c)})}),o.length?(o.sort((s,n)=>s.rootFret-n.rootFret),o[0].frets):null}ukeVoicing(e){const t=this.parseChord(e),i=qi,o=t.intervals.map(c=>(t.rootPc+c)%12),s=c=>{const d=new Set(c);let p=null;const g=[],a=v=>{if(v===4){const b=g.map((m,y)=>(i[y]+m)%12);for(const m of d)if(b.indexOf(m)<0)return;for(const m of b)if(!d.has(m))return;const f=g.filter(m=>m>0),l=f.length?Math.max(...f)-Math.min(...f):0;if(l>3)return;const h=l*12+g.reduce((m,y)=>m+y,0);(!p||h<p.score)&&(p={frets:g.slice(),score:h});return}for(let b=0;b<=5;b++)g.push(b),a(v+1),g.pop()};return a(0),p},n=s(o);if(n)return n.frets;const r=s(t.intervals.filter(c=>c!==7).map(c=>(t.rootPc+c)%12));return r?r.frets:null}degOf(e,t){return Gi[((e-t)%12+12)%12]||"1"}notesLineFor(e){return e.intervals.map(t=>{const i=dr[(e.rootPc+t)%12];return this.showDegrees?`${i} (${this.degOf((e.rootPc+t)%12,e.rootPc)})`:i}).join(" · ")}onChordClick(e){this.activeChordIndex=e,this.dispatchEvent(new CustomEvent("chord-preview",{detail:e,bubbles:!0,composed:!0})),setTimeout(()=>{this.activeChordIndex===e&&(this.activeChordIndex=null)},450)}onBackClick(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}renderPianoSvg(e,t){const n=[0,2,4,5,7,9,11],r=this.parseChord(e),c=[],d=[],p=[];for(let a=0;a<2;a++)n.forEach((v,b)=>{c.push({x:(a*7+b)*22,w:22-1.5,h:86})});for(let a=0;a<2;a++)[0,1,3,4,5].forEach(v=>{const b=a*7+v;d.push({x:b*22+22*.64,w:22*.58,h:52})});r.intervals.forEach(a=>{const v=r.rootPc+a,b=Math.floor(v/12),f=v%12,l=n.indexOf(f),h=a===0,m=h?"#F2735F":t,y=this.showDegrees&&Gi[a%12]||"";if(l>=0){const k=b*7+l;p.push({cx:k*22+(22-1.5)/2,cy:67,r:9,fill:m,label:y,lc:h?"#FBF3E6":"#2E271F"})}else{const w=(b*7+n.indexOf(f-1))*22+22*.64,E=22*.58;p.push({cx:w+E/2,cy:38,r:7.5,fill:m,label:y,lc:h?"#FBF3E6":"#2E271F"})}});const g=14*22;return u`
    ...
    `}renderFretSvg(e,t){const r=this.parseChord(e),c=t?qi:pr,d=t?this.ukeVoicing(e)||[null,null,null,null]:this.guitarVoicing(e)||[null,null,null,null,null,null],p=c.length,g=d.filter(w=>w!==null&&w>0),a=g.length&&Math.max(...g)>4?Math.min(...g)-1:0,v=[],b=[],f=[],l=[],h=[];for(let w=0;w<p;w++)v.push({x:w*18});for(let w=0;w<=4;w++)b.push({y:16+w*24,sw:w===0&&a===0?3:1.2});d.forEach((w,E)=>{const O=E*18;if(w===null){h.push({x:O});return}if(w===0){l.push({x:O});return}const _=((c[E]+w-r.rootPc)%12+12)%12;f.push({cx:O,cy:16+(w-a-.5)*24,fill:_===0?"#F2735F":"#2E271F",label:this.showDegrees?this.degOf((c[E]+w)%12,r.rootPc):""})});const m=(p-1)*18+26,y=16+4*24+12,k=(p-1)*18;return{posLabel:a>0?`${a+1}fr`:"",svg:u`
      ...
      `}}render(){if(!this.progression)return u``;const e=Ie(this.progression.mood);this.style.setProperty("--active-mood-color",e);const t=this.order.map(s=>this.progression.chords[s]||this.progression.chords[0]),i=this.playInstrument==="Piano",o=i?"One voicing per chord, root position — the red dot is the root, play left to right.":"Exact voicings including 7ths — the red dot is the root, ○ is an open string, × is muted.";return u`
      ${this.embedded?"":u`
        <app-header
          .isAuthenticated=${this.isAuthenticated}
          .userEmail=${this.userEmail}
      ...
      <div class="container" style="${this.embedded?"padding: 10px 0 40px;":""}">
        ...
        ${i?u`
          <div class="cards-grid piano-grid">
            ${t.map((s,n)=>{const r=this.parseChord(s.name),c=this.activeChordIndex===n;return u`
                <div
        ...
        `:u`
          <div class="cards-grid fret-grid">
            ${t.map((s,n)=>{const r=this.parseChord(s.name),c=this.renderFretSvg(s.name,this.playInstrument==="Ukulele"),d=this.activeChordIndex===n;return u`
                <div
  ...
  `;de([I({type:Object})],te.prototype,"progression",2);de([I({type:Array})],te.prototype,"order",2);de([I({type:Boolean})],te.prototype,"isAuthenticated",2);de([I({type:String})],te.prototype,"userEmail",2);de([I({type:Number})],te.prototype,"savedCount",2);de([I({type:Boolean})],te.prototype,"embedded",2);de([x()],te.prototype,"playInstrument",2);de([x()],te.prototype,"showDegrees",2);de([x()],te.prototype,"activeChordIndex",2);te=de([re("play-along-screen")],te);var hr=Object.defineProperty,ur=Object.getOwnPropertyDescriptor,_e=(e,t,i,o)=>{for(var s=o>1?void 0:o?ur(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&hr(t,i,s),s};let ve=class extends ne{constructor(){super(...arguments),this.open=!1,this.mounted=!1,this.isOAuthLoading=!1,this.errorMessage=null,this.closeTimer=null}willUpdate(e){e.has("open")&&this.open&&(this.mounted=!0)}updated(e){e.has("open")&&(this.open?(this.closeTimer&&(clearTimeout(this.closeTimer),this.closeTimer=null),this.mounted=!0,this.errorMessage=null,setTimeout(()=>{this.googleBtnContainer&&Pe.renderGoogleButton(this.googleBtnContainer,t=>{t.success?this.close():t.message&&(this.errorMessage=t.message)})},50)):this.mounted&&(this.closeTimer=setTimeout(()=>{this.mounted=!1},280)))}close(){this.errorMessage=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}async handleGoogleSignIn(){this.errorMessage=null,this.isOAuthLoading=!0;try{const e=await Pe.signInWithGoogle();e.success?this.close():e.message&&(this.errorMessage=e.message)}catch(e){const t=e instanceof Error?e.message:String(e);this.errorMessage=t||"Google sign-in failed. Please try again."}finally{this.isOAuthLoading=!1}}render(){return!this.open&&!this.mounted?u``:u`
  ...
  `;M([x()],A.prototype,"chordData",2);M([x()],A.prototype,"screen",2);M([x()],A.prototype,"libraryOpen",2);M([x()],A.prototype,"genre",2);M([x()],A.prototype,"mood",2);M([x()],A.prototype,"progression",2);M([x()],A.prototype,"activeIndex",2);M([x()],A.prototype,"progressStep",2);M([x()],A.prototype,"order",2);M([x()],A.prototype,"keyOverride",2);M([x()],A.prototype,"scaleOverride",2);M([x()],A.prototype,"playing",2);M([x()],A.prototype,"showTheory",2);M([x()],A.prototype,"instrument",2);M([x()],A.prototype,"playStyle",2);M([x()],A.prototype,"sheetOpen",2);M([x()],A.prototype,"sheetMode",2);M([x()],A.prototype,"swapIndex",2);M([x()],A.prototype,"alternatives",2);M([x()],A.prototype,"theoryGroups",2);M([x()],A.prototype,"borrowedChords",2);M([x()],A.prototype,"length",2);M([x()],A.prototype,"sections",2);M([x()],A.prototype,"activeSectionIdx",2);M([x()],A.prototype,"activePlayingSectionIdx",2);M([x()],A.prototype,"totalSongSteps",2);M([x()],A.prototype,"pendingChordSuggestion",2);M([x()],A.prototype,"userEmail",2);M([x()],A.prototype,"isAuthenticated",2);M([x()],A.prototype,"syncStatus",2);M([x()],A.prototype,"authModalOpen",2);M([x()],A.prototype,"toastMessage",2);M([x()],A.prototype,"toastUndoId",2);M([x()],A.prototype,"isGenerating",2);A=M([re("chroma-chords-app")],A);
