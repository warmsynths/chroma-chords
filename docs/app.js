import{f as rs,u as as,n as Rt,s as Ti,G as Ve,F as Zt,E as ls,C as jt,V as cs,D as ds,l as ps,S as ae,a as Ei,P as H,b as Le,M as Ni,R as Ai,c as hs,i as ie,d as se,e as u,A as Mi,O as us,w as L}from"./assets/vendor-UNJlRQ4n.js";import"https://warmsynths.github.io/human-midi/human-engine.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gs={attribute:!0,type:String,converter:as,reflect:!1,hasChanged:rs},ms=(e=gs,t,i)=>{const{kind:s,metadata:o}=i;let n=globalThis.litPropertyMetadata.get(o);if(n===void 0&&globalThis.litPropertyMetadata.set(o,n=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(i.name,e),s==="accessor"){const{name:r}=i;return{set(c){const d=t.get.call(this);t.set.call(this,c),this.requestUpdate(r,d,e,!0,c)},init(c){return c!==void 0&&this.C(r,void 0,e,c),c}}}if(s==="setter"){const{name:r}=i;return function(c){const d=this[r];t.call(this,c),this.requestUpdate(r,d,e,!0,c)}}throw Error("Unsupported decorator location: "+s)};function $(e){return(t,i)=>typeof i=="object"?ms(e,t,i):((s,o,n)=>{const r=o.hasOwnProperty(n);return o.constructor.createProperty(n,s),r?Object.getOwnPropertyDescriptor(o,n):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function x(e){return $({...e,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fs=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Oi(e,t){return(i,s,o)=>{const n=r=>r.renderRoot?.querySelector(e)??null;return fs(i,s,{get(){return n(this)}})}}const $e="chroma_chords_projects",vs="chord_voyager_projects";class Ce{static getProjects(){if(typeof localStorage>"u"||typeof localStorage.getItem!="function")return[];try{let t=localStorage.getItem($e);if(t||(t=localStorage.getItem(vs),t&&localStorage.setItem($e,t)),t){const i=JSON.parse(t);let s=!1;return i.forEach(o=>{(o.genre==="Unknown"||!o.genre)&&(o.genre="Pop",s=!0),Array.isArray(o.chords)||(o.chords=[],s=!0)}),s&&localStorage.setItem($e,JSON.stringify(i)),i}}catch(t){console.error("Failed to load projects from localStorage:",t)}return[]}static setProjects(t){if(!(typeof localStorage>"u"||typeof localStorage.setItem!="function"))try{localStorage.setItem($e,JSON.stringify(t))}catch(i){console.error("Failed to set projects to localStorage:",i)}}static mergeProjects(t,i){const s=new Map;return t.forEach(o=>s.set(o.id,o)),i.forEach(o=>{const n=s.get(o.id);!n||o.lastModified>n.lastModified?s.set(o.id,o):o.lastModified===n.lastModified&&(n.syncedToCloud=!0)}),Array.from(s.values())}static saveProject(t){const i=this.getProjects(),s=i.findIndex(o=>o.id===t.id);t.lastModified=Date.now(),s>=0?i[s]=t:i.push(t);try{localStorage.setItem($e,JSON.stringify(i))}catch(o){console.error("Failed to save project to localStorage:",o)}}static deleteProject(t){let i=this.getProjects();i=i.filter(s=>s.id!==t);try{localStorage.setItem($e,JSON.stringify(i))}catch(s){console.error("Failed to delete project from localStorage:",s)}}static exportProjectFile(t){const i=JSON.stringify(t,null,2),s=new Blob([i],{type:"application/json"}),o=URL.createObjectURL(s),n=document.createElement("a");n.href=o,n.download=`${t.name.replace(/[^a-z0-9]/gi,"_").toLowerCase()}_chroma_chords.json`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(o)}static importProjectFile(t){return new Promise((i,s)=>{const o=new FileReader;o.onload=n=>{try{const r=n.target?.result,c=JSON.parse(r);c&&typeof c=="object"&&Array.isArray(c.chords)?(c.id=Math.random().toString(36).substr(2,9),c.lastModified=Date.now(),i(c)):s(new Error("Invalid project file format"))}catch{s(new Error("Failed to parse JSON file"))}},o.onerror=()=>s(new Error("Failed to read file")),o.readAsText(t)})}}const qe="chroma_chords_auth_token",it="chroma_chords_auth_user",bs="184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com";function st(e){try{const t=e.split(".");if(t.length!==3)return null;let i=t[1].replace(/-/g,"+").replace(/_/g,"/");for(;i.length%4!==0;)i+="=";let s="";if(typeof atob=="function")s=atob(i);else if(typeof Buffer<"u")s=Buffer.from(i,"base64").toString("binary");else return null;const o=decodeURIComponent(s.split("").map(n=>"%"+("00"+n.charCodeAt(0).toString(16)).slice(-2)).join(""));return JSON.parse(o)}catch{return null}}function xs(){try{return"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com"}catch{return bs}}class ys{constructor(t){this.currentUser=null,this.currentAccessToken=null,this.isLoading=!0,this.listeners=new Set,this.gisLoaded=!1,this.clientId=t!==void 0?t:xs(),this.initSession()}initSession(){if(typeof window>"u"||typeof localStorage>"u"||typeof localStorage.getItem!="function"){this.isLoading=!1;return}try{const t=localStorage.getItem(qe);if(t){const i=st(t);i&&i.exp&&i.exp*1e3>Date.now()?(this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture}):(localStorage.removeItem(qe),localStorage.removeItem(it),this.currentAccessToken=null,this.currentUser=null)}}catch(t){console.warn("Failed to restore auth session from localStorage:",t)}finally{this.isLoading=!1}}isConfigured(){return!!this.clientId}getAuthState(){return{user:this.currentUser,accessToken:this.currentAccessToken,isAuthenticated:!!this.currentUser&&!!this.currentAccessToken,isLoading:this.isLoading}}getUser(){return this.currentUser}async getAccessToken(){if(this.currentAccessToken){const t=st(this.currentAccessToken);if(t&&t.exp&&t.exp*1e3<=Date.now())return await this.signOut(),null}return this.currentAccessToken}subscribe(t){return this.listeners.add(t),t(this.getAuthState()),()=>{this.listeners.delete(t)}}notify(){const t=this.getAuthState();this.listeners.forEach(i=>{try{i(t)}catch(s){console.error("Error in AuthState listener:",s)}})}handleCredentialResponse(t){if(!t||typeof t!="string")return{success:!1,message:"Invalid credential provided."};const i=st(t);if(!i||!i.sub)return{success:!1,message:"Failed to decode Google user token."};if(i.exp&&i.exp*1e3<=Date.now())return{success:!1,message:"Google session token has expired."};this.currentAccessToken=t,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture};try{typeof localStorage<"u"&&(localStorage.setItem(qe,t),localStorage.setItem(it,JSON.stringify(this.currentUser)))}catch(s){console.warn("Failed to persist auth session to localStorage:",s)}return this.notify(),{success:!0,user:this.currentUser}}async loadGisScript(){return typeof window>"u"?!1:window.google?.accounts?.id?(this.gisLoaded=!0,!0):new Promise(t=>{const i=document.querySelector('script[src*="accounts.google.com/gsi/client"]');if(i){i.addEventListener("load",()=>{this.gisLoaded=!0,t(!0)}),i.addEventListener("error",()=>t(!1));return}const s=document.createElement("script");s.src="https://accounts.google.com/gsi/client",s.async=!0,s.defer=!0,s.onload=()=>{this.gisLoaded=!0,t(!0)},s.onerror=()=>t(!1),document.head.appendChild(s)})}async renderGoogleButton(t,i){if(!this.clientId||typeof window>"u"||!t)return;await this.loadGisScript();const s=window.google;if(s?.accounts?.id)try{s.accounts.id.initialize({client_id:this.clientId,callback:o=>{if(o.credential){const n=this.handleCredentialResponse(o.credential);i?.({success:n.success,message:n.message})}else i?.({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.innerHTML="",s.accounts.id.renderButton(t,{theme:"outline",size:"large",type:"standard",shape:"pill",text:"continue_with",logo_alignment:"left",width:320})}catch(o){console.warn("Failed to render Google button:",o)}}async signInWithGoogle(){if(!this.clientId)return{success:!1,message:"Google Client ID is not configured."};if(typeof window>"u")return{success:!1,message:"Window is not available in current environment."};await this.loadGisScript();const t=window.google;return t?.accounts?.id?new Promise(i=>{try{t.accounts.id.initialize({client_id:this.clientId,callback:s=>{if(s.credential){const o=this.handleCredentialResponse(s.credential);i({success:o.success,message:o.message})}else i({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),t.accounts.id.prompt(s=>{(s.isNotDisplayed?.()||s.isSkippedMoment?.())&&console.info("Google prompt skipped or not displayed.")})}catch(s){const o=s instanceof Error?s.message:String(s);i({success:!1,message:o})}}):{success:!1,message:"Google Sign-In script failed to load."}}async signInWithOAuth(t="google"){return t!=="google"?{success:!1,message:`Unsupported auth provider: ${t}. Only Google is supported.`}:this.signInWithGoogle()}async signOut(){this.currentUser=null,this.currentAccessToken=null;try{typeof localStorage<"u"&&(localStorage.removeItem(qe),localStorage.removeItem(it)),typeof window<"u"&&window.google?.accounts?.id&&window.google.accounts.id.disableAutoSelect?.()}catch(t){console.warn("Error during sign out storage cleanup:",t)}return this.notify(),{success:!0}}}const Ae=new ys;class ws{formatUrl(t){let i=t.trim().replace(/\/+$/,"");return i&&!i.startsWith("http://")&&!i.startsWith("https://")&&(i="https://"+i),i}applyAuthHeaders(t,i){if(!i)return;const s=i.trim();s.toLowerCase().startsWith("bearer ")?t.Authorization=s:t.Authorization=`Bearer ${s}`}async testConnection(t,i){const s=this.formatUrl(t);if(!s)return{ok:!1,status:0,message:"Worker URL cannot be empty"};try{const o={};this.applyAuthHeaders(o,i);const n=new AbortController,r=setTimeout(()=>n.abort(),8e3),c=await fetch(`${s}/api/health`,{method:"GET",headers:o,signal:n.signal});if(clearTimeout(r),c.status===200)return{ok:!0,status:200,message:"Connected to Cloudflare Worker",timestamp:(await c.json().catch(()=>({}))).timestamp};if(c.status===401)return{ok:!1,status:401,message:"Unauthorized: Invalid or missing authorization token"};const d=await c.text().catch(()=>"");return{ok:!1,status:c.status,message:`Connection error (${c.status}): ${d||c.statusText}`}}catch(o){return o instanceof Error&&o.name==="AbortError"?{ok:!1,status:0,message:"Connection timed out (8s limit)"}:{ok:!1,status:0,message:"Network error: Unable to reach worker endpoint"}}}async sync(t,i,s){const o=this.formatUrl(t);if(!o)throw new Error("Worker URL is not configured");const n={"Content-Type":"application/json"};this.applyAuthHeaders(n,i);const r=new AbortController,c=setTimeout(()=>r.abort(),15e3),d=await fetch(`${o}/api/sync`,{method:"POST",headers:n,body:JSON.stringify(s),signal:r.signal});if(clearTimeout(c),!d.ok){let p="";try{const g=await d.json();p=g.error||g.message||""}catch{p=await d.text().catch(()=>"")}throw new Error(`Cloud sync failed (${d.status}): ${p||d.statusText||"Unknown error"}`)}return await d.json()}}const ks=new ws,ei="chroma_chords_deleted_projects",ti="chroma_chords_last_sync_time",Ss="https://chroma-chords-api.warmsynths.workers.dev";function Is(){try{return"https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev"}catch{return Ss}}function ii(e){return typeof window<"u"&&typeof localStorage<"u"?localStorage.getItem(e):null}function si(e,t){typeof window<"u"&&typeof localStorage<"u"&&localStorage.setItem(e,t)}class $s{constructor(){this.userEmail=null,this.authenticated=!1,this.isCloudSyncing=!1,this.syncTimeout=null,this.syncQueued=!1,this.syncStatus="sign-in",this.authStateCallbacks=new Set,this.projectsChangeCallbacks=new Set,this.syncStatusCallbacks=new Set,this.unsubscribeAuth=null,this.onlineHandler=null,this.offlineHandler=null,this.setupAuthSubscription(),this.setupOnlineListener()}setupAuthSubscription(){this.unsubscribeAuth=Ae.subscribe(t=>{const i=this.authenticated;this.userEmail=t.user?.email||null,this.authenticated=t.isAuthenticated,this.syncStatus=this.authenticated?"synced":"sign-in",this.notifyAuthState(),this.notifySyncStatus(),!i&&this.authenticated&&this.syncWithCloud().catch(s=>{console.warn("Auto cloud sync on sign-in encountered an error:",s)})})}setupOnlineListener(){typeof window<"u"&&typeof window.addEventListener=="function"&&(this.onlineHandler=()=>{this.isAuthenticated()&&this.scheduleCloudSync()},this.offlineHandler=()=>{this.isAuthenticated()&&(this.syncStatus="offline",this.notifySyncStatus())},window.addEventListener("online",this.onlineHandler),window.addEventListener("offline",this.offlineHandler))}destroy(){this.unsubscribeAuth&&(this.unsubscribeAuth(),this.unsubscribeAuth=null),typeof window<"u"&&typeof window.removeEventListener=="function"&&(this.onlineHandler&&(window.removeEventListener("online",this.onlineHandler),this.onlineHandler=null),this.offlineHandler&&(window.removeEventListener("offline",this.offlineHandler),this.offlineHandler=null)),this.syncTimeout&&(clearTimeout(this.syncTimeout),this.syncTimeout=null)}getUserEmail(){return this.userEmail}isAuthenticated(){return this.authenticated}get isAdmin(){return!!(this.userEmail&&this.userEmail.toLowerCase().trim()==="warmsynthsiloveyou@gmail.com")}getSyncStatus(){return this.syncStatus}subscribeSyncStatus(t){return this.syncStatusCallbacks.add(t),t(this.syncStatus),()=>this.syncStatusCallbacks.delete(t)}notifySyncStatus(){this.syncStatusCallbacks.forEach(t=>{try{t(this.syncStatus)}catch(i){console.error("Error in SyncStatus callback:",i)}})}subscribeAuthState(t){return this.authStateCallbacks.add(t),t(this.userEmail,this.authenticated),()=>this.authStateCallbacks.delete(t)}notifyAuthState(){this.authStateCallbacks.forEach(t=>{try{t(this.userEmail,this.authenticated)}catch(i){console.error("Error in AuthState callback:",i)}})}subscribeProjects(t){return this.projectsChangeCallbacks.add(t),t(this.getProjects()),()=>this.projectsChangeCallbacks.delete(t)}subscribe(t){return this.subscribeProjects(t)}notifyProjectsChanged(){const t=this.getProjects();this.projectsChangeCallbacks.forEach(i=>{try{i(t)}catch(s){console.error("Error in ProjectsChange callback:",s)}})}logout(){this.userEmail=null,this.authenticated=!1,this.syncStatus="sign-in",this.notifyAuthState(),this.notifySyncStatus()}getProjects(){return Ce.getProjects()}isProjectSaved(t){return t?Ce.getProjects().some(i=>i.id===t):!1}saveProject(t){Ce.saveProject(t),this.removeTombstone(t.id),this.notifyProjectsChanged(),this.scheduleCloudSync()}deleteProject(t){Ce.deleteProject(t),this.addTombstone(t),this.notifyProjectsChanged(),this.scheduleCloudSync()}getTombstones(){const t=ii(ei);if(!t)return[];try{return JSON.parse(t)}catch{return[]}}setTombstones(t){si(ei,JSON.stringify(t))}addTombstone(t){const i=this.getTombstones(),s=i.findIndex(n=>n.id===t),o=new Date().toISOString();s>=0?i[s].deletedAt=o:i.push({id:t,deletedAt:o}),this.setTombstones(i)}removeTombstone(t){const i=this.getTombstones().filter(s=>s.id!==t);this.setTombstones(i)}getLastSyncTime(){return ii(ti)}setLastSyncTime(t){si(ti,t)}scheduleCloudSync(){this.syncTimeout&&clearTimeout(this.syncTimeout),this.syncTimeout=setTimeout(()=>{this.syncTimeout=null,this.isCloudSyncing?this.syncQueued=!0:this.syncWithCloud().catch(t=>{console.warn("Scheduled cloud sync failed:",t)})},2e3)}async syncWithCloud(t){if(this.isCloudSyncing){this.syncQueued=!0;return}const i=await Ae.getAccessToken();if(!this.isAuthenticated()||!i)return;const s=t||Is();if(s){this.isCloudSyncing=!0,this.syncStatus="syncing",this.notifySyncStatus();try{const o=Ce.getProjects(),n=this.getTombstones(),r=this.getLastSyncTime(),c=o.map(h=>({...h,deletedAt:null})),d=await ks.sync(s,i,{sets:c,lastSyncTime:r,tombstones:n}),p=new Map;o.forEach(h=>{p.set(h.id,{...h,syncedToCloud:!0})});const g=d.tombstones||[],l=new Set(g.map(h=>h.id));(d.sets||[]).forEach(h=>{if(h.deletedAt)l.add(h.id);else{const m=p.get(h.id),y=h.lastModified||(h.updatedAt?new Date(h.updatedAt).getTime():0),w=m?.lastModified||0;(!m||y>=w)&&p.set(h.id,{id:h.id,name:h.name,lastModified:y,genre:h.genre,mood:h.mood,key:h.key,scaleType:h.scaleType,bpm:h.bpm,showTheory:h.showTheory,chords:Array.isArray(h.chords)?h.chords:[],syncedToCloud:!0})}}),l.forEach(h=>{p.delete(h)});const v=Array.from(p.values());Ce.setProjects(v);const b=this.getTombstones(),f=new Set(n.map(h=>h.id)),a=b.filter(h=>!f.has(h.id));this.setTombstones(a),(d.lastSyncTime||d.syncedAt)&&this.setLastSyncTime(d.lastSyncTime||d.syncedAt),this.syncStatus="synced",this.notifySyncStatus(),this.notifyProjectsChanged()}catch(o){console.warn("Cloud sync encountered an error, transitioning to offline status:",o),this.syncStatus="offline",this.notifySyncStatus()}finally{this.isCloudSyncing=!1,this.syncQueued&&(this.syncQueued=!1,this.scheduleCloudSync())}}}async syncProjectsFromCloud(){return this.syncWithCloud()}async syncProjectsToCloud(){return this.syncWithCloud()}}const F=new $s;let ot=null,nt=null,rt=null,oi=null,at=null,lt=null,ct=null,dt=null,pt=null,ht=null,ut=null;function Di(){return ot||(ot=new Ei({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination()),ot}let Ye="Warm",Te=null,gt=null,ve=null,mt=null,He=null,be=null,ft=null,vt=null,bt=null,xe=null;function _t(){if(!Te){Te=new Ve(1);const e=Di();gt=new Zt({frequency:3200,type:"lowpass",rolloff:-12}),ve=new Ve(1),gt.connect(ve),ve.connect(e),Te.connect(gt),mt=new ls({high:3.5,mid:0,low:-.5,highFrequency:4500}),He=new jt({frequency:1.5,delayTime:3,depth:.35,wet:.3});try{He.start()}catch{}be=new Ve(0),mt.connect(He),He.connect(be),be.connect(e),Te.connect(mt),ft=new Zt({frequency:1800,type:"bandpass",Q:.8}),vt=new cs({frequency:.5,depth:.1,wet:.4}),bt=new ds({distortion:.1,wet:.15}),xe=new Ve(0),ft.connect(vt),vt.connect(bt),bt.connect(xe),xe.connect(e),Te.connect(ft)}return Te}function Ne(e){_t();const t=e?e.toLowerCase().trim():"warm";Ye=t==="glassy"?"Glassy":t==="dusty"?"Dusty":"Warm";const i=.05,s=Rt();try{ve&&be&&xe&&(Ye==="Warm"?(ve.gain.rampTo(1,i,s),be.gain.rampTo(0,i,s),xe.gain.rampTo(0,i,s)):Ye==="Glassy"?(ve.gain.rampTo(0,i,s),be.gain.rampTo(1,i,s),xe.gain.rampTo(0,i,s)):Ye==="Dusty"&&(ve.gain.rampTo(0,i,s),be.gain.rampTo(0,i,s),xe.gain.rampTo(1,i,s)))}catch(o){console.warn("Failed to ramp master tone:",o)}}function Cs(){return nt||(nt=new hs({urls:{F1:"A_029__F1_5.m4a",B1:"A_035__B1_5.m4a",E2:"A_040__E2_5.m4a",A2:"A_045__A2_5.m4a",D3:"A_050__D3_5.m4a",G3:"A_055__G3_5.m4a",B3:"A_059__B3_5.m4a",D4:"A_062__D4_5.m4a",F4:"A_065__F4_5.m4a",B4:"A_071__B4_5.m4a",E5:"A_076__E5_5.m4a",A5:"A_081__A5_5.m4a",D6:"A_086__D6_5.m4a",G6:"A_091__G6_5.m4a"},baseUrl:"https://danigb.github.io/samples/jlearman/rhodes-mki/jRhodes3d-mono/",volume:-12,onload:()=>{console.log("Rhodes piano sampler loaded successfully!")},onerror:e=>{console.warn("Failed to load Rhodes piano sampler:",e)}}).connect(_t())),nt}function Ts(e){const t=_t();switch(e){case"organ":return rt||(rt=new H(ae,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(t)),rt;case"pad-strings":return at||(oi=new Ai({decay:4.5,wet:.35}).connect(t),at=new H(ae,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(oi)),at;case"juno-pad":if(!ct){lt=new jt({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).connect(t);try{lt.start()}catch{}ct=new H(ae,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(lt)}return ct;case"stab":return dt||(dt=new H(Ni,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(t)),dt;case"epiano":return pt||(pt=new H(Le,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(t)),pt;case"guitar":return ht||(ht=new H(ae,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(t)),ht;case"bell":return ut||(ut=new H(Le,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(t)),ut;case"rhodes":default:return Cs()}}const ke=[{name:"Piano",instrument:"rhodes",color:"#9CC0EC"},{name:"Rhodes",instrument:"epiano",color:"#F2A79B"},{name:"Nylon Guitar",instrument:"guitar",color:"#F6D98B"},{name:"Warm Pad",instrument:"pad-strings",color:"#C9A9E0"},{name:"Synth Bell",instrument:"bell",color:"#B8CC9E"},{name:"Drawbar Organ",instrument:"organ",color:"#E8609A"},{name:"Analog Synth",instrument:"juno-pad",color:"#7B61FF"},{name:"Synth Stab",instrument:"stab",color:"#FF8C42"}],Se=[{name:"Block chords",color:"#F2A79B",patch:{arpMode:"off",spread:.3}},{name:"Arpeggio",color:"#9CC0EC",patch:{arpMode:"up",arpRate:"1/8",arpRange:1}},{name:"Strum",color:"#F6D98B",patch:{arpMode:"up",arpRate:"1/32",arpRange:1}},{name:"Broken (swing)",color:"#C9A9E0",patch:{arpMode:"up",arpRate:"1/8T",arpRange:1}},{name:"Half-time",color:"#B8CC9E",patch:{arpMode:"off",spread:.1,durationMultiplier:1.8}},{name:"Descending Arp",color:"#7B61FF",patch:{arpMode:"down",arpRate:"1/8",arpRange:1}},{name:"Off-beat / Ska",color:"#FF8C42",patch:{arpMode:"off",spread:.1,microTiming:.8}},{name:"Fast Triplet",color:"#7CD9B6",patch:{arpMode:"up",arpRate:"1/16T",arpRange:1}}],Gt={Pop:"rhodes",Rock:"rhodes","Indie/Folk":"rhodes","Lo-fi/Chill":"rhodes","Jazz-ish":"rhodes","R&B/Soul":"rhodes",Gospel:"organ",Cinematic:"pad-strings",Synthwave:"juno-pad","House/Dance":"stab",Blues:"rhodes","Funk/Disco":"epiano","Country/Bluegrass":"guitar","Reggae/Dub":"organ",Metal:"stab",Punk:"stab","Ambient/Drone":"pad-strings","Trap/Hip-Hop":"epiano","Bossa Nova/Latin":"guitar","Classical/Orchestral":"pad-strings","EDM/Trance":"juno-pad",Afrobeats:"epiano",Shoegaze:"pad-strings"},Vt={Pop:{minVelocity:90,maxVelocity:110,spread:.5,microTiming:.3,humanVariance:.3,duration:1},Rock:{minVelocity:105,maxVelocity:127,spread:.2,microTiming:.1,humanVariance:.15,duration:.9},"Indie/Folk":{minVelocity:80,maxVelocity:105,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},"Lo-fi/Chill":{minVelocity:55,maxVelocity:85,spread:2.5,microTiming:1.2,humanVariance:.8,duration:1.4,arpMode:"up",arpRate:"1/8",arpRange:1},"Jazz-ish":{minVelocity:70,maxVelocity:100,spread:1.8,microTiming:1,humanVariance:.6,duration:1.2,arpMode:"up",arpRate:"1/8T",arpRange:1},"R&B/Soul":{minVelocity:75,maxVelocity:105,spread:1.2,microTiming:.6,humanVariance:.5,duration:1.3},Gospel:{minVelocity:95,maxVelocity:120,spread:.4,microTiming:.2,humanVariance:.2,duration:1.5},Cinematic:{minVelocity:60,maxVelocity:90,spread:0,microTiming:0,humanVariance:.1,duration:2.2},Synthwave:{minVelocity:70,maxVelocity:95,spread:0,microTiming:0,humanVariance:.1,duration:1.8},"House/Dance":{minVelocity:100,maxVelocity:127,spread:0,microTiming:.1,humanVariance:.15,duration:.5},Blues:{minVelocity:80,maxVelocity:110,spread:1.4,microTiming:.7,humanVariance:.5,duration:1.2},"Funk/Disco":{minVelocity:95,maxVelocity:125,spread:.3,microTiming:.2,humanVariance:.2,duration:.8},"Country/Bluegrass":{minVelocity:85,maxVelocity:115,spread:1,microTiming:.4,humanVariance:.3,duration:1},"Reggae/Dub":{minVelocity:70,maxVelocity:100,spread:2,microTiming:1,humanVariance:.6,duration:1.3},Metal:{minVelocity:110,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:.8},Punk:{minVelocity:115,maxVelocity:127,spread:.1,microTiming:.1,humanVariance:.1,duration:.7},"Ambient/Drone":{minVelocity:45,maxVelocity:75,spread:0,microTiming:0,humanVariance:.05,duration:3},"Trap/Hip-Hop":{minVelocity:90,maxVelocity:120,spread:.2,microTiming:.2,humanVariance:.2,duration:1},"Bossa Nova/Latin":{minVelocity:75,maxVelocity:105,spread:1.5,microTiming:.8,humanVariance:.5,duration:1.1,arpMode:"up",arpRate:"1/8T",arpRange:1},"Classical/Orchestral":{minVelocity:50,maxVelocity:115,spread:.5,microTiming:.3,humanVariance:.3,duration:2},"EDM/Trance":{minVelocity:95,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:1.2},Afrobeats:{minVelocity:85,maxVelocity:115,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},Shoegaze:{minVelocity:65,maxVelocity:95,spread:.8,microTiming:.4,humanVariance:.3,duration:2.5}},Es={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Warm Pad",bell:"Synth Bell",organ:"Piano",stab:"Nylon Guitar"};function Ns(e){const t=Gt[e]??"rhodes";return Es[t]??"Piano"}function As(e){return(Vt[e]?.arpMode??"off")==="off"?"Block chords":"Arpeggio"}function Bi(){return Promise.race([ps(),new Promise(e=>setTimeout(e,80))])}function Fi(e,t){const i=t/60;switch(e){case"1/4":return 1/i;case"1/8":return .5/i;case"1/8T":return .5/i*(2/3);case"1/16":return .25/i;case"1/32":return .125/i;default:return .25/i}}function Pi(e,t){const i=[];for(let s=0;s<t;s++)for(const o of e){const n=o.match(/^([A-G]#?)(-?\d+)$/);if(n){const r=n[1],c=parseInt(n[2],10)+s;i.push(`${r}${c}`)}else i.push(o)}return i}function zi(e,t){const i=[...e];switch(t){case"up":return i;case"down":return[...i].reverse();case"up-down":return[...i,...[...i].reverse().slice(1,-1)];case"random":return i.sort(()=>Math.random()-.5);default:return i}}const ni={rhodes:"Piano",epiano:"Rhodes",guitar:"Nylon Guitar","pad-strings":"Warm Pad","juno-pad":"Analog Synth",bell:"Synth Bell",organ:"Drawbar Organ",stab:"Synth Stab"};function Ms(e){if(!e)return;const t=e.toLowerCase().trim();return ni[t]?ni[t]:ke.find(s=>s.name.toLowerCase()===t||s.instrument.toLowerCase()===t)?.name}function Os(e){if(!e)return;const t=e.toLowerCase().trim();return t.includes("strum")?"Strum":t.includes("descend")?"Descending Arp":t.includes("half")?"Half-time":t.includes("swing")||t.includes("broken")?"Broken (swing)":t.includes("offbeat")||t.includes("ska")||t.includes("syncopat")||t.includes("groove")?"Off-beat / Ska":t.includes("triplet")||t.includes("fast")?"Fast Triplet":t.includes("arp")||t.includes("cascade")?"Arpeggio":t.includes("block")||t.includes("pad")||t.includes("sustained")?"Block chords":Se.find(s=>s.name.toLowerCase()===t)?.name??"Block chords"}function Ds(e,t=.7,i,s="rhodes",o){try{Promise.all([Ti(),Bi()]).then(()=>{const n=Ts(s);if(o&&typeof o=="object"&&Object.keys(o).length>0)try{typeof n.set=="function"&&n.set(o)}catch(p){console.warn("Failed to apply customConfig to Tone.js instrument:",p)}const r=e.length,c=r<=1?1:Math.max(.4,1/Math.sqrt(r)),d=Rt();if(i&&i.arpMode&&i.arpMode!=="off"){const p=i.bpm??80,g=i.arpRate??"1/16",l=i.arpRange??1,v=i.arpMode,b=Fi(g,p),f=Pi(e,l),a=zi(f,v),h=()=>i.minVelocity!==void 0&&i.maxVelocity!==void 0?(i.minVelocity+Math.random()*(i.maxVelocity-i.minVelocity))/127*c:c,m=i.duration?i.duration*(1+(Math.random()-.5)*.1*(i.humanVariance??0)):Math.max(.05,b*.9);a.forEach((y,w)=>{const k=i.microTiming?(Math.random()-.5)*i.microTiming*.02:0;n.triggerAttackRelease(y,m,d+w*b+k,h())});return}e.forEach((p,g)=>{let l=0,v=c,b=t;if(i){const{minVelocity:f,maxVelocity:a,spread:h,microTiming:m,humanVariance:y,duration:w}=i;v=(typeof i.velocity=="number"?Math.min(1,Math.max(.1,i.velocity/127)):(f+Math.random()*(a-f))/127)*c;const D=g*h*.1,B=(Math.random()-.5)*m*.05,_=(Math.random()-.5)*y*.03;l=Math.max(0,D+B+_),b=w*(1+(Math.random()-.5)*.2*y)}n.triggerAttackRelease(p,b,d+l,v)})}).catch(n=>{console.warn("Audio playback gesture failed:",n)})}catch(n){console.warn("Audio playback failed:",n)}}function Bs(e,t){if(!Array.isArray(e)||e.length===0)return[];if(e.length<=1)return e;if(t<=25)return e.length<=2?e:[e[0],e[e.length-1]];if(t<=55)return e.length<=4?e:e.slice(0,4);if(t<=80)return e;const i=[...e],o=e[e.length-1].match(/^([A-G]#?)(-?\d+)$/);if(o){const n=parseInt(o[2],10);i.push(`${o[1]}${n+1}`)}return i}function ri(e,t,i){const s=t==="Unknown"||!t?"Pop":t,o=i?.instrument?ke.find(a=>a.name===i.instrument):void 0,n=i?.playStyle?Se.find(a=>a.name===i.playStyle):void 0,r=o?.instrument??Gt[s]??"rhodes",c=Vt[s]||{},d=n?.patch??{};i?.feelSettings?.tone&&Ne(i.feelSettings.tone);const p={};if(i?.feelSettings){const{spread:a,swing:h,humanState:m}=i.feelSettings;m?Object.assign(p,m):(typeof a=="number"&&(p.spread=parseFloat((a/100*1.5).toFixed(2))),typeof h=="number"&&(p.microTiming=parseFloat((h/100*.9).toFixed(2)),p.humanVariance=parseFloat((h/100*.6).toFixed(2))))}const g={...c,...d,...p,bpm:i?.bpm??c.bpm??90,...typeof i?.velocity=="number"?{velocity:i.velocity}:{}},l=i?.duration??c.duration??.9,v=d.durationMultiplier?l*d.durationMultiplier:l,b=i?.feelSettings?.density??50,f=Bs(e,b);Ds(f,v,g,r,i?.customConfig)}let xt=null;function Fs(){if(!xt){const e=Di();xt=new ae({oscillator:{type:"sine"},envelope:{attack:.02,decay:.25,sustain:.85,release:.4},volume:-7}).connect(e)}return xt}function Ps(e,t=.8,i,s=.85){try{Promise.all([Ti(),Bi()]).then(()=>{const o=Fs(),r=`${e.replace(/\d+$/,"")}1`,c=typeof i=="number"?i:Rt();o.triggerAttackRelease(r,t,c,s)}).catch(o=>console.warn("Sub bass audio failed:",o))}catch(o){console.warn("Sub bass audio failed:",o)}}function zs(e,t="root position"){const i={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},s=4,o=(Array.isArray(e)?e:[]).filter(p=>typeof p=="string"&&p.trim().length>0).map(p=>p.replace(/\d+$/,""));if(o.length===0)return["C4","E4","G4"];let n=s,r=i[o[0]]??0;const c=[];o.forEach((p,g)=>{const l=i[p]??0;g>0&&l<=r&&n++,c.push({name:p,oct:n}),r=l});const d=(t||"").toLowerCase();if(d.includes("octave")||d.includes("high"))return c.map(p=>`${p.name}${p.oct+1}`);if(d.includes("inversion")||d.includes("1st")){if(c.length>1){const[p,...g]=c;return[...g.map(l=>`${l.name}${l.oct}`),`${p.name}${p.oct+1}`]}return c.map(p=>`${p.name}${p.oct}`)}else return c.map(p=>`${p.name}${p.oct}`)}const Us=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],Ls=["C","Db","D","Eb","E","F","Gb","G","Ab","A","Bb","B"],P={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},Rs=new Set(["F","Bb","Eb","Ab","Db","Gb"]),je=["C","Db","D","Eb","E","F","F#","G","Ab","A","Bb","B"],ne={maj:[0,4,7],min:[0,3,7],dim:[0,3,6],aug:[0,4,8],dom7:[0,4,7,10],min7:[0,3,7,10],maj7:[0,4,7,11],dim7:[0,3,6,9],sus4:[0,5,7],sus2:[0,2,7],dom9:[0,4,7,10,14],maj9:[0,4,7,11,14],min9:[0,3,7,10,14],maj6:[0,4,7,9],min6:[0,3,7,9],mmaj7:[0,3,7,11],sus7:[0,5,7,10],sus9:[0,5,7,10,14]},js=Object.keys(ne),Ui={TONIC:"home",SUPERTONIC:"rise",MEDIANT:"glow",SUBDOMINANT:"lift",DOMINANT:"reach",SUBMEDIANT:"hold","LEADING-TONE":"edge",SUBTONIC:"drift"},Et={TONIC:"Tonic",SUPERTONIC:"Supertonic",MEDIANT:"Mediant",SUBDOMINANT:"Subdominant",DOMINANT:"Dominant",SUBMEDIANT:"Submediant","LEADING-TONE":"Leading tone",SUBTONIC:"Subtonic"},qt={TONIC:.04,SUBMEDIANT:.24,MEDIANT:.34,SUBDOMINANT:.42,SUPERTONIC:.52,SUBTONIC:.58,"LEADING-TONE":.78,DOMINANT:.68},Nt={MAJOR:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},NATURAL_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},HARMONIC_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III+",SUBDOMINANT:"iv",DOMINANT:"V",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MELODIC_MINOR:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III+",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},DORIAN:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MIXOLYDIAN:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii°",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},LYDIAN:{TONIC:"I",SUPERTONIC:"II",MEDIANT:"iii",SUBDOMINANT:"iv°",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii",SUBTONIC:"♭VII"},PHRYGIAN:{TONIC:"i",SUPERTONIC:"♭II",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v°",SUBMEDIANT:"♭VI","LEADING-TONE":"vii",SUBTONIC:"♭vii"},LOCRIAN:{TONIC:"i°",SUPERTONIC:"♭II",MEDIANT:"♭iii",SUBDOMINANT:"iv",DOMINANT:"♭V",SUBMEDIANT:"♭VI","LEADING-TONE":"♭vii",SUBTONIC:"♭vii"}};function M(e,t){const i=(e%12+12)%12;return t?Ls[i]:Us[i]}function ee(e){if(!e)return{root:"C",quality:"maj"};const t=e.trim(),i=t[0]?.toUpperCase();let s="C",o=t;if(i&&/[A-G]/.test(i)){const r=t[1];r==="b"||r==="B"||r==="♭"||r==="♭"?(s=`${i}b`,o=t.slice(2)):r==="#"||r==="♯"||r==="♯"?(s=`${i}#`,o=t.slice(2)):(s=i,o=t.slice(1))}o=o.toLowerCase();let n="maj";return o.includes("maj9")||o.includes("m9")&&o.includes("maj")?n="maj9":o.includes("min9")||o.includes("m9")?n="min9":o.includes("dom9")||o.includes("9sus")||o.includes("9")?o.includes("9sus")||o.includes("sus9")?n="sus9":n="dom9":o.includes("m(maj7)")||o.includes("mmaj7")||o.includes("minmaj7")?n="mmaj7":o.includes("maj7sus")||o.includes("7sus")?n="sus7":o.includes("maj7")||o.includes("m7")&&o.includes("maj")?n="maj7":o.includes("min7")||o.includes("m7")?n="min7":o.includes("min6")||o.includes("m6")?n="min6":o.includes("maj6")||o.includes("6")&&!o.includes("m")?n="maj6":o.includes("dim7")?n="dim7":o.includes("dim")||o.includes("°")?n="dim":o.includes("aug")||o.includes("+")?n="aug":o.includes("sus2")?n="sus2":o.includes("sus4")||o.includes("sus")?n="sus4":o.includes("7")?n="dom7":o.includes("min")||o==="m"?n="min":n="maj",{root:s,quality:n}}const _s=Object.keys(Nt),Me={MAJOR:"Ionian",NATURAL_MINOR:"Aeolian",HARMONIC_MINOR:"Harmonic minor",MELODIC_MINOR:"Melodic minor",DORIAN:"Dorian",MIXOLYDIAN:"Mixolydian",LYDIAN:"Lydian"},Re=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],Gs={Pop:"MAJOR",Rock:"MAJOR",Gospel:"MAJOR","Indie/Folk":"MAJOR","Lo-fi/Chill":"DORIAN","Jazz-ish":"DORIAN","R&B/Soul":"MIXOLYDIAN","House/Dance":"MIXOLYDIAN",Synthwave:"LYDIAN",Cinematic:"LYDIAN",Blues:"MIXOLYDIAN","Funk/Disco":"MIXOLYDIAN","Country/Bluegrass":"MAJOR","Reggae/Dub":"DORIAN",Metal:"HARMONIC_MINOR",Punk:"MAJOR","Ambient/Drone":"LYDIAN","Trap/Hip-Hop":"NATURAL_MINOR","Bossa Nova/Latin":"DORIAN","Classical/Orchestral":"MAJOR","EDM/Trance":"NATURAL_MINOR",Afrobeats:"MIXOLYDIAN",Shoegaze:"LYDIAN"},Vs={Uplifting:null,Melancholy:"NATURAL_MINOR",Dreamy:null,Tense:"HARMONIC_MINOR",Warm:null,Nostalgic:"NATURAL_MINOR",Energetic:null,Dark:"HARMONIC_MINOR",Peaceful:null,Groovy:"MIXOLYDIAN",Epic:"MAJOR"},Yt={Uplifting:["DOMINANT","SUBDOMINANT","SUBMEDIANT"],Melancholy:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Dreamy:["MEDIANT","SUBDOMINANT","SUPERTONIC"],Tense:["DOMINANT","LEADING-TONE","SUPERTONIC"],Warm:["SUBDOMINANT","MEDIANT","SUBMEDIANT"],Nostalgic:["SUBMEDIANT","MEDIANT","DOMINANT"],Energetic:["DOMINANT","SUBDOMINANT","SUPERTONIC"],Dark:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Peaceful:["TONIC","SUBDOMINANT","MEDIANT"],Groovy:["SUBDOMINANT","DOMINANT","SUBTONIC"],Epic:["TONIC","DOMINANT","SUBMEDIANT"]},Oe=[{name:"Uplifting",dot:"#F6D98B",desc:"Bright, major, forward-moving",iconPath:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5"},{name:"Melancholy",dot:"#9CC0EC",desc:"Minor-leaning, unresolved longing",iconPath:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15"},{name:"Dreamy",dot:"#C9A9E0",desc:"Suspended, floating, reverb-soaked",iconPath:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0"},{name:"Tense",dot:"#F2735F",desc:"Chromatic pulls, unresolved tension",iconPath:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12"},{name:"Warm",dot:"#F2C9A0",desc:"Rich, consonant, close voicings",iconPath:"M12 4 a6.5 6.5 0 1 0 6.5 6.5"},{name:"Nostalgic",dot:"#B8CC9E",desc:"Bittersweet, borrowed chords",iconPath:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},{name:"Energetic",dot:"#FF8C42",desc:"High velocity, driving rhythm",iconPath:"M13 2 L4 14 h7 l-2 8 11-12 h-7 z"},{name:"Dark",dot:"#7B61FF",desc:"Deep minor, ominous resonance",iconPath:"M12 3 a9 9 0 1 0 9 9 a9 9 0 0 1-9-9 z"},{name:"Peaceful",dot:"#7CD9B6",desc:"Serene, gentle acoustic space",iconPath:"M12 2 a10 10 0 1 0 10 10 A10 10 0 0 0 12 2 z M12 6 a6 6 0 1 1-6 6 a6 6 0 0 1 6-6 z"},{name:"Groovy",dot:"#E8609A",desc:"Syncopated, rhythmic bounce",iconPath:"M4 12 c4-4 8 4 12-4 s8 4 4 8"},{name:"Epic",dot:"#E5C158",desc:"Sweeping dynamics, triumphant power",iconPath:"M12 2 l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 z"}];function we(e){return(Oe.find(t=>t.name===e)||Oe[0]).dot}const qs={MAJOR:[{degrees:["TONIC","DOMINANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBMEDIANT","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","DOMINANT"]},{degrees:["TONIC","MEDIANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBDOMINANT","SUBMEDIANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","MEDIANT","SUBMEDIANT"]},{degrees:["SUBDOMINANT","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","DOMINANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","SUBMEDIANT","TONIC"]}],NATURAL_MINOR:[{degrees:["TONIC","SUBMEDIANT","MEDIANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","MEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUBTONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","SUBTONIC","TONIC","DOMINANT"]},{degrees:["SUBMEDIANT","SUBTONIC","MEDIANT","TONIC"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","SUBMEDIANT","SUBDOMINANT","TONIC"]}],HARMONIC_MINOR:[{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUBDOMINANT"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUPERTONIC","DOMINANT"]},{degrees:["SUBMEDIANT","DOMINANT","TONIC","SUBDOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]}],DORIAN:[{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUPERTONIC","SUBTONIC"]},{degrees:["SUBDOMINANT","TONIC","SUBTONIC","SUPERTONIC"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUPERTONIC","SUBDOMINANT","SUBTONIC","TONIC"]}],MIXOLYDIAN:[{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBDOMINANT"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUBDOMINANT","SUBTONIC","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","TONIC","SUBDOMINANT","SUPERTONIC"]}],LYDIAN:[{degrees:["TONIC","SUPERTONIC","SUBMEDIANT","DOMINANT"]},{degrees:["TONIC","DOMINANT","SUPERTONIC","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]}]};function Ys(e,t){return 1+e.degrees.filter(i=>t.includes(i)).length*.6}function Xe(e,t){const i=e.reduce((o,n)=>o+t(n),0);let s=Math.random()*i;for(const o of e)if(s-=t(o),s<=0)return o;return e[e.length-1]}function Hs(e){if(e.length)return e[Math.floor(Math.random()*e.length)]}const At=4,De=1,he=8,Ws=1700,Js={TONIC:{SUBDOMINANT:.35,SUBMEDIANT:.25,SUPERTONIC:.15,DOMINANT:.15,MEDIANT:.05,SUBTONIC:.05},SUPERTONIC:{DOMINANT:.5,SUBDOMINANT:.2,SUBMEDIANT:.15,TONIC:.1,"LEADING-TONE":.05},MEDIANT:{SUBMEDIANT:.4,SUBDOMINANT:.3,SUPERTONIC:.15,DOMINANT:.15},SUBDOMINANT:{DOMINANT:.45,TONIC:.25,SUPERTONIC:.15,SUBMEDIANT:.15},DOMINANT:{TONIC:.55,SUBMEDIANT:.25,SUBDOMINANT:.15,MEDIANT:.05},SUBMEDIANT:{SUBDOMINANT:.4,SUPERTONIC:.25,DOMINANT:.2,TONIC:.15},"LEADING-TONE":{TONIC:.7,SUBMEDIANT:.2,MEDIANT:.1},SUBTONIC:{TONIC:.45,SUBDOMINANT:.3,SUBMEDIANT:.15,DOMINANT:.1}};function Ks(e,t="MAJOR",i="Pop",s="Uplifting"){let n={TONIC:1,SUBDOMINANT:.45,SUBMEDIANT:.4,SUPERTONIC:.3,SUBTONIC:.3,MEDIANT:.15,DOMINANT:.15,"LEADING-TONE":.02}[e]??.1;return t.includes("MINOR")||t==="DORIAN"?(e==="SUBMEDIANT"&&(n*=1.4),e==="SUBTONIC"&&(n*=1.3)):t==="MIXOLYDIAN"?(e==="SUBTONIC"&&(n*=1.8),e==="SUBDOMINANT"&&(n*=1.5)):t==="LYDIAN"&&e==="SUPERTONIC"&&(n*=1.8),i==="Lo-fi/Chill"||i==="R&B/Soul"?((e==="SUBDOMINANT"||e==="SUPERTONIC")&&(n*=2),e==="SUBMEDIANT"&&(n*=1.5)):i==="Jazz-ish"||i==="Bossa Nova/Latin"?(e==="SUPERTONIC"&&(n*=2.5),e==="SUBDOMINANT"&&(n*=1.8)):i==="Pop"||i==="Indie/Folk"||i==="Shoegaze"?(e==="SUBDOMINANT"||e==="SUBMEDIANT")&&(n*=1.8):i==="Synthwave"||i==="House/Dance"||i==="Rock"||i==="Punk"||i==="Funk/Disco"||i==="Reggae/Dub"?(e==="SUBTONIC"&&(n*=2.2),e==="SUBDOMINANT"&&(n*=1.8),e==="SUBMEDIANT"&&(n*=1.6)):(i==="Classical/Orchestral"||i==="Gospel")&&e==="TONIC"&&(n*=2.5),s==="Uplifting"||s==="Epic"||s==="Peaceful"?e==="TONIC"&&(n*=2.5):s==="Melancholy"||s==="Dark"?(e==="SUBMEDIANT"&&(n*=2.2),e==="SUPERTONIC"&&(n*=1.5)):s==="Dreamy"||s==="Nostalgic"||s==="Warm"?(e==="SUBDOMINANT"&&(n*=2),e==="SUBMEDIANT"&&(n*=1.6),e==="MEDIANT"&&(n*=1.4)):s==="Tense"?(e==="SUPERTONIC"||e==="SUBDOMINANT")&&(n*=1.8):(s==="Groovy"||s==="Energetic")&&(e==="SUBTONIC"||e==="SUBDOMINANT")&&(n*=1.8),(Yt[s]||[]).includes(e)&&(n*=1.3),Math.max(.01,n)}function yt(e,t,i="MAJOR",s="Pop",o="Uplifting"){if(e===t)return .05;let r=(Js[e]||{})[t]??.1;return(i.includes("MINOR")||i==="DORIAN")&&(e==="TONIC"&&t==="SUBMEDIANT"&&(r*=1.5),e==="SUBMEDIANT"&&t==="MEDIANT"&&(r*=1.4),e==="MEDIANT"&&t==="SUBTONIC"&&(r*=1.4),e==="SUBTONIC"&&t==="TONIC"&&(r*=1.3)),s==="Jazz-ish"||s==="Lo-fi/Chill"?(e==="SUPERTONIC"&&t==="DOMINANT"&&(r*=1.8),e==="DOMINANT"&&t==="TONIC"&&(r*=1.5),e==="TONIC"&&t==="SUPERTONIC"&&(r*=1.4)):(s==="House/Dance"||s==="Synthwave")&&(t==="SUBTONIC"||t==="SUBDOMINANT")&&(r*=1.5),(Yt[o]||[]).includes(t)&&(r*=1.5),Math.max(.01,r)}function Xs(e,t,i,s,o,n,r=At){let c=i.filter(l=>e.degrees[l]);c.length||(c=i);const d=Xe(c,l=>Ks(l,e.type,o,n))||"TONIC",p=[d];let g=d;for(let l=1;l<r;l++){const v=l===r-1;let b=i.filter(h=>e.degrees[h]);b.length||(b=i);const f=b.filter(h=>h!==g),a=f.length?f:b;if(v){const h=Xe(a,m=>{const y=yt(m,p[0],e.type,o,n),w=yt(g,m,e.type,o,n);return y*w});p.push(h)}else{const h=a.filter(w=>!p.includes(w)),m=h.length?h:a,y=Xe(m,w=>yt(g,w,e.type,o,n));g=y,p.push(y)}}return p}function et(e,t,i){return e.includes("b")||e==="F"||e==="Bb"||e==="Eb"||e==="Ab"||e==="Db"||e==="Gb"?!0:e.includes("#")?!1:i}function V(e,t){const{root:i,quality:s}=ee(e),o=P[i]??0,n=ne[s]||ne.maj,r=et(i,s,t);return n.map(c=>M(o+c,r))}async function Qs(){const e=typeof import.meta<"u"?"./":"/",t=e.endsWith("/")?e:`${e}/`,i=`${t}chroma_chords_data.json`,s=`${t}chord_voyager_data.json`;let o=await fetch(i).catch(()=>null);if((!o||!o.ok)&&(o=await fetch(s).catch(()=>null)),(!o||!o.ok)&&(o=await fetch("/chroma_chords_data.json").catch(()=>null)),(!o||!o.ok)&&(o=await fetch("/chord_voyager_data.json").catch(()=>null)),!o||!o.ok){const r=new URL("./chroma_chords_data.json",import.meta.url).href;o=await fetch(r)}if(!o.ok)throw new Error(`HTTP error: ${o.status}`);const n=await o.json();return no(n),n}const Zs={C:"F",Db:"F#",D:"G",Eb:"Ab",E:"A",F:"Bb","F#":"B",G:"C",Ab:"Db",A:"D",Bb:"Eb",B:"E"},eo={C:"Bb","C#":"B",D:"C","D#":"Db",E:"D",F:"Eb","F#":"E",G:"F","G#":"F#",A:"G","A#":"Ab",B:"A"},to={C:"G",Db:"Ab",D:"A",Eb:"Bb",E:"B",F:"C","F#":"Db",G:"D",Ab:"Eb",A:"E",Bb:"F",B:"F#"},io={DORIAN_SUPERTONIC:"TONIC",DORIAN_MEDIANT:"SUPERTONIC",DORIAN_SUBDOMINANT:"MEDIANT",DORIAN_DOMINANT:"SUBDOMINANT",DORIAN_SUBMEDIANT:"DOMINANT","DORIAN_LEADING-TONE":"SUBMEDIANT",DORIAN_TONIC:"SUBTONIC",MIXOLYDIAN_DOMINANT:"TONIC",MIXOLYDIAN_SUBMEDIANT:"SUPERTONIC","MIXOLYDIAN_LEADING-TONE":"MEDIANT",MIXOLYDIAN_TONIC:"SUBDOMINANT",MIXOLYDIAN_SUPERTONIC:"DOMINANT",MIXOLYDIAN_MEDIANT:"SUBMEDIANT",MIXOLYDIAN_SUBDOMINANT:"SUBTONIC",LYDIAN_SUBDOMINANT:"TONIC",LYDIAN_DOMINANT:"SUPERTONIC",LYDIAN_SUBMEDIANT:"MEDIANT","LYDIAN_LEADING-TONE":"SUBDOMINANT",LYDIAN_TONIC:"DOMINANT",LYDIAN_SUPERTONIC:"SUBMEDIANT",LYDIAN_MEDIANT:"LEADING-TONE"},so={DORIAN_TONIC:"SUPERTONIC",DORIAN_SUPERTONIC:"MEDIANT",DORIAN_MEDIANT:"SUBDOMINANT",DORIAN_SUBDOMINANT:"DOMINANT",DORIAN_DOMINANT:"SUBMEDIANT",DORIAN_SUBMEDIANT:"LEADING-TONE",DORIAN_SUBTONIC:"TONIC",MIXOLYDIAN_TONIC:"DOMINANT",MIXOLYDIAN_SUPERTONIC:"SUBMEDIANT",MIXOLYDIAN_MEDIANT:"LEADING-TONE",MIXOLYDIAN_SUBDOMINANT:"TONIC",MIXOLYDIAN_DOMINANT:"SUPERTONIC",MIXOLYDIAN_SUBMEDIANT:"MEDIANT",MIXOLYDIAN_SUBTONIC:"SUBDOMINANT",LYDIAN_TONIC:"SUBDOMINANT",LYDIAN_SUPERTONIC:"DOMINANT",LYDIAN_MEDIANT:"SUBMEDIANT",LYDIAN_SUBDOMINANT:"LEADING-TONE",LYDIAN_DOMINANT:"TONIC",LYDIAN_SUBMEDIANT:"SUPERTONIC","LYDIAN_LEADING-TONE":"MEDIANT"},oo={DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]};function no(e){const t=[["MIXOLYDIAN",Zs],["DORIAN",eo],["LYDIAN",to]];for(const[i,s]of t)for(const[o,n]of Object.entries(s)){const r=e.scales[`${n}_MAJOR`];if(!r)continue;const c=`${o}_${i}`,d={};for(const p of oo[i]){const g=so[`${i}_${p}`],l=r.degrees[g];if(!l)continue;const v=JSON.parse(JSON.stringify(l));v.next_chord_options=(v.next_chord_options||[]).map(b=>{if(b.nodeId.startsWith(`${n}_MAJOR_`)){const f=b.nodeId.replace(`${n}_MAJOR_`,""),a=io[`${i}_${f}`];if(a)return{name:b.name,nodeId:`${o}_${i}_${a}`}}return b}),d[p]=v}e.scales[c]={root:o,type:i,degrees:d}}}const ro=[156,192,236],ao=[242,115,95];function Qe(e,t,i){return e+(t-e)*i}function Be(e){const t=Math.max(0,Math.min(1,e));return"#"+ro.map((s,o)=>Math.round(Qe(s,ao[o],t))).map(s=>s.toString(16).padStart(2,"0")).join("")}function Z(e){const t=Math.max(0,Math.min(1,e));return{size:Math.round(Qe(84,128,t)),radius:Math.round(Qe(40,12,t)),fontSize:Math.round(Qe(21,30,t)),color:Be(t)}}function Li(e,t,i){return{Tonic:`As the tonic, ${i} establishes home — the point of full rest and resolution.`,Supertonic:`As the supertonic, ${i} steps just off home, a light pivot toward what comes next.`,Mediant:`As the mediant, ${i} offers a soft, glowing detour — related to home, but colored differently.`,Subdominant:`As the subdominant, ${i} lifts away from home, opening the progression outward before it turns back.`,Dominant:`As the dominant, ${i} builds the pull of the progression — tension that wants to resolve.`,Submediant:`As the submediant, ${i} offers a warmer, more introspective variation of the tonic — stable but tinged with longing.`,"Leading tone":`As the leading tone, ${i} sits right on the edge, straining toward resolution.`,Subtonic:`As the subtonic, ${i} drifts just below home, a soft modal step rather than a hard pull.`}[e]||`${i} colors the progression as the ${e.toLowerCase()} of ${t}.`}function Ri(e,t,i,s){const n=i.degrees[t].chord_name,r=qt[t]??.5,c=Nt[i.type]||Nt.MAJOR;return{name:ai(n),tag:Ui[t]||"move",roman:c[t]||"?",color:Be(r),functionLabel:Et[t]||t,notes:V(n,s),scaleLabel:`${i.root} ${Me[i.type]||i.type}`,desc:Li(Et[t]||t,Me[i.type]||i.type,ai(n)),degree:t,scaleKey:e,tension:r}}function ai(e){const{root:t,quality:i}=ee(e);return`${t}${{maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"}[i]??""}`}const lo={Pop:116,"Lo-fi/Chill":80,"R&B/Soul":90,"Indie/Folk":105,Synthwave:118,"Jazz-ish":95,Gospel:85,Cinematic:75,Rock:124,"House/Dance":126,Blues:88,"Funk/Disco":114,"Country/Bluegrass":110,"Reggae/Dub":78,Metal:140,Punk:155,"Ambient/Drone":65,"Trap/Hip-Hop":135,"Bossa Nova/Latin":120,"Classical/Orchestral":72,"EDM/Trance":132,Afrobeats:108,Shoegaze:112};function ji(e,t){let i=lo[e]||92;return t==="Tense"&&(i+=6),(t==="Dreamy"||t==="Melancholy")&&(i-=6),i}function Mt(e,t,i,s){const o=Math.max(De,Math.min(he,s?.length??At)),n=Gs[t]||"MAJOR",r=Vs[i],c=s?.scaleType||(r&&n==="MAJOR"?r:n);let d=s?.key&&je.includes(s.key)?s.key:Hs(je),p=`${d}_${c}`;e.scales[p]||(d="C",p=`${d}_${c}`);let g=e.scales[p];if(!g){const w=Object.keys(e.scales).find(k=>k.endsWith(`_${c}`))||Object.keys(e.scales)[0];g=e.scales[w],d=g?g.root:"C",p=w}const l=j(d,c),v=Object.keys(g.degrees),b=Yt[i]||[],f=qs[c]||[],a=o===At?f.filter(w=>w.degrees.every(k=>v.includes(k))):[],y=(a.length&&Math.random()<.25?Xe(a,w=>Ys(w,b)).degrees:Xs(g,p,v,b,t,i,o)).map(w=>Ri(p,w,g,l));return{genre:t,mood:i,key:d,scaleType:c,bpm:ji(t,i),chords:y}}const co={TONIC:{upper:"I",lower:"i"},SUPERTONIC:{upper:"II",lower:"ii"},MEDIANT:{upper:"III",lower:"iii"},SUBDOMINANT:{upper:"IV",lower:"iv"},DOMINANT:{upper:"V",lower:"v"},SUBMEDIANT:{upper:"VI",lower:"vi"},"LEADING-TONE":{upper:"VII",lower:"vii"},SUBTONIC:{upper:"♭VII",lower:"♭vii"}},po={0:{upper:"I",lower:"i"},1:{upper:"♭II",lower:"♭ii"},2:{upper:"II",lower:"ii"},3:{upper:"♭III",lower:"♭iii"},4:{upper:"III",lower:"iii"},5:{upper:"IV",lower:"iv"},6:{upper:"♯IV",lower:"♯iv"},7:{upper:"V",lower:"v"},8:{upper:"♭VI",lower:"♭vi"},9:{upper:"VI",lower:"vi"},10:{upper:"♭VII",lower:"♭vii"},11:{upper:"VII",lower:"vii"}};function _i(e){return ne[e]?e:ee(`C${e||""}`).quality}function Gi(e,t){return t==="dom7"?`${e}7`:t==="maj7"?`${e}maj7`:t==="min7"?`${e}7`:t==="dim"?`${e}°`:t==="dim7"?`${e}°7`:t==="aug"?`${e}+`:t==="sus4"?`${e}sus4`:t==="sus2"?`${e}sus2`:t==="dom9"?`${e}9`:t==="maj9"?`${e}maj9`:t==="min9"?`${e}m9`:e}function Vi(e,t){const i=co[e]||{upper:"I",lower:"i"},o=t==="min"||t==="min7"||t==="dim"||t==="dim7"||t==="min9"?i.lower:i.upper;return Gi(o,t)}function Ht(e,t){const i=po[(e%12+12)%12]||{upper:"?",lower:"?"},o=t==="min"||t==="min7"||t==="dim"||t==="dim7"||t==="min9"?i.lower:i.upper;return Gi(o,t)}function ho(e,t,i,s){const o=t==="maj"||t==="dom7"||t==="dom9",n=t==="min"||t==="min7"||t==="min9";if(e==="MEDIANT"&&o)return{functionLabel:"Secondary Dominant",tag:"glow",tension:.58,desc:`${i} acts as a secondary dominant (III) adding bright chromatic tension and pull.`};if(e==="SUPERTONIC"&&o)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.62,desc:`${i} acts as a secondary dominant (II), driving momentum toward the dominant.`};if(e==="SUBMEDIANT"&&o)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.55,desc:`${i} acts as a secondary dominant (VI), energizing the progression.`};if(e==="TONIC"&&t==="dom7")return{functionLabel:"Secondary Dominant",tag:"reach",tension:.52,desc:`${i} acts as a secondary dominant (I7), pulling strongly toward the subdominant.`};if(e==="SUBDOMINANT"&&n)return{functionLabel:"Borrowed (Minor iv)",tag:"drift",tension:.48,desc:`${i} borrows the poignant minor iv cadence from the parallel minor mode.`};const r=qt[e]??.4;return{functionLabel:"Chromatic Alteration",tag:"color",tension:Math.min(.85,r+.15),desc:`${i} adds chromatic color to the ${s.root} ${Me[s.type]||s.type} progression.`}}function Wt(e,t,i,s){const o=(e%12+12)%12,n=(P[i]??0)+o,c=`${M(n,s)}${Jt[t]??t}`;return o===10?{functionLabel:"Borrowed (Subtonic ♭VII)",tag:"drift",tension:.45,desc:`${c} is the borrowed Mixolydian ♭VII chord, adding a classic rock/pop lift.`}:o===8?{functionLabel:"Borrowed (Submediant ♭VI)",tag:"glow",tension:.5,desc:`${c} is the borrowed Aeolian ♭VI chord, introducing epic modal depth.`}:o===3?{functionLabel:"Borrowed (Mediant ♭III)",tag:"glow",tension:.52,desc:`${c} is the borrowed ♭III chord, providing chromatic punch and modal color.`}:o===1?{functionLabel:"Neapolitan (♭II)",tag:"edge",tension:.65,desc:`${c} is the Neapolitan ♭II chord, providing dramatic half-step motion.`}:{functionLabel:"Borrowed",tag:"drift",tension:.42,desc:`${c} borrows its color from outside the current key.`}}function uo(e,t,i,s,o){const n=i.degrees[t],{root:r}=ee(n.chord_name),c=P[r]??0,d=M(c,o),p=`${d}${Jt[s]??s}`,g=et(d,s,o),l=ne[s]?ne[s].map(f=>M(c+f,g)):V(n.chord_name,o),v=Vi(t,s),b=ho(t,s,p,i);return{name:p,tag:b.tag,roman:v,color:Be(b.tension),functionLabel:b.functionLabel,notes:l,scaleLabel:`${i.root} ${Me[i.type]||i.type}`,desc:b.desc,degree:t,scaleKey:e,tension:b.tension}}function go(e,t,i,s,o,n){const r=`${t}_${i}`,c=e.scales[r];if(!c||!s.length)return null;const d=j(t,i),p=P[t]??0,g={};Object.entries(c.degrees).forEach(([v,b])=>{const{root:f}=ee(b.chord_name),a=P[f]??0;a in g||(g[a]=v)});const l=s.slice(0,he).map(({root:v,quality:b})=>{const f=P[v]??p,a=g[f],h=_i(b);if(a){const k=c.degrees[a],{quality:D}=ee(k.chord_name);return h===D||!b&&D?Ri(r,a,c,d):uo(r,a,c,h,d)}const m=(f-p+12)%12,y=Wt(m,h,t,d),w=Ht(m,h);return mo(t,m,h,y.functionLabel,w,y.tag,d)});return l.length<De?null:{genre:o,mood:n,key:t,scaleType:i,bpm:ji(o,n),chords:l}}const Jt={maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"};function mo(e,t,i,s,o,n,r){const c=(P[e]??0)+t,d=M(c,r),p=_i(i),g=`${d}${Jt[p]??p}`,l=et(d,p,r),v=(ne[p]||ne.maj).map(a=>M(c+a,l)),b=o==="?"?Ht(t,p):o,f=.42;return{name:g,tag:n,roman:b,color:Be(f),functionLabel:s==="Borrowed"?Wt(t,p,e,r).functionLabel:s,notes:v,scaleLabel:"Borrowed",desc:`${g} borrows its color from outside the current key.`,degree:"BORROWED",scaleKey:"",tension:f}}function Ot(e){const t=e.match(/^[A-Ga-g][#b]?/),i=t?t[0]:"C";return i[0].toUpperCase()+i.slice(1)}function fo(e){const t=(e||"C").trim(),i=t[0]?.toUpperCase()||"C";let s=i,o=t.slice(1);if(t.length>1){const n=t[1];n==="b"||n==="B"||n==="♭"||n==="♭"?(s=`${i}b`,o=t.slice(2)):(n==="#"||n==="♯"||n==="♯")&&(s=`${i}#`,o=t.slice(2))}return{root:s,suffix:o}}function vo(e,t,i){const{root:s,suffix:o}=fo(e),n=s.replace("♭","b").replace("♯","#"),c=(((P[n]??0)+t)%12+12)%12;return`${M(c,i)}${o}`}function bo(e,t,i){if(!e||!e.chords||e.chords.length===0)return e;const s=/\bmin\b|minor/i.test(t)||/\b[A-G][#b]?m\b/.test(t),o=/\bmaj\b|major/i.test(t),n=s&&!o,r=t.replace(/\s*(maj|min|major|minor)\s*/gi,"").replace(/♭/g,"b").replace(/♯/g,"#").trim(),c=n?"NATURAL_MINOR":o?"MAJOR":e.scaleType||"MAJOR",d=r,p=(e.key||"C").replace("♭","b").replace("♯","#").trim(),g=P[p]??0,l=P[d]??0,v=((l-g)%12+12)%12,b=j(d,c),f=`${d}_${c}`,a={TONIC:0,SUPERTONIC:2,MEDIANT:c.includes("MINOR")||c==="DORIAN"?3:4,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:c==="MAJOR"||c==="DORIAN"?9:8,SUBTONIC:10,"LEADING-TONE":11},h=e.chords.map(m=>{const y=vo(m.name,v,b),{root:w,quality:k}=ee(y),B=(((P[w]??0)-l)%12+12)%12;let _=null;for(const[Y,me]of Object.entries(a))if(me===B){_=Y;break}let W,K,X=m.tag||"move",ce=m.tension,Q=m.degree;if(_)Q=_,W=Vi(Q,k),K=Et[Q]||Q,X=Ui[Q]||X,ce=qt[Q]??ce;else{Q="BORROWED",W=Ht(B,k);const Y=Wt(B,k,d,b);K=Y.functionLabel,X=Y.tag||X,ce=Y.tension||.45}const T=V(y,b);return{...m,name:y,roman:W,functionLabel:K,tag:X,notes:T,degree:Q,scaleKey:f,scaleLabel:`${d} ${Me[c]||c}`,desc:Li(K,Me[c]||c,y),tension:ce}});return{...e,key:d,scaleType:c,chords:h}}const li={Major:[0,4,7],Minor:[0,3,7],"Suspended (sus)":[0,5,7],Diminished:[0,3,6]};function qi(e,t,i,s){const o=P[e]??0;let n=li[t]||li.Major;return i==="6th"?n=[...n,9]:i==="7th (dom / m7)"?n=[...n,10]:i==="Major 7th (M7)"?n=[...n,11]:i==="9th"&&(n=[...n,10,14]),n.map(r=>M(o+r,s))}const xo={Major:"",Minor:"m","Suspended (sus)":"sus",Diminished:"dim"},yo={None:"","6th":"6","7th (dom / m7)":"7","Major 7th (M7)":"maj7","9th":"9"};function Yi(e,t,i){return t==="Minor"&&i==="Major 7th (M7)"?`${e}m(maj7)`:`${e}${xo[t]??""}${yo[i]??""}`}const wo={MAJOR:0,LYDIAN:5,MIXOLYDIAN:7,DORIAN:2,NATURAL_MINOR:9,HARMONIC_MINOR:9},Hi={};je.forEach(e=>{Hi[P[e]]=e});function ko(e,t){const i=wo[t]??0,o=(((P[e]??0)-i)%12+12)%12;return Hi[o]??"C"}function j(e,t){const i=ko(e,t);return Rs.has(i)||i.includes("b")}function ci(e,t,i){const s=Ot(e.name),o=s.includes("b"),n=Yi(s,t,i),r=qi(s,t,i,o);let c=e.roman||"";if(c){const g=c.match(/^([♭♯b#]*)([ivxIVX]+)/);if(g){const l=g[1],v=g[2],b=t==="Minor"||t==="Diminished",f=b?v.toLowerCase():v.toUpperCase();let a="";t==="Diminished"?a=i==="7th (dom / m7)"?"°7":"°":t==="Suspended (sus)"?a="sus4":i==="6th"?a="6":i==="7th (dom / m7)"?a="7":i==="Major 7th (M7)"?a=b?"m(maj7)":"maj7":i==="9th"&&(a=b?"m9":"maj9"),c=`${l}${f}${a}`}}let d=e.tension??1;t==="Diminished"?d=Math.max(d,3):t==="Suspended (sus)"?d=Math.max(d,2):i==="7th (dom / m7)"?d=Math.max(d,2.5):(i==="9th"||i==="Major 7th (M7)")&&(d=Math.max(d,2));const p=Be(d);return{...e,name:n,notes:r,roman:c,tension:d,color:p}}function U(e,t,i,s,o,n,r,c){const d=Yi(e,t,i),p=qi(e,t,i,c);return{name:d,tag:s||"sub",roman:s,color:Be(r),functionLabel:o,notes:p,scaleLabel:"Substitution",desc:n,degree:"SUBSTITUTION",scaleKey:"",tension:r}}function Kt(e,t,i){const s=P[t.key]??0,o=t.scaleType.includes("MINOR"),n=j(t.key,t.scaleType),r=o?[(()=>{const g=M(s+1,!0),l=U(g,"Major","Major 7th (M7)","♭II","Neapolitan","a dark, dramatic slide in from a half-step above",.6,!0);return{name:l.name,roman:"♭II",notes:l.notes,sub:"Neapolitan chord — a dramatic slide in from a half-step above",chord:l,tension:.6}})(),(()=>{const g=M(s+5,!0),l=U(g,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.45,!0);return{name:l.name,roman:"iv",notes:l.notes,sub:"the minor subdominant — deeper minor mood",chord:l,tension:.45}})(),(()=>{const g=M(s+10,!0),l=U(g,"Minor","7th (dom / m7)","v","Minor dominant","unresolved minor drift",.52,!0);return{name:l.name,roman:"v",notes:l.notes,sub:"a step further into shadow — unresolving drift",chord:l,tension:.52}})()]:[(()=>{const g=M(s+8,!0),l=U(g,"Major","Major 7th (M7)","♭VI","Flat submediant",`borrowed from ${t.key} minor — the cinematic shadow`,.5,!0);return{name:l.name,roman:"♭VI",notes:l.notes,sub:`borrowed from ${t.key} minor — the cinematic shadow`,chord:l,tension:.5}})(),(()=>{const g=M(s+5,!0),l=U(g,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.42,!0);return{name:l.name,roman:"iv",notes:l.notes,sub:"the minor subdominant — softer, sadder",chord:l,tension:.42}})(),(()=>{const g=M(s+3,!0),l=U(g,"Major","Major 7th (M7)","♭III","Flat mediant","a step further out — cooler, more remote",.58,!0);return{name:l.name,roman:"♭III",notes:l.notes,sub:"a step further out — cooler, more remote",chord:l,tension:.58}})()],c=[(()=>{const g=M(s+7,n),l=M(s+2,n),v=U(l,"Major","7th (dom / m7)","V7/V","Secondary dominant",`aimed at ${g}7 — sharpens the approach`,.82,n);return{name:v.name,roman:"V7/V",notes:v.notes,sub:`aimed at ${g}7 — sharpens the approach`,chord:v,tension:.82}})(),(()=>{const g=M(s+(o?3:9),n),l=M(s+4,n),v=U(l,"Major","7th (dom / m7)","V7/vi","Secondary dominant",`aimed at ${g}m7 — makes it feel arrived at`,.88,n);return{name:v.name,roman:"V7/vi",notes:v.notes,sub:`aimed at ${g}m7 — makes it feel arrived at`,chord:v,tension:.88}})(),(()=>{const g=M(s+1,!0),l=U(g,"Major","7th (dom / m7)","subV7","Tritone substitute","a tritone substitute — slides in sideways",.95,!0);return{name:l.name,roman:"subV7",notes:l.notes,sub:"a tritone substitute — slides in sideways",chord:l,tension:.95}})()],d=[(()=>{const g=M(s+5,n),l=U(g,"Major","Major 7th (M7)",o?"IV":"IVmaj7","Subdominant","floats rather than resolving",.3,n);return{name:l.name,roman:"IV",notes:l.notes,sub:"floats rather than resolving",chord:l,tension:.3}})(),(()=>{const g=M(s,n),l=U(g,o?"Minor":"Major","9th",o?"im9":"Imaj9","Tonic extension","the same home with more air in it",.18,n);return{name:l.name,roman:o?"im9":"Imaj9",notes:l.notes,sub:"the same home with more air in it",chord:l,tension:.18}})(),(()=>{const g=M(s+(o?3:4),n),l=U(g,o?"Major":"Minor","7th (dom / m7)",o?"♭III":"iii","Mediant","wistful, halfway between home and away",.35,n);return{name:l.name,roman:o?"♭III":"iii",notes:l.notes,sub:"wistful, halfway between home and away",chord:l,tension:.35}})()],p=[(()=>{const g=M(s,n),l=U(g,o?"Minor":"Major",o?"None":"Major 7th (M7)",o?"i":"I","Tonic","full resolution — the sense of arriving",.05,n);return{name:l.name,roman:o?"i":"I",notes:l.notes,sub:"full resolution — the sense of arriving",chord:l,tension:.05}})(),(()=>{const g=M(s+7,n),l=U(g,"Major","7th (dom / m7)","V7","Dominant","the pull that makes home feel earned",1,n);return{name:l.name,roman:"V7",notes:l.notes,sub:"the pull that makes home feel earned",chord:l,tension:1}})(),(()=>{const g=M(s+(o?8:9),n),l=U(g,o?"Major":"Minor","7th (dom / m7)",o?"♭VI":"vi","Submediant","a soft landing instead of a full stop",.28,n);return{name:l.name,roman:o?"♭VI":"vi",notes:l.notes,sub:"a soft landing instead of a full stop",chord:l,tension:.28}})()];return[{name:"Darker",sub:"heavier, more shadow",tension:.55,rows:r},{name:"More tension",sub:"sharper pull forward",tension:.85,rows:c},{name:"Dreamier",sub:"softer, more air",tension:.3,rows:d},{name:"Resolve home",sub:"settles back to center",tension:.05,rows:p}]}function Wi(e,t,i){const s=P[t.key]??0,o=t.scaleType.includes("MINOR"),n=j(t.key,t.scaleType),r=t.chords;if(o){const a=r[0]?.name||"chord 1",h=r[1]?.name||"chord 2",m=r[2]?.name||"chord 3",y=r[3]?.name||"chord 4",w=U(M(s,n),"Major","None","I","Major tonic","same root, turned bright",.2,n),k=U(M(s+5,n),"Major","None","IV","Major subdominant","the Dorian lift, sunny and open",.35,n),D=U(M(s+9,n),"Minor","None","vi","Submediant","melodic lift upward",.4,n),B=U(M(s+11,n),"Diminished","None","vii°","Leading tone","classical harmonic pull",.55,n);return[{name:w.name,sub:`in place of ${a} · same root, turned bright`,roman:"I",notes:w.notes,chord:w,tension:.2},{name:k.name,sub:`in place of ${h} · the Dorian lift, sunny and open`,roman:"IV",notes:k.notes,chord:k,tension:.35},{name:D.name,sub:`in place of ${m} · melodic lift upward`,roman:"vi",notes:D.notes,chord:D,tension:.4},{name:B.name,sub:`in place of ${y} · classical harmonic pull`,roman:"vii°",notes:B.notes,chord:B,tension:.55}]}const c=r[0]?.name||"chord 1",d=r[1]?.name||"chord 2",p=r[2]?.name||"chord 3",g=r[3]?.name||"chord 4",l=U(M(s,n),"Minor","None","i","Tonic minor","same root, turned sad",.3,n),v=U(M(s+5,!0),"Minor","None","iv","Minor subdominant","the lift, but heavier",.4,!0),b=U(M(s+8,!0),"Major","None","♭VI","Flat submediant","big and cinematic",.45,!0),f=U(M(s+10,!0),"Major","None","♭VII","Flat subtonic","lands sideways, not home",.5,!0);return[{name:l.name,sub:`in place of ${c} · same root, turned sad`,roman:"i",notes:l.notes,chord:l,tension:.3},{name:v.name,sub:`in place of ${d} · the lift, but heavier`,roman:"iv",notes:v.notes,chord:v,tension:.4},{name:b.name,sub:`in place of ${p} · big and cinematic`,roman:"♭VI",notes:b.notes,chord:b,tension:.45},{name:f.name,sub:`in place of ${g} · lands sideways, not home`,roman:"♭VII",notes:f.notes,chord:f,tension:.5}]}function So(e,t,i){return Kt(e,t).map(o=>{const n=o.rows[0];return{label:o.name,sub:o.sub,chord:n.chord,functionCaption:`${n.roman} · ${n.notes.join(" · ")}`,rationale:n.sub}})}const Io={m8:"https://warmsynths.github.io/hypersyn-chord-helper/",circuit:"https://warmsynths.github.io/circuit-chords/"},$o={m8:43303,circuit:43302};function Co(e,t,i){let s=Io[t];typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(s=`http://localhost:${$o[t]}/`);const n=(i&&i.length>0?i.map(r=>e.chords[r]).filter(r=>!!r):e.chords).map(r=>encodeURIComponent(r.name)).join("+");return`${s}?p=${n}`}const To={0:{symbol:"1",name:"Root",isGuideTone:!1},1:{symbol:"♭9",name:"Minor 9th",isGuideTone:!1},2:{symbol:"9",name:"Major 2nd / 9th",isGuideTone:!1},3:{symbol:"♭3",name:"Minor 3rd",isGuideTone:!0},4:{symbol:"3",name:"Major 3rd",isGuideTone:!0},5:{symbol:"4",name:"Perfect 4th",isGuideTone:!1},6:{symbol:"♭5",name:"Diminished 5th",isGuideTone:!1},7:{symbol:"5",name:"Perfect 5th",isGuideTone:!1},8:{symbol:"♯5 / ♭6",name:"Augmented 5th",isGuideTone:!1},9:{symbol:"6",name:"Major 6th",isGuideTone:!1},10:{symbol:"♭7",name:"Minor 7th",isGuideTone:!0},11:{symbol:"7",name:"Major 7th",isGuideTone:!0},14:{symbol:"9",name:"Major 9th",isGuideTone:!1}};function Eo(e,t){const{root:i,quality:s}=ee(e),o=P[i]??0,n=ne[s]||ne.maj,r=et(i,s,t);return n.map(c=>{const d=M(o+c,r),p=To[c]||{symbol:`+${c}`,name:`Interval ${c}`,isGuideTone:!1};return{note:d,intervalSymbol:p.symbol,roleName:p.name,isGuideTone:p.isGuideTone}})}function No(e){if(!e||e.length<2)return[];const t=[],i=s=>s.replace(/[^A-Za-z♭♯]/g,"");for(let s=0;s<e.length;s++){const o=s,n=(s+1)%e.length,r=e[o],c=e[n],d=i(r.roman),p=i(c.roman),g=o+1,l=n+1,v=`Bar ${g} → ${l}`,b=`${r.name} → ${c.name}`,f=`${r.roman}–${c.roman}`;(d==="V"||d==="v")&&(p==="I"||p==="i")?t.push({name:"Perfect cadence",type:"Authentic Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"The dominant resolves home — the strongest full stop.",why:"The dominant resolves home — the strongest full stop.",move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name}):(d==="IV"||d==="iv")&&(p==="I"||p==="i")?t.push({name:"Plagal cadence",type:"Plagal Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"A softer landing home, no dominant pull.",why:"A softer landing home, no dominant pull.",move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name}):(d==="V"||d==="v")&&(p==="vi"||p==="♭VI"||p==="VI")?t.push({name:"Interrupted cadence",type:"Deceptive Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"Sidesteps home at the last moment.",why:"Sidesteps home at the last moment.",move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name}):d==="♭VII"&&(p==="I"||p==="i")?t.push({name:"Backdoor cadence",type:"Backdoor Cadence",shortName:`${r.name} → ${c.name} (♭VII–${c.roman})`,description:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",why:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name}):(p==="V"||p==="v")&&d!=="V"&&d!=="v"?t.push({name:"Half cadence",type:"Half Cadence",shortName:`${r.name} → ${c.name} (${r.roman}–${c.roman})`,description:"Pauses on the dominant, left hanging.",why:"Pauses on the dominant, left hanging.",move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name}):r.functionLabel==="Secondary Dominant"&&t.push({name:"Secondary Dominant pull",type:"Secondary Dominant Pull",shortName:`${r.name} → ${c.name}`,description:`${r.name} acts as a temporary dominant, pulling strongly into ${c.name}.`,why:`${r.name} acts as a temporary dominant, pulling strongly into ${c.name}.`,move:b,degrees:f,bars:v,fromBar:g,toBar:l,fromChord:r.name,toChord:c.name})}return t}function Ao(e){if(!e||e.length<2)return[];const t=[];for(let i=0;i<e.length;i++){const s=i,o=(i+1)%e.length,n=e[s],r=e[o],c=new Set(n.notes.map(h=>P[h]??0)),d=r.notes.filter(h=>c.has(P[h]??-1)),p=P[Ot(n.name)]??0,g=P[Ot(r.name)]??0,l=Math.min((g-p+12)%12,(p-g+12)%12);let v="Harmonic Shift";d.length>=2?v=`Strong Common Tones (${d.length} shared)`:l<=2?v="Stepwise Bass Motion":(l===5||l===7)&&(v="4th / 5th Cycle Jump");const b=`Bar ${s+1} → ${o+1}`,f=`${n.name} → ${r.name}`,a=d.length?`${d.join(" · ")} held over`:l<=2?"Bass steps by a tone":"No shared notes";t.push({fromBar:s+1,toBar:o+1,fromChord:n.name,toChord:r.name,move:b,chords:f,link:a,hasShared:d.length>0,commonNotes:d,semitoneDistance:l,motionType:v})}return t}function di(e,t=4){const i=Array.isArray(e)?e.filter(l=>typeof l=="string"&&l.trim().length>0):[];if(i.length===0)return[];const s={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},o=i.map(l=>l.replace(/\d+$/,"")),n=o[0],r=s[n]??0;let c=t,d=r;const p=[];return o.forEach((l,v)=>{const b=s[l]??0;v>0&&b<=d&&c++,p.push(`${l}${c}`),d=b}),[`${n}${t-1}`,...p]}class Mo{constructor(){this.mode="single",this.progression=null,this.order=[],this.sections=[],this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.playing=!1,this.instrument=null,this.playStyle=null,this.autoplayTimer=null,this.tickCallbacks=new Set,this.abOverride=null,this.subBassEnabled=!1,this.barsPerChord=1,this.feelSettings={swing:0,spread:50,density:50,tone:"Warm"}}setSubBassEnabled(t){this.subBassEnabled=t}isSubBassEnabled(){return this.subBassEnabled}setProgression(t,i){this.mode="single",this.progression=t,t?this.order=i||Array.from({length:t.chords.length},(s,o)=>o):this.order=[]}setSong(t){this.mode="song",this.sections=t,this.songStep=0,this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}isSongMode(){return this.mode==="song"}getActiveSectionIndex(){return this.activeSectionIndex}getTotalSteps(){return this.mode==="song"?this.sections.reduce((t,i)=>t+i.order.length,0):this.order.length}setOrder(t,i){this.order=t,typeof i=="number"&&(this.activeIndex=i)}setInstrument(t){this.instrument=t}setPlayStyle(t){this.playStyle=t}setBpm(t){const i=Math.max(40,Math.min(240,t));this.progression&&(this.progression.bpm=i),this.playing&&this.startAutoplay()}setBarsPerChord(t){this.barsPerChord=Math.max(1,t),this.playing&&this.startAutoplay()}getBarsPerChord(){return this.barsPerChord}setFeelSettings(t){this.feelSettings={...this.feelSettings,...t}}getFeelSettings(){return{...this.feelSettings}}getStepIntervalMs(){const t=this.mode==="song"?this.sections[this.activeSectionIndex]?.progression.bpm||this.progression?.bpm||84:this.progression?.bpm||84,i=Math.max(40,Math.min(240,t)),s=Math.max(1,this.barsPerChord);return Math.round(s*(24e4/i))}isPlaying(){return this.playing}getActiveIndex(){return this.activeIndex}getProgressStep(){return this.mode==="song"?this.songStep:this.progressStep}subscribeTick(t){return this.tickCallbacks.add(t),()=>this.tickCallbacks.delete(t)}notifyTick(){const t=this.getTotalSteps();this.mode==="song"?this.tickCallbacks.forEach(i=>i(this.activeIndex,this.songStep,this.activeSectionIndex,t,!0)):this.tickCallbacks.forEach(i=>i(this.activeIndex,this.progressStep,0,t,!1))}updateSongStepState(t){let i=0;for(let s=0;s<this.sections.length;s++){const o=this.sections[s].order.length;if(t<i+o){this.activeSectionIndex=s;const n=t-i;this.activeIndex=this.sections[s].order[n]??0,this.progressStep=n;return}i+=o}this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}startAutoplay(){this.stopAutoplay();const t=this.getStepIntervalMs();this.autoplayTimer=setInterval(()=>{if(this.playing){if(this.mode==="song"){const i=this.getTotalSteps();if(i<=0)return;this.songStep=(this.songStep+1)%i,this.updateSongStepState(this.songStep)}else{if(!this.progression||this.order.length<=0)return;this.activeIndex=(this.activeIndex+1)%this.order.length,this.progressStep=(this.progressStep+1)%this.order.length}this.playActiveChord(),this.notifyTick()}},t)}stopAutoplay(){this.autoplayTimer&&(clearInterval(this.autoplayTimer),this.autoplayTimer=null)}togglePlay(){return this.playing?(this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.stopAutoplay(),this.notifyTick()):(this.playing=!0,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.mode==="song"&&this.sections.length>0&&this.updateSongStepState(0),this.startAutoplay(),this.playActiveChord(),this.notifyTick()),this.playing}setABOverride(t,i,s="before"){t==null?this.abOverride=null:typeof t=="object"?this.abOverride=t:this.abOverride={index:t,chord:i||null,side:s}}clearABOverride(){this.abOverride=null}playActiveChord(){if(this.mode==="song"){const t=this.sections[this.activeSectionIndex];if(!t)return;const i=this.activeIndex,s=t.progression.chords[i];if(s){const o=s.notes&&s.notes.length>0?s.notes:V(s.name,j(t.progression.key,t.progression.scaleType)),n=di(o,4);ri(n,t.progression.genre,{bpm:t.progression.bpm,duration:this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0,feelSettings:this.feelSettings})}}else{if(!this.progression)return;const t=this.order[this.activeIndex]??0;let i=this.progression.chords[t];if(this.abOverride&&this.abOverride.index===t&&this.abOverride.side==="after"&&this.abOverride.chord&&(i=this.abOverride.chord),i){let s=Array.isArray(i.notes)?i.notes:[];if(s.length===0||!s.every(o=>typeof o=="string"&&o.trim().length>0)){const o=i.name||"CMAJ",n=this.progression.key||"C",r=this.progression.scaleType||"MAJOR";s=V(o,j(n,r))}this.playChordNotes(s,1.2),this.subBassEnabled&&s.length>0&&Ps(s[0],1.4)}}}auditionChord(t,i=.8){if(!t)return;let s=Array.isArray(t.notes)?t.notes:[];if(s.length===0||!s.every(o=>typeof o=="string"&&o.trim().length>0)){const o=t.name||"CMAJ",n=this.progression?.key||"C",r=this.progression?.scaleType||"MAJOR";s=V(o,j(n,r))}this.playChordNotes(s,i)}playChordAtIndex(t,i=.8,s,o){if(!this.progression||!this.progression.chords[t])return;const n=this.progression.chords[t];let r=Array.isArray(n.notes)?n.notes:[];if(r.length===0||!r.every(c=>typeof c=="string"&&c.trim().length>0)){const c=n.name||"CMAJ",d=this.progression.key||"C",p=this.progression.scaleType||"MAJOR";r=V(c,j(d,p))}this.playChordNotes(r,i,s,o)}playChordNotes(t,i,s,o){if(!this.progression)return;const n=Array.isArray(t)?t.filter(c=>typeof c=="string"&&c.trim().length>0):[];if(n.length===0)return;const r=s?zs(n,s):di(n,4);ri(r,this.progression.genre||"Unknown",{bpm:this.progression.bpm||120,duration:i||this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:this.playStyle??void 0,velocity:o,feelSettings:this.feelSettings})}jumpToStep(t){!this.progression||this.order.length<=0||(this.activeIndex=t%this.order.length,this.progressStep=t%this.order.length,this.playActiveChord(),this.notifyTick())}playFromBar(t){!this.progression||this.order.length<=0||(this.activeIndex=t%this.order.length,this.progressStep=t%this.order.length,this.playing=!0,this.startAutoplay(),this.playActiveChord(),this.notifyTick())}reset(){this.stopAutoplay(),this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.notifyTick()}}const S=new Mo,Oo=Oe.map(e=>e.name),Do=["rhodes","epiano","guitar","pad-strings","bell","organ","juno-pad","stab"];function Bo(e,t){const i=e.length+1,s=t.length+1,o=Array.from({length:i},()=>new Array(s).fill(0));for(let n=0;n<i;n++)o[n][0]=n;for(let n=0;n<s;n++)o[0][n]=n;for(let n=1;n<i;n++)for(let r=1;r<s;r++)o[n][r]=e[n-1]===t[r-1]?o[n-1][r-1]:1+Math.min(o[n-1][r-1],o[n-1][r],o[n][r-1]);return o[i-1][s-1]}function ye(e,t){if(typeof e!="string")return null;const i=e.trim();if(!i)return null;const s=i.toLowerCase(),o=t.find(d=>d.toLowerCase()===s);if(o)return o;let n=null,r=1/0;for(const d of t){const p=Bo(s,d.toLowerCase());p<r&&(r=p,n=d)}const c=Math.max(2,Math.floor(s.length*.4));return r<=c?n:null}function Fo(e){if(!Array.isArray(e))return;const t=[];for(const i of e){if(!i||typeof i!="object")continue;const s=i,o=ye(s.root,je),n=ye(s.quality,js);o&&n&&t.push({root:o,quality:n})}if(t.length)return t.slice(0,he)}function Po(e){if(!e||typeof e!="object"||Array.isArray(e))return;const t=e,i=ye(t.presetId,Do)??(typeof t.presetId=="string"&&t.presetId.trim()?t.presetId.trim():void 0);if(!i)return;const s=t.customConfig&&typeof t.customConfig=="object"&&!Array.isArray(t.customConfig)?t.customConfig:void 0;return{presetId:i,customConfig:s}}function wt(e,t){const i=e&&typeof e=="object"?e:{},s=ye(i.genre,Re)??t.genre,o=ye(i.mood,Oo)??t.mood,n=ye(i.key,je)??void 0,r=ye(i.scaleType,_s)??void 0,c=n&&r?Fo(i.chords):void 0;let d;typeof i.length=="number"&&Number.isFinite(i.length)&&(d=Math.max(De,Math.min(he,Math.round(i.length))));const p=typeof i.rhythmStyle=="string"&&i.rhythmStyle.trim()?i.rhythmStyle.trim():void 0,g=Po(i.instrumentConfig),l=i._rateLimit&&typeof i._rateLimit=="object"?i._rateLimit:void 0;return{genre:s,mood:o,key:n,scaleType:r,length:d,chords:c,rhythmStyle:p,instrumentConfig:g,_rateLimit:l}}const zo=[{id:"deepseek-v4-flash-free",name:"DeepSeek V4 Flash Free",provider:"opencodeai",vendor:"DeepSeek"},{id:"mimo-v2.5-free",name:"MiMo V2.5 Free",provider:"opencodeai",vendor:"Xiaomi"},{id:"laguna-s-2.1-free",name:"Laguna S 2.1 Free",provider:"opencodeai",vendor:"Stealth"},{id:"ling-3.0-flash-free",name:"Ling-3.0-flash Free",provider:"opencodeai",vendor:"Stealth"},{id:"nemotron-3-ultra-free",name:"Nemotron 3 Ultra Free",provider:"opencodeai",vendor:"NVIDIA"},{id:"north-mini-code-free",name:"North Mini Code Free",provider:"opencodeai",vendor:"Stealth"}],Dt=[{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash-Lite",provider:"google",vendor:"Google"},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",provider:"google",vendor:"Google"},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash",provider:"google",vendor:"Google"}],Ji="chroma-chords-llm-provider",Ki="chroma-chords-llm-model";function Xi(){const e=localStorage.getItem(Ji);return e==="opencodeai"||e==="anthropic"||e==="openrouter"||e==="google"?e:"google"}function Uo(e){localStorage.setItem(Ji,e)}function Qi(){const e=localStorage.getItem(Ki);return e?e==="gemini-1.5-flash"||e==="gemini-2.0-flash"||e==="gemini-2.5-flash"||e==="gemini-3.5-flash"||e==="gemini-1.5-pro"?"gemini-3.1-flash-lite":e:Dt[0].id}function kt(e){localStorage.setItem(Ki,e)}const St={genre:Re[0],mood:Oe[0].name},Zi="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev",Lo=12e3;async function Ro(){try{const e=await fetch(Zi);if(e.ok)return await e.json()}catch{}return null}const es={Uplifting:["happy","joy","bright","hope","celebrat","win","sun","morning","triumph"],Melancholy:["sad","rain","lonely","grief","loss","blue","tear","goodbye"],Dreamy:["dream","float","cloud","soft","sleep","hazy","ethereal","stars"],Tense:["fear","anxious","dark","storm","fight","chase","danger","thriller"],Warm:["cozy","home","fire","love","autumn","familiar","fireplace"],Nostalgic:["memory","childhood","old","faded","remember","summer","photo","yearbook"],Energetic:["energetic","pumped","hype","fast","running","workout","power","fire"],Dark:["dark","creepy","night","evil","shadow","gothic","gloomy"],Peaceful:["peaceful","calm","quiet","zen","relax","nature","gentle","still"],Groovy:["groovy","funky","danceable","rhythm","swing","bounce","jam"],Epic:["epic","heroic","grand","triumphant","majestic","legendary","glory"]},ts={Pop:["pop","radio","dance","catchy","hit"],"Lo-fi/Chill":["lofi","lo-fi","study","bedroom","tape","chill","relax"],"R&B/Soul":["rnb","r&b","soul","smooth","slow jam","sultry"],"Indie/Folk":["folk","acoustic","campfire","porch","story","indie"],Synthwave:["synth","80s","neon","retro","synthwave","arcade"],"Jazz-ish":["jazz","smoky","bar","lounge","late night","saxophone"],Gospel:["gospel","church","choir","soulful","worship"],Cinematic:["movie","film","epic","trailer","scene","cinematic"],Rock:["rock","guitar","drive","loud","energy","highway"],"House/Dance":["house","edm","club","rave","four on the floor","dance floor"],Blues:["blues","12 bar","delta","chicago blues","harmonica"],"Funk/Disco":["funk","funky","groovy","disco","slap bass","boogie"],"Country/Bluegrass":["country","bluegrass","nashville","banjo","twang"],"Reggae/Dub":["reggae","dub","jamaica","ska","offbeat","roots"],Metal:["metal","heavy metal","thrash","riff","shred","headbang","metallica","megadeth","slayer","iron maiden"],Punk:["punk","garage","mosh","rebel","skate"],"Ambient/Drone":["ambient","drone","atmospheric","soundscape","meditation","space"],"Trap/Hip-Hop":["trap","hiphop","hip-hop","rap","808","beat"],"Bossa Nova/Latin":["bossa","bossa nova","samba","latin","rio","habanera"],"Classical/Orchestral":["classical","orchestra","symphony","concerto","violin","chamber"],"EDM/Trance":["trance","techno","buildup","drop","festival"],Afrobeats:["afrobeats","afropop","lagos","highlife","afro"],Shoegaze:["shoegaze","fuzz","wall of sound","dream pop","gazer"]};function Ze(e,t){const i=e.toLowerCase();let s=null,o=0;return Object.keys(t).forEach(n=>{const r=t[n].reduce((c,d)=>c+(i.includes(d)?1:0),0);r>o&&(o=r,s=n)}),s}function is(e){const t=Ze(e,ts),i=Ze(e,es);return!t||!i?null:{genre:t,mood:i}}async function jo(e){const t=new AbortController,i=setTimeout(()=>t.abort(),Lo);try{const o=await fetch(Zi,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:e,provider:Xi(),model:Qi()}),signal:t.signal}),n=await o.json().catch(()=>null);if(!o.ok||n&&typeof n=="object"&&"error"in n){const r=n&&typeof n=="object"&&"error"in n?String(n.error):`HTTP ${o.status}`,c=new Error(`Classifier request failed: ${r}`);throw n&&typeof n=="object"&&"_rateLimit"in n&&(c._rateLimit=n._rateLimit),c}return n}finally{clearTimeout(i)}}async function _o(e){const t=e.trim(),i=t.toLowerCase();if(i.startsWith("mock")||i.startsWith("test")){const o=t.replace(/^(mock|test)\s*:?\s*/i,"").trim(),n=Ze(o,ts)??"Synthwave",r=Ze(o,es)??"Dreamy",c={Metal:"stab",Rock:"guitar",Punk:"stab","Lo-fi/Chill":"epiano",Synthwave:"juno-pad","EDM/Trance":"juno-pad",Gospel:"organ","Reggae/Dub":"organ","Country/Bluegrass":"guitar","Bossa Nova/Latin":"guitar","Ambient/Drone":"pad-strings",Cinematic:"pad-strings","Classical/Orchestral":"pad-strings","Jazz-ish":"rhodes",Pop:"rhodes","R&B/Soul":"epiano"},d={Metal:"heavy_strum",Rock:"driving_strum",Punk:"fast_power_strum","Lo-fi/Chill":"slow_arpeggio",Synthwave:"retro_16th_arp","EDM/Trance":"fast_triplets",Gospel:"block_chords","Reggae/Dub":"offbeat_ska","Jazz-ish":"swing_feel","Bossa Nova/Latin":"syncopated_bossa","Ambient/Drone":"sustained_pad","Classical/Orchestral":"slow_arpeggio",Pop:"straight_8ths"},p={Metal:{key:"E",scaleType:"NATURAL_MINOR",chords:[{root:"E",quality:"min"},{root:"G",quality:"maj"},{root:"D",quality:"maj"},{root:"C",quality:"maj"},{root:"E",quality:"min"},{root:"A",quality:"min"},{root:"B",quality:"dom7"},{root:"E",quality:"min"}]},Rock:{key:"A",scaleType:"MAJOR",chords:[{root:"A",quality:"maj"},{root:"D",quality:"maj"},{root:"E",quality:"dom7"},{root:"F#",quality:"min"},{root:"D",quality:"maj"},{root:"A",quality:"maj"},{root:"E",quality:"dom7"},{root:"A",quality:"maj"}]},"Jazz-ish":{key:"F",scaleType:"DORIAN",chords:[{root:"F",quality:"min7"},{root:"A#",quality:"dom7"},{root:"D#",quality:"maj7"},{root:"G#",quality:"maj7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"min7"},{root:"F",quality:"dom7"}]},"Lo-fi/Chill":{key:"C",scaleType:"DORIAN",chords:[{root:"C",quality:"min7"},{root:"F",quality:"maj7"},{root:"A#",quality:"maj7"},{root:"D#",quality:"maj7"},{root:"C",quality:"min7"},{root:"D#",quality:"maj7"},{root:"F",quality:"min7"},{root:"G",quality:"min7"}]},Gospel:{key:"C",scaleType:"MAJOR",chords:[{root:"C",quality:"maj"},{root:"E",quality:"min7"},{root:"F",quality:"maj7"},{root:"G",quality:"dom7"},{root:"A",quality:"min7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"maj"}]},_default:{key:"F#",scaleType:"DORIAN",chords:[{root:"F#",quality:"min7"},{root:"B",quality:"maj"},{root:"C#",quality:"min7"},{root:"E",quality:"maj"},{root:"F#",quality:"min7"},{root:"A",quality:"maj7"},{root:"B",quality:"min7"},{root:"C#",quality:"dom7"}]}},g=p[n]||p._default,l=c[n]||"rhodes",v=d[n]||"slow_arpeggio",b={genre:n,mood:r,key:g.key,scaleType:g.scaleType,length:8,chords:g.chords,rhythmStyle:v,instrumentConfig:{presetId:l,customConfig:{envelope:{attack:.05,decay:.5,sustain:.6,release:1.2}}}};return wt(b,{genre:n,mood:r})}const s=is(e);try{const o=await jo(e);return wt(o,s??St)}catch(o){console.warn("LLM classification failed, falling back to keyword heuristic:",o);const n=wt(s??St,St);return o&&typeof o=="object"&&"_rateLimit"in o&&(n._rateLimit=o._rateLimit),n}}class Go{static async resolvePrompt(t,i,s,o,n,r){let c=r||null,d=null,p=null;if(!c&&n&&n.trim().length>0)try{c=await _o(n)}catch(v){console.warn("Failed to classify prompt via LLM/local fallback:",v)}const g=!!(c&&c.chords?.length&&c.key&&c.scaleType);let l=null;return g&&c&&c.chords&&c.key&&c.scaleType&&(l=go(t,c.key,c.scaleType,c.chords,c.genre||i,c.mood||s)),l||(l=Mt(t,i,s,{length:o})),g&&c&&(c.instrumentConfig?.presetId&&(d=Ms(c.instrumentConfig.presetId)??null),c.rhythmStyle&&(p=Os(c.rhythmStyle)??null)),l.chords.length>o&&(l={...l,chords:l.chords.slice(0,o)}),n&&(l={...l,searchTerm:n}),{progression:l,instrument:d,playStyle:p,normalizedSuggestion:c}}}const We=[{name:"Verse",desc:"Settled, familiar.",reorder:e=>Array.from({length:e},(t,i)=>i)},{name:"Chorus",desc:"Brighter, opens the key up.",reorder:e=>Array.from({length:e},(t,i)=>(i+Math.ceil(e/2))%e)},{name:"Pre-chorus",desc:"Leans in, sets up the turn.",reorder:e=>Array.from({length:e},(t,i)=>(i+1)%e)},{name:"Bridge",desc:"Detours, borrows a shadow chord.",reorder:e=>Array.from({length:e},(t,i)=>e-1-i)},{name:"Outro",desc:"Settles back down.",reorder:e=>Array.from({length:e},(t,i)=>(i-1+e)%e)}];class Ee{static createInitialSong(t,i){const s=i||Array.from({length:t.chords.length},(o,n)=>n);return[{name:We[0].name,desc:We[0].desc,progression:t,order:s.slice()}]}static addSection(t,i){if(t.length>=We.length)return{sections:t,activeIndex:t.length-1};const s=We[t.length],o=s.reorder(i.chords.length),n={name:s.name,desc:s.desc,progression:i,order:o},r=[...t,n];return{sections:r,activeIndex:r.length-1}}static syncActiveSection(t,i,s,o){if(!t[i])return t;const n=[...t];return n[i]={...n[i],progression:s,order:o.slice()},n}}const G=4,de=45e3,pi="chroma_chords_capacity_v2";class Vo{constructor(){this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=Date.now(),this.timer=null,this.subscribers=new Set,this.init()}init(){try{if(typeof localStorage<"u"){const t=localStorage.getItem(pi),i=Date.now();if(t){const s=JSON.parse(t),o=typeof s.charges=="number"?s.charges:G,n=typeof s.lastTime=="number"?s.lastTime:i;if(o<G){const r=Math.max(0,i-n),c=Math.floor(r/de);this.charges=Math.min(G,o+c);const d=r%de;this.rechargeNextSec=Math.max(1,Math.ceil((de-d)/1e3)),this.lastCapacityTime=i-d}else this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=i}else this.charges=G,this.rechargeNextSec=45,this.lastCapacityTime=i}}catch{this.charges=G,this.rechargeNextSec=45}this.save(),this.startTimer()}save(){try{typeof localStorage<"u"&&localStorage.setItem(pi,JSON.stringify({charges:this.charges,lastTime:this.lastCapacityTime}))}catch{}}startTimer(){this.timer&&clearInterval(this.timer),this.timer=setInterval(()=>{if(this.charges<G){const t=Date.now(),i=Math.max(0,t-this.lastCapacityTime);if(i>=de){const o=Math.floor(i/de);this.charges=Math.min(G,this.charges+o),this.lastCapacityTime=t-i%de,this.save()}const s=(t-this.lastCapacityTime)%de;this.rechargeNextSec=Math.max(1,Math.ceil((de-s)/1e3))}else this.rechargeNextSec=45;this.notify()},1e3)}getState(){return{charges:this.charges,max:G,rechargeNextSec:this.rechargeNextSec}}getCharges(){return this.charges}getRechargeNextSec(){return this.rechargeNextSec}getCapacityMax(){return G}spendCharge(){return this.charges<=0?(this.notify(),!1):(this.charges===G&&(this.lastCapacityTime=Date.now()),this.charges-=1,this.save(),this.notify(),!0)}subscribe(t){return this.subscribers.add(t),t(this.getState()),()=>{this.subscribers.delete(t)}}notify(){const t=this.getState();this.subscribers.forEach(i=>{try{i(t)}catch(s){console.error("Error in CapacityService subscriber callback:",s)}})}}const Bt=new Vo;var qo=Object.defineProperty,Yo=Object.getOwnPropertyDescriptor,J=(e,t,i,s)=>{for(var o=s>1?void 0:s?Yo(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&qo(t,i,o),o};let q=class extends se{constructor(){super(...arguments),this.compact=!1,this.hideCapacity=!1,this.isAdmin=!1,this.capacityCharges=4,this.capacityMax=4,this.rechargeNextSec=60,this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.syncStatus="synced",this.title="Chroma Chords",this.accountMenuOpen=!1,this.showCapacityNote=!1,this.unsubscribeProjects=null,this.unsubscribeCapacity=null}connectedCallback(){super.connectedCallback(),this.unsubscribeProjects=F.subscribeProjects(()=>{this.savedCount=F.getProjects().length,this.syncStatus=F.getSyncStatus(),this.requestUpdate()}),this.unsubscribeCapacity=Bt.subscribe(e=>{this.capacityCharges=e.charges,this.capacityMax=e.max,this.rechargeNextSec=e.rechargeNextSec,this.requestUpdate()}),this.savedCount=F.getProjects().length}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeProjects&&this.unsubscribeProjects(),this.unsubscribeCapacity&&this.unsubscribeCapacity()}toggleCapacityNote(e){e.stopPropagation(),this.showCapacityNote=!this.showCapacityNote,this.accountMenuOpen=!1}toggleAccountMenu(e){e.stopPropagation(),this.accountMenuOpen=!this.accountMenuOpen,this.showCapacityNote=!1}onSignIn(){this.dispatchEvent(new CustomEvent("request-login",{bubbles:!0,composed:!0}))}onSignOut(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("request-logout",{bubbles:!0,composed:!0}))}onViewSets(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("view-sets",{bubbles:!0,composed:!0}))}onSyncNow(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("sync-projects",{bubbles:!0,composed:!0}))}render(){const e=(this.userEmail||"U")[0].toUpperCase();return u`
  ...
  `;J([$({type:Boolean})],q.prototype,"compact",2);J([$({type:Boolean})],q.prototype,"hideCapacity",2);J([$({type:Boolean})],q.prototype,"isAdmin",2);J([$({type:Number})],q.prototype,"capacityCharges",2);J([$({type:Number})],q.prototype,"capacityMax",2);J([$({type:Number})],q.prototype,"rechargeNextSec",2);J([$({type:Boolean})],q.prototype,"isAuthenticated",2);J([$({type:String})],q.prototype,"userEmail",2);J([$({type:Number})],q.prototype,"savedCount",2);J([$({type:String})],q.prototype,"syncStatus",2);J([$({type:String})],q.prototype,"title",2);J([x()],q.prototype,"accountMenuOpen",2);J([x()],q.prototype,"showCapacityNote",2);q=J([oe("app-header")],q);var Ho=Object.defineProperty,Wo=Object.getOwnPropertyDescriptor,Xt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Wo(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Ho(t,i,o),o};const Ft=["bean","bird","cat","note"];function Pt(e=.45){return{show:Math.random()<e,kind:Ft[Math.floor(Math.random()*Ft.length)]}}function zt(e){return e[Math.floor(Math.random()*e.length)]}class ss{constructor(t=7,i=1800){this.threshold=t,this.windowMs=i,this.count=0,this.lastClickAt=0}click(){const t=Date.now();return t-this.lastClickAt>this.windowMs&&(this.count=0),this.lastClickAt=t,this.count+=1,this.count>=this.threshold?(this.count=0,!0):!1}}const Jo={bean:{width:92,height:86},bird:{width:88,height:88},cat:{width:90,height:88},note:{width:74,height:67}};let _e=class extends se{constructor(){super(...arguments),this.kind="bean",this.scale=1}willUpdate(e){if(e.has("kind")||e.has("scale")){const{width:t,height:i}=Jo[this.kind];this.style.width=`${t*this.scale}px`,this.style.height=`${i*this.scale}px`}}renderBean(){const e="#D98A54";return u`
    ...
    `}render(){const e=this.kind==="bird"?this.renderBird():this.kind==="cat"?this.renderCat():this.kind==="note"?this.renderNote():this.renderBean();return e?u`<div style="transform:scale(${this.scale}); transform-origin:top left;">${e}</div>`:Mi}};_e.styles=ie`
    :host {
      display: block;
      pointer-events: none;
      user-select: none;
  ...
  `;Xt([$({type:String})],_e.prototype,"kind",2);Xt([$({type:Number})],_e.prototype,"scale",2);_e=Xt([oe("mascot-character")],_e);var Ko=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,Qt=(e,t,i,s)=>{for(var o=s>1?void 0:s?Xo(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Ko(t,i,o),o};const Ut=3200;let Ge=class extends se{constructor(){super(...arguments),this.trigger=0,this.visible=!1,this.hideTimer=null}updated(e){e.has("trigger")&&this.trigger>0&&(this.visible=!0,this.hideTimer&&clearTimeout(this.hideTimer),this.hideTimer=setTimeout(()=>{this.visible=!1},Ut))}disconnectedCallback(){super.disconnectedCallback(),this.hideTimer&&clearTimeout(this.hideTimer)}render(){return this.visible?u`
      <div class="caption">✨ you found the whole gang! ✨</div>
      <div class="overlay">
        <div class="row">
          ${Ft.map(e=>u`<mascot-character .kind=${e} .scale=${.5}></mascot-character>`)}
        </div>
      </div>
    `:Mi}};Ge.styles=ie`
    :host {
    ...
    .overlay {
      ...
      gap: 10px;
      pointer-events: none;
      animation: egg-pop ${Ut}ms ease forwards;
    }
    .caption {
      position: fixed;
      left: 50%;
      ...
      white-space: nowrap;
      pointer-events: none;
      animation: egg-caption-pop ${Ut}ms ease forwards;
    }
    .row {
      display: flex;
                ...
                <div class="pill ${l===this.genre?"selected":""}" style=${l===this.genre?`background:${e}`:""} @click=${()=>this.selectGenre(l)}>
                  <div class="genre-icon-wrap">
                    <svg width="12" height="12" viewBox="0 0 24 24">
                      <rect x="6" y="6" width="12" height="12" rx=${sn[v%3]} fill=${tn[v%3]} />
                    </svg>
                  </div>
                  ${l}
                </div>
  ...
  `;O([$({type:String})],N.prototype,"genre",2);O([$({type:String})],N.prototype,"mood",2);O([$({type:Number})],N.prototype,"length",2);O([x()],N.prototype,"freeText",2);O([x()],N.prototype,"placeholderIdx",2);O([x()],N.prototype,"llmSuggestion",2);O([x()],N.prototype,"llmResolved",2);O([x()],N.prototype,"classifyError",2);O([x()],N.prototype,"expandedGenre",2);O([x()],N.prototype,"expandedMood",2);O([x()],N.prototype,"mascot",2);O([x()],N.prototype,"mascotSlot",2);O([x()],N.prototype,"peekMascot",2);O([x()],N.prototype,"peekSide",2);O([$({type:Boolean})],N.prototype,"isAuthenticated",2);O([$({type:String})],N.prototype,"userEmail",2);O([$({type:Boolean})],N.prototype,"isAdmin",2);O([$({type:Boolean})],N.prototype,"isGenerating",2);O([x()],N.prototype,"currentProvider",2);O([x()],N.prototype,"currentModel",2);O([x()],N.prototype,"showAdminModal",2);O([x()],N.prototype,"isClassifying",2);O([x()],N.prototype,"loadingMsgIdx",2);O([x()],N.prototype,"googleRemaining",2);O([x()],N.prototype,"googleLimit",2);O([x()],N.prototype,"googleCooldownSec",2);O([x()],N.prototype,"orRemaining",2);O([x()],N.prototype,"orLimit",2);O([x()],N.prototype,"capacityCharges",2);O([x()],N.prototype,"rechargeNextSec",2);O([x()],N.prototype,"showCapacityNote",2);O([x()],N.prototype,"paradeTrigger",2);N=O([oe("seed-screen")],N);function ui(e){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=e.match(/^([A-Ga-g][#b]?)(-?\d+)?$/);if(!i)return 60;const s=i[1].charAt(0).toUpperCase()+i[1].slice(1),o=t[s]??0,n=i[2]!==void 0?parseInt(i[2],10):4;return Math.min(127,Math.max(0,(n+1)*12+o))}function os(e,t,i,s=1,o){const n=t&&t.length>0?t.map(m=>e.chords[m]).filter(m=>!!m):e.chords,r=e.bpm||120,c=s*240/r,d=i?Se.find(m=>m.name.toLowerCase()===i.toLowerCase()):void 0,p=Vt[e.genre]||{},g=d?.patch??{},l={...p,...g},v=p.duration??.9,b=g.durationMultiplier?v*g.durationMultiplier:v,f=l.spread??0,a=0,h=[];return n.forEach((m,y)=>{const w=a/100*.04*(y%2===1?1:0),k=y*c+w,B=(m.notes&&m.notes.length>0?m.notes:["C","E","G"]).map(_=>`${_}4`);if(l.arpMode&&l.arpMode!=="off"){const _=l.arpRate??"1/16",W=l.arpRange??1,K=l.arpMode,X=Fi(_,r),ce=Pi(B,W),Q=zi(ce,K),T=l.duration?l.duration:Math.max(.6,b);Q.forEach((Y,me)=>{const tt=k+me*X;h.push({note:Y,midi:ui(Y),startTime:tt,duration:T})})}else B.forEach((_,W)=>{const K=W*f*.1,X=k+K;h.push({note:_,midi:ui(_),startTime:X,duration:b})})}),h}function rn(e){const t=[];let i=Math.max(0,Math.floor(e));for(t.push(i&127);(i>>=7)>0;)t.unshift(i&127|128);return t}function an(e,t,i,s=1,o){const n=e.bpm||120,r=480,c=os(e,t,i,s),d=[];c.forEach(m=>{const y=Math.round(m.startTime/(60/n)*r),w=Math.max(1,Math.round(m.duration/(60/n)*r));d.push({tick:y,type:"on",midi:m.midi}),d.push({tick:y+w,type:"off",midi:m.midi})}),d.sort((m,y)=>m.tick!==y.tick?m.tick-y.tick:m.type!==y.type?m.type==="off"?-1:1:m.midi-y.midi);const p=[],g=Math.round(6e7/n);p.push(0),p.push(255,81,3),p.push(g>>16&255,g>>8&255,g&255);const l="Chroma Chords";p.push(0),p.push(255,3,l.length);for(let m=0;m<l.length;m++)p.push(l.charCodeAt(m));let v=0;d.forEach(m=>{const y=m.tick-v;v=m.tick,p.push(...rn(y)),m.type==="on"?p.push(144,m.midi,80):p.push(128,m.midi,0)}),p.push(0),p.push(255,47,0);const b=[77,84,104,100,0,0,0,6,0,0,0,1,r>>8&255,r&255],f=p.length,a=[77,84,114,107,f>>24&255,f>>16&255,f>>8&255,f&255],h=new Uint8Array(b.length+a.length+p.length);return h.set(b,0),h.set(a,b.length),h.set(p,b.length+a.length),h}function ln(e,t,i,s){const o=an(e,t,s),n=new Blob([o],{type:"audio/midi"}),r=(e.key||"C").toLowerCase(),c=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),d=e.bpm||120,p=`chroma-chords-${r}-${c}-${d}bpm.mid`;ns(n,p)}function cn(e,t){const i=new Ei({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination();switch((e?ke.find(n=>n.name.toLowerCase()===e.toLowerCase()):void 0)?.instrument??(t?Gt[t]:void 0)??"rhodes"){case"bell":return new H(Le,{harmonicity:5.5,modulationIndex:12,envelope:{attack:.002,decay:1.1,sustain:.05,release:.8},modulationEnvelope:{attack:.002,decay:.5,sustain:0,release:.4},volume:-16}).connect(i);case"epiano":return new H(Le,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-14}).connect(i);case"guitar":return new H(ae,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.5,sustain:.05,release:.6},volume:-13}).connect(i);case"organ":return new H(ae,{oscillator:{type:"fatsquare",count:3,spread:20},envelope:{attack:.015,decay:.1,sustain:.9,release:.35},volume:-16}).connect(i);case"pad-strings":{const n=new Ai({decay:4.5,wet:.35}).connect(i);return new H(ae,{oscillator:{type:"sine"},envelope:{attack:.9,decay:.4,sustain:.8,release:2.8},volume:-15}).connect(n)}case"juno-pad":{const n=new jt({frequency:.8,delayTime:3.5,depth:.7,wet:.5}).start().connect(i);return new H(ae,{oscillator:{type:"fatsawtooth",count:3,spread:25},envelope:{attack:.35,decay:.4,sustain:.85,release:1.6},volume:-16}).connect(n)}case"stab":return new H(Ni,{oscillator:{type:"square"},envelope:{attack:.004,decay:.14,sustain:.12,release:.15},filterEnvelope:{attack:.004,decay:.15,sustain:.1,release:.2,baseFrequency:300,octaves:4},volume:-14}).connect(i);case"rhodes":default:return new H(Le,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-12}).connect(i)}}function dn(e){const t=e.numberOfChannels,i=e.sampleRate,s=16,o=s/8,n=t*o,r=e.length*t*o,c=new ArrayBuffer(44+r),d=new DataView(c),p=(v,b)=>{for(let f=0;f<b.length;f++)d.setUint8(v+f,b.charCodeAt(f))};p(0,"RIFF"),d.setUint32(4,36+r,!0),p(8,"WAVE"),p(12,"fmt "),d.setUint32(16,16,!0),d.setUint16(20,1,!0),d.setUint16(22,t,!0),d.setUint32(24,i,!0),d.setUint32(28,i*n,!0),d.setUint16(32,n,!0),d.setUint16(34,s,!0),p(36,"data"),d.setUint32(40,r,!0);const g=[];for(let v=0;v<t;v++)g.push(e.getChannelData(v));let l=44;for(let v=0;v<e.length;v++)for(let b=0;b<t;b++){const f=Math.max(-1,Math.min(1,g[b][v])),a=f<0?f*32768:f*32767;d.setInt16(l,a,!0),l+=2}return new Blob([new Uint8Array(c)],{type:"audio/wav"})}async function pn(e,t,i,s,o=1,n){const r=os(e,t,s,o);if(!r.length)return;const d=r.reduce((a,h)=>Math.max(a,h.startTime+h.duration),0)+1.2,p=await us(async()=>{const a=cn(i,e.genre);r.forEach(h=>{a.triggerAttackRelease(h.note,h.duration,h.startTime)})},d),g=dn(p.get()),l=(e.key||"C").toLowerCase(),v=(e.mood||"progression").toLowerCase().replace(/\s+/g,"-"),b=e.bpm||120,f=`chroma-chords-${l}-${v}-${b}bpm.wav`;ns(g,f)}function ns(e,t){if(typeof URL>"u"||typeof URL.createObjectURL!="function")return;const i=URL.createObjectURL(e);if(typeof document>"u")return;const s=document.createElement("a");s.href=i,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(i),1e3)}var hn=Object.defineProperty,un=Object.getOwnPropertyDescriptor,Ie=(e,t,i,s)=>{for(var o=s>1?void 0:s?un(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&hn(t,i,o),o};const gn=L`
...
`,fn=[{device:"m8",mono:"M8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:gn},{device:"circuit",mono:"CT",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:mn}];let le=class extends se{constructor(){super(...arguments),this.open=!1,this.visible=!1,this.progression=null,this.order=[],this.instrument=null,this.playStyle=null,this.onKeyDown=e=>{e.key==="Escape"&&this.isOpened&&this.close()}}get isOpened(){return this.open||this.visible}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKeyDown)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}close(){this.emit("close")}handleDeviceClick(e){if(!this.progression)return;const t=Co(this.progression,e,this.order);window.open(t,"_blank");const i=e==="m8"?"M8 Tracker":"Circuit Tracks";this.emit("toast",`Opening ${i} helper...`),this.close()}async handleWavClick(){if(this.progression){this.emit("toast","Generating WAV audio...");try{await pn(this.progression,this.order,this.instrument,this.playStyle),this.emit("toast","WAV file downloaded")}catch(e){console.error("WAV export failed",e),this.emit("toast","Failed to generate WAV file")}this.close()}}handleMidiClick(){if(this.progression){try{ln(this.progression,this.order,this.instrument,this.playStyle),this.emit("toast","MIDI file downloaded")}catch(e){console.error("MIDI export failed",e),this.emit("toast","Failed to generate MIDI file")}this.close()}}render(){const e=this.isOpened;return u`
  ...
  `;Ie([$({type:Boolean})],le.prototype,"open",2);Ie([$({type:Boolean})],le.prototype,"visible",2);Ie([$({type:Object})],le.prototype,"progression",2);Ie([$({type:Array})],le.prototype,"order",2);Ie([$({type:String})],le.prototype,"instrument",2);Ie([$({type:String})],le.prototype,"playStyle",2);le=Ie([oe("share-modal")],le);var vn=Object.defineProperty,bn=Object.getOwnPropertyDescriptor,C=(e,t,i,s)=>{for(var o=s>1?void 0:s?bn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&vn(t,i,o),o};const $t=[{name:"Oasis",color:"#F6D98B",r:10,plain:"leans on a bright chord that shouldn’t fit, then walks home",theory:"borrowed major ♭III, plagal IV–I, sus4 held over a static root",hoist:["E♭maj7","Fmaj7","A♭"],font:"Anton, sans-serif",pillFs:13,pillTrack:"0.08em"},{name:"Radiohead",color:"#C9A9E0",r:3,plain:"swaps a chord for its stranger neighbour a third away",theory:"chromatic mediants and modal mixture — ♭VI and ♭III against a major tonic",hoist:["A♭maj7","E♭maj7","Em7"],font:"'Space Mono', monospace",weight:700,pillFs:12.5,pillTrack:"0.02em"},{name:"Nirvana",color:"#F2A79B",r:2,plain:"moves the root in big jumps and leaves the middle empty",theory:"power-chord roots by minor third and tritone — no thirds, so major or minor stays open",hoist:["A♭","E♭maj7","B♭"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"0.04em"},{name:"Steely Dan",color:"#9CC0EC",r:13,plain:"adds one note that makes a plain chord sound expensive",theory:"major triad plus 9th with no 7th, ii–V chains, tritone substitution",hoist:["Cmaj9","D♭7","Fm7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,italic:!0,pillFs:13,pillTrack:"0.01em"},{name:"Mac DeMarco",color:"#B8CC9E",r:7,plain:"two lush chords looped loose, bass sliding underneath",theory:"maj7 vamp with chromatic bass motion, no real resolution",hoist:["Fmaj7","Cmaj9","Em7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"-0.01em"}],gi=["Pop","Lo-fi/Chill","R&B/Soul","Synthwave","Indie/Folk","Rock","Jazz-ish","Cinematic"],mi=["Uplifting","Melancholy","Dreamy"],xn={Uplifting:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5",Melancholy:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15",Dreamy:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0",Tense:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12",Warm:"M12 4 a6.5 6.5 0 1 0 6.5 6.5",Nostalgic:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},fe={Tonic:"home",Submediant:"drifting",Subdominant:"lifting",Supertonic:"stepping up",Mediant:"wistful",Dominant:"pulling home","Dominant 7th":"pulling home"},yn=fe,Ct=["A","S","D","F","G","H","J","K"],wn=["Octave up","1st inversion","Low root"],kn=[{label:"Major",sub:"bright"},{label:"Minor",sub:"warm"},{label:"Suspended (sus)",sub:"floating"},{label:"Diminished",sub:"unstable"}],Sn=[{label:"None",sub:"triad only"},{label:"6th",sub:"soft lift"},{label:"7th (dom / m7)",sub:"classic tension"},{label:"Major 7th (M7)",sub:"lush, jazzy"},{label:"9th",sub:"wide, colorful"}],fi=[{k:"swing",label:"Swing",hint:"How far behind the beat the notes land",steps:[{v:0,name:"Straight"},{v:25,name:"Light"},{v:55,name:"Loose"},{v:85,name:"Heavy"}]},{k:"spread",label:"Spread",hint:"How far apart the notes sit",steps:[{v:15,name:"Tight"},{v:50,name:"Close"},{v:75,name:"Open"},{v:95,name:"Wide"}]},{k:"density",label:"Density",hint:"How many notes per chord",steps:[{v:20,name:"Sparse"},{v:50,name:"Simple"},{v:75,name:"Full"},{v:95,name:"Busy"}]}],pe={swing:0,spread:50,density:50,tone:"Warm"},vi=["Warm","Glassy","Dusty"],Tt=["C min","A min","F min","D min","G min","E♭ maj","C maj","G maj","F maj"],In=["C","D♭","D","E♭","E","F","F♯","G","A♭","A","B♭","B"],bi={Darker:["Three chords that add weight without changing the key.","All three pull from the parallel minor or its subdominant — same key, more shadow."],"More tension":["Three chords that lean harder into the next bar.","Dominant approaches — each one aims at a chord later in the loop."],Dreamier:["Three chords that open the bar up and let it float.","Extensions and softer degrees — less pull toward home."],"Resolve home":["Three chords that settle the bar back to center.","Tonic and its neighbours — the sense of arriving."],Borrowed:["Four chords from the minor version of this key. Each one swaps in for a chord you already have.","Modal interchange — four chords from the parallel minor, each matched to the chord it can stand in for."]},xi=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],yi={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},Je={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},Ke={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},Lt={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},Ue={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}};function $n(e){const t=e===""?"maj":e;if(Ue[5][t]||Ue[6][t])return t;const i=Lt[t];return i&&(Ue[5][i]||Ue[6][i])?i:"maj"}function Cn(e){const t=$n(e.q),i=[];return[[6,4],[5,9]].forEach(([s,o])=>{const n=Ue[s][t];if(!n)return;const r=((e.rootPc-o)%12+12)%12;i.push({rootFret:r,frets:n.map(c=>c===null?null:c+r)})}),i.length?(i.sort((s,o)=>s.rootFret-o.rootFret),i[0].frets):null}function Tn(e){const t=[7,0,4,9],i=e.intervals.map(r=>(e.rootPc+r)%12),s=r=>{const c=new Set(r);let d=null;const p=[],g=l=>{if(l===4){const v=p.map((h,m)=>(t[m]+h)%12);for(const h of c)if(v.indexOf(h)<0)return;for(const h of v)if(!c.has(h))return;const b=p.filter(h=>h>0),f=b.length?Math.max(...b)-Math.min(...b):0;if(f>3)return;const a=f*12+p.reduce((h,m)=>h+m,0);(!d||a<d.score)&&(d={frets:p.slice(),score:a});return}for(let v=0;v<=5;v++)p.push(v),g(l+1),p.pop()};return g(0),d},o=s(i);if(o)return o.frets;const n=s(e.intervals.filter(r=>r!==7).map(r=>(e.rootPc+r)%12));return n?n.frets:null}const wi=[{key:"Darker",label:"Darker",tension:.55},{key:"More tension",label:"Tense",tension:.9},{key:"Dreamier",label:"Dreamy",tension:.3},{key:"Resolve home",label:"Home",tension:.05},{key:"Borrowed",label:"Borrow",tension:.42,twoTone:!0}];let I=class extends se{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.userEmail=null,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.isGenerating=!1,this.libraryOpen=!1,this.isMobile=typeof window<"u"?window.innerWidth<900:!1,this.activeView="loop",this.vibeOpen=!1,this.selectedBand=null,this.freeText="",this.vibePlaceholderIdx=0,this.expandedGenre=!1,this.expandedMood=!1,this.activeSwapFamily="Darker",this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.detailIndex=0,this.abPick=null,this.abSide="before",this.abPlaying=!1,this.savedSets=[],this.renamingId=null,this.draftName="",this.confirmDeleteId=null,this.librarySearch="",this.librarySelectMode=!1,this.librarySelected=[],this.playInstrument="Piano",this.showDegrees=!1,this.mobileSheetOpen=!1,this.mobileDetailSheetOpen=!1,this.padFlash=-1,this.padHeld=-1,this.gridFor=-1,this.lastPad=null,this.tempoOpen=!1,this.feelOpen=!1,this.shareOpen=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.barsPerChord=1,this.keyIdx=0,this.swing=0,this.spread=50,this.density=50,this.tone="Warm",this.showAdvancedFeel=!1,this.humanEngineState=null,this.auditionDeg=null,this.auditionName=null,this.auditionBar=0,this.gridTimer=null,this.vibeExamples=["Rainy drive at 2am, first day of summer...","Portishead trip-hop","Bohemian Rhapsody","Tame Impala neo-psychedelia","Warm acoustic fireplace"],this.placeholderTimer=null,this.unsubscribeProjects=null,this.onResizeHandler=()=>{this.isMobile=window.innerWidth<900},this.handleKeyDown=e=>{const t=e.target;if(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"))return;if(e.key===" "||e.code==="Space"){e.preventDefault(),this.togglePlay();return}if(e.key==="Escape"){e.preventDefault(),(this.tempoOpen||this.feelOpen)&&(this.tempoOpen=!1,this.feelOpen=!1,this.requestUpdate());return}const i=Ct.map(o=>o.toLowerCase()).indexOf((e.key||"").toLowerCase()),s=this.progression?.chords||[];if(i>=0&&i<s.length){e.preventDefault();const o=88+i%3*6,n=s[i],r=this.getChordLadder(n),c=this.getLadderHome(n);let d=c>=0?c:0,p=1,g="1st inversion";this.lastPad?.idx===i&&typeof this.lastPad.reach=="number"&&r.length>0&&(d=(this.lastPad.reach+1)%r.length),e.shiftKey&&(p=0,g="up an octave");const l=r.length>0&&r[d]?r[d]:n.name,v=d!==c&&!!r[d],b=this.progression?.key||"C",f=this.progression?.scaleType||"MAJOR",a=V(l,j(b,f));this.padFlash=i,this.padHeld=i,this.gridFor=i;const h=v?"→ "+l:p===0?"UP AN OCTAVE":p===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:i,voicing:g,vel:o,zone:p,reach:d,meta:h},S.playChordNotes(a,.85,g,o),this.requestUpdate()}},this.handleKeyUp=e=>{Ct.map(i=>i.toLowerCase()).indexOf((e.key||"").toLowerCase())>=0&&(this.padFlash=-1,this.requestUpdate())},this.toggleVibe=()=>{this.vibeOpen=!this.vibeOpen,this.requestUpdate()},this.toggleLibrary=()=>{this.libraryOpen=!this.libraryOpen,this.dispatchEvent(new CustomEvent("library-open-change",{detail:this.libraryOpen,bubbles:!0,composed:!0})),this.requestUpdate()},this.togglePlay=()=>{this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))},this.clearSelection=()=>{this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.abPick=null,this.abPlaying=!1,S.setABOverride(null),this.requestUpdate()},this.toggleABPlayback=()=>{if(!(!this.progression||this.swapIndex===null)){if(this.abPlaying=!this.abPlaying,this.abPlaying){const e=j(this.progression.key,this.progression.scaleType),t=this.abSide==="after"&&this.abPick?{...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:V(this.abPick.chord,e)}:this.progression.chords[this.swapIndex];S.setABOverride({index:this.swapIndex,side:this.abSide,chord:t}),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))}else this.playing&&this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),S.setABOverride(null);this.requestUpdate()}},this.confirmSwap=()=>{if(this.swapIndex===null||!this.abPick||!this.progression)return;const e=j(this.progression.key,this.progression.scaleType),t=V(this.abPick.chord,e),i=[...this.progression.chords];i[this.swapIndex]={...i[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:t};const s={...this.progression,chords:i};this.dispatchEvent(new CustomEvent("progression-change",{detail:s,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("toast",{detail:`Swapped in ${this.abPick.chord}`,bubbles:!0,composed:!0})),S.setABOverride(null),this.abPlaying=!1,this.swapIndex=null,this.isInspectorOpen=!1,this.mobileSheetOpen=!1,this.abPick=null,this.requestUpdate()},this.onDecLength=()=>{const e=this.progression?.chords.length||4;e>De&&this.dispatchEvent(new CustomEvent("set-length",{detail:e-1,bubbles:!0,composed:!0}))},this.onIncLength=()=>{const e=this.progression?.chords.length||4;e<he&&this.dispatchEvent(new CustomEvent("set-length",{detail:e+1,bubbles:!0,composed:!0}))},this.onReroll=()=>{this.dispatchEvent(new CustomEvent("reroll",{bubbles:!0,composed:!0}))},this.onTheoryToggle=()=>{this.showTheory=!this.showTheory,this.dispatchEvent(new CustomEvent("theory-toggle",{detail:this.showTheory,bubbles:!0,composed:!0})),this.requestUpdate()},this.toggleInstrumentExpand=()=>{this.expandedInstrument=!this.expandedInstrument,this.expandedPlayStyle=!1,this.requestUpdate()},this.togglePlayStyleExpand=()=>{this.expandedPlayStyle=!this.expandedPlayStyle,this.expandedInstrument=!1,this.requestUpdate()},this.onHumanChange=e=>{e.detail&&(this.humanEngineState=e.detail,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:e.detail}))},this.onHumanPreview=e=>{e.detail&&(this.humanEngineState=e.detail,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:e.detail}))}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResizeHandler),window.addEventListener("keydown",this.handleKeyDown),window.addEventListener("keyup",this.handleKeyUp),this.placeholderTimer=setInterval(()=>{this.vibePlaceholderIdx=(this.vibePlaceholderIdx+1)%this.vibeExamples.length},2800),this.savedSets=F.getProjects(),this.unsubscribeProjects=typeof F.subscribeProjects=="function"?F.subscribeProjects(()=>{this.savedSets=F.getProjects(),this.requestUpdate()}):typeof F.subscribe=="function"?F.subscribe(()=>{this.savedSets=F.getProjects(),this.requestUpdate()}):null,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone}),S.setBarsPerChord(this.barsPerChord),Ne(this.tone)}updated(e){super.updated(e),(e.has("swing")||e.has("spread")||e.has("density")||e.has("tone")||e.has("humanEngineState"))&&(S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:this.humanEngineState}),e.has("tone")&&Ne(this.tone)),e.has("barsPerChord")&&S.setBarsPerChord(this.barsPerChord)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResizeHandler),window.removeEventListener("keydown",this.handleKeyDown),window.removeEventListener("keyup",this.handleKeyUp),this.placeholderTimer&&clearInterval(this.placeholderTimer),this.unsubscribeProjects&&this.unsubscribeProjects()}getVibeSummary(){const e=[this.progression?.genre||"Pop",(this.progression?.mood||"Warm").toLowerCase()];return this.selectedBand&&e.push(this.selectedBand),e.join(" · ")}onGenreClick(e){this.dispatchEvent(new CustomEvent("set-genre",{detail:e,bubbles:!0,composed:!0})),this.requestUpdate()}onMoodClick(e){this.dispatchEvent(new CustomEvent("set-mood",{detail:e,bubbles:!0,composed:!0})),this.requestUpdate()}onBandClick(e){this.selectedBand===e?this.selectedBand=null:this.selectedBand=e;const t=$t.find(i=>i.name===this.selectedBand);t&&this.dispatchEvent(new CustomEvent("toast",{detail:`Active artist DNA: ${t.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}onVibeSubmit(e){e.preventDefault();const t=this.freeText.trim();t&&(this.dispatchEvent(new CustomEvent("freetext-generate",{detail:t,bubbles:!0,composed:!0})),this.vibeOpen=!1,this.requestUpdate())}onJumpBar(e){this.progressStep=e*4,S.playFromBar(e),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),this.requestUpdate()}getChordLadder(e){if(!e)return[];const t=String(e.name),i=(t.match(/^[A-G][#b]?/)||["C"])[0];return(/sus/.test(t)?["sus4","7sus4","9sus4","maj7sus4"]:/dim/.test(t)?["dim","dim7","dim9"]:/^[A-G][#b]?m(?!aj)/.test(t)?["m","m6","m7","m9","mMaj7"]:["","6","7","maj7","maj9"]).map(o=>i+o)}getLadderHome(e){return this.getChordLadder(e).indexOf(e&&e.name)}handlePadPointerDown(e,t){let i="1st inversion",s=1,o;const n=this.progression?.chords;if(e.currentTarget&&typeof e.currentTarget.getBoundingClientRect=="function"){const h=e.currentTarget.getBoundingClientRect(),m=(e.clientY-h.top)/(h.height||1);if(m<.34?(s=0,i="up an octave"):m>.67?(s=2,i="low, root position"):(s=1,i="1st inversion"),typeof e.clientX=="number"&&n&&n[t]){const y=this.getChordLadder(n[t]),w=Math.min(.999,Math.max(0,(e.clientX-h.left)/(h.width||1)));o=Math.min(y.length-1,Math.floor(w*y.length))}}const r=n?n[t]:null;if(!r)return;const c=this.getChordLadder(r),d=this.getLadderHome(r),p=o!==void 0&&c[o]?c[o]:r.name,g=o!==void 0&&o!==d&&!!c[o],l=this.progression?.key||"C",v=this.progression?.scaleType||"MAJOR",b=V(p,j(l,v)),f=88+t%3*6;this.gridTimer&&(clearTimeout(this.gridTimer),this.gridTimer=null),this.padFlash=t,this.padHeld=t,this.gridFor=t;const a=g?"→ "+p:s===0?"UP AN OCTAVE":s===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:t,voicing:i,vel:f,zone:s,reach:o,meta:a},S.playChordNotes(b,.85,i,f),this.requestUpdate()}handlePadPointerUp(){this.padFlash=-1,this.padHeld=-1,this.gridTimer&&clearTimeout(this.gridTimer),this.gridTimer=window.setTimeout(()=>{this.gridFor=-1,this.requestUpdate()},1100),this.requestUpdate()}openSwap(e){this.swapIndex=e,this.detailOpen=!1,this.isInspectorOpen=!0,this.abPick=null,this.abSide="before",this.abPlaying=!1,S.setABOverride(null),this.isMobile&&(this.mobileSheetOpen=!0),this.requestUpdate()}openDetail(e){this.detailIndex=e,this.detailOpen=!0,this.swapIndex=null,this.isInspectorOpen=!1,this.isMobile&&(this.mobileDetailSheetOpen=!0),this.requestUpdate()}selectAlternative(e){const t=this.progression?j(this.progression.key,this.progression.scaleType):!1,i=e.chord.notes&&e.chord.notes.length>0?e.chord.notes:V(e.chord.name,t);this.abPick={chord:e.name,tension:e.tension,roman:e.roman||"",fn:e.sub,label:e.name},this.abSide="after",this.swapIndex!==null&&this.progression&&S.setABOverride({index:this.swapIndex,side:"after",chord:{...this.progression.chords[this.swapIndex],name:e.name,roman:e.roman||"",tension:e.tension,notes:i}}),S.auditionChord({...e.chord,notes:i},.8),this.requestUpdate()}previewAlternative(e){if(!this.progression)return;const t=j(this.progression.key,this.progression.scaleType),i=V(e,t);S.auditionChord({name:e,notes:i,tag:"",color:"#F2A79B",functionLabel:"",desc:"",degree:"",scaleKey:this.progression.key,roman:"",scaleLabel:"",tension:.2},.8)}setABSide(e){if(this.abSide=e,this.swapIndex!==null&&this.progression){const t=j(this.progression.key,this.progression.scaleType);if(e==="before")S.setABOverride({index:this.swapIndex,side:"before",chord:this.progression.chords[this.swapIndex]}),S.auditionChord(this.progression.chords[this.swapIndex],.8);else if(this.abPick){const i=V(this.abPick.chord,t),s={...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:i};S.setABOverride({index:this.swapIndex,side:"after",chord:s}),S.auditionChord(s,.8)}}this.requestUpdate()}onAbCellClick(e){if(!this.progression)return;if(e===this.swapIndex&&this.abSide==="after"&&this.abPick){const i=j(this.progression.key,this.progression.scaleType),s={...this.progression.chords[e],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:V(this.abPick.chord,i)};S.auditionChord(s,.8)}else S.playChordAtIndex(e,.8)}getChordQualityLabel(e){if(!e)return"Major";const t=e.trim().replace(/^[A-G][#b♭♯]?/i,"");return/sus/i.test(t)?"Suspended (sus)":/(dim|°)/i.test(t)?"Diminished":/^(m|min)(?!aj)/.test(t)?"Minor":"Major"}getChordQualitySub(e){switch(this.getChordQualityLabel(e)){case"Minor":return"warm";case"Suspended (sus)":return"floating";case"Diminished":return"unstable";default:return"bright"}}getChordExtensionLabel(e){if(!e)return"None";const t=e.trim().replace(/^[A-G][#b♭♯]?/i,"");return/9/.test(t)?"9th":/(maj7|\(maj7\)|Δ)/i.test(t)||/M7/.test(t)?"Major 7th (M7)":/6/.test(t)?"6th":/(7|11|13)/.test(t)?"7th (dom / m7)":"None"}getChordExtensionSub(e){switch(this.getChordExtensionLabel(e)){case"6th":return"soft lift";case"7th (dom / m7)":return"classic tension";case"Major 7th (M7)":return"lush, jazzy";case"9th":return"wide, colorful";default:return"triad only"}}changeChordQuality(e){if(!this.progression)return;const t=[...this.progression.chords],i=t[this.detailIndex];if(!i)return;const s=this.getChordExtensionLabel(i.name),o=ci(i,e,s);t[this.detailIndex]=o;const n={...this.progression,chords:t};this.progression=n,this.dispatchEvent(new CustomEvent("progression-change",{detail:n,bubbles:!0,composed:!0})),S.auditionChord(o,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${o.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}changeChordExtension(e){if(!this.progression)return;const t=[...this.progression.chords],i=t[this.detailIndex];if(!i)return;const s=this.getChordQualityLabel(i.name),o=ci(i,s,e);t[this.detailIndex]=o;const n={...this.progression,chords:t};this.progression=n,this.dispatchEvent(new CustomEvent("progression-change",{detail:n,bubbles:!0,composed:!0})),S.auditionChord(o,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${o.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}renderDetailKeyboard(e=[]){const t={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,F:5,"E#":5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=new Set(e.map(c=>t[c.replace(/\d+$/,"")]??-1)),s=[{note:"C",pc:0},{note:"D",pc:2},{note:"E",pc:4},{note:"F",pc:5},{note:"G",pc:7},{note:"A",pc:9},{note:"B",pc:11}],o=100/7,n=o*.58,r=[{note:"C#",pc:1,after:0},{note:"D#",pc:3,after:1},{note:"F#",pc:6,after:3},{note:"G#",pc:8,after:4},{note:"A#",pc:10,after:5}];return u`
    ...
    `}get feelChanged(){return this.swing!==pe.swing||this.spread!==pe.spread||this.density!==pe.density||this.tone!==pe.tone}resetFeel(){this.swing=pe.swing,this.spread=pe.spread,this.density=pe.density,this.tone=pe.tone,this.humanEngineState=null,S.setFeelSettings({swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,humanState:void 0}),Ne(this.tone),this.requestUpdate()}nudgeBpm(e){const t=this.progression?.bpm||84,i=Math.max(40,Math.min(240,t+e));this.progression&&(this.progression.bpm=i),S.setBpm(i),this.dispatchEvent(new CustomEvent("set-bpm",{detail:i,bubbles:!0,composed:!0})),this.requestUpdate()}setDirectBpm(e){if(isNaN(e))return;const t=Math.max(40,Math.min(240,e));this.progression&&(this.progression.bpm=t),S.setBpm(t),this.dispatchEvent(new CustomEvent("set-bpm",{detail:t,bubbles:!0,composed:!0})),this.requestUpdate()}setBarsPerChord(e){this.barsPerChord=e,S.setBarsPerChord(e),this.requestUpdate()}selectKey(e){if(this.keyIdx=Tt.indexOf(e),!this.progression)return;const t=bo(this.progression,e);this.progression=t,S.setProgression(t),this.dispatchEvent(new CustomEvent("progression-change",{detail:t,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("toast",{detail:`Transposed to ${t.key} ${t.scaleType==="NATURAL_MINOR"?"minor":"major"}`,bubbles:!0,composed:!0})),this.requestUpdate()}onScaleDegreeClick(e,t,i,s){this.auditionDeg=e,this.auditionName=t,this.auditionBar=i?s+1:0;const o=j(this.progression?.key||"C",this.progression?.scaleType||"MAJOR"),n=V(t,o);S.auditionChord({name:t,notes:n},.8),this.requestUpdate()}getTheoryData(e){const t=(this.progression?.scaleType||"").toUpperCase().includes("MINOR")||(this.progression?.key||"").includes("m"),i=this.progression?.key||"C",s=P[i.replace("b","b").replace("♭","b")]??0,o=t?{steps:[0,2,3,5,7,8,10],romans:["i","ii°","♭III","iv","v","♭VI","♭VII"],quals:["m","dim","","m","m","",""],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"natural minor"}:{steps:[0,2,4,5,7,9,11],romans:["I","ii","iii","IV","V","vi","vii°"],quals:["","m","m","","","m","dim"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"major"},n=i.replace("b","♭")+" "+o.name,r=e.map(a=>{const h=ee(a.name);return P[h.root]??0}),c=a=>o.steps.indexOf(((a-s)%12+12)%12),d=o.steps.map((a,h)=>{const m=(s+a)%12,w=In[m]+o.quals[h],k=r.indexOf(m),D=k>=0,B=this.auditionDeg===h;return{di:h,roman:o.romans[h],name:w,fn:o.fns[h],inLoop:D,on:B,barIdx:k,aria:`Hear ${w}, the ${o.fns[h].toLowerCase()} of ${n}`}}),p=this.auditionDeg===null||this.auditionDeg<0?"Tap a degree to hear it":this.auditionBar?`${this.auditionName} · bar ${this.auditionBar} of the loop`:`${this.auditionName} · not in this loop`,g=e.map(a=>a.roman||o.romans[Math.max(0,c(P[ee(a.name).root]??0))]).join(" – "),l=i.replace("b","♭")+" "+(t?"minor":"major"),v=No(e),b=Ao(e),f=this.progression?.note||"";return{scaleName:n,scaleHint:p,scaleDegrees:d,romanFormula:g,keyModeLine:l,cadences:v,voiceLinks:b,setNote:f}}renderScaleChords(e,t,i,s){const o=we(this.progression?.mood||"Warm");return u`
      <div
      ...
      <div class="tempo-popover-desktop" style="background: var(--cv-cream); border-radius: 16px; padding: 14px 16px; margin-top: 11px; display: flex; flex-wrap: wrap; align-items: flex-end; gap: 18px;">
        ...
        <div style="flex: 1; min-width: 240px;">
          ...
          <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px;">
            ${Tt.map((t,i)=>{const s=this.keyIdx===i||this.progression?.key===t.replace(" min","").replace(" maj","").replace("♭","b");return u`
                <button
    ...
    `}renderFeelDrawerDesktop(){return this.feelOpen?u`
      <div class="feel-popover-desktop" style="background: var(--cv-cream); border-radius: 18px; padding: 14px 16px 16px; margin-top: 11px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 8px 22px; margin-top: 8px;">
          ${fi.map(e=>{const t=this[e.k];let i=e.steps[0];return e.steps.forEach(s=>{Math.abs(s.v-t)<Math.abs(i.v-t)&&(i=s)}),u`
              <div style="display: flex; align-items: center; gap: 14px; padding: 5px 0; min-width: 0;">
                ...
                <div style="display: flex; gap: 5px; flex: 1; min-width: 0;">
                  ${e.steps.map(s=>{const o=s===i;return u`
                      <button
                        ...
                        @click=${()=>{this[e.k]=s.v,S.setFeelSettings({[e.k]:s.v}),this.requestUpdate()}}
    ...
    `:""}renderTheoryStrip(e){const{keyModeLine:t,romanFormula:i,cadences:s,voiceLinks:o,setNote:n}=e;return u`
    ...
    `}renderChordDetailContent(e){const t=e[this.detailIndex],i=this.getChordQualityLabel(t?.name),s=this.getChordExtensionLabel(t?.name),o=j(this.progression?.key||"C",this.progression?.scaleType||"MAJOR"),n=t?Eo(t.name,o):[];return u`
      ...
      <div class="quality-chips-grid">
        ${kn.map(r=>{const c=r.label===i;return u`
            <button
      ...
      <div class="ext-chips-grid">
        ${Sn.map(r=>{const c=r.label===s;return u`
            <button
    ...
    `}renderPianoCard(e,t){const i=ee(e.name),s=yi[i.root]??0,o=Ke[i.quality]||Ke[Lt[i.quality]||"maj"]||[0,4,7],n=22,r=86,c=52,d=[0,2,4,5,7,9,11],p=[],g=[],l=[];for(let f=0;f<2;f++)d.forEach((a,h)=>{p.push({x:(f*7+h)*n,w:n-1.5,h:r})});for(let f=0;f<2;f++)[0,1,3,4,5].forEach(a=>{const h=f*7+a;g.push({x:h*n+n*.64,w:n*.58,h:c})});o.forEach(f=>{const a=s+f,h=Math.floor(a/12),m=a%12,y=d.indexOf(m),w=f===0,k=y<0,D=w?"#F2735F":k?"#FBF3E6":"#2E271F",B=w?"#FBF3E6":k?"#2E271F":"#FBF3E6",_=this.showDegrees?Je[f%12]:"";if(y>=0){const W=h*7+y;l.push({cx:W*n+(n-1.5)/2,cy:r-19,r:9,fill:D,isRoot:w,label:_,lc:B})}else{const K=(h*7+d.indexOf(m-1))*n+n*.64,X=n*.58;l.push({cx:K+X/2,cy:c-14,r:7.5,fill:D,isRoot:w,label:_,lc:B})}});const v=14*n,b=o.map(f=>{const a=xi[(s+f)%12];return this.showDegrees?`${a} (${Je[f%12]})`:a}).join(" · ");return u`
      <div
        class="play-card"
    ...
    `}renderFretCard(e,t,i){const s=ee(e.name),o=yi[s.root]??0,n=Ke[s.quality]||Ke[Lt[s.quality]||"maj"]||[0,4,7],r=[4,9,2,7,11,4],c=[7,0,4,9],d=i==="Ukulele",p=d?c:r,g=d?Tn({root:s.root,rootPc:o,q:s.quality,intervals:n})||[null,null,null,null]:Cn({root:s.root,rootPc:o,q:s.quality})||[null,null,null,null,null,null],l=18,v=24,b=4,f=16,a=p.length,h=g.filter(T=>T!==null&&T>0),m=h.length&&Math.max(...h)>4?Math.min(...h)-1:0,y=[],w=[],k=[],D=[],B=[];for(let T=0;T<a;T++)y.push({x:T*l});for(let T=0;T<=b;T++)w.push({y:f+T*v,sw:T===0&&m===0?3:1.2});g.forEach((T,Y)=>{const me=Y*l;if(T===null){B.push({x:me});return}if(T===0){D.push({x:me});return}const tt=((p[Y]+T-o)%12+12)%12;k.push({cx:me,cy:f+(T-m-.5)*v,fill:tt===0?"#F2735F":"#2E271F",label:this.showDegrees?Je[((p[Y]+T-o)%12+12)%12]:""})});const _=(a-1)*l,W=(a-1)*l+26,K=f+b*v+12,X=m>0?`${m+1}fr`:"",ce=m>0,Q=n.map(T=>{const Y=xi[(o+T)%12];return this.showDegrees?`${Y} (${Je[T%12]})`:Y}).join(" · ");return u`
      <div
        class="play-card"
      ...
      >
        ...
        <svg width="${W}" height="${K}" viewBox="-13 -2 ${W} ${K}" style="display: block; width: 100%; max-width: ${W*1.5}px; height: auto;">
          ${w.map(T=>L`
    ...
    `}renderChordPad(e,t,i,s){const o=Z(e.tension||.1),n=this.activeIndex===t&&this.playing,r=this.padFlash===t||this.padHeld===t,c=this.swapIndex===t,d=this.getChordLadder(e),p=this.getLadderHome(e),g=this.lastPad?.idx===t,l=g&&typeof this.lastPad?.reach=="number"?this.lastPad.reach:p,v=g&&l>=0&&l!==p&&d[l],b=g?v?"→ "+d[l]:wn[this.lastPad?.zone??1]||this.lastPad?.voicing||"":"";return u`
      <div
      ...
      >
        ...
        <div class="pad-top-row">
          <span class="pad-key-badge">${Ct[t]||""}</span>
        ...
        <div class="pad-bottom-info">
          ...
          <div class="pad-chord-name">${g&&v&&d[l]?d[l]:e.name}</div>
    ...
    `}renderLibraryPopoverContent(e){const t=this.librarySearch.trim().toLowerCase(),i=this.savedSets.filter(s=>!t||(s.name+" "+s.genre+" "+s.mood).toLowerCase().includes(t));return u`
      ...
      <div class="studio-container" style="--mood-color: ${t};">
        ...
        ${this.vibeOpen?u`
          <div class="vibe-popover-desktop">
            ...
            <div class="popover-kicker spaced">Mood</div>
            <div class="pills-group">
              ${mi.map(a=>{const h=we(a),m=this.progression?.mood===a;return u`
                  <button class="pill mood-pill ${m?"active":""}" style="${m?`background: ${h}; color: #2E271F;`:""}" @click=${()=>this.onMoodClick(a)}>
                    <span class="mood-badge" style="background: ${m?"rgba(46, 39, 31, 0.12)":h+"33"};">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="${m?"#2E271F":h}" stroke-width="2.2" stroke-linecap="round"><path d="${xn[a]||"M12 4 a6.5 6.5 0 1 0 6.5 6.5"}"/></svg>
                    </span>
                    ${a}
                  </button>
                `})}
  ...
  `;Fe([$({type:Boolean})],ue.prototype,"visible",2);Fe([$({type:String})],ue.prototype,"defaultName",2);Fe([x()],ue.prototype,"mounted",2);Fe([x()],ue.prototype,"name",2);Fe([Oi(".name-input")],ue.prototype,"inputEl",2);ue=Fe([oe("save-set-modal")],ue);var An=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,R=(e,t,i,s)=>{for(var o=s>1?void 0:s?Mn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&An(t,i,o),o};const On=["Piano","Rhodes","Nylon Guitar","Warm Pad"],Dn=["Block chords","Arpeggio","Strum","Broken (swing)"],Bn=["flex-start","center","flex-end"];let z=class extends se{constructor(){super(...arguments),this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.canAddSection=!0,this.playing=!1,this.progressStep=0,this.totalSteps=0,this.instrument=null,this.playStyle=null,this.isAuthenticated=!1,this.isBookmarked=!1,this.embedded=!1,this.expandedInstrument=!1,this.expandedPlayStyle=!1,this.expandedAllInstruments=!1,this.expandedAllPlayStyles=!1,this.snapProgress=!1,this.saveModalVisible=!1,this.mascot=Pt(.5),this.mascotAlign=zt([...Bn]),this.eggCounter=new ss,this.paradeTrigger=0}onWordmarkClick(){this.eggCounter.click()&&this.paradeTrigger++}willUpdate(e){if(e.has("progressStep")){const t=e.get("progressStep");this.snapProgress=t!==void 0&&this.progressStep<t}}updated(e){e.has("progressStep")&&this.snapProgress&&requestAnimationFrame(()=>requestAnimationFrame(()=>{this.snapProgress=!1}))}selectSection(e){this.dispatchEvent(new CustomEvent("select-section",{detail:e,bubbles:!0,composed:!0}))}addSection(){this.canAddSection&&this.dispatchEvent(new CustomEvent("add-section",{bubbles:!0,composed:!0}))}backToProgression(){this.dispatchEvent(new CustomEvent("back-to-progression",{bubbles:!0,composed:!0}))}render(){const e=this.sections[0]?.progression.genre??"Pop",t=this.instrument??Ns(e),i=this.playStyle??As(e),s=this.totalSteps||this.sections.reduce((a,h)=>a+h.order.length,0),o=!this.playing||s<=0?0:this.snapProgress?this.progressStep/s*100:(this.progressStep+1)/s*100,n=ke.filter(a=>a.name!==t);let r=On.filter(a=>n.some(h=>h.name===a));const c=n.filter(a=>!r.includes(a.name)),d=this.expandedAllInstruments?n:n.filter(a=>r.includes(a.name)),p=Se.filter(a=>a.name!==i);let g=Dn.filter(a=>p.some(h=>h.name===a));const l=p.filter(a=>!g.includes(a.name)),v=this.expandedAllPlayStyles?p:p.filter(a=>g.includes(a.name)),b=this.sections[this.playing?this.activePlayingSectionIdx:0]||this.sections[0],f=b?we(b.progression.mood):"#C9A9E0";return u`
            ...
            ${this.sections.map((a,h)=>{const m=this.playing?h===this.activePlayingSectionIdx:h===this.activeSectionIdx,y=we(a.progression.mood);return u`
                <div class="section-row ${m?"active":""}" style=${m?`--ring-color:${y}`:""} @click=${()=>this.selectSection(h)}>
                  ...
                  <div class="section-chips">
                    ${a.order.map(w=>{const k=a.progression.chords[w],D=Z(k.tension);return u`<div class="section-chip" style="background:${D.color};border-radius:${Math.round(D.radius*.4)}px;" title="${k.name}"></div>`})}
                  </div>
                </div>
              `})}
            ...
            <div class="transport">
              ...
              <div class="progress-track">
                <div
                  ...
                  style="width:${o}%;background:${f};--progress-duration:${Ws}ms"
                ></div>
              </div>
              ${this.isAuthenticated?u`
  ...
  `;R([$({type:Array})],z.prototype,"sections",2);R([$({type:Number})],z.prototype,"activeSectionIdx",2);R([$({type:Number})],z.prototype,"activePlayingSectionIdx",2);R([$({type:Boolean})],z.prototype,"canAddSection",2);R([$({type:Boolean})],z.prototype,"playing",2);R([$({type:Number})],z.prototype,"progressStep",2);R([$({type:Number})],z.prototype,"totalSteps",2);R([$({type:String})],z.prototype,"instrument",2);R([$({type:String})],z.prototype,"playStyle",2);R([$({type:Boolean})],z.prototype,"isAuthenticated",2);R([$({type:Boolean})],z.prototype,"isBookmarked",2);R([$({type:Boolean})],z.prototype,"embedded",2);R([x()],z.prototype,"expandedInstrument",2);R([x()],z.prototype,"expandedPlayStyle",2);R([x()],z.prototype,"expandedAllInstruments",2);R([x()],z.prototype,"expandedAllPlayStyles",2);R([x()],z.prototype,"snapProgress",2);R([x()],z.prototype,"saveModalVisible",2);R([x()],z.prototype,"mascot",2);R([x()],z.prototype,"mascotAlign",2);R([x()],z.prototype,"paradeTrigger",2);z=R([oe("song-screen")],z);var Fn=Object.defineProperty,Pn=Object.getOwnPropertyDescriptor,re=(e,t,i,s)=>{for(var o=s>1?void 0:s?Pn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Fn(t,i,o),o};const ki={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},zn=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],Si={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},Ii={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},$i={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},ze={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}},Un=[4,9,2,7,11,4],Ci=[7,0,4,9];let te=class extends se{constructor(){super(...arguments),this.order=[0,1,2,3],this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.embedded=!1,this.playInstrument="Piano",this.showDegrees=!1,this.activeChordIndex=null}parseChord(e){const t=/^([A-G][b#]?)(.*)$/.exec(e||"C"),i=t?t[1]:"C",s=t?t[2]:"",o=Si[s]||Si[$i[s]||"maj"]||[0,4,7];return{root:i,rootPc:ki[i]===void 0?0:ki[i],q:s,intervals:o}}shapeQual(e){const t=e===""?"maj":e;if(ze[5][t]||ze[6][t])return t;const i=$i[t];return i&&(ze[5][i]||ze[6][i])?i:"maj"}guitarVoicing(e){const t=this.parseChord(e),i=this.shapeQual(t.q),s=[];return[[6,4],[5,9]].forEach(([o,n])=>{const r=ze[o][i];if(!r)return;const c=((t.rootPc-n)%12+12)%12;s.push({rootFret:c,frets:r.map(d=>d===null?null:d+c)})}),s.length?(s.sort((o,n)=>o.rootFret-n.rootFret),s[0].frets):null}ukeVoicing(e){const t=this.parseChord(e),i=Ci,s=t.intervals.map(c=>(t.rootPc+c)%12),o=c=>{const d=new Set(c);let p=null;const g=[],l=v=>{if(v===4){const b=g.map((m,y)=>(i[y]+m)%12);for(const m of d)if(b.indexOf(m)<0)return;for(const m of b)if(!d.has(m))return;const f=g.filter(m=>m>0),a=f.length?Math.max(...f)-Math.min(...f):0;if(a>3)return;const h=a*12+g.reduce((m,y)=>m+y,0);(!p||h<p.score)&&(p={frets:g.slice(),score:h});return}for(let b=0;b<=5;b++)g.push(b),l(v+1),g.pop()};return l(0),p},n=o(s);if(n)return n.frets;const r=o(t.intervals.filter(c=>c!==7).map(c=>(t.rootPc+c)%12));return r?r.frets:null}degOf(e,t){return Ii[((e-t)%12+12)%12]||"1"}notesLineFor(e){return e.intervals.map(t=>{const i=zn[(e.rootPc+t)%12];return this.showDegrees?`${i} (${this.degOf((e.rootPc+t)%12,e.rootPc)})`:i}).join(" · ")}onChordClick(e){this.activeChordIndex=e,this.dispatchEvent(new CustomEvent("chord-preview",{detail:e,bubbles:!0,composed:!0})),setTimeout(()=>{this.activeChordIndex===e&&(this.activeChordIndex=null)},450)}onBackClick(e){e.preventDefault(),this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}renderPianoSvg(e,t){const n=[0,2,4,5,7,9,11],r=this.parseChord(e),c=[],d=[],p=[];for(let l=0;l<2;l++)n.forEach((v,b)=>{c.push({x:(l*7+b)*22,w:22-1.5,h:86})});for(let l=0;l<2;l++)[0,1,3,4,5].forEach(v=>{const b=l*7+v;d.push({x:b*22+22*.64,w:22*.58,h:52})});r.intervals.forEach(l=>{const v=r.rootPc+l,b=Math.floor(v/12),f=v%12,a=n.indexOf(f),h=l===0,m=h?"#F2735F":t,y=this.showDegrees&&Ii[l%12]||"";if(a>=0){const w=b*7+a;p.push({cx:w*22+(22-1.5)/2,cy:67,r:9,fill:m,label:y,lc:h?"#FBF3E6":"#2E271F"})}else{const k=(b*7+n.indexOf(f-1))*22+22*.64,D=22*.58;p.push({cx:k+D/2,cy:38,r:7.5,fill:m,label:y,lc:h?"#FBF3E6":"#2E271F"})}});const g=14*22;return u`
    ...
    `}renderFretSvg(e,t){const r=this.parseChord(e),c=t?Ci:Un,d=t?this.ukeVoicing(e)||[null,null,null,null]:this.guitarVoicing(e)||[null,null,null,null,null,null],p=c.length,g=d.filter(k=>k!==null&&k>0),l=g.length&&Math.max(...g)>4?Math.min(...g)-1:0,v=[],b=[],f=[],a=[],h=[];for(let k=0;k<p;k++)v.push({x:k*18});for(let k=0;k<=4;k++)b.push({y:16+k*24,sw:k===0&&l===0?3:1.2});d.forEach((k,D)=>{const B=D*18;if(k===null){h.push({x:B});return}if(k===0){a.push({x:B});return}const _=((c[D]+k-r.rootPc)%12+12)%12;f.push({cx:B,cy:16+(k-l-.5)*24,fill:_===0?"#F2735F":"#2E271F",label:this.showDegrees?this.degOf((c[D]+k)%12,r.rootPc):""})});const m=(p-1)*18+26,y=16+4*24+12,w=(p-1)*18;return{posLabel:l>0?`${l+1}fr`:"",svg:u`
      ...
      `}}render(){if(!this.progression)return u``;const e=we(this.progression.mood);this.style.setProperty("--active-mood-color",e);const t=this.order.map(o=>this.progression.chords[o]||this.progression.chords[0]),i=this.playInstrument==="Piano",s=i?"One voicing per chord, root position — the red dot is the root, play left to right.":"Exact voicings including 7ths — the red dot is the root, ○ is an open string, × is muted.";return u`
      ${this.embedded?"":u`
        <app-header
          .isAuthenticated=${this.isAuthenticated}
          .userEmail=${this.userEmail}
      ...
      <div class="container" style="${this.embedded?"padding: 10px 0 40px;":""}">
        ...
        ${i?u`
          <div class="cards-grid piano-grid">
            ${t.map((o,n)=>{const r=this.parseChord(o.name),c=this.activeChordIndex===n;return u`
                <div
        ...
        `:u`
          <div class="cards-grid fret-grid">
            ${t.map((o,n)=>{const r=this.parseChord(o.name),c=this.renderFretSvg(o.name,this.playInstrument==="Ukulele"),d=this.activeChordIndex===n;return u`
                <div
  ...
  `;re([$({type:Object})],te.prototype,"progression",2);re([$({type:Array})],te.prototype,"order",2);re([$({type:Boolean})],te.prototype,"isAuthenticated",2);re([$({type:String})],te.prototype,"userEmail",2);re([$({type:Number})],te.prototype,"savedCount",2);re([$({type:Boolean})],te.prototype,"embedded",2);re([x()],te.prototype,"playInstrument",2);re([x()],te.prototype,"showDegrees",2);re([x()],te.prototype,"activeChordIndex",2);te=re([oe("play-along-screen")],te);var Ln=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,Pe=(e,t,i,s)=>{for(var o=s>1?void 0:s?Rn(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Ln(t,i,o),o};let ge=class extends se{constructor(){super(...arguments),this.open=!1,this.mounted=!1,this.isOAuthLoading=!1,this.errorMessage=null,this.closeTimer=null}willUpdate(e){e.has("open")&&this.open&&(this.mounted=!0)}updated(e){e.has("open")&&(this.open?(this.closeTimer&&(clearTimeout(this.closeTimer),this.closeTimer=null),this.mounted=!0,this.errorMessage=null,setTimeout(()=>{this.googleBtnContainer&&Ae.renderGoogleButton(this.googleBtnContainer,t=>{t.success?this.close():t.message&&(this.errorMessage=t.message)})},50)):this.mounted&&(this.closeTimer=setTimeout(()=>{this.mounted=!1},280)))}close(){this.errorMessage=null,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}async handleGoogleSignIn(){this.errorMessage=null,this.isOAuthLoading=!0;try{const e=await Ae.signInWithGoogle();e.success?this.close():e.message&&(this.errorMessage=e.message)}catch(e){const t=e instanceof Error?e.message:String(e);this.errorMessage=t||"Google sign-in failed. Please try again."}finally{this.isOAuthLoading=!1}}render(){return!this.open&&!this.mounted?u``:u`
  ...
  `;Pe([$({type:Boolean})],ge.prototype,"open",2);Pe([x()],ge.prototype,"mounted",2);Pe([x()],ge.prototype,"isOAuthLoading",2);Pe([x()],ge.prototype,"errorMessage",2);Pe([Oi("#google-btn-container")],ge.prototype,"googleBtnContainer",2);ge=Pe([oe("auth-modal")],ge);var jn=Object.defineProperty,_n=Object.getOwnPropertyDescriptor,A=(e,t,i,s)=>{for(var o=s>1?void 0:s?_n(t,i):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&jn(t,i,o),o};let E=class extends se{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.screen="loop",this.libraryOpen=!1,this.genre="Pop",this.mood="Dreamy",this.progression=null,this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.keyOverride=null,this.scaleOverride=null,this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle=null,this.sheetOpen=!1,this.sheetMode="swap",this.swapIndex=null,this.alternatives=[],this.theoryGroups=[],this.borrowedChords=[],this.length=4,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.pendingChordSuggestion=null,this.userEmail=null,this.isAuthenticated=!1,this.syncStatus="sign-in",this.authModalOpen=!1,this.toastMessage=null,this.toastUndoId=null,this.isGenerating=!1,this.currentProjectId=null,this.activeSearchPrompt=null,this.previousScreenBeforeSets="loop",this.unsubscribeAuth=null,this.unsubscribeProjects=null,this.unsubscribeSyncStatus=null,this.unsubscribeTick=null,this.toastDismissTimeout=null,this.onHashChange=()=>{this.syncRouteFromHash()},this.onGlobalKeyDown=e=>{e.key==="Escape"&&this.sheetOpen&&(this.sheetOpen=!1,this.swapIndex=null,this.requestUpdate())},this.onLoginRequest=()=>{this.authModalOpen=!0},this.onLogoutRequest=async()=>{await Ae.signOut(),F.logout()}}connectedCallback(){super.connectedCallback(),this.showTheory=(localStorage.getItem("chroma-chords-show-theory")||localStorage.getItem("chord-voyager-show-theory"))==="true";const e=localStorage.getItem("chroma-chords-instrument");e&&ke.some(i=>i.name===e)&&(this.instrument=e);const t=localStorage.getItem("chroma-chords-play-style");t&&Se.some(i=>i.name===t)&&(this.playStyle=t),S.setInstrument(this.instrument),S.setPlayStyle(this.playStyle),this.unsubscribeAuth=Ae.subscribe(i=>{this.userEmail=i.user?.email||null,this.isAuthenticated=i.isAuthenticated}),this.unsubscribeProjects=F.subscribeProjects(()=>{this.requestUpdate()}),this.unsubscribeSyncStatus=F.subscribeSyncStatus(i=>{this.syncStatus=i,this.requestUpdate()}),this.unsubscribeTick=S.subscribeTick((i,s,o,n,r)=>{this.activeIndex=i,this.progressStep=s,typeof o=="number"&&(this.activePlayingSectionIdx=o),typeof n=="number"&&(this.totalSongSteps=n),this.playing=S.isPlaying()}),window.addEventListener("hashchange",this.onHashChange),window.addEventListener("keydown",this.onGlobalKeyDown),this.syncRouteFromHash(),Qs().then(i=>{this.chordData=i,this.progression||(this.progression=Mt(this.chordData,this.genre,this.mood,{length:this.length}),this.order=Array.from({length:this.length},(s,o)=>o),S.setProgression(this.progression,this.order),this.sections=Ee.createInitialSong(this.progression,this.order),this.screen="loop")}).catch(i=>{console.error("Failed to load chord data:",i)})}disconnectedCallback(){super.disconnectedCallback(),S.stopAutoplay(),window.removeEventListener("hashchange",this.onHashChange),window.removeEventListener("keydown",this.onGlobalKeyDown),this.unsubscribeAuth&&this.unsubscribeAuth(),this.unsubscribeProjects&&this.unsubscribeProjects(),this.unsubscribeSyncStatus&&this.unsubscribeSyncStatus(),this.unsubscribeTick&&this.unsubscribeTick(),this.toastDismissTimeout&&clearTimeout(this.toastDismissTimeout)}get isAdmin(){return F.isAdmin}syncRouteFromHash(){const e=window.location.hash.replace(/^#/,"").toLowerCase();e==="sets"||e==="11a"?(this.libraryOpen=!0,this.screen="loop"):e==="play-along"||e==="12a"?this.screen="play-along":e==="song"||e==="5a"?(this.screen="song",this.sections.length&&S.setSong(this.sections)):this.screen="loop"}setScreen(e){this.screen=e;const t=`#${e}`;window.location.hash!==t&&history.pushState(null,"",t)}onGenreChange(e){this.genre=e.detail,this.regenerate()}onMoodChange(e){this.mood=e.detail,this.regenerate()}async onGenerate(e){if(!this.isGenerating){this.isGenerating=!0;try{this.keyOverride=null,this.scaleOverride=null;const t=e?.detail?.promptText||this.activeSearchPrompt||void 0,i=await Go.resolvePrompt(this.chordData,this.genre,this.mood,this.length,t,this.pendingChordSuggestion);i.instrument&&(this.instrument=i.instrument,localStorage.setItem("chroma-chords-instrument",i.instrument),S.setInstrument(i.instrument)),i.playStyle&&(this.playStyle=i.playStyle,localStorage.setItem("chroma-chords-play-style",i.playStyle),S.setPlayStyle(i.playStyle));const s=i.progression;this.progression=s,this.order=Array.from({length:s.chords.length},(o,n)=>n),this.length=s.chords.length,this.activeIndex=0,this.progressStep=0,this.playing=!1,S.setProgression(s,this.order),S.reset(),this.setScreen("loop"),this.sections=Ee.createInitialSong(s,this.order),this.activeSectionIdx=0,this.pendingChordSuggestion=null,this.activeSearchPrompt=null}catch(t){console.error("Failed to generate progression:",t),this.showToast("Failed to generate progression. Please try again.")}finally{this.isGenerating=!1}}}onLengthChange(e){this.length=e.detail,this.regenerate()}regenerate(){if(!this.chordData.scales||Object.keys(this.chordData.scales).length===0)return;const e=Mt(this.chordData,this.genre,this.mood,{key:this.keyOverride??void 0,scaleType:this.scaleOverride??void 0,length:this.length});this.progression=e,this.order=Array.from({length:this.length},(t,i)=>i),this.activeIndex=0,this.progressStep=0,S.setProgression(e,this.order),this.sections=Ee.createInitialSong(this.progression,this.order),this.activeSectionIdx=0,this.playing&&(S.startAutoplay(),S.playActiveChord()),this.requestUpdate()}onReroll(){this.regenerate()}onLoadProject(e){const t=e.detail,i=[];for(const s of t.chords){let o=s.notes;(!o||o.length===0)&&(o=V(s.name,j(t.key||"C",t.scaleType||"MAJOR"))),i.push({name:s.name,tag:s.tag||"diatonic",roman:s.roman||"",color:s.color||"#9CC0EC",functionLabel:s.functionLabel||"",notes:o,scaleLabel:s.scaleLabel||"",desc:s.desc||"",degree:s.degree||"",scaleKey:s.scaleKey||"",tension:s.tension||.1})}this.currentProjectId=t.id,this.genre=t.genre||"Pop",this.mood=t.mood||"Dreamy",this.progression={genre:t.genre||"Unknown",mood:t.mood||"Neutral",key:t.key||"C",scaleType:t.scaleType||"MAJOR",bpm:t.bpm||120,chords:i},this.order=Array.from({length:this.progression.chords.length},(s,o)=>o),this.length=this.progression.chords.length,this.showTheory=t.showTheory??this.showTheory,t.barsPerChord&&S.setBarsPerChord(t.barsPerChord),t.feel&&S.setFeelSettings(t.feel),S.setProgression(this.progression,this.order),this.setScreen("loop"),this.sections=Ee.createInitialSong(this.progression,this.order),this.activeSectionIdx=0,this.showToast(`Loaded "${t.name}"`)}onDeleteProject(e){F.deleteProject(e.detail),this.currentProjectId===e.detail&&(this.currentProjectId=null),this.requestUpdate()}onRenameProject(e){const t=F.getProjects().find(i=>i.id===e.detail.id);t&&(t.name=e.detail.name,F.saveProject(t),this.requestUpdate())}async onSyncProjects(){await F.syncWithCloud(),this.requestUpdate()}onSaveSet(e){this.saveProject(e.detail)}onTheoryToggle(){this.showTheory=!this.showTheory,localStorage.setItem("chroma-chords-show-theory",String(this.showTheory))}onSetInstrument(e){this.instrument=e.detail,localStorage.setItem("chroma-chords-instrument",e.detail),S.setInstrument(e.detail)}onSetPlayStyle(e){this.playStyle=e.detail,localStorage.setItem("chroma-chords-play-style",e.detail),S.setPlayStyle(e.detail)}onTogglePlay(){this.playing=S.togglePlay()}onTogglePlaySong(){S.setSong(this.sections),this.playing=S.togglePlay()}onChordTap(e){this.progression&&(this.playing&&(S.stopAutoplay(),this.playing=!1),S.clearABOverride(),this.swapIndex=e.detail,this.sheetMode="swap",this.alternatives=So(this.chordData,this.progression,e.detail),this.theoryGroups=Kt(this.chordData,this.progression,e.detail),this.borrowedChords=Wi(this.chordData,this.progression,e.detail),this.sheetOpen=!0,S.playChordAtIndex(e.detail,.8))}onAuditionChord(e){S.auditionChord(e.detail,.8)}onSelectAlternative(e){if(!this.progression||this.swapIndex===null)return;const t=e.detail,s=[...this.progression.chords];s[this.swapIndex]=t.chord,this.progression={...this.progression,chords:s},S.setProgression(this.progression,this.order),this.sheetOpen=!1,this.swapIndex=null,this.showToast(`Swapped in ${t.chord.name}`)}onSheetClose(){this.sheetOpen=!1,this.swapIndex=null,S.clearABOverride()}onProgressionChange(e){this.progression=e.detail,S.setProgression(this.progression,this.order),this.sections.length>0&&(this.sections=Ee.syncActiveSection(this.sections,this.activeSectionIdx,this.progression,this.order)),this.requestUpdate()}onAddSection(){if(!this.progression)return;const e=Ee.addSection(this.sections,this.progression);this.sections=e.sections,this.activeSectionIdx=e.activeIndex,this.requestUpdate()}onSelectSection(e){this.activeSectionIdx=e.detail;const t=this.sections[e.detail];t&&(this.order=t.order.slice(),S.setOrder(this.order)),this.requestUpdate()}showToast(e,t){this.toastDismissTimeout&&clearTimeout(this.toastDismissTimeout),this.toastMessage=e,this.toastUndoId=t||null,this.toastDismissTimeout=setTimeout(()=>{this.toastMessage=null,this.toastUndoId=null},3200)}onToastUndo(){this.toastUndoId&&(F.deleteProject(this.toastUndoId),this.currentProjectId===this.toastUndoId&&(this.currentProjectId=null),this.toastMessage=null,this.toastUndoId=null,this.requestUpdate())}saveProject(e){if(!this.progression)return;const t=this.currentProjectId||Math.random().toString(36).slice(2,11);this.currentProjectId=t;const i=F.getProjects().find(c=>c.id===t),s=e||i?.name||`Progression in ${this.progression.key} ${this.progression.scaleType}`,o=S.getFeelSettings(),n=S.getBarsPerChord(),r={id:t,name:s,lastModified:Date.now(),genre:this.progression.genre,mood:this.progression.mood,key:this.progression.key,scaleType:this.progression.scaleType,bpm:this.progression.bpm,chords:this.progression.chords,showTheory:this.showTheory,barsPerChord:n,feel:{swing:o.swing??0,spread:o.spread??50,density:o.density??50,tone:o.tone??"Warm",humanState:o.humanState}};F.saveProject(r),e&&F.scheduleCloudSync(),this.showToast(`Saved "${s}"`,t),this.requestUpdate()}render(){return this.currentProjectId&&F.isProjectSaved(this.currentProjectId),u`
