 ...
 */function Nn(t,e){return(i,n,o)=>{const s=r=>r.renderRoot?.querySelector(t)??null;return Sn(i,n,{get(){return s(this)}})}}const Ae="chroma_chords_projects",kn="chord_voyager_projects";class Me{static getProjects(){if(typeof localStorage>"u"||typeof localStorage.getItem!="function")return[];try{let e=localStorage.getItem(Ae);if(e||(e=localStorage.getItem(kn),e&&localStorage.setItem(Ae,e)),e){const i=JSON.parse(e);let n=!1;return i.forEach(o=>{(o.genre==="Unknown"||!o.genre)&&(o.genre="Pop",n=!0),Array.isArray(o.chords)||(o.chords=[],n=!0)}),n&&localStorage.setItem(Ae,JSON.stringify(i)),i}}catch(e){console.error("Failed to load projects from localStorage:",e)}return[]}static setProjects(e){if(!(typeof localStorage>"u"||typeof localStorage.setItem!="function"))try{localStorage.setItem(Ae,JSON.stringify(e))}catch(i){console.error("Failed to set projects to localStorage:",i)}}static mergeProjects(e,i){const n=new Map;return e.forEach(o=>n.set(o.id,o)),i.forEach(o=>{const s=n.get(o.id);!s||o.lastModified>s.lastModified?n.set(o.id,o):o.lastModified===s.lastModified&&(s.syncedToCloud=!0)}),Array.from(n.values())}static saveProject(e){const i=this.getProjects(),n=i.findIndex(o=>o.id===e.id);e.lastModified=Date.now(),n>=0?i[n]=e:i.push(e);try{localStorage.setItem(Ae,JSON.stringify(i))}catch(o){console.error("Failed to save project to localStorage:",o)}}static deleteProject(e){let i=this.getProjects();i=i.filter(n=>n.id!==e);try{typeof localStorage<"u"&&typeof localStorage.setItem=="function"&&localStorage.setItem(Ae,JSON.stringify(i))}catch(n){console.error("Failed to delete project from localStorage:",n)}}static exportProjectFile(e){const i=JSON.stringify(e,null,2),n=new Blob([i],{type:"application/json"}),o=URL.createObjectURL(n),s=document.createElement("a");s.href=o,s.download=`${e.name.replace(/[^a-z0-9]/gi,"_").toLowerCase()}_chroma_chords.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}static importProjectFile(e){return new Promise((i,n)=>{const o=new FileReader;o.onload=s=>{try{const r=s.target?.result,a=JSON.parse(r);a&&typeof a=="object"&&Array.isArray(a.chords)?(a.id=Math.random().toString(36).substr(2,9),a.lastModified=Date.now(),i(a)):n(new Error("Invalid project file format"))}catch{n(new Error("Failed to parse JSON file"))}},o.onerror=()=>n(new Error("Failed to read file")),o.readAsText(e)})}}const Qe="chroma_chords_auth_token",At="chroma_chords_auth_user",Tn="184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com";function Mt(t){try{const e=t.split(".");if(e.length!==3)return null;let i=e[1].replace(/-/g,"+").replace(/_/g,"/");for(;i.length%4!==0;)i+="=";let n="";if(typeof atob=="function")n=atob(i);else if(typeof Buffer<"u")n=Buffer.from(i,"base64").toString("binary");else return null;const o=decodeURIComponent(n.split("").map(s=>"%"+("00"+s.charCodeAt(0).toString(16)).slice(-2)).join(""));return JSON.parse(o)}catch{return null}}function Cn(){try{return"184710057667-s8j8uvuthct60tpppbhp7iiphp0s8qpq.apps.googleusercontent.com"}catch{return Tn}}class En{constructor(e){this.currentUser=null,this.currentAccessToken=null,this.isLoading=!0,this.listeners=new Set,this.gisLoaded=!1,this.clientId=e!==void 0?e:Cn(),this.initSession()}initSession(){if(typeof window>"u"||typeof localStorage>"u"||typeof localStorage.getItem!="function"){this.isLoading=!1;return}try{const e=localStorage.getItem(Qe);if(e){const i=Mt(e);i&&i.exp&&i.exp*1e3>Date.now()?(this.currentAccessToken=e,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture}):(localStorage.removeItem(Qe),localStorage.removeItem(At),this.currentAccessToken=null,this.currentUser=null)}}catch(e){console.warn("Failed to restore auth session from localStorage:",e)}finally{this.isLoading=!1}}isConfigured(){return!!this.clientId}getAuthState(){return{user:this.currentUser,accessToken:this.currentAccessToken,isAuthenticated:!!this.currentUser&&!!this.currentAccessToken,isLoading:this.isLoading}}getUser(){return this.currentUser}async getAccessToken(){if(this.currentAccessToken){const e=Mt(this.currentAccessToken);if(e&&e.exp&&e.exp*1e3<=Date.now())return await this.signOut(),null}return this.currentAccessToken}subscribe(e){return this.listeners.add(e),e(this.getAuthState()),()=>{this.listeners.delete(e)}}notify(){const e=this.getAuthState();this.listeners.forEach(i=>{try{i(e)}catch(n){console.error("Error in AuthState listener:",n)}})}handleCredentialResponse(e){if(!e||typeof e!="string")return{success:!1,message:"Invalid credential provided."};const i=Mt(e);if(!i||!i.sub)return{success:!1,message:"Failed to decode Google user token."};if(i.exp&&i.exp*1e3<=Date.now())return{success:!1,message:"Google session token has expired."};this.currentAccessToken=e,this.currentUser={id:i.sub,email:i.email,name:i.name,picture:i.picture};try{typeof localStorage<"u"&&(localStorage.setItem(Qe,e),localStorage.setItem(At,JSON.stringify(this.currentUser)))}catch(n){console.warn("Failed to persist auth session to localStorage:",n)}return this.notify(),{success:!0,user:this.currentUser}}async loadGisScript(){return typeof window>"u"?!1:window.google?.accounts?.id?(this.gisLoaded=!0,!0):new Promise(e=>{const i=document.querySelector('script[src*="accounts.google.com/gsi/client"]');if(i){i.addEventListener("load",()=>{this.gisLoaded=!0,e(!0)}),i.addEventListener("error",()=>e(!1));return}const n=document.createElement("script");n.src="https://accounts.google.com/gsi/client",n.async=!0,n.defer=!0,n.onload=()=>{this.gisLoaded=!0,e(!0)},n.onerror=()=>e(!1),document.head.appendChild(n)})}async renderGoogleButton(e,i){if(!this.clientId||typeof window>"u"||!e)return;await this.loadGisScript();const n=window.google;if(n?.accounts?.id)try{n.accounts.id.initialize({client_id:this.clientId,callback:o=>{if(o.credential){const s=this.handleCredentialResponse(o.credential);i?.({success:s.success,message:s.message})}else i?.({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),e.innerHTML="",n.accounts.id.renderButton(e,{theme:"outline",size:"large",type:"standard",shape:"pill",text:"continue_with",logo_alignment:"left",width:320})}catch(o){console.warn("Failed to render Google button:",o)}}async signInWithGoogle(){if(!this.clientId)return{success:!1,message:"Google Client ID is not configured."};if(typeof window>"u")return{success:!1,message:"Window is not available in current environment."};await this.loadGisScript();const e=window.google;return e?.accounts?.id?new Promise(i=>{try{e.accounts.id.initialize({client_id:this.clientId,callback:n=>{if(n.credential){const o=this.handleCredentialResponse(n.credential);i({success:o.success,message:o.message})}else i({success:!1,message:"No credential returned from Google."})},auto_select:!1,cancel_on_tap_outside:!0}),e.accounts.id.prompt(n=>{(n.isNotDisplayed?.()||n.isSkippedMoment?.())&&console.info("Google prompt skipped or not displayed.")})}catch(n){const o=n instanceof Error?n.message:String(n);i({success:!1,message:o})}}):{success:!1,message:"Google Sign-In script failed to load."}}async signInWithOAuth(e="google"){return e!=="google"?{success:!1,message:`Unsupported auth provider: ${e}. Only Google is supported.`}:this.signInWithGoogle()}async signOut(){this.currentUser=null,this.currentAccessToken=null;try{typeof localStorage<"u"&&(localStorage.removeItem(Qe),localStorage.removeItem(At)),typeof window<"u"&&window.google?.accounts?.id&&window.google.accounts.id.disableAutoSelect?.()}catch(e){console.warn("Error during sign out storage cleanup:",e)}return this.notify(),{success:!0}}}const Ue=new En;class On{formatUrl(e){let i=e.trim().replace(/\/+$/,"");return i&&!i.startsWith("http://")&&!i.startsWith("https://")&&(i="https://"+i),i}applyAuthHeaders(e,i){if(!i)return;const n=i.trim();n.toLowerCase().startsWith("bearer ")?e.Authorization=n:e.Authorization=`Bearer ${n}`}async testConnection(e,i){const n=this.formatUrl(e);if(!n)return{ok:!1,status:0,message:"Worker URL cannot be empty"};try{const o={};this.applyAuthHeaders(o,i);const s=new AbortController,r=setTimeout(()=>s.abort(),8e3),a=await fetch(`${n}/api/health`,{method:"GET",headers:o,signal:s.signal});if(clearTimeout(r),a.status===200)return{ok:!0,status:200,message:"Connected to Cloudflare Worker",timestamp:(await a.json().catch(()=>({}))).timestamp};if(a.status===401)return{ok:!1,status:401,message:"Unauthorized: Invalid or missing authorization token"};const c=await a.text().catch(()=>"");return{ok:!1,status:a.status,message:`Connection error (${a.status}): ${c||a.statusText}`}}catch(o){return o instanceof Error&&o.name==="AbortError"?{ok:!1,status:0,message:"Connection timed out (8s limit)"}:{ok:!1,status:0,message:"Network error: Unable to reach worker endpoint"}}}async sync(e,i,n){const o=this.formatUrl(e);if(!o)throw new Error("Worker URL is not configured");const s={"Content-Type":"application/json"};this.applyAuthHeaders(s,i);const r=new AbortController,a=setTimeout(()=>r.abort(),45e3);try{const c=await fetch(`${o}/api/sync`,{method:"POST",headers:s,body:JSON.stringify(n),signal:r.signal});if(clearTimeout(a),!c.ok){let p="";try{const h=await c.json();p=h.error||h.message||""}catch{p=await c.text().catch(()=>"")}throw new Error(`Cloud sync failed (${c.status}): ${p||c.statusText||"Unknown error"}`)}return await c.json()}catch(c){throw clearTimeout(a),c instanceof Error&&c.name==="AbortError"?new Error("Cloud sync request timed out (45s limit)"):c}}}const An=new On,wi="chroma_chords_deleted_projects",Ii="chroma_chords_last_sync_time",Mn="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev";function $n(){try{return"https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev"}catch{return Mn}}function Si(t){return typeof window<"u"&&typeof localStorage<"u"&&typeof localStorage.getItem=="function"?localStorage.getItem(t):null}function Ni(t,e){typeof window<"u"&&typeof localStorage<"u"&&typeof localStorage.setItem=="function"&&localStorage.setItem(t,e)}class Dn{constructor(){this.userEmail=null,this.authenticated=!1,this.isCloudSyncing=!1,this.syncTimeout=null,this.syncQueued=!1,this.syncStatus="sign-in",this.lastSyncError=null,this.authStateCallbacks=new Set,this.projectsChangeCallbacks=new Set,this.syncStatusCallbacks=new Set,this.unsubscribeAuth=null,this.onlineHandler=null,this.offlineHandler=null,this.setupAuthSubscription(),this.setupOnlineListener()}setupAuthSubscription(){this.unsubscribeAuth=Ue.subscribe(e=>{const i=this.authenticated;this.userEmail=e.user?.email||null,this.authenticated=e.isAuthenticated,this.syncStatus=this.authenticated?"synced":"sign-in",this.authenticated||(this.lastSyncError=null),this.notifyAuthState(),this.notifySyncStatus(),!i&&this.authenticated&&this.syncWithCloud().catch(n=>{console.warn("Auto cloud sync on sign-in encountered an error:",n)})})}setupOnlineListener(){typeof window<"u"&&typeof window.addEventListener=="function"&&(this.onlineHandler=()=>{this.isAuthenticated()&&this.scheduleCloudSync()},this.offlineHandler=()=>{this.isAuthenticated()&&(this.syncStatus="offline",this.notifySyncStatus())},window.addEventListener("online",this.onlineHandler),window.addEventListener("offline",this.offlineHandler))}destroy(){this.unsubscribeAuth&&(this.unsubscribeAuth(),this.unsubscribeAuth=null),typeof window<"u"&&typeof window.removeEventListener=="function"&&(this.onlineHandler&&(window.removeEventListener("online",this.onlineHandler),this.onlineHandler=null),this.offlineHandler&&(window.removeEventListener("offline",this.offlineHandler),this.offlineHandler=null)),this.syncTimeout&&(clearTimeout(this.syncTimeout),this.syncTimeout=null)}getUserEmail(){return this.userEmail}isAuthenticated(){return this.authenticated}get isAdmin(){return!!(this.userEmail&&this.userEmail.toLowerCase().trim()==="warmsynthsiloveyou@gmail.com")}getSyncStatus(){return this.syncStatus}subscribeSyncStatus(e){return this.syncStatusCallbacks.add(e),e(this.syncStatus),()=>this.syncStatusCallbacks.delete(e)}notifySyncStatus(){this.syncStatusCallbacks.forEach(e=>{try{e(this.syncStatus)}catch(i){console.error("Error in SyncStatus callback:",i)}})}subscribeAuthState(e){return this.authStateCallbacks.add(e),e(this.userEmail,this.authenticated),()=>this.authStateCallbacks.delete(e)}notifyAuthState(){this.authStateCallbacks.forEach(e=>{try{e(this.userEmail,this.authenticated)}catch(i){console.error("Error in AuthState callback:",i)}})}subscribeProjects(e){return this.projectsChangeCallbacks.add(e),e(this.getProjects()),()=>this.projectsChangeCallbacks.delete(e)}subscribe(e){return this.subscribeProjects(e)}notifyProjectsChanged(){const e=this.getProjects();this.projectsChangeCallbacks.forEach(i=>{try{i(e)}catch(n){console.error("Error in ProjectsChange callback:",n)}})}logout(){this.userEmail=null,this.authenticated=!1,this.syncStatus="sign-in",this.notifyAuthState(),this.notifySyncStatus()}getProjects(){return Me.getProjects()}isProjectSaved(e){return e?Me.getProjects().some(i=>i.id===e):!1}saveProject(e){Me.saveProject(e),this.removeTombstone(e.id),this.notifyProjectsChanged(),this.scheduleCloudSync()}deleteProject(e){Me.deleteProject(e),this.addTombstone(e),this.notifyProjectsChanged(),this.scheduleCloudSync()}getTombstones(){const e=Si(wi);if(!e)return[];try{return JSON.parse(e)}catch{return[]}}setTombstones(e){Ni(wi,JSON.stringify(e))}addTombstone(e){const i=this.getTombstones(),n=i.findIndex(s=>s.id===e),o=new Date().toISOString();n>=0?i[n].deletedAt=o:i.push({id:e,deletedAt:o}),this.setTombstones(i)}removeTombstone(e){const i=this.getTombstones().filter(n=>n.id!==e);this.setTombstones(i)}getLastSyncTime(){return Si(Ii)}setLastSyncTime(e){Ni(Ii,e)}scheduleCloudSync(){this.syncTimeout&&clearTimeout(this.syncTimeout),this.syncTimeout=setTimeout(()=>{this.syncTimeout=null,this.isCloudSyncing?this.syncQueued=!0:this.syncWithCloud().catch(e=>{console.warn("Scheduled cloud sync failed:",e)})},2e3)}async syncWithCloud(e){if(this.isCloudSyncing){this.syncQueued=!0;return}const i=await Ue.getAccessToken();if(!this.isAuthenticated()||!i)return;const n=e||$n();if(n){this.isCloudSyncing=!0,this.syncStatus="syncing",this.notifySyncStatus();try{const o=Me.getProjects(),s=this.getTombstones(),r=this.getLastSyncTime(),a=r?new Date(r).getTime():0,p=(r?o.filter(y=>!y.syncedToCloud||y.lastModified&&y.lastModified>a):o).map(y=>({...y,deletedAt:null})),h=await An.sync(n,i,{sets:p,lastSyncTime:r,tombstones:s}),l=new Map;o.forEach(y=>{l.set(y.id,{...y,syncedToCloud:!0})});const g=h.tombstones||[],d=new Set(g.map(y=>y.id));(h.sets||[]).forEach(y=>{if(y.deletedAt)d.add(y.id);else{const N=l.get(y.id),I=y.lastModified||(y.updatedAt?new Date(y.updatedAt).getTime():0),x=N?.lastModified||0;(!N||I>=x)&&l.set(y.id,{id:y.id,name:y.name,lastModified:I,genre:y.genre,mood:y.mood,key:y.key,scaleType:y.scaleType,bpm:y.bpm,showTheory:y.showTheory,chords:Array.isArray(y.chords)?y.chords:[],syncedToCloud:!0})}}),d.forEach(y=>{l.delete(y)});const u=Array.from(l.values());Me.setProjects(u);const m=this.getTombstones(),v=new Set(s.map(y=>y.id)),b=m.filter(y=>!v.has(y.id));this.setTombstones(b),(h.lastSyncTime||h.syncedAt)&&this.setLastSyncTime(h.lastSyncTime||h.syncedAt),this.lastSyncError=null,this.syncStatus="synced",this.notifySyncStatus(),this.notifyProjectsChanged()}catch(o){this.lastSyncError=o instanceof Error?o.message:String(o),console.warn("Cloud sync encountered an error, transitioning to offline status:",o),this.syncStatus="offline",this.notifySyncStatus()}finally{this.isCloudSyncing=!1,this.syncQueued&&(this.syncQueued=!1,this.scheduleCloudSync())}}}getLastSyncError(){return this.lastSyncError}async syncProjectsFromCloud(){return this.syncWithCloud()}async syncProjectsToCloud(){return this.syncWithCloud()}}const D=new Dn;let $t=null,gt=null,ft=null,bt=null,Ge=null,Dt=null,Bt=null,Ft=null,Ze=null,Pt=null,Ut=null,Rt=null,Lt=null,et=null,tt=null,it=null,nt=null,ot=null,zt=null,jt=null,_t=null,st=null,rt=null,Gt=null,Vt=null,at=null,qt=null,Ht=null;function Vi(){return $t||($t=new Gi({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination()),$t}let lt="Warm",$e=null,Yt=null,Ie=null,Jt=null,ct=null,Se=null,Wt=null,Kt=null,Xt=null,Ne=null;function Oe(){if(!$e){$e=new Xe(1);const t=Vi();Yt=new ie({frequency:3200,type:"lowpass",rolloff:-12}),Ie=new Xe(1),Yt.connect(Ie),Ie.connect(t),$e.connect(Yt),Jt=new Fe({high:3.5,mid:0,low:-.5,highFrequency:4500}),ct=new me({frequency:1.5,delayTime:3,depth:.35,wet:.3});try{ct.start()}catch{}Se=new Xe(0),Jt.connect(ct),ct.connect(Se),Se.connect(t),$e.connect(Jt),Wt=new ie({frequency:1800,type:"bandpass",Q:.8}),Kt=new Pe({frequency:.5,depth:.1,wet:.4}),Xt=new ge({distortion:.1,wet:.15}),Ne=new Xe(0),Wt.connect(Kt),Kt.connect(Xt),Xt.connect(Ne),Ne.connect(t),$e.connect(Wt)}return $e}function Ve(t){Oe();const e=t?t.toLowerCase().trim():"warm";lt=e==="glassy"?"Glassy":e==="dusty"?"Dusty":"Warm";const i=.05,n=fi();try{Ie&&Se&&Ne&&(lt==="Warm"?(Ie.gain.rampTo(1,i,n),Se.gain.rampTo(0,i,n),Ne.gain.rampTo(0,i,n)):lt==="Glassy"?(Ie.gain.rampTo(0,i,n),Se.gain.rampTo(1,i,n),Ne.gain.rampTo(0,i,n)):lt==="Dusty"&&(Ie.gain.rampTo(0,i,n),Se.gain.rampTo(0,i,n),Ne.gain.rampTo(1,i,n)))}catch(o){console.warn("Failed to ramp master tone:",o)}}function Bn(t="Warm",e){const i=t?t.toLowerCase().trim():"warm",n=e??vn();if(i==="glassy"){const s=new Fe({high:3.5,mid:0,low:-.5,highFrequency:4500}),r=new me({frequency:1.5,delayTime:3,depth:.35,wet:.3});try{r.start(0)}catch{}return s.connect(r),r.connect(n),s}if(i==="dusty"){const s=new ie({frequency:1800,type:"bandpass",Q:.8}),r=new Pe({frequency:.5,depth:.1,wet:.4}),a=new ge({distortion:.1,wet:.15});return s.connect(r),r.connect(a),a.connect(n),s}const o=new ie({frequency:3200,type:"lowpass",rolloff:-12});return o.connect(n),o}const Qt=typeof import.meta<"u"&&"./"||"./",kt=Qt.endsWith("/")?Qt:`${Qt}/`,qi={A1:"A1.mp3",C2:"C2.mp3","F#2":"Fs2.mp3",C3:"C3.mp3","F#3":"Fs3.mp3",C4:"C4.mp3","F#4":"Fs4.mp3",C5:"C5.mp3","F#5":"Fs5.mp3",C6:"C6.mp3","F#6":"Fs6.mp3",C7:"C7.mp3"},Fn=`${kt}audio/samples/grand-piano/`,Hi={F1:"A_029__F1_5.m4a",B1:"A_035__B1_5.m4a",E2:"A_040__E2_5.m4a",A2:"A_045__A2_5.m4a",D3:"A_050__D3_5.m4a",G3:"A_055__G3_5.m4a",B3:"A_059__B3_5.m4a",D4:"A_062__D4_5.m4a",F4:"A_065__F4_5.m4a",B4:"A_071__B4_5.m4a",E5:"A_076__E5_5.m4a",A5:"A_081__A5_5.m4a",D6:"A_086__D6_5.m4a",G6:"A_091__G6_5.m4a"},Pn=`${kt}audio/samples/stage-rhodes/`,Yi={B1:"B1.mp3",E2:"E2.mp3",A2:"A2.mp3",D3:"D3.mp3",G3:"G3.mp3",B3:"B3.mp3",E4:"E4.mp3",A4:"A4.mp3",E5:"E5.mp3",A5:"A5.mp3"},Un=`${kt}audio/samples/nylon-guitar/`,Ji={E2:"E2.mp3",A2:"A2.mp3",C3:"C3.mp3","D#3":"Ds3.mp3","F#3":"Fs3.mp3",A3:"A3.mp3",C4:"C4.mp3","D#4":"Ds4.mp3","F#4":"Fs4.mp3",A4:"A4.mp3",C5:"C5.mp3","F#5":"Fs5.mp3",A5:"A5.mp3"},Rn=`${kt}audio/samples/jazz-guitar/`;function Ln(t="piano"){let e=null,i={};if(t==="jazz-guitar"?(e=Ge,i=Ji):t==="guitar"?(e=bt,i=Yi):t==="rhodes"||t==="epiano"?(e=ft,i=Hi):(e=gt,i=qi),!e||!e.loaded)return null;const n=e._buffers;if(!n)return null;const o={};for(const s of Object.keys(i))try{const r=li(s).toMidi(),a=n.has(r)?n.get(r):n.has(s)?n.get(s):null;a&&typeof a.get=="function"&&a.get()&&(o[s]=a.get())}catch{}return Object.keys(o).length>0?o:null}async function zn(t="piano"){const e=_n(t);if(e.loaded)return e;try{return await Promise.race([_i(),new Promise((i,n)=>setTimeout(()=>n(new Error("Sample load timeout")),3e3))]),e}catch(i){return console.warn(`ensureSamplerLoaded(${t}) timed out or failed:`,i),null}}function Wi(){return gt||(gt=new he({urls:qi,baseUrl:Fn,volume:-9,onload:()=>console.log("Grand Piano sampler loaded successfully!"),onerror:t=>console.warn("Failed to load Grand Piano sampler:",t)}).connect(Oe())),gt}function Ki(){return ft||(ft=new he({urls:Hi,baseUrl:Pn,volume:-10,onload:()=>console.log("Stage Rhodes sampler loaded successfully!"),onerror:t=>console.warn("Failed to load Stage Rhodes sampler:",t)}).connect(Oe())),ft}function Xi(){return bt||(bt=new he({urls:Yi,baseUrl:Un,volume:-8,onload:()=>console.log("Nylon Guitar sampler loaded successfully!"),onerror:t=>console.warn("Failed to load Nylon Guitar sampler:",t)}).connect(Oe())),bt}function Qi(){if(!Ge){const t=Oe();Dt=new Fe({low:1.5,mid:2,high:-3.5,lowFrequency:480,highFrequency:2800}),Bt=new ie({frequency:2800,type:"lowpass",rolloff:-12}),Ft=new pe({decay:1.8,preDelay:.02,wet:.18}),Ge=new he({urls:Ji,baseUrl:Rn,volume:-8,onload:()=>console.log("Jazz Archtop sampler loaded successfully!"),onerror:e=>console.warn("Failed to load Jazz Archtop sampler:",e)}),Ge.connect(Dt),Dt.connect(Bt),Bt.connect(Ft),Ft.connect(t)}return Ge}function jn(){if(!ot){const t=Oe();zt=new Pe({frequency:.45,depth:.18,wet:.65}),jt=new ge({distortion:.12,wet:.18}),_t=new ie({frequency:3400,type:"lowpass",rolloff:-12}),st=new me({frequency:.25,delayTime:4.2,depth:.6,wet:.35});try{st.start()}catch{}ot=new q(Be,{oscillator:{type:"fatsawtooth",count:2,spread:14},envelope:{attack:.03,decay:.6,sustain:.75,release:1.4},filterEnvelope:{attack:.04,decay:.8,sustain:.4,release:1.2,baseFrequency:450,octaves:2.6,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.8},volume:-11}),ot.connect(zt),zt.connect(jt),jt.connect(_t),_t.connect(st),st.connect(t)}return ot}function _n(t){return t==="jazz-guitar"?Qi():t==="guitar"?Xi():t==="rhodes"||t==="epiano"?Ki():Wi()}function Gn(t){const e=Oe();switch(t){case"organ":return Ze||(Pt=new Pe({frequency:5.8,depth:.12,wet:.55}),Ut=new ge({distortion:.08,wet:.15}),Rt=new ie({frequency:4500,type:"lowpass",rolloff:-12}),Ze=new q(ce,{oscillator:{type:"fatsine",count:3,spread:15},envelope:{attack:.008,decay:.15,sustain:.9,release:.25},volume:-12}),Ze.connect(Pt),Pt.connect(Ut),Ut.connect(Rt),Rt.connect(e)),Ze;case"pad-strings":if(!tt){Lt=new pe({decay:5.5,preDelay:.03,wet:.45}),et=new me({frequency:.45,delayTime:4,depth:.5,wet:.4});try{et.start()}catch{}tt=new q(ce,{oscillator:{type:"fatsawtooth",count:3,spread:22},envelope:{attack:.65,decay:.8,sustain:.85,release:2.5},volume:-13}),tt.connect(et),et.connect(Lt),Lt.connect(e)}return tt;case"juno-pad":if(!nt){it=new me({frequency:.85,delayTime:3.5,depth:.72,wet:.55});try{it.start()}catch{}nt=new q(Be,{oscillator:{type:"fatsawtooth",count:3,spread:20},envelope:{attack:.02,decay:.45,sustain:.65,release:.85},filterEnvelope:{attack:.02,decay:.5,sustain:.35,release:.8,baseFrequency:750,octaves:3.2,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.5},volume:-12}),nt.connect(it),it.connect(e)}return nt;case"stab":return rt||(Gt=new ge({distortion:.1,wet:.12}),Vt=new pe({decay:1,wet:.22}),rt=new q(Be,{oscillator:{type:"fatsawtooth",count:2,spread:12},envelope:{attack:.003,decay:.16,sustain:.08,release:.18},filterEnvelope:{attack:.003,decay:.14,sustain:.05,release:.16,baseFrequency:420,octaves:3.5,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2},volume:-10}),rt.connect(Gt),Gt.connect(Vt),Vt.connect(e)),rt;case"bell":return at||(qt=new Fe({high:3.5,mid:-.5,low:-2,highFrequency:4800}),Ht=new pe({decay:3.2,wet:.32}),at=new q(ci,{harmonicity:3.5,modulationIndex:12,envelope:{attack:.002,decay:1.2,sustain:.04,release:1.4},modulationEnvelope:{attack:.002,decay:.6,sustain:.01,release:.5},volume:-12}),at.connect(qt),qt.connect(Ht),Ht.connect(e)),at;case"guitar":return Xi();case"jazz-guitar":return Qi();case"sh101":return jn();case"rhodes":case"epiano":return Ki();case"piano":default:return Wi()}}const ae=[{name:"Grand Piano",instrument:"piano",color:"#9CC0EC"},{name:"Stage Rhodes",instrument:"rhodes",color:"#F2A79B"},{name:"Nylon Guitar",instrument:"guitar",color:"#F6D98B"},{name:"Jazz Archtop",instrument:"jazz-guitar",color:"#D89047"},{name:"Drawbar Organ",instrument:"organ",color:"#E8609A"},{name:"Cinematic Pad",instrument:"pad-strings",color:"#C9A9E0"},{name:"Celestial Bell",instrument:"bell",color:"#B8CC9E"},{name:"Juno Synth",instrument:"juno-pad",color:"#7B61FF"},{name:"Vintage SH-101",instrument:"sh101",color:"#4EA598"},{name:"House Stab",instrument:"stab",color:"#FF8C42"}],ki={piano:"Grand Piano","grand piano":"Grand Piano",rhodes:"Stage Rhodes","stage rhodes":"Stage Rhodes",epiano:"Stage Rhodes","nylon guitar":"Nylon Guitar",guitar:"Nylon Guitar","jazz archtop":"Jazz Archtop","jazz guitar":"Jazz Archtop",archtop:"Jazz Archtop",hollowbody:"Jazz Archtop","jazz-guitar":"Jazz Archtop","vintage sh-101":"Vintage SH-101","sh-101":"Vintage SH-101",sh101:"Vintage SH-101","boc synth":"Vintage SH-101","warm pad":"Cinematic Pad","cinematic pad":"Cinematic Pad","pad-strings":"Cinematic Pad","synth bell":"Celestial Bell","celestial bell":"Celestial Bell",bell:"Celestial Bell","drawbar organ":"Drawbar Organ",organ:"Drawbar Organ","analog synth":"Juno Synth","juno synth":"Juno Synth","juno-pad":"Juno Synth","synth stab":"House Stab","house stab":"House Stab",stab:"House Stab"};function ue(t){if(!t)return"Grand Piano";const e=t.trim().toLowerCase();if(ki[e])return ki[e];const i=ae.find(n=>n.name.toLowerCase()===e);return i?i.name:"Grand Piano"}const We=[{name:"Block chords",color:"#F2A79B",patch:{arpMode:"off",spread:.3}},{name:"Arpeggio",color:"#9CC0EC",patch:{arpMode:"up",arpRate:"1/8",arpRange:1}},{name:"Strum",color:"#F6D98B",patch:{arpMode:"up",arpRate:"1/32",arpRange:1,isStrum:!0}},{name:"Broken (swing)",color:"#C9A9E0",patch:{arpMode:"up",arpRate:"1/8T",arpRange:1}},{name:"Half-time",color:"#B8CC9E",patch:{arpMode:"off",spread:.1,durationMultiplier:1.8}},{name:"Descending Arp",color:"#7B61FF",patch:{arpMode:"down",arpRate:"1/8",arpRange:1}},{name:"Off-beat / Ska",color:"#FF8C42",patch:{arpMode:"off",spread:.1,microTiming:.8}},{name:"Fast Triplet",color:"#7CD9B6",patch:{arpMode:"up",arpRate:"1/16T",arpRange:1}}],Tt={Pop:"piano",Rock:"piano","Indie/Folk":"guitar","Lo-fi/Chill":"rhodes","Jazz-ish":"rhodes","R&B/Soul":"rhodes",Gospel:"organ",Cinematic:"pad-strings",Synthwave:"juno-pad","House/Dance":"stab",Blues:"rhodes","Funk/Disco":"rhodes","Country/Bluegrass":"guitar","Reggae/Dub":"organ",Metal:"stab",Punk:"stab","Ambient/Drone":"pad-strings","Trap/Hip-Hop":"bell","Bossa Nova/Latin":"guitar","Classical/Orchestral":"piano","EDM/Trance":"juno-pad",Afrobeats:"guitar",Shoegaze:"pad-strings"},bi={Pop:{minVelocity:90,maxVelocity:110,spread:.5,microTiming:.3,humanVariance:.3,duration:1},Rock:{minVelocity:105,maxVelocity:127,spread:.2,microTiming:.1,humanVariance:.15,duration:.9},"Indie/Folk":{minVelocity:80,maxVelocity:105,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},"Lo-fi/Chill":{minVelocity:55,maxVelocity:85,spread:2.5,microTiming:1.2,humanVariance:.8,duration:1.4,arpMode:"up",arpRate:"1/8",arpRange:1},"Jazz-ish":{minVelocity:70,maxVelocity:100,spread:1.8,microTiming:1,humanVariance:.6,duration:1.2,arpMode:"up",arpRate:"1/8T",arpRange:1},"R&B/Soul":{minVelocity:75,maxVelocity:105,spread:1.2,microTiming:.6,humanVariance:.5,duration:1.3},Gospel:{minVelocity:95,maxVelocity:120,spread:.4,microTiming:.2,humanVariance:.2,duration:1.5},Cinematic:{minVelocity:60,maxVelocity:90,spread:0,microTiming:0,humanVariance:.1,duration:2.2},Synthwave:{minVelocity:70,maxVelocity:95,spread:0,microTiming:0,humanVariance:.1,duration:1.8},"House/Dance":{minVelocity:100,maxVelocity:127,spread:0,microTiming:.1,humanVariance:.15,duration:.5},Blues:{minVelocity:80,maxVelocity:110,spread:1.4,microTiming:.7,humanVariance:.5,duration:1.2},"Funk/Disco":{minVelocity:95,maxVelocity:125,spread:.3,microTiming:.2,humanVariance:.2,duration:.8},"Country/Bluegrass":{minVelocity:85,maxVelocity:115,spread:1,microTiming:.4,humanVariance:.3,duration:1},"Reggae/Dub":{minVelocity:70,maxVelocity:100,spread:2,microTiming:1,humanVariance:.6,duration:1.3},Metal:{minVelocity:110,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:.8},Punk:{minVelocity:115,maxVelocity:127,spread:.1,microTiming:.1,humanVariance:.1,duration:.7},"Ambient/Drone":{minVelocity:45,maxVelocity:75,spread:0,microTiming:0,humanVariance:.05,duration:3},"Trap/Hip-Hop":{minVelocity:90,maxVelocity:120,spread:.2,microTiming:.2,humanVariance:.2,duration:1},"Bossa Nova/Latin":{minVelocity:75,maxVelocity:105,spread:1.5,microTiming:.8,humanVariance:.5,duration:1.1,arpMode:"up",arpRate:"1/8T",arpRange:1},"Classical/Orchestral":{minVelocity:50,maxVelocity:115,spread:.5,microTiming:.3,humanVariance:.3,duration:2},"EDM/Trance":{minVelocity:95,maxVelocity:127,spread:.1,microTiming:.05,humanVariance:.1,duration:1.2},Afrobeats:{minVelocity:85,maxVelocity:115,spread:1,microTiming:.5,humanVariance:.4,duration:1.1},Shoegaze:{minVelocity:65,maxVelocity:95,spread:.8,microTiming:.4,humanVariance:.3,duration:2.5}};function Zi(){return Promise.race([_i(),new Promise(t=>setTimeout(t,80))])}function en(t,e){const i=e/60;switch(t){case"1/4":return 1/i;case"1/8":return .5/i;case"1/8T":return .5/i*(2/3);case"1/16":return .25/i;case"1/32":return .125/i;default:return .25/i}}function tn(t,e){const i=[];for(let n=0;n<e;n++)for(const o of t){const s=o.match(/^([A-G]#?)(-?\d+)$/);if(s){const r=s[1],a=parseInt(s[2],10)+n;i.push(`${r}${a}`)}else i.push(o)}return i}function nn(t,e){const i=[...t];switch(e){case"up":return i;case"down":return[...i].reverse();case"up-down":return[...i,...[...i].reverse().slice(1,-1)];case"random":return i.sort(()=>Math.random()-.5);default:return i}}const Ti={piano:"Grand Piano",rhodes:"Stage Rhodes",epiano:"Stage Rhodes",guitar:"Nylon Guitar","pad-strings":"Cinematic Pad","juno-pad":"Juno Synth",bell:"Celestial Bell",organ:"Drawbar Organ",stab:"House Stab"};function Vn(t){if(!t)return;const e=t.toLowerCase().trim();return Ti[e]?Ti[e]:ae.find(n=>n.name.toLowerCase()===e||n.instrument.toLowerCase()===e)?.name}function qn(t){if(!t)return;const e=t.toLowerCase().trim();return e.includes("strum")?"Strum":e.includes("descend")?"Descending Arp":e.includes("half")?"Half-time":e.includes("swing")||e.includes("broken")?"Broken (swing)":e.includes("offbeat")||e.includes("ska")||e.includes("syncopat")||e.includes("groove")?"Off-beat / Ska":e.includes("triplet")||e.includes("fast")?"Fast Triplet":e.includes("arp")||e.includes("cascade")?"Arpeggio":e.includes("block")||e.includes("pad")||e.includes("sustained")?"Block chords":We.find(n=>n.name.toLowerCase()===e)?.name??"Block chords"}function Hn(t,e=.7,i,n="piano",o){try{Promise.all([ji(),Zi()]).then(()=>{const s=Gn(n);if(o&&typeof o=="object"&&Object.keys(o).length>0)try{typeof s.set=="function"&&s.set(o)}catch(g){console.warn("Failed to apply customConfig to Tone.js instrument:",g)}const r=t.length,a=r<=1?1:Math.max(.4,1/Math.sqrt(r)),c=fi(),p=n==="guitar"||n==="jazz-guitar",h=n==="jazz-guitar";if(i&&i.arpMode&&i.arpMode!=="off"){const g=i.bpm??80,d=i.arpRate??"1/16",u=i.arpRange??1,m=i.arpMode,v=en(d,g),b=tn(t,u),y=nn(b,m),N=()=>i.minVelocity!==void 0&&i.maxVelocity!==void 0?(i.minVelocity+Math.random()*(i.maxVelocity-i.minVelocity))/127*a:a,I=(i.isStrum===!0||i.playStyle==="Strum"||d==="1/32")&&(d==="1/32"||i.isStrum===!0),x=typeof i.arpGate=="number"?Math.max(.1,Math.min(2,i.arpGate)):.85,O=1+(Math.random()-.5)*.1*(i.humanVariance??0),F=typeof i.duration=="number"&&i.duration>0?i.duration:e,z=typeof i.spread=="number"&&i.spread>0?Math.min(.045,Math.max(.02,i.spread*.04)):.028,A=I?z:v,$=Math.max(1.4,F)*(1+(Math.random()-.5)*.1*(i.humanVariance??0)),V=Math.max(.04,v*x*O);y.forEach((j,C)=>{const P=i.microTiming?(Math.random()-.5)*i.microTiming*(I?.005:.02):0,H=I?$:V;let Y=N();I&&p&&C===0&&(Y=Math.min(1,Y*(h?1.05:1.1))),s.triggerAttackRelease(j,H,c+C*A+P,Y)});return}(p?[...t].sort((g,d)=>{try{return li(g).toMidi()-li(d).toMidi()}catch{return 0}}):t).forEach((g,d)=>{let u=0,m=a,v=e;if(i){const{minVelocity:b,maxVelocity:y,spread:N,microTiming:I,humanVariance:x,duration:O}=i;m=(typeof i.velocity=="number"?Math.min(1,Math.max(.1,i.velocity/127)):(b+Math.random()*(y-b))/127)*a;const z=p?d*(h?.018:.024):0,A=d*(N??.3)*.1,$=(Math.random()-.5)*(I??0)*.05,V=(Math.random()-.5)*(x??0)*.03;u=Math.max(0,z+A+$+V),v=(O||e)*(1+(Math.random()-.5)*.2*(x??0))}else p&&(u=d*(h?.018:.024));p&&d===0&&(m=Math.min(1,m*(h?1.05:1.1))),s.triggerAttackRelease(g,v,c+u,m)})}).catch(s=>{console.warn("Audio playback gesture failed:",s)})}catch(s){console.warn("Audio playback failed:",s)}}function on(t,e){if(!Array.isArray(t)||t.length===0)return[];if(t.length<=1)return t;if(e<=25)return t.length<=2?t:[t[0],t[t.length-1]];if(e<=55)return t.length<=4?t:t.slice(0,4);if(e<=80)return t;const i=[...t],o=t[t.length-1].match(/^([A-G]#?)(-?\d+)$/);if(o){const s=parseInt(o[2],10);i.push(`${o[1]}${s+1}`)}return i}function Ci(t,e,i){const n=e==="Unknown"||!e?"Pop":e,o=i?.instrument?ue(i.instrument):void 0,s=o?ae.find(b=>b.name.toLowerCase()===o.toLowerCase()):void 0,r=i?.playStyle||i?.feelSettings?.playStyle,a=r?We.find(b=>b.name===r):void 0,c=s?.instrument??Tt[n]??"piano",p=bi[n]||{},h=a?.patch??{};i?.feelSettings?.tone&&Ve(i.feelSettings.tone);const l={};if(i?.feelSettings){const{spread:b,swing:y,humanise:N,humanState:I,advOverride:x}=i.feelSettings;if(I)Object.assign(l,I);else if(typeof b=="number"&&(l.spread=parseFloat((b/100).toFixed(2))),typeof N=="number"&&(l.humanVariance=parseFloat((N/100).toFixed(2))),typeof y=="number"||typeof N=="number"){const O=typeof y=="number"?y:0,F=typeof N=="number"?N:45;l.microTiming=parseFloat((O/100*.5+F/100*.3).toFixed(2))}x&&(typeof x.spread=="number"&&(l.spread=x.spread),typeof x.duration=="number"&&(l.duration=x.duration),typeof x.humanVariance=="number"&&(l.humanVariance=x.humanVariance),typeof x.variance=="number"&&(l.humanVariance=x.variance),typeof x.microTiming=="number"&&(l.microTiming=x.microTiming),typeof x.micro=="number"&&(l.microTiming=x.micro),typeof x.arpMode=="string"&&(l.arpMode=x.arpMode),typeof x.arpRate=="string"&&(l.arpRate=x.arpRate),typeof x.arpRange=="number"&&(l.arpRange=x.arpRange),typeof x.arpGate=="number"&&(l.arpGate=x.arpGate),typeof x.minVelocity=="number"&&(l.minVelocity=x.minVelocity),typeof x.maxVelocity=="number"&&(l.maxVelocity=x.maxVelocity))}h.arpMode&&h.arpMode!=="off"&&(i?.feelSettings?.advOverride&&i.feelSettings.advOverride.arpMode!==void 0||(l.arpMode=h.arpMode,h.arpRate&&(!i?.feelSettings?.advOverride||i.feelSettings.advOverride.arpRate===void 0)&&(l.arpRate=h.arpRate),h.arpRange!==void 0&&(!i?.feelSettings?.advOverride||i.feelSettings.advOverride.arpRange===void 0)&&(l.arpRange=h.arpRange))),h.isStrum!==void 0&&(!i?.feelSettings?.advOverride||i.feelSettings.advOverride.isStrum===void 0)&&(l.isStrum=h.isStrum);const g={...p,...h,...l,bpm:i?.bpm??p.bpm??90,playStyle:r,...typeof i?.velocity=="number"?{velocity:i.velocity}:{}},d=i?.duration??p.duration??.9,u=typeof l.duration=="number"?l.duration:h.durationMultiplier?d*h.durationMultiplier:d,m=i?.feelSettings?.density??50,v=on(t,m);Hn(v,u,g,c,i?.customConfig)}let Zt=null;function Yn(){if(!Zt){const t=Vi();Zt=new ce({oscillator:{type:"sine"},envelope:{attack:.02,decay:.25,sustain:.85,release:.4},volume:-7}).connect(t)}return Zt}function Jn(t,e=.8,i,n=.85){try{Promise.all([ji(),Zi()]).then(()=>{const o=Yn(),r=`${t.replace(/\d+$/,"")}1`,a=typeof i=="number"?i:fi();o.triggerAttackRelease(r,e,a,n)}).catch(o=>console.warn("Sub bass audio failed:",o))}catch(o){console.warn("Sub bass audio failed:",o)}}function Wn(t,e="root position"){const i={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},n=4,o=(Array.isArray(t)?t:[]).filter(p=>typeof p=="string"&&p.trim().length>0).map(p=>p.replace(/\d+$/,""));if(o.length===0)return["C4","E4","G4"];let s=n,r=i[o[0]]??0;const a=[];o.forEach((p,h)=>{const l=i[p]??0;h>0&&l<=r&&s++,a.push({name:p,oct:s}),r=l});const c=(e||"").toLowerCase();if(c.includes("octave")||c.includes("high"))return a.map(p=>`${p.name}${p.oct+1}`);if(c.includes("inversion")||c.includes("1st")){if(a.length>1){const[p,...h]=a;return[...h.map(l=>`${l.name}${l.oct}`),`${p.name}${p.oct+1}`]}return a.map(p=>`${p.name}${p.oct}`)}else return a.map(p=>`${p.name}${p.oct}`)}const Kn=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],Xn=["C","Db","D","Eb","E","F","Gb","G","Ab","A","Bb","B"],B={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},Qn=new Set(["F","Bb","Eb","Ab","Db","Gb"]),He=["C","Db","D","Eb","E","F","F#","G","Ab","A","Bb","B"],ne={maj:[0,4,7],min:[0,3,7],dim:[0,3,6],aug:[0,4,8],dom7:[0,4,7,10],min7:[0,3,7,10],maj7:[0,4,7,11],dim7:[0,3,6,9],sus4:[0,5,7],sus2:[0,2,7],dom9:[0,4,7,10,14],maj9:[0,4,7,11,14],min9:[0,3,7,10,14],maj6:[0,4,7,9],min6:[0,3,7,9],mmaj7:[0,3,7,11],sus7:[0,5,7,10],sus9:[0,5,7,10,14]},Zn=Object.keys(ne),vt={TONIC:"home",SUPERTONIC:"rise",MEDIANT:"glow",SUBDOMINANT:"lift",DOMINANT:"reach",SUBMEDIANT:"hold","LEADING-TONE":"edge",SUBTONIC:"drift"},Ye={TONIC:"Tonic",SUPERTONIC:"Supertonic",MEDIANT:"Mediant",SUBDOMINANT:"Subdominant",DOMINANT:"Dominant",SUBMEDIANT:"Submediant","LEADING-TONE":"Leading tone",SUBTONIC:"Subtonic"},Je={TONIC:.04,SUBMEDIANT:.24,MEDIANT:.34,SUBDOMINANT:.42,SUPERTONIC:.52,SUBTONIC:.58,"LEADING-TONE":.78,DOMINANT:.68},xt={MAJOR:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},NATURAL_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},HARMONIC_MINOR:{TONIC:"i",SUPERTONIC:"ii°",MEDIANT:"♭III+",SUBDOMINANT:"iv",DOMINANT:"V",SUBMEDIANT:"♭VI","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MELODIC_MINOR:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III+",SUBDOMINANT:"IV",DOMINANT:"V",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},DORIAN:{TONIC:"i",SUPERTONIC:"ii",MEDIANT:"♭III",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi°","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},MIXOLYDIAN:{TONIC:"I",SUPERTONIC:"ii",MEDIANT:"iii°",SUBDOMINANT:"IV",DOMINANT:"v",SUBMEDIANT:"vi","LEADING-TONE":"vii°",SUBTONIC:"♭VII"},LYDIAN:{TONIC:"I",SUPERTONIC:"II",MEDIANT:"iii",SUBDOMINANT:"iv°",DOMINANT:"V",SUBMEDIANT:"vi","LEADING-TONE":"vii",SUBTONIC:"♭VII"},PHRYGIAN:{TONIC:"i",SUPERTONIC:"♭II",MEDIANT:"♭III",SUBDOMINANT:"iv",DOMINANT:"v°",SUBMEDIANT:"♭VI","LEADING-TONE":"vii",SUBTONIC:"♭vii"},LOCRIAN:{TONIC:"i°",SUPERTONIC:"♭II",MEDIANT:"♭iii",SUBDOMINANT:"iv",DOMINANT:"♭V",SUBMEDIANT:"♭VI","LEADING-TONE":"♭vii",SUBTONIC:"♭vii"}};function M(t,e){const i=(t%12+12)%12;return e?Xn[i]:Kn[i]}function W(t){if(!t)return{root:"C",quality:"maj"};const e=t.trim(),i=e[0]?.toUpperCase();let n="C",o=e;if(i&&/[A-G]/.test(i)){const r=e[1];r==="b"||r==="B"||r==="♭"||r==="♭"?(n=`${i}b`,o=e.slice(2)):r==="#"||r==="♯"||r==="♯"?(n=`${i}#`,o=e.slice(2)):(n=i,o=e.slice(1))}o=o.toLowerCase();let s="maj";return o.includes("maj9")||o.includes("m9")&&o.includes("maj")?s="maj9":o.includes("min9")||o.includes("m9")?s="min9":o.includes("dom9")||o.includes("9sus")||o.includes("9")?o.includes("9sus")||o.includes("sus9")?s="sus9":s="dom9":o.includes("m(maj7)")||o.includes("mmaj7")||o.includes("minmaj7")?s="mmaj7":o.includes("maj7sus")||o.includes("7sus")?s="sus7":o.includes("maj7")||o.includes("m7")&&o.includes("maj")?s="maj7":o.includes("min7")||o.includes("m7")?s="min7":o.includes("min6")||o.includes("m6")?s="min6":o.includes("maj6")||o.includes("6")&&!o.includes("m")?s="maj6":o.includes("dim7")?s="dim7":o.includes("dim")||o.includes("°")?s="dim":o.includes("aug")||o.includes("+")?s="aug":o.includes("sus2")?s="sus2":o.includes("sus4")||o.includes("sus")?s="sus4":o.includes("7")?s="dom7":o.includes("min")||o==="m"?s="min":s="maj",{root:n,quality:s}}const eo=Object.keys(xt),te={MAJOR:"Major",NATURAL_MINOR:"Minor",HARMONIC_MINOR:"Harmonic minor",MELODIC_MINOR:"Melodic minor",DORIAN:"Dorian",MIXOLYDIAN:"Mixolydian",LYDIAN:"Lydian",PHRYGIAN:"Phrygian",LOCRIAN:"Locrian"},dt={MAJOR:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"],NATURAL_MINOR:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],PHRYGIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LOCRIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],HARMONIC_MINOR:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"],MELODIC_MINOR:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]},De={MAJOR:{TONIC:0,SUPERTONIC:2,MEDIANT:4,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:9,"LEADING-TONE":11},NATURAL_MINOR:{TONIC:0,SUPERTONIC:2,MEDIANT:3,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:8,SUBTONIC:10},DORIAN:{TONIC:0,SUPERTONIC:2,MEDIANT:3,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:9,SUBTONIC:10},PHRYGIAN:{TONIC:0,SUPERTONIC:1,MEDIANT:3,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:8,SUBTONIC:10},LYDIAN:{TONIC:0,SUPERTONIC:2,MEDIANT:4,SUBDOMINANT:6,DOMINANT:7,SUBMEDIANT:9,"LEADING-TONE":11},MIXOLYDIAN:{TONIC:0,SUPERTONIC:2,MEDIANT:4,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:9,SUBTONIC:10},LOCRIAN:{TONIC:0,SUPERTONIC:1,MEDIANT:3,SUBDOMINANT:5,DOMINANT:6,SUBMEDIANT:8,SUBTONIC:10},HARMONIC_MINOR:{TONIC:0,SUPERTONIC:2,MEDIANT:3,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:8,"LEADING-TONE":11},MELODIC_MINOR:{TONIC:0,SUPERTONIC:2,MEDIANT:3,SUBDOMINANT:5,DOMINANT:7,SUBMEDIANT:9,"LEADING-TONE":11}},Ei={MAJOR:{TONIC:"maj",SUPERTONIC:"min",MEDIANT:"min",SUBDOMINANT:"maj",DOMINANT:"maj",SUBMEDIANT:"min","LEADING-TONE":"dim"},NATURAL_MINOR:{TONIC:"min",SUPERTONIC:"dim",MEDIANT:"maj",SUBDOMINANT:"min",DOMINANT:"min",SUBMEDIANT:"maj",SUBTONIC:"maj"},DORIAN:{TONIC:"min",SUPERTONIC:"min",MEDIANT:"maj",SUBDOMINANT:"maj",DOMINANT:"min",SUBMEDIANT:"dim",SUBTONIC:"maj"},PHRYGIAN:{TONIC:"min",SUPERTONIC:"maj",MEDIANT:"maj",SUBDOMINANT:"min",DOMINANT:"dim",SUBMEDIANT:"maj",SUBTONIC:"min"},LYDIAN:{TONIC:"maj",SUPERTONIC:"maj",MEDIANT:"min",SUBDOMINANT:"dim",DOMINANT:"maj",SUBMEDIANT:"min","LEADING-TONE":"min"},MIXOLYDIAN:{TONIC:"maj",SUPERTONIC:"min",MEDIANT:"dim",SUBDOMINANT:"maj",DOMINANT:"min",SUBMEDIANT:"min",SUBTONIC:"maj"},LOCRIAN:{TONIC:"dim",SUPERTONIC:"maj",MEDIANT:"min",SUBDOMINANT:"min",DOMINANT:"maj",SUBMEDIANT:"maj",SUBTONIC:"min"},HARMONIC_MINOR:{TONIC:"min",SUPERTONIC:"dim",MEDIANT:"aug",SUBDOMINANT:"min",DOMINANT:"maj",SUBMEDIANT:"maj","LEADING-TONE":"dim"},MELODIC_MINOR:{TONIC:"min",SUPERTONIC:"min",MEDIANT:"aug",SUBDOMINANT:"maj",DOMINANT:"maj",SUBMEDIANT:"dim","LEADING-TONE":"dim"}},sn=["Pop","Lo-fi/Chill","R&B/Soul","Indie/Folk","Synthwave","Jazz-ish","Gospel","Cinematic","Rock","House/Dance","Blues","Funk/Disco","Country/Bluegrass","Reggae/Dub","Metal","Punk","Ambient/Drone","Trap/Hip-Hop","Bossa Nova/Latin","Classical/Orchestral","EDM/Trance","Afrobeats","Shoegaze"],to={Pop:"MAJOR",Rock:"MAJOR",Gospel:"MAJOR","Indie/Folk":"MAJOR","Lo-fi/Chill":"DORIAN","Jazz-ish":"DORIAN","R&B/Soul":"MIXOLYDIAN","House/Dance":"MIXOLYDIAN",Synthwave:"LYDIAN",Cinematic:"LYDIAN",Blues:"MIXOLYDIAN","Funk/Disco":"MIXOLYDIAN","Country/Bluegrass":"MAJOR","Reggae/Dub":"DORIAN",Metal:"HARMONIC_MINOR",Punk:"MAJOR","Ambient/Drone":"LYDIAN","Trap/Hip-Hop":"NATURAL_MINOR","Bossa Nova/Latin":"DORIAN","Classical/Orchestral":"MAJOR","EDM/Trance":"NATURAL_MINOR",Afrobeats:"MIXOLYDIAN",Shoegaze:"LYDIAN"},io={Uplifting:null,Melancholy:"NATURAL_MINOR",Dreamy:null,Tense:"HARMONIC_MINOR",Warm:null,Nostalgic:"NATURAL_MINOR",Energetic:null,Dark:"HARMONIC_MINOR",Peaceful:null,Groovy:"MIXOLYDIAN",Epic:"MAJOR"},yi={Uplifting:["DOMINANT","SUBDOMINANT","SUBMEDIANT"],Melancholy:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Dreamy:["MEDIANT","SUBDOMINANT","SUPERTONIC"],Tense:["DOMINANT","LEADING-TONE","SUPERTONIC"],Warm:["SUBDOMINANT","MEDIANT","SUBMEDIANT"],Nostalgic:["SUBMEDIANT","MEDIANT","DOMINANT"],Energetic:["DOMINANT","SUBDOMINANT","SUPERTONIC"],Dark:["SUBMEDIANT","SUBTONIC","SUPERTONIC"],Peaceful:["TONIC","SUBDOMINANT","MEDIANT"],Groovy:["SUBDOMINANT","DOMINANT","SUBTONIC"],Epic:["TONIC","DOMINANT","SUBMEDIANT"]},wt=[{name:"Uplifting",dot:"#F6D98B",desc:"Bright, major, forward-moving",iconPath:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5"},{name:"Melancholy",dot:"#9CC0EC",desc:"Minor-leaning, unresolved longing",iconPath:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15"},{name:"Dreamy",dot:"#C9A9E0",desc:"Suspended, floating, reverb-soaked",iconPath:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0"},{name:"Tense",dot:"#F2735F",desc:"Chromatic pulls, unresolved tension",iconPath:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12"},{name:"Warm",dot:"#F2C9A0",desc:"Rich, consonant, close voicings",iconPath:"M12 4 a6.5 6.5 0 1 0 6.5 6.5"},{name:"Nostalgic",dot:"#B8CC9E",desc:"Bittersweet, borrowed chords",iconPath:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},{name:"Energetic",dot:"#FF8C42",desc:"High velocity, driving rhythm",iconPath:"M13 2 L4 14 h7 l-2 8 11-12 h-7 z"},{name:"Dark",dot:"#7B61FF",desc:"Deep minor, ominous resonance",iconPath:"M12 3 a9 9 0 1 0 9 9 a9 9 0 0 1-9-9 z"},{name:"Peaceful",dot:"#7CD9B6",desc:"Serene, gentle acoustic space",iconPath:"M12 2 a10 10 0 1 0 10 10 A10 10 0 0 0 12 2 z M12 6 a6 6 0 1 1-6 6 a6 6 0 0 1 6-6 z"},{name:"Groovy",dot:"#E8609A",desc:"Syncopated, rhythmic bounce",iconPath:"M4 12 c4-4 8 4 12-4 s8 4 4 8"},{name:"Epic",dot:"#E5C158",desc:"Sweeping dynamics, triumphant power",iconPath:"M12 2 l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 z"}];function ei(t){return(wt.find(e=>e.name===t)||wt[0]).dot}const no={MAJOR:[{degrees:["TONIC","DOMINANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBMEDIANT","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","DOMINANT"]},{degrees:["TONIC","MEDIANT","SUBMEDIANT","SUBDOMINANT"]},{degrees:["TONIC","SUBDOMINANT","SUBMEDIANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","MEDIANT","SUBMEDIANT"]},{degrees:["SUBDOMINANT","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","DOMINANT","SUBDOMINANT","DOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","SUBMEDIANT","TONIC"]}],NATURAL_MINOR:[{degrees:["TONIC","SUBMEDIANT","MEDIANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","MEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUBTONIC","DOMINANT"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBMEDIANT"]},{degrees:["SUBMEDIANT","SUBTONIC","TONIC","DOMINANT"]},{degrees:["SUBMEDIANT","SUBTONIC","MEDIANT","TONIC"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","SUBMEDIANT","SUBDOMINANT","TONIC"]}],HARMONIC_MINOR:[{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUBDOMINANT"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","DOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","SUPERTONIC","DOMINANT"]},{degrees:["SUBMEDIANT","DOMINANT","TONIC","SUBDOMINANT"]},{degrees:["SUBDOMINANT","DOMINANT","TONIC","SUBMEDIANT"]}],DORIAN:[{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUBDOMINANT","SUPERTONIC","SUBTONIC"]},{degrees:["SUBDOMINANT","TONIC","SUBTONIC","SUPERTONIC"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUPERTONIC","SUBDOMINANT","SUBTONIC","TONIC"]}],MIXOLYDIAN:[{degrees:["TONIC","SUBTONIC","SUBDOMINANT","SUBMEDIANT"]},{degrees:["TONIC","SUBDOMINANT","SUBTONIC","SUPERTONIC"]},{degrees:["TONIC","SUBMEDIANT","SUBDOMINANT","SUBTONIC"]},{degrees:["TONIC","SUPERTONIC","SUBTONIC","SUBDOMINANT"]},{degrees:["SUBTONIC","SUBDOMINANT","TONIC","DOMINANT"]},{degrees:["SUBDOMINANT","SUBTONIC","TONIC","SUBMEDIANT"]},{degrees:["SUBTONIC","TONIC","SUBDOMINANT","SUPERTONIC"]}],LYDIAN:[{degrees:["TONIC","SUPERTONIC","SUBMEDIANT","DOMINANT"]},{degrees:["TONIC","DOMINANT","SUPERTONIC","SUBMEDIANT"]},{degrees:["TONIC","SUBMEDIANT","DOMINANT","SUPERTONIC"]},{degrees:["TONIC","SUPERTONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","TONIC","DOMINANT","SUBMEDIANT"]},{degrees:["SUPERTONIC","DOMINANT","TONIC","SUBMEDIANT"]}]};function oo(t,e){return 1+t.degrees.filter(i=>e.includes(i)).length*.6}function J(t,e){const i=t.reduce((o,s)=>o+e(s),0);let n=Math.random()*i;for(const o of t)if(n-=e(o),n<=0)return o;return t[t.length-1]}function so(t){if(t.length)return t[Math.floor(Math.random()*t.length)]}const di=4,Ke=1,Re=8,ro={TONIC:{SUBDOMINANT:.35,SUBMEDIANT:.25,SUPERTONIC:.15,DOMINANT:.15,MEDIANT:.05,SUBTONIC:.05},SUPERTONIC:{DOMINANT:.5,SUBDOMINANT:.2,SUBMEDIANT:.15,TONIC:.1,"LEADING-TONE":.05},MEDIANT:{SUBMEDIANT:.4,SUBDOMINANT:.3,SUPERTONIC:.15,DOMINANT:.15},SUBDOMINANT:{DOMINANT:.45,TONIC:.25,SUPERTONIC:.15,SUBMEDIANT:.15},DOMINANT:{TONIC:.55,SUBMEDIANT:.25,SUBDOMINANT:.15,MEDIANT:.05},SUBMEDIANT:{SUBDOMINANT:.4,SUPERTONIC:.25,DOMINANT:.2,TONIC:.15},"LEADING-TONE":{TONIC:.7,SUBMEDIANT:.2,MEDIANT:.1},SUBTONIC:{TONIC:.45,SUBDOMINANT:.3,SUBMEDIANT:.15,DOMINANT:.1}};function rn(t,e="MAJOR",i="Pop",n="Uplifting"){let s={TONIC:1,SUBDOMINANT:.45,SUBMEDIANT:.4,SUPERTONIC:.3,SUBTONIC:.3,MEDIANT:.15,DOMINANT:.15,"LEADING-TONE":.02}[t]??.1;return e.includes("MINOR")||e==="DORIAN"?(t==="SUBMEDIANT"&&(s*=1.4),t==="SUBTONIC"&&(s*=1.3)):e==="MIXOLYDIAN"?(t==="SUBTONIC"&&(s*=1.8),t==="SUBDOMINANT"&&(s*=1.5)):e==="LYDIAN"&&t==="SUPERTONIC"&&(s*=1.8),i==="Lo-fi/Chill"||i==="R&B/Soul"?((t==="SUBDOMINANT"||t==="SUPERTONIC")&&(s*=2),t==="SUBMEDIANT"&&(s*=1.5)):i==="Jazz-ish"||i==="Bossa Nova/Latin"?(t==="SUPERTONIC"&&(s*=2.5),t==="SUBDOMINANT"&&(s*=1.8)):i==="Pop"||i==="Indie/Folk"||i==="Shoegaze"?(t==="SUBDOMINANT"||t==="SUBMEDIANT")&&(s*=1.8):i==="Synthwave"||i==="House/Dance"||i==="Rock"||i==="Punk"||i==="Funk/Disco"||i==="Reggae/Dub"?(t==="SUBTONIC"&&(s*=2.2),t==="SUBDOMINANT"&&(s*=1.8),t==="SUBMEDIANT"&&(s*=1.6)):(i==="Classical/Orchestral"||i==="Gospel")&&t==="TONIC"&&(s*=2.5),n==="Uplifting"||n==="Epic"||n==="Peaceful"?t==="TONIC"&&(s*=2.5):n==="Melancholy"||n==="Dark"?(t==="SUBMEDIANT"&&(s*=2.2),t==="SUPERTONIC"&&(s*=1.5)):n==="Dreamy"||n==="Nostalgic"||n==="Warm"?(t==="SUBDOMINANT"&&(s*=2),t==="SUBMEDIANT"&&(s*=1.6),t==="MEDIANT"&&(s*=1.4)):n==="Tense"?(t==="SUPERTONIC"||t==="SUBDOMINANT")&&(s*=1.8):(n==="Groovy"||n==="Energetic")&&(t==="SUBTONIC"||t==="SUBDOMINANT")&&(s*=1.8),(yi[n]||[]).includes(t)&&(s*=1.3),Math.max(.01,s)}function fe(t,e,i="MAJOR",n="Pop",o="Uplifting"){if(t===e)return .05;let r=(ro[t]||{})[e]??.1;return(i.includes("MINOR")||i==="DORIAN")&&(t==="TONIC"&&e==="SUBMEDIANT"&&(r*=1.5),t==="SUBMEDIANT"&&e==="MEDIANT"&&(r*=1.4),t==="MEDIANT"&&e==="SUBTONIC"&&(r*=1.4),t==="SUBTONIC"&&e==="TONIC"&&(r*=1.3)),n==="Jazz-ish"||n==="Lo-fi/Chill"?(t==="SUPERTONIC"&&e==="DOMINANT"&&(r*=1.8),t==="DOMINANT"&&e==="TONIC"&&(r*=1.5),t==="TONIC"&&e==="SUPERTONIC"&&(r*=1.4)):(n==="House/Dance"||n==="Synthwave")&&(e==="SUBTONIC"||e==="SUBDOMINANT")&&(r*=1.5),(yi[o]||[]).includes(e)&&(r*=1.5),Math.max(.01,r)}function ao(t,e,i,n,o,s,r=di){let a=i.filter(l=>t.degrees[l]);a.length||(a=i);const c=J(a,l=>rn(l,t.type,o,s))||"TONIC",p=[c];let h=c;for(let l=1;l<r;l++){const g=l===r-1;let d=i.filter(v=>t.degrees[v]);d.length||(d=i);const u=d.filter(v=>v!==h),m=u.length?u:d;if(g){const v=J(m,b=>{const y=fe(b,p[0],t.type,o,s),N=fe(h,b,t.type,o,s);return y*N});p.push(v)}else{const v=m.filter(N=>!p.includes(N)),b=v.length?v:m,y=J(b,N=>fe(h,N,t.type,o,s));h=y,p.push(y)}}return p}function Ct(t,e,i){return t.includes("b")||t==="F"||t==="Bb"||t==="Eb"||t==="Ab"||t==="Db"||t==="Gb"?!0:t.includes("#")?!1:i}function G(t,e){const{root:i,quality:n}=W(t),o=B[i]??0,s=ne[n]||ne.maj,r=Ct(i,n,e);return s.map(a=>M(o+a,r))}async function lo(){const t=typeof import.meta<"u"?"./":"/",i=`${t.endsWith("/")?t:`${t}/`}chroma_chords_data.json`;let n=await fetch(i).catch(()=>null);if((!n||!n.ok)&&(n=await fetch("/chroma_chords_data.json").catch(()=>null)),(!n||!n.ok)&&(n=await fetch("./chroma_chords_data.json").catch(()=>null)),!n||!n.ok)throw new Error(`HTTP error: ${n?n.status:"failed to fetch chroma_chords_data.json"}`);const o=await n.json();return fo(o),o}const co={C:"F",Db:"F#",D:"G",Eb:"Ab",E:"A",F:"Bb","F#":"B",G:"C",Ab:"Db",A:"D",Bb:"Eb",B:"E"},po={C:"Bb","C#":"B",D:"C","D#":"Db",E:"D",F:"Eb","F#":"E",G:"F","G#":"F#",A:"G","A#":"Ab",B:"A"},ho={C:"G",Db:"Ab",D:"A",Eb:"Bb",E:"B",F:"C","F#":"Db",G:"D",Ab:"Eb",A:"E",Bb:"F",B:"F#"},uo={DORIAN_SUPERTONIC:"TONIC",DORIAN_MEDIANT:"SUPERTONIC",DORIAN_SUBDOMINANT:"MEDIANT",DORIAN_DOMINANT:"SUBDOMINANT",DORIAN_SUBMEDIANT:"DOMINANT","DORIAN_LEADING-TONE":"SUBMEDIANT",DORIAN_TONIC:"SUBTONIC",MIXOLYDIAN_DOMINANT:"TONIC",MIXOLYDIAN_SUBMEDIANT:"SUPERTONIC","MIXOLYDIAN_LEADING-TONE":"MEDIANT",MIXOLYDIAN_TONIC:"SUBDOMINANT",MIXOLYDIAN_SUPERTONIC:"DOMINANT",MIXOLYDIAN_MEDIANT:"SUBMEDIANT",MIXOLYDIAN_SUBDOMINANT:"SUBTONIC",LYDIAN_SUBDOMINANT:"TONIC",LYDIAN_DOMINANT:"SUPERTONIC",LYDIAN_SUBMEDIANT:"MEDIANT","LYDIAN_LEADING-TONE":"SUBDOMINANT",LYDIAN_TONIC:"DOMINANT",LYDIAN_SUPERTONIC:"SUBMEDIANT",LYDIAN_MEDIANT:"LEADING-TONE"},mo={DORIAN_TONIC:"SUPERTONIC",DORIAN_SUPERTONIC:"MEDIANT",DORIAN_MEDIANT:"SUBDOMINANT",DORIAN_SUBDOMINANT:"DOMINANT",DORIAN_DOMINANT:"SUBMEDIANT",DORIAN_SUBMEDIANT:"LEADING-TONE",DORIAN_SUBTONIC:"TONIC",MIXOLYDIAN_TONIC:"DOMINANT",MIXOLYDIAN_SUPERTONIC:"SUBMEDIANT",MIXOLYDIAN_MEDIANT:"LEADING-TONE",MIXOLYDIAN_SUBDOMINANT:"TONIC",MIXOLYDIAN_DOMINANT:"SUPERTONIC",MIXOLYDIAN_SUBMEDIANT:"MEDIANT",MIXOLYDIAN_SUBTONIC:"SUBDOMINANT",LYDIAN_TONIC:"SUBDOMINANT",LYDIAN_SUPERTONIC:"DOMINANT",LYDIAN_MEDIANT:"SUBMEDIANT",LYDIAN_SUBDOMINANT:"LEADING-TONE",LYDIAN_DOMINANT:"TONIC",LYDIAN_SUBMEDIANT:"SUPERTONIC","LYDIAN_LEADING-TONE":"MEDIANT"},go={DORIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],MIXOLYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","SUBTONIC"],LYDIAN:["TONIC","SUPERTONIC","MEDIANT","SUBDOMINANT","DOMINANT","SUBMEDIANT","LEADING-TONE"]};function fo(t){const e=[["MIXOLYDIAN",co],["DORIAN",po],["LYDIAN",ho]];for(const[i,n]of e)for(const[o,s]of Object.entries(n)){const r=t.scales[`${s}_MAJOR`];if(!r)continue;const a=`${o}_${i}`,c={};for(const p of go[i]){const h=mo[`${i}_${p}`],l=r.degrees[h];if(!l)continue;const g=JSON.parse(JSON.stringify(l));g.next_chord_options=(g.next_chord_options||[]).map(d=>{if(d.nodeId.startsWith(`${s}_MAJOR_`)){const u=d.nodeId.replace(`${s}_MAJOR_`,""),m=uo[`${i}_${u}`];if(m)return{name:d.name,nodeId:`${o}_${i}_${m}`}}return d}),c[p]=g}t.scales[a]={root:o,type:i,degrees:c}}}const bo=[156,192,236],yo=[242,115,95];function yt(t,e,i){return t+(e-t)*i}function Le(t){const e=Math.max(0,Math.min(1,t));return"#"+bo.map((n,o)=>Math.round(yt(n,yo[o],e))).map(n=>n.toString(16).padStart(2,"0")).join("")}function Q(t){const e=Math.max(0,Math.min(1,t));return{size:Math.round(yt(84,128,e)),radius:Math.round(yt(40,12,e)),fontSize:Math.round(yt(21,30,e)),color:Le(e)}}function It(t,e,i){return{Tonic:`As the tonic, ${i} establishes home — the point of full rest and resolution.`,Supertonic:`As the supertonic, ${i} steps just off home, a light pivot toward what comes next.`,Mediant:`As the mediant, ${i} offers a soft, glowing detour — related to home, but colored differently.`,Subdominant:`As the subdominant, ${i} lifts away from home, opening the progression outward before it turns back.`,Dominant:`As the dominant, ${i} builds the pull of the progression — tension that wants to resolve.`,Submediant:`As the submediant, ${i} offers a warmer, more introspective variation of the tonic — stable but tinged with longing.`,"Leading tone":`As the leading tone, ${i} sits right on the edge, straining toward resolution.`,Subtonic:`As the subtonic, ${i} drifts just below home, a soft modal step rather than a hard pull.`}[t]||`${i} colors the progression as the ${t.toLowerCase()} of ${e}.`}function de(t,e,i,n){const s=i.degrees[e].chord_name,r=Je[e]??.5,a=xt[i.type]||xt.MAJOR;return{name:Oi(s),tag:vt[e]||"move",roman:a[e]||"?",color:Le(r),functionLabel:Ye[e]||e,notes:G(s,n),scaleLabel:`${i.root} ${te[i.type]||i.type}`,desc:It(Ye[e]||e,te[i.type]||i.type,Oi(s)),degree:e,scaleKey:t,tension:r}}function Oi(t){const{root:e,quality:i}=W(t);return`${e}${{maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"}[i]??""}`}const vo={Pop:116,"Lo-fi/Chill":80,"R&B/Soul":90,"Indie/Folk":105,Synthwave:118,"Jazz-ish":95,Gospel:85,Cinematic:75,Rock:124,"House/Dance":126,Blues:88,"Funk/Disco":114,"Country/Bluegrass":110,"Reggae/Dub":78,Metal:140,Punk:155,"Ambient/Drone":65,"Trap/Hip-Hop":135,"Bossa Nova/Latin":120,"Classical/Orchestral":72,"EDM/Trance":132,Afrobeats:108,Shoegaze:112};function an(t,e){let i=vo[t]||92;return e==="Tense"&&(i+=6),(e==="Dreamy"||e==="Melancholy")&&(i-=6),i}function pi(t,e,i,n){const o=Math.max(Ke,Math.min(Re,n?.length??di)),s=to[e]||"MAJOR",r=io[i],a=n?.scaleType||(r&&s==="MAJOR"?r:s);let c=n?.key&&He.includes(n.key)?n.key:so(He),p=`${c}_${a}`;t.scales[p]||(c="C",p=`${c}_${a}`);let h=t.scales[p];if(!h){const N=Object.keys(t.scales).find(I=>I.endsWith(`_${a}`))||Object.keys(t.scales)[0];h=t.scales[N],c=h?h.root:"C",p=N}const l=R(c,a),g=Object.keys(h.degrees),d=yi[i]||[],u=no[a]||[],m=o===di?u.filter(N=>N.degrees.every(I=>g.includes(I))):[],y=(m.length&&Math.random()<.25?J(m,N=>oo(N,d)).degrees:ao(h,p,g,d,e,i,o)).map(N=>de(p,N,h,l));return{genre:e,mood:i,key:c,scaleType:a,bpm:an(e,i),chords:y}}function xo(t,e,i,n=[]){const o=t.chords.length,s=Math.max(Ke,Math.min(Re,e));if(s===o)return{progression:t,cachedTailChords:[...n]};if(s<o){const A=t.chords.slice(0,s),$=t.chords.slice(s);return{progression:{...t,chords:A},cachedTailChords:[...$,...n]}}const r=[...t.chords],a=[...n],c=s-o,p=[];for(;p.length<c&&a.length>0;)p.push(a.shift());const h=[...r,...p],l=s-h.length;if(l<=0)return{progression:{...t,chords:h},cachedTailChords:a};const g=t.key||"C",d=t.scaleType||"MAJOR";let u=`${g}_${d}`,m=i.scales?.[u];if(!m&&i.scales&&Object.keys(i.scales).length>0){const A=Object.keys(i.scales).find($=>$.endsWith(`_${d}`))||Object.keys(i.scales)[0];m=i.scales[A],u=A}if(!m)return{progression:{...t,chords:h},cachedTailChords:a};const v=R(m.root||g,d),b=Object.keys(m.degrees);let y=b.filter(A=>m.degrees[A]);y.length||(y=b);const N=A=>{if(!A)return"TONIC";if(A.degree&&m.degrees[A.degree])return A.degree;for(const[$,V]of Object.entries(m.degrees))if(V.chord_name===A.name)return $;return"TONIC"},I=h[h.length-1];let x=N(I);const O=h[0],F=N(O),z=[];for(let A=0;A<l;A++){const $=A===l-1,V=y.filter(P=>P!==x),j=V.length?V:y;let C;$?C=J(j,P=>{const H=fe(P,F,m.type,t.genre,t.mood),Y=fe(x,P,m.type,t.genre,t.mood);return H*Y})||j[0]:C=J(j,P=>fe(x,P,m.type,t.genre,t.mood))||j[0],x=C,z.push(de(u,C,m,v))}return{progression:{...t,chords:[...h,...z]},cachedTailChords:a}}const wo={TONIC:{upper:"I",lower:"i"},SUPERTONIC:{upper:"II",lower:"ii"},MEDIANT:{upper:"III",lower:"iii"},SUBDOMINANT:{upper:"IV",lower:"iv"},DOMINANT:{upper:"V",lower:"v"},SUBMEDIANT:{upper:"VI",lower:"vi"},"LEADING-TONE":{upper:"VII",lower:"vii"},SUBTONIC:{upper:"♭VII",lower:"♭vii"}},Io={0:{upper:"I",lower:"i"},1:{upper:"♭II",lower:"♭ii"},2:{upper:"II",lower:"ii"},3:{upper:"♭III",lower:"♭iii"},4:{upper:"III",lower:"iii"},5:{upper:"IV",lower:"iv"},6:{upper:"♯IV",lower:"♯iv"},7:{upper:"V",lower:"v"},8:{upper:"♭VI",lower:"♭vi"},9:{upper:"VI",lower:"vi"},10:{upper:"♭VII",lower:"♭vii"},11:{upper:"VII",lower:"vii"}};function ln(t){return ne[t]?t:W(`C${t||""}`).quality}function vi(t,e){return e==="dom7"?`${t}7`:e==="maj7"?`${t}maj7`:e==="min7"?`${t}7`:e==="dim"?`${t}°`:e==="dim7"?`${t}°7`:e==="aug"?`${t}+`:e==="sus4"?`${t}sus4`:e==="sus2"?`${t}sus2`:e==="dom9"?`${t}9`:e==="maj9"?`${t}maj9`:e==="min9"?`${t}m9`:t}function St(t,e){const i=wo[t]||{upper:"I",lower:"i"},o=e==="min"||e==="min7"||e==="dim"||e==="dim7"||e==="min9"?i.lower:i.upper;return vi(o,e)}function Et(t,e){const i=Io[(t%12+12)%12]||{upper:"?",lower:"?"},o=e==="min"||e==="min7"||e==="dim"||e==="dim7"||e==="min9"?i.lower:i.upper;return vi(o,e)}function So(t,e,i,n){const o=e==="maj"||e==="dom7"||e==="dom9",s=e==="min"||e==="min7"||e==="min9";if(t==="MEDIANT"&&o)return{functionLabel:"Secondary Dominant",tag:"glow",tension:.58,desc:`${i} acts as a secondary dominant (III) adding bright chromatic tension and pull.`};if(t==="SUPERTONIC"&&o)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.62,desc:`${i} acts as a secondary dominant (II), driving momentum toward the dominant.`};if(t==="SUBMEDIANT"&&o)return{functionLabel:"Secondary Dominant",tag:"lift",tension:.55,desc:`${i} acts as a secondary dominant (VI), energizing the progression.`};if(t==="TONIC"&&e==="dom7")return{functionLabel:"Secondary Dominant",tag:"reach",tension:.52,desc:`${i} acts as a secondary dominant (I7), pulling strongly toward the subdominant.`};if(t==="SUBDOMINANT"&&s)return{functionLabel:"Borrowed (Minor iv)",tag:"drift",tension:.48,desc:`${i} borrows the poignant minor iv cadence from the parallel minor mode.`};const r=Je[t]??.4;return{functionLabel:"Chromatic Alteration",tag:"color",tension:Math.min(.85,r+.15),desc:`${i} adds chromatic color to the ${n.root} ${te[n.type]||n.type} progression.`}}function Ot(t,e,i,n){const o=(t%12+12)%12,s=(B[i]??0)+o,a=`${M(s,n)}${xi[e]??e}`;return o===10?{functionLabel:"Borrowed (Subtonic ♭VII)",tag:"drift",tension:.45,desc:`${a} is the borrowed Mixolydian ♭VII chord, adding a classic rock/pop lift.`}:o===8?{functionLabel:"Borrowed (Submediant ♭VI)",tag:"glow",tension:.5,desc:`${a} is the borrowed Aeolian ♭VI chord, introducing epic modal depth.`}:o===3?{functionLabel:"Borrowed (Mediant ♭III)",tag:"glow",tension:.52,desc:`${a} is the borrowed ♭III chord, providing chromatic punch and modal color.`}:o===1?{functionLabel:"Neapolitan (♭II)",tag:"edge",tension:.65,desc:`${a} is the Neapolitan ♭II chord, providing dramatic half-step motion.`}:{functionLabel:"Borrowed",tag:"drift",tension:.42,desc:`${a} borrows its color from outside the current key.`}}function No(t,e,i,n,o){const s=i.degrees[e],{root:r}=W(s.chord_name),a=B[r]??0,c=M(a,o),p=`${c}${xi[n]??n}`,h=Ct(c,n,o),l=ne[n]?ne[n].map(u=>M(a+u,h)):G(s.chord_name,o),g=St(e,n),d=So(e,n,p,i);return{name:p,tag:d.tag,roman:g,color:Le(d.tension),functionLabel:d.functionLabel,notes:l,scaleLabel:`${i.root} ${te[i.type]||i.type}`,desc:d.desc,degree:e,scaleKey:t,tension:d.tension}}function ko(t,e,i,n,o,s){const r=`${e}_${i}`,a=t.scales[r];if(!a||!n.length)return null;const c=R(e,i),p=B[e]??0,h={};Object.entries(a.degrees).forEach(([g,d])=>{const{root:u}=W(d.chord_name),m=B[u]??0;m in h||(h[m]=g)});const l=n.slice(0,Re).map(({root:g,quality:d})=>{const u=B[g]??p,m=h[u],v=ln(d);if(m){const I=a.degrees[m],{quality:x}=W(I.chord_name);return v===x||!d&&x?de(r,m,a,c):No(r,m,a,v,c)}const b=(u-p+12)%12,y=Ot(b,v,e,c),N=Et(b,v);return To(e,b,v,y.functionLabel,N,y.tag,c)});return l.length<Ke?null:{genre:o,mood:s,key:e,scaleType:i,bpm:an(o,s),chords:l}}const xi={maj:"",min:"m",dim:"dim",aug:"aug",dom7:"7",min7:"m7",maj7:"maj7",dim7:"dim7",sus4:"sus4"};function To(t,e,i,n,o,s,r){const a=(B[t]??0)+e,c=M(a,r),p=ln(i),h=`${c}${xi[p]??p}`,l=Ct(c,p,r),g=(ne[p]||ne.maj).map(m=>M(a+m,l)),d=o==="?"?Et(e,p):o,u=.42;return{name:h,tag:s,roman:d,color:Le(u),functionLabel:n==="Borrowed"?Ot(e,p,t,r).functionLabel:n,notes:g,scaleLabel:"Borrowed",desc:`${h} borrows its color from outside the current key.`,degree:"BORROWED",scaleKey:"",tension:u}}function hi(t){const e=t.match(/^[A-Ga-g][#b]?/),i=e?e[0]:"C";return i[0].toUpperCase()+i.slice(1)}function Co(t){const e=(t||"C").trim(),i=e[0]?.toUpperCase()||"C";let n=i,o=e.slice(1);if(e.length>1){const s=e[1];s==="b"||s==="B"||s==="♭"||s==="♭"?(n=`${i}b`,o=e.slice(2)):(s==="#"||s==="♯"||s==="♯")&&(n=`${i}#`,o=e.slice(2))}return{root:n,suffix:o}}function Eo(t,e,i){const{root:n,suffix:o}=Co(t),s=n.replace("♭","b").replace("♯","#"),a=(((B[s]??0)+e)%12+12)%12;return`${M(a,i)}${o}`}function Ai(t,e,i){if(!t||!t.chords||t.chords.length===0)return t;const n=/\bmin\b|minor/i.test(e)||/\b[A-G][#b]?m\b/.test(e),o=/\bmaj\b|major/i.test(e),s=n&&!o,r=e.replace(/\s*(maj|min|major|minor)\s*/gi,"").replace(/♭/g,"b").replace(/♯/g,"#").trim(),a=i||(s?"NATURAL_MINOR":o?"MAJOR":t.scaleType||"MAJOR"),c=r,p=(t.key||"C").replace("♭","b").replace("♯","#").trim(),h=B[p]??0,l=B[c]??0,g=((l-h)%12+12)%12,d=R(c,a),u=`${c}_${a}`,m=De[a]||De.MAJOR,v=t.chords.map(b=>{const y=Eo(b.name,g,d),{root:N,quality:I}=W(y),O=(((B[N]??0)-l)%12+12)%12;let F=null;for(const[P,H]of Object.entries(m))if(H===O){F=P;break}let z,A,$=b.tag||"move",V=b.tension,j=b.degree;if(F)j=F,z=St(j,I),A=Ye[j]||j,$=vt[j]||$,V=Je[j]??V;else{j="BORROWED",z=Et(O,I);const P=Ot(O,I,c,d);A=P.functionLabel,$=P.tag||$,V=P.tension||.45}const C=G(y,d);return{...b,name:y,roman:z,functionLabel:A,tag:$,notes:C,degree:j,scaleKey:u,scaleLabel:`${c} ${te[a]||a}`,desc:It(A,te[a]||a,y),tension:V}});return{...t,key:c,scaleType:a,chords:v}}function Oo(t,e,i,n){if(t==="sus4"||t==="sus2"||t==="sus7"||t==="sus9")return t;const o=t.includes("7"),s=t.includes("9"),r=t.includes("6");return e==="min"?s?"min9":o?i==="TONIC"&&(n==="HARMONIC_MINOR"||n==="MELODIC_MINOR")&&(t==="maj7"||t==="mmaj7")?"mmaj7":"min7":r?"min6":"min":e==="maj"?s?i==="DOMINANT"?"dom9":"maj9":o?i==="DOMINANT"?"dom7":"maj7":r?"maj6":"maj":e==="dim"?o?"dim7":"dim":e==="aug"?"aug":e}function Ao(t,e){switch(e){case"maj":return t;case"min":return`${t}m`;case"dim":return`${t}dim`;case"aug":return`${t}aug`;case"dom7":return`${t}7`;case"min7":return`${t}m7`;case"maj7":return`${t}maj7`;case"dim7":return`${t}dim7`;case"sus4":return`${t}sus4`;case"sus2":return`${t}sus2`;case"dom9":return`${t}9`;case"maj9":return`${t}maj9`;case"min9":return`${t}m9`;case"maj6":return`${t}6`;case"min6":return`${t}m6`;case"mmaj7":return`${t}m(maj7)`;case"sus7":return`${t}7sus4`;case"sus9":return`${t}9sus4`;default:return`${t}${e}`}}function Mo(t,e){if(!t||!t.chords||t.chords.length===0)return t;const i=(t.scaleType||"MAJOR").toUpperCase().replace(/\s+/g,"_"),n=(e||i).toUpperCase().replace(/\s+/g,"_"),o=(t.key||"C").replace(/♭/g,"b").replace(/♯/g,"#").trim(),s=B[o]??0,r=R(o,n),a=`${o}_${n}`,c=dt[i]||dt.MAJOR,p=De[i]||De.MAJOR,h=dt[n]||dt.MAJOR,l=De[n]||De.MAJOR,g=Ei[n]||Ei.MAJOR,d=t.chords.map(u=>{const{root:m,quality:v}=W(u.name),y=(((B[m]??0)-s)%12+12)%12;let N=-1;if(u.degree&&u.degree!=="BORROWED"&&(N=c.indexOf(u.degree)),N===-1)for(let I=0;I<c.length;I++){const x=c[I];if(p[x]===y){N=I;break}}if(N>=0&&N<h.length){const I=h[N],x=l[I],O=(s+x)%12,F=M(O,r),z=g[I]||"maj",A=Oo(v,z,I,n),$=Ao(F,A),V=G($,r),j=xt[n]?.[I];let C;if(j)if(A==="maj"||A==="min")C=j;else{const _e=j.replace(/[°+]/g,"");C=vi(_e,A)}else C=St(I,A);const P=Ye[I]||I,H=vt[I]||u.tag||"move",Y=Je[I]??u.tension;return{...u,name:$,roman:C,functionLabel:P,tag:H,notes:V,degree:I,scaleKey:a,scaleLabel:`${o} ${te[n]||n}`,desc:It(P,te[n]||n,$),tension:Y}}else{let I=null;for(const[x,O]of Object.entries(l))if(O===y){I=x;break}if(I){const x=St(I,v),O=Ye[I]||I,F=vt[I]||u.tag||"move",z=Je[I]??u.tension,A=G(u.name,r);return{...u,roman:x,functionLabel:O,tag:F,notes:A,degree:I,scaleKey:a,scaleLabel:`${o} ${te[n]||n}`,desc:It(O,te[n]||n,u.name),tension:z}}else{const x=Et(y,v),O=Ot(y,v,o,r),F=G(u.name,r);return{...u,roman:x,functionLabel:O.functionLabel,tag:O.tag||u.tag,tension:O.tension||.45,notes:F,degree:"BORROWED",scaleKey:a,scaleLabel:"Borrowed",desc:`${u.name} borrows its color from outside the current key.`}}}});return{...t,scaleType:n,chords:d}}const Mi={Major:[0,4,7],Minor:[0,3,7],"Suspended (sus)":[0,5,7],Diminished:[0,3,6]};function cn(t,e,i,n){const o=B[t]??0;let s=Mi[e]||Mi.Major;return i==="6th"?s=[...s,9]:i==="7th (dom / m7)"?s=[...s,10]:i==="Major 7th (M7)"?s=[...s,11]:i==="9th"&&(s=[...s,10,14]),s.map(r=>M(o+r,n))}const $o={Major:"",Minor:"m","Suspended (sus)":"sus",Diminished:"dim"},Do={None:"","6th":"6","7th (dom / m7)":"7","Major 7th (M7)":"maj7","9th":"9"};function dn(t,e,i){return e==="Minor"&&i==="Major 7th (M7)"?`${t}m(maj7)`:`${t}${$o[e]??""}${Do[i]??""}`}const Bo={MAJOR:0,LYDIAN:5,MIXOLYDIAN:7,DORIAN:2,NATURAL_MINOR:9,HARMONIC_MINOR:9,PHRYGIAN:4,LOCRIAN:11,MELODIC_MINOR:9},pn={};He.forEach(t=>{pn[B[t]]=t});function Fo(t,e){const i=(e||"MAJOR").toUpperCase().replace(/\s+/g,"_"),n=Bo[i]??0,s=(((B[t]??0)-n)%12+12)%12;return pn[s]??"C"}function R(t,e){const i=Fo(t,e);return Qn.has(i)||i.includes("b")}function ti(t,e,i){const n=hi(t.name),o=n.includes("b"),s=dn(n,e,i),r=cn(n,e,i,o);let a=t.roman||"";if(a){const h=a.match(/^([♭♯b#]*)([ivxIVX]+)/);if(h){const l=h[1],g=h[2],d=e==="Minor"||e==="Diminished",u=d?g.toLowerCase():g.toUpperCase();let m="";e==="Diminished"?m=i==="7th (dom / m7)"?"°7":"°":e==="Suspended (sus)"?m="sus4":i==="6th"?m="6":i==="7th (dom / m7)"?m="7":i==="Major 7th (M7)"?m=d?"m(maj7)":"maj7":i==="9th"&&(m=d?"m9":"maj9"),a=`${l}${u}${m}`}}const c=t.initialChord?.tension??t.tension??.1,p=t.initialChord?.color??t.color??Le(c);return{...t,name:s,notes:r,roman:a,tension:c,color:p}}function _(t,e,i,n,o,s,r,a){const c=dn(t,e,i),p=cn(t,e,i,a);return{name:c,tag:n||"sub",roman:n,color:Le(r),functionLabel:o,notes:p,scaleLabel:"Substitution",desc:s,degree:"SUBSTITUTION",scaleKey:"",tension:r}}function $i(t,e,i){const n=B[e.key]??0,o=e.scaleType.includes("MINOR"),s=R(e.key,e.scaleType),r=o?[(()=>{const h=M(n+1,!0),l=_(h,"Major","Major 7th (M7)","♭II","Neapolitan","a dark, dramatic slide in from a half-step above",.6,!0);return{name:l.name,roman:"♭II",notes:l.notes,sub:"Neapolitan chord — a dramatic slide in from a half-step above",chord:l,tension:.6}})(),(()=>{const h=M(n+5,!0),l=_(h,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.45,!0);return{name:l.name,roman:"iv",notes:l.notes,sub:"the minor subdominant — deeper minor mood",chord:l,tension:.45}})(),(()=>{const h=M(n+10,!0),l=_(h,"Minor","7th (dom / m7)","v","Minor dominant","unresolved minor drift",.52,!0);return{name:l.name,roman:"v",notes:l.notes,sub:"a step further into shadow — unresolving drift",chord:l,tension:.52}})()]:[(()=>{const h=M(n+8,!0),l=_(h,"Major","Major 7th (M7)","♭VI","Flat submediant",`borrowed from ${e.key} minor — the cinematic shadow`,.5,!0);return{name:l.name,roman:"♭VI",notes:l.notes,sub:`borrowed from ${e.key} minor — the cinematic shadow`,chord:l,tension:.5}})(),(()=>{const h=M(n+5,!0),l=_(h,"Minor","7th (dom / m7)","iv","Minor subdominant","the minor subdominant — softer, sadder",.42,!0);return{name:l.name,roman:"iv",notes:l.notes,sub:"the minor subdominant — softer, sadder",chord:l,tension:.42}})(),(()=>{const h=M(n+3,!0),l=_(h,"Major","Major 7th (M7)","♭III","Flat mediant","a step further out — cooler, more remote",.58,!0);return{name:l.name,roman:"♭III",notes:l.notes,sub:"a step further out — cooler, more remote",chord:l,tension:.58}})()],a=[(()=>{const h=M(n+7,s),l=M(n+2,s),g=_(l,"Major","7th (dom / m7)","V7/V","Secondary dominant",`aimed at ${h}7 — sharpens the approach`,.82,s);return{name:g.name,roman:"V7/V",notes:g.notes,sub:`aimed at ${h}7 — sharpens the approach`,chord:g,tension:.82}})(),(()=>{const h=M(n+(o?3:9),s),l=M(n+4,s),g=_(l,"Major","7th (dom / m7)","V7/vi","Secondary dominant",`aimed at ${h}m7 — makes it feel arrived at`,.88,s);return{name:g.name,roman:"V7/vi",notes:g.notes,sub:`aimed at ${h}m7 — makes it feel arrived at`,chord:g,tension:.88}})(),(()=>{const h=M(n+1,!0),l=_(h,"Major","7th (dom / m7)","subV7","Tritone substitute","a tritone substitute — slides in sideways",.95,!0);return{name:l.name,roman:"subV7",notes:l.notes,sub:"a tritone substitute — slides in sideways",chord:l,tension:.95}})()],c=[(()=>{const h=M(n+5,s),l=_(h,"Major","Major 7th (M7)",o?"IV":"IVmaj7","Subdominant","floats rather than resolving",.3,s);return{name:l.name,roman:"IV",notes:l.notes,sub:"floats rather than resolving",chord:l,tension:.3}})(),(()=>{const h=M(n,s),l=_(h,o?"Minor":"Major","9th",o?"im9":"Imaj9","Tonic extension","the same home with more air in it",.18,s);return{name:l.name,roman:o?"im9":"Imaj9",notes:l.notes,sub:"the same home with more air in it",chord:l,tension:.18}})(),(()=>{const h=M(n+(o?3:4),s),l=_(h,o?"Major":"Minor","7th (dom / m7)",o?"♭III":"iii","Mediant","wistful, halfway between home and away",.35,s);return{name:l.name,roman:o?"♭III":"iii",notes:l.notes,sub:"wistful, halfway between home and away",chord:l,tension:.35}})()],p=[(()=>{const h=M(n,s),l=_(h,o?"Minor":"Major",o?"None":"Major 7th (M7)",o?"i":"I","Tonic","full resolution — the sense of arriving",.05,s);return{name:l.name,roman:o?"i":"I",notes:l.notes,sub:"full resolution — the sense of arriving",chord:l,tension:.05}})(),(()=>{const h=M(n+7,s),l=_(h,"Major","7th (dom / m7)","V7","Dominant","the pull that makes home feel earned",1,s);return{name:l.name,roman:"V7",notes:l.notes,sub:"the pull that makes home feel earned",chord:l,tension:1}})(),(()=>{const h=M(n+(o?8:9),s),l=_(h,o?"Major":"Minor","7th (dom / m7)",o?"♭VI":"vi","Submediant","a soft landing instead of a full stop",.28,s);return{name:l.name,roman:o?"♭VI":"vi",notes:l.notes,sub:"a soft landing instead of a full stop",chord:l,tension:.28}})()];return[{name:"Darker",sub:"heavier, more shadow",tension:.55,rows:r},{name:"More tension",sub:"sharper pull forward",tension:.85,rows:a},{name:"Dreamier",sub:"softer, more air",tension:.3,rows:c},{name:"Resolve home",sub:"settles back to center",tension:.05,rows:p}]}function ui(t,e,i){const n=B[e.key]??0,o=e.scaleType.includes("MINOR"),s=R(e.key,e.scaleType),r=e.chords;if(o){const m=r[0]?.name||"chord 1",v=r[1]?.name||"chord 2",b=r[2]?.name||"chord 3",y=r[3]?.name||"chord 4",N=_(M(n,s),"Major","None","I","Major tonic","same root, turned bright",.2,s),I=_(M(n+5,s),"Major","None","IV","Major subdominant","the Dorian lift, sunny and open",.35,s),x=_(M(n+9,s),"Minor","None","vi","Submediant","melodic lift upward",.4,s),O=_(M(n+11,s),"Diminished","None","vii°","Leading tone","classical harmonic pull",.55,s);return[{name:N.name,sub:`in place of ${m} · same root, turned bright`,roman:"I",notes:N.notes,chord:N,tension:.2},{name:I.name,sub:`in place of ${v} · the Dorian lift, sunny and open`,roman:"IV",notes:I.notes,chord:I,tension:.35},{name:x.name,sub:`in place of ${b} · melodic lift upward`,roman:"vi",notes:x.notes,chord:x,tension:.4},{name:O.name,sub:`in place of ${y} · classical harmonic pull`,roman:"vii°",notes:O.notes,chord:O,tension:.55}]}const a=r[0]?.name||"chord 1",c=r[1]?.name||"chord 2",p=r[2]?.name||"chord 3",h=r[3]?.name||"chord 4",l=_(M(n,s),"Minor","None","i","Tonic minor","same root, turned sad",.3,s),g=_(M(n+5,!0),"Minor","None","iv","Minor subdominant","the lift, but heavier",.4,!0),d=_(M(n+8,!0),"Major","None","♭VI","Flat submediant","big and cinematic",.45,!0),u=_(M(n+10,!0),"Major","None","♭VII","Flat subtonic","lands sideways, not home",.5,!0);return[{name:l.name,sub:`in place of ${a} · same root, turned sad`,roman:"i",notes:l.notes,chord:l,tension:.3},{name:g.name,sub:`in place of ${c} · the lift, but heavier`,roman:"iv",notes:g.notes,chord:g,tension:.4},{name:d.name,sub:`in place of ${p} · big and cinematic`,roman:"♭VI",notes:d.notes,chord:d,tension:.45},{name:u.name,sub:`in place of ${h} · lands sideways, not home`,roman:"♭VII",notes:u.notes,chord:u,tension:.5}]}const Po={m8:"https://warmsynths.github.io/m8hyper/",circuit:"https://warmsynths.github.io/circuit-chords/"},Uo={m8:43303,circuit:43302};function Ro(t,e,i){let n=Po[e];typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1")&&(n=`http://localhost:${Uo[e]}/`);const o=i&&i.length>0?i.map(r=>t.chords[r]).filter(r=>!!r):t.chords,s=o.map(r=>encodeURIComponent(r.name)).join("+");if(e==="circuit"){const r=h=>{const l=(h||"").toLowerCase();return l.includes("octave")||l.includes("high")||l.includes("up")?"octave":l.includes("inversion")||l.includes("1st")?"1st":"root"},a=o.map(h=>r(h.voicing)).join("+"),c=encodeURIComponent(t.key||"C"),p=encodeURIComponent((t.scaleType||"major").toLowerCase());return`${n}?p=${s}&v=${a}&key=${c}&scale=${p}`}return`${n}?p=${s}`}const Lo={0:{symbol:"1",name:"Root",isGuideTone:!1},1:{symbol:"♭9",name:"Minor 9th",isGuideTone:!1},2:{symbol:"9",name:"Major 2nd / 9th",isGuideTone:!1},3:{symbol:"♭3",name:"Minor 3rd",isGuideTone:!0},4:{symbol:"3",name:"Major 3rd",isGuideTone:!0},5:{symbol:"4",name:"Perfect 4th",isGuideTone:!1},6:{symbol:"♭5",name:"Diminished 5th",isGuideTone:!1},7:{symbol:"5",name:"Perfect 5th",isGuideTone:!1},8:{symbol:"♯5 / ♭6",name:"Augmented 5th",isGuideTone:!1},9:{symbol:"6",name:"Major 6th",isGuideTone:!1},10:{symbol:"♭7",name:"Minor 7th",isGuideTone:!0},11:{symbol:"7",name:"Major 7th",isGuideTone:!0},14:{symbol:"9",name:"Major 9th",isGuideTone:!1}};function zo(t,e){const{root:i,quality:n}=W(t),o=B[i]??0,s=ne[n]||ne.maj,r=Ct(i,n,e);return s.map(a=>{const c=M(o+a,r),p=Lo[a]||{symbol:`+${a}`,name:`Interval ${a}`,isGuideTone:!1};return{note:c,intervalSymbol:p.symbol,roleName:p.name,isGuideTone:p.isGuideTone}})}function jo(t){if(!t||t.length<2)return[];const e=[],i=n=>n.replace(/[^A-Za-z♭♯]/g,"");for(let n=0;n<t.length;n++){const o=n,s=(n+1)%t.length,r=t[o],a=t[s],c=i(r.roman),p=i(a.roman),h=o+1,l=s+1,g=`Bar ${h} → ${l}`,d=`${r.name} → ${a.name}`,u=`${r.roman}–${a.roman}`;(c==="V"||c==="v")&&(p==="I"||p==="i")?e.push({name:"Perfect cadence",type:"Authentic Cadence",shortName:`${r.name} → ${a.name} (${r.roman}–${a.roman})`,description:"The dominant resolves home — the strongest full stop.",why:"The dominant resolves home — the strongest full stop.",move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name}):(c==="IV"||c==="iv")&&(p==="I"||p==="i")?e.push({name:"Plagal cadence",type:"Plagal Cadence",shortName:`${r.name} → ${a.name} (${r.roman}–${a.roman})`,description:"A softer landing home, no dominant pull.",why:"A softer landing home, no dominant pull.",move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name}):(c==="V"||c==="v")&&(p==="vi"||p==="♭VI"||p==="VI")?e.push({name:"Interrupted cadence",type:"Deceptive Cadence",shortName:`${r.name} → ${a.name} (${r.roman}–${a.roman})`,description:"Sidesteps home at the last moment.",why:"Sidesteps home at the last moment.",move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name}):c==="♭VII"&&(p==="I"||p==="i")?e.push({name:"Backdoor cadence",type:"Backdoor Cadence",shortName:`${r.name} → ${a.name} (♭VII–${a.roman})`,description:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",why:"Borrowed subtonic resolving up a whole step into the tonic with smooth jazz/pop flavor.",move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name}):(p==="V"||p==="v")&&c!=="V"&&c!=="v"?e.push({name:"Half cadence",type:"Half Cadence",shortName:`${r.name} → ${a.name} (${r.roman}–${a.roman})`,description:"Pauses on the dominant, left hanging.",why:"Pauses on the dominant, left hanging.",move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name}):r.functionLabel==="Secondary Dominant"&&e.push({name:"Secondary Dominant pull",type:"Secondary Dominant Pull",shortName:`${r.name} → ${a.name}`,description:`${r.name} acts as a temporary dominant, pulling strongly into ${a.name}.`,why:`${r.name} acts as a temporary dominant, pulling strongly into ${a.name}.`,move:d,degrees:u,bars:g,fromBar:h,toBar:l,fromChord:r.name,toChord:a.name})}return e}function _o(t){if(!t||t.length<2)return[];const e=[];for(let i=0;i<t.length;i++){const n=i,o=(i+1)%t.length,s=t[n],r=t[o],a=new Set(s.notes.map(v=>B[v]??0)),c=r.notes.filter(v=>a.has(B[v]??-1)),p=B[hi(s.name)]??0,h=B[hi(r.name)]??0,l=Math.min((h-p+12)%12,(p-h+12)%12);let g="Harmonic Shift";c.length>=2?g=`Strong Common Tones (${c.length} shared)`:l<=2?g="Stepwise Bass Motion":(l===5||l===7)&&(g="4th / 5th Cycle Jump");const d=`Bar ${n+1} → ${o+1}`,u=`${s.name} → ${r.name}`,m=c.length?`${c.join(" · ")} held over`:l<=2?"Bass steps by a tone":"No shared notes";e.push({fromBar:n+1,toBar:o+1,fromChord:s.name,toChord:r.name,move:d,chords:u,link:m,hasShared:c.length>0,commonNotes:c,semitoneDistance:l,motionType:g})}return e}function mi(t,e=4){const i=Array.isArray(t)?t.filter(l=>typeof l=="string"&&l.trim().length>0):[];if(i.length===0)return[];const n={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},o=i.map(l=>l.replace(/\d+$/,"")),s=o[0],r=n[s]??0;let a=e,c=r;const p=[];return o.forEach((l,g)=>{const d=n[l]??0;g>0&&d<=c&&a++,p.push(`${l}${a}`),c=d}),[`${s}${e-1}`,...p]}class Go{constructor(){this.mode="single",this.progression=null,this.order=[],this.sections=[],this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.playing=!1,this.instrument=null,this.playStyle=null,this.autoplayTimer=null,this.tickCallbacks=new Set,this.abOverride=null,this.subBassEnabled=!1,this.barsPerChord=1,this.feelSettings={swing:0,spread:50,density:50,tone:"Warm"}}setSubBassEnabled(e){this.subBassEnabled=e}isSubBassEnabled(){return this.subBassEnabled}setProgression(e,i){this.mode="single",this.progression=e,e?(this.order=i||Array.from({length:e.chords.length},(n,o)=>o),this.order.length>0&&(this.activeIndex>=this.order.length&&(this.activeIndex=this.activeIndex%this.order.length),this.progressStep>=this.order.length&&(this.progressStep=this.progressStep%this.order.length))):this.order=[]}setSong(e){this.mode="song",this.sections=e,this.songStep=0,this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}isSongMode(){return this.mode==="song"}getActiveSectionIndex(){return this.activeSectionIndex}getTotalSteps(){return this.mode==="song"?this.sections.reduce((e,i)=>e+i.order.length,0):this.order.length}setOrder(e,i){this.order=e,typeof i=="number"&&(this.activeIndex=i)}setInstrument(e){this.instrument=e}setPlayStyle(e){this.playStyle=e}setBpm(e){const i=Math.max(40,Math.min(240,e));this.progression&&(this.progression.bpm=i),this.playing&&this.startAutoplay()}setBarsPerChord(e){this.barsPerChord=Math.max(1,e),this.playing&&this.startAutoplay()}getBarsPerChord(){return this.barsPerChord}setFeelSettings(e){this.feelSettings={...this.feelSettings,...e}}getFeelSettings(){return{...this.feelSettings}}getStepIntervalMs(){const e=this.mode==="song"?this.sections[this.activeSectionIndex]?.progression.bpm||this.progression?.bpm||84:this.progression?.bpm||84,i=Math.max(40,Math.min(240,e)),n=Math.max(1,this.barsPerChord);return Math.round(n*(24e4/i))}isPlaying(){return this.playing}getActiveIndex(){return this.activeIndex}getProgressStep(){return this.mode==="song"?this.songStep:this.progressStep}subscribeTick(e){return this.tickCallbacks.add(e),()=>this.tickCallbacks.delete(e)}notifyTick(){const e=this.getTotalSteps();this.mode==="song"?this.tickCallbacks.forEach(i=>i(this.activeIndex,this.songStep,this.activeSectionIndex,e,!0)):this.tickCallbacks.forEach(i=>i(this.activeIndex,this.progressStep,0,e,!1))}updateSongStepState(e){let i=0;for(let n=0;n<this.sections.length;n++){const o=this.sections[n].order.length;if(e<i+o){this.activeSectionIndex=n;const s=e-i;this.activeIndex=this.sections[n].order[s]??0,this.progressStep=s;return}i+=o}this.activeSectionIndex=0,this.activeIndex=0,this.progressStep=0}startAutoplay(){this.stopAutoplay();const e=this.getStepIntervalMs();this.autoplayTimer=setInterval(()=>{if(this.playing){if(this.mode==="song"){const i=this.getTotalSteps();if(i<=0)return;this.songStep=(this.songStep+1)%i,this.updateSongStepState(this.songStep)}else{if(!this.progression||this.order.length<=0)return;this.activeIndex=(this.activeIndex+1)%this.order.length,this.progressStep=(this.progressStep+1)%this.order.length}this.playActiveChord(),this.notifyTick()}},e)}stopAutoplay(){this.autoplayTimer&&(clearInterval(this.autoplayTimer),this.autoplayTimer=null)}togglePlay(){return this.playing?(this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.stopAutoplay(),this.notifyTick()):(this.playing=!0,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.mode==="song"&&this.sections.length>0&&this.updateSongStepState(0),this.startAutoplay(),this.playActiveChord(),this.notifyTick()),this.playing}setABOverride(e,i,n="before"){e==null?this.abOverride=null:typeof e=="object"?this.abOverride=e:this.abOverride={index:e,chord:i||null,side:n}}clearABOverride(){this.abOverride=null}playActiveChord(){if(this.mode==="song"){const e=this.sections[this.activeSectionIndex];if(!e)return;const i=this.activeIndex,n=e.progression.chords[i];if(n){const o=n.notes&&n.notes.length>0?n.notes:G(n.name,R(e.progression.key,e.progression.scaleType)),s=mi(o,4),r=i!==void 0&&this.feelSettings?.barFeel&&this.feelSettings.barFeel[i]?{...this.feelSettings,...this.feelSettings.barFeel[i]}:this.feelSettings;Ci(s,e.progression.genre,{bpm:e.progression.bpm,duration:this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:r?.playStyle??this.playStyle??void 0,feelSettings:r})}}else{if(!this.progression)return;const e=this.order[this.activeIndex]??0;let i=this.progression.chords[e];if(this.abOverride&&this.abOverride.index===e&&this.abOverride.side==="after"&&this.abOverride.chord&&(i=this.abOverride.chord),i){let n=Array.isArray(i.notes)?i.notes:[];if(n.length===0||!n.every(o=>typeof o=="string"&&o.trim().length>0)){const o=i.name||"CMAJ",s=this.progression.key||"C",r=this.progression.scaleType||"MAJOR";n=G(o,R(s,r))}i.voicing?this.playChordNotes(n,1.2,i.voicing):this.playChordNotes(n,1.2),this.subBassEnabled&&n.length>0&&Jn(n[0],1.4)}}}auditionChord(e,i=.8){if(!e)return;let n=Array.isArray(e.notes)?e.notes:[];if(n.length===0||!n.every(o=>typeof o=="string"&&o.trim().length>0)){const o=e.name||"CMAJ",s=this.progression?.key||"C",r=this.progression?.scaleType||"MAJOR";n=G(o,R(s,r))}e.voicing?this.playChordNotes(n,i,e.voicing):this.playChordNotes(n,i)}playChordAtIndex(e,i=.8,n,o){if(!this.progression||!this.progression.chords[e])return;const s=this.progression.chords[e];let r=Array.isArray(s.notes)?s.notes:[];if(r.length===0||!r.every(c=>typeof c=="string"&&c.trim().length>0)){const c=s.name||"CMAJ",p=this.progression.key||"C",h=this.progression.scaleType||"MAJOR";r=G(c,R(p,h))}const a=n||s.voicing;a!==void 0?this.playChordNotes(r,i,a,o):this.playChordNotes(r,i)}playChordNotes(e,i,n,o,s){if(!this.progression)return;const r=Array.isArray(e)?e.filter(h=>typeof h=="string"&&h.trim().length>0):[];if(r.length===0)return;const a=n?Wn(r,n):mi(r,4),c=s!==void 0?s:this.playing?this.order[this.activeIndex]??0:void 0,p=c!==void 0&&this.feelSettings?.barFeel&&this.feelSettings.barFeel[c]?{...this.feelSettings,...this.feelSettings.barFeel[c]}:this.feelSettings;Ci(a,this.progression.genre||"Unknown",{bpm:this.progression.bpm||120,duration:i||this.getStepIntervalMs()/1e3*.85,instrument:this.instrument??void 0,playStyle:p?.playStyle??this.playStyle??void 0,velocity:o,feelSettings:p})}jumpToStep(e){!this.progression||this.order.length<=0||(this.activeIndex=e%this.order.length,this.progressStep=e%this.order.length,this.playActiveChord(),this.notifyTick())}playFromBar(e){!this.progression||this.order.length<=0||(this.activeIndex=e%this.order.length,this.progressStep=e%this.order.length,this.playing=!0,this.startAutoplay(),this.playActiveChord(),this.notifyTick())}reset(){this.stopAutoplay(),this.playing=!1,this.activeIndex=0,this.progressStep=0,this.songStep=0,this.activeSectionIndex=0,this.notifyTick()}}const S=new Go,Vo=wt.map(t=>t.name),qo=["rhodes","epiano","guitar","pad-strings","bell","organ","juno-pad","stab"];function Ho(t,e){const i=t.length+1,n=e.length+1,o=Array.from({length:i},()=>new Array(n).fill(0));for(let s=0;s<i;s++)o[s][0]=s;for(let s=0;s<n;s++)o[0][s]=s;for(let s=1;s<i;s++)for(let r=1;r<n;r++)o[s][r]=t[s-1]===e[r-1]?o[s-1][r-1]:1+Math.min(o[s-1][r-1],o[s-1][r],o[s][r-1]);return o[i-1][n-1]}function ke(t,e){if(typeof t!="string")return null;const i=t.trim();if(!i)return null;const n=i.toLowerCase(),o=e.find(c=>c.toLowerCase()===n);if(o)return o;let s=null,r=1/0;for(const c of e){const p=Ho(n,c.toLowerCase());p<r&&(r=p,s=c)}const a=Math.max(2,Math.floor(n.length*.4));return r<=a?s:null}function Yo(t){if(!Array.isArray(t))return;const e=[];for(const i of t){if(!i||typeof i!="object")continue;const n=i,o=ke(n.root,He),s=ke(n.quality,Zn);o&&s&&e.push({root:o,quality:s})}if(e.length)return e.slice(0,Re)}function Jo(t){if(!t||typeof t!="object"||Array.isArray(t))return;const e=t,i=ke(e.presetId,qo)??(typeof e.presetId=="string"&&e.presetId.trim()?e.presetId.trim():void 0);if(!i)return;const n=e.customConfig&&typeof e.customConfig=="object"&&!Array.isArray(e.customConfig)?e.customConfig:void 0;return{presetId:i,customConfig:n}}function ii(t,e){const i=t&&typeof t=="object"?t:{},n=ke(i.genre,sn)??e.genre,o=ke(i.mood,Vo)??e.mood,s=ke(i.key,He)??void 0,r=ke(i.scaleType,eo)??void 0,a=s&&r?Yo(i.chords):void 0;let c;typeof i.length=="number"&&Number.isFinite(i.length)&&(c=Math.max(Ke,Math.min(Re,Math.round(i.length))));const p=typeof i.rhythmStyle=="string"&&i.rhythmStyle.trim()?i.rhythmStyle.trim():void 0,h=Jo(i.instrumentConfig),l=i._rateLimit&&typeof i._rateLimit=="object"?i._rateLimit:void 0;return{genre:n,mood:o,key:s,scaleType:r,length:c,chords:a,rhythmStyle:p,instrumentConfig:h,_rateLimit:l}}const Wo=[{id:"gemini-3.1-flash-lite",name:"Gemini 3.1 Flash-Lite",provider:"google",vendor:"Google"},{id:"gemini-3.6-flash",name:"Gemini 3.6 Flash",provider:"google",vendor:"Google"},{id:"gemini-3.5-flash",name:"Gemini 3.5 Flash",provider:"google",vendor:"Google"}],Ko="chroma-chords-llm-provider",Xo="chroma-chords-llm-model";function Qo(){const t=localStorage.getItem(Ko);return t==="opencodeai"||t==="anthropic"||t==="openrouter"||t==="google"?t:"google"}function Zo(){const t=localStorage.getItem(Xo);return t?t==="gemini-1.5-flash"||t==="gemini-2.0-flash"||t==="gemini-2.5-flash"||t==="gemini-3.5-flash"||t==="gemini-1.5-pro"?"gemini-3.1-flash-lite":t:Wo[0].id}const ni={genre:sn[0],mood:wt[0].name},es="https://chroma-chords-classifier.warmsynthsiloveyou.workers.dev",ts=12e3,hn={Uplifting:["happy","joy","bright","hope","celebrat","win","sun","morning","triumph"],Melancholy:["sad","rain","lonely","grief","loss","blue","tear","goodbye"],Dreamy:["dream","float","cloud","soft","sleep","hazy","ethereal","stars"],Tense:["fear","anxious","dark","storm","fight","chase","danger","thriller"],Warm:["cozy","home","fire","love","autumn","familiar","fireplace"],Nostalgic:["memory","childhood","old","faded","remember","summer","photo","yearbook"],Energetic:["energetic","pumped","hype","fast","running","workout","power","fire"],Dark:["dark","creepy","night","evil","shadow","gothic","gloomy"],Peaceful:["peaceful","calm","quiet","zen","relax","nature","gentle","still"],Groovy:["groovy","funky","danceable","rhythm","swing","bounce","jam"],Epic:["epic","heroic","grand","triumphant","majestic","legendary","glory"]},un={Pop:["pop","radio","dance","catchy","hit"],"Lo-fi/Chill":["lofi","lo-fi","study","bedroom","tape","chill","relax"],"R&B/Soul":["rnb","r&b","soul","smooth","slow jam","sultry"],"Indie/Folk":["folk","acoustic","campfire","porch","story","indie"],Synthwave:["synth","80s","neon","retro","synthwave","arcade"],"Jazz-ish":["jazz","smoky","bar","lounge","late night","saxophone"],Gospel:["gospel","church","choir","soulful","worship"],Cinematic:["movie","film","epic","trailer","scene","cinematic"],Rock:["rock","guitar","drive","loud","energy","highway"],"House/Dance":["house","edm","club","rave","four on the floor","dance floor"],Blues:["blues","12 bar","delta","chicago blues","harmonica"],"Funk/Disco":["funk","funky","groovy","disco","slap bass","boogie"],"Country/Bluegrass":["country","bluegrass","nashville","banjo","twang"],"Reggae/Dub":["reggae","dub","jamaica","ska","offbeat","roots"],Metal:["metal","heavy metal","thrash","riff","shred","headbang","metallica","megadeth","slayer","iron maiden"],Punk:["punk","garage","mosh","rebel","skate"],"Ambient/Drone":["ambient","drone","atmospheric","soundscape","meditation","space"],"Trap/Hip-Hop":["trap","hiphop","hip-hop","rap","808","beat"],"Bossa Nova/Latin":["bossa","bossa nova","samba","latin","rio","habanera"],"Classical/Orchestral":["classical","orchestra","symphony","concerto","violin","chamber"],"EDM/Trance":["trance","techno","buildup","drop","festival"],Afrobeats:["afrobeats","afropop","lagos","highlife","afro"],Shoegaze:["shoegaze","fuzz","wall of sound","dream pop","gazer"]};function Nt(t,e){const i=t.toLowerCase();let n=null,o=0;return Object.keys(e).forEach(s=>{const r=e[s].reduce((a,c)=>a+(i.includes(c)?1:0),0);r>o&&(o=r,n=s)}),n}function is(t){const e=Nt(t,un),i=Nt(t,hn);return!e||!i?null:{genre:e,mood:i}}async function ns(t){const e=new AbortController,i=setTimeout(()=>e.abort(),ts);try{const o=await fetch(es,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:t,provider:Qo(),model:Zo()}),signal:e.signal}),s=await o.json().catch(()=>null);if(!o.ok||s&&typeof s=="object"&&"error"in s){const r=s&&typeof s=="object"&&"error"in s?String(s.error):`HTTP ${o.status}`,a=new Error(`Classifier request failed: ${r}`);throw s&&typeof s=="object"&&"_rateLimit"in s&&(a._rateLimit=s._rateLimit),a}return s}finally{clearTimeout(i)}}async function os(t){const e=t.trim(),i=e.toLowerCase();if(i.startsWith("mock")||i.startsWith("test")){const o=e.replace(/^(mock|test)\s*:?\s*/i,"").trim(),s=Nt(o,un)??"Synthwave",r=Nt(o,hn)??"Dreamy",a={Metal:"stab",Rock:"guitar",Punk:"stab","Lo-fi/Chill":"epiano",Synthwave:"juno-pad","EDM/Trance":"juno-pad",Gospel:"organ","Reggae/Dub":"organ","Country/Bluegrass":"guitar","Bossa Nova/Latin":"guitar","Ambient/Drone":"pad-strings",Cinematic:"pad-strings","Classical/Orchestral":"pad-strings","Jazz-ish":"rhodes",Pop:"rhodes","R&B/Soul":"epiano"},c={Metal:"heavy_strum",Rock:"driving_strum",Punk:"fast_power_strum","Lo-fi/Chill":"slow_arpeggio",Synthwave:"retro_16th_arp","EDM/Trance":"fast_triplets",Gospel:"block_chords","Reggae/Dub":"offbeat_ska","Jazz-ish":"swing_feel","Bossa Nova/Latin":"syncopated_bossa","Ambient/Drone":"sustained_pad","Classical/Orchestral":"slow_arpeggio",Pop:"straight_8ths"},p={Metal:{key:"E",scaleType:"NATURAL_MINOR",chords:[{root:"E",quality:"min"},{root:"G",quality:"maj"},{root:"D",quality:"maj"},{root:"C",quality:"maj"},{root:"E",quality:"min"},{root:"A",quality:"min"},{root:"B",quality:"dom7"},{root:"E",quality:"min"}]},Rock:{key:"A",scaleType:"MAJOR",chords:[{root:"A",quality:"maj"},{root:"D",quality:"maj"},{root:"E",quality:"dom7"},{root:"F#",quality:"min"},{root:"D",quality:"maj"},{root:"A",quality:"maj"},{root:"E",quality:"dom7"},{root:"A",quality:"maj"}]},"Jazz-ish":{key:"F",scaleType:"DORIAN",chords:[{root:"F",quality:"min7"},{root:"A#",quality:"dom7"},{root:"D#",quality:"maj7"},{root:"G#",quality:"maj7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"min7"},{root:"F",quality:"dom7"}]},"Lo-fi/Chill":{key:"C",scaleType:"DORIAN",chords:[{root:"C",quality:"min7"},{root:"F",quality:"maj7"},{root:"A#",quality:"maj7"},{root:"D#",quality:"maj7"},{root:"C",quality:"min7"},{root:"D#",quality:"maj7"},{root:"F",quality:"min7"},{root:"G",quality:"min7"}]},Gospel:{key:"C",scaleType:"MAJOR",chords:[{root:"C",quality:"maj"},{root:"E",quality:"min7"},{root:"F",quality:"maj7"},{root:"G",quality:"dom7"},{root:"A",quality:"min7"},{root:"D",quality:"min7"},{root:"G",quality:"dom7"},{root:"C",quality:"maj"}]},_default:{key:"F#",scaleType:"DORIAN",chords:[{root:"F#",quality:"min7"},{root:"B",quality:"maj"},{root:"C#",quality:"min7"},{root:"E",quality:"maj"},{root:"F#",quality:"min7"},{root:"A",quality:"maj7"},{root:"B",quality:"min7"},{root:"C#",quality:"dom7"}]}},h=p[s]||p._default,l=a[s]||"rhodes",g=c[s]||"slow_arpeggio",d={genre:s,mood:r,key:h.key,scaleType:h.scaleType,length:8,chords:h.chords,rhythmStyle:g,instrumentConfig:{presetId:l,customConfig:{envelope:{attack:.05,decay:.5,sustain:.6,release:1.2}}}};return ii(d,{genre:s,mood:r})}const n=is(t);try{const o=await ns(t);return ii(o,n??ni)}catch(o){console.warn("LLM classification failed, falling back to keyword heuristic:",o);const s=ii(n??ni,ni);return o&&typeof o=="object"&&"_rateLimit"in o&&(s._rateLimit=o._rateLimit),s}}class ss{static async resolvePrompt(e,i,n,o,s,r){let a=r||null,c=null,p=null;if(!a&&s&&s.trim().length>0)try{a=await os(s)}catch(g){console.warn("Failed to classify prompt via LLM/local fallback:",g)}const h=!!(a&&a.chords?.length&&a.key&&a.scaleType);let l=null;return h&&a&&a.chords&&a.key&&a.scaleType&&(l=ko(e,a.key,a.scaleType,a.chords,a.genre||i,a.mood||n)),l||(l=pi(e,i,n,{length:o})),h&&a&&(a.instrumentConfig?.presetId&&(c=Vn(a.instrumentConfig.presetId)??null),a.rhythmStyle&&(p=qn(a.rhythmStyle)??null)),l.chords.length>o&&(l={...l,chords:l.chords.slice(0,o)}),s&&(l={...l,searchTerm:s}),{progression:l,instrument:c,playStyle:p,normalizedSuggestion:a}}}const xe=[{name:"Verse",desc:"Settled, familiar.",reorder:t=>Array.from({length:t},(e,i)=>i)},{name:"Chorus",desc:"Brighter, opens the key up.",reorder:t=>Array.from({length:t},(e,i)=>(i+Math.ceil(t/2))%t)},{name:"Bridge",desc:"Detours, borrows a shadow chord.",reorder:t=>Array.from({length:t},(e,i)=>t-1-i)},{name:"Outro",desc:"Settles back down.",reorder:t=>Array.from({length:t},(e,i)=>(i-1+t)%t)},{name:"Pre-chorus",desc:"Leans in, sets up the turn.",reorder:t=>Array.from({length:t},(e,i)=>(i+1)%t)}];class re{static createInitialSong(e,i){const n=i||Array.from({length:e.chords.length},(o,s)=>s);return[{name:xe[0].name,desc:xe[0].desc,progression:e,order:n.slice()}]}static generateSectionProgression(e,i,n,o){const s=e.key,r=e.scaleType||"MAJOR",a=e.genre||"Pop",c=e.mood||"Uplifting",p=e.bpm||120,h=R(s,r),l=`${s}_${r}`,g=e.chords.length||4;let d=o&&o>=2&&o<=8?o:g;i==="Pre-chorus"&&!o&&g>4&&(d=4);const u=n?.scales?n.scales[l]:void 0;let m=[];return u&&Object.keys(u.degrees).length>0?m=this.walkSectionMarkov(u,l,i,a,c,h,d,e,n):m=this.fallbackSectionChords(e,i,d,h),i==="Chorus"&&this.areChordSequencesIdentical(e.chords,m)&&(m=this.shiftChorusVariation(m,u,l,h)),{genre:a,mood:c,key:s,scaleType:r,bpm:p,chords:m}}static walkSectionMarkov(e,i,n,o,s,r,a,c,p){const h=Object.keys(e.degrees),l=this.pickSectionStartDegree(n,e,o,s),g=[l];let d=l;for(let m=1;m<a;m++){const v=m===a-1,b=h.filter(N=>e.degrees[N]&&N!==d),y=b.length?b:h;if(v){const N=J(y,I=>{let x=fe(d,I,e.type,o,s);return n==="Outro"&&I==="TONIC"?x*=8:n==="Pre-chorus"&&(I==="DOMINANT"||I==="SUBDOMINANT")?x*=6:n==="Chorus"&&(I==="TONIC"||I==="SUBDOMINANT"||I==="DOMINANT")&&(x*=2.5),Math.max(.01,x)});g.push(N)}else{const N=y.filter(O=>!g.includes(O)),I=N.length?N:y,x=J(I,O=>{let F=fe(d,O,e.type,o,s);return F*=this.getSectionTransitionMultiplier(n,d,O),Math.max(.01,F)});d=x,g.push(x)}}const u=g.map(m=>de(i,m,e,r));if(n==="Bridge"&&u.length>=3&&p)try{const m=ui(p,c,1);if(m&&m.length>0){const v=m.find(b=>b.roman.includes("VI")||b.roman.includes("VII")||b.roman==="iv")||m[0];if(v&&v.chord){const b=Math.min(u.length-2,1);u[b]={...v.chord,desc:v.sub||"Shadow chord borrowed for the bridge detour."}}}}catch{}return u}static pickSectionStartDegree(e,i,n,o){const s=Object.keys(i.degrees),r=a=>!!i.degrees[a];if(e==="Chorus"){const a={SUBDOMINANT:3.5,SUBMEDIANT:3,SUPERTONIC:1.2,TONIC:.5,MEDIANT:.8,DOMINANT:.6};return J(s,c=>(a[c]||.4)*(r(c)?1:.01))}if(e==="Bridge"){const a={SUBMEDIANT:3.5,MEDIANT:2.5,SUBDOMINANT:2.2,SUPERTONIC:1.5,TONIC:.2};return J(s,c=>(a[c]||.5)*(r(c)?1:.01))}if(e==="Pre-chorus"){const a={SUPERTONIC:3.2,SUBDOMINANT:2.8,SUBMEDIANT:2,TONIC:.3};return J(s,c=>(a[c]||.4)*(r(c)?1:.01))}if(e==="Outro"){const a={SUBDOMINANT:2.5,SUBMEDIANT:2,TONIC:2.5};return J(s,c=>(a[c]||.5)*(r(c)?1:.01))}return J(s,a=>rn(a,i.type,n,o))}static getSectionTransitionMultiplier(e,i,n){if(e==="Chorus"){if(i==="SUBDOMINANT"&&(n==="DOMINANT"||n==="TONIC"))return 2.2;if(i==="SUBMEDIANT"&&(n==="SUBDOMINANT"||n==="DOMINANT"))return 2;if(i==="DOMINANT"&&(n==="TONIC"||n==="SUBMEDIANT")||i==="TONIC"&&(n==="SUBDOMINANT"||n==="DOMINANT"))return 1.8}else if(e==="Pre-chorus"){if(i==="SUPERTONIC"&&(n==="SUBDOMINANT"||n==="DOMINANT"))return 2.8;if(i==="SUBMEDIANT"&&n==="SUPERTONIC")return 2.2;if(i==="SUBDOMINANT"&&n==="DOMINANT")return 3.2}else if(e==="Bridge"){if(i==="SUBMEDIANT"&&n==="MEDIANT")return 2;if(i==="MEDIANT"&&n==="SUBDOMINANT")return 2.2;if(i==="SUBDOMINANT"&&n==="DOMINANT")return 2}else if(e==="Outro"){if(i==="SUBDOMINANT"&&n==="TONIC")return 2.8;if(i==="SUBMEDIANT"&&n==="SUBDOMINANT")return 2}return 1}static fallbackSectionChords(e,i,n,o){const s=e.chords,r=B[e.key]??0,a=(e.scaleType||"").includes("MINOR");let c=[];if(i==="Chorus")s.length>=4?c=[s[1],s[2],s[3]||s[0],s[0]]:c=[...s].reverse();else if(i==="Bridge"){const h=a?_(M(r+5,o),"Major","None","IV","Major subdominant","the Dorian lift, sunny and open",.35,o):_(M(r+8,!0),"Major","None","♭VI","Flat submediant","cinematic shadow detour",.48,!0);s.length>=4?c=[s[3]||s[1],h,s[1]||s[2],s[2]||s[0]]:c=[h,...s]}else i==="Pre-chorus"?s.length>=4?c=[s[1],s[2],s[1],s[2]]:c=s:i==="Outro"?s.length>=4?c=[s[1],s[3]||s[1],s[1],s[0]]:c=s:c=(xe.find(g=>g.name===i)||xe[1]).reorder(s.length).map(g=>s[g%s.length]);const p=[];for(let h=0;h<n;h++)p.push(c[h%c.length]);return p}static areChordSequencesIdentical(e,i){return e.length!==i.length?!1:e.every((n,o)=>n.name===i[o]?.name)}static shiftChorusVariation(e,i,n,o=!0,s){const r=s||e.length;if(!i||!n)return e;const a=i.degrees.SUBDOMINANT?de(n,"SUBDOMINANT",i,o):null,c=i.degrees.DOMINANT?de(n,"DOMINANT",i,o):null,p=i.degrees.SUBMEDIANT?de(n,"SUBMEDIANT",i,o):null,h=i.degrees.TONIC?de(n,"TONIC",i,o):null;if(a&&c&&p&&h){const l=[a,c,p,h],g=[];for(let d=0;d<r;d++)g.push(l[d%l.length]);return g}return e}static addSection(e,i,n,o){if(e.length>=xe.length)return{sections:e,activeIndex:e.length-1};const s=xe[e.length],r=this.generateSectionProgression(i,s.name,n,o),a=Array.from({length:r.chords.length},(h,l)=>l),c={name:s.name,desc:s.desc,progression:r,order:a},p=[...e,c];return{sections:p,activeIndex:p.length-1}}static removeSection(e,i){if(e.length<=1||i<0||i>=e.length)return{sections:e,activeIndex:0};const n=e.filter((s,r)=>r!==i),o=Math.min(i,n.length-1);return{sections:n,activeIndex:Math.max(0,o)}}static syncActiveSection(e,i,n,o){if(!e[i])return e;const s=[...e];return s[i]={...s[i],progression:n,order:o.slice()},s}}var rs=Object.defineProperty,as=Object.getOwnPropertyDescriptor,se=(t,e,i,n)=>{for(var o=n>1?void 0:n?as(e,i):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(o=(n?r(e,i,o):r(o))||o);return n&&o&&rs(e,i,o),o};let Z=class extends Ce{constructor(){super(...arguments),this.compact=!1,this.isAdmin=!1,this.isAuthenticated=!1,this.userEmail=null,this.savedCount=0,this.syncStatus="synced",this.syncError=null,this.title="Chroma Chords",this.accountMenuOpen=!1,this.unsubscribeProjects=null,this.unsubscribeSyncStatus=null}connectedCallback(){super.connectedCallback(),this.unsubscribeProjects=D.subscribeProjects(()=>{this.savedCount=D.getProjects().length,this.requestUpdate()}),this.unsubscribeSyncStatus=D.subscribeSyncStatus(t=>{this.syncStatus=t,this.syncError=D.getLastSyncError(),this.requestUpdate()}),this.savedCount=D.getProjects().length,this.syncStatus=D.getSyncStatus(),this.syncError=D.getLastSyncError()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeProjects&&this.unsubscribeProjects(),this.unsubscribeSyncStatus&&this.unsubscribeSyncStatus()}toggleAccountMenu(t){t.stopPropagation(),this.accountMenuOpen=!this.accountMenuOpen}onSignIn(){this.dispatchEvent(new CustomEvent("request-login",{bubbles:!0,composed:!0}))}onSignOut(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("request-logout",{bubbles:!0,composed:!0}))}onViewSets(){this.accountMenuOpen=!1,this.dispatchEvent(new CustomEvent("view-sets",{bubbles:!0,composed:!0}))}onSyncNow(){this.dispatchEvent(new CustomEvent("sync-projects",{bubbles:!0,composed:!0}))}renderSyncStatusText(){return this.syncStatus==="synced"?"Synced with cloud":this.syncStatus==="syncing"?"Syncing with cloud...":this.syncStatus==="offline"?"Sync failed (offline)":"Sign in to sync"}render(){const t=this.userEmail?this.userEmail.charAt(0).toUpperCase():"U";return f`
  ...
  `;se([E({type:Boolean})],Z.prototype,"compact",2);se([E({type:Boolean})],Z.prototype,"isAdmin",2);se([E({type:Boolean})],Z.prototype,"isAuthenticated",2);se([E({type:String})],Z.prototype,"userEmail",2);se([E({type:Number})],Z.prototype,"savedCount",2);se([E({type:String})],Z.prototype,"syncStatus",2);se([E({type:String})],Z.prototype,"syncError",2);se([E({type:String})],Z.prototype,"title",2);se([w()],Z.prototype,"accountMenuOpen",2);Z=se([Ee("app-header")],Z);function Di(t){const e={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,"E#":5,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=t.match(/^([A-Ga-g][#b]?)(-?\d+)?$/);if(!i)return 60;const n=i[1].charAt(0).toUpperCase()+i[1].slice(1),o=e[n]??0,s=i[2]!==void 0?parseInt(i[2],10):4;return Math.min(127,Math.max(0,(s+1)*12+o))}function mn(t,e,i,n=1,o){const s=e&&e.length>0?e.map(y=>t.chords[y]).filter(y=>!!y):t.chords,r=t.bpm||120,a=n*240/r,c=i?We.find(y=>y.name.toLowerCase()===i.toLowerCase()):void 0,p=bi[t.genre]||{},h=c?.patch??{},l={...p,...h,...o?.humanState??{}},g=p.duration??.9,d=h.durationMultiplier?g*h.durationMultiplier:g,u=o?.humanState?.strum!==void 0?o.humanState.strum/100*1.5:o?.spread!==void 0?o.spread/100*1.5:p.spread??.3,m=o?.humanState?.swing!==void 0?o.humanState.swing:o?.swing??0,v=o?.density??50,b=[];return s.forEach((y,N)=>{const I=m/100*.04*(N%2===1?1:0),x=N*a+I,O=y.notes&&y.notes.length>0?y.notes:["C","E","G"];let F=mi(O,4);if(F=on(F,v),l.arpMode&&l.arpMode!=="off"){const z=l.arpRate??"1/16",A=l.arpRange??1,$=l.arpMode,V=en(z,r),j=tn(F,A),C=nn(j,$),P=l.duration?l.duration:Math.max(.6,d);C.forEach((H,Y)=>{const _e=x+Y*V;b.push({note:H,midi:Di(H),startTime:_e,duration:P})})}else{const z=o?.humanState?.instrument||void 0,A=z?ue(z):void 0,$=A?ae.find(C=>C.name.toLowerCase()===A.toLowerCase())?.instrument??"piano":Tt[t.genre]??"piano",V=$==="guitar"||$==="jazz-guitar",j=$==="jazz-guitar";F.forEach((C,P)=>{const Y=(V?P*(j?.018:.024):0)+P*u*.1,_e=x+Y;b.push({note:C,midi:Di(C),startTime:_e,duration:V?Math.max(d,1.2):d})})}}),b}function ls(t){const e=[];let i=Math.max(0,Math.floor(t));for(e.push(i&127);(i>>=7)>0;)e.unshift(i&127|128);return e}function cs(t,e,i,n=1,o){const s=t.bpm||120,r=480,a=mn(t,e,i,n,o),c=[];a.forEach(b=>{const y=Math.round(b.startTime/(60/s)*r),N=Math.max(1,Math.round(b.duration/(60/s)*r));c.push({tick:y,type:"on",midi:b.midi}),c.push({tick:y+N,type:"off",midi:b.midi})}),c.sort((b,y)=>b.tick!==y.tick?b.tick-y.tick:b.type!==y.type?b.type==="off"?-1:1:b.midi-y.midi);const p=[],h=Math.round(6e7/s);p.push(0),p.push(255,81,3),p.push(h>>16&255,h>>8&255,h&255);const l="Chroma Chords";p.push(0),p.push(255,3,l.length);for(let b=0;b<l.length;b++)p.push(l.charCodeAt(b));let g=0;c.forEach(b=>{const y=b.tick-g;g=b.tick,p.push(...ls(y)),b.type==="on"?p.push(144,b.midi,80):p.push(128,b.midi,0)}),p.push(0),p.push(255,47,0);const d=[77,84,104,100,0,0,0,6,0,0,0,1,r>>8&255,r&255],u=p.length,m=[77,84,114,107,u>>24&255,u>>16&255,u>>8&255,u&255],v=new Uint8Array(d.length+m.length+p.length);return v.set(d,0),v.set(m,d.length),v.set(p,d.length+m.length),v}function ds(t,e,i,n,o=1,s){const r=cs(t,e,n,o,s),a=new Blob([r],{type:"audio/midi"}),c=(t.key||"C").toLowerCase(),p=(t.mood||"progression").toLowerCase().replace(/\s+/g,"-"),h=t.bpm||120,l=`chroma-chords-${c}-${p}-${h}bpm.mid`;gn(a,l)}function ps(t,e,i="Warm",n){const o=new Gi({threshold:-6,ratio:20,attack:.002,release:.1,knee:3}).toDestination(),s=Bn(i,o),r=t?ue(t):void 0;switch((r?ae.find(p=>p.name.toLowerCase()===r.toLowerCase()):void 0)?.instrument??(e?Tt[e]:void 0)??"piano"){case"bell":{const p=new Fe({high:3.5,mid:-.5,low:-2,highFrequency:4800}).connect(s),h=new pe({decay:3.2,wet:.32}).connect(p);return new q(ci,{harmonicity:3.5,modulationIndex:12,envelope:{attack:.002,decay:1.2,sustain:.04,release:1.4},modulationEnvelope:{attack:.002,decay:.6,sustain:.01,release:.5},volume:-12}).connect(h)}case"organ":{const p=new ie({frequency:4500,type:"lowpass",rolloff:-12}).connect(s),h=new ge({distortion:.08,wet:.15}).connect(p),l=new Pe({frequency:5.8,depth:.12,wet:.55}).connect(h);return new q(ce,{oscillator:{type:"fatsine",count:3,spread:15},envelope:{attack:.008,decay:.15,sustain:.9,release:.25},volume:-12}).connect(l)}case"pad-strings":{const p=new pe({decay:5.5,preDelay:.03,wet:.45}).connect(s),h=new me({frequency:.45,delayTime:4,depth:.5,wet:.4}).start(0).connect(p);return new q(ce,{oscillator:{type:"fatsawtooth",count:3,spread:22},envelope:{attack:.65,decay:.8,sustain:.85,release:2.5},volume:-13}).connect(h)}case"juno-pad":{const p=new me({frequency:.85,delayTime:3.5,depth:.72,wet:.55}).start(0).connect(s);return new q(Be,{oscillator:{type:"fatsawtooth",count:3,spread:20},envelope:{attack:.02,decay:.45,sustain:.65,release:.85},filterEnvelope:{attack:.02,decay:.5,sustain:.35,release:.8,baseFrequency:750,octaves:3.2,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.5},volume:-12}).connect(p)}case"stab":{const p=new ge({distortion:.1,wet:.12}).connect(s),h=new pe({decay:1,wet:.22}).connect(p);return new q(Be,{oscillator:{type:"fatsawtooth",count:2,spread:12},envelope:{attack:.003,decay:.16,sustain:.08,release:.18},filterEnvelope:{attack:.003,decay:.14,sustain:.05,release:.16,baseFrequency:420,octaves:3.5,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2},volume:-10}).connect(h)}case"jazz-guitar":{const p=new Fe({low:-1,mid:2,high:-3.5,lowFrequency:480,highFrequency:2800}).connect(s),h=new ie({frequency:2800,type:"lowpass",rolloff:-12}).connect(p),l=new pe({decay:1.8,preDelay:.02,wet:.18}).connect(h);return n&&Object.keys(n).length>0?new he({urls:n,volume:-8}).connect(l):new q(ce,{oscillator:{type:"triangle"},envelope:{attack:.005,decay:.7,sustain:.08,release:.9},volume:-8}).connect(l)}case"sh101":{const p=new me({frequency:.25,delayTime:4.2,depth:.6,wet:.35}).start(0).connect(s),h=new ie({frequency:3400,type:"lowpass",rolloff:-12}).connect(p),l=new ge({distortion:.12,wet:.18}).connect(h),g=new Pe({frequency:.45,depth:.18,wet:.65}).connect(l);return new q(Be,{oscillator:{type:"fatsawtooth",count:2,spread:14},envelope:{attack:.03,decay:.6,sustain:.75,release:1.4},filterEnvelope:{attack:.04,decay:.8,sustain:.4,release:1.2,baseFrequency:450,octaves:2.6,exponent:2},filter:{type:"lowpass",rolloff:-24,Q:2.8},volume:-11}).connect(g)}case"guitar":return n&&Object.keys(n).length>0?new he({urls:n,volume:-8}).connect(s):new q(ce,{oscillator:{type:"triangle"},envelope:{attack:.004,decay:.6,sustain:.05,release:.8},volume:-8}).connect(s);case"rhodes":case"epiano":return n&&Object.keys(n).length>0?new he({urls:n,volume:-10}).connect(s):new q(ci,{harmonicity:2,modulationIndex:3.5,envelope:{attack:.008,decay:.6,sustain:.25,release:1.2},modulationEnvelope:{attack:.008,decay:.4,sustain:.1,release:.6},volume:-10}).connect(s);case"piano":default:return n&&Object.keys(n).length>0?new he({urls:n,volume:-9}).connect(s):new q(ce,{oscillator:{type:"triangle"},envelope:{attack:.005,decay:.8,sustain:.15,release:1},volume:-9}).connect(s)}}function hs(t){const e=t.numberOfChannels,i=t.sampleRate,n=16,o=n/8,s=e*o,r=t.length*e*o,a=new ArrayBuffer(44+r),c=new DataView(a),p=(g,d)=>{for(let u=0;u<d.length;u++)c.setUint8(g+u,d.charCodeAt(u))};p(0,"RIFF"),c.setUint32(4,36+r,!0),p(8,"WAVE"),p(12,"fmt "),c.setUint32(16,16,!0),c.setUint16(20,1,!0),c.setUint16(22,e,!0),c.setUint32(24,i,!0),c.setUint32(28,i*s,!0),c.setUint16(32,s,!0),c.setUint16(34,n,!0),p(36,"data"),c.setUint32(40,r,!0);const h=[];for(let g=0;g<e;g++)h.push(t.getChannelData(g));let l=44;for(let g=0;g<t.length;g++)for(let d=0;d<e;d++){const u=Math.max(-1,Math.min(1,h[d][g])),m=u<0?u*32768:u*32767;c.setInt16(l,m,!0),l+=2}return new Blob([new Uint8Array(a)],{type:"audio/wav"})}async function us(t,e,i,n,o=1,s){const r=mn(t,e,n,o,s);if(!r.length)return;const a=e&&e.length>0?e.map(x=>t.chords[x]).filter(x=>!!x):t.chords,c=t.bpm||120,p=o*240/c,h=Math.max(.1,a.length*p),l=i?ue(i):void 0,d=(l?ae.find(x=>x.name.toLowerCase()===l.toLowerCase()):void 0)?.instrument??(t.genre?Tt[t.genre]:void 0)??"piano";await zn(d);const u=Ln(d),m=s?.tone||"Warm",v=await xn(async()=>{const x=ps(l||i,t.genre,m,u);r.forEach(O=>{O.startTime<h&&x.triggerAttackRelease(O.note,O.duration,O.startTime)})},h),b=hs(v.get()),y=(t.key||"C").toLowerCase(),N=(t.mood||"progression").toLowerCase().replace(/\s+/g,"-"),I=`chroma-chords-${y}-${N}-${c}bpm.wav`;gn(b,I)}function gn(t,e){if(typeof URL>"u"||typeof URL.createObjectURL!="function")return;const i=URL.createObjectURL(t);if(typeof document>"u")return;const n=document.createElement("a");n.href=i,n.download=e,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(i),1e3)}var ms=Object.defineProperty,gs=Object.getOwnPropertyDescriptor,le=(t,e,i,n)=>{for(var o=n>1?void 0:n?gs(e,i):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(o=(n?r(e,i,o):r(o))||o);return n&&o&&ms(e,i,o),o};const fs=X`
...
`,ys=[{device:"m8",mono:"M8",name:"M8 Tracker",desc:"Opens the M8 helper with this progression.",svg:fs},{device:"circuit",mono:"CT",name:"Circuit Tracks",desc:"Opens the Circuit Tracks helper with this progression.",svg:bs}];let ee=class extends Ce{constructor(){super(...arguments),this.open=!1,this.visible=!1,this.progression=null,this.order=[],this.instrument=null,this.playStyle=null,this.barsPerChord=1,this.feelSettings=null,this.onKeyDown=t=>{t.key==="Escape"&&this.isOpened&&this.close()}}get isOpened(){return this.open||this.visible}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKeyDown)}emit(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}close(){this.emit("close")}handleDeviceClick(t){if(!this.progression)return;const e=Ro(this.progression,t,this.order);window.open(e,"_blank");const i=t==="m8"?"M8 Tracker":"Circuit Tracks";this.emit("toast",`Opening ${i} helper...`),this.close()}async handleWavClick(){if(this.progression){this.emit("toast","Generating WAV audio...");try{const t=this.barsPerChord||S.getBarsPerChord()||1,e=this.feelSettings||S.getFeelSettings();await us(this.progression,this.order,this.instrument,this.playStyle,t,e),this.emit("toast","WAV file downloaded")}catch(t){console.error("WAV export failed",t),this.emit("toast","Failed to generate WAV file")}this.close()}}handleMidiClick(){if(this.progression){try{const t=this.barsPerChord||S.getBarsPerChord()||1,e=this.feelSettings||S.getFeelSettings();ds(this.progression,this.order,this.instrument,this.playStyle,t,e),this.emit("toast","MIDI file downloaded")}catch(t){console.error("MIDI export failed",t),this.emit("toast","Failed to generate MIDI file")}this.close()}}render(){const t=this.isOpened;return f`
  ...
  `;le([E({type:Boolean})],ee.prototype,"open",2);le([E({type:Boolean})],ee.prototype,"visible",2);le([E({type:Object})],ee.prototype,"progression",2);le([E({type:Array})],ee.prototype,"order",2);le([E({type:String})],ee.prototype,"instrument",2);le([E({type:String})],ee.prototype,"playStyle",2);le([E({type:Number})],ee.prototype,"barsPerChord",2);le([E({type:Object})],ee.prototype,"feelSettings",2);ee=le([Ee("share-modal")],ee);var vs=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,ve=(t,e,i,n)=>{for(var o=n>1?void 0:n?xs(e,i):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(o=(n?r(e,i,o):r(o))||o);return n&&o&&vs(e,i,o),o};function ws(t,e,i){return Math.round(t+(e-t)*i)}function fn(t,e,i){const n=[1,3,5].map(s=>parseInt(t.slice(s,s+2),16)),o=[1,3,5].map(s=>parseInt(e.slice(s,s+2),16));return"#"+n.map((s,r)=>ws(s,o[r],i).toString(16).padStart(2,"0")).join("")}function Is(t){const e=[1,3,5].map(i=>parseInt(t.slice(i,i+2),16)/255).map(i=>i<=.03928?i/12.92:Math.pow((i+.055)/1.055,2.4));return .2126*e[0]+.7152*e[1]+.0722*e[2]}function Bi(t){let i=.3,n=t;for(;i<=.86&&(n=fn(t,"#2E271F",i),!((.925+.05)/(Is(n)+.05)>=4.7));i+=.03);return n}let oe=class extends Ce{constructor(){super(...arguments),this.swapIndex=0,this.feelings=[],this.activeFeel="Darker",this.pickedChord=null,this.padCols=4,this.moodColor="#9CC0EC"}onSelectFeel(t){this.activeFeel=t,this.dispatchEvent(new CustomEvent("swap-feel-change",{detail:{feel:t},bubbles:!0,composed:!0}))}onAudition(t,e){this.dispatchEvent(new CustomEvent("swap-audition",{detail:{chordName:t.name,roman:t.roman||"",notes:t.notes||(t.chord?.notes??[]),sub:t.sub,tension:t.tension,feel:e.name,chord:t.chord},bubbles:!0,composed:!0}))}onConfirm(){this.dispatchEvent(new CustomEvent("swap-confirm",{bubbles:!0,composed:!0}))}onClose(){this.dispatchEvent(new CustomEvent("swap-close",{bubbles:!0,composed:!0}))}render(){const t=Math.max(1,this.padCols||4),e=this.swapIndex%t,i=`calc((100% - ${12*(t-1)}px) / ${t})`,n=this.chord?.tension??.3,o=Q(n).color,s=this.feelings.find(b=>b.name===this.activeFeel)||this.feelings[0],r=Math.max(0,this.feelings.findIndex(b=>b.name===s?.name)),a=Math.max(1,this.feelings.length),c=`calc((100% - ${7*(a-1)}px) / ${a})`,p=r===0,h=r===a-1;let l=`left: calc(${c} * ${r} + ${7*r}px); width: ${c};`,g="12px";p&&h?(l="left: 0; right: 0; width: 100%;",g="0 0 12px 12px"):p?(l=`left: 0; width: ${c};`,g="0 12px 12px 12px"):h&&(l=`left: auto; right: 0; width: ${c};`,g="12px 0 12px 12px");const d=s?.tension??.3,u=Bi(Q(d).color),m=`Bar ${this.swapIndex+1} · ${this.chord?.name||"Chord"} could feel…`,v=this.pickedChord?`hearing swap: ${this.pickedChord.name}`:"tap to audition in the loop";return f`
        ...
        <div class="lane-clip">
          <div class="lane-panel" style="background: ${o};">
            ...
            <div class="feelings-row">
              ${this.feelings.map(b=>{const y=b.name===s?.name,N=Q(b.tension),I=y?Bi(N.color):fn(N.color,"#FBF6EC",.5);return f`
                  <button
                    class="feel-tile"
                    data-feel-tile="1"
                    data-sel="${y?"1":"0"}"
                  ...
                  >
                    <span class="feel-tile-name" style="color: ${y?"#FBF6EC":"#2E271F"};">${b.name}</span>
                    <span class="feel-tile-sub" style="color: ${y?"#FBF6EC":"#2E271F"};">${b.sub}</span>
                  </button>
                `})}
            </div>
            ...
            <div class="chords-shell" data-lane-join="${r}">
              ...
              <div class="chords-box" style="background: ${u}; border-radius: ${g};">
                ${(s?.rows||[]).map(b=>{const y=this.pickedChord?.name===b.name,N=typeof b.tension=="number"?b.tension:d,I=Q(N);return f`
                    <button
  ...
  `;ze([E({type:Object})],be.prototype,"originalChord",2);ze([E({type:Number})],be.prototype,"barIndex",2);ze([E({type:Array})],be.prototype,"feelings",2);ze([E({type:Number})],be.prototype,"feelIndex",2);ze([E({type:Number})],be.prototype,"chordIndex",2);be=ze([Ee("chord-pad-cycler")],be);var ks=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,T=(t,e,i,n)=>{for(var o=n>1?void 0:n?Ts(e,i):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(o=(n?r(e,i,o):r(o))||o);return n&&o&&ks(e,i,o),o};const oi=[{name:"Oasis",color:"#F6D98B",r:10,plain:"leans on a bright chord that shouldn’t fit, then walks home",theory:"borrowed major ♭III, plagal IV–I, sus4 held over a static root",hoist:["E♭maj7","Fmaj7","A♭"],font:"Anton, sans-serif",pillFs:13,pillTrack:"0.08em"},{name:"Radiohead",color:"#C9A9E0",r:3,plain:"swaps a chord for its stranger neighbour a third away",theory:"chromatic mediants and modal mixture — ♭VI and ♭III against a major tonic",hoist:["A♭maj7","E♭maj7","Em7"],font:"'Space Mono', monospace",weight:700,pillFs:12.5,pillTrack:"0.02em"},{name:"Nirvana",color:"#F2A79B",r:2,plain:"moves the root in big jumps and leaves the middle empty",theory:"power-chord roots by minor third and tritone — no thirds, so major or minor stays open",hoist:["A♭","E♭maj7","B♭"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"0.04em"},{name:"Steely Dan",color:"#9CC0EC",r:13,plain:"adds one note that makes a plain chord sound expensive",theory:"major triad plus 9th with no 7th, ii–V chains, tritone substitution",hoist:["Cmaj9","D♭7","Fm7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,italic:!0,pillFs:13,pillTrack:"0.01em"},{name:"Mac DeMarco",color:"#B8CC9E",r:7,plain:"two lush chords looped loose, bass sliding underneath",theory:"maj7 vamp with chromatic bass motion, no real resolution",hoist:["Fmaj7","Cmaj9","Em7"],font:"'Plus Jakarta Sans', sans-serif",weight:800,pillFs:12,pillTrack:"-0.01em"}],Fi=["Pop","Lo-fi/Chill","R&B/Soul","Synthwave","Indie/Folk","Rock","Jazz-ish","Cinematic"],Pi=["Uplifting","Melancholy","Dreamy"],Cs={Uplifting:"M4 18 C 8 18 8 11 12 11 C 16 11 16 5 20 5",Melancholy:"M3 9 Q 8 9 9 14 T 15 17 Q 19 18 21 15",Dreamy:"M4 15 a4 4 0 1 1 8 0 a4 4 0 1 1 8 0",Tense:"M3 12 L7 6 L11 16 L15 6 L19 16 L21 12",Warm:"M12 4 a6.5 6.5 0 1 0 6.5 6.5",Nostalgic:"M3 12 C 7 6 9 18 13 12 C 17 6 19 18 21 12"},we={Tonic:"home",Submediant:"drifting",Subdominant:"lifting",Supertonic:"stepping up",Mediant:"wistful",Dominant:"pulling home","Dominant 7th":"pulling home"},Es=we,si=["A","S","D","F","Z","X","C","V"],Os=["Octave up","1st inversion","Low root"];function Ui(t){if(!t)return 1;const e=t.toLowerCase();return e.includes("octave")||e.includes("up")?0:e.includes("low")||e.includes("root")?2:1}const As=[{label:"Major",sub:"bright"},{label:"Minor",sub:"warm"},{label:"Suspended (sus)",sub:"floating"},{label:"Diminished",sub:"unstable"}],Ms=[{label:"None",sub:"triad only"},{label:"6th",sub:"soft lift"},{label:"7th (dom / m7)",sub:"classic tension"},{label:"Major 7th (M7)",sub:"lush, jazzy"},{label:"9th",sub:"wide, colorful"}],ri=[{k:"playStyle",label:"Pattern",hint:"How the notes are laid out in time",steps:[{v:"Block chords",name:"Block"},{v:"Arpeggio",name:"Arp"},{v:"Strum",name:"Strum"},{v:"Broken (swing)",name:"Broken"},{v:"Half-time",name:"Half-time"}]},{k:"swing",label:"Swing",hint:"How far behind the beat the notes land",steps:[{v:0,name:"Straight"},{v:25,name:"Light"},{v:55,name:"Loose"},{v:85,name:"Heavy"}]},{k:"spread",label:"Spread",hint:"How far apart the notes sit",steps:[{v:15,name:"Tight"},{v:50,name:"Close"},{v:75,name:"Open"},{v:95,name:"Wide"}]},{k:"density",label:"Density",hint:"How many notes per chord",steps:[{v:20,name:"Sparse"},{v:50,name:"Simple"},{v:75,name:"Full"},{v:95,name:"Busy"}]},{k:"humanise",label:"Humanise",hint:"How loose the timing and touch are",steps:[{v:0,name:"Machine"},{v:45,name:"Natural"},{v:80,name:"Loose"}]},{k:"tone",label:"Tone",hint:"The colour of the instrument",steps:[{v:"Warm",name:"Warm"},{v:"Glassy",name:"Glassy"},{v:"Dusty",name:"Dusty"}]}],K={playStyle:"Block chords",swing:0,spread:50,density:50,humanise:45,tone:"Warm"},$s=["C","D♭","D","E♭","E","F","F♯","G","A♭","A","B♭","B"],Ri=[{root:"C",label:"C"},{root:"Db",label:"C♯ / D♭"},{root:"D",label:"D"},{root:"Eb",label:"D♯ / E♭"},{root:"E",label:"E"},{root:"F",label:"F"},{root:"F#",label:"F♯ / G♭"},{root:"G",label:"G"},{root:"Ab",label:"G♯ / A♭"},{root:"A",label:"A"},{root:"Bb",label:"A♯ / B♭"},{root:"B",label:"B"}],pt=[{type:"MAJOR",label:"Major",abbrev:"Maj"},{type:"NATURAL_MINOR",label:"Minor",abbrev:"Min"},{type:"DORIAN",label:"Dorian",abbrev:"Dor"},{type:"MIXOLYDIAN",label:"Mixolydian",abbrev:"Mix"},{type:"LYDIAN",label:"Lydian",abbrev:"Lyd"},{type:"PHRYGIAN",label:"Phrygian",abbrev:"Phr"},{type:"HARMONIC_MINOR",label:"Harmonic Min",abbrev:"Harm"},{type:"MELODIC_MINOR",label:"Melodic Min",abbrev:"Mel"},{type:"LOCRIAN",label:"Locrian",abbrev:"Loc"}],ai={MAJOR:{steps:[0,2,4,5,7,9,11],romans:["I","ii","iii","IV","V","vi","vii°"],quals:["","m","m","","","m","dim"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"major"},NATURAL_MINOR:{steps:[0,2,3,5,7,8,10],romans:["i","ii°","♭III","iv","v","♭VI","♭VII"],quals:["m","dim","","m","m","",""],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"natural minor"},DORIAN:{steps:[0,2,3,5,7,9,10],romans:["i","ii","♭III","IV","v","vi°","♭VII"],quals:["m","m","","","m","dim",""],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"Dorian"},PHRYGIAN:{steps:[0,1,3,5,7,8,10],romans:["i","♭II","♭III","iv","v°","♭VI","♭vii"],quals:["m","","","m","dim","","m"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"Phrygian"},LYDIAN:{steps:[0,2,4,6,7,9,11],romans:["I","II","iii","iv°","V","vi","vii"],quals:["","","m","dim","","m","m"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"Lydian"},MIXOLYDIAN:{steps:[0,2,4,5,7,9,10],romans:["I","ii","iii°","IV","v","vi","♭VII"],quals:["","m","dim","","m","m",""],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"Mixolydian"},LOCRIAN:{steps:[0,1,3,5,6,8,10],romans:["i°","♭II","♭iii","iv","♭V","♭VI","♭vii"],quals:["dim","","m","m","","","m"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Subtonic"],name:"Locrian"},HARMONIC_MINOR:{steps:[0,2,3,5,7,8,11],romans:["i","ii°","♭III+","iv","V","♭VI","vii°"],quals:["m","dim","aug","m","","","dim"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"Harmonic minor"},MELODIC_MINOR:{steps:[0,2,3,5,7,9,11],romans:["i","ii","♭III+","IV","V","vi°","vii°"],quals:["m","m","aug","","","dim","dim"],fns:["Tonic","Supertonic","Mediant","Subdominant","Dominant","Submediant","Leading tone"],name:"Melodic minor"}},ht={Darker:["Three chords that add weight without changing the key.","All three pull from the parallel minor or its subdominant — same key, more shadow."],"More tension":["Three chords that lean harder into the next bar.","Dominant approaches — each one aims at a chord later in the loop."],Dreamier:["Three chords that open the bar up and let it float.","Extensions and softer degrees — less pull toward home."],"Resolve home":["Three chords that settle the bar back to center.","Tonic and its neighbours — the sense of arriving."],Borrowed:["Four chords from the minor version of this key. Each one swaps in for a chord you already have.","Modal interchange — four chords from the parallel minor, each matched to the chord it can stand in for."]},Li=["C","C#","D","Eb","E","F","F#","G","Ab","A","Bb","B"],zi={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},ut={0:"1",1:"♭9",2:"9",3:"♭3",4:"3",5:"4",6:"♭5",7:"5",8:"♭6",9:"6",10:"♭7",11:"7"},mt={"":[0,4,7],maj:[0,4,7],m:[0,3,7],min:[0,3,7],maj7:[0,4,7,11],m7:[0,3,7,10],7:[0,4,7,10],6:[0,4,7,9],m6:[0,3,7,9],dim:[0,3,6],m7b5:[0,3,6,10],sus4:[0,5,7],sus2:[0,2,7],9:[0,4,7,10],maj9:[0,4,7,11],m9:[0,3,7,10],add9:[0,4,7]},gi={9:"7",maj9:"maj7",m9:"m7",add9:"maj",sus2:"sus4",min:"m","":"maj"},qe={6:{maj:[0,2,2,1,0,0],m:[0,2,2,0,0,0],7:[0,2,0,1,0,0],maj7:[0,2,1,1,0,0],m7:[0,2,0,0,0,0],6:[0,2,2,1,2,0],m6:[0,2,2,0,2,0],sus4:[0,2,2,2,0,0]},5:{maj:[null,0,2,2,2,0],m:[null,0,2,2,1,0],7:[null,0,2,0,2,0],maj7:[null,0,2,1,2,0],m7:[null,0,2,0,1,0],6:[null,0,2,2,2,2],m6:[null,0,2,2,1,2],sus4:[null,0,2,2,3,0],dim:[null,0,1,2,1,null],m7b5:[null,0,1,0,1,null]}};function Ds(t){const e=t===""?"maj":t;if(qe[5][e]||qe[6][e])return e;const i=gi[e];return i&&(qe[5][i]||qe[6][i])?i:"maj"}function Bs(t){const e=Ds(t.q),i=[];return[[6,4],[5,9]].forEach(([n,o])=>{const s=qe[n][e];if(!s)return;const r=((t.rootPc-o)%12+12)%12;i.push({rootFret:r,frets:s.map(a=>a===null?null:a+r)})}),i.length?(i.sort((n,o)=>n.rootFret-o.rootFret),i[0].frets):null}function Fs(t){const e=[7,0,4,9],i=t.intervals.map(r=>(t.rootPc+r)%12),n=r=>{const a=new Set(r);let c=null;const p=[],h=l=>{if(l===4){const g=p.map((v,b)=>(e[b]+v)%12);for(const v of a)if(g.indexOf(v)<0)return;for(const v of g)if(!a.has(v))return;const d=p.filter(v=>v>0),u=d.length?Math.max(...d)-Math.min(...d):0;if(u>3)return;const m=u*12+p.reduce((v,b)=>v+b,0);(!c||m<c.score)&&(c={frets:p.slice(),score:m});return}for(let g=0;g<=5;g++)p.push(g),h(l+1),p.pop()};return h(0),c},o=n(i);if(o)return o.frets;const s=n(t.intervals.filter(r=>r!==7).map(r=>(t.rootPc+r)%12));return s?s.frets:null}let k=class extends Ce{constructor(){super(...arguments),this.chordData={chords:{},scales:{}},this.activeIndex=0,this.progressStep=0,this.order=[0,1,2,3],this.playing=!1,this.showTheory=!1,this.instrument=null,this.playStyle="Block chords",this.isAuthenticated=!1,this.userEmail=null,this.sections=[],this.activeSectionIdx=0,this.activePlayingSectionIdx=0,this.totalSongSteps=0,this.isGenerating=!1,this.libraryOpen=!1,this.isMobile=typeof window<"u"?window.innerWidth<900:!1,this.activeView="loop",this.vibeOpen=!1,this.selectedBand=null,this.freeText="",this.vibePlaceholderIdx=0,this.expandedGenre=!1,this.expandedMood=!1,this.activeSwapFamily="Darker",this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.detailIndex=0,this.abPick=null,this.abSide="before",this.abPlaying=!1,this.mobileFeelIndex=0,this.mobileChordIndex=0,this.savedSets=[],this.renamingId=null,this.draftName="",this.confirmDeleteId=null,this.librarySearch="",this.librarySelectMode=!1,this.librarySelected=[],this.playInstrument="Piano",this.showDegrees=!1,this.mobileSheetOpen=!1,this.mobileDetailSheetOpen=!1,this.padFlash=-1,this.padHeld=-1,this.gridFor=-1,this.lastPad=null,this.tempoOpen=!1,this.feelOpen=!1,this.shareOpen=!1,this.expandedInstrument=!1,this.barsPerChord=1,this.swing=0,this.spread=50,this.density=50,this.humanise=45,this.tone="Warm",this.feelScope="loop",this.barFeel={},this.advOverride={},this.advOpen=!1,this.showAdvancedFeel=!1,this.humanEngineState=null,this.auditionDeg=null,this.auditionName=null,this.auditionBar=0,this.gridTimer=null,this.pendingLatch=null,this.vibeExamples=["Rainy drive at 2am, first day of summer...","Portishead trip-hop","Bohemian Rhapsody","Tame Impala neo-psychedelia","Warm acoustic fireplace"],this.placeholderTimer=null,this.unsubscribeProjects=null,this.onResizeHandler=()=>{this.isMobile=window.innerWidth<900},this.handleKeyDown=t=>{if(t.key==="Escape"&&(this.vibeOpen||this.tempoOpen||this.feelOpen)){t.preventDefault(),this.vibeOpen=!1,this.tempoOpen=!1,this.feelOpen=!1,this.requestUpdate();return}if(this.isEditableTarget(t))return;if(t.key===" "||t.code==="Space"){t.preventDefault(),this.togglePlay();return}if(t.ctrlKey||t.metaKey||t.altKey)return;const e=si.map(n=>n.toLowerCase()).indexOf((t.key||"").toLowerCase()),i=this.progression?.chords||[];if(e>=0&&e<i.length){t.preventDefault();const n=88+e%3*6,o=i[e],s=this.getLadderHome(o),r=o.voicing||"1st inversion",a=Ui(r),c=this.progression?.key||"C",p=this.progression?.scaleType||"MAJOR",h=o.notes&&o.notes.length?o.notes:G(o.name,R(c,p));this.gridTimer&&(clearTimeout(this.gridTimer),this.gridTimer=null),this.padFlash=e,this.padHeld=e,this.gridFor=e;const l=a===0?"UP AN OCTAVE":a===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:e,voicing:r,vel:n,zone:a,reach:s,meta:l},S.playChordNotes(h,.85,r,n),this.requestUpdate()}},this.handleKeyUp=t=>{if(this.isEditableTarget(t)||t.ctrlKey||t.metaKey||t.altKey)return;si.map(i=>i.toLowerCase()).indexOf((t.key||"").toLowerCase())>=0&&(this.padFlash=-1,this.requestUpdate())},this.toggleVibe=()=>{this.vibeOpen=!this.vibeOpen,this.requestUpdate()},this.setLibraryOpen=t=>{this.libraryOpen=t,this.dispatchEvent(new CustomEvent("library-open-change",{detail:t,bubbles:!0,composed:!0})),this.requestUpdate()},this.toggleLibrary=()=>{this.setLibraryOpen(!this.libraryOpen)},this.toggleLibrarySelectMode=()=>{this.librarySelectMode=!this.librarySelectMode,this.librarySelectMode||(this.librarySelected=[]),this.requestUpdate()},this.toggleSelectLoop=t=>{this.librarySelected.includes(t)?this.librarySelected=this.librarySelected.filter(e=>e!==t):this.librarySelected=[...this.librarySelected,t],this.requestUpdate()},this.toggleSelectAllVisible=()=>{const t=this.librarySearch.trim().toLowerCase(),i=this.savedSets.filter(o=>!t||(o.name+" "+o.genre+" "+o.mood).toLowerCase().includes(t)).map(o=>o.id);if(i.length>0&&i.every(o=>this.librarySelected.includes(o)))this.librarySelected=this.librarySelected.filter(o=>!i.includes(o));else{const o=new Set([...this.librarySelected,...i]);this.librarySelected=Array.from(o)}this.requestUpdate()},this.deleteSelectedLoops=()=>{const t=[...this.librarySelected];if(!t.length)return;const e=t.length;for(const i of t)D.deleteProject(i),this.dispatchEvent(new CustomEvent("delete-project",{detail:i,bubbles:!0,composed:!0}));this.savedSets=D.getProjects(),this.librarySelected=[],this.savedSets.length||(this.librarySelectMode=!1),this.dispatchEvent(new CustomEvent("toast",{detail:`Deleted ${e} loop${e>1?"s":""}`,bubbles:!0,composed:!0})),this.requestUpdate()},this.togglePlay=()=>{this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))},this.clearSelection=()=>{this.swapIndex=null,this.isInspectorOpen=!1,this.detailOpen=!1,this.abPick=null,this.abPlaying=!1,S.setABOverride(null),this.requestUpdate()},this.toggleABPlayback=()=>{if(!(!this.progression||this.swapIndex===null)){if(this.abPlaying=!this.abPlaying,this.abPlaying){const t=R(this.progression.key,this.progression.scaleType),e=this.abSide==="after"&&this.abPick?{...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:G(this.abPick.chord,t)}:this.progression.chords[this.swapIndex];S.setABOverride({index:this.swapIndex,side:this.abSide,chord:e}),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0}))}else this.playing&&this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),S.setABOverride(null);this.requestUpdate()}},this.confirmSwap=()=>{if(this.swapIndex===null||!this.abPick||!this.progression)return;const t=R(this.progression.key,this.progression.scaleType),e=this.abPick.notes&&this.abPick.notes.length?this.abPick.notes:G(this.abPick.chord,t),i=[...this.progression.chords],n=i[this.swapIndex],o=n.initialChord||{...n};i[this.swapIndex]={...n,name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:e,initialChord:o};const s={...this.progression,chords:i};this.progression=s,this.dispatchEvent(new CustomEvent("progression-change",{detail:s,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("toast",{detail:`Swapped in ${this.abPick.chord}`,bubbles:!0,composed:!0})),S.setABOverride(null),this.abPlaying=!1,this.swapIndex=null,this.isInspectorOpen=!1,this.mobileSheetOpen=!1,this.abPick=null,this.requestUpdate()},this.handleCyclerKeep=t=>{t&&t.chordName&&(!this.abPick||this.abPick.chord!==t.chordName)&&this.handleSwapAudition({chordName:t.chordName,roman:t.roman||"",tension:t.tension??.3,sub:t.sub||"",feel:t.feel||"Resolve home",chord:t.chord}),this.confirmSwap()},this.onDecLength=()=>{const t=this.progression?.chords.length||4;t>Ke&&this.dispatchEvent(new CustomEvent("set-length",{detail:t-1,bubbles:!0,composed:!0}))},this.onIncLength=()=>{const t=this.progression?.chords.length||4;t<Re&&this.dispatchEvent(new CustomEvent("set-length",{detail:t+1,bubbles:!0,composed:!0}))},this.onSetLength=t=>{(this.progression?.chords.length||4)!==t&&this.dispatchEvent(new CustomEvent("set-length",{detail:t,bubbles:!0,composed:!0}))},this.onReroll=()=>{this.dispatchEvent(new CustomEvent("reroll",{bubbles:!0,composed:!0}))},this.onTheoryToggle=()=>{this.showTheory=!this.showTheory,this.dispatchEvent(new CustomEvent("theory-toggle",{detail:this.showTheory,bubbles:!0,composed:!0})),this.requestUpdate()},this.toggleInstrumentExpand=()=>{this.expandedInstrument=!this.expandedInstrument,this.requestUpdate()},this.onParameterOverride=t=>{const{param:e,value:i}=t.detail;this.advOverride={...this.advOverride,[e]:i},S.setFeelSettings({advOverride:this.advOverride}),this.requestUpdate()},this.onParameterRelink=t=>{const{param:e}=t.detail,i={...this.advOverride};delete i[e],this.advOverride=i,S.setFeelSettings({advOverride:this.advOverride}),this.requestUpdate()},this.onHumanChange=t=>{t.detail&&(this.humanEngineState=t.detail,S.setFeelSettings({playStyle:this.playStyle,swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,barFeel:this.barFeel,advOverride:this.advOverride,humanState:t.detail}))},this.onHumanPreview=t=>{t.detail&&(this.humanEngineState=t.detail,S.setFeelSettings({playStyle:this.playStyle,swing:this.swing,spread:this.spread,density:this.density,tone:this.tone,barFeel:this.barFeel,advOverride:this.advOverride,humanState:t.detail}))}}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.onResizeHandler),window.addEventListener("keydown",this.handleKeyDown),window.addEventListener("keyup",this.handleKeyUp),this.placeholderTimer=setInterval(()=>{this.vibePlaceholderIdx=(this.vibePlaceholderIdx+1)%this.vibeExamples.length},2800),this.savedSets=D.getProjects(),this.unsubscribeProjects=typeof D.subscribeProjects=="function"?D.subscribeProjects(()=>{this.savedSets=D.getProjects(),this.requestUpdate()}):typeof D.subscribe=="function"?D.subscribe(()=>{this.savedSets=D.getProjects(),this.requestUpdate()}):null,S.setFeelSettings({playStyle:this.playStyle,swing:this.swing,spread:this.spread,density:this.density,humanise:this.humanise,tone:this.tone,barFeel:this.barFeel,advOverride:this.advOverride}),S.setBarsPerChord(this.barsPerChord),Ve(this.tone)}updated(t){super.updated(t),(t.has("swing")||t.has("spread")||t.has("density")||t.has("humanise")||t.has("playStyle")||t.has("tone")||t.has("barFeel")||t.has("advOverride")||t.has("humanEngineState"))&&(S.setFeelSettings({playStyle:this.playStyle,swing:this.swing,spread:this.spread,density:this.density,humanise:this.humanise,tone:this.tone,barFeel:this.barFeel,advOverride:this.advOverride,humanState:this.humanEngineState}),t.has("playStyle")&&S.setPlayStyle(this.playStyle),t.has("tone")&&Ve(this.tone)),t.has("barsPerChord")&&S.setBarsPerChord(this.barsPerChord)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResizeHandler),window.removeEventListener("keydown",this.handleKeyDown),window.removeEventListener("keyup",this.handleKeyUp),this.placeholderTimer&&clearInterval(this.placeholderTimer),this.unsubscribeProjects&&this.unsubscribeProjects()}isEditableTarget(t){const e=o=>{if(!o||typeof o!="object")return!1;const s=o,r=(s.tagName||"").toUpperCase();return r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||!!s.isContentEditable},i=typeof t.composedPath=="function"?t.composedPath():[t.target];for(const o of i)if(e(o))return!0;let n=typeof document<"u"?document.activeElement:null;for(;n&&n.shadowRoot&&n.shadowRoot.activeElement;)n=n.shadowRoot.activeElement;return!!e(n)}getVibeSummary(){const t=[this.progression?.genre||"Pop",(this.progression?.mood||"Warm").toLowerCase()];return this.selectedBand&&t.push(this.selectedBand),t.join(" · ")}onGenreClick(t){this.dispatchEvent(new CustomEvent("set-genre",{detail:t,bubbles:!0,composed:!0})),this.requestUpdate()}onMoodClick(t){this.dispatchEvent(new CustomEvent("set-mood",{detail:t,bubbles:!0,composed:!0})),this.requestUpdate()}onBandClick(t){this.selectedBand===t?this.selectedBand=null:this.selectedBand=t;const e=oi.find(i=>i.name===this.selectedBand);e&&this.dispatchEvent(new CustomEvent("toast",{detail:`Active artist DNA: ${e.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}onVibeSubmit(t){t.preventDefault();const e=this.freeText.trim();e&&(this.dispatchEvent(new CustomEvent("freetext-generate",{detail:e,bubbles:!0,composed:!0})),this.vibeOpen=!1,this.requestUpdate())}onJumpBar(t){this.progressStep=t*4,S.playFromBar(t),this.playing||this.dispatchEvent(new CustomEvent("toggle-play",{bubbles:!0,composed:!0})),this.requestUpdate()}getChordLadder(t){if(!t)return[];const e=String(t.name),i=(e.match(/^[A-G][#b]?/)||["C"])[0];return(/sus/.test(e)?["sus4","7sus4","9sus4","maj7sus4"]:/dim/.test(e)?["dim","dim7","dim9"]:/^[A-G][#b]?m(?!aj)/.test(e)?["m","m6","m7","m9","mMaj7"]:["","6","7","maj7","maj9"]).map(o=>i+o)}getLadderHome(t){return this.getChordLadder(t).indexOf(t&&t.name)}handlePadPointerDown(t,e){const i=this.progression?.chords,n=i?i[e]:null;if(!n)return;let o=n.voicing||"1st inversion",s=Ui(o),r;const a=this.getChordLadder(n),c=this.getLadderHome(n);if(t.currentTarget&&typeof t.currentTarget.getBoundingClientRect=="function"){const v=t.currentTarget.getBoundingClientRect(),b=Math.min(.999,Math.max(0,(t.clientX-v.left)/(v.width||1))),y=Math.min(.999,Math.max(0,(t.clientY-v.top)/(v.height||1)));y<.34?(s=0,o="up an octave"):y>.67?(s=2,o="low, root position"):(s=1,o="1st inversion"),a.length>0&&(r=Math.min(a.length-1,Math.floor(b*a.length)));try{t.currentTarget.setPointerCapture?.(t.pointerId)}catch{}}const p=r!==void 0&&a[r]?a[r]:n.name,h=r!==void 0&&r!==c&&!!a[r],l=this.progression?.key||"C",g=this.progression?.scaleType||"MAJOR",d=G(p,R(l,g)),u=88+e%3*6;this.gridTimer&&(clearTimeout(this.gridTimer),this.gridTimer=null),this.padFlash=e,this.padHeld=e,this.gridFor=e;const m=h?"→ "+p:s===0?"UP AN OCTAVE":s===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:e,voicing:o,vel:u,zone:s,reach:r,meta:m},S.playChordNotes(d,.85,o,u),this.pendingLatch={index:e,reach:r,voicing:o,targetChordName:p},this.requestUpdate()}handlePadPointerMove(t,e){if(this.padHeld!==e)return;const i=this.progression?.chords,n=i?i[e]:null;if(n&&t.currentTarget&&typeof t.currentTarget.getBoundingClientRect=="function"){const o=t.currentTarget.getBoundingClientRect(),s=Math.min(.999,Math.max(0,(t.clientX-o.left)/(o.width||1))),r=Math.min(.999,Math.max(0,(t.clientY-o.top)/(o.height||1)));let a=1,c="1st inversion";r<.34?(a=0,c="up an octave"):r>.67&&(a=2,c="low, root position");const p=this.getChordLadder(n),h=this.getLadderHome(n),l=p.length>0?Math.min(p.length-1,Math.floor(s*p.length)):void 0,g=l!==void 0&&p[l]?p[l]:n.name,d=l!==void 0&&l!==h&&!!p[l];if(this.pendingLatch?.reach!==l||this.pendingLatch?.voicing!==c){this.pendingLatch={index:e,reach:l,voicing:c,targetChordName:g};const u=this.progression?.key||"C",m=this.progression?.scaleType||"MAJOR",v=G(g,R(u,m)),b=88+e%3*6,y=d?"→ "+g:a===0?"UP AN OCTAVE":a===1?"1ST INVERSION":"ROOT POSITION";this.lastPad={idx:e,voicing:c,vel:b,zone:a,reach:l,meta:y},S.playChordNotes(v,.65,c,b),this.requestUpdate()}}}handlePadPointerUp(t){if(t&&t.currentTarget)try{t.currentTarget.releasePointerCapture?.(t.pointerId)}catch{}if(this.padFlash=-1,this.padHeld=-1,this.gridTimer&&clearTimeout(this.gridTimer),this.gridTimer=window.setTimeout(()=>{this.gridFor=-1,this.requestUpdate()},1100),this.pendingLatch){const{index:e,reach:i,voicing:n,targetChordName:o}=this.pendingLatch;if(this.pendingLatch=null,this.progression&&this.progression.chords[e]){const s=this.progression.chords[e],r=this.getChordLadder(s),a=this.getLadderHome(s),c=s.voicing||"1st inversion",p=i!==void 0&&i!==a&&!!r[i]&&!!o;if(p||!!n&&n!==c){const l=s.initialChord||{...s};let g;if(p&&o){const m=this.getChordQualityLabel(s.name),v=this.getChordExtensionLabel(o),b=this.progression.key||"C",y=this.progression.scaleType||"MAJOR";g=ti(s,m,v),g.name=o,g.notes=G(o,R(b,y))}else g={...s};n&&(g.voicing=n),g.name===l.name&&(!l.voicing||g.voicing===l.voicing)?delete g.initialChord:g.initialChord=l;const d=[...this.progression.chords];d[e]=g;const u={...this.progression,chords:d};this.progression=u,this.dispatchEvent(new CustomEvent("progression-change",{detail:u,bubbles:!0,composed:!0})),S.setProgression(u,this.order)}}}this.requestUpdate()}openSwap(t){this.swapIndex=t,this.detailOpen=!1,this.isInspectorOpen=!0,this.abPick=null,this.abSide="before",this.abPlaying=!1,this.mobileFeelIndex=0,this.mobileChordIndex=0,this.activeSwapFamily="Darker",S.setABOverride(null),this.requestUpdate()}getSwapFeelings(t){if(!this.progression||!this.chordData.scales)return[];const e=this.progression.scaleType?.includes("MINOR")??!1,i=$i(this.chordData,this.progression),n=ui(this.chordData,this.progression),o=i.map(a=>({name:a.name,sub:ht[a.name]?ht[a.name][this.showTheory?1:0]:a.sub||"",tension:a.tension,rows:a.rows.map(c=>({name:c.name,roman:c.roman||"",notes:c.notes||c.chord?.notes,sub:c.sub,tension:c.tension,chord:c.chord}))}));o.push({name:"Borrowed",sub:`Four chords from the ${e?"major":"minor"} version of this key`,tension:.45,rows:n.map(a=>({name:a.name,roman:a.roman||"",notes:a.notes||a.chord?.notes,sub:a.sub,tension:a.tension,chord:a.chord}))});const s=o.filter(a=>a.name!=="Borrowed").sort((a,c)=>a.tension-c.tension),r=o.filter(a=>a.name==="Borrowed");return[...s,...r]}handleSwapAudition(t){if(this.swapIndex===null||!this.progression)return;const e=this.progression.chords[this.swapIndex],i=R(this.progression.key,this.progression.scaleType),n=t.notes&&t.notes.length?t.notes:G(t.chordName,i)||e.notes,o=t.chord?{...t.chord,name:t.chordName,notes:n,roman:t.roman||t.chord.roman||"",tension:t.tension,functionLabel:t.sub||t.chord.functionLabel||"Swapped in"}:{...e,name:t.chordName,notes:n,roman:t.roman||"",tension:t.tension,functionLabel:t.sub||"Swapped in"};this.abPick={chord:t.chordName,name:t.chordName,roman:t.roman||"",notes:n,tension:t.tension,fn:t.sub,functionLabel:t.sub,label:t.chordName},this.abSide="after",this.activeSwapFamily=t.feel,S.auditionChord(o,.8),S.setABOverride({index:this.swapIndex,side:"after",chord:o}),this.requestUpdate()}openDetail(t){this.detailIndex=t,this.detailOpen=!0,this.swapIndex=null,this.isInspectorOpen=!1,this.isMobile&&(this.mobileDetailSheetOpen=!0),this.requestUpdate()}selectAlternative(t){const e=this.progression?R(this.progression.key,this.progression.scaleType):!1,i=t.chord.notes&&t.chord.notes.length>0?t.chord.notes:G(t.chord.name,e);this.abPick={chord:t.name,tension:t.tension,roman:t.roman||"",fn:t.sub,label:t.name},this.abSide="after",this.swapIndex!==null&&this.progression&&S.setABOverride({index:this.swapIndex,side:"after",chord:{...this.progression.chords[this.swapIndex],name:t.name,roman:t.roman||"",tension:t.tension,notes:i}}),S.auditionChord({...t.chord,notes:i},.8),this.requestUpdate()}previewAlternative(t){if(!this.progression)return;const e=R(this.progression.key,this.progression.scaleType),i=G(t,e);S.auditionChord({name:t,notes:i,tag:"",color:"#F2A79B",functionLabel:"",desc:"",degree:"",scaleKey:this.progression.key,roman:"",scaleLabel:"",tension:.2},.8)}setABSide(t){if(this.abSide=t,this.swapIndex!==null&&this.progression){const e=R(this.progression.key,this.progression.scaleType);if(t==="before")S.setABOverride({index:this.swapIndex,side:"before",chord:this.progression.chords[this.swapIndex]}),S.auditionChord(this.progression.chords[this.swapIndex],.8);else if(this.abPick){const i=G(this.abPick.chord,e),n={...this.progression.chords[this.swapIndex],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:i};S.setABOverride({index:this.swapIndex,side:"after",chord:n}),S.auditionChord(n,.8)}}this.requestUpdate()}onAbCellClick(t){if(!this.progression)return;if(t===this.swapIndex&&this.abSide==="after"&&this.abPick){const i=R(this.progression.key,this.progression.scaleType),n={...this.progression.chords[t],name:this.abPick.chord,roman:this.abPick.roman,tension:this.abPick.tension,notes:G(this.abPick.chord,i)};S.auditionChord(n,.8)}else S.playChordAtIndex(t,.8)}getChordQualityLabel(t){if(!t)return"Major";const e=t.trim().replace(/^[A-G][#b♭♯]?/i,"");return/sus/i.test(e)?"Suspended (sus)":/(dim|°)/i.test(e)?"Diminished":/^(m|min)(?!aj)/.test(e)?"Minor":"Major"}getChordQualitySub(t){switch(this.getChordQualityLabel(t)){case"Minor":return"warm";case"Suspended (sus)":return"floating";case"Diminished":return"unstable";default:return"bright"}}getChordExtensionLabel(t){if(!t)return"None";const e=t.trim().replace(/^[A-G][#b♭♯]?/i,"");return/9/.test(e)?"9th":/(maj7|\(maj7\)|Δ)/i.test(e)||/M7/.test(e)?"Major 7th (M7)":/6/.test(e)?"6th":/(7|11|13)/.test(e)?"7th (dom / m7)":"None"}getChordExtensionSub(t){switch(this.getChordExtensionLabel(t)){case"6th":return"soft lift";case"7th (dom / m7)":return"classic tension";case"Major 7th (M7)":return"lush, jazzy";case"9th":return"wide, colorful";default:return"triad only"}}changeChordQuality(t){if(!this.progression)return;const e=[...this.progression.chords],i=e[this.detailIndex];if(!i)return;const n=this.getChordExtensionLabel(i.name),o=ti(i,t,n);e[this.detailIndex]=o;const s={...this.progression,chords:e};this.progression=s,this.dispatchEvent(new CustomEvent("progression-change",{detail:s,bubbles:!0,composed:!0})),S.auditionChord(o,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${o.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}changeChordExtension(t){if(!this.progression)return;const e=[...this.progression.chords],i=e[this.detailIndex];if(!i)return;const n=this.getChordQualityLabel(i.name),o=ti(i,n,t);e[this.detailIndex]=o;const s={...this.progression,chords:e};this.progression=s,this.dispatchEvent(new CustomEvent("progression-change",{detail:s,bubbles:!0,composed:!0})),S.auditionChord(o,.8),this.dispatchEvent(new CustomEvent("toast",{detail:`Changed chord to ${o.name}`,bubbles:!0,composed:!0})),this.requestUpdate()}renderDetailKeyboard(t=[]){const e={C:0,"B#":0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,Fb:4,F:5,"E#":5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11,Cb:11},i=new Set(t.map(a=>e[a.replace(/\d+$/,"")]??-1)),n=[{note:"C",pc:0},{note:"D",pc:2},{note:"E",pc:4},{note:"F",pc:5},{note:"G",pc:7},{note:"A",pc:9},{note:"B",pc:11}],o=100/7,s=o*.58,r=[{note:"C#",pc:1,after:0},{note:"D#",pc:3,after:1},{note:"F#",pc:6,after:3},{note:"G#",pc:8,after:4},{note:"A#",pc:10,after:5}];return f`
        ...
        <div style="flex: 1; min-width: 260px; display: flex; flex-direction: column; gap: 12px;">
          <div>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px;">
              ${Ri.map(e=>{const i=(this.progression?.key||"C").replace(/♭/g,"b").replace(/♯/g,"#").trim(),n=B[i]??0,o=B[e.root]??0,s=n===o;return f`
                  <button
          ...
          <div>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 6px;">
              ${pt.map(e=>{const i=(this.progression?.scaleType||"MAJOR").toUpperCase().replace(/\s+/g,"_"),n=i===e.type||e.type==="NATURAL_MINOR"&&i==="MINOR";return f`
                  <button
    ...
    `}renderFeelDrawerDesktop(){if(!this.feelOpen)return"";const t=this.fScopeBar===null?"Everything below applies to every chord in the loop.":`Only ${this.progression?.chords?.[this.fScopeBar]?.name||"this chord"} plays this way — the rest keep the loop feel.`;return f`
      <div class="feel-popover-desktop" style="animation: cvfv-panel 200ms var(--cv-ease, cubic-bezier(0.23, 1, 0.32, 1)); background: var(--cv-cream); border-radius: 18px; padding: 14px 16px 16px; margin-top: 11px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 8px 22px; margin-top: 10px;">
          ${ri.map(e=>{const i=this.fget(e.k);let n=e.steps[0];return typeof i!="number"?n=e.steps.find(o=>o.v===i)||e.steps[0]:e.steps.forEach(o=>{Math.abs(Number(o.v)-Number(i))<Math.abs(Number(n.v)-Number(i))&&(n=o)}),f`
    ...
    `}onSelectSectionCard(t){this.activeSectionIdx=t,this.activeView="loop",this.dispatchEvent(new CustomEvent("select-section",{detail:t,bubbles:!0,composed:!0}))}renderSongSectionList(t){const e=this.sections.length<xe.length;return f`
    ...
    `}renderChordDetailContent(t){const e=t[this.detailIndex],i=this.getChordQualityLabel(e?.name),n=this.getChordExtensionLabel(e?.name),o=R(this.progression?.key||"C",this.progression?.scaleType||"MAJOR"),s=e?zo(e.name,o):[];return f`
      ...
      <div class="quality-chips-grid">
        ${As.map(r=>{const a=r.label===i;return f`
            <button
      ...
      <div class="ext-chips-grid">
        ${Ms.map(r=>{const a=r.label===n;return f`
            <button
    ...
    `}renderPianoCard(t,e){const i=W(t.name),n=zi[i.root]??0,o=mt[i.quality]||mt[gi[i.quality]||"maj"]||[0,4,7],s=22,r=86,a=52,c=[0,2,4,5,7,9,11],p=[],h=[],l=[];for(let u=0;u<2;u++)c.forEach((m,v)=>{p.push({x:(u*7+v)*s,w:s-1.5,h:r})});for(let u=0;u<2;u++)[0,1,3,4,5].forEach(m=>{const v=u*7+m;h.push({x:v*s+s*.64,w:s*.58,h:a})});o.forEach(u=>{const m=n+u,v=Math.floor(m/12),b=m%12,y=c.indexOf(b),N=u===0,I=y<0,x=N?"#F2735F":I?"#FBF3E6":"#2E271F",O=N?"#FBF3E6":I?"#2E271F":"#FBF3E6",F=this.showDegrees?ut[u%12]:"";if(y>=0){const z=v*7+y;l.push({cx:z*s+(s-1.5)/2,cy:r-19,r:9,fill:x,isRoot:N,label:F,lc:O})}else{const A=(v*7+c.indexOf(b-1))*s+s*.64,$=s*.58;l.push({cx:A+$/2,cy:a-14,r:7.5,fill:x,isRoot:N,label:F,lc:O})}});const g=14*s,d=o.map(u=>{const m=Li[(n+u)%12];return this.showDegrees?`${m} (${ut[u%12]})`:m}).join(" · ");return f`
      <div
        class="play-card"
    ...
    `}renderFretCard(t,e,i){const n=W(t.name),o=zi[n.root]??0,s=mt[n.quality]||mt[gi[n.quality]||"maj"]||[0,4,7],r=[4,9,2,7,11,4],a=[7,0,4,9],c=i==="Ukulele",p=c?a:r,h=c?Fs({root:n.root,rootPc:o,q:n.quality,intervals:s})||[null,null,null,null]:Bs({root:n.root,rootPc:o,q:n.quality})||[null,null,null,null,null,null],l=18,g=24,d=4,u=16,m=p.length,v=h.filter(C=>C!==null&&C>0),b=v.length&&Math.max(...v)>4?Math.min(...v)-1:0,y=[],N=[],I=[],x=[],O=[];for(let C=0;C<m;C++)y.push({x:C*l});for(let C=0;C<=d;C++)N.push({y:u+C*g,sw:C===0&&b===0?3:1.2});h.forEach((C,P)=>{const H=P*l;if(C===null){O.push({x:H});return}if(C===0){x.push({x:H});return}const Y=((p[P]+C-o)%12+12)%12;I.push({cx:H,cy:u+(C-b-.5)*g,fill:Y===0?"#F2735F":"#2E271F",label:this.showDegrees?ut[((p[P]+C-o)%12+12)%12]:""})});const F=(m-1)*l,z=(m-1)*l+26,A=u+d*g+12,$=b>0?`${b+1}fr`:"",V=b>0,j=s.map(C=>{const P=Li[(o+C)%12];return this.showDegrees?`${P} (${ut[C%12]})`:P}).join(" · ");return f`
      <div
        class="play-card"
      ...
      >
        ...
        <svg width="${z}" height="${A}" viewBox="-13 -2 ${z} ${A}" style="display: block; width: 100%; max-width: ${z*1.5}px; height: auto;">
          ${N.map(C=>X`
            <rect x="0" y="${C.y}" width="${F}" height="${C.sw}" fill="rgba(46,39,31,0.4)"></rect>
          `)}
          ${y.map(C=>X`
    ...
    `}renderChordPad(t,e,i,n){const o=Q(t.tension||.1),s=this.activeIndex===e&&this.playing,r=this.padFlash===e||this.padHeld===e,a=this.swapIndex===e,c=this.getChordLadder(t),p=this.getLadderHome(t),h=this.lastPad?.idx===e,l=h&&typeof this.lastPad?.reach=="number"?this.lastPad.reach:p,g=h&&l>=0&&l!==p&&c[l],d=g?l:p,u=h?g?"→ "+c[l]:Os[this.lastPad?.zone??1]||this.lastPad?.voicing||"":t.voicing&&t.voicing!=="1st inversion"?t.voicing.toUpperCase():"";return f`
      <div
      ...
      >
        <div class="pad-voicing-grid ${this.gridFor===e?"active":""}">
          ${c.slice(1).map((m,v)=>f`
            <div style="position: absolute; top: 0; bottom: 0; left: ${(v+1)/c.length*100}%; width: 1px; background: rgba(46,39,31,0.18);"></div>
          `)}
        </div>
        ...
        <div class="pad-bottom-info">
          ...
          <div style="display: flex; gap: 3px; margin-top: 7px;">
            ${c.map((m,v)=>f`
              <div style="width: ${v===d?16:6}px; height: 4px; border-radius: 3px; background: ${v===d?g?i:"rgba(46,39,31,0.55)":"rgba(46,39,31,0.16)"}; transition: width 200ms cubic-bezier(0.23,1,0.32,1), background 180ms ease;"></div>
            `)}
          </div>
        </div>
      </div>
            ...
            ${this.activeView==="loop"?f`
              <div class="stage-card" style="padding: 18px 14px;">
                ...
                <div class="pad-cells-grid" style="grid-template-columns: 1fr 1fr; gap: 10px;">
                  ${t.map((d,u)=>{if(this.swapIndex===u){const m=Q(d.tension||.1),v=this.activeIndex===u&&this.playing;return f`
                        <div
                          class="pad-cell pad-cell-cycler ${v?"pad-lit":""}"
                          style="
                            background: ${m.color};
                            border-radius: 20px;
                            padding: 12px;
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 10px;">
                  ${ae.map(d=>f`
                    <button
                      ...
                      @click=${()=>{this.instrument=d.name,S.setInstrument(d.name),this.dispatchEvent(new CustomEvent("set-instrument",{detail:d.name,bubbles:!0,composed:!0})),this.expandedInstrument=!1,this.requestUpdate()}}
                    >
              ...
              ${this.showTheory?f`
                <div class="mobile-theory-panel">
                  ...
                  <div class="mobile-arc-bars" style="display: flex; align-items: flex-end; gap: 6px; height: 132px; margin-top: 14px;">
                    ${t.map(d=>{const u=Math.round(28+(d.tension||.1)*85),m=Q(d.tension||.1);return f`
                        <div style="flex: 1; display: flex; flex-direction: column; align-items: center; cursor: default;">
                          ...
                          <div style="font-size: 10px; font-weight: 700; color: var(--cv-ink-muted);">${we[d.functionLabel]||""}</div>
                        </div>
                      `})}
                  </div>
      ...
      <div class="studio-container" style="--mood-color: ${e};">
        ...
        ${this.vibeOpen?f`
          <div class="vibe-popover-desktop">
            ...
            <div class="popover-kicker spaced">Mood</div>
            <div class="pills-group">
              ${Pi.map(d=>{const u=ei(d),m=this.progression?.mood===d;return f`
                  <button class="pill mood-pill ${m?"active":""}" style="${m?`background: ${u}; color: #2E271F;`:""}" @click=${()=>this.onMoodClick(d)}>
                    <span class="mood-badge" style="background: ${m?"rgba(46, 39, 31, 0.12)":u+"33"};">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="${m?"#2E271F":u}" stroke-width="2.2" stroke-linecap="round"><path d="${Cs[d]||"M12 4 a6.5 6.5 0 1 0 6.5 6.5"}"/></svg>
                    </span>
                    ${d}
                  </button>
                `})}
            ...
            ${this.activeView==="loop"?f`
              <div class="stage-card stage-panel">
                ...
                <div class="pad-cells-grid pad-cells-row cv-padgrid" data-padgrid="1" data-wide="1">
                  ${t.map((d,u)=>{const v=Math.min(t.length-1,(Math.floor((this.swapIndex??0)/4)+1)*4-1);return f`
                      ${this.renderChordPad(d,u,e,!0)}
                      ${this.swapIndex!==null&&u===v?f`
                        <chord-swap-lane
              ...
              <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 12px;">
                <div>
                  ...
                  <div style="display: flex; align-items: baseline; gap: 8px; margin-top: 4px;">
                    ...
                    ${this.showTheory&&g?.roman?f`<span class="swap-roman">${g.roman}</span>`:""}
          ...
          `:f`
            ...
            <div class="inspector-body">
              <div class="arc-bars-row">
                ${t.map((d,u)=>{const m=Q(d.tension||.1),v=Math.round(18+(d.tension||.1)*62);return f`
                    <button class="arc-bar-col" @click=${()=>this.openSwap(u)} aria-label="${d.name}, ${we[d.functionLabel]||""}">
                      <div class="arc-bar-fill-wrap">
                        <div class="arc-bar-fill" style="height: ${v}px; background: ${m.color};"></div>
                      </div>
                      <div class="arc-bar-name">${d.name}</div>
                      <div class="arc-bar-feel">${we[d.functionLabel]||""}</div>
                    </button>
                  `})}
              </div>
  ...
  `;L([w()],U.prototype,"chordData",2);L([w()],U.prototype,"libraryOpen",2);L([w()],U.prototype,"genre",2);L([w()],U.prototype,"mood",2);L([w()],U.prototype,"progression",2);L([w()],U.prototype,"activeIndex",2);L([w()],U.prototype,"progressStep",2);L([w()],U.prototype,"order",2);L([w()],U.prototype,"playing",2);L([w()],U.prototype,"showTheory",2);L([w()],U.prototype,"instrument",2);L([w()],U.prototype,"playStyle",2);L([w()],U.prototype,"length",2);L([w()],U.prototype,"sections",2);L([w()],U.prototype,"activeSectionIdx",2);L([w()],U.prototype,"activePlayingSectionIdx",2);L([w()],U.prototype,"totalSongSteps",2);L([w()],U.prototype,"userEmail",2);L([w()],U.prototype,"isAuthenticated",2);L([w()],U.prototype,"syncStatus",2);L([w()],U.prototype,"syncError",2);L([w()],U.prototype,"authModalOpen",2);L([w()],U.prototype,"toastMessage",2);L([w()],U.prototype,"toastUndoId",2);L([w()],U.prototype,"isGenerating",2);L([w()],U.prototype,"chordLengthCache",2);U=L([Ee("chroma-chords-app")],U);
